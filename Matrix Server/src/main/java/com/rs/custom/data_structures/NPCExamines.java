...
public class NPCExamines {
     ...
     */
    private static final String UNPACKED = Settings.SERVER_DIR + "data/npcs/unpackedExamines.txt";

    /**
     * The location of the packed examines.
     */
    private static final String PACKED = Settings.SERVER_DIR + "data/npcs/packedExamines.e";
