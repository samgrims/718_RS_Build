	...
	try {
		...
		do {
			...
			if (12 == Class360.anInt3896 * -707576455) {
				...
				Class360.aClass25_3905.method389((Class264_Sub4.method2515(IPAddress.createSocket(AvalonApplet.LOBBY_IP, AvalonApplet.LOBBY_PORT), 15000, -649048480)), Class241.aClass471_2705.address, (byte) 0);
				...
				class298_sub36.out.writeInt(AvalonApplet.REVISION, -1354427278);
				if (AvalonApplet.SUB_REVISION != -1) {
				    class298_sub36.out.writeInt(AvalonApplet.SUB_REVISION, 376398822);
				}
			...
			if (-707576455 * Class360.anInt3896 == 82) {
				...
				if (!Class360.aBoolean3886) {
				    stream.writeInt(AvalonApplet.REVISION, 711122101);
				    if (AvalonApplet.SUB_REVISION != -1) {
					stream.writeInt(AvalonApplet.SUB_REVISION, 98092954);
				    }
				...
				if (!Class360.aBoolean3886) {
				    stream.writeInt(AvalonApplet.REVISION, -452164382);
				    if (AvalonApplet.SUB_REVISION != -1) {
					stream.writeInt(AvalonApplet.SUB_REVISION, 317411115);
				    }
