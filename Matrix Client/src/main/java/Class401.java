...
public class Class401 implements Interface21 {
	...
	public static boolean method4932(Class401 class401, int i) {
		try {
			return (aClass401_6555 == class401 || class401 == aClass401_6554
					|| aClass401_6560 == class401 || aClass401_6553 == class401 || aClass401_6556 == class401);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qq.b(").append(')').toString());
		}
	}
	...
	static final void method4935(Class403 class403, byte i) {
		try {
			...
			if ((((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919]) >= (((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239]))
				((Class403) class403).anInt5259 += ((((Class403) class403).anIntArray5257[((Class403) class403).anInt5259 * 1883543357]) * 286750741);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qq.al(").append(')').toString());
		}
	}

	public static Class401[] method4936(int i) {
		try {
			return (new Class401[] { aClass401_6556, aClass401_6552,
					aClass401_6553, aClass401_6557, aClass401_6555,
					aClass401_6560, aClass401_6554 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qq.a(").append(')').toString());
		}
	}

	public static Class464 method4937(ItemDefinitions class468,
			RsByteBuffer class298_sub53, byte i) {
		try {
			...
			if (bool) {
				class464.anIntArray5694[0] = class298_sub53
						.readBigSmart(1235052657);
				class464.anIntArray5695[0] = class298_sub53
						.readBigSmart(1235052657);
				if (-1 != 34210967 * ((ItemDefinitions) class468).anInt5737
						|| -1 != -1284247975 * ((ItemDefinitions) class468).anInt5746) {
					class464.anIntArray5694[1] = class298_sub53
							.readBigSmart(1235052657);
					class464.anIntArray5695[1] = class298_sub53
							.readBigSmart(1235052657);
				}
				if (((ItemDefinitions) class468).anInt5759 * 1313278521 != -1
						|| -1767718263 * ((ItemDefinitions) class468).anInt5741 != -1) {
					class464.anIntArray5694[2] = class298_sub53
							.readBigSmart(1235052657);
					class464.anIntArray5695[2] = class298_sub53
							.readBigSmart(1235052657);
				}
			}
			if (bool_5_) {
				class464.anIntArray5690[0] = class298_sub53
						.readBigSmart(1235052657);
				class464.anIntArray5697[0] = class298_sub53
						.readBigSmart(1235052657);
				if (86274879 * ((ItemDefinitions) class468).anInt5749 != -1
						|| ((ItemDefinitions) class468).anInt5764 * 1578724433 != -1) {
					class464.anIntArray5690[1] = class298_sub53
							.readBigSmart(1235052657);
					class464.anIntArray5697[1] = class298_sub53
							.readBigSmart(1235052657);
				}
			}
			if (bool_6_) {
				...
				for (int i_9_ = 0; i_9_ < 4; i_9_++) {
					if (is[i_9_] != 15)
						class464.aShortArray5698[is[i_9_]] = (short) class298_sub53
								.readUnsignedShort();
				}
			}
			if (bool_7_) {
				...
				for (int i_11_ = 0; i_11_ < 2; i_11_++) {
					if (15 != is[i_11_])
						class464.aShortArray5699[is[i_11_]] = (short) class298_sub53
								.readUnsignedShort();
				}
			}
			return class464;
	...
	static void method4938(int i, int i_12_, int i_13_, int i_14_, int i_15_,
			int i_16_, int i_17_, byte i_18_) {
		try {
			int i_19_ = Class463.method6012(i_13_,
					1155384281 * Class372_Sub3.anInt4049, -1062447355
							* Class372_Sub3.anInt4050, -1212608691);
			int i_20_ = Class463.method6012(i_14_,
					Class372_Sub3.anInt4049 * 1155384281,
					Class372_Sub3.anInt4050 * -1062447355, -1212608691);
			int i_21_ = Class463.method6012(i, Class372_Sub3.anInt4051
					* -1424479739, 1135094847 * Class372_Sub3.anInt4048,
					-1212608691);
			int i_22_ = Class463.method6012(i_12_, -1424479739
					* Class372_Sub3.anInt4051,
					Class372_Sub3.anInt4048 * 1135094847, -1212608691);
			int i_23_ = Class463.method6012(i_13_ + i_17_,
					1155384281 * Class372_Sub3.anInt4049,
					Class372_Sub3.anInt4050 * -1062447355, -1212608691);
			int i_24_ = Class463.method6012(i_14_ - i_17_,
					Class372_Sub3.anInt4049 * 1155384281, -1062447355
							* Class372_Sub3.anInt4050, -1212608691);
			for (int i_25_ = i_19_; i_25_ < i_23_; i_25_++)
				Class82_Sub22.method940(
						(Class372_Sub3.anIntArrayArray4047[i_25_]), i_21_,
						i_22_, i_16_, -1884573988);
			for (int i_26_ = i_20_; i_26_ > i_24_; i_26_--)
				Class82_Sub22.method940(
						(Class372_Sub3.anIntArrayArray4047[i_26_]), i_21_,
						i_22_, i_16_, 712014890);
			int i_27_ = Class463.method6012(i + i_17_, -1424479739
					* Class372_Sub3.anInt4051,
					Class372_Sub3.anInt4048 * 1135094847, -1212608691);
			int i_28_ = Class463.method6012(i_12_ - i_17_,
					Class372_Sub3.anInt4051 * -1424479739,
					Class372_Sub3.anInt4048 * 1135094847, -1212608691);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qq.q(").append(')').toString());
		}
	}

	static void method4939(Class298_Sub37_Sub15 class298_sub37_sub15, int i,
			int i_30_, short i_31_) {
		try {
			if (null != class298_sub37_sub15
					&& (Class436.aClass453_5480.aClass298_5643 != class298_sub37_sub15)) {
				...
				if (23 == i_34_) {
					if (1806357379 * client.playerRights > 0
							&& Class434.method5802(1267311211))
						Class476
								.method6083(
										(Class287.myPlayer.plane),
										i_32_ + -1760580017
												* class341.gameSceneBaseX, i_33_
						...
						if(AppletLoader.usingRS) {
							...
							if (1 == i_35_) {
								...
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeByte(-1);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeShort((int) client.aFloat8949,
												16711935);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeByte(57);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeByte(1227356013 * client.anInt8801);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeByte(356727603 * client.anInt8749);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeByte(89);
								Class217 class217 = (Class287.myPlayer
										.method4337().aClass217_2599);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeShort((int) class217.aFloat2451,
												16711935);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeShort((int) class217.aFloat2454,
												16711935);
								class298_sub36.aClass298_Sub53_Sub2_7396
										.writeByte(63);
							} else {
							...
							client.aClass25_8711.method390(class298_sub36,
									(byte) -115);
						}else{
							Class277.sendWalkPacket(i_35_, Class350
									.method4214(i_32_, i_33_, (short) 808));
							if(i_35_ == 0) {
								client.anInt8784 = i * 143636043;
								client.anInt8785 = i_30_ * 381532777;
								client.anInt8748 = 277162405;
						...
						Class82_Sub21.method938(i_32_, i_33_, true, Class350
								.method4214(i_32_, i_33_, (short) 808),
								-1776617382);
				...
				if (class198 != null) {
					if(class198 != OutcommingPacket.ITEM_ON_FLOOR_EXAMINE)
						Class277.sendWalkPacket(Class282
								.method2619(i_32_, i_33_, 1, 1, 1978833308));
					client.anInt8784 = i * 143636043;
					client.anInt8785 = i_30_ * 381532777;
					client.anInt8748 = 554324810;
					client.anInt8786 = 0;
					Class298_Sub36 class298_sub36 = Class18.method359(class198,
							client.aClass25_8711.aClass449_330, (byte) 23);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(
							283514611 * class341.gameSceneBaseY + i_33_, 16711935);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(i_32_
							+ -1760580017 * class341.gameSceneBaseX, 1653379787);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(i_35_,
							16711935);
					class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(
							Class151.method1644(984220338) ? 1 : 0, (byte) 1);
				...
				if (59 == i_34_) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(
							OutcommingPacket.aClass198_2087,
							client.aClass25_8711.aClass449_330, (byte) 6);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(
							1262526353 * Class379.anInt4099, 969641873);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(
							392084321 * client.anInt8836, 16711935);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(
							class341.gameSceneBaseY * 283514611 + i_33_, 16711935);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(
							client.anInt8906 * 1408085039);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(
							class341.gameSceneBaseX * -1760580017 + i_32_,
							1993411127);
					client.aClass25_8711.method390(class298_sub36, (byte) -125);
					Class82_Sub21
							.method938(i_32_, i_33_, true, Class350.method4214(
				...
				if (2 == i_34_) {
					...
					if (Class424.aClass424_6611 == class424
						...
						class336 = Class194.method1867(i_32_, i_33_, 0, 0, class424, i_4_,
								(byte) -22);
					...
					client.anInt8786 = 0;
					Class298_Sub36 class298_sub36 = Class18.method359(
							OutcommingPacket.INTERFACE_ON_OBJECT,
							client.aClass25_8711.aClass449_330, (byte) 52);
					class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(
							Class151.method1644(-427290804) ? 1 : 0, (byte) 1);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(
							client.anInt8906 * 1408085039);
					class298_sub36.aClass298_Sub53_Sub2_7396
							.writeShortLE128(283514611 * class341.gameSceneBaseY + i_33_);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeIntV2(
							(int) (l >>> 32) & 0x7fffffff);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(
							1262526353 * Class379.anInt4099, 671195475);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(
							client.anInt8836 * 392084321, 462918069);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(i_32_
				...
				if (i_34_ == 30 && client.aClass105_8652 == null) {
					...
					client.aClass105_8652 = Class140.method1558(i_33_, i_32_,
							-156511736);
				...
				if (class198_36_ != null) {
					...
					if (null != player) {
						...
						client.anInt8748 = 554324810;
						client.anInt8786 = 0;
						Class298_Sub36 class298_sub36 = Class18
								.method359(class198_36_,
										(client.aClass25_8711.aClass449_330),
										(byte) 74);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(
								Class151.method1644(1625676244) ? 1 : 0);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(
								i_35_);
						client.aClass25_8711.method390(class298_sub36,
								(byte) -105);
				...
				if (i_34_ == 16) {
					...
					client.anInt8786 = 0;
					Class298_Sub36 class298_sub36 = Class18.method359(
							OutcommingPacket.INTERFACE_ON_PLAYER,
							client.aClass25_8711.aClass449_330, (byte) 82);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort(
							1408085039 * client.anInt8906, 16711935);
					class298_sub36.aClass298_Sub53_Sub2_7396
							.writeShort(
									(Class287.myPlayer.anInt10064) * 1888274983,
									16711935);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeIntV2(
							Class379.anInt4099 * 1262526353);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(
							client.anInt8836 * 392084321);
					class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(
							Class151.method1644(-1804963392) ? 1 : 0, (byte) 1);
				...
				if (i_34_ == 17) {
					...
					client.anInt8786 = 0;
					Class298_Sub36 class298_sub36 = Class18.method359(
							OutcommingPacket.aClass198_2062,
							client.aClass25_8711.aClass449_330, (byte) 15);
					class298_sub36.aClass298_Sub53_Sub2_7396
							.method3617(
									Class151.method1644(1934855379) ? 1 : 0,
									1961724405);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(
							1408085039 * client.anInt8906);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(i_32_
							+ class341.gameSceneBaseX * -1760580017);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(
							283514611 * class341.gameSceneBaseY + i_33_);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeIntLE(
							1262526353 * Class379.anInt4099, (byte) 1);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(
							client.anInt8836 * 392084321);
				...
				if (58 == i_34_) {
					IComponentDefinition class105 = Class140.method1558(i_33_, i_32_,
							-156511736);
					if (class105 != null)
				...
				if (null != class198_37_) {
					...
					if (null != class298_sub29) {
						...
						client.anInt8786 = 0;
						Class298_Sub36 class298_sub36 = Class18
								.method359(class198_37_,
										(client.aClass25_8711.aClass449_330),
										(byte) 15);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(
								i_35_);
						class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(
								Class151.method1644(1824393579) ? 1 : 0,
								(byte) 1);
						client.aClass25_8711.method390(class298_sub36,
								(byte) -120);
						Class82_Sub21
				...
				if (packet != null) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(
							packet, client.aClass25_8711.aClass449_330,
							(byte) 94);
					class298_sub36.aClass298_Sub53_Sub2_7396
							.writeByte128(
									Class151.method1644(1030396767) ? 1 : 0,
									1999137832);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeIntLE(
							(int) (l >>> 32) & 0x7fffffff, (byte) 1);
					class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(i_32_
							+ class341.gameSceneBaseX * -1760580017, 1077977138);
					class298_sub36.aClass298_Sub53_Sub2_7396
				...
				if (8 == i_34_) {
					...
					if (class298_sub29 != null) {
						...
						client.anInt8786 = 0;
						Class298_Sub36 class298_sub36 = Class18.method359(
								OutcommingPacket.INTERFACE_ON_NPC,
								(client.aClass25_8711.aClass449_330),
								(byte) 103);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeByte(
								Class151.method1644(-510062351) ? 1 : 0);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(
								1262526353 * Class379.anInt4099, -828026807);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(
								i_35_, 1218473206);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE128(
								client.anInt8836 * 392084321);
						class298_sub36.aClass298_Sub53_Sub2_7396.writeShortLE(
								1408085039 * client.anInt8906, 249731045);
						client.aClass25_8711.method390(class298_sub36,
								(byte) -11);
						Class82_Sub21
								.method938(
				...
				if (25 == i_34_) {
					...
					if (class105 != null) {
						...
						Class147.method1600(class105, class298_sub38
								...
								1387537939);
						client.aString8838 = Class88.method977(class105,
								-447348156);
						if (null == client.aString8838)
							client.aString8838 = "Null";
						client.aString8754 = new StringBuilder().append(
								class105.aString1228).append(
								Class285.method2709(16777215, -1652576288))
								.toString();
					}
				} else {
					if (15 == i_34_) {
						...
						if (null != player) {
							...
							Class298_Sub36 class298_sub36 = Class18.method359(
									...
									(byte) 92);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.writeShort(client.anInt8906 * 1408085039,
											16711935);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.writeShort(i_35_, 16711935);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.writeIntV2(
											Class379.anInt4099 * 1262526353);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.writeShortLE128(392084321 * client.anInt8836);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.write128Byte(
											Class151.method1644(1486448273) ? 1
													: 0, (byte) 1);
							client.aClass25_8711.method390(class298_sub36,
									(byte) -120);
							Class82_Sub21
					...
					if (i_34_ == 60) {
						if (client.playerRights * 1806357379 > 0
								&& Class434.method5802(838408640))
							Class476
									.method6083(
											(Class287.myPlayer.plane),
											class341.gameSceneBaseX * -1760580017
							...
							client.anInt8786 = 0;
							Class298_Sub36 class298_sub36 = Class18.method359(
									OutcommingPacket.aClass198_2082,
									(client.aClass25_8711.aClass449_330),
									(byte) 98);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.writeShort(class341.gameSceneBaseY * 283514611
											+ i_33_, 16711935);
							class298_sub36.aClass298_Sub53_Sub2_7396
									.writeShort128(-1760580017
											* class341.gameSceneBaseX + i_32_);
							client.aClass25_8711.method390(class298_sub36,
									(byte) -43);
						}
					}
					...
					if (null != Class236.aClass105_2606
							&& 0 == -2018194505 * client.anInt8788)
						Tradution
								.method6054(Class236.aClass105_2606, 1534658392);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qq.bs(").append(')').toString());
		}
	}

	static final void method4940(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1372893999
					* Class360.anInt3871;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qq.aho(").append(')').toString());
		}
	}
}
