...
public class IncommingPacket {
	...
	public static IncommingPacket aClass202_2207;
	...
	public static IncommingPacket aClass202_1900;
	...
	public static IncommingPacket aClass202_2273;
	...
	static {
		...
		aClass202_2207 = new IncommingPacket(57, 25);
		...
		aClass202_1900 = new IncommingPacket(113, 25);
		...
		aClass202_2273 = new IncommingPacket(143, 32);
	...
	static final void method1903(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub6
					.method886(i_1_, i_2_, false, 1051533242);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("in.tv(").append(')').toString());
		}
	}
	...
	static final void method1906(Class403 class403, byte i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2074,
					client.aClass25_8711.aClass449_330, (byte) 125);
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_5_,
					-1055367891);
			client.aClass25_8711.method390(class298_sub36, (byte) -42);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("in.sz(").append(')').toString());
		}
	}
