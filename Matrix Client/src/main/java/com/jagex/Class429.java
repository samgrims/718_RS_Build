...
public class Class429 implements Interface21 {
	...
	static {
		...
		for (int i = 0; i < class429s_0_.length; i++) {
			...
			if ((aClass429Array6635[-1719637847
			                        * ((Class429) class429).anInt6630]) != null)
	...
	public static Class429 method5754(int i, int i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("rt.d(").append(')').toString());
		}
	}

	Class429(String string, String string_2_, String string_3_,
			Class401 class401, int i, String string_4_) {
	...
	public String toString() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("rt.toString(").append(')').toString());
		}
	}
	...
	public static Class429[] method5756(int i) {
		try {
			return (new Class429[] { aClass429_6632, aClass429_6626,
					aClass429_6628, aClass429_6625, aClass429_6624,
					aClass429_6627 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("rt.a(").append(')').toString());
		}
	}

	static final void method5757(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547
					.method5628((byte) 103) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("rt.ans(").append(')').toString());
		}
	}
	...
	public static Class25 method5760(short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("rt.fc(").append(')').toString());
		}
	}

	static final void method5761(GraphicsToolkit class_ra, Interface_ma interface_ma,
			byte i) {
		try {
			if (null != Class301_Sub1.aClass298_Sub37_Sub13_3218) {
				...
				if (Class301_Sub1.anInt7624 * -1289394455 < 10) {
					if (!Class301_Sub1.aClass243_3248
							.method2312(
									Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640,
									-2140139718)) {
						Class301_Sub1.anInt7624 = (Class_v.aClass243_7622
								.method2305(
										(Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640),
										-1210672889)) / 10 * 1078186329;
						return;
					}
				...
				Class301_Sub1.anInt3239 = ((Class301_Sub1.aClass298_Sub37_Sub13_3218.anInt9647 * -2052483955) >> 6 << 6)
						- Class301_Sub1.anInt3245 + 64;
				...
				if (Class301_Sub1.aClass298_Sub37_Sub13_3218
						.method3453(
								Class287.myPlayer.plane,
								(((int) class217.aFloat2451 >> 9) + -1760580017
										* class341.gameSceneBaseX),
										(283514611 * class341.gameSceneBaseY + ((int) class217.aFloat2454 >> 9)),
										is, 46106083)) {
					i_7_ = is[1] - Class301_Sub1.anInt3245;
					i_8_ = is[2] - Class301_Sub1.anInt3238;
				}
				if (!Class301_Sub1.aBoolean7631 && i_7_ >= 0
						&& i_7_ < Class301_Sub1.anInt3239 && i_8_ >= 0
						&& i_8_ < Class301_Sub1.anInt3240) {
				...
				} else if (1646852571 * Class301_Sub1.anInt7629 != -1
						&& -1 != Class301_Sub1.anInt7623 * 679054909) {
					Class301_Sub1.aClass298_Sub37_Sub13_3218.method3452(
							1646852571 * Class301_Sub1.anInt7629,
							Class301_Sub1.anInt7623 * 679054909, is,
							-1594439812);
					if (null != is) {
						Class82_Sub14.anInt6875 = -2076584633
								* (is[1] - Class301_Sub1.anInt3245);
					...
					Class301_Sub1.aClass298_Sub37_Sub13_3218
					.method3452(
							(Class301_Sub1.aClass298_Sub37_Sub13_3218.anInt9644)
							* -1973484731 >> 14 & 0x3fff,
							-1973484731
							* (Class301_Sub1.aClass298_Sub37_Sub13_3218.anInt9644)
							& 0x3fff, is, -1810513482);
					Class82_Sub14.anInt6875 = (is[1] - Class301_Sub1.anInt3245)
							* -2076584633;
					Class376.anInt4090 = (is[2] - Class301_Sub1.anInt3238)
							* -435591305;
				}
				...
				Class301_Sub1.aByteArrayArrayArray3229 = IcmpService_Sub1
						.method6381(Class301_Sub1.anInt3254, 51229796);
				...
				if (Class301_Sub1.anInt3228 > 16)
					Class301_Sub1.anInt3228 = 16;
				Class301_Sub1.method3707(interface_ma,
						(Class301_Sub1.anInt3227 >> 2 << 10),
						Class301_Sub1.anInt3228 >> 1);
				Class301_Sub1.aClass339_3251.method4119(1024, 256,
						303697513);
				Class301_Sub1.aClass487_3225.method6160(256, 256,
						-1144646938);
				...
				Class301_Sub1.anInt7624 = 88890100;
					...
					Class301_Sub1.method3699(class_ra, Class301_Sub1.anInt3227,
							Class301_Sub1.anInt3228);
						...
						if (!Class301_Sub1.aClass243_3248
								.method2312(
										...
										.append(
												...
												.toString(), -2145213052))
							return;
						Class301_Sub1.aClass296_3235 = (Class237
								.method2192(
										Class301_Sub1.aClass243_3248,
										new StringBuilder()
										.append(
												Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640)
												.append("_staticelements")
					...
					Class381.aClass4_4119 = new Class4(class_ra, 11, true,
					...
					Class255.aClass4_2795 = new Class4(class_ra, 12, true,
							Class52_Sub2_Sub1.aCanvas9079);
					...
					Class52.aClass4_508 = new Class4(class_ra, 14, true,
							Class52_Sub2_Sub1.aCanvas9079);
					...
					Class414.aClass4_5326 = new Class4(class_ra, 17, true,
							Class52_Sub2_Sub1.aCanvas9079);
					...
					Class355.aClass4_6525 = new Class4(class_ra, 19, true,
							Class52_Sub2_Sub1.aCanvas9079);
					...
					Class400.aClass4_5224 = new Class4(class_ra, 22, true,
							Class52_Sub2_Sub1.aCanvas9079);
					...
					Class152.aClass4_1594 = new Class4(class_ra, 26, true,
							Class52_Sub2_Sub1.aCanvas9079);
					Class301_Sub1.anInt7624 = -669291869;
					Class517.method6310(true, 1357229880);
					Class113.method1247(1747834568);
				} else {
					Class241.aClass4_2707 = new Class4(class_ra, 30, true,
							Class52_Sub2_Sub1.aCanvas9079);
