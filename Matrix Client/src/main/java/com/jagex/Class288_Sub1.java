		...
		try {
			if (Class525.aClass486_6298 != null) {
				try {
					...
					if (Class525.aClass486_6298 == AccountCreationStage.aClass486_6060) {
						...
						class298_sub36.out.writeByte(-1813470547 * Class211.aClass211_2415.anInt2418);
						class298_sub36.out.writeShort(0, 16711935);
						int i_1_ = ((class298_sub36.out.index) * 385051775);
						class298_sub36.out.writeShort(718, 16711935);
						class298_sub36.out.writeShort(1, 16711935);
						...
						class298_sub36.out.writeByte(Class321.aClass429_3357.method242(694163818));
						class298_sub36.out.writeByte(client.aClass411_8944.gameType * -937307905);
						...
						Class525.aClass486_6298 = AccountCreationStage.aClass486_6061;
					}
					if (AccountCreationStage.aClass486_6061 == Class525.aClass486_6298) {
						if (client.aClass25_8693.method387(537308016)
								.isAvailable(1, (byte) -109)) {
							client.aClass25_8693
							.method387(537308016)
							.readBytes(
									(((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333.buffer),
									0, 1, (byte) -97);
							Class525.aClass412_6299 = ((Class412) (Class422_Sub20
									.method5701(
											Class400.method4928((short) 4505),
											(((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333.buffer[0]) & 0xff,
											(byte) 2)));
							if (Class525.aClass412_6299 == Class412.aClass412_6569) {
								client.aClass25_8693.aClass449_330 = new IsaacCipher(
										Class361.anIntArray3913);
								int[] is = new int[4];
								for (int i_3_ = 0; i_3_ < 4; i_3_++)
									is[i_3_] = 50 + Class361.anIntArray3913[i_3_];
								((Class25) client.aClass25_8693).aClass449_334 = new IsaacCipher(
										is);
								new IsaacCipher(is);
								((Class25) client.aClass25_8693).aClass298_Sub53_Sub2_333
								.method3665(
										(((Class25) client.aClass25_8693).aClass449_334),
										(byte) 81);
