	...
	public String toString() {
		try {
			String string = new StringBuilder().append(
					((Class298_Sub31_Sub1) this).aClass100_9318.toString())
					.append(" ").append(
							((Class298_Sub31_Sub1) this).aString9315)
					.toString();
			if (((Class298_Sub31_Sub1) this).aString9316 != null
					&& !"".equals(((Class298_Sub31_Sub1) this).aString9316))
				string = new StringBuilder().append(string).append(" : ")
						.append(((Class298_Sub31_Sub1) this).aString9316)
						.toString();
			return string;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("afb.toString(").append(')').toString());
		}
	}
