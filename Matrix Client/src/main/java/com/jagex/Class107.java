...
public class Class107 {
	...
	static final void method1139(Class403 class403, int i) {
		try {
			...
			String string_2_ = ((String) (((Class403) class403).anObjectArray5240[1
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2085, class25.aClass449_330, (byte) 119);
			class298_sub36.out.writeByte((Class58
					.method693(string, 824741758) + 2 + Class58.method693(
					string_2_, 1825350693)));
	...
	static final void method1143(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.aByteArray1657[i_6_];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ej.xa(").append(')').toString());
		}
	}
	...
	public static void method1144(boolean bool, short i) {
		try {
			if (1596783995 * client.anInt8724 != 2
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2011,
