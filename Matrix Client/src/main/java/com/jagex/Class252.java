...
public class Class252 {
	...
	static void method2409(GraphicsToolkit class_ra, byte[][][] is, int i, int i_0_,
		...
		try {
			if (i_6_ != 0 && 0 != i) {
				...
				class_ra.N(i_0_, i_1_, i_4_, i_5_, i_2_, i_3_,
						is[i_6_ - 1][i_7_], i, i_8_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kn.a(").append(')').toString());
		}
	}
