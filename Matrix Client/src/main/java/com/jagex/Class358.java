...
public class Class358 {
	...
	void method4278(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
				...
				((Class358) this).anInt3855 = class298_sub53
						.readBigSmart(1235052657) * 315680607;
			else if (i == 4)
				((Class358) this).anInt3857 = class298_sub53
						.readBigSmart(1235052657)
						* -1871987079;
			else if (i == 5)
				((Class358) this).anInt3860 = class298_sub53
						.readBigSmart(1235052657)
						* -1006502127;
			else if (i == 6)
				((Class358) this).anInt3858 = class298_sub53
						.readBigSmart(1235052657)
						* -818871601;
			else if (i == 7)
				anInt3859 = class298_sub53.readShort(1738296677) * -1393539651;
			else if (8 == i)
				((Class358) this).aString3846 = class298_sub53
	...
	public String method4279(int i, int i_2_) {
		try {
			...
			for (;;) {
				...
				string = new StringBuilder().append(string.substring(0, i_3_))
						.append(Class128_Sub1.method1440(i, false, (byte) 8))
						.append(string.substring(2 + i_3_)).toString();
			}
			return string;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.b(").append(')').toString());
		}
	}
	...
	public Class57 method4280(GraphicsToolkit class_ra, short i) {
		try {
			if (459224223 * ((Class358) this).anInt3855 < 0)
				return null;
			Class57 class57 = ((Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
					.method4184((long) (459224223 * ((Class358) this).anInt3855))));
			if (class57 == null) {
				method4283(class_ra, 370410201);
				class57 = (Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4184((long) (459224223 * ((Class358) this).anInt3855)));
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.p(").append(')').toString());
		}
	}
	...
	public Class57 method4281(GraphicsToolkit class_ra, byte i) {
		try {
			if (((Class358) this).anInt3857 * 1894403017 < 0)
				return null;
			Class57 class57 = ((Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
					.method4184((long) (((Class358) this).anInt3857 * 1894403017))));
			if (class57 == null) {
				method4283(class_ra, 445358153);
				class57 = (Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4184((long) (1894403017 * ((Class358) this).anInt3857)));
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.k(").append(')').toString());
		}
	}
	...
	public Class57 method4282(GraphicsToolkit class_ra, byte i) {
		try {
			if (1896268847 * ((Class358) this).anInt3858 < 0)
				return null;
			Class57 class57 = ((Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
					.method4184((long) (((Class358) this).anInt3858 * 1896268847))));
			if (class57 == null) {
				method4283(class_ra, -388591321);
				class57 = (Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4184((long) (1896268847 * ((Class358) this).anInt3858)));
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.d(").append(')').toString());
		}
	}
	...
	void method4283(GraphicsToolkit class_ra, int i) {
		try {
			...
			if (459224223 * ((Class358) this).anInt3855 >= 0
					&& (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
							.method4184((long) (459224223 * ((Class358) this).anInt3855))) == null
					&& class243
							.method2310(
									((Class358) this).anInt3855 * 459224223,
									-457216440)) {
				IndexedImage class89 = IndexedImage.method979(class243,
						(((Class358) this).anInt3855 * 459224223));
				((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4194(
								class_ra.method5125(class89, true),
								(long) (((Class358) this).anInt3855 * 459224223));
			}
			if (((Class358) this).anInt3860 * -1362963983 >= 0
					&& ((((Class347) ((Class358) this).aClass347_3856).aClass348_3700
							.method4184((long) (((Class358) this).anInt3860 * -1362963983))) == null)
					&& class243.method2310(
							(-1362963983 * ((Class358) this).anInt3860),
							-457216440)) {
				IndexedImage class89 = IndexedImage.method979(class243,
						(-1362963983 * ((Class358) this).anInt3860));
				((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4194(
								class_ra.method5125(class89, true),
								(long) (((Class358) this).anInt3860 * -1362963983));
			}
			if (((Class358) this).anInt3857 * 1894403017 >= 0
					&& ((((Class347) ((Class358) this).aClass347_3856).aClass348_3700
							.method4184((long) (((Class358) this).anInt3857 * 1894403017))) == null)
					&& class243.method2310(
							(((Class358) this).anInt3857 * 1894403017),
							-457216440)) {
				IndexedImage class89 = IndexedImage.method979(class243,
						(((Class358) this).anInt3857 * 1894403017));
				((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4194(
								class_ra.method5125(class89, true),
								(long) (((Class358) this).anInt3857 * 1894403017));
			}
			if (((Class358) this).anInt3858 * 1896268847 >= 0
					&& ((((Class347) ((Class358) this).aClass347_3856).aClass348_3700
							.method4184((long) (((Class358) this).anInt3858 * 1896268847))) == null)
					&& class243.method2310(
							(((Class358) this).anInt3858 * 1896268847),
							-457216440)) {
				IndexedImage class89 = IndexedImage.method979(class243,
						(1896268847 * ((Class358) this).anInt3858));
				((Class347) ((Class358) this).aClass347_3856).aClass348_3700
						.method4194(
								class_ra.method5125(class89, true),
								(long) (1896268847 * ((Class358) this).anInt3858));
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.u(").append(')').toString());
		}
	}
	...
	public Class57 method4284(GraphicsToolkit class_ra, int i) {
		try {
			if (((Class358) this).anInt3860 * -1362963983 < 0)
				return null;
			Class57 class57 = ((Class57) (((Class347) ((Class358) this).aClass347_3856).aClass348_3700
					.method4184((long) (-1362963983 * ((Class358) this).anInt3860))));
			if (class57 == null) {
	...
	static void method4286(Class403 class403, int i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = (Class316.aClass362_3318
					.method4307(
							(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2]),
							245040087).aStringArray4022[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1])]);
			((Class403) class403).anInt5239 -= -783761378;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.h(").append(')').toString());
		}
	}
	...
	static boolean method4287(int i, int i_4_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.fa(").append(')').toString());
		}
	}

	public static void method4288(String string, boolean bool, int i,
		...
		try {
			...
			if (i_7_ == 0)
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (int) Math
						.pow((double) i_7_, 1.0 / (double) i_8_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oy.zs(").append(')').toString());
		}
	}

	static void method4290(IComponentDefinition class105, Class_ta class_ta, int i,
			int i_9_, int i_10_, int i_11_, int i_12_, String string,
			Class264 class264, Class505 class505, int i_13_, int i_14_) {
		try {
			int i_15_;
