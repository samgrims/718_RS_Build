...
public abstract class Class213 {
			...
			for (int i_8_ = 0; i_8_ < i_0_; i_8_++) {
				for (int i_9_ = 0; i_9_ < i; i_9_++) {
					for (int i_10_ = 0; i_10_ < ((Class213) this).anInt2443; i_10_++) {
						...
						int i_32_ = ((Class213) this).aShortArray2434[i_20_
								+ i_30_];
						int i_33_ = ((Class213) this).aShortArray2434[i_21_
								+ i_30_];
						int i_34_ = ((Class213) this).aShortArray2434[i_20_
								+ i_31_];
						int i_35_ = ((Class213) this).aShortArray2434[i_21_
								+ i_31_];
						int i_36_ = method1965(
								(((Class213) this).aShortArray2434[i_18_
										+ i_32_]), i_15_, i_16_, i_17_);
						int i_37_ = method1965(
								(((Class213) this).aShortArray2434[i_19_
										+ i_32_]), i_27_, i_16_, i_17_);
						int i_38_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
						i_36_ = method1965(
								(((Class213) this).aShortArray2434[i_18_
										+ i_33_]), i_15_, i_28_, i_17_);
						i_37_ = method1965(
								(((Class213) this).aShortArray2434[i_19_
										+ i_33_]), i_27_, i_28_, i_17_);
						int i_39_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
						int i_40_ = i_38_ + (i_25_ * (i_39_ - i_38_) >> 12);
						i_36_ = method1965(
								(((Class213) this).aShortArray2434[i_18_
										+ i_34_]), i_15_, i_16_, i_29_);
						i_37_ = method1965(
								(((Class213) this).aShortArray2434[i_19_
										+ i_34_]), i_27_, i_16_, i_29_);
						i_38_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
						i_36_ = method1965(
								(((Class213) this).aShortArray2434[i_18_
										+ i_35_]), i_15_, i_28_, i_29_);
						i_37_ = method1965(
								(((Class213) this).aShortArray2434[i_19_
										+ i_35_]), i_27_, i_28_, i_29_);
						i_39_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
						int i_41_ = i_38_ + (i_25_ * (i_39_ - i_38_) >> 12);
						method1961(i_10_, i_40_
								+ (i_26_ * (i_41_ - i_40_) >> 12));
					}
					method1970();
				}
			}
	...
	void method1962() {
		...
		for (int i = 0; i < ((Class213) this).anInt2443; i++)
			((Class213) this).aShortArray2436[i] = (short) (int) Math.pow(2.0,
					(double) i);
	}
	...
	void method1964() {
		...
		for (int i = 0; i < 255; i++) {
			int i_47_ = 255 - i;
			int i_48_ = Class298_Sub19_Sub3.method3039(random, i_47_,
					(byte) -33);
	...
	static int method1965(int i, int i_50_, int i_51_, int i_52_) {
		...
		int i_55_ = i_53_ < 4 ? i_51_ : i_53_ == 12 || i_53_ == 14 ? i_50_
				: i_52_;
		return (((i_53_ & 0x1) == 0 ? i_54_ : -i_54_) + ((i_53_ & 0x2) == 0 ? i_55_
				: -i_55_));
	}
