...
public class Class298_Sub32_Sub32 extends Class298_Sub32 {
	...
	void method3340(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub32) this).anInt9511 = class298_sub53
					.readUnsignedShort() * 1298582163;
			break;
		case 1:
			((Class298_Sub32_Sub32) this).anInt9514 = class298_sub53
					.readUnsignedShort() * 2091520197;
			break;
		}
	}
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_2_ = 0; i_2_ < -1474554145 * Class250.anInt2755; i_2_++) {
					int i_3_ = is_1_[i_2_];
					is[i_2_] = (i_3_ < (((Class298_Sub32_Sub32) this).anInt9511 * 1295115163) || i_3_ > 1628368397 * ((Class298_Sub32_Sub32) this).anInt9514) ? 0
							: 4096;
				}
			}
			return is;
	...
	int[] method3341(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_5_ = 0; i_5_ < -1474554145 * Class250.anInt2755; i_5_++) {
				int i_6_ = is_4_[i_5_];
				is[i_5_] = ((i_6_ < ((Class298_Sub32_Sub32) this).anInt9511 * 1295115163) || i_6_ > 1628368397 * (((Class298_Sub32_Sub32) this).anInt9514)) ? 0
						: 4096;
			}
		}
		return is;
	...
	int[] method3342(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_8_ = 0; i_8_ < -1474554145 * Class250.anInt2755; i_8_++) {
				int i_9_ = is_7_[i_8_];
				is[i_8_] = ((i_9_ < ((Class298_Sub32_Sub32) this).anInt9511 * 1295115163) || i_9_ > 1628368397 * (((Class298_Sub32_Sub32) this).anInt9514)) ? 0
						: 4096;
			}
		}
		return is;
	...
	static final void method3344(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub7.aBoolean8385 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahu.us(").append(')').toString());
		}
	}
