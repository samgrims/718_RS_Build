...
public class Class153_Sub2 extends Class153 {
	...
	void method1657(ByteBuffer bytebuffer, short i, short i_0_, byte i_1_,
	...
	void method1658() {
		if (((Class153_Sub2) this).aLong8623 != 0L) {
			((Class153_Sub2) this).aClass_ra_Sub3_Sub2_8624
					.method5552(((Class153_Sub2) this).aLong8623);
			((Class153_Sub2) this).aLong8623 = 0L;
		}
	}
		...
		for (short i_5_ = 0; i_5_ < aClass181Array6405.length; i_5_++) {
			...
			for (int i_7_ = 0; i_7_ < class181.method1842(); i_7_++) {
				...
				if (class155 == Class155.aClass155_1610)
					method1657(bytebuffer, i_5_, i_6_, (byte) 2, (byte) 0,
							(byte) 0, (byte) 0);
				else if (class155 == Class155.aClass155_1596)
					method1657(bytebuffer, i_5_, i_6_, (byte) 2, (byte) 0,
							(byte) 3, (byte) 0);
				else if (class155 == Class155.aClass155_1597)
					method1657(bytebuffer, i_5_, i_6_, (byte) 4, (byte) 0,
							(byte) 10, (byte) 0);
					...
					byte i_15_ = i;
					i++;
					class153_sub2_8_.method1657(bytebuffer_9_, i_10_, i_11_,
					...
					byte i_23_ = i;
					i++;
					class153_sub2_16_.method1657(bytebuffer_17_, i_18_, i_19_,
					...
					byte i_31_ = i;
					i++;
					class153_sub2_24_.method1657(bytebuffer_25_, i_26_, i_27_,
					...
					byte i_39_ = i;
					i++;
					class153_sub2_32_.method1657(bytebuffer_33_, i_34_, i_35_,
							i_36_, i_37_, i_38_, i_39_);
				}
				i_6_ += class155.anInt1611;
			}
		}
		method1657(bytebuffer, (short) 255, (short) 0, (byte) 17, (byte) 0,
				(byte) 0, (byte) 0);
		((Class153_Sub2) this).aLong8623 = (IDirect3DDevice
				.CreateVertexDeclaration(
						((Class_ra_Sub3_Sub2) ((Class153_Sub2) this).aClass_ra_Sub3_Sub2_8624).aLong9847,
						((Class153_Sub2) this).aClass_ra_Sub3_Sub2_8624.aLong8217));
