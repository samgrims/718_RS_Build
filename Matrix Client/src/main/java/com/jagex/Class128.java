package com.jagex;/* Class128 - Decompiled by JODE
...
public class Class128 implements Interface5 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fe.f(").append(')').toString());
		}
	}

	Class128(Class139 class139, Class133 class133, int i, int i_0_, int i_1_,
	...
	static final void method1435(boolean bool, Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fe.cm(").append(')').toString());
		}
	}

	static final void method1436(IComponentDefinition class105, Class119 class119,
	...
	static final void method1438(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_9_ == 2 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fe.yy(").append(')').toString());
		}
	}
}
