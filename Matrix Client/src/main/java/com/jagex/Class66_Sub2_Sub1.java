...
public class Class66_Sub2_Sub1 extends Class66_Sub2 {
	...
	Interface9_Impl1 method774() {
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_2_ = 0; i_2_ < 6; i_2_++)
				anIntArrayArray9101[i_2_] = interface_ma.method171(
						anIntArray9109[i_2_], 1.0F, i, i, false, 1504533027);
	...
	Class66_Sub2_Sub1(Class_ra_Sub3 class_ra_sub3, int i, int i_3_, int i_4_,
	...
	Interface9_Impl1 method773() {
		if (((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 == null) {
			...
			for (int i_8_ = 0; i_8_ < 6; i_8_++) {
				if (!interface_ma
						.method170(anIntArray9109[i_8_], (short) 30897))
					return null;
			...
			for (int i_10_ = 0; i_10_ < 6; i_10_++)
				anIntArrayArray9101[i_10_] = interface_ma.method171(
						anIntArray9109[i_10_], 1.0F, i, i, false, -1308282836);
			((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102 = ((Class66_Sub2_Sub1) this).aClass_ra_Sub3_9106
					.method5415(i, bool, anIntArrayArray9101);
		}
		return ((Class66_Sub2_Sub1) this).anInterface9_Impl1_9102;
