...
public abstract class Class308 {
	...
	public void method3764(String string, byte i) {
		try {
			...
			if (((Class308) this).aString3274 == null)
				...
				if (null != ((Class308) this).aClass298_Sub24_Sub4_3280
						&& !(((Class308) this).aString3274
								.equals(((Class308) this).aClass298_Sub24_Sub4_3280
										.method3091((byte) 108))))
					((Class308) this).aClass298_Sub24_Sub4_3280 = null;
				if (((Class308) this).aClass298_Sub24_Sub4_3280 == null) {
					for (Class298_Sub24 class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
							.method5816(1591555400); null != class298_sub24; class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
							.method5815((byte) -51)) {
						if (class298_sub24 instanceof Class298_Sub24_Sub4) {
							...
							if (((Class308) this).aString3274
									.equals(class298_sub24_sub4
											.method3091((byte) 59))) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mu.s(").append(')').toString());
		}
	}

	void method3765(int i) throws IOException {
		try {
			while (((Class298_Sub24_Sub3) ((Class308) this).aClass298_Sub24_Sub3_3278).anOggStreamState7351
					.packetOut(((Class308) this).anOggPacket3272) != 1) {
			...
			((Class308) this).aClass298_Sub24_Sub3_3278.method3073(
					((Class308) this).anOggPacket3272, -1226862921);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mu.p(").append(')').toString());
		}
	}
	...
	void method3767(byte i) {
		try {
			for (Class298_Sub24 class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
					.method5816(2015139315); null != class298_sub24; class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
					.method5815((byte) 5)) {
				if (!(class298_sub24 instanceof Class298_Sub24_Sub4)) {
					if (i <= 0) {
						/* empty */
					...
					Class298_Sub24_Sub4 class298_sub24_sub4 = (Class298_Sub24_Sub4) class298_sub24;
					while (((((Class298_Sub24_Sub4) class298_sub24_sub4).anInt7352)
							* -1312498565 <= 8 || (method3779((short) 30482) > (double) class298_sub24_sub4
							.method3093(-136313953)))
							&& (((Class298_Sub24_Sub4) class298_sub24_sub4).anOggStreamState7351
									.packetOut(((Class308) this).anOggPacket3272)) == 1)
						class298_sub24_sub4.method3073(
								(((Class308) this).anOggPacket3272),
								-1226862921);
				}
			}
		...
		try {
			if (null != ((Class308) this).aClass298_Sub24_Sub1_3268)
				return (!((Class308) this).aClass298_Sub24_Sub3_3278
						.method3087(-1737998296) || (method3779((short) 7060) > ((Class308) this).aClass298_Sub24_Sub3_3278
						.method3085(-2077117247)));
			double d = (double) ((Class308) this).aClass298_Sub24_Sub3_3278
					.method3084(-1240396603);
			return (0.0 == d || ((double) Class122.method1319((byte) 1) >= (double) ((Class308) this).aClass298_Sub24_Sub3_3278
					.method3086((byte) 0)
					+ 1000.0 / d));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mu.k(").append(')').toString());
		}
	}
	...
	void method3769(int i) {
		try {
			for (Class298_Sub24 class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
					.method5816(2104844471); null != class298_sub24; class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
					.method5815((byte) -42)) {
				if (((Class308) this).aClass298_Sub24_Sub3_3278 == class298_sub24) {
					...
					while (((Class298_Sub24) class298_sub24).anOggStreamState7351
							.packetOut() == 1)
						class298_sub24.method3073(
								(((Class308) this).anOggPacket3272),
								-1226862921);
				}
			}
			if (((Class308) this).aClass298_Sub24_Sub3_3278 != null) {
				for (int i_0_ = 0; i_0_ < 10 && method3768(-1610938594); i_0_++) {
					if (((Class298_Sub24_Sub3) ((Class308) this).aClass298_Sub24_Sub3_3278).anOggStreamState7351
							.packetOut() != 1) {
						method3771((byte) 61);
						break;
					}
	...
	public void method3771(byte i) {
		try {
			if (!((Class308) this).aBoolean3276) {
				for (Class298_Sub24 class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
						.method5816(1658578802); class298_sub24 != null; class298_sub24 = (Class298_Sub24) ((Class308) this).aClass437_3279
						.method5815((byte) -74)) {
	...
	public boolean method3773(int i) {
		try {
			if (!((Class308) this).aBoolean3276
					&& !((Class308) this).aBoolean3277)
				return false;
			if (null != ((Class308) this).aClass298_Sub24_Sub1_3268
					&& ((Class308) this).aClass298_Sub24_Sub1_3268
							.method3083(-693943954) > 0)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mu.n(").append(')').toString());
		}
	}
	...
	Class298_Sub24 method3774(byte i) throws IOException {
		try {
			...
			while_75_: do {
				int i_1_;
				do {
					if (((Class308) this).anOggSyncState3273
							.pageOut(((Class308) this).anOggPage3271) > 0)
						break while_75_;
					i_1_ = method3775(((Class308) this).aByteArray3270,
							-2116572420);
					if (-1 == i_1_) {
					...
					if (0 == i_1_)
						return null;
				} while (((Class308) this).anOggSyncState3273.write(
						((Class308) this).aByteArray3270, i_1_));
			...
			if (((Class308) this).anOggPage3271.isBOS()) {
				...
				if (!oggstreamstate.pageIn(((Class308) this).anOggPage3271))
					throw new IllegalStateException();
				if (oggstreamstate
						.packetPeek(((Class308) this).anOggPacket3272) != 1)
					throw new IllegalStateException();
				Class298_Sub24 class298_sub24;
				if (null == ((Class308) this).aClass298_Sub24_Sub3_3278
						&& ((Class308) this).anOggPacket3272.isTheora()) {
					((Class308) this).aClass298_Sub24_Sub3_3278 = new Class298_Sub24_Sub3(
							oggstreamstate);
					class298_sub24 = ((Class308) this).aClass298_Sub24_Sub3_3278;
				} else if (null == ((Class308) this).aClass298_Sub24_Sub1_3268
						&& ((Class308) this).anOggPacket3272.isVorbis()) {
					((Class308) this).aClass298_Sub24_Sub1_3268 = new Class298_Sub24_Sub1(
							oggstreamstate);
	...
	public void method3776(boolean bool, int i) {
		try {
			if (null != ((Class308) this).aClass298_Sub24_Sub1_3268) {
				Class298_Sub19_Sub3 class298_sub19_sub3 = ((Class308) this).aClass298_Sub24_Sub1_3268
						.method3082(-840425248);
	...
	public double method3779(short i) {
		try {
			if (((Class308) this).aClass298_Sub24_Sub1_3268 != null)
				return ((Class308) this).aClass298_Sub24_Sub1_3268
						.method3081(-762609524);
			if (null != ((Class308) this).aClass298_Sub24_Sub3_3278)
				return ((Class308) this).aClass298_Sub24_Sub3_3278
						.method3085(-831725814);
			return 0.0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mu.z(").append(')').toString());
		}
	}
				...
				while_77_: for (/**/; !((Class308) this).aBoolean3276; ((Class308) this).aBoolean3281 = false) {
					...
					if (class298_sub24 == ((Class308) this).aClass298_Sub24_Sub1_3268) {
						if (((Class308) this).aClass298_Sub24_Sub1_3268
								.method3083(-693943954) < 50) {
							do {
								if ((((Class298_Sub24_Sub1) (((Class308) this).aClass298_Sub24_Sub1_3268)).anOggStreamState7351
										.packetOut(((Class308) this).anOggPacket3272)) != 1)
									continue while_77_;
								((Class308) this).aClass298_Sub24_Sub1_3268
										.method3073(
								...
								method3767((byte) 126);
								if (((Class308) this).aClass298_Sub24_Sub3_3278 != null) {
									double d = ((Class308) this).aClass298_Sub24_Sub3_3278
											.method3085(-820053880);
									for (int i_4_ = 0; i_4_ < 10
											&& method3768(1506745043); i_4_++) {
										method3765(-508179442);
										if (((Class308) this).aBoolean3276)
											return;
									}
									if (d < ((Class308) this).aClass298_Sub24_Sub3_3278
											.method3085(-1579482552))
										break;
								}
							} while (((Class308) this).aClass298_Sub24_Sub1_3268
									.method3083(-693943954) < 50);
							break;
						}
						break;
					...
					if (class298_sub24 instanceof Class298_Sub24_Sub4)
						...
						while ((((Class298_Sub24) class298_sub24).anOggStreamState7351
								.packetOut(((Class308) this).anOggPacket3272)) == 1) {
							if (1 == (((Class298_Sub24) class298_sub24).anInt7352)
									* -1312498565
									&& (class298_sub24 instanceof Class298_Sub24_Sub4))
								method3764(((Class308) this).aString3274,
										(byte) 43);
							class298_sub24.method3073(
									(((Class308) this).anOggPacket3272),
									-1226862921);
	...
	static final void method3782(int i, int i_7_, int i_8_, int i_9_, int i_10_) {
		try {
			...
			int i_13_ = -i_8_;
			int i_14_ = -1;
			int i_15_ = Class463.method6012(i_8_ + i, Class372_Sub1.anInt4051
					* -1424479739, Class372_Sub1.anInt4048 * 1135094847,
					-1212608691);
			int i_16_ = Class463.method6012(i - i_8_, Class372_Sub1.anInt4051
					* -1424479739, 1135094847 * Class372_Sub1.anInt4048,
					-1212608691);
			Class82_Sub22.method940(Class372_Sub1.anIntArrayArray4047[i_7_],
					i_16_, i_15_, i_9_, 410046201);
			while (i_12_ > i_11_) {
				i_14_ += 2;
				i_13_ += i_14_;
				if (i_13_ > 0) {
					...
					if (i_18_ >= 1155384281 * Class372_Sub1.anInt4049
							&& i_17_ <= Class372_Sub1.anInt4050 * -1062447355) {
						int i_19_ = Class463.method6012(i_11_ + i,
								(Class372_Sub1.anInt4051 * -1424479739),
								(1135094847 * Class372_Sub1.anInt4048),
								-1212608691);
						int i_20_ = Class463.method6012(i - i_11_,
						...
						if (i_18_ <= Class372_Sub1.anInt4050 * -1062447355)
							Class82_Sub22.method940(
									(Class372_Sub1.anIntArrayArray4047[i_18_]),
									i_20_, i_19_, i_9_, 483446032);
						if (i_17_ >= 1155384281 * Class372_Sub1.anInt4049)
							Class82_Sub22.method940(
									(Class372_Sub1.anIntArrayArray4047[i_17_]),
									i_20_, i_19_, i_9_, 694694186);
					}
				}
				i_11_++;
				int i_21_ = i_7_ - i_11_;
				int i_22_ = i_11_ + i_7_;
				if (i_22_ >= 1155384281 * Class372_Sub1.anInt4049
						&& i_21_ <= -1062447355 * Class372_Sub1.anInt4050) {
					int i_23_ = Class463
							.method6012(i_12_ + i,
									(-1424479739 * Class372_Sub1.anInt4051),
									(Class372_Sub1.anInt4048 * 1135094847),
					...
					if (i_22_ <= Class372_Sub1.anInt4050 * -1062447355)
						Class82_Sub22.method940(
								(Class372_Sub1.anIntArrayArray4047[i_22_]),
								i_24_, i_23_, i_9_, -698175360);
					if (i_21_ >= Class372_Sub1.anInt4049 * 1155384281)
						Class82_Sub22.method940(
								(Class372_Sub1.anIntArrayArray4047[i_21_]),
								i_24_, i_23_, i_9_, -1368687138);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	public static void method3784(byte i) {
		try {
			if (Class474.aBoolean5970) {
				if (Class474.anInt5971 * -64101949 < -1648308965
						* Class395.anInt5190)
					Class474.anInt5971 = Class395.anInt5190 * 1429182921;
				while (Class474.anInt5971 * -64101949 < -499146007
						* Class338.anInt3630) {
					Class343_Sub1 class343_sub1 = Class226.method2105(
							Class474.anInt5971 * -64101949, (byte) -50);
					if (class343_sub1 == null
							|| -1 != class343_sub1.anInt7720 * 512449113)
						Class474.anInt5971 += 854136555;
					else {
						if (Class474.aClass396_5978 == null)
							Class474.aClass396_5978 = (client.aClass404_8715
									.method4946(class343_sub1.aString7718,
											(byte) 111));
						int i_25_ = Class474.aClass396_5978.anInt5195
								* -747638219;
						if (i_25_ == -1)
							break;
