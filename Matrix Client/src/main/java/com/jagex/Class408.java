...
public class Class408 {
	...
	static Class444[] method4965(byte i) {
		try {
			return (new Class444[] { Class444.aClass444_5605,
					Class444.aClass444_5604, Class444.aClass444_5602,
					Class444.aClass444_5606, Class444.aClass444_5603 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qy.a(").append(')').toString());
		}
	}
	...
	public static int method4966(long l) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qy.i(").append(')').toString());
		}
	}

	static Class147[] method4967(byte i) {
		try {
			return (new Class147[] { Class147.aClass147_1579,
					Class147.aClass147_1578, Class147.aClass147_1577 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qy.a(").append(')').toString());
		}
	...
	static final void method4969(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.FRIEND_CHAT_QUICK_CHAT_MESSAGE, class25.aClass449_330, (byte) 51);
