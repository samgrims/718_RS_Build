...
public class Class298_Sub32_Sub38 extends Class298_Sub32 {
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_2_ = 0; i_2_ < Class250.anInt2755 * -1474554145; i_2_++) {
					...
					i_4_ = i_4_ > 2048 ? i_4_ - 4096 : i_4_;
					int i_5_ = i_1_
							+ (351466605 * ((Class298_Sub32_Sub38) this).anInt9559);
					i_5_ = i_5_ < -2048 ? 4096 + i_5_ : i_5_;
					i_5_ = i_5_ > 2048 ? i_5_ - 4096 : i_5_;
					int i_6_ = (-670406741
							* ((Class298_Sub32_Sub38) this).anInt9561 + i_3_);
					i_6_ = i_6_ < -2048 ? 4096 + i_6_ : i_6_;
					i_6_ = i_6_ > 2048 ? i_6_ - 4096 : i_6_;
					int i_7_ = i_1_
							+ (((Class298_Sub32_Sub38) this).anInt9565 * 939068299);
					i_7_ = i_7_ < -2048 ? 4096 + i_7_ : i_7_;
					i_7_ = i_7_ > 2048 ? i_7_ - 4096 : i_7_;
					is[i_2_] = (method3380(i_4_, i_5_, 1631373907) || method3379(
							i_6_, i_7_, 689077390)) ? 4096 : 0;
				}
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aie.i(").append(')').toString());
		}
	}
	...
	boolean method3379(int i, int i_8_, int i_9_) {
		try {
			...
			i_11_ = (i_11_ << 12)
					/ (((Class298_Sub32_Sub38) this).anInt9563 * -1052090709);
			i_11_ = (i_11_ << 12)
					/ (454265253 * ((Class298_Sub32_Sub38) this).anInt9564);
			i_11_ = i_11_
					* (679642301 * ((Class298_Sub32_Sub38) this).anInt9560) >> 12;
			return i_8_ - i < i_11_ && i_8_ - i > -i_11_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aie.am(").append(')').toString());
		}
	}
	...
	boolean method3380(int i, int i_12_, int i_13_) {
		try {
			int i_14_ = ((i_12_ - i)
					* (-1052090709 * ((Class298_Sub32_Sub38) this).anInt9563) >> 12);
			int i_15_ = Class250.anIntArray2763[255 * i_14_ >> 12 & 0xff];
			i_15_ = (i_15_ << 12)
					/ (-1052090709 * ((Class298_Sub32_Sub38) this).anInt9563);
			i_15_ = (i_15_ << 12)
					/ (454265253 * ((Class298_Sub32_Sub38) this).anInt9564);
			i_15_ = i_15_
					* (((Class298_Sub32_Sub38) this).anInt9560 * 679642301) >> 12;
			return i + i_12_ < i_15_ && i + i_12_ > -i_15_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aie.ac(").append(')').toString());
		}
	}
	...
	int[] method3381(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_17_ = 0; i_17_ < Class250.anInt2755 * -1474554145; i_17_++) {
				...
				int i_19_ = (((Class298_Sub32_Sub38) this).anInt9562
						* -1801516933 + i_18_);
				...
				int i_21_ = (-670406741
						* ((Class298_Sub32_Sub38) this).anInt9561 + i_18_);
				...
				is[i_17_] = (method3380(i_19_, i_20_, 838244364) || method3379(
						i_21_, i_22_, 424769104)) ? 4096 : 0;
			}
		}
		return is;
	}
	...
	void method3384(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 5:
			((Class298_Sub32_Sub38) this).anInt9560 = class298_sub53
					.readUnsignedShort()
					* -1402300779;
			break;
		case 0:
			((Class298_Sub32_Sub38) this).anInt9562 = class298_sub53
					.readUnsignedShort()
					* -2115004749;
			break;
		case 3:
			((Class298_Sub32_Sub38) this).anInt9565 = class298_sub53
					.readUnsignedShort()
					* -1141390301;
			break;
		case 2:
			((Class298_Sub32_Sub38) this).anInt9561 = class298_sub53
					.readUnsignedShort()
					* -871015677;
			break;
		case 6:
			((Class298_Sub32_Sub38) this).anInt9564 = class298_sub53
					.readUnsignedShort() * 233322029;
			break;
		case 4:
			((Class298_Sub32_Sub38) this).anInt9563 = class298_sub53
					.readUnsignedShort() * 1435675651;
			break;
		case 1:
			((Class298_Sub32_Sub38) this).anInt9559 = class298_sub53
					.readUnsignedShort()
					* -925420187;
			break;
		}
	...
	int[] method3386(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_25_ = 0; i_25_ < Class250.anInt2755 * -1474554145; i_25_++) {
				...
				int i_27_ = (((Class298_Sub32_Sub38) this).anInt9562
						* -1801516933 + i_26_);
				...
				int i_29_ = (-670406741
						* ((Class298_Sub32_Sub38) this).anInt9561 + i_26_);
				...
				is[i_25_] = (method3380(i_27_, i_28_, -630514594) || method3379(
						i_29_, i_30_, -716173681)) ? 4096 : 0;
			}
		}
		return is;
	}
	...
	public static int method3387(int i, int i_31_, int i_32_, int i_33_) {
		try {
			int i_34_ = 255 - i_32_;
			i_31_ = (i_32_ * (i_31_ & 0xff00ff) & ~0xff00ff | i_32_
					* (i_31_ & 0xff00) & 0xff0000) >>> 8;
			return i_31_
					+ (((i & 0xff00ff) * i_34_ & ~0xff00ff | (i & 0xff00)
							* i_34_ & 0xff0000) >>> 8);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aie.u(").append(')').toString());
		}
	}
}
