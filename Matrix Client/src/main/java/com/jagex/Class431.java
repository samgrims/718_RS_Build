...
public class Class431 implements Interface15 {
	...
	public Object method215(int[] is, int i, int i_0_, int i_1_, int i_2_,
			boolean bool) {
		return ((Class431) this).aClass_ra6503.method5030(is, i, i_0_, i_1_,
				i_2_, false);
	}

	public Object method212(int[] is, int i, int i_3_, int i_4_, int i_5_,
			boolean bool) {
		return ((Class431) this).aClass_ra6503.method5030(is, i, i_3_, i_4_,
				i_5_, false);
	}

	public Object method214(int[] is, int i, int i_6_, int i_7_, int i_8_,
			boolean bool, int i_9_) {
		try {
			return ((Class431) this).aClass_ra6503.method5030(is, i, i_6_,
					i_7_, i_8_, false);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rv.a(").append(')').toString());
		}
	}

	public Object method213(int[] is, int i, int i_10_, int i_11_, int i_12_,
			boolean bool) {
		return ((Class431) this).aClass_ra6503.method5030(is, i, i_10_, i_11_,
				i_12_, false);
	}
	...
	static void method5766(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rv.ae(").append(')').toString());
		}
	}

	public static void method5767(int i, Class243 class243, int i_18_,
			int i_19_, int i_20_, boolean bool, int i_21_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rv.r(").append(')').toString());
		}
	}

	public static void method5768(
			Entity class365_sub1_sub1_sub2, int[] is, int i,
			boolean bool, byte i_22_) {
		try {
			...
			for (int i_27_ = 0; i_27_ < is.length; i_27_++) {
				if (is[i_27_] != -1)
					bool_26_ = false;
				if (null == class365_sub1_sub1_sub2.anIntArray10093
						|| -1 == class365_sub1_sub1_sub2.anIntArray10093[i_27_]
						|| ((Class501.aClass395_6122.method4903(is[i_27_],
								(byte) -62).anInt4178)
								* -1445588039 >= (Class501.aClass395_6122
								.method4903(
										class365_sub1_sub1_sub2.anIntArray10093[i_27_],
										(byte) -47).anInt4178)
								* -1445588039)) {
					class365_sub1_sub1_sub2.anIntArray10093 = is;
					class365_sub1_sub1_sub2.aClass438_10078.method5828(i,
							-1445580533);
					if (bool)
			...
			if (bool_26_) {
				...
				class365_sub1_sub1_sub2.aClass438_10078.method5828(i,
						-1445580533);
				if (bool)
					class365_sub1_sub1_sub2.anInt10125 = -526956429
							* class365_sub1_sub1_sub2.anInt10120;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rv.ke(").append(')').toString());
		}
	}
}
