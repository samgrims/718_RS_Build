...
final class Class97_Sub1 extends Class97 {
	...
	public static final void method1043(int moveLocalX, int moveLocalY, int moveZ, int speed2,
			int speed1, boolean bool) {
		try {
			...
			if (bool && Class21.anInt276 * 1534163843 >= 100) {
				...
				Class110.anInt6403 = (Class356.method4271(-1740717447
						* Class367.anInt4000, Class146.anInt1575 * -299812095,
						1855729883 * Class99.anInt952, -2087363822) - -1439836243
	...
	public static void method1044(Class298 class298, Class298 class298_5_, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yz.b(").append(')').toString());
		}
	}

	static Class298_Sub37_Sub12 method1045(byte i) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = ((Class298_Sub37_Sub12) Class298_Sub37_Sub12.aClass461_9638
					.method5984(1993015786));
			...
			do {
				class298_sub37_sub12 = (Class298_Sub37_Sub12) Class298_Sub37_Sub12.aClass461_9607
						.method5984(-962629622);
				if (class298_sub37_sub12 == null)
					return null;
