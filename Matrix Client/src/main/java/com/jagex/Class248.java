...
public class Class248 implements Runnable {
	...
	void method2382(byte i) {
		try {
			...
			synchronized (((Class248) this).aLinkedList2750) {
				...
				class267 = (Class267) ((Class248) this).aLinkedList2750
						.pollFirst();
			}
			do {
				try {
	...
	void method2383(Class267 class267, int i) {
		try {
			if (Class266.aClass266_2852 == ((Class267) class267).aClass266_2857)
				...
				((Class248) this).aClass283_2751.sendMapScene(class267,
						-1991819579);
			for (boolean bool = ((Class248) this).aClass283_2751
					.method2672(-1688450979); !bool; bool = ((Class248) this).aClass283_2751
					.method2672(-770547477)) {
				/* empty */
			}
	...
	static final void method2386(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2068,
					client.aClass25_8693.aClass449_330, (byte) 47);
			class298_sub36.out.writeShort((Class58
					.method693(string, -250227687) + Class58.method693(
					string_1_, -433489347)), 16711935);
			class298_sub36.out.writeString(string,
					2110683902);
			class298_sub36.out.writeString(string_1_,
					2142092723);
			client.aClass25_8693.method390(class298_sub36, (byte) -123);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kj.vq(").append(')').toString());
		}
	}
	...
	static void method2389(GraphicsToolkit class_ra, Class_ta class_ta,
			IComponentDefinition class105, int i, int i_6_, int i_7_, int i_8_, int i_9_,
			byte i_10_) {
		try {
			Class352 class352 = Class363.aClass339_3931.method4116(i_9_,
					-405562208);
			if (class352 != null && class352.aBoolean3780
					&& class352.method4237(Class128.aClass148_6331, 1844230404)) {
				if (class352.anIntArray3803 != null) {
					...
					for (int i_11_ = 0; i_11_ < is.length / 2; i_11_++) {
						...
						if (Class298_Sub1.anInt7164 * -863531439 != 2) {
							i_13_ = 256 * i_13_
									/ (client.anInt8749 * 356727603 + 256);
					...
					Class117 class117 = class105
							.method1116(class_ra, 973176237);
					if (null != class117)
						Class81.method858(class_ra, is, class352.anInt3808
								* -248291889, class117.anIntArray1396,
								class117.anIntArray1395);
					if (class352.anInt3806 * -972644285 > 0) {
						for (int i_15_ = 0; i_15_ < is.length / 2 - 1; i_15_++) {
							...
							class_ra
									.method5007(
											...
											i_18_,
											i_19_,
											(class352.anIntArray3814[class352.aByteArray3777[i_15_] & 0xff]),
											1, class_ta, i, i_6_,
											class352.anInt3806 * -972644285,
											class352.anInt3799 * 2123190239,
											-176015499 * class352.anInt3788);
						}
						...
						class_ra
								.method5007(
										...
										1, class_ta, i, i_6_, -972644285
												* class352.anInt3806,
										2123190239 * class352.anInt3799,
						...
						for (int i_30_ = 0; i_30_ < is.length / 2 - 1; i_30_++)
							class_ra
									.method5022(
											...
											is[(i_30_ + 1) * 2],
											is[1 + 2 * (1 + i_30_)],
											(class352.anIntArray3814[(class352.aByteArray3777[i_30_]) & 0xff]),
											1, class_ta, i, i_6_);
						class_ra
								.method5022(
										is[is.length - 2],
				...
				if (-1 != class352.anInt3785 * 715019623) {
					...
					if (null != class57)
						Class443.method5883(class105, class_ta, i, i_6_, i_7_,
								i_8_, class57, (byte) -86);
				}
				if (class352.aString3792 != null) {
					...
					Class358.method4290(class105, class_ta, i, i_6_, i_7_,
							i_8_, i_31_, class352.aString3792, class264,
							class505, -1836991893 * class352.anInt3781,
							1768300509);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kj.z(").append(')').toString());
		}
	}
}
