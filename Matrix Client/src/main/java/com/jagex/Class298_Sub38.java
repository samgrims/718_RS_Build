...
public final class Class298_Sub38 extends Class298 {
	...
	static final void method3499(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1289394455
					* Class301_Sub1.anInt7624 == 100 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abw.aei(").append(')').toString());
		}
	}
	...
	public static final void method3502(String string, int i, int i_3_) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.CHANGE_FRIEND_CHAT_PACKET, class25.aClass449_330, (byte) 82);
			class298_sub36.out.writeByte(1 + Class58
					.method693(string, 986937694));
