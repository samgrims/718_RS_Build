...
public class Class128_Sub2 extends Class128 {
	...
	Class128_Sub2(Class139 class139, Class133 class133, int i, int i_0_,
		...
		try {
			...
			for (int i_8_ = objects.length - 1; i_8_ >= 1; i_8_--) {
				if (string.charAt(i_8_ - 1) == 's')
					objects[i_8_] = (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751)
							* -203050393]);
				else if (string.charAt(i_8_ - 1) == '\u00a7')
					objects[i_8_] = new Long(
							((Class403) class403).aLongArray5251[(((Class403) class403).anInt5245 -= -682569305) * 1685767703]);
				else
					objects[i_8_] = new Integer(
