...
public class Class216 implements Interface24 {
	...
	public int method256(int i) {
		try {
			if (((Class216) this).aClass243_6656.method2312(
					((Class216) this).aString6655, -2147290732))
				return 100;
			return ((Class216) this).aClass243_6656.method2305(
					((Class216) this).aString6655, -1986969413);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jc.a(").append(')').toString());
		}
	}
	...
	public int method258() {
		if (((Class216) this).aClass243_6656.method2312(
				((Class216) this).aString6655, -2133628727))
			return 100;
		return ((Class216) this).aClass243_6656.method2305(
				((Class216) this).aString6655, -162075659);
	}
		...
		try {
			...
			try {
				...
				throw new RuntimeException(new StringBuilder().append(
						exception.getMessage()).append(" ").append(i)
						.toString());
			}
	...
	static final void method1997(Class403 class403, int i) {
		try {
			...
			Class102 class102 = Class298_Sub40_Sub13.method3517(i_1_,
					-500483592);
			String string = "";
	...
	static String method1999(int[] is, byte i) {
		try {
			...
			for (int i_3_ = 0; i_3_ < is.length; i_3_++) {
				Class369 class369 = Class316.aClass362_3318.method4307(
						is[i_3_], 245040087);
				if (class369.anInt4028 * 347977109 == -1) {
					if (i != 1)
						throw new IllegalStateException();
				} else {
					Class57 class57 = ((Class57) (Class436.aClass348_5500
							.method4184((long) (347977109 * class369.anInt4028))));
					if (class57 == null) {
						IndexedImage class89 = IndexedImage.method987(
								Class158.idx8,
								class369.anInt4028 * 347977109, 0);
						if (class89 != null) {
							class57 = Class373.aClass_ra4071.method5125(
									class89, true);
							Class436.aClass348_5500.method4194(class57,
									(long) (class369.anInt4028 * 347977109));
						}
					}
					if (null != class57) {
	...
	static void method2002(int i, int i_6_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jc.s(").append(')').toString());
		}
	}

	static final void method2003(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class287.myPlayer.aClass386_10084
					.method4719((byte) 0) >> 3;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jc.uc(").append(')').toString());
		}
	}
}
