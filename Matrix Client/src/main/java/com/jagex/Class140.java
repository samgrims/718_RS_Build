...
public class Class140 implements Runnable {
	...
	Class142 method1552(int i, int i_0_) {
		try {
			if (((Class140) this).aClass142Array1550 == null || i < 0
					|| i >= ((Class140) this).aClass142Array1550.length)
				return null;
			return ((Class140) this).aClass142Array1550[i];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fr.a(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			try {
				int i = (Class401.aClass401_6557 == Class242.aClass401_2708 ? 80
						: (1606920449 * Class474.aClass471_5976.worldId + 7000));
								...
								new DataInputStream(
										new URL(
												new StringBuilder()
														.append("http://")
														.append(
																Class474.aClass471_5976.address)
														.append(":")
														.append(i)
														.append(
																"/news.ws?game=")
														.append(
																-937307905
																		* (client.aClass411_8944.gameType))
														.toString())
												.openStream()))));
				...
				for (int i_1_ = 0; i_1_ < strings.length; i_1_ += 3)
					((Class140) this).aClass142Array1550[i_1_ / 3] = new Class142(
							strings[i_1_], strings[i_1_ + 1], strings[2 + i_1_]);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fr.run(").append(')').toString());
		}
	}

	public static Class190 method1554(int i, int i_2_) {
		try {
			Class190 class190 = (Class190) Class190.aClass348_1929
					.method4184((long) i);
			if (class190 != null)
				return class190;
			...
			if (Class436.anInt5506 * -278777595 < 410) {
				...
				if (class503.aBoolean6163) {
					if (1817570317 * class365_sub1_sub1_sub2_sub1.anInt10189 != 0) {
						String string_3_ = (client.aClass411_8944 == Class411.aClass411_5316 ? (Tradution.aClass470_5928
								.method6049(Class321.aClass429_3357, -875414210))
								: (Tradution.aClass470_5911.method6049(
						...
						string = new StringBuilder()
								...
								.append(
										Class18
												.method358(
														1817570317 * (class365_sub1_sub1_sub2_sub1.anInt10189),
														(Class287.myPlayer.anInt10206) * 696798311,
														(byte) 4))
								.append(Class26.aString349)
								.append(string_3_)
								.append(
										1817570317 * class365_sub1_sub1_sub2_sub1.anInt10189)
								.append(Class26.aString352).toString();
					}
					if (client.aBoolean8835 && !bool) {
						Class497 class497 = (831522399 * Class132.anInt1508 != -1 ? (Class92.aClass504_905
								.method6251(831522399 * Class132.anInt1508,
										1875400558))
								: null);
						if ((Class298.anInt3192 * -112110875 & 0x2) != 0
								&& (null == class497 || (class503.method6239(
										(Class132.anInt1508 * 831522399),
										(-388931549 * class497.anInt6100),
										(byte) 47) != class497.anInt6100
										* -388931549)))
							Class234
									.method2174(
											client.aString8838,
											new StringBuilder().append(
													client.aString8754).append(
													" ").append(
											...
											8,
											-1,
											(long) (1888274983 * (class365_sub1_sub1_sub2_sub1.anInt10064)),
											0,
											0,
											true,
											false,
					...
					if (!bool) {
						...
						if (null != strings) {
							for (int i_4_ = strings.length - 1; i_4_ >= 0; i_4_--) {
								if (strings[i_4_] != null
										&& (0 == class503.aByte6158 || (!(strings[i_4_]
												.equalsIgnoreCase(Tradution.aClass470_5906
														.method6049(
																Class321.aClass429_3357,
																-875414210))) && !(strings[i_4_]
												.equalsIgnoreCase(Tradution.aClass470_5905
														.method6049(
																Class321.aClass429_3357,
																-875414210)))))) {
									int i_5_ = 0;
									...
									Class234
											.method2174(
													...
													i_5_,
													-1,
													(long) ((class365_sub1_sub1_sub2_sub1.anInt10064) * 1888274983),
													0,
													0,
													true,
													false,
	...
	public static byte[] method1557(String string, byte i) {
		try {
			...
			int i_14_ = i_13_ / 4 * 3;
			if (i_13_ - 2 >= i_12_
					|| (Class163.method1773(string.charAt(i_13_ - 2),
							1186467127) == -1))
				i_14_ -= 2;
			else if (i_13_ - 1 >= i_12_
					|| Class163
							.method1773(string.charAt(i_13_ - 1), 1292628022) == -1)
				i_14_--;
	...
	public static IComponentDefinition method1558(int i, int i_15_, int i_16_) {
		try {
			...
			if (-1 == i_15_)
				return class105;
			if (class105 == null || class105.aClass105Array1292 == null
					|| i_15_ >= class105.aClass105Array1292.length)
				return null;
			return class105.aClass105Array1292[i_15_];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fr.p(").append(')').toString());
		}
	}

	static final boolean method1559(Class433 class433, int i, int i_17_,
			byte i_18_) {
		try {
