...
public class Class405 {
	...
	public Class405(Class243 class243) {
		byte[] is = class243.method2294(
				(-363169051 * Class380.aClass380_4105.anInt4108), (byte) 105);
			...
			for (;;) {
				...
				if (1 == i_0_) {
					...
					for (/**/; i_2_ < anIntArray5267.length; i_2_++) {
						anIntArray5267[i_2_] = class298_sub53
								.readUnsignedByte();
					...
					anInt5266 = class298_sub53.readUnsignedByte()
							* -636252365;
				else if (4 == i_0_)
					anInt5270 = class298_sub53.readUnsignedByte()
							* -78914705;
				else if (5 == i_0_) {
					anIntArray5272 = new int[class298_sub53
							.readUnsignedByte()];
					for (int i_3_ = 0; i_3_ < anIntArray5272.length; i_3_++)
						anIntArray5272[i_3_] = class298_sub53
								.readUnsignedByte();
				} else if (6 == i_0_) {
					anIntArray5273 = new int[class298_sub53
							.readUnsignedByte()];
					for (int i_4_ = 0; i_4_ < anIntArray5273.length; i_4_++)
						anIntArray5273[i_4_] = class298_sub53
								.readUnsignedByte();
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qv.a(").append(')').toString());
		}
	}

	static final void method4956(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8802 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qv.uq(").append(')').toString());
		}
	}
		...
		try {
			if (null != ((Class297) class297).aClass298_Sub19_Sub2_3184)
				Class285.aClass298_Sub19_Sub4_3083
						.method3048(((Class297) class297).aClass298_Sub19_Sub2_3184);
			else
				((Class297) class297).anInt3177 = -2147483648;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qv.j(").append(')').toString());
		}
	}

	static final void method4958(int i) {
		try {
			Class152.method1652(Class373.aClass_ra4071,
		...
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318
					.method4307(
							...
							245040087).anInt4006) * 1327747841;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qv.r(").append(')').toString());
		}
	}
}
