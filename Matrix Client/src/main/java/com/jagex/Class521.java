	...
	static final void method6322(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vz.ahh(").append(')').toString());
		}
	}

	public static Class146[] method6323(int i) {
		try {
			return (new Class146[] { Class146.aClass146_1569,
					Class146.aClass146_1565, Class146.aClass146_1566,
					Class146.aClass146_1567, Class146.aClass146_1568,
					Class146.aClass146_1572, Class146.aClass146_1573,
					Class146.aClass146_1564, Class146.aClass146_1570,
					Class146.aClass146_1571 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vz.a(").append(')').toString());
		}
	}
}
