...
public class Class133 {
	...
	public int method1482(int i, int i_0_, int i_1_) {
		try {
			int i_2_ = (Class298_Sub40_Sub9.anInt9716 * -1111710645 > i_0_ ? -1111710645
