...
public class Class298_Sub32_Sub2 extends Class298_Sub32 {
	...
	final void method3143(int[][] is, byte i) {
		try {
			...
			Class463.method6009(0, 0, Class250.anInt2753 * -901777799,
					Class250.anInt2758 * -289063255, -252258015);
		...
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_11_ = 0; i_11_ < 461985445 * Class250.anInt2756; i_11_++) {
					...
					int[] is_15_ = is_13_[1];
					int[] is_16_ = is_13_[2];
					for (int i_17_ = 0; i_17_ < Class250.anInt2755
							* -1474554145; i_17_++) {
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_19_) {
		try {
			if (0 == i) {
				((Class298_Sub32_Sub2) this).aClass98Array9321 = new Class98[class298_sub53
						.readUnsignedByte()];
				for (int i_20_ = 0; (i_20_ < ((Class298_Sub32_Sub2) this).aClass98Array9321.length); i_20_++) {
					int i_21_ = class298_sub53.readUnsignedByte();
					switch (i_21_) {
					case 0:
						((Class298_Sub32_Sub2) this).aClass98Array9321[i_20_] = Class298_Sub37
								.method3405(class298_sub53, -920913322);
						break;
					case 3:
						((Class298_Sub32_Sub2) this).aClass98Array9321[i_20_] = Class7
								.method313(class298_sub53, 2061944382);
						break;
					case 1:
						((Class298_Sub32_Sub2) this).aClass98Array9321[i_20_] = SubIncommingPacket
								.method1922(class298_sub53, -1403634291);
						break;
					case 2:
						((Class298_Sub32_Sub2) this).aClass98Array9321[i_20_] = Class68
								.method783(class298_sub53, 505653408);
						break;
					}
				}
			} else if (i == 1)
	...
	void method3146(int i, RsByteBuffer class298_sub53) {
		if (0 == i) {
			...
			for (int i_22_ = 0; i_22_ < ((Class298_Sub32_Sub2) this).aClass98Array9321.length; i_22_++) {
				...
				switch (i_23_) {
				case 0:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_22_] = Class298_Sub37
							.method3405(class298_sub53, -205247731);
					break;
				case 3:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_22_] = Class7
							.method313(class298_sub53, -291977486);
					break;
				case 1:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_22_] = SubIncommingPacket
							.method1922(class298_sub53, -1904035175);
					break;
				case 2:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_22_] = Class68
							.method783(class298_sub53, 634970133);
					break;
				}
			}
		} else if (i == 1)
	...
	void method3147(int i, RsByteBuffer class298_sub53) {
		if (0 == i) {
			...
			for (int i_24_ = 0; i_24_ < ((Class298_Sub32_Sub2) this).aClass98Array9321.length; i_24_++) {
				...
				switch (i_25_) {
				case 0:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_24_] = Class298_Sub37
							.method3405(class298_sub53, 492697170);
					break;
				case 3:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_24_] = Class7
							.method313(class298_sub53, -646790238);
					break;
				case 1:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_24_] = SubIncommingPacket
							.method1922(class298_sub53, 388197853);
					break;
				case 2:
					((Class298_Sub32_Sub2) this).aClass98Array9321[i_24_] = Class68
							.method783(class298_sub53, 892412290);
					break;
				}
			}
		} else if (i == 1)
