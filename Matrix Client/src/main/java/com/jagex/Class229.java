...
public class Class229 implements Interface12 {
	...
	static byte[] aByteArray6457 = { 31, -117, 8, 0, 0, 0, 0, 0, 0, 0, -5, 127,
	...
	public void method160(boolean bool, int i) {
		try {
			...
			for (int i_2_ = 0; i_2_ < interface6s.length; i_2_++) {
				...
				if (interface6 != null)
					interface6.method58(bool || ((Class229) this).aBoolean6450,
							(byte) -77);
			}
			((Class229) this).aBoolean6450 = false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jr.b(").append(')').toString());
		}
	}
	...
	public void method149(short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jr.k(").append(')').toString());
		}
	}

	public boolean method153(long l) {
		try {
			return (Class122.method1319((byte) 1) >= l
					+ (long) (((Class229) this).anInt6454 * -568263897));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jr.x(").append(')').toString());
		}
	}
	...
	Class229(Class509 class509, int i, int i_7_, Class143 class143) {
		...
		for (int i_8_ = 0; i_8_ < ((Class229) this).anInterface6Array6453.length; i_8_++)
			((Class229) this).anInterface6Array6453[i_8_] = class143
					.method1572(
							(((Class229) this).aClass509_6451.anInterface5Array6217[i_8_]),
							(byte) 86);
	}
	...
	static Class302_Sub5 method2122(byte i) {
		try {
			Class302_Sub5 class302_sub5 = ((Class302_Sub5) Class302_Sub5.aClass442_7661
					.method5871((byte) 3));
			...
			synchronized (Class385.aClient4141) {
				if (null != Class231.aFrame2589) {
					...
					if (container == null) {
						...
						client.anInt6472 = container.getSize().height
								* -2115832951;
						if (Class298_Sub36.aFrame7403 == container) {
							...
							client.anInt6472 -= (insets.bottom + insets.top)
									* -2115832951;
						}
						...
						if (container == Class298_Sub36.aFrame7403) {
							Insets insets = Class298_Sub36.aFrame7403
									.getInsets();
							Class52_Sub2_Sub1.aCanvas9079
									.setLocation(insets.left + client.anInt6473
											* 1898544019, client.anInt6474
											* 540368727 + insets.top);
						} else
							Class52_Sub2_Sub1.aCanvas9079.setLocation(
									client.anInt6473 * 1898544019,
