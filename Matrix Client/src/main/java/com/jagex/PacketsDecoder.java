		...
		try {
			...
			if (null == ((Class25) class25).INCOMMING_PACKET) {
				if (((Class25) class25).aBoolean337) {
					...
					class318
							.readBytes(
									(((Class25) class25).aClass298_Sub53_Sub2_333.buffer),
									0, 1, (byte) 1);
				...
				if (i_78_ < 0 || i_78_ >= class202s.length)
					throw new IOException(new StringBuilder().append(i_78_)
							.append(" ").append(
									385051775 * stream.index)
							.toString());
				((Class25) class25).INCOMMING_PACKET = class202s[i_78_];
				((Class25) class25).anInt336 = ((Class25) class25).INCOMMING_PACKET.anInt2165
						* -80186869;
			}
			if (-1 == -866602563 * ((Class25) class25).anInt336) {
				if (!class318.isAvailable(1, (byte) -5))
					return false;
				class318.readBytes(stream.buffer, 0, 1,
						(byte) 48);
			...
			if (-2 == -866602563 * ((Class25) class25).anInt336) {
				if (!class318.isAvailable(2, (byte) 9))
					return false;
				class318.readBytes(stream.buffer, 0, 2,
						(byte) -84);
				stream.index = 0;
				((Class25) class25).anInt336 = stream
						.readUnsignedShort()
						* -1265692267;
			...
			if (-866602563 * ((Class25) class25).anInt336 > 0) {
				if (!class318
						.isAvailable(
								(-866602563 * ((Class25) class25).anInt336),
								(byte) -53))
					return false;
				stream.index = 0;
				class318.readBytes(stream.buffer, 0,
						-866602563 * ((Class25) class25).anInt336, (byte) 117);
			...
			if (IncommingPacket.MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_80_ == 99)
					...
					if (!string_83_.equals("")
							&& Class287.method2722(string_83_, -1821123802)) {
						((Class25) class25).INCOMMING_PACKET = null;
						return true;
					}
					Class242_Sub1.method2282(i_80_, i_81_, string, string_83_,
							string, string_84_, -1468983571);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.MODEL_ON_ICOMPONENT_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(interfaceHash, 2, modelId, -1, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2277 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(interfaceHash, 3, i_88_, i_89_, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.GRAPHICS_PACKET) {
				...
				if (targetHash >> 30 != 0) {
					...
					int i_102_ = ((targetHash >> 14 & 0x3fff) - -1760580017
							* class341.gameSceneBaseX);
					int i_103_ = (targetHash & 0x3fff) - 283514611
							* class341.gameSceneBaseY;
					if (i_102_ >= 0
							&& i_103_ >= 0
							&& (i_102_ < client.aClass283_8716
									.method2629(-1990296889))
							&& (i_103_ < client.aClass283_8716
						...
						if (graphicsId == -1) {
							...
							if (i_106_ < 3
									&& (client.aClass283_8716
											.method2654(651162634).method2320(
											i_102_, i_103_, -2025869337)))
								i_106_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(
									client.aClass283_8716
											.method2675(-1611682495), graphicsId,
									speed, i_101_, i_106_, i_104_, Class356
											.method4271(i_104_, i_105_, i_101_,
													-1215922012)
					...
					if (null != class298_sub29) {
						...
						if (-1 != graphicsId && i_109_ != -1) {
							if (graphicsId == i_109_) {
								Class398 class398 = Class158_Sub1.aClass389_8568
										.method4857(graphicsId, -2138799623);
								if (class398.aBoolean5215
										&& -1 != class398.anInt5205 * 1505778629) {
									Class391 class391 = (Class501.aClass395_6122
											.method4903(
													class398.anInt5205 * 1505778629,
													(byte) -71));
									int i_110_ = class391.anInt4184
											* -1117238071;
								...
								Class398 class398 = Class158_Sub1.aClass389_8568
										.method4857(graphicsId, -1997923010);
								Class398 class398_111_ = Class158_Sub1.aClass389_8568
										.method4857(i_109_, -1881939747);
								if (class398.anInt5205 * 1505778629 != -1
										&& (class398_111_.anInt5205 * 1505778629 != -1)) {
									Class391 class391 = (Class501.aClass395_6122
											.method4903(
													class398.anInt5205 * 1505778629,
													(byte) 83));
									Class391 class391_112_ = (Class501.aClass395_6122
											.method4903(
													(1505778629 * class398_111_.anInt5205),
													(byte) -25));
						...
						if (bool_108_) {
							...
							if (-1 != graphicsId) {
								Class398 class398 = Class158_Sub1.aClass389_8568
										.method4857(graphicsId, -1696520605);
								int i_113_ = class398.aBoolean5215 ? 0 : 2;
								if (bool)
									i_113_ = 1;
								class56.aClass438_569.method5824(
					...
					if (class365_sub1_sub1_sub2_sub2 != null) {
						...
						if (graphicsId != -1 && -1 != i_116_) {
							if (graphicsId == i_116_) {
								Class398 class398 = Class158_Sub1.aClass389_8568
										.method4857(graphicsId, -1990411818);
								if (class398.aBoolean5215
								...
								Class398 class398 = Class158_Sub1.aClass389_8568
										.method4857(graphicsId, -1975194771);
								Class398 class398_118_ = Class158_Sub1.aClass389_8568
										.method4857(i_116_, -1893234855);
								if (-1 != class398.anInt5205 * 1505778629
										&& -1 != (1505778629 * class398_118_.anInt5205)) {
									Class391 class391 = (Class501.aClass395_6122
											.method4903(
													1505778629 * class398.anInt5205,
													(byte) -1));
									Class391 class391_119_ = (Class501.aClass395_6122
											.method4903(
													(class398_118_.anInt5205 * 1505778629),
													(byte) -13));
						...
						if (bool_115_) {
							...
							if (graphicsId != -1) {
								Class398 class398 = Class158_Sub1.aClass389_8568
										.method4857(graphicsId, -2053481236);
			...
			if (IncommingPacket.aClass202_2273 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class341 class341 = new Class341(stream
						.readInt((byte) -80));
				...
				Class113.method1254(i_128_,
						new Class298_Sub51_Sub3(i_129_, i_122_, new Class409(
								class341, i_126_, i_127_, i_124_)), new int[] {
								i_131_, i_121_, i_123_, i_130_ }, false,
						1266119011);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.PRIVATE_GAME_BAR_STAGE_PACKET) {
				Class110.aClass459_6404 = Class275.method2571(
						stream.readUnsignedByte(), 413652738);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2199 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (bool_139_) {
					...
					for (i_141_ = 0; i_141_ < Class489.anInt6071 * -1801543887; i_141_++) {
						if (Class82_Sub6.aClass7Array6846[i_141_].aString93
								.equals(string_136_)
								&& (Class82_Sub6.aClass7Array6846[i_141_].anInt95 * -1071570519) == i_137_) {
							if (i <= -1128197512)
					...
					if (i_141_ < -1801543887 * Class489.anInt6071) {
						for (/**/; i_141_ < -1801543887 * Class489.anInt6071
								- 1; i_141_++)
					...
					String string_142_ = stream
							.readString(-1357066804);
					Class7 class7 = new Class7();
					class7.aString92 = string;
					class7.aString93 = string_136_;
					((Class7) class7).aString94 = Class173.method1824(
							class7.aString93, -514633017);
					...
					for (i_143_ = -1801543887 * Class489.anInt6071 - 1; i_143_ >= 0; i_143_--) {
						int i_144_ = ((Class7) Class82_Sub6.aClass7Array6846[i_143_]).aString94
								.compareTo(((Class7) class7).aString94);
						if (0 == i_144_) {
							Class82_Sub6.aClass7Array6846[i_143_].anInt95 = -129166695
									* i_137_;
							Class82_Sub6.aClass7Array6846[i_143_].aByte97 = i_138_;
							Class82_Sub6.aClass7Array6846[i_143_].aString96 = string_142_;
							if (string_136_
									.equals(Class287.myPlayer.aString10195))
			...
			if (IncommingPacket.SYSTEM_UPDATE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				if (Class299.method3682(client.anInt8752 * -1233866115,
						1765230881))
					client.anInt8669 = (int) ((float) stream
							.readUnsignedShort() * 2.5F)
							* -2090750423;
				else
					client.anInt8669 = (stream
							.readUnsignedShort() * 1701996750);
				client.anInt8888 = client.anInt8933 * 1991119277;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2245) {
				...
				if (bool)
					Class350.aClass298_Sub25_3757 = new Class298_Sub25(
							stream);
				else
					Class375.aClass298_Sub25_4084 = new Class298_Sub25(
							stream);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2184 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class320.method3913(soundId, i_149_, i_150_, i_151_, false,
						i_152_, 1571464629);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2307 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (bool != Class525.aBoolean6300
						|| i_153_ != Class100.anInt1079 * -1537941929) {
					Class525.aBoolean6300 = bool;
					Class100.anInt1079 = i_153_ * -442700441;
					Class126.method1405(Class502.aClass502_6725, -1, -1,
							-387034642);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (IncommingPacket.ICOMPONENT_MODEL_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(i_155_, 1, i_154_, -1, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2236) {
				...
				if (null != client.aClass299Array8671[i_156_]) {
					client.aClass299Array8671[i_156_].method3677(
							client.aClass283_8716.method2675(-1611682495),
							-1127737066);
					client.aClass299Array8671[i_156_] = null;
				}
				if (i_157_ != -1) {
					client.aClass299Array8671[i_156_] = new Class299(
							Class373.aClass_ra4071, stream, i_157_);
					client.aClass299Array8671[i_156_].method3676(
							client.aClass283_8716.method2675(-1611682495),
							2021897283);
				}
				((Class25) class25).INCOMMING_PACKET = null;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2177) {
				...
				if (stream.method3615((byte) 83))
					Class249.method2391(stream,
							(385051775 * stream.index) - 28,
							(byte) 2);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SET_MOUSE_PACKET) {
				Class82_Sub6.aString6845 = (-866602563
						* ((Class25) class25).anInt336 > 2 ? stream
						.readString(-1124509361)
						: Tradution.aClass470_5854.method6049(
								Class321.aClass429_3357, -875414210));
				client.anInt8822 = ((((Class25) class25).anInt336 * -866602563 > 0 ? stream
						.readUnsignedShort()
						: -1) * 812630591);
			...
			if (IncommingPacket.aClass202_2160 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class113.method1254(i_160_, new Class298_Sub51_Sub4(i_165_,
						i_158_, new Class400(class341, i_162_)), new int[] {
						i_161_, i_159_, i_164_, i_163_ }, false, 518456835);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2153 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Object object = null;
				Class298_Sub25 class298_sub25 = (bool ? Class350.aClass298_Sub25_3757
						: Class375.aClass298_Sub25_4084);
				while_86_: do {
					if (null == class298_sub25)
						...
						if (i_167_ <= 1) {
							if (client.aBoolean8811 && !client.aBoolean8812
									|| client.aBoolean8802)
								bool_169_ = true;
				...
				if (!bool_169_) {
					...
					String string_171_ = (Class248.decryptStringMessage(Class127_Sub1
							.huffManDecryption(stream, 406823150),
							298199531));
					int i_172_ = bool ? 41 : 44;
					if (2 == i_167_ || i_167_ == 3)
						Class25.method393(i_172_, 0, new StringBuilder()
								.append(Class247.method2368(1, -278777595))
								.append(string).toString(), new StringBuilder()
								.append(Class247.method2368(1, -278777595))
								.append(string).toString(), string,
								string_171_, class298_sub25.aString7358, -1,
								1446000206);
					else if (i_167_ == 1)
						Class25.method393(i_172_, 0, new StringBuilder()
								.append(Class247.method2368(0, -278777595))
								.append(string).toString(), new StringBuilder()
								.append(Class247.method2368(0, -278777595))
								.append(string).toString(), string,
								string_171_, class298_sub25.aString7358, -1,
						...
						Class25.method393(i_172_, 0, string, string, string,
								string_171_, class298_sub25.aString7358, -1,
								1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
			...
			if (IncommingPacket.ICOMPONENT_SETTINGS_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				for (int slot = fromSlot; slot <= toSlot; slot++) {
					...
					if (class298_sub38 == null) {
						if (-1 == slot)
							class298_sub38_178_ = new Class298_Sub38(
									settingsHash,
									((Class50.getIComponentDefinitions(icomponentHash, (byte) -34).aClass298_Sub38_1219.anInt7410) * -1133219011));
						else
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SEND_FRIEND_QUICK_CHAT_MESSAGE_PACKET) {
				...
				String string_180_ = Class447.aClass469_5618.method6045(i_179_,
						(short) -5033).method3459(stream,
						-734708119);
				Class25.method393(19, 0, string, string, string, string_180_,
						null, i_179_, 1446000206);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2223 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_181_ == -1) {
					...
					if (i_182_ < 0)
						i_182_ = 0;
					else if (i_182_ >= client.aClass283_8716
							.method2629(-2076483330))
						i_182_ = client.aClass283_8716.method2629(-1922242399);
					i_183_ -= 283514611 * class341.gameSceneBaseY;
					if (i_183_ < 0)
						i_183_ = 0;
					else if (i_183_ >= client.aClass283_8716
							.method2630(-1784447321))
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2274) {
				...
				Class242.method2269(i_186_, i_187_ + (i_188_ << 16),
						-1655835904);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.OBJECT_ANIMATION_PACKET) {
				...
				Tradution.method6055(i_195_, i_196_, i_197_, i_193_, i_191_,
						i_192_, animationId, -1216383524);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.PUBLIC_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (null != class365_sub1_sub1_sub2_sub2.aString10195
						&& null != class365_sub1_sub1_sub2_sub2.aClass366_10209) {
					boolean bool_201_ = false;
					if (rights != 2) {
						if (!bool
								&& (client.aBoolean8811 && !client.aBoolean8812 || client.aBoolean8802))
							bool_201_ = true;
						else if (Class287.method2722(
					...
					if (!bool_201_) {
						...
						if (bool) {
							i_199_ &= 0x7fff;
							Class177 class177 = Class498.method6209(
									stream, (byte) 25);
							i_202_ = -2034569943 * class177.anInt1787;
							string = (class177.aClass298_Sub37_Sub14_1788
									.method3459(stream, -734708119));
						} else
							string = Class248.decryptStringMessage((Class127_Sub1
									.huffManDecryption(stream,
											-1331458039)), -446542687);
						class365_sub1_sub1_sub2_sub2.method4474(string.trim(),
								i_199_ >> 8, i_199_ & 0xff, 1232670584);
						int i_203_;
						if (rights == 1 || 2 == rights)
							...
							i_203_ = bool ? 17 : 2;
						if (rights == 2)
							Class25.method393(i_203_, 0, new StringBuilder()
									.append(Class247.method2368(1, -278777595))
									.append(
									...
									Class247.method2368(1, -278777595)).append(
									class365_sub1_sub1_sub2_sub2.method4475(
											false, (byte) -97)).toString(),
									class365_sub1_sub1_sub2_sub2.aString10200,
									string, null, i_202_, 1446000206);
						else if (rights == 1)
							Class25.method393(i_203_, 0, new StringBuilder()
									.append(Class247.method2368(0, -278777595))
									.append(
											class365_sub1_sub1_sub2_sub2
													.method4470(true,
															-1640003201))
									.toString(), new StringBuilder().append(
									Class247.method2368(0, -278777595)).append(
									class365_sub1_sub1_sub2_sub2.method4475(
											false, (byte) -113)).toString(),
									class365_sub1_sub1_sub2_sub2.aString10200,
									string, null, i_202_, 1446000206);
						else if (rights != 0)
							Class25.method393(i_203_, 0, "<img="+rights+">"+
									class365_sub1_sub1_sub2_sub2.method4470(
											true, -1755073777),
											 "<img="+rights+">"+
									class365_sub1_sub1_sub2_sub2.method4475(
											false, (byte) -103),
					...
					Class357
							.method4276(
									Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub12_7543
											.method5669((byte) 92), -1, -1,
									false, 1686359227);
				byte[] is = new byte[((Class25) class25).anInt336 * -866602563];
				stream.method3662(is, 0, -866602563
						* ((Class25) class25).anInt336, (byte) 1);
				String string = Class52
						.method556(is, 0,
								(((Class25) class25).anInt336 * -866602563),
								1174912789);
				String string_204_ = "opensn";
				if (!client.aBoolean8638
						|| !Class65.method762(string, 1, string_204_,
								-2024310199))
					Class273
							.method2559(
									string,
									...
									Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
											.method5677(-446024577) == 5,
									string_204_, client.aBoolean8867,
									client.aBoolean8651, -1865929375);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.RUN_SCRIPT_PACKET) {
				...
				for (int i_216_ = string.length() - 1; i_216_ >= 0; i_216_--) {
					if (string.charAt(i_216_) == 's')
						objects[i_216_ + 1] = stream
								.readString(1977322513);
					else
						objects[i_216_ + 1] = new Integer(stream
								.readInt((byte) -5));
				}
				...
				ClientScript class298_sub37_sub17 = Class216.getClientScript(
						(Integer) objects[0], (byte) 1);
			...
			if (IncommingPacket.LOAD_MAP_SCENE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				RsBitsBuffer class298_sub53_sub2_217_ = new RsBitsBuffer(
						((Class25) class25).anInt336 * -866602563);
				System
						.arraycopy(
								(((Class25) class25).aClass298_Sub53_Sub2_333.buffer),
								385051775 * (((Class25) class25).aClass298_Sub53_Sub2_333.index),
								class298_sub53_sub2_217_.buffer, 0,
								-866602563 * ((Class25) class25).anInt336);
				Class119.method1304(1536628978);
				if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub21_7580
						.method5703((byte) -123) == 1)
					Class62.aClass248_612.method2385(new Class267(
							Class266.LOAD_MAP_SCENE_NORMAL, class298_sub53_sub2_217_),
							1122139565);
				else
					client.aClass283_8716.sendMapScene(new Class267(
							Class266.LOAD_MAP_SCENE_NORMAL, class298_sub53_sub2_217_),
							-1991819579);
				((Class25) class25).INCOMMING_PACKET = null;
				return false;
			...
			if (IncommingPacket.RUN_ENERGY_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				client.anInt8844 = stream.readUnsignedByte()
						* -1985989501;
				client.anInt8888 = client.anInt8933 * 1991119277;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ITEMS_PACKET) {
				...
				for (int i_225_ = 0; i_225_ < i_224_; i_225_++) {
					...
					Class82_Sub8.method896(i_222_, i_225_, i_226_ - 1, i_227_,
							bool, 1471693915);
				}
			...
			if (IncommingPacket.RECEIVE_PRIVATE_QUICK_CHAT_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_87_: do {
					...
					if (rights != 2
							&& Class287.method2722(string_233_, -1912331316))
						bool_238_ = true;
				} while (false);
				if (!bool_238_) {
					client.aLongArray8915[client.anInt8916 * 1594173071] = l_237_;
					client.anInt8916 = 1356544111 * ((1594173071 * client.anInt8916 + 1) % 100);
					String string_240_ = Class447.aClass469_5618.method6045(
							i_236_, (short) -8978).method3459(
							stream, -734708119);
					if (2 == rights)
						Class25.method393(18, 0, new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string).toString(), new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string_233_).toString(), string, string_240_,
								null, i_236_, 1446000206);
					else if (rights == 1)
						Class25.method393(18, 0, new StringBuilder().append(
								Class247.method2368(0, -278777595)).append(
								string).toString(), new StringBuilder().append(
						 ...
						 Class25.method393(18, 0, "<img="+rights+">"+ string ,  "<img="+rights+">"+string_233_, string,
									string_240_, null, i_236_, 1446000206);
					else
						Class25.method393(18, 0, string, string_233_, string,
								string_240_, null, i_236_, 1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (IncommingPacket.aClass202_2259 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (-821031539 * Class384.anInt4128 != i_241_) {
					...
					Class126.method1405(Class502.aClass502_6723, -1, -1,
							459954784);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (IncommingPacket.aClass202_2276 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class375.basePlane = stream.readUnsignedByte()
						* -1217120325;
				Class216.baseTileY = ((stream
						.readByteC(-136295651) << 3) * 2091861441);
				while (385051775 * stream.index < ((Class25) class25).anInt336
						* -866602563) {
					SubIncommingPacket class206 = (Class309_Sub1.method3807((byte) -52)[stream
							.readUnsignedByte()]);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2248) {
				...
				Class428 class428 = ((Class428) Class422_Sub20.method5701(
						Class440.method5861(-810032943), i_250_, (byte) 2));
				if (class428 == null)
			...
			if (IncommingPacket.aClass202_2195 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class413 class413 = ((Class413) Class422_Sub20.method5701(
						Class348.method4196(-424264250), i_259_, (byte) 2));
				if (class413 == null)
			...
			if (IncommingPacket.RECEIVE_FRIEND_CHAT_QUICK_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				while_88_: do {
					...
					if (rights != 2
							&& Class287.method2722(string_260_, -1463632350))
						bool_266_ = true;
				} while (false);
				if (!bool_266_) {
					client.aLongArray8915[1594173071 * client.anInt8916] = l_265_;
					client.anInt8916 = ((client.anInt8916 * 1594173071 + 1) % 100 * 1356544111);
					String string_268_ = Class447.aClass469_5618.method6045(
							i_264_, (short) -10826).method3459(
							stream, -734708119);
					if (2 == rights)
						Class25.method393(20, 0, new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string).toString(), new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string_260_).toString(), string, string_268_,
								Class404.method4952(l), i_264_, 1446000206);
					else if (rights == 1)
						Class25.method393(20, 0, new StringBuilder().append(
								Class247.method2368(0, -278777595)).append(
								string).toString(), new StringBuilder().append(
						...
						Class25.method393(20, 0, "<img="+rights+">"+string,  "<img="+rights+">"+string_260_, string,
								string_268_, Class404.method4952(l), i_264_,
								1446000206);
					else
						Class25.method393(20, 0, string, string_260_, string,
								string_268_, Class404.method4952(l), i_264_,
								1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.FRIENDS_PACKET) {
				while (stream.index * 385051775 < ((Class25) class25).anInt336
						* -866602563) {
					boolean bool = stream.readUnsignedByte() == 1;
					String string = stream.readString(1159315726);
					String string_269_ = stream
							.readString(1988455124);
					int i_270_ = stream.readUnsignedShort();
					int i_271_ = stream.readUnsignedByte();
					boolean bool_272_ = stream
							.readUnsignedByte() == 1;
					String string_273_ = "";
					boolean bool_274_ = false;
					if (i_270_ > 0) {
						string_273_ = stream
								.readString(1917634572);
						bool_274_ = stream.readUnsignedByte() == 1;
					}
					for (int i_275_ = 0; i_275_ < client.anInt8941
							* -1054937867; i_275_++) {
						if (!bool) {
							if (string.equals(client.aStringArray8704[i_275_])) {
								if (client.anIntArray8946[i_275_] != i_270_) {
									boolean bool_276_ = true;
									for (Class302_Sub2 class302_sub2 = ((Class302_Sub2) client.aClass442_8951
											.method5868(-16777216)); null != class302_sub2; class302_sub2 = ((Class302_Sub2) client.aClass442_8951
											.method5872(269965941))) {
										if (((Class302_Sub2) class302_sub2).aString7648
												.equals(string)) {
											if (i_270_ != 0
													&& (((Class302_Sub2) class302_sub2).aShort7646 == 0)) {
												class302_sub2
														.method3714(185516853);
												bool_276_ = false;
											} else if (i_270_ == 0
													&& (0 != (((Class302_Sub2) class302_sub2).aShort7646))) {
												class302_sub2
														.method3714(1336201155);
												bool_276_ = false;
											}
										}
									}
									if (bool_276_)
										client.aClass442_8951.method5870(
												new Class302_Sub2(string,
														i_270_), 1940667363);
								...
								.equals(client.aStringArray8704[i_275_])) {
				...
				while_89_: do {
					do {
						...
						for (int i_278_ = 0; i_278_ < i_277_; i_278_++) {
							...
							if ((Class474.aClass471_5979.worldId * 1606920449 != client.anIntArray8946[i_278_])
									&& ((1606920449 * Class474.aClass471_5979.worldId) == client.anIntArray8946[i_278_ + 1]))
								bool_279_ = true;
							if (!bool_279_
									&& client.anIntArray8946[i_278_] == 0
									&& client.anIntArray8946[i_278_ + 1] != 0)
								bool_279_ = true;
							if (!bool_279_ && !client.aBooleanArray8950[i_278_]
									&& client.aBooleanArray8950[1 + i_278_])
								bool_279_ = true;
							if (bool_279_) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SET_CAMERA_POS_PACKET) {
				...
				Class97_Sub1.method1043(moveLocalX, moveLocalY, moveZ, speed2, speed1,
						true);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2228 == ((Class25) class25).INCOMMING_PACKET) {
				if (-1 != client.WINDOW_PANE_ID * -257444687)
					Class82_Sub10.method903(client.WINDOW_PANE_ID * -257444687, 0,
							390245730);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2207 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class113.method1254(i_299_, new Class298_Sub51_Sub2(i_296_,
						i_294_, i_293_), new int[] { i_292_, i_298_, i_297_,
						i_295_ }, false, 1697416272);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2239) {
				client.anInt8913 = stream.readUnsigned128Byte((byte) 101)
						* -1777248765;
			...
			if (IncommingPacket.aClass202_2267 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(interfaceHash, 5, i_300_, i_302_, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SEND_PRIVATE_MESSAGE_PACKET) {
				...
				String string_305_ = (Class248
						.decryptStringMessage(Class127_Sub1.huffManDecryption(
								stream, 1133530682), 882285799));
				Class242_Sub1.method2282(6, 0, string, string, string,
						string_305_, -109686251);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ITEMS_UPDATE_PACKET) {
				...
				while (385051775 * stream.index < ((Class25) class25).anInt336
					...
					Class82_Sub8.method896(key, slotId, id - 1, i_337_,
							negativekeyCheck, -540593777);
				}
			...
			if (IncommingPacket.aClass202_2250 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(i_342_, 5, client.playerIndex * -442628795,
						0, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2172) {
				...
				Class355
						.method4265(i_344_, i_347_, i_345_, i_346_, -1411433618);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2290 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_364_ >= 0
						&& i_365_ >= 0
						&& (i_364_ < client.aClass283_8716
								.method2629(-1911669738) * 2)
						&& (i_365_ < client.aClass283_8716
								.method2629(-1992464171) * 2)
						&& i_351_ >= 0
						&& i_361_ >= 0
						&& (i_351_ < client.aClass283_8716
								.method2630(-2022476058) * 2)
						&& (i_361_ < client.aClass283_8716
								.method2630(1563119067) * 2) && 65535 != i_348_) {
					i_364_ *= 256;
					i_365_ *= 256;
					i_351_ = 256 * i_351_;
					i_361_ = 256 * i_361_;
				...
				if (rights != 2) {
					if (client.aBoolean8811 && !client.aBoolean8812
						...
						bool_368_ = true;
							...
							&& Class287.method2722(string_366_, -1379408074))
						bool_368_ = true;
				}
				if (!bool_368_) {
					String string_369_ = (Class248.decryptStringMessage(Class127_Sub1
							.huffManDecryption(stream, 1427185881),
							1705296480));
					if (2 == rights)
						Class25.method393(24, 0, new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string).toString(), new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string_366_).toString(), string, string_369_,
								null, -1, 1446000206);
					else if (rights == 1)
						Class25.method393(24, 0, new StringBuilder().append(
								Class247.method2368(0, -278777595)).append(
						...
						Class25.method393(24, 0, "<img="+rights+">"+string,  "<img="+rights+">"+string_366_, string,
								string_369_, null, -1, 1446000206);
					else
						Class25.method393(24, 0, string, string_366_, string,
								string_369_, null, -1, 1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			if (IncommingPacket.aClass202_2179 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class237.method2198(i_373_, i_375_, i_372_, i_374_,
						(short) -8450);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2297 == ((Class25) class25).INCOMMING_PACKET) {
				client.aBoolean8815 = stream
						.readUnsignedByteC((short) -6905) == 1;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2221 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class82_Sub20.method935(i_377_, i_379_, i_378_, i_376_,
						1382023549);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.CUTSCENE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class399.aClass243_5220.method2310(
						577335585 * client.anInt8870, -457216440);
				...
				for (int i_382_ = 0; i_382_ < i_381_; i_382_++) {
					for (int i_383_ = 0; i_383_ < 4; i_383_++)
						Class298_Sub37.anIntArrayArray7407[i_382_][i_383_] = stream
								.readInt((byte) 32);
				}
				int i_384_ = stream.readUnsignedByte();
				Class128_Sub1.aClass298_Sub53_8555 = new RsByteBuffer(i_384_);
				Class128_Sub1.aClass298_Sub53_8555.writeBytes(
						stream.buffer,
						385051775 * stream.index, i_384_,
						(short) -25177);
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.ITEM_ON_ICOMPONENT_PACKET) {
				...
				ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(i_386_);
				Class355.method4265(i_388_, 330519029 * class468.anInt5714,
						-3355859 * class468.anInt5715,
						class468.anInt5713 * 1396167403, -1121225747);
				Class253.method2422(i_388_, 252709809 * class468.anInt5717,
						-1811316489 * class468.anInt5718, class468.anInt5716
								* -1368639199, 499708204);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.RECEIVE_QUICK_PRIVATE_MESSAGE) {
				...
				while_90_: do {
					if (class298_sub25 == null)
						...
						if (rights != 2
								&& Class287.method2722(string, -1151281576))
							bool_398_ = true;
					}
				} while (false);
				if (!bool_398_) {
					...
					String string_400_ = Class447.aClass469_5618.method6045(
							i_396_, (short) -926).method3459(
							stream, -734708119);
					int i_401_ = bool ? 42 : 45;
					if (rights == 2 || 3 == rights)
						Class25.method393(i_401_, 0, new StringBuilder()
								.append(Class247.method2368(1, -278777595))
								.append(string).toString(), new StringBuilder()
								.append(Class247.method2368(1, -278777595))
								.append(string).toString(), string,
								string_400_, class298_sub25.aString7358,
								i_396_, 1446000206);
					else if (1 == rights)
						Class25.method393(i_401_, 0, new StringBuilder()
								.append(Class247.method2368(0, -278777595))
						...
						Class25.method393(i_401_, 0, "<img="+rights+">"+string, "<img="+rights+">"+string, string,
								string_400_, class298_sub25.aString7358,
								i_396_, 1446000206);
					else
						Class25.method393(i_401_, 0, string, string, string,
								string_400_, class298_sub25.aString7358,
								i_396_, 1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
			...
			if (IncommingPacket.aClass202_2174 == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (i_403_ <= 1
						&& Class287.method2722(string_402_, -1454768672))
					bool_405_ = true;
				if (!bool_405_) {
					String string_406_ = Class447.aClass469_5618.method6045(
							i_404_, (short) -11547).method3459(
							stream, -734708119);
					if (2 == i_403_)
						Class25.method393(25, 0, new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string).toString(), new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string_402_).toString(), string, string_406_,
								null, i_404_, 1446000206);
					else if (1 == i_403_)
						Class25.method393(25, 0, new StringBuilder().append(
								Class247.method2368(0, -278777595)).append(
								string).toString(), new StringBuilder().append(
						...
						Class25.method393(25, 0, string, string_402_, string,
								string_406_, null, i_404_, 1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SOUND_INDEX15) {
				...
				Class320.method3913(soundId, i_408_, i_409_, i_410_, true, 256,
						2006173434);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2232) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_1998, class25.aClass449_330,
						(byte) 120);
				class298_sub36.out.write128Byte(
						914379507 * client.anInt6467, (byte) 1);
				class298_sub36.out.writeInt(i_413_,
						390381879);
				class298_sub36.out.writeIntV1(i_414_,
						(byte) -42);
				class25.method390(class298_sub36, (byte) -114);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_1900 == ((Class25) class25).INCOMMING_PACKET) {//interface defs?
				...
				Class113.method1254(interfaceId, new Class298_Sub51_Sub1(fromSlot,
						clipped, toSlot), new int[] { firstXtea, secondXtea, thirdXtea,
						fourthXtea }, false, -983354204);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.SECURITY_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				Class273.method2566(stream,
						((Class25) class25).anInt336 * -866602563, (byte) -111);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
				...
				if (class298_sub29 != null)
					Class431
							.method5768(
									...
									is, i_424_, true, (byte) -7);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.aClass202_2220 == ((Class25) class25).INCOMMING_PACKET) {
				Class216.baseTileY = ((stream
						.read128Byte(1269677513) << 3) * 2091861441);
				Class375.basePlane = stream.readUnsigned128Byte((byte) 40)
						* -1217120325;
					...
					if (i_426_ == Class375.basePlane * -191892109
						...
						if (i_428_ >= 0
								...
								&& i_428_ < client.aClass283_8716
										.method2629(-2088487368)
								&& i_430_ < client.aClass283_8716
										.method2630(1377874440))
							Class173.method1820(
									(Class375.basePlane * -191892109), i_428_,
									i_430_, 1641680263);
					}
				}
				for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7152
						.method5939(1766612795); class298_sub1 != null; class298_sub1 = ((Class298_Sub1) Class298_Sub1.aClass453_7152
						.method5944(49146))) {
					if ((class298_sub1.anInt7150 * 634196087 >= 134435705 * ClanSettings.baseTileX)
							&& (634196087 * class298_sub1.anInt7150 < 8 + 134435705 * ClanSettings.baseTileX)
							&& (-2146829167 * class298_sub1.anInt7155 >= -105526719
									* Class216.baseTileY)
							&& (-2146829167 * class298_sub1.anInt7155 < Class216.baseTileY
									* -105526719 + 8)
							&& (((Class298_Sub1) class298_sub1).anInt7151 * 2108312995) == -191892109
									* Class375.basePlane)
				...
				for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7162
						...
						.method5944(49146))) {
					if ((634196087 * class298_sub1.anInt7150 >= 134435705 * ClanSettings.baseTileX)
							&& (634196087 * class298_sub1.anInt7150 < ClanSettings.baseTileX * 134435705 + 8)
							&& (class298_sub1.anInt7155 * -2146829167 >= -105526719
									* Class216.baseTileY)
							&& (class298_sub1.anInt7155 * -2146829167 < -105526719
									* Class216.baseTileY + 8)
							&& ((2108312995 * ((Class298_Sub1) class298_sub1).anInt7151) == -191892109
									* Class375.basePlane))
						((Class298_Sub1) class298_sub1).aBoolean7160 = true;
				}
				((Class25) class25).INCOMMING_PACKET = null;
			...
			if (IncommingPacket.WORLD_TILE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class375.basePlane = (stream
						.readUnsignedByteC((short) -28965) * -1217120325);
				ClanSettings.baseTileX = ((stream
						.read128Byte(-1150117384) << 3) * 1536927433);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.SKILL_LEVEL_PACKET) {
				...
				client.anIntArray8833[(client.anInt8875 += 1972492301)
						* -1048955195 - 1 & 0x1f] = skillId;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.FRIENDS_CHAT_CHANNEL_PACKET) {
				...
				for (int i_446_ = 0; i_446_ < Class489.anInt6071 * -1801543887; i_446_++) {
					...
					class7s[i_446_].aString92 = stream
							.readString(403996572);
					bool = stream.readUnsignedByte() == 1;
					if (bool)
						class7s[i_446_].aString93 = stream
								.readString(1553463180);
					else
						class7s[i_446_].aString93 = class7s[i_446_].aString92;
					((Class7) class7s[i_446_]).aString94 = Class173.method1824(
							class7s[i_446_].aString93, 445649895);
					class7s[i_446_].anInt95 = (stream
							.readUnsignedShort() * -129166695);
					class7s[i_446_].aByte97 = stream
							.readByte(-12558881);
					class7s[i_446_].aString96 = stream
							.readString(-1930467617);
					if (class7s[i_446_].aString93
							.equals(Class287.myPlayer.aString10195))
				...
				while_91_: do {
					do {
						...
						for (int i_449_ = 0; i_449_ < i_448_; i_449_++) {
							if ((((Class7) class7s[i_449_]).aString94
									.compareTo(((Class7) class7s[1 + i_449_]).aString94)) > 0) {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.HINT_ICON_PACKET) {
				...
				((Class19) class19).anInt258 = stream
						.readUnsignedByte()
						* -1078964265;
				if (((Class19) class19).anInt258 * -92466201 >= 0
						&& (((Class19) class19).anInt258 * -92466201 < Class128_Sub2.aClass57Array8560.length)) {
					if (class19.anInt266 * 958933333 == 1
							|| 10 == class19.anInt266 * 958933333) {
						class19.anInt256 = (stream
								.readUnsignedShort() * 1626935871);
						((Class19) class19).anInt265 = (stream
								.readUnsignedShort() * -571637617);
						stream.index += 465653244;
					} else if (class19.anInt266 * 958933333 >= 2
							&& class19.anInt266 * 958933333 <= 6) {
						...
						((Class19) class19).anInt259 = (stream
								.readUnsignedByte() * -1962848411);
						Class341 class341 = client.aClass283_8716
								.method2628(681479919);
						class19.anInt260 += ((stream
								.readUnsignedShort() - -1760580017
								* class341.gameSceneBaseX) << 9) * 962213171;
						class19.anInt261 += ((stream
								.readUnsignedShort() - class341.gameSceneBaseY * 283514611) << 9) * 313675491;
						((Class19) class19).anInt262 = ((stream
								.readUnsignedByte() << 2) * -2098711205);
						class19.anInt257 = (stream
								.readUnsignedShort() * -1670140163);
					}
					class19.anInt263 = (stream
							.readInt((byte) -34) * -698073157);
			...
			if (IncommingPacket.PLAYER_ON_ICOMPONENT_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(i_453_, 3, client.playerIndex * -442628795,
						0, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.BLACK_OUT_PACKET) {
				Class3.anInt56 = stream.readUnsignedByte()
						* -986054733;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.LOAD_MAP_SCENE_DYNAMIC_PACKET) {
				RsBitsBuffer class298_sub53_sub2_455_ = new RsBitsBuffer(
						((Class25) class25).anInt336 * -866602563);
				System
						.arraycopy(
								(((Class25) class25).aClass298_Sub53_Sub2_333.buffer),
								(((Class25) class25).aClass298_Sub53_Sub2_333.index) * 385051775,
								class298_sub53_sub2_455_.buffer, 0,
								((Class25) class25).anInt336 * -866602563);
				Class119.method1304(1849823335);
				if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub21_7580
						.method5703((byte) -70) == 1)
					Class62.aClass248_612.method2385(new Class267(
							Class266.LOAD_MAP_SCENE_DYNAMIC, class298_sub53_sub2_455_),
							1563574437);
				else
					client.aClass283_8716.sendMapScene(new Class267(
							Class266.LOAD_MAP_SCENE_DYNAMIC, class298_sub53_sub2_455_),
			...
			if (IncommingPacket.aClass202_2194 == ((Class25) class25).INCOMMING_PACKET) {
				...
				Class426.method5743(i_463_, i_464_, i_465_, i_459_, i_462_,
						i_458_, i_461_, 2105013784);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.OPEN_URL_PACKET) {
				if (Class452.aBoolean5642 && Class231.aFrame2589 != null)
					Class357
							.method4276(
									Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub12_7543
											.method5669((byte) 42), -1, -1,
									false, -1432148158);
				byte[] is = new byte[((Class25) class25).anInt336 * -866602563
						- 1];
				boolean bool = stream.readUnsignedByte() == 1;
				stream.method3662(is, 0,
						(((Class25) class25).anInt336 * -866602563) - 1,
						(byte) 1);
					...
					if (!client.aBoolean8638
						...
						Class346
								.method4172(
										...
										true,
										Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
												.method5677(-2008340671) == 5,
										client.aBoolean8867,
										client.aBoolean8651, (byte) 13);
				} else
					Class346
							.method4172(
									string,
									true,
									Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
											.method5677(-389602471) == 5,
									client.aBoolean8867, client.aBoolean8651,
									(byte) 54);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2238 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.sendSomethingOnIComponent(i_471_, 7, i_470_ << 16 | i_469_, i_472_,
						262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			if (IncommingPacket.PLAYER_UPDATE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				Class247.decodePlayerUpdate(stream,
						((Class25) class25).anInt336 * -866602563, 1110385787);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.RECEIVE_FRIEND_CHAT_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				if (!bool_478_) {
					...
					String string_480_ = (Class248.decryptStringMessage(Class127_Sub1
							.huffManDecryption(stream, 130122413),
							-1233870536));
					if (rights == 2 || rights == 3)
						Class25.method393(9, 0, new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string).toString(), new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string_473_).toString(), string, string_480_,
								Class404.method4952(l), -1, 1446000206);
					else if (1 == rights)
						Class25.method393(9, 0, new StringBuilder().append(
								Class247.method2368(0, -278777595)).append(
								string).toString(), new StringBuilder().append(
						...
						Class25.method393(9, 0, "<img="+rights+">"+string, "<img="+rights+">"+string_473_, string,
								string_480_, Class404.method4952(l), -1,
								1446000206);
					else
						Class25.method393(9, 0, string, string_473_, string,
								string_480_, Class404.method4952(l), -1,
								1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
			...
			if (IncommingPacket.aClass202_2157 == ((Class25) class25).INCOMMING_PACKET) {
				Class298_Sub41.anInt7456 = stream
						.read24BitInteger((byte) -43) * 777394511;
				client.aBoolean8811 = stream
						.readUnsignedByte() == 1;
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.RECEIVE_PRIVATE_MESSAGE_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				long l = (long) stream.readUnsignedShort();
				long l_489_ = (long) stream
						.read24BitUnsignedInteger((byte) -115);
				int rights = stream.readUnsignedByte();
				...
				if (!bool_492_) {
					...
					String string_494_ = (Class248.decryptStringMessage(Class127_Sub1
							.huffManDecryption(stream, -1313378115),
							19429593));
					if (2 == rights)
						Class25.method393(7, 0, new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string).toString(), new StringBuilder().append(
								Class247.method2368(1, -278777595)).append(
								string_488_).toString(), string, string_494_,
								null, -1, 1446000206);
					else if (rights == 1)
						Class25.method393(7, 0, new StringBuilder().append(
								Class247.method2368(0, -278777595)).append(
						...
						Class25.method393(3, 0, "<img="+rights+">"+string, "<img="+rights+">"+string_488_, string,
								string_494_, null, -1, 1446000206);
					else
						Class25.method393(3, 0, string, string_488_, string,
								string_494_, null, -1, 1446000206);
				}
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			...
			IPAddress
					.method6062(
							new StringBuilder()
									.append(
											((Class25) class25).INCOMMING_PACKET != null ? 2075990793 * (((Class25) class25).INCOMMING_PACKET.anInt2187)
													: -1)
									.append(Class26.aString353)
									.append(
											null != ((Class25) class25).aClass202_345 ? (((Class25) class25).aClass202_345.anInt2187) * 2075990793
													: -1)
									.append(Class26.aString353)
									.append(
											null != ((Class25) class25).aClass202_348 ? (((Class25) class25).aClass202_348.anInt2187) * 2075990793
													: -1).append(" ").append(
											((Class25) class25).anInt336
													* -866602563).toString(),
