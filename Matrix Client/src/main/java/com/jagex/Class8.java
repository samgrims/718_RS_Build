...
public class Class8 {
	...
	static String method315(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			if ((((Class298_Sub37_Sub15) class298_sub37_sub15).aString9669 == null)
					|| ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9669
							.length() == 0) {
				if (null != (((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657)
						&& ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657
								.length() > 0)
					return new StringBuilder()
							.append(
									((Class298_Sub37_Sub15) class298_sub37_sub15).aString9667)
							.append(
			...
			if ((null != ((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657)
				...
				return new StringBuilder()
						.append(
								((Class298_Sub37_Sub15) class298_sub37_sub15).aString9667)
						.append(
								Tradution.aClass470_5916.method6049(
	...
	static final void method317(Class403 class403, int i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = ((Class403) class403).aClass298_Sub25_5237.aString7358;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ai.xj(").append(')').toString());
		}
	}

	static Class298_Sub19_Sub1 method318(
			Class298_Sub19_Sub1 class298_sub19_sub1, int i) {
		try {
			Class298_Sub19_Sub1 class298_sub19_sub1_0_ = (null == class298_sub19_sub1 ? new Class298_Sub19_Sub1()
					: new Class298_Sub19_Sub1(class298_sub19_sub1));
			class298_sub19_sub1_0_.method2962(9, 128, 346222187);
			return class298_sub19_sub1_0_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ai.f(").append(')').toString());
		}
	}
	...
	public static void method319(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ai.g(").append(')').toString());
		}
	}

	static final void method320(Class403 class403, int i) {
		try {
			Class62 class62 = ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242
					.method4437(658355638);
			if (null == class62)
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class62
						.method721((byte) 1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ai.aok(").append(')').toString());
		}
	}
