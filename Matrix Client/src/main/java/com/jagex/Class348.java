...
public final class Class348 {
	...
	public int method4183(byte i) {
		try {
			int i_0_ = 0;
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703
					.method5984(1659179977); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703
					.method5985(1776119940)) {
	...
	public Object method4184(long l) {
		try {
			...
			if (class298_sub37_sub9.method3438(-1388215910)) {
				...
				((Class348) this).aClass461_3703.method5982(
						class298_sub37_sub9, (byte) -40);
				class298_sub37_sub9.aLong7406 = 0L;
			}
			return object;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("on.a(").append(')').toString());
		}
	}
	...
	public void method4185(Object object, long l, int i, byte i_1_) {
		try {
			...
			while (1177262507 * ((Class348) this).anInt3704 < 0) {
				Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703
						.method5983(-2130209329);
	...
	public void method4186(int i, int i_2_) {
		try {
			for (Class298_Sub37_Sub9 class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703
					.method5984(-1737359401); class298_sub37_sub9 != null; class298_sub37_sub9 = (Class298_Sub37_Sub9) ((Class348) this).aClass461_3703
				...
				} else if ((class298_sub37_sub9.aLong7406 += 1476940603538232441L)
						* -5533549728640346679L > (long) i) {
					Class298_Sub37_Sub9_Sub2 class298_sub37_sub9_sub2 = (new Class298_Sub37_Sub9_Sub2(
	...
	static final void method4195(Class403 class403, int i) {
		try {
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub1_7552,
					i_7_, 1144244334);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("on.ahd(").append(')').toString());
		}
	}

	public static Class413[] method4196(int i) {
		try {
			return (new Class413[] { Class413.aClass413_6580,
					Class413.aClass413_6583, Class413.aClass413_6579,
					Class413.aClass413_6586, Class413.aClass413_6587,
					Class413.aClass413_6576, Class413.aClass413_6585,
					Class413.aClass413_6581, Class413.aClass413_6577,
					Class413.aClass413_6575, Class413.aClass413_6584,
					Class413.aClass413_6588, Class413.aClass413_6582,
					Class413.aClass413_6578 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("on.a(").append(')').toString());
		}
	...
	static final void method4198(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((NPC) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242).aClass73_10187
					.method817(i_12_, -966489489);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("on.ao(").append(')').toString());
		}
	}
}
