...
public class Class371 {
			...
			for (;;) {
				...
				if (1 == opcode) {
					...
					for (int i_1_ = 0; i_1_ < anIntArray4033.length; i_1_++) {
						anIntArray4033[i_1_] = class298_sub53
								.readShort(2110626558);
						anIntArray4034[i_1_] = class298_sub53
								.readShort(1614151446);
					}
					bool = true;
				} else if (opcode == 2)
					anInt4035 = class298_sub53.readBigSmart(1235052657) * 39715579;
				else if (opcode == 3) {
					anInt4032 = class298_sub53.readUnsignedByte()
							* -1837748075;
					...
					anInt4042 = class298_sub53.read24BitUnsignedInteger((byte) 3)
							* -990069469;
				else if (opcode == 6)
					...
					anInt4037 = class298_sub53.readUnsignedByte()
							* -328397825;
				else if (opcode == 12) {
					anInt4045 = class298_sub53.readUnsignedShort()
							* -618853911;
					anInt4046 = class298_sub53.readUnsignedShort()
							* -1051634129;
				}else if (opcode == 13) {
	...
	public Class371(Class243 class243) {
		...
		byte[] is = class243.method2294(
				(-363169051 * Class380.aClass380_4104.anInt4108), (byte) 61);
		method4580(new RsByteBuffer(is), -1224635914);
	}

	static void method4581(Class403 class403, short i) {
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 2] = (Class316.aClass362_3318
					.method4307(
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pk.c(").append(')').toString());
		}
	}

	static final void method4582(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1122 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pk.lk(").append(')').toString());
		}
	}
	...
	static final void method4583(Class403 class403, int i) {
		try {
			...
			int i_10_ = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7584
					.method5726(-2143866938);
			if (i_9_ != i_10_) {
				if (Class435.method5804(client.anInt8752 * -1233866115,
					...
					if (i_10_ == 0 && -1256171511 * Class300.anInt3207 != -1) {
						Class477.method6096(Class374_Sub1.aClass243_7731,
								-1256171511 * Class300.anInt3207, 0, i_9_,
								false, -2115031871);
	...
	static final void method4585(Class403 class403, int i) {
		try {
			...
			MapDetails class298_sub37_sub13 = Class298_Sub7
					.method2864(-577360818);
			if (class298_sub37_sub13 != null) {
				boolean bool = class298_sub37_sub13.method3453(
						i_12_ >> 28 & 0x3, i_12_ >> 14 & 0x3fff,
						i_12_ & 0x3fff, Class388.anIntArray4156, -253186022);
				if (bool)
					Class118.method1293(Class388.anIntArray4156[1],
							Class388.anIntArray4156[2], -548972447);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pk.ado(").append(')').toString());
		}
	}
