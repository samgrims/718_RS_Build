		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_2_ = 0; i_2_ < Class250.anInt2755 * -1474554145; i_2_++)
					is[i_2_] = method3212(Class250.anIntArray2762[i_2_], i_1_,
							(byte) -64) % 4096;
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahb.i(").append(')').toString());
		}
	}
	...
	int[] method3211(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_4_ = 0; i_4_ < Class250.anInt2755 * -1474554145; i_4_++)
				is[i_4_] = method3212(Class250.anIntArray2762[i_4_], i_3_,
						(byte) 4) % 4096;
		}
		return is;
	}
	...
	int[] method3213(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_9_ = 0; i_9_ < Class250.anInt2755 * -1474554145; i_9_++)
				is[i_9_] = method3212(Class250.anIntArray2762[i_9_], i_8_,
						(byte) -53) % 4096;
		}
		return is;
	}
