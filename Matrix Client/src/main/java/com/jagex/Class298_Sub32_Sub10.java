...
public class Class298_Sub32_Sub10 extends Class298_Sub32 {
	...
	int[][] method3198(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_10_ = 0; i_10_ < -1474554145 * Class250.anInt2755; i_10_++) {
				is_7_[i_10_] = ((Class298_Sub32_Sub10) this).anInt9392
						* -1444969569;
				is_8_[i_10_] = -1731491595
						* ((Class298_Sub32_Sub10) this).anInt9391;
	...
	int[][] method3199(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_14_ = 0; i_14_ < -1474554145 * Class250.anInt2755; i_14_++) {
				is_11_[i_14_] = ((Class298_Sub32_Sub10) this).anInt9392
						* -1444969569;
				is_12_[i_14_] = -1731491595
						* ((Class298_Sub32_Sub10) this).anInt9391;
	...
	public static void method3200(Class95 class95, int i, int i_15_) {
		try {
			...
			Class298_Sub19_Sub1 class298_sub19_sub1 = class95
					.method1028(47610786);
			if (class298_sub19_sub1 != null) {
				...
				Class79.aClass298_Sub19_Sub1_737.method2958(class95
						.method1027(-1730334000), false, (byte) 90);
				Class79.aClass298_Sub19_Sub1_737.method2961(i, 1926330524);
				if (Class79.aClass284_738 != null)
					Class79.aClass284_738.method2679(
							Class79.aClass298_Sub19_Sub1_737, 1556269790);
				Class11.method329(-659623615);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agx.h(").append(')').toString());
		}
	}
}
