...
public class Class131 {
	...
	public Class125 method1467(int i, int i_0_) {
		try {
			Class125 class125;
			synchronized (((Class131) this).aClass348_1496) {
				class125 = (Class125) ((Class131) this).aClass348_1496
						.method4184((long) i);
			}
			if (class125 != null)
				return class125;
			...
			if (class105 != null) {
				if (class105.anInt1154 * -1309843523 != -1) {
					...
					if (i_4_ < class105s.length) {
						Class425.method5737(class105s, i_4_ + 1, class105s,
								i_4_, class105s.length - i_4_ - 1);
	...
	static final void method1471(Class403 class403, int i) {
		try {
			...
			Class173.method1822(((i_5_ >> 14 & 0x3fff) - class341.gameSceneBaseX
					* -1760580017),
					((i_5_ & 0x3fff) - 283514611 * class341.gameSceneBaseY),
					i_6_ << 2, i_7_, i_8_, (byte) 72);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fh.agc(").append(')').toString());
		}
	}
}
