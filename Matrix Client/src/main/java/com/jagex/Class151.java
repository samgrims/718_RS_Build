...
public class Class151 implements Interface5 {
	...
	Class151(String string, Class139 class139, Class133 class133, int i,
	...
	public static Class182 method1643(int i, int i_9_) {
		try {
			Class182 class182 = (Class182) Class182.aClass348_1815
					.method4184((long) i);
			if (class182 != null)
				return class182;
	...
	static boolean method1644(int i) {
		try {
			return Class492.method6184(Class144.aClass381_1563.aClass355_4114,
					-1572506836);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gc.a(").append(')').toString());
		}
	}
