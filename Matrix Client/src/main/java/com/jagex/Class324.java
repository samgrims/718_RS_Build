...
public class Class324 {
		...
		try {
			...
			if (!bool) {
				...
				while_78_: do {
					...
					} while ((((Class365_Sub1) class365_sub1).anInt7725 * -1235150701) < -1235150701
							* (((Class365_Sub1) class335_2_.aClass365_Sub1_3616).anInt7725));
	...
	static final void method3958(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1287 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nn.ot(").append(')').toString());
		}
	}
		...
		try {
			Class369 class369 = Class316.aClass362_3318
					.method4307(
							...
							245040087);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null == class369.anIntArray4016 ? 0
					: class369.anIntArray4016.length);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nn.d(").append(')').toString());
		}
	}
}
