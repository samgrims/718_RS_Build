	...
	static final void method4676(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pu.acv(").append(')').toString());
		}
	}

	static final void method4677(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
					.method5677(-706712654);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pu.ajb(").append(')').toString());
		}
	}
	...
	public static void method4678(int i) {
		try {
			if (Class386.aClass471_4146.worldId * 1606920449 != -1)
				Class372.method4589(
						(Class386.aClass471_4146.worldId * 1606920449),
						Class386.aClass471_4146.address, 955770805);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pu.b(").append(')').toString());
		}
	}
	...
	static void method4679(IComponentDefinition class105, IComponentDefinition class105_3_, int i) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.SWITCH_INTERFACE_ITEM_PACKET,
					client.aClass25_8711.aClass449_330, (byte) 44);
			...
			class298_sub36.out.writeShortLE128(
					class105_3_.anInt1154 * -1309843523);
			class298_sub36.out.writeShortLE(
					class105.anInt1280 * -1232467723, 1472780126);
			client.aClass25_8711.method390(class298_sub36, (byte) -67);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pu.kq(").append(')').toString());
		}
	}
	...
	static final void method4680(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581
					.method5648(1496111936) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pu.ane(").append(')').toString());
		}
	}

	static final void method4681(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1137 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pu.lh(").append(')').toString());
		}
	}
	...
	static String method4682(IComponentDefinition class105, int i, byte i_4_) {
		try {
			...
			if (null == class105.aStringArray1195
					|| class105.aStringArray1195.length <= i
					|| null == class105.aStringArray1195[i]
					|| class105.aStringArray1195[i].trim().length() == 0) {
