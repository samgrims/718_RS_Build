...
public class Class298_Sub44 extends Class298 {
	...
	void method3528(int i) {
		try {
			if (((Class298_Sub44) this).aString7502.length() > 40)
				((Class298_Sub44) this).aString7502 = ((Class298_Sub44) this).aString7502
						.substring(0, 40);
			if (((Class298_Sub44) this).aString7503.length() > 40)
				((Class298_Sub44) this).aString7503 = ((Class298_Sub44) this).aString7503
						.substring(0, 40);
			if (((Class298_Sub44) this).aString7482.length() > 10)
				((Class298_Sub44) this).aString7482 = ((Class298_Sub44) this).aString7482
						.substring(0, 10);
			if (((Class298_Sub44) this).aString7505.length() > 10)
				((Class298_Sub44) this).aString7505 = ((Class298_Sub44) this).aString7505
						.substring(0, 10);
	...
	public void writeMachineInformation(RsByteBuffer buffer, int i) {
		try {
			...
			buffer.writeByte((((Class298_Sub44) this).anInt7471 * -1570985485)); //OS type.
			...
			buffer.writeShort((((Class298_Sub44) this).anInt7469 * -2088235843), 16711935); //Maximum memory
			buffer.writeByte((-1837764033 * ((Class298_Sub44) this).anInt7498)); //Available processors
			buffer.putTriByte(399637415 * cpuClockSpeed, (byte) 115); //Clock speed (MHz)
			buffer.writeShort((-1360789919 * ((Class298_Sub44) this).cpuClockSpeed1), 16711935); //Clock speed (MHz)
			...
			buffer.writeByte((((Class298_Sub44) this).directXDriverDate * 1183412533)); //DirectX driver date (month).
			buffer.writeShort((-669549295 * ((Class298_Sub44) this).directXDriverData2), 16711935); //DirectX driver date (year).
			buffer.putJagString(((Class298_Sub44) this).aString7496, (short) 3988); //CPU type.
			buffer.putJagString(((Class298_Sub44) this).aString7511, (short) -4559); //CPU data
			buffer.writeByte((78038867 * ((Class298_Sub44) this).cpuInfo)); //CPU cores amount.
			buffer.writeByte((((Class298_Sub44) this).anInt7489 * 664924581)); //Raw cpu info0
			...
			try {
				...
				if (is_6_ != null && is_6_.length % 5 == 0) {
					...
					for (int i_7_ = 0; i_7_ < is_6_.length / 5; i_7_++) {
						...
						Class472 class472 = new Class472(i_8_, i_9_, i_10_,
								i_11_, i_12_);
						hashmap.put(Integer.valueOf(i_8_), class472);
					}
					Class472 class472 = (Class472) hashmap.get(Integer
							.valueOf(0));
					if (null != class472) {
						RsByteBuffer class298_sub53 = new RsByteBuffer(13);
						class298_sub53
								.writeLEInt(
										(-2056580217 * (((Class472) class472).anInt5960)),
										162325587);
						class298_sub53
								.writeLEInt(
						...
						((Class298_Sub44) this).aString7496 = class298_sub53
					...
					if (null != class472_13_) {
						...
						((Class298_Sub44) this).anInt7489 = -1403810259
								* (i_14_ >> 16 & 0xff);
					...
					class298_sub53.index = 0;
					((Class298_Sub44) this).aString7511 = class298_sub53
					...
					for (int i_18_ = 0; i_18_ < strings[0].length; i_18_ += 2) {
						if (strings[0][i_18_].equalsIgnoreCase("szDescription"))
							...
							try {
								...
								((Class298_Sub44) this).directXDriverDate = ((Integer
										.parseInt(string.substring(0, i_19_))) * 1759516957);
								((Class298_Sub44) this).directXDriverData2 = ((Integer
				...
				if (strings_21_ != null) {
					...
					((Class298_Sub44) this).aString7482 = new StringBuilder()
