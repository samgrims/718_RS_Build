...
public class Class284 {
			...
			if (!((Class284) this).aBoolean3053) {
				...
				try {
					if (l > (6353619706144323107L * ((Class284) this).aLong3051 + 6000L))
						((Class284) this).aLong3051 = -2662467539374708341L
								* (l - 6000L);
					for (/**/; (l > (6353619706144323107L * ((Class284) this).aLong3051 + 5000L)); l = Class122
							.method1319((byte) 1)) {
					...
					try {
						if (0L != (-2629227736231104439L * ((Class284) this).aLong3060)) {
							if (l < (((Class284) this).aLong3060 * -2629227736231104439L))
								return;
							method2684(
									(((Class284) this).anInt3046 * -1894797445),
									816646714);
						...
						if (((Class284) this).anInt3063 * -25238017 - i_0_ > 1581283719 * ((Class284) this).anInt3061)
							((Class284) this).anInt3061 = (-2137785289 * (-25238017
									* ((Class284) this).anInt3063 - i_0_));
						int i_1_ = (((Class284) this).anInt3056 * 444653019 + ((Class284) this).anInt3071 * 1513728603);
						if (i_1_ + 256 > 16384)
							i_1_ = 16128;
						if (i_1_ + 256 > -1894797445
								* ((Class284) this).anInt3046) {
							...
							i_0_ = 0;
							((Class284) this).aBoolean3065 = true;
							if (i_1_ + 256 > ((Class284) this).anInt3046
									* -1894797445) {
						...
						if (l > (((Class284) this).aLong3064 * -9016197443635909135L)) {
							if (!((Class284) this).aBoolean3065) {
								if ((((Class284) this).anInt3061 * 1581283719 == 0)
										&& 0 == (-1912576967 * ((Class284) this).anInt3062)) {
									method2686(331463442);
									((Class284) this).aLong3060 = (2000L + l)
											* -3392636722701155847L;
									return;
								}
								((Class284) this).anInt3056 = (Math
										.min(
												(((Class284) this).anInt3062 * -1912576967),
												1581283719 * (((Class284) this).anInt3061)) * -1422272941);
								((Class284) this).anInt3062 = ((Class284) this).anInt3061
										* -43955265;
							} else
						...
						method2686(331463442);
						((Class284) this).aLong3060 = (l + 2000L)
								* -3392636722701155847L;
					}
				}
			}
	...
	final void method2682(int[] is, int i) {
		...
		((Class284) this).anInt3072 -= i * -1831995011;
		if (null != ((Class284) this).aClass298_Sub19_3054
				&& ((Class284) this).anInt3072 * -577697835 <= 0) {
			((Class284) this).anInt3072 += -1831995011
					* (anInt3059 * 1164070869 >> 4);
			Class62.method731(((Class284) this).aClass298_Sub19_3054,
					-1934060670);
			method2691(((Class284) this).aClass298_Sub19_3054,
					((Class284) this).aClass298_Sub19_3054.method2950(),
					(byte) -73);
			int i_4_ = 0;
			int i_5_ = 255;
			int i_6_ = 7;
				...
				for (int i_9_ = i_5_ >>> i_7_ & 0x11111111; 0 != i_9_; i_9_ >>>= 4) {
					if (0 != (i_9_ & 0x1)) {
						...
						while (class298_sub19_10_ != null) {
							...
							if (null != class298_sub26
									&& (((Class298_Sub26) class298_sub26).anInt7362 > i_8_)) {
								i_5_ |= 1 << i_7_;
								...
								if (i_4_ >= (1853708541 * ((Class284) this).anInt3055))
									break while_72_;
								Class298_Sub19 class298_sub19_12_ = class298_sub19_10_
										.method2930();
								if (null != class298_sub19_12_) {
									int i_13_ = (((Class298_Sub19) class298_sub19_10_).anInt7311);
									for (/**/; class298_sub19_12_ != null; class298_sub19_12_ = class298_sub19_10_
											.method2931())
										method2691(class298_sub19_12_, (i_13_
												* class298_sub19_12_
														.method2950() >> 8),
												(byte) -50);
								}
		...
		((Class284) this).aLong3051 = Class122.method1319((byte) 1)
				* -2662467539374708341L;
	}
	...
	static final void method2693(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1156
					* -2093041337;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lu.oc(").append(')').toString());
		}
	}
	...
	static final void method2694(IComponentDefinition class105, Class403 class403, int i) {
		try {
			...
			if (class105.anInt1184 * 1548853569 != 6
					&& 2 != class105.anInt1184 * 1548853569)
				throw new RuntimeException("");
			Class503 class503 = Class15.aClass507_224.method6269(
					class105.anInt1151 * 572201537, 2035169508);
			if (class105.aClass498_1307 == null)
				class105.aClass498_1307 = new Class498(class503,
						1548853569 * class105.anInt1184 == 6);
			class105.aClass498_1307.aLong6110 = Class382.method4686(954429430) * 3177550440302969639L;
			if (null == class503.aShortArray6134 || i_24_ < 0
					|| i_24_ >= class503.aShortArray6134.length)
				throw new RuntimeException("");
			class105.aClass498_1307.aShortArray6109[i_24_] = (short) i_23_;
			Tradution.method6054(class105, -579030149);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lu.qi(").append(')').toString());
		}
	}
	...
	static final void method2695(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub6_7551
					.method5647(207850013) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lu.ajo(").append(')').toString());
		}
	}

	static final void method2696(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			Class497 class497 = Class92.aClass504_905.method6251(i_25_,
					493338480);
	...
	static final void method2697(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ObjectDefinitions
					.method5788((char) i_27_, (short) 160) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lu.zq(").append(')').toString());
		}
	}
}
