package com.jagex;/* Class82 - Decompiled by JODE
		...
		try {
			...
			if (1690480405 * class496.anInt6097 != -1) {
				if (class432.aBoolean5401) {
					...
					i = 0;
				Class57 class57 = class496.method6198(class_ra, i,
						class432.aBoolean5440, (byte) -63);
				if (class57 != null) {
					...
					if (0 != class496.anInt6096 * -2012904123)
						class57.method634(i_0_, i_1_ - (i_4_ - 1) * 4, i_5_,
								i_6_, 0, (~0xffffff | class496.anInt6096
										* -2012904123), 1);
					else
						class57.method633(i_0_, i_1_ - 4 * (i_4_ - 1), i_5_,
								i_6_);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("di.x(").append(')').toString());
		}
	}
	...
	static final void method874(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = l == -1L ? "" : Long.toString(l, 36)
					.toUpperCase();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("di.aab(").append(')').toString());
		}
	}
		...
		try {
			...
			Class370.method4578(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
							.method5677(-1637975360), false, 622850291);
			Class3.method300(656179282);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("di.aia(").append(')').toString());
		}
	}
