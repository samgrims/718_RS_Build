package com.jagex;/* Class120 - Decompiled by JODE
...
public class Class120 {
		...
		try {
			...
			if (class298_sub49 != null) {
				...
				if (null != class298_sub24_sub4) {
					double d = ((Class298_Sub49) class298_sub49).aClass308_Sub1_7591
							.method3779((short) 4615);
					if ((double) class298_sub24_sub4.method3092((byte) 8) <= d
							&& ((double) class298_sub24_sub4
									.method3093(-327557193) >= d))
	...
	static float method1312(float f, float f_4_, float f_5_, float f_6_,
			float f_7_, float f_8_, int i, int i_9_) {
		try {
			float f_10_ = 0.0F;
			float f_11_ = f_6_ - f;
			...
			for (/**/; f_10_ < 1.1F; f_10_ += 0.1F) {
				...
				if (i_20_ > 0
						&& i_21_ > 0
						&& i_20_ < client.aClass283_8716
								.method2629(-1954958237)
						&& i_21_ < client.aClass283_8716
								.method2630(-1173220944)) {
					int i_22_ = (Class287.myPlayer.plane);
					if (i_22_ < 3
							&& ((client.aClass283_8716.method2654(936952439).aByteArrayArrayArray2731[1][i_20_][i_21_]) & 0x2) != 0)
						i_22_++;
					int i_23_ = (class331.aClass_xaArray3519[i_22_].method6340(
							(int) f_17_, (int) f_19_, -1328298083));
					if ((float) i_23_ < f_18_) {
						if (i >= 2)
							return (f_10_ - 0.1F + method1312(f_14_, f_15_,
									f_16_, f_17_, f_18_, f_19_, i - 1,
									1869450178) * 0.1F);
						return f_10_;
					}
				}
