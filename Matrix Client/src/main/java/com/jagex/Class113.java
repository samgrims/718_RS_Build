package com.jagex;/* Class113 - Decompiled by JODE
...
public class Class113 {
	...
	int method1245(byte[] is, int i, byte[] is_16_, int i_17_, int i_18_,
			int i_19_) {
		try {
			if (0 == i_18_)
				return 0;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ep.f(").append(')').toString());
		}
	}

	int method1246(byte[] is, int i, int i_24_, byte[] is_25_, int i_26_,
			byte i_27_) {
		try {
			int i_28_ = 0;
			int i_29_ = i_26_ << 3;
	...
	static final void method1248(Class403 class403, byte i) {
		try {
			...
			Class298_Sub33
					.method3396(class105, class119, class403, -1171777109);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ep.eo(").append(')').toString());
		}
	}
	...
	static final void method1251(Class403 class403, int i) {
		try {
			...
			if (client.aString8804 != null
					&& i_41_ < Class489.anInt6071 * -1801543887)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ep.wh(").append(')').toString());
		}
	}

	static final void method1252(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub20_7578
					.method5700(-1397951801);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ep.akj(").append(')').toString());
		}
	}
	...
	public static Class133[] method1255(int i) {
		try {
			return (new Class133[] { Class133.aClass133_1510,
					Class133.aClass133_1511, Class133.aClass133_1509 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ep.a(").append(')').toString());
		}
