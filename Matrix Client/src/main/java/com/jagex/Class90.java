	...
	static final void method997(Class403 class403, int i) {
		try {
			...
			String string = (String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751)
					* -203050393]);
			if (client.anInt8752 * -1233866115 != 14
					|| Class315.method3837((byte) -13))
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Class372
						.method4589(i_1_, string, 955770805) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dr.als(").append(')').toString());
		}
	}
}
