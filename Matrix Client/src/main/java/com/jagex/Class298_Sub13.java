...
public class Class298_Sub13 extends Class298 {
	...
	Class298_Sub13(RsByteBuffer class298_sub53) {
		...
		RsByteBuffer class298_sub53_53_ = new RsByteBuffer(
				((Class298_Sub13) this).aByteArray7258);
			...
			while_6_: do {
				for (;;) {
					...
					if (i_65_ == 23) {
						...
						class298_sub53_53_.writeByte(
								(class298_sub53.buffer[i_52_++]));
						class298_sub53_53_.writeByte(
								(class298_sub53.buffer[i_52_++]));
						class298_sub53_53_.writeByte(
								(class298_sub53.buffer[i_52_++]));
						...
						if (i_63_ == 0) {
							...
							class298_sub53_53_.writeByte(
									(class298_sub53.buffer[i_46_++]));
						}
					}
				}
				throw new RuntimeException();
			} while (false);
			class298_sub53_53_.method3599(
					(class298_sub53_53_.index * 385051775) - i_62_,
					1397495562);
		}
	}
				...
				while (((Class103) class103).anIntArray1105[i_70_] == i_71_) {
					...
					if (i_73_ == 144) {
						...
						if (i_81_ > 0) {
							...
							Class298_Sub28 class298_sub28 = ((Class298_Sub28) ((Class298_Sub13) this).aClass440_7259
									.method5852((long) i_82_));
							if (class298_sub28 == null) {
								class298_sub28 = new Class298_Sub28(
										new byte[128]);
								((Class298_Sub13) this).aClass440_7259
										.method5858(class298_sub28,
												(long) i_82_);
							}
