package com.jagex;/* Class115 - Decompiled by JODE
	...
	static final void method1260(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("er.mu(").append(')').toString());
		}
	}

	static final void method1261(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass365_Sub1_Sub4_Sub1_5253
					.method4363((byte) 33);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("er.apo(").append(')').toString());
		}
	}
