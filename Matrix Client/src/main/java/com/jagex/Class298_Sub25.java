package com.jagex;/* Class298_Sub25 - Decompiled by JODE
		...
		try {
			if (((Class298_Sub25) this).anIntArray7357 == null) {
				...
				Class298_Sub32_Sub32.method3345(strings,
						(((Class298_Sub25) this).anIntArray7357), 715814355);
			}
			return ((Class298_Sub25) this).anIntArray7357;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abj.f(").append(')').toString());
		}
	}

	void method3096(Class163 class163, int i) {
		try {
			if (aClass163Array7359 == null
					|| 649879491 * anInt7356 >= aClass163Array7359.length)
	...
	public int method3097(String string, byte i) {
		try {
			for (int i_1_ = 0; i_1_ < 649879491 * anInt7356; i_1_++) {
				if (aClass163Array7359[i_1_].aString1681
			...
			if (anInt7356 * 649879491 > 0) {
				...
				for (int i_3_ = 0; i_3_ < anInt7356 * 649879491; i_3_++) {
					...
					if (((Class298_Sub25) this).aBoolean7354)
						class163.aString1681 = class298_sub53
								.readString(254031265);
					class163.aByte1683 = class298_sub53.readByte(-12558881);
					class163.anInt1682 = class298_sub53.readUnsignedShort()
							* -62810701;
	...
	void method3099(int i, byte i_4_) {
		try {
			if (null != aClass163Array7359)
				Class425.method5737(aClass163Array7359, 0,
						aClass163Array7359 = new Class163[i], 0,
						anInt7356 * 649879491);
			else
				aClass163Array7359 = new Class163[i];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abj.a(").append(')').toString());
		}
	}
	...
	void method3100(int i, int i_5_) {
		try {
			...
			if (0 == anInt7356 * 649879491)
				...
				Class425.method5737(aClass163Array7359, 1 + i,
						aClass163Array7359, i, anInt7356 * 649879491 - i);
			((Class298_Sub25) this).anIntArray7357 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abj.p(").append(')').toString());
		}
	}
	...
	static final void method3102(Class403 class403, int i) {
		try {
			MapDetails class298_sub37_sub13 = Class301
					.method3705(((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]);
			if (class298_sub37_sub13 == null
					|| null == class298_sub37_sub13.aString9641)
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = "";
			else
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class298_sub37_sub13.aString9641;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abj.adf(").append(')').toString());
		}
	}
	...
	static final void method3103(Class403 class403, int i) {
		try {
			...
			if (var_long == null)
				...
				((Class403) class403).aLongArray5251[((((Class403) class403).anInt5245 += -682569305) * 1685767703) - 1] = var_long
						.longValue();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abj.bs(").append(')').toString());
		}
	}
}
