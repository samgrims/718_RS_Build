...
public class Class31 {
	...
	void method433(Interface2 interface2, int i) {
		if (i != 0) {
			method434();
			((Class31) this).aClass_ra_Sub2_386
					.method5256(((Class31) this).aClass30_Sub2_394);
	...
	void method434() {
		if (((Class31) this).aBoolean389) {
			...
			if (((Class31) this).aClass30_Sub2_394 != null
				...
				((Class31) this).anInt390 = i;
				int i_5_ = 0;
				i_2_ = (((Class31) this).anInt383 + ((Class31) this).anInt385
						* i_1_);
				...
				if (((Class31) this).aClass30_Sub2_394 == null) {
					((Class31) this).aClass30_Sub2_394 = new Class30_Sub2(
							((Class31) this).aClass_ra_Sub2_386,
							3553,
							...
							128,
							false,
							(((Class_ra_Sub2) (((Class31) this).aClass_ra_Sub2_386)).aByteArray8201),
							Class55.aClass55_567, false);
					((Class31) this).aClass30_Sub2_394.method420(false, false);
					((Class31) this).aClass30_Sub2_394.method410(true);
				} else
					((Class31) this).aClass30_Sub2_394
							.method421(
									0,
									0,
									128,
									128,
									(((Class_ra_Sub2) ((Class31) this).aClass_ra_Sub2_386).aByteArray8201),
									Class55.aClass55_567, 0, 0, false);
			}
		}
	}

	Class31(Class_ra_Sub2 class_ra_sub2, Class44 class44,
			Class_xa_Sub3 class_xa_sub3, int i, int i_9_, int i_10_, int i_11_,
			int i_12_) {
		...
		for (int i_17_ = 0; i_17_ < i_13_; i_17_++) {
			int i_18_ = ((i_16_ + i_17_)
					* (class_xa_sub3.anInt6287 * -506105871) + i_15_);
		...
		if (i_14_ > 0) {
			...
			((Class31) this).anInterface2_392 = (((Class31) this).aClass_ra_Sub2_386
					.method5284(5123, class298_sub53.buffer,
							class298_sub53.index * 385051775, false));
			((Class31) this).aClass46_Sub1_393 = new Class46_Sub1(
					((Class31) this).aClass_ra_Sub2_386, 5123, null, 1);
		} else
