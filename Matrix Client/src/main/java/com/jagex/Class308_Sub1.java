...
public class Class308_Sub1 extends Class308 {
	...
	int method3775(byte[] is, int i) throws IOException {
		try {
			if (((Class308_Sub1) this).anIntArray7672 == null) {
				if (!((Class308_Sub1) this).aClass243_7670.method2290(
						((Class308_Sub1) this).anInt7668 * -247750727, 0,
						-925167069))
					return 0;
				byte[] is_0_ = (((Class308_Sub1) this).aClass243_7670
						.method2315(-247750727
								* ((Class308_Sub1) this).anInt7668, 0,
								(byte) -2));
				if (null == is_0_)
				...
				for (int i_2_ = 0; i_2_ < i_1_; i_2_++)
					((Class308_Sub1) this).anIntArray7672[i_2_] = ((Class308_Sub1) this).aClass298_Sub53_7675
							.readUnsignedShort();
			}
			...
			while_9_: do {
				do {
					...
					if (i_3_ < i_4_) {
						((Class308_Sub1) this).aClass298_Sub53_7674
								.readBytes(
										(((Class308_Sub1) this).aClass298_Sub53_7675.buffer),
										(((Class308_Sub1) this).aClass298_Sub53_7675.index) * 385051775,
										i_3_, -953523806);
						((Class308_Sub1) this).aClass298_Sub53_7675.buffer = null;
						return is.length;
					}
					((Class308_Sub1) this).aClass298_Sub53_7675
							.writeBytes(
									(((Class308_Sub1) this).aClass298_Sub53_7674.buffer),
									(((Class308_Sub1) this).aClass298_Sub53_7674.index * 385051775),
									i_4_, (short) -26872);
	...
	public void method3785(byte i) {
		try {
			if (null != ((Class308_Sub1) this).anIntArray7672) {
				for (int i_6_ = 0; (i_6_ < 10 && (i_6_ + 352672983
						* ((Class308_Sub1) this).anInt7673 < ((Class308_Sub1) this).anIntArray7672.length)); i_6_++) {
					if ((((Class308_Sub1) this).aByteArrayArray7671[i_6_] == null)
							&& (((Class308_Sub1) this).aClass243_7670
									.method2290(
											(((Class308_Sub1) this).anIntArray7672[i_6_
													+ (352672983 * ((Class308_Sub1) this).anInt7673)]),
											0, -951445461)))
						((Class308_Sub1) this).aByteArrayArray7671[i_6_] = (((Class308_Sub1) this).aClass243_7670
								.method2315(
										(((Class308_Sub1) this).anIntArray7672[(352672983 * ((Class308_Sub1) this).anInt7673 + i_6_)]),
										0, (byte) -31));
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acm.as(").append(')').toString());
		}
	}
	...
	int method3777(byte[] is) throws IOException {
		if (((Class308_Sub1) this).anIntArray7672 == null) {
			if (!((Class308_Sub1) this).aClass243_7670.method2290(
					...
					-1752861403))
				return 0;
			byte[] is_7_ = (((Class308_Sub1) this).aClass243_7670.method2315(
					-247750727 * ((Class308_Sub1) this).anInt7668, 0, (byte) 9));
			if (null == is_7_)
				throw new IllegalStateException("");
			...
			for (int i_8_ = 0; i_8_ < i; i_8_++)
				((Class308_Sub1) this).anIntArray7672[i_8_] = ((Class308_Sub1) this).aClass298_Sub53_7675
						.readUnsignedShort();
		}
		if (((Class308_Sub1) this).anInt7673 * 352672983 >= ((Class308_Sub1) this).anIntArray7672.length)
			return -1;
	...
	int method3778(byte[] is) throws IOException {
		if (((Class308_Sub1) this).anIntArray7672 == null) {
			if (!((Class308_Sub1) this).aClass243_7670.method2290(
					...
					-718226291))
				return 0;
			byte[] is_11_ = (((Class308_Sub1) this).aClass243_7670.method2315(
					-247750727 * ((Class308_Sub1) this).anInt7668, 0,
					(byte) -126));
			if (null == is_11_)
				throw new IllegalStateException("");
			...
			for (int i_12_ = 0; i_12_ < i; i_12_++)
				((Class308_Sub1) this).anIntArray7672[i_12_] = ((Class308_Sub1) this).aClass298_Sub53_7675
						.readUnsignedShort();
		}
		if (((Class308_Sub1) this).anInt7673 * 352672983 >= ((Class308_Sub1) this).anIntArray7672.length)
			return -1;
	...
	int method3766(byte[] is) throws IOException {
		if (((Class308_Sub1) this).anIntArray7672 == null) {
			if (!((Class308_Sub1) this).aClass243_7670.method2290(
					...
					-1469304085))
				return 0;
			byte[] is_15_ = (((Class308_Sub1) this).aClass243_7670.method2315(
					-247750727 * ((Class308_Sub1) this).anInt7668, 0,
					(byte) -90));
			if (null == is_15_)
				throw new IllegalStateException("");
			...
			for (int i_16_ = 0; i_16_ < i; i_16_++)
				((Class308_Sub1) this).anIntArray7672[i_16_] = ((Class308_Sub1) this).aClass298_Sub53_7675
						.readUnsignedShort();
		}
		if (((Class308_Sub1) this).anInt7673 * 352672983 >= ((Class308_Sub1) this).anIntArray7672.length)
			return -1;
	...
	static final void method3786(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1150 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acm.kh(").append(')').toString());
		}
	}
}
