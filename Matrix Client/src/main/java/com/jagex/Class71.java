...
public class Class71 {
		...
		try {
			if (!aBoolean684) {
				if (830010277 * anInt685 > 0) {
					Class298_Sub29 class298_sub29 = new Class298_Sub29(
							interface25);
	...
	static synchronized void method810(byte i) {
		try {
			for (;;) {
				Class298_Sub29 class298_sub29 = (Class298_Sub29) aClass453_686
						.method5936(2119725533);
