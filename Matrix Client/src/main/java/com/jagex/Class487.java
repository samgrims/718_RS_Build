...
public class Class487 {
	...
	public Class496 method6159(int i, int i_0_) {
		try {
			...
			synchronized (((Class487) this).aClass348_6064) {
				class496 = (Class496) ((Class487) this).aClass348_6064
						.method4184((long) i);
			}
			if (class496 != null)
				return class496;
	...
	public void method6162(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ub.i(").append(')').toString());
		}
	}

	public Class487(Class411 class411, Class429 class429, Class243 class243,
			Class243 class243_3_) {
		((Class487) this).aClass243_6067 = class243;
		((Class487) this).aClass243_6068 = class243_3_;
		((Class487) this).aClass243_6067.method2316(
	...
	static final void method6164(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ub.aaa(").append(')').toString());
		}
	}

	static final void method6165(int i, int i_5_, int i_6_, int i_7_, int i_8_,
			int i_9_, int i_10_) {
		try {
			...
			while (i_13_ > i_11_) {
				...
				if (i_14_ >= 0) {
					...
					i_14_ -= i_13_ << 1;
					if (i_13_ >= i_12_) {
						int[] is_21_ = Class372_Sub1.anIntArrayArray4047[i_5_
								+ i_13_];
						int[] is_22_ = Class372_Sub1.anIntArrayArray4047[i_5_
								- i_13_];
						int i_23_ = i + i_11_;
						int i_24_ = i - i_11_;
						...
						int[] is_25_ = Class372_Sub1.anIntArrayArray4047[i_5_
								+ i_13_];
						int[] is_26_ = Class372_Sub1.anIntArrayArray4047[i_5_
								- i_13_];
				...
				int i_35_ = i - i_13_;
				if (i_11_ < i_12_) {
					int i_36_ = (i_15_ < i_11_ ? Class372_Sub1.anIntArray7727[i_11_]
							: i_15_);
					int i_37_ = i_36_ + i;
					int i_38_ = i - i_36_;
