...
public class Class482 {
	...
	static void method6116(RsByteBuffer class298_sub53, byte i) {
		try {
			if ((class298_sub53.buffer.length - class298_sub53.index * 385051775) >= 1) {
				...
				if (i_0_ >= 0
						&& i_0_ <= 1
						&& (class298_sub53.buffer.length - class298_sub53.index * 385051775) >= 2) {
						...
						for (int i_2_ = 0; i_2_ < i_1_; i_2_++) {
							...
							if (i_3_ < Class374.anIntArray4078.length) {
								if (!Class254.aBooleanArray2790[i_3_]) {
									...
									if ((Class320.aClass494_6550.method6191(
											i_3_, (byte) 10).aChar5968) == '1') {
										if (i_4_ < -1)
											continue;
										if (i_4_ > 1) {
											if (i != 3) {
	...
	static final void method6121(int i, int i_12_, int i_13_, int i_14_,
		...
		try {
			...
			if (i_19_ < 0)
				...
				i_19_ = 100;
			int i_20_ = (client.aShort8923 + i_19_
					* (client.aShort8931 - client.aShort8923) / 100);
			i_16_ = i_20_ * i_16_ >> 8;
