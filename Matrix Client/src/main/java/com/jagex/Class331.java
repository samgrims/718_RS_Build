package com.jagex;/* Class331 - Decompiled by JODE
...
public class Class331 {
			...
			for (int i_7_ = 0; i_7_ < 3; i_7_++) {
				...
				if (null != class326_8_) {
					for (Class322 class322 = class326_8_.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
						...
						if (i == class365_sub1_sub1.aShort9798
								&& class365_sub1_sub1.aShort9795 == i_5_)
		...
		try {
			...
			for (int i_15_ = i; i_15_ >= 0; i_15_--) {
				if (aClass326ArrayArrayArray3516[i_15_][i_12_][i_13_] == null) {
					Class326 class326 = (aClass326ArrayArrayArray3516[i_15_][i_12_][i_13_] = new Class326(
							i_15_));
					if (bool)
						class326.aByte3466++;
				}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.d(").append(')').toString());
		}
	}

	public int method4014(int i, int i_16_, byte i_17_) {
		try {
			return (null != ((Class331) this).aShortArrayArray3523 ? ((Class331) this).aShortArrayArray3523[i][i_16_] & 0xffff
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.x(").append(')').toString());
		}
	}

	public int method4015(int i, int i_18_, byte i_19_) {
		try {
			return (null != ((Class331) this).anIntArrayArray3522 ? (((Class331) this).anIntArrayArray3522[i][i_18_] & 0xffffff)
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.r(").append(')').toString());
		}
	}

	public int method4016(int i, int i_20_, byte i_21_) {
		try {
			return (((Class331) this).aByteArrayArray3524 != null ? ((Class331) this).aByteArrayArray3524[i][i_20_] & 0xff
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.q(").append(')').toString());
		}
	}

	public int method4017(int i, int i_22_, byte i_23_) {
		try {
			return (((Class331) this).aByteArrayArray3525 != null ? ((Class331) this).aByteArrayArray3525[i][i_22_] & 0xff
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.n(").append(')').toString());
		}
	}

	public int method4018(int i, int i_24_, int i_25_) {
		try {
			return (null != ((Class331) this).aByteArrayArray3527 ? ((Class331) this).aByteArrayArray3527[i][i_24_] & 0xff
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.z(").append(')').toString());
		}
	}

	public void method4019(int i, int i_26_, int i_27_, int i_28_, int i_29_,
			int i_30_, int i_31_, int i_32_, byte i_33_) {
		try {
			if (null != ((Class331) this).anIntArrayArray3522)
				((Class331) this).anIntArrayArray3522[i][i_26_] = ~0xffffff
						| i_27_;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.y(").append(')').toString());
		}
	}

	public void method4020(int i, int i_34_, int i_35_,
			Class365_Sub1_Sub5 class365_sub1_sub5,
			Class365_Sub1_Sub5 class365_sub1_sub5_36_, byte i_37_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.v(").append(')').toString());
		}
	}

	public void method4021(int i, int i_39_, int i_40_,
			Class365_Sub1_Sub3 class365_sub1_sub3,
			Class365_Sub1_Sub3 class365_sub1_sub3_41_, int i_42_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.g(").append(')').toString());
		}
	}

	public boolean method4022(Class365_Sub1_Sub1 class365_sub1_sub1,
			boolean bool, byte i) {
		try {
			...
			if (class365_sub1_sub1.aShort9798 < 0
					|| class365_sub1_sub1.aShort9795 < 0
					|| class365_sub1_sub1.aShort9796 >= 1988988347 * anInt3514
					|| class365_sub1_sub1.aShort9797 >= anInt3549 * 1340714547)
				return false;
			short i_48_ = 0;
			for (int i_49_ = class365_sub1_sub1.aShort9798; i_49_ <= class365_sub1_sub1.aShort9796; i_49_++) {
				for (int i_50_ = class365_sub1_sub1.aShort9795; i_50_ <= class365_sub1_sub1.aShort9797; i_50_++) {
					Class326 class326 = method4012(
							class365_sub1_sub1.plane, i_49_, i_50_,
							960411819);
					if (class326 != null) {
						Class322 class322 = Class238.method2199(
								class365_sub1_sub1, (byte) 47);
						...
						if (bool_44_
								&& 0 != ((((Class331) this).anIntArrayArray3522[i_49_][i_50_]) & ~0xffffff)) {
						...
						if (!bool
								&& null != class326.aClass365_Sub1_Sub2_3461
								&& (class326.aClass365_Sub1_Sub2_3461.aShort9801 > i_48_))
			...
			if (bool) {
				Class217 class217 = Class217.method2005(class365_sub1_sub1
		...
		try {
			...
			if (null != class326) {
				...
				if (null != class365_sub1_sub3) {
					class365_sub1_sub3.aShort9802 = (short) (i_57_
							* class365_sub1_sub3.aShort9802 / (16 << anInt3504
							* -1688804109 - 7));
					class365_sub1_sub3.aShort9803 = (short) (class365_sub1_sub3.aShort9803
							* i_57_ / (16 << -1688804109 * anInt3504 - 7));
				}
				if (class365_sub1_sub3_59_ != null) {
					class365_sub1_sub3_59_.aShort9802 = (short) (i_57_
							* class365_sub1_sub3_59_.aShort9802 / (16 << anInt3504
							* -1688804109 - 7));
					class365_sub1_sub3_59_.aShort9803 = (short) (class365_sub1_sub3_59_.aShort9803
							* i_57_ / (16 << anInt3504 * -1688804109 - 7));
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.c(").append(')').toString());
		}
	}
	...
	public Class365_Sub1_Sub3 method4027(int i, int i_66_, int i_67_, int i_68_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.l(").append(')').toString());
		}
	}

	public Class331(GraphicsToolkit class_ra, int i, int i_69_, int i_70_, int i_71_,
			int i_72_, boolean bool, boolean bool_73_) {
		...
		((Class331) this).aBoolean3510 = ((Class331) this).aClass_ra3508
				.method5048() > 0;
		anInt3504 = i * -1524575173;
		((Class331) this).anInt3536 = (1 << anInt3504 * -1688804109) * 732171711;
		((Class331) this).anInt3546 = -413418327
				* (((Class331) this).anInt3536 * 1828905535 >> 1);
		...
		((Class331) this).anInt3541 = 0;
		((Class331) this).aBooleanArrayArray3563 = (new boolean[(((Class331) this).anInt3538
				* 583010427 + ((Class331) this).anInt3538 * 583010427 + 1)][(((Class331) this).anInt3538
				* 583010427 + ((Class331) this).anInt3538 * 583010427 + 1)]);
		((Class331) this).aBooleanArrayArray3561 = (new boolean[2 + (583010427 * ((Class331) this).anInt3538 + ((Class331) this).anInt3538 * 583010427)][(583010427
				* ((Class331) this).anInt3538
				+ 583010427
				* ((Class331) this).anInt3538 + 2)]);
	...
	public Class365_Sub1_Sub1 method4028(int i, int i_74_, int i_75_,
			Interface17 interface17, short i_76_) {
		try {
			...
			for (Class322 class322 = class326.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
				Class365_Sub1_Sub1 class365_sub1_sub1 = class322.aClass365_Sub1_Sub1_3359;
				if ((interface17 == null || interface17.method229(
						class365_sub1_sub1, -98426520))
						&& class365_sub1_sub1.aShort9798 == i_74_
						&& class365_sub1_sub1.aShort9795 == i_75_) {
	...
	public Class365_Sub1_Sub4 method4034(int i, int i_94_, int i_95_, int i_96_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.ah(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub1 method4035(int i, int i_97_, int i_98_,
			Interface17 interface17, int i_99_) {
		try {
			...
			for (Class322 class322 = class326.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
				Class365_Sub1_Sub1 class365_sub1_sub1 = class322.aClass365_Sub1_Sub1_3359;
				if ((null == interface17 || interface17.method229(
						class365_sub1_sub1, 240755990))
						&& class365_sub1_sub1.aShort9798 == i_97_
						&& class365_sub1_sub1.aShort9795 == i_98_)
					return class365_sub1_sub1;
			}
			return null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.ai(").append(')').toString());
		}
	}
			...
			for (int i_103_ = 0; i_103_ < anInt3514 * 1988988347; i_103_++) {
				for (int i_104_ = 0; i_104_ < 1340714547 * anInt3549; i_104_++) {
					...
					if (null != class326) {
						...
						if (null != class365_sub1_sub5
								&& class365_sub1_sub5.method4366(1673017934)) {
							method4039(class365_sub1_sub5, i, i_103_, i_104_,
									1, 1);
							if (class365_sub1_sub5_105_ != null
									&& class365_sub1_sub5_105_
											.method4366(1884072683)) {
								method4039(class365_sub1_sub5_105_, i, i_103_,
										i_104_, 1, 1);
								class365_sub1_sub5_105_.method4355(
										((Class331) this).aClass_ra3508,
										class365_sub1_sub5, 0, 0, 0, false,
										1471147933);
						...
						for (Class322 class322 = class326.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
							Class365_Sub1_Sub1 class365_sub1_sub1 = class322.aClass365_Sub1_Sub1_3359;
							if (class365_sub1_sub1 != null
									&& class365_sub1_sub1
											.method4366(1908249416)) {
								method4039(
										class365_sub1_sub1,
										i,
										i_103_,
										i_104_,
										1 + (class365_sub1_sub1.aShort9796 - (class365_sub1_sub1.aShort9798)),
										(class365_sub1_sub1.aShort9797
												- class365_sub1_sub1.aShort9795 + 1));
								class365_sub1_sub1.method4398((byte) 61);
							}
						}
						Class365_Sub1_Sub2 class365_sub1_sub2 = class326.aClass365_Sub1_Sub2_3461;
						if (null != class365_sub1_sub2
								&& class365_sub1_sub2.method4366(1396337054)) {
							method4038(class365_sub1_sub2, i, i_103_, i_104_,
									795291520);
	...
	void method4038(Class365_Sub1 class365_sub1, int i, int i_106_, int i_107_,
			int i_108_) {
		try {
			if (i_106_ < anInt3514 * 1988988347) {
				...
				if (class326 != null
						&& class326.aClass365_Sub1_Sub2_3461 != null
						&& class326.aClass365_Sub1_Sub2_3461
								.method4366(1670858079))
					class365_sub1.method4355(((Class331) this).aClass_ra3508,
							class326.aClass365_Sub1_Sub2_3461,
							(1828905535 * ((Class331) this).anInt3536), 0, 0,
							true, 1480517000);
			}
			if (i_107_ < 1988988347 * anInt3514) {
				...
				if (class326 != null
						&& null != class326.aClass365_Sub1_Sub2_3461
						&& class326.aClass365_Sub1_Sub2_3461
								.method4366(1930175079))
					class365_sub1.method4355(((Class331) this).aClass_ra3508,
							class326.aClass365_Sub1_Sub2_3461, 0, 0,
							(1828905535 * ((Class331) this).anInt3536), true,
							1828441739);
			}
			if (i_106_ < 1988988347 * anInt3514
					&& i_107_ < anInt3549 * 1340714547) {
				Class326 class326 = aClass326ArrayArrayArray3516[i][1 + i_106_][i_107_ + 1];
				if (null != class326
						&& null != class326.aClass365_Sub1_Sub2_3461
						&& class326.aClass365_Sub1_Sub2_3461
								.method4366(2111976416))
					class365_sub1.method4355(((Class331) this).aClass_ra3508,
							class326.aClass365_Sub1_Sub2_3461,
							(((Class331) this).anInt3536 * 1828905535), 0,
							(((Class331) this).anInt3536 * 1828905535), true,
							1058354287);
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.ap(").append(')').toString());
		}
	}

	void method4039(Class365_Sub1 class365_sub1, int i, int i_109_, int i_110_,
				...
				for (int i_118_ = i_113_; i_118_ <= i_114_; i_118_++) {
					if (i_118_ >= 0 && i_118_ < anInt3514 * 1988988347) {
						for (int i_119_ = i_115_; i_119_ <= i_116_; i_119_++) {
							if (i_119_ >= 0
									&& i_119_ < 1340714547 * anInt3549
									&& (!bool || i_118_ >= i_114_
											|| i_119_ >= i_116_ || i_119_ < i_110_
											&& i_118_ != i_109_)) {
								Class326 class326 = (aClass326ArrayArrayArray3516[i_117_][i_118_][i_119_]);
								if (null != class326) {
									int i_120_ = (((aClass_xaArray3517[i_117_]
											.method6341(i_118_, i_119_,
													(byte) -40))
											+ (aClass_xaArray3517[i_117_]
													.method6341(1 + i_118_,
															i_119_, (byte) -92))
											+ (aClass_xaArray3517[i_117_]
													.method6341(i_118_,
															1 + i_119_,
															(byte) -41)) + (aClass_xaArray3517[i_117_]
											.method6341(i_118_ + 1, i_119_ + 1,
													(byte) -106))) / 4 - ((aClass_xaArray3517[i]
											.method6341(i_109_, i_110_,
													(byte) 0))
											+ (aClass_xaArray3517[i]
													.method6341(i_109_ + 1,
															i_110_, (byte) -79))
											+ (aClass_xaArray3517[i]
													.method6341(i_109_,
															1 + i_110_,
															(byte) -78)) + (aClass_xaArray3517[i]
											.method6341(1 + i_109_, 1 + i_110_,
													(byte) -80))) / 4);
									Class365_Sub1_Sub5 class365_sub1_sub5 = class326.aClass365_Sub1_Sub5_3457;
									Class365_Sub1_Sub5 class365_sub1_sub5_121_ = class326.aClass365_Sub1_Sub5_3458;
									if (class365_sub1_sub5 != null
											&& class365_sub1_sub5
													.method4366(2051783389))
										class365_sub1
												.method4355(
														((Class331) this).aClass_ra3508,
														class365_sub1_sub5,
														((((Class331) this).anInt3546 * 394962841 * (1 - i_111_)) + (1828905535 * ((Class331) this).anInt3536 * (i_118_ - i_109_))),
														i_120_,
														(((i_119_ - i_110_) * (1828905535 * (((Class331) this).anInt3536))) + (((Class331) this).anInt3546 * 394962841 * (1 - i_112_))),
														bool, 1604469537);
									if (class365_sub1_sub5_121_ != null
											&& class365_sub1_sub5_121_
													.method4366(1486894505))
										class365_sub1
												.method4355(
														((Class331) this).aClass_ra3508,
														class365_sub1_sub5_121_,
														((((Class331) this).anInt3536 * 1828905535 * (i_118_ - i_109_)) + (((Class331) this).anInt3546 * 394962841 * (1 - i_111_))),
														i_120_,
														((1828905535 * ((Class331) this).anInt3536 * (i_119_ - i_110_)) + ((1 - i_112_) * (394962841 * (((Class331) this).anInt3546)))),
														bool, 1798941005);
									for (Class322 class322 = class326.aClass322_3456; null != class322; class322 = class322.aClass322_3360) {
										Class365_Sub1_Sub1 class365_sub1_sub1 = (class322.aClass365_Sub1_Sub1_3359);
										if (class365_sub1_sub1 != null
												&& class365_sub1_sub1
														.method4366(1399351341)
												&& ((class365_sub1_sub1.aShort9798 == i_118_) || i_113_ == i_118_)
												&& ((class365_sub1_sub1.aShort9795 == i_119_) || i_115_ == i_119_)) {
											int i_122_ = 1 + ((class365_sub1_sub1.aShort9796) - (class365_sub1_sub1.aShort9798));
											int i_123_ = ((class365_sub1_sub1.aShort9797)
													- (class365_sub1_sub1.aShort9795) + 1);
											class365_sub1
													.method4355(
															(((Class331) this).aClass_ra3508),
															class365_sub1_sub1,
															((1828905535 * (((Class331) this).anInt3536) * ((class365_sub1_sub1.aShort9798) - i_109_)) + ((i_122_ - i_111_) * (394962841 * (((Class331) this).anInt3546)))),
															i_120_,
															((((class365_sub1_sub1.aShort9795) - i_110_) * ((((Class331) this).anInt3536) * 1828905535)) + (394962841 * (((Class331) this).anInt3546) * (i_123_ - i_112_))),
															bool, 784338104);
										}
									}
								}
	...
	public void method4040(int i, int i_124_, int i_125_, int i_126_,
			byte[][][] is, int[] is_127_, int[] is_128_, int[] is_129_,
			int[] is_130_, int[] is_131_, int i_132_, byte i_133_, int i_134_,
		...
		((Class331) this).anInt3553 = (i_124_ >> anInt3504 * -1688804109)
				* -14089225;
		...
		((Class331) this).anInt3533 = (1283818765 * ((Class331) this).anInt3553 - ((Class331) this).anInt3538
				* -1864237879);
		...
		((Class331) this).anInt3551 = (((Class331) this).anInt3513 * 1233371147 - ((Class331) this).anInt3538
				* -678030197);
		...
		((Class331) this).anInt3550 = (-1827235035
				* ((Class331) this).anInt3553 + ((Class331) this).anInt3538
				* -679030015);
		if (((Class331) this).anInt3550 * 945006459 > anInt3514 * 1988988347)
			((Class331) this).anInt3550 = anInt3514 * -1126318399;
		((Class331) this).anInt3552 = (((Class331) this).anInt3538
				* -1363529219 + ((Class331) this).anInt3513 * -690201987);
		...
		if (((Class331) this).aBoolean3511) {
			for (int i_140_ = 0; i_140_ < (583010427
					* ((Class331) this).anInt3538 + ((Class331) this).anInt3538
					* 583010427 + 2); i_140_++) {
				int i_141_ = 0;
				int i_142_ = 0;
				for (int i_143_ = 0; i_143_ < (583010427
						* ((Class331) this).anInt3538
						+ ((Class331) this).anInt3538 * 583010427 + 2); i_143_++) {
					if (i_143_ > 1)
						((Class331) this).anIntArray3562[i_143_ - 2] = i_141_;
					i_141_ = i_142_;
					int i_144_ = (((Class331) this).anInt3553 * -804213305
							- 583010427 * ((Class331) this).anInt3538 + i_140_);
					int i_145_ = (465603579 * ((Class331) this).anInt3513
							- ((Class331) this).anInt3538 * 583010427 + i_143_);
					if (i_144_ >= 0 && i_145_ >= 0
							&& i_144_ < 1988988347 * anInt3514
							&& i_145_ < 1340714547 * anInt3549) {
						int i_146_ = i_144_ << anInt3504 * -1688804109;
						int i_147_ = i_145_ << -1688804109 * anInt3504;
						int i_148_ = (aClass_xaArray3519[aClass_xaArray3519.length - 1]
								.method6341(i_144_, i_145_, (byte) -48) - (1000 << -1688804109
								* anInt3504 - 7));
						int i_149_ = ((null != aClass_xaArray3521 ? (aClass_xaArray3521[0]
								.method6341(i_144_, i_145_, (byte) -75) + 1828905535 * ((Class331) this).anInt3536)
								: (aClass_xaArray3519[0].method6341(i_144_,
										i_145_, (byte) -70) + 1828905535 * ((Class331) this).anInt3536)) + (1000 << anInt3504
								* -1688804109 - 7));
						i_142_ = (((Class331) this).aClass_ra3508.method5025(
								i_146_, i_148_, i_147_, i_146_, i_149_, i_147_));
					...
					if (i_140_ > 0 && i_143_ > 0) {
						int i_150_ = (((Class331) this).anIntArray3562[i_143_ - 1]
								& ((Class331) this).anIntArray3562[i_143_]
								& i_141_ & i_142_);
			...
			if (!bool_138_)
				...
				aClass333_3512.method4081(((Class331) this).aClass_ra3508,
						i_132_);
			}
		} else {
			if (null == ((Class331) this).aBooleanArrayArray3564)
				((Class331) this).aBooleanArrayArray3564 = (new boolean[(((Class331) this).anInt3538
						* 583010427 + 583010427 * ((Class331) this).anInt3538 + 2)][(583010427
						* ((Class331) this).anInt3538
						+ 583010427
						* ((Class331) this).anInt3538 + 2)]);
		...
		if (((Class331) this).aBoolean3510) {
			for (int i_153_ = 0; i_153_ < ((Class331) this).anInt3556
					* -2060364501; i_153_++)
				((Class331) this).aClass321Array3558[i_153_].method3918(i,
						bool, (byte) 1);
		}
		if (aClass326ArrayArrayArray3520 != null) {
			method4052(true, -740850409);
			((Class331) this).aClass_ra3508.method5057(-1, new Class78(1583160,
					40, 127, 63, 0, 0, 0));
	...
	void method4041(boolean bool, byte[][][] is, int i, byte i_154_, int i_155_) {
		...
		if (0 == (i_155_ & 0x2)) {
			for (Class365_Sub1 class365_sub1 = ((Class331) this).aClass365_Sub1Array3532[i_156_]; null != class365_sub1; class365_sub1 = ((Class365_Sub1) class365_sub1).aClass365_Sub1_7721) {
				...
				if (-1 != (-1235150701 * ((Class365_Sub1) class365_sub1).anInt7725)
						&& !method4045(class365_sub1, bool, is, i, i_154_))
		...
		if (0 == (i_155_ & 0x1)) {
			...
			for (Class365_Sub1 class365_sub1 = ((Class331) this).aClass365_Sub1Array3534[i_156_]; class365_sub1 != null; class365_sub1 = ((Class365_Sub1) class365_sub1).aClass365_Sub1_7721) {
				...
				if ((((Class365_Sub1) class365_sub1).anInt7725 * -1235150701 != -1)
						&& !method4045(class365_sub1, bool, is, i, i_154_)) {
			...
			if (!bool) {
				for (int i_157_ = 0; i_157_ < 1204219039 * ((Class331) this).anInt3541; i_157_++) {
					method4042(
							(((Class331) this).aClass365_Sub1_Sub1Array3539[i_157_]),
							-765484247);
					if (-1 != ((Class365_Sub1_Sub1) (((Class331) this).aClass365_Sub1_Sub1Array3539[i_157_])).anInt7725
							* -1235150701
							&& !method4045(
									(((Class331) this).aClass365_Sub1_Sub1Array3539[i_157_]),
									bool, is, i, i_154_)) {
						if (((Class331) this).aClass365_Sub1_Sub1Array3539[i_157_]
								.method4376((short) 255))
		...
		if (-1367168231 * ((Class331) this).anInt3535 > 0) {
			method4044(((Class331) this).aClass365_Sub1Array3515, 0,
					-1367168231 * ((Class331) this).anInt3535 - 1);
			for (int i_158_ = 0; i_158_ < ((Class331) this).anInt3535
					* -1367168231; i_158_++)
				method4046(((Class331) this).aClass365_Sub1Array3515[i_158_],
						((Class331) this).aClass298_Sub10Array3529);
		}
		if (((Class331) this).aBoolean3510)
			...
			for (int i_159_ = 0; i_159_ < anInt3548 * 1678382205; i_159_++) {
				if (i_159_ >= i && null != is) {
					...
					if ((((Class331) this).aBooleanArrayArray3563.length + 1387802915 * ((Class331) this).anInt3533) > 1988988347 * anInt3514)
						i_160_ -= (((Class331) this).anInt3533
								* 1387802915
								+ (((Class331) this).aBooleanArrayArray3563).length - 1988988347 * anInt3514);
					...
					if ((1655515601 * ((Class331) this).anInt3551 + ((Class331) this).aBooleanArrayArray3563[0].length) > anInt3549 * 1340714547)
						i_161_ -= (1655515601
								* ((Class331) this).anInt3551
								+ (((Class331) this).aBooleanArrayArray3563[0]).length - 1340714547 * anInt3549);
					boolean[][] bools = ((Class331) this).aBooleanArrayArray3561;
					if (((Class331) this).aBoolean3511) {
						for (int i_162_ = -1810993483
								* ((Class331) this).anInt3547; i_162_ < i_160_; i_162_++) {
							int i_163_ = (((Class331) this).anInt3533
									* 1387802915 + i_162_ - (-1810993483 * ((Class331) this).anInt3547));
							for (int i_164_ = (((Class331) this).anInt3507 * -301075153); i_164_ < i_161_; i_164_++) {
								...
								if (((Class331) this).aBooleanArrayArray3563[i_162_][i_164_]) {
									int i_165_ = (i_164_
											+ (1655515601 * ((Class331) this).anInt3551) - (((Class331) this).anInt3507 * -301075153));
									for (int i_166_ = i_159_; i_166_ >= 0; i_166_--) {
										if ((aClass326ArrayArrayArray3516[i_166_][i_163_][i_165_]) != null
												&& (aClass326ArrayArrayArray3516[i_166_][i_163_][i_165_].aByte3466) == i_159_) {
											if ((i_166_ >= i && (is[i_166_][i_163_][i_165_] == i_154_))
													|| (aClass333_3512
															.method4071(i_159_,
																	i_163_,
																	i_165_)))
					...
					aClass_xaArray3517[i_159_].method6338(-804213305
							* ((Class331) this).anInt3553,
							((Class331) this).anInt3513 * 465603579,
							((Class331) this).anInt3538 * 583010427,
							((Class331) this).aBooleanArrayArray3561, false,
							i_155_);
				} else {
					...
					if ((1387802915 * ((Class331) this).anInt3533 + ((Class331) this).aBooleanArrayArray3563.length) > anInt3514 * 1988988347)
						i_167_ -= (1387802915
								* ((Class331) this).anInt3533
								+ (((Class331) this).aBooleanArrayArray3563).length - 1988988347 * anInt3514);
					int i_168_ = ((Class331) this).aBooleanArrayArray3563[0].length;
					if ((1655515601 * ((Class331) this).anInt3551 + ((Class331) this).aBooleanArrayArray3563[0].length) > anInt3549 * 1340714547)
						i_168_ -= ((((Class331) this).aBooleanArrayArray3563[0]).length
								+ ((Class331) this).anInt3551 * 1655515601 - anInt3549 * 1340714547);
					boolean[][] bools = ((Class331) this).aBooleanArrayArray3561;
					if (((Class331) this).aBoolean3511) {
						for (int i_169_ = ((Class331) this).anInt3547
								* -1810993483; i_169_ < i_167_; i_169_++) {
							int i_170_ = (i_169_ + ((Class331) this).anInt3533
									* 1387802915 - (-1810993483 * ((Class331) this).anInt3547));
							for (int i_171_ = (((Class331) this).anInt3507 * -301075153); i_171_ < i_168_; i_171_++) {
								if ((((Class331) this).aBooleanArrayArray3563[i_169_][i_171_])
										&& !(aClass333_3512
												.method4071(
														i_159_,
														i_170_,
														(i_171_
																+ (((Class331) this).anInt3551 * 1655515601) - (((Class331) this).anInt3507 * -301075153)))))
					...
					aClass_xaArray3517[i_159_].method6338(
							((Class331) this).anInt3553 * -804213305,
							((Class331) this).anInt3513 * 465603579,
							583010427 * ((Class331) this).anInt3538,
							((Class331) this).aBooleanArrayArray3561, true,
							i_155_);
				}
			}
		}
		if (708424067 * ((Class331) this).anInt3560 > 0) {
			method4043(((Class331) this).aClass365_Sub1Array3503, 0,
					708424067 * ((Class331) this).anInt3560 - 1);
			for (int i_172_ = 0; i_172_ < ((Class331) this).anInt3560 * 708424067; i_172_++)
				method4046(((Class331) this).aClass365_Sub1Array3503[i_172_],
						((Class331) this).aClass298_Sub10Array3529);
		}
	}
	...
	void method4042(Class365_Sub1 class365_sub1, int i) {
		try {
			...
			((Class331) this).aClass_ra3508.method5060(
					(float) (int) class217.aFloat2451,
					(float) ((int) class217.aFloat2455 + (class365_sub1
							.method4361(1951240662) >> 1)),
					(float) (int) class217.aFloat2454,
					((Class331) this).aFloatArray3505);
			((Class365_Sub1) class365_sub1).anInt7725 = 144688539 * (int) ((Class331) this).aFloatArray3505[2];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.aj(").append(')').toString());
		}
	}
	...
	void method4043(Class365_Sub1[] class365_sub1s, int i, int i_173_) {
		if (i < i_173_) {
			...
			int i_176_ = -1235150701
					* ((Class365_Sub1) class365_sub1).anInt7725;
			for (int i_177_ = i; i_177_ < i_173_; i_177_++) {
				if ((-1235150701 * ((Class365_Sub1) class365_sub1s[i_177_]).anInt7725) > (i_177_ & 0x1)
						+ i_176_) {
	...
	void method4044(Class365_Sub1[] class365_sub1s, int i, int i_179_) {
		if (i < i_179_) {
			...
			int i_182_ = ((Class365_Sub1) class365_sub1).anInt7725
					* -1235150701;
			for (int i_183_ = i; i_183_ < i_179_; i_183_++) {
				if ((-1235150701 * ((Class365_Sub1) class365_sub1s[i_183_]).anInt7725) < (i_183_ & 0x1)
						+ i_182_) {
	...
	boolean method4045(Class365_Sub1 class365_sub1, boolean bool,
			byte[][][] is, int i, byte i_185_) {
		if (!((Class331) this).aBoolean3511)
			return false;
		if (class365_sub1 instanceof Class365_Sub1_Sub1) {
			...
			for (int i_190_ = i_188_; i_190_ <= i_186_; i_190_++) {
				for (int i_191_ = i_189_; i_191_ <= i_187_; i_191_++) {
					if (class365_sub1.aByte7724 < 1678382205 * anInt3548
							&& i_190_ >= ((Class331) this).anInt3533 * 1387802915
							&& i_190_ < ((Class331) this).anInt3550 * 945006459
							&& i_191_ >= 1655515601 * ((Class331) this).anInt3551
							&& i_191_ < ((Class331) this).anInt3552 * 779833815) {
						if ((is != null && class365_sub1.plane >= i && (is[class365_sub1.plane][i_190_][i_191_] == i_185_))
								|| !class365_sub1.method4360(1467136065)
								|| class365_sub1.method4364(
										(((Class331) this).aClass_ra3508),
										(byte) -33)) {
							if (!bool
									&& i_190_ >= (((Class331) this).anInt3553 * -804213305) - 16
									&& i_190_ <= -804213305
											* (((Class331) this).anInt3553)
											+ 16
									&& i_191_ >= (((Class331) this).anInt3513 * 465603579) - 16
									&& i_191_ <= 16 + 465603579 * ((Class331) this).anInt3513)
								class365_sub1.method4357(
										(((Class331) this).aClass_ra3508),
										1659529754);
							return true;
						}
		...
		if (class365_sub1.aByte7724 < anInt3548 * 1678382205
				&& i_192_ >= 1387802915 * ((Class331) this).anInt3533
				&& i_192_ < 945006459 * ((Class331) this).anInt3550
				&& i_193_ >= 1655515601 * ((Class331) this).anInt3551
				&& i_193_ < 779833815 * ((Class331) this).anInt3552) {
			if ((is != null && class365_sub1.plane >= i && is[class365_sub1.plane][i_192_][i_193_] == i_185_)
					|| !class365_sub1.method4360(1252283375)
					|| class365_sub1.method4364(
							((Class331) this).aClass_ra3508, (byte) 91)) {
				if (!bool
						&& i_192_ >= ((Class331) this).anInt3553 * -804213305
								- 16
						&& i_192_ <= 16 + -804213305
								* ((Class331) this).anInt3553
						&& i_193_ >= 465603579 * ((Class331) this).anInt3513 - 16
						&& i_193_ <= 16 + 465603579 * ((Class331) this).anInt3513)
					class365_sub1.method4357(((Class331) this).aClass_ra3508,
							1423007257);
				return true;
			}
			return false;
	...
	void method4046(Class365_Sub1 class365_sub1,
			Class298_Sub10[] class298_sub10s) {
		if (((Class331) this).aBoolean3510) {
		...
		if (aClass_xaArray3517 == aClass_xaArray3521) {
			...
			((Class331) this).aClass_ra3508.method5058(aClass_xaArray3519[0]
					.method6340((int) class217.aFloat2451,
							(int) class217.aFloat2454, -1986155301), class78);
		}
		Class335 class335 = class365_sub1.method4394(
				((Class331) this).aClass_ra3508, -461368503);
		if (null != class335) {
	...
	public void method4047(Class_na class_na, int i, int i_196_, int i_197_,
			boolean[] bools, int i_198_) {
		try {
				...
				for (int i_200_ = 0; i_200_ <= i; i_200_++) {
					if (bools == null || bools[i_200_]) {
						...
						if (null == class_xa) {
							...
							class_xa.NA(class_na, i_196_, (i_199_ - class_xa
									.method6340(i_196_, i_197_, -1764966761)),
									i_197_, 0, false);
					}
				}
			}
	...
	void method4048(int i, int i_201_, int i_202_) {
		try {
							...
							if (null != class_na) {
								...
								for (int i_208_ = i_203_ - 1; i_208_ >= 0; i_208_--) {
									...
									if (class_xa_209_ == null) {
										...
										int i_210_ = (class_xa.method6341(
												i_205_, i_204_, (byte) -85) - (class_xa_209_
												.method6341(i_205_, i_204_,
														(byte) -14)));
										int i_211_ = (class_xa
												.method6341(1 + i_205_, i_204_,
														(byte) -116) - (class_xa_209_
												.method6341(1 + i_205_, i_204_,
														(byte) -55)));
										int i_212_ = (class_xa.method6341(
												1 + i_205_, i_204_ + 1,
												(byte) -109) - (class_xa_209_
												.method6341(1 + i_205_,
														i_204_ + 1, (byte) -78)));
										int i_213_ = (class_xa
												.method6341(i_205_, 1 + i_204_,
														(byte) -117) - (class_xa_209_
												.method6341(i_205_, 1 + i_204_,
														(byte) -112)));
										class_xa_209_
												.UA(
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.ac(").append(')').toString());
		}
	}

	public void method4049(byte i) {
		try {
			for (int i_214_ = 0; i_214_ < -2060364501
					* ((Class331) this).anInt3556; i_214_++) {
				if (!((Class331) this).aBooleanArray3559[i_214_]) {
					...
					int i_219_ = (class298_sub10.method2895(823958259) - i_216_ >> anInt3504
							* -1688804109);
					int i_220_ = (class298_sub10.method2897((byte) 84) - i_216_ >> -1688804109
							* anInt3504);
					int i_221_ = (class298_sub10.method2897((byte) 73) + i_216_ >> anInt3504
							* -1688804109);
					if (i_220_ < 0) {
						i_218_ -= i_220_;
						i_220_ = 0;
					...
					for (int i_222_ = i_220_; i_222_ <= i_221_; i_222_++) {
						...
						for (int i_228_ = i_226_; i_228_ <= i_227_; i_228_++) {
							int i_229_ = 1;
							Class365_Sub1_Sub1 class365_sub1_sub1 = method4035(
									i_215_, i_228_, i_222_, null, -741941433);
							if (null != class365_sub1_sub1
									&& 0 != ((Class365_Sub1_Sub1) class365_sub1_sub1).aByte9800) {
					...
					if (aBoolean3540)
						aClass_xaArray3517[i_215_].method6342(class298_sub10,
								is);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.bf(").append(')').toString());
		}
	}
			...
			for (int i_244_ = 0; i_244_ < anInt3514 * 1988988347; i_244_++) {
				for (int i_245_ = 0; i_245_ < anInt3549 * 1340714547; i_245_++) {
					if (null == aClass326ArrayArrayArray3516[0][i_244_][i_245_])
						aClass326ArrayArrayArray3516[0][i_244_][i_245_] = new Class326(
								0);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.p(").append(')').toString());
		}
	}
	...
	public void method4051(Class321 class321, int i) {
		try {
			if (((Class331) this).anInt3556 * -2060364501 < 65391) {
				Class298_Sub10 class298_sub10 = class321.aClass298_Sub10_3337;
				((Class331) this).aClass321Array3558[-2060364501
						* ((Class331) this).anInt3556] = class321;
				((Class331) this).aBooleanArray3559[((Class331) this).anInt3556
						* -2060364501] = false;
				...
				for (int i_248_ = i_246_; i_248_ <= i_247_; i_248_++) {
					int i_249_ = 0;
					int i_250_ = ((class298_sub10.method2897((byte) 46)
							- class298_sub10.method2900(1506691) + 394962841 * ((Class331) this).anInt3546) >> anInt3504
							* -1688804109);
					if (i_250_ < 0) {
						i_249_ -= i_250_;
						i_250_ = 0;
					}
					int i_251_ = ((class298_sub10.method2897((byte) 8)
							+ class298_sub10.method2900(-884319007) - ((Class331) this).anInt3546 * 394962841) >> -1688804109
							* anInt3504);
					...
					for (int i_252_ = i_250_; i_252_ <= i_251_; i_252_++) {
						...
						int i_254_ = (((class298_sub10.method2895(823958259)
								- class298_sub10.method2900(-701525248) + ((Class331) this).anInt3546 * 394962841) >> anInt3504
								* -1688804109) + (i_253_ >>> 8));
						...
						for (int i_256_ = i_254_; i_256_ <= i_255_; i_256_++) {
							...
							if ((l & 0xffffL) == 0L)
								((Class331) this).aLongArrayArrayArray3554[i_248_][i_256_][i_252_] = l
										| (long) (((Class331) this).anInt3556 * -2060364501);
							else if ((l & 0xffff0000L) == 0L)
								((Class331) this).aLongArrayArrayArray3554[i_248_][i_256_][i_252_] = l
										| (long) (((Class331) this).anInt3556 * -2060364501) << 16;
							else if ((l & 0xffff00000000L) == 0L)
								((Class331) this).aLongArrayArrayArray3554[i_248_][i_256_][i_252_] = l
										| (long) (((Class331) this).anInt3556 * -2060364501) << 32;
							else if ((l & ~0xffffffffffffL) == 0L)
								((Class331) this).aLongArrayArrayArray3554[i_248_][i_256_][i_252_] = l
										| (long) (((Class331) this).anInt3556 * -2060364501) << 48;
						}
					}
				}
			}
	...
	public void method4052(boolean bool, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.b(").append(')').toString());
		}
	}

	public void method4053(int i, int i_257_, int i_258_, int i_259_,
			Class365_Sub1_Sub4 class365_sub1_sub4, int i_260_) {
		try {
			Class326 class326 = method4012(i, i_257_, i_258_, 1185117443);
			if (null != class326) {
				class365_sub1_sub4
						.method4340(new Class217(
								(float) ((i_257_ << anInt3504 * -1688804109) + (394962841 * ((Class331) this).anInt3546)),
								(float) i_259_,
								(float) ((i_258_ << -1688804109 * anInt3504) + 394962841 * (((Class331) this).anInt3546))));
	...
	public Class365_Sub1_Sub3 method4054(int i, int i_262_, int i_263_,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.o(").append(')').toString());
		}
	}

	public boolean method4055(Class_na class_na, int i, int i_265_, int i_266_,
			boolean[] bools, int i_267_) {
		try {
			boolean bool = false;
			if (aClass_xaArray3521 != aClass_xaArray3517) {
				...
				for (/**/; i_269_ <= i; i_269_++) {
					...
					if (null == class_xa) {
						...
						int i_270_ = i_268_
								- class_xa.method6340(i_265_, i_266_,
										-1859389272);
						if (bools != null) {
							bools[i_269_] = class_xa.method6353(class_na,
									i_265_, i_270_, i_266_, 0, false);
							if (!bools[i_269_]) {
								if (i_267_ == 2008908432)
									throw new IllegalStateException();
								continue;
	...
	public void method4056(int i, Class_xa class_xa, byte i_271_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.u(").append(')').toString());
		}
	}

	public void method4057(int i, int i_272_, int i_273_,
			Class365_Sub1_Sub2 class365_sub1_sub2, int i_274_) {
		try {
	...
	public Class365_Sub1_Sub4 method4059(int i, int i_279_, int i_280_,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.aa(").append(')').toString());
		}
	}

	public int method4060(int i, int i_282_, int i_283_) {
		try {
			return (((Class331) this).aByteArrayArray3526 != null ? ((Class331) this).aByteArrayArray3526[i][i_282_] & 0xff
					: 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.s(").append(')').toString());
		}
	}
	...
	static final void method4061(Class403 class403, byte i) {
		try {
			...
			if (i_284_ >= 0 && i_284_ < 2
					&& null != client.anIntArrayArrayArray8767[i_284_]
					&& i_285_ >= 0
					&& i_285_ < client.anIntArrayArrayArray8767[i_284_].length) {
				client.anIntArrayArrayArray8767[i_284_][i_285_] = new int[] {
						(i_286_ >> 14 & 0x3fff) << 9, i_287_ << 2,
						(i_286_ & 0x3fff) << 9, i_290_ };
				client.anIntArrayArrayArray8767[i_284_][1 + i_285_] = new int[] {
						(i_288_ >> 14 & 0x3fff) << 9, i_289_ << 2,
						(i_288_ & 0x3fff) << 9 };
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nu.afm(").append(')').toString());
		}
	}
