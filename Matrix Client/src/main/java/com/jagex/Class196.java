...
public class Class196 implements Interface7_Impl2 {
	...
	Class196(Class_ra_Sub3_Sub2 class_ra_sub3_sub2, Class77 class77,
			boolean bool) {
	...
	public void method113(int i) {
		((Class196) this).anInt8587 = ((Class196) this).aClass77_8589.anInt724
				* 685647847 * i;
		if (((Class196) this).anInt8587 > ((Class196) this).anInt8586) {
			...
			if (((Class196) this).aBoolean8588) {
				...
				i_1_ = 1;
			((Class196) this).aLong8590 = (IDirect3DDevice
					.CreateIndexBuffer(
							((Class_ra_Sub3_Sub2) ((Class196) this).aClass_ra_Sub3_Sub2_8585).aLong9847,
							((Class196) this).anInt8587,
							i_0_,
							(((Class196) this).aClass77_8589 == Class77.aClass77_718 ? 101
									: 102), i_1_));
	...
	public boolean method63(int i, int i_4_, long l) {
		return jagdx.a.f(IDirect3DIndexBuffer.Upload(
				((Class196) this).aLong8590, i, i_4_,
				((Class196) this).aBoolean8588 ? 8192 : 0, l));
	}
	...
	void method1874() {
		if (((Class196) this).aLong8590 != 0L) {
			((Class196) this).aClass_ra_Sub3_Sub2_8585
					.method5552(((Class196) this).aLong8590);
			((Class196) this).aLong8590 = 0L;
		}
		((Class196) this).anInt8586 = 0;
		((Class196) this).anInt8587 = 0;
	...
	public long method62(int i, int i_5_) {
		return IDirect3DIndexBuffer.Lock(((Class196) this).aLong8590, i, i_5_,
				(((Class196) this).aBoolean8588 ? 8192 : 0));
	}
	...
	public boolean method61(int i, int i_6_, long l) {
		return jagdx.a.f(IDirect3DIndexBuffer.Upload(
				((Class196) this).aLong8590, i, i_6_,
				((Class196) this).aBoolean8588 ? 8192 : 0, l));
	}

	public boolean method67(int i, int i_7_, long l) {
		return jagdx.a.f(IDirect3DIndexBuffer.Upload(
				((Class196) this).aLong8590, i, i_7_,
				((Class196) this).aBoolean8588 ? 8192 : 0, l));
	}
	...
	public long method68(int i, int i_8_) {
		return IDirect3DIndexBuffer.Lock(((Class196) this).aLong8590, i, i_8_,
				(((Class196) this).aBoolean8588 ? 8192 : 0));
	}
