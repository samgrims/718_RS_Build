package com.jagex;/* Class197 - Decompiled by JODE
...
public class Class197 {
	...
	public int method1878(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ii.i(").append(')').toString());
		}
	}

	public Class505 method1879(Interface10 interface10, int i, int i_3_) {
		try {
			Class454 class454 = method1885(interface10, i, true, true,
					-160012913);
			if (null == class454)
				return null;
	...
	public void method1881(int i, int i_4_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ii.r(").append(')').toString());
		}
	}

	public void method1882(Interface10 interface10, byte i) {
		try {
			((Class197) this).aMap1990 = new HashMap(
					((Class197) this).anIntArray1991.length);
			for (int i_5_ = 0; i_5_ < ((Class197) this).anIntArray1991.length; i_5_++) {
				...
				Class505 class505 = Class255.method2439(
						((Class197) this).aClass243_1988, i_6_, -227622319);
				byte[] is = ((Class197) this).aClass243_1987.method2294(i_6_,
						(byte) 82);
				Object object = interface10.method131(is, class505, true,
						-2012626904);
				((Class197) this).aMap1990.put(Integer.valueOf(i_5_),
						new Class454(object, class505));
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ii.a(").append(')').toString());
		}
	}

	public Object method1883(Interface10 interface10, int i, boolean bool,
			boolean bool_7_, int i_8_) {
		try {
			Class454 class454 = method1885(interface10, i, bool, bool_7_,
					229227815);
			if (class454 == null)
				return null;
	...
	public void method1884(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ii.q(").append(')').toString());
		}
	}

	Class454 method1885(Interface10 interface10, int i, boolean bool,
		...
		try {
			...
			if (((Class197) this).anIntArray1991 != null) {
				for (int i_11_ = 0; i_11_ < ((Class197) this).anIntArray1991.length; i_11_++) {
					if (i == ((Class197) this).anIntArray1991[i_11_])
						return (Class454) ((Class197) this).aMap1990
								.get(Integer.valueOf(i_11_));
				}
			}
			Class454 class454 = ((Class454) ((Class197) this).aClass348_1989
					.method4184((long) (i << 1 | (bool_9_ ? 1 : 0))));
			if (null != class454) {
				if (bool && class454.anObject5646 == null) {
					Class505 class505 = Class255.method2439(
							((Class197) this).aClass243_1988, i, -221293891);
					if (null == class505)
						return null;
			...
			byte[] is = ((Class197) this).aClass243_1987.method2294(i,
					(byte) 54);
			if (null == is)
				return null;
			Class505 class505 = Class255.method2439(
					((Class197) this).aClass243_1988, i, 1718390038);
			if (class505 == null)
				return null;
			if (bool)
				class454 = new Class454(interface10.method131(is, class505,
						bool_9_, -1761009560), class505);
			else
				class454 = new Class454(interface10.method131(is, class505,
						bool_9_, -2090037397), null);
			((Class197) this).aClass348_1989.method4194(class454,
					(long) (i << 1 | (bool_9_ ? 1 : 0)));
			return class454;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ii.u(").append(')').toString());
		}
	}
	...
	static final void method1886(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1086526073
					* class105.anInt1262;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ii.px(").append(')').toString());
		}
	}
