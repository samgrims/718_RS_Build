...
public class Class82_Sub13 extends Class82 {
	...
	public void method866(int i) {
		try {
			...
			client.anInt8720 = -1656733051
					* (392492523 * ((Class82_Sub13) this).anInt6869 & 0xff);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ya.f(").append(')').toString());
		}
	}

	Class82_Sub13(RsByteBuffer class298_sub53) {
		super(class298_sub53);
		((Class82_Sub13) this).anInt6868 = class298_sub53
				.readUnsignedShort()
				* -477707085;
		((Class82_Sub13) this).anInt6869 = class298_sub53
				.readInt((byte) -19)
				* -1164408125;
	}
	...
	public void method868() {
		...
		client.anInt8681 = 563175129 * (392492523 * ((Class82_Sub13) this).anInt6869 >>> 24);
		client.anInt8731 = (-1719011785 * (((Class82_Sub13) this).anInt6869 * 392492523 >>> 16 & 0xff));
		client.anInt8732 = -1294785203
				* (392492523 * ((Class82_Sub13) this).anInt6869 >>> 8 & 0xff);
		client.anInt8720 = -1656733051
				* (392492523 * ((Class82_Sub13) this).anInt6869 & 0xff);
	}
	...
	public static final int method910(Class433 class433, byte[] is, int i,
