...
public class Class47_Sub9 extends Class47 {
	...
	void method505(boolean bool) {
		Class30_Sub1 class30_sub1 = ((Class47_Sub9) this).aClass_ra_Sub2_491
				.method5280();
		if (((Class47_Sub9) this).aBoolean6809 && class30_sub1 != null) {
			...
			((Class47_Sub9) this).aClass_ra_Sub2_491
					.method5256(((Class45) ((Class47_Sub9) this).aClass45_6813).aClass30_Sub4_485);
			...
			OpenGL
					.glUniform3f(
							...
							-(((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloatArray8124[0]),
							-(((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloatArray8124[1]),
							-(((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloatArray8124[2]));
			OpenGL
					.glUniform4f(
							OpenGL.glGetUniformLocation(i, "sunColour"),
							(((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloat8125),
							(((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloat8128),
							(((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aFloat8191),
							1.0F);
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i, "sunExponent"),
							96.0F + Math
									.abs(((Class_ra_Sub2) (((Class47_Sub9) this).aClass_ra_Sub2_491)).aFloatArray8124[1]) * 928.0F);
	...
	void method503(int i, int i_0_) {
		if (((Class47_Sub9) this).aBoolean6811) {
			...
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i_4_, "time"),
							(float) (i_1_
									* ((Class_ra_Sub2) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
	...
	void method516(int i, int i_15_) {
		if (((Class47_Sub9) this).aBoolean6811) {
			...
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i_19_, "time"),
							(float) (i_16_
									* ((Class_ra_Sub2) (((Class47_Sub9) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_19_, "scale"), f);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_19_,
					"breakWaterDepth"), (float) i_17_);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_19_,
					"breakWaterOffset"), f_18_);
		}
	}
	...
	Class47_Sub9(Class_ra_Sub2 class_ra_sub2, Class45 class45) {
		...
		if ((((Class45) ((Class47_Sub9) this).aClass45_6813).aClass30_Sub4_485 != null)
				&& (((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aBoolean8183)
				&& (((Class_ra_Sub2) ((Class47_Sub9) this).aClass_ra_Sub2_491).aBoolean8093)) {
			...
			Class48 class48_20_ = (Class48
					.method526(
							...
							35632,
							"varying vec3 wvVertex;\nvarying float waterDepth;\nuniform vec3 sunDir;\nuniform vec4 sunColour;\nuniform float sunExponent;\nuniform float breakWaterDepth;\nuniform float breakWaterOffset;\nuniform sampler3D normalSampler;\nuniform samplerCube envMapSampler;\nvoid main() {\nvec4 wnNormal = texture3D(normalSampler, gl_TexCoord[0].xyz).rbga;\nwnNormal.xyz = 2.0*wnNormal.xyz-1.0;\nvec3 wnVector = normalize(wvVertex);\nvec3 wnReflection = reflect(wnVector, wnNormal.xyz);\nvec3 envColour = textureCube(envMapSampler, wnReflection).rgb;\nvec4 specularColour = sunColour*pow(clamp(-dot(sunDir, wnReflection), 0.0, 1.0), sunExponent);\nfloat shoreFactor = clamp(waterDepth/breakWaterDepth-breakWaterOffset*wnNormal.w, 0.0, 1.0);\nfloat ndote = dot(wnVector, wnNormal.xyz);\nfloat fresnel = pow(1.0-abs(ndote), 2.0);\nvec4 surfaceColour = vec4(envColour, fresnel*shoreFactor)+specularColour*shoreFactor;\ngl_FragColor = vec4(mix(surfaceColour.rgb, gl_Fog.color.rgb, gl_FogFragCoord), surfaceColour.a);\n}\n"));
			((Class47_Sub9) this).aClass29_6812 = Class29.method406(
					((Class47_Sub9) this).aClass_ra_Sub2_491, new Class48[] {
							class48, class48_20_ });
