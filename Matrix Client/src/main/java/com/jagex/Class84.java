package com.jagex;/* Class84 - Decompiled by JODE
...
public class Class84 {
	...
	Class84 method945(int i, int i_0_) {
		try {
			return new Class84(1834782277 * anInt768, i,
					-1606786303 * anInt766, anInt769 * 2010148771);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dk.a(").append(')').toString());
		}
	}
	...
	static void method946(String[] strings, short[] is, int i, int i_4_,
			int i_5_) {
		try {
			if (i < i_4_) {
				int i_6_ = (i_4_ + i) / 2;
				...
				for (int i_9_ = i; i_9_ < i_4_; i_9_++) {
					if (null == string
							|| (null != strings[i_9_] && strings[i_9_]
									.compareTo(string) < (i_9_ & 0x1))) {
	...
	static final void method948(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.COLOR_ID_PACKET,
					client.aClass25_8711.aClass449_330, (byte) 54);
			class298_sub36.out
					.writeShort(i_13_, 16711935);
			client.aClass25_8711.method390(class298_sub36, (byte) -99);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dk.sd(").append(')').toString());
		}
	}
	...
	static final void method951(Class403 class403, int i) {
		try {
			IComponentDefinition class105 = (((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242.aClass119_10131
					.method1297(
