		...
		try {
			Class369 class369 = Class316.aClass362_3318
					.method4307(
							...
							245040087);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class369.anIntArray4019 == null ? 0
					: class369.anIntArray4019.length);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rd.t(").append(')').toString());
		}
	}
