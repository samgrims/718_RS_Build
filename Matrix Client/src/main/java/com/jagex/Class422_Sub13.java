package com.jagex;/* Class422_Sub13 - Decompiled by JODE
...
public class Class422_Sub13 extends Class422 {
	...
	public void method5673(byte i) {
		try {
			if (aClass298_Sub48_5346.aClass422_Sub14_7571.method5679(16711680)
					&& !Class261.method2465(
							aClass298_Sub48_5346.aClass422_Sub14_7571
									.method5677(-1298559578), 1142209695))
				anInt5350 = 0;
			if (anInt5350 * -1598873795 < 0 || anInt5350 * -1598873795 > 2)
				anInt5350 = method5611(-1016152227) * 1886334997;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ado.s(").append(')').toString());
		}
	}
	...
	public boolean method5674(int i) {
		try {
			if (!Class261.method2465(aClass298_Sub48_5346.aClass422_Sub14_7571
					.method5677(-541516290), 718607573))
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ado.z(").append(')').toString());
		}
	}
	...
	public int method5616(int i) {
		if (!Class261.method2465(aClass298_Sub48_5346.aClass422_Sub14_7571
				.method5677(-2048845946), -31427967))
			return 3;
		return 1;
	}
	...
	public int method5612(int i, int i_1_) {
		try {
			if (!Class261.method2465(aClass298_Sub48_5346.aClass422_Sub14_7571
					.method5677(-1771476690), -1583872086))
				return 3;
			return 1;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ado.f(").append(')').toString());
		}
	}

	static void method5676(int i, int i_2_, int i_3_, int i_4_, int i_5_,
		...
		try {
			...
			if (i_2_ >= 1155384281 * Class372_Sub1_Sub1.anInt4049
					&& i_2_ <= Class372_Sub1_Sub1.anInt4050 * -1062447355) {
				int[] is = Class372_Sub1_Sub1.anIntArrayArray4047[i_2_];
				int i_40_ = Class463.method6012(i - i_3_,
						(Class372_Sub1_Sub1.anInt4051 * -1424479739),
						(Class372_Sub1_Sub1.anInt4048 * 1135094847),
						-1212608691);
				int i_41_ = Class463.method6012(i + i_3_,
						(-1424479739 * Class372_Sub1_Sub1.anInt4051),
						(Class372_Sub1_Sub1.anInt4048 * 1135094847),
						-1212608691);
				int i_42_ = Class463.method6012(i - i_12_,
						(Class372_Sub1_Sub1.anInt4051 * -1424479739),
						(1135094847 * Class372_Sub1_Sub1.anInt4048),
						-1212608691);
				int i_43_ = Class463.method6012(i_12_ + i,
						(Class372_Sub1_Sub1.anInt4051 * -1424479739),
						(Class372_Sub1_Sub1.anInt4048 * 1135094847),
						-1212608691);
			...
			while (i_10_ > 0) {
				...
				if (i_45_ >= Class372_Sub1_Sub1.anInt4049 * 1155384281
						&& i_44_ <= -1062447355 * Class372_Sub1_Sub1.anInt4050) {
					int i_46_ = Class463.method6012(i + i_9_,
							(Class372_Sub1_Sub1.anInt4051 * -1424479739),
							(1135094847 * Class372_Sub1_Sub1.anInt4048),
							-1212608691);
					int i_47_ = Class463.method6012(i - i_9_,
							(-1424479739 * Class372_Sub1_Sub1.anInt4051),
							(Class372_Sub1_Sub1.anInt4048 * 1135094847),
							-1212608691);
					if (bool) {
						int i_48_ = (Class463.method6012(i + i_11_, -1424479739
								* Class372_Sub1_Sub1.anInt4051,
								Class372_Sub1_Sub1.anInt4048 * 1135094847,
								-1212608691));
						int i_49_ = (Class463.method6012(i - i_11_,
								Class372_Sub1_Sub1.anInt4051 * -1424479739,
								1135094847 * Class372_Sub1_Sub1.anInt4048,
								-1212608691));
						...
						if (i_44_ >= 1155384281 * Class372_Sub1_Sub1.anInt4049)
							Class82_Sub22
									.method940(
											(Class372_Sub1_Sub1.anIntArrayArray4047[i_44_]),
											i_47_, i_46_, i_6_, -1094701951);
						if (i_45_ <= Class372_Sub1_Sub1.anInt4050 * -1062447355)
							Class82_Sub22
									.method940(
											(Class372_Sub1_Sub1.anIntArrayArray4047[i_45_]),
											i_47_, i_46_, i_6_, 1089051807);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ado.av(").append(')').toString());
		}
	}
}
