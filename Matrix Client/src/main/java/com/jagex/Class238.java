...
final class Class238 implements Interface10 {
	public Object method131(byte[] is, Class505 class505, boolean bool, int i) {
		try {
			return Class373.aClass_ra4071.method5092(class505, IndexedImage
					.method982(is), bool);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("k.a(").append(')').toString());
		}
	}
	...
	public static void method2200(Class139 class139, Class133 class133, int i,
	...
	static final void method2202(Class403 class403, int i) {
		try {
			...
			Class359.method4291(Class389.aClass119Array4165[i_13_ >>> 16],
					i_13_ & 0xffff, i_14_, i_15_,
					((Class403) class403).aBoolean5261, class403, -782842809);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("k.ba(").append(')').toString());
		}
	}
}
