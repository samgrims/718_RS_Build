package com.jagex;/* Class422_Sub2 - Decompiled by JODE
...
public class Class422_Sub2 extends Class422 {
	...
	static final void method5630(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class11.anInt156 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
					.method5677(-460463412) * 1970440745)
					* -1111444967;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adc.amy(").append(')').toString());
		}
	}
	...
	static String method5631(long l, int i, boolean bool, byte i_3_) {
		try {
			...
			return new StringBuilder().append(Integer.toString(i_4_ / 10))
					.append(i_4_ % 10).append("/").append(i_5_ / 10).append(
							i_5_ % 10).append("/").append(i_6_ % 100 / 10)
					.append(i_6_ % 10).append(" ").append(i_7_ / 10).append(
							i_7_ % 10).append(":").append(i_8_ / 10).append(
							i_8_ % 10).toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adc.b(").append(')').toString());
		}
	}
}
