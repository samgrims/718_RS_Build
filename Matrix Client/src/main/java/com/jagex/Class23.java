	...
	static final void method375(Class403 class403, int i) {
		try {
			...
			Class352 class352 = Class363.aClass339_3931.method4116(i_0_,
					-2093323393);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class352.anInt3817
					* -804513353;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ax.ama(").append(')').toString());
		}
	}
		...
		try {
			...
			if (class298_sub49 != null) {
				...
				if (class298_sub24_sub3 != null) {
					...
					return ((Class57) class298_sub24_sub3.method3088(
							(Class423.aClass431_5352), -710052434));
				}
			}
			return null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ax.k(").append(')').toString());
		}
	}

	static void method377(String string, String string_2_, String string_3_,
			boolean bool, boolean bool_4_, byte i) {
		try {
			...
			if (class25.method387(537308016) != null) {
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2084, class25.aClass449_330,
						(byte) 52);
				class298_sub36.out.writeShort((Class58
						.method693(string, -142100047)
						+ Class58.method693(string_2_, -435846723)
						+ Class58.method693(string_3_, 733332406) + 1),
						16711935);
				class298_sub36.out.writeString(string,
						2114181594);
				class298_sub36.out.writeString(string_2_,
						2128054697);
				class298_sub36.out.writeString(string_3_,
						2103261593);
				int i_5_ = 0;
				if (bool)
					i_5_ |= 0x1;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ax.h(").append(')').toString());
		}
	}

	static final void method378(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -278777595
					* Class436.anInt5506;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1592446965 * Class436.anInt5479;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ax.ua(").append(')').toString());
		}
	}

	public static int method379(RsByteBuffer class298_sub53, String string,
			int i) {
		try {
			...
			class298_sub53.index += ((Class106.aClass113_1308.method1246(
					is, 0, is.length, class298_sub53.buffer,
					385051775 * class298_sub53.index, (byte) -45)) * 116413311);
			return 385051775 * class298_sub53.index - i_6_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ax.f(").append(')').toString());
		}
	}
}
