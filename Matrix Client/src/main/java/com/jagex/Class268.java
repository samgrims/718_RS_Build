...
public class Class268 {
	...
	final void method2530(RsByteBuffer class298_sub53) {
		...
		for (int i_2_ = 0; i_2_ < 10; i_2_++) {
			...
			((Class268) this).anIntArray2867[i_2_] = class298_sub53
					.method3645(590991010);
			((Class268) this).anIntArray2868[i_2_] = class298_sub53
					.readUnsignedSmart(1723054621);
		}
		...
		((Class268) this).aClass286_2870.method2715(class298_sub53,
				((Class268) this).aClass279_2878);
	}
	...
	final int[] method2531(int i, int i_4_) {
		...
		for (int i_11_ = 0; i_11_ < 5; i_11_++) {
			if (((Class268) this).anIntArray2866[i_11_] != 0) {
				...
				anIntArray2882[i_11_] = (int) ((double) (((Class279) (((Class268) this).aClass279_2877)).anInt2974 - (((Class279) ((Class268) this).aClass279_2877).anInt2973))
						* 32.768
						* Math
								.pow(
										1.0057929410678534,
										(double) (((Class268) this).anIntArray2867[i_11_])) / d);
		...
		for (int i_12_ = 0; i_12_ < i; i_12_++) {
			...
			if (((Class268) this).aClass279_2860 != null) {
				...
				i_13_ += method2529(
						i_7_,
						i_16_,
						(((Class279) (((Class268) this).aClass279_2860)).anInt2975)) >> 1;
			...
			if (((Class268) this).aClass279_2862 != null) {
				...
				i_14_ = i_14_
						* ((method2529(
								i_10_,
								i_18_,
								(((Class279) (((Class268) this).aClass279_2862)).anInt2975)) >> 1) + 32768) >> 15;
			...
			for (int i_19_ = 0; i_19_ < 5; i_19_++) {
				if (((Class268) this).anIntArray2866[i_19_] != 0) {
					...
					if (i_20_ < i) {
						anIntArray2875[i_20_] += method2529(
								anIntArray2858[i_19_],
								i_14_ * anIntArray2881[i_19_] >> 15,
								(((Class279) ((Class268) this).aClass279_2877).anInt2975));
						anIntArray2858[i_19_] += ((i_13_
								* anIntArray2882[i_19_] >> 16) + anIntArray2872[i_19_]);
					}
				}
			}
		}
		if (((Class268) this).aClass279_2879 != null) {
			...
			for (int i_23_ = 0; i_23_ < i; i_23_++) {
				...
				int i_26_;
				if (bool_22_)
					i_26_ = ((((Class279) ((Class268) this).aClass279_2879).anInt2973) + (((((Class279) ((Class268) this).aClass279_2879).anInt2974) - (((Class279) ((Class268) this).aClass279_2879).anInt2973))
							* i_24_ >> 8));
				else
					i_26_ = ((((Class279) ((Class268) this).aClass279_2879).anInt2973) + (((((Class279) ((Class268) this).aClass279_2879).anInt2974) - (((Class279) ((Class268) this).aClass279_2879).anInt2973))
							* i_25_ >> 8));
		...
		if (((Class268) this).anInt2869 > 0 && ((Class268) this).anInt2864 > 0) {
			...
			for (int i_28_ = i_27_; i_28_ < i; i_28_++)
				anIntArray2875[i_28_] += (anIntArray2875[i_28_ - i_27_]
						* ((Class268) this).anInt2864 / 100);
		}
		if (((Class286) ((Class268) this).aClass286_2870).anIntArray3088[0] > 0
				|| (((Class286) ((Class268) this).aClass286_2870).anIntArray3088[1] > 0)) {
			((Class268) this).aClass279_2878.method2608();
			int i_29_ = ((Class268) this).aClass279_2878.method2605(i + 1);
			int i_30_ = ((Class268) this).aClass286_2870.method2716(0,
					(float) i_29_ / 65536.0F);
			int i_31_ = ((Class268) this).aClass286_2870.method2716(1,
					(float) i_29_ / 65536.0F);
			if (i >= i_30_ + i_31_) {
				int i_32_ = 0;
				int i_33_ = i_31_;
				...
				for (/**/; i_32_ < i_33_; i_32_++) {
					...
					for (int i_35_ = 0; i_35_ < i_30_; i_35_++)
						i_34_ += (int) (((long) (anIntArray2875[i_32_ + i_30_
								- 1 - i_35_]) * (long) (Class286.anIntArrayArray3090[0][i_35_])) >> 16);
					for (int i_36_ = 0; i_36_ < i_32_; i_36_++)
						i_34_ -= (int) (((long) anIntArray2875[i_32_ - 1
								- i_36_] * (long) (Class286.anIntArrayArray3090[1][i_36_])) >> 16);
				...
				for (;;) {
					...
					for (/**/; i_32_ < i_33_; i_32_++) {
						...
						for (int i_38_ = 0; i_38_ < i_30_; i_38_++)
							i_37_ += (int) (((long) (anIntArray2875[i_32_
									+ i_30_ - 1 - i_38_]) * (long) (Class286.anIntArrayArray3090[0][i_38_])) >> 16);
						for (int i_39_ = 0; i_39_ < i_31_; i_39_++)
							i_37_ -= (int) (((long) (anIntArray2875[i_32_ - 1
									- i_39_]) * (long) (Class286.anIntArrayArray3090[1][i_39_])) >> 16);
						anIntArray2875[i_32_] = i_37_;
						i_29_ = ((Class268) this).aClass279_2878
								.method2605(i + 1);
					}
					if (i_32_ >= i - i_30_)
						break;
					i_30_ = ((Class268) this).aClass286_2870.method2716(0,
							(float) i_29_ / 65536.0F);
					i_31_ = ((Class268) this).aClass286_2870.method2716(1,
							(float) i_29_ / 65536.0F);
					i_33_ += 128;
				}
				for (/**/; i_32_ < i; i_32_++) {
					...
					for (int i_41_ = i_32_ + i_30_ - i; i_41_ < i_30_; i_41_++)
						i_40_ += (int) (((long) (anIntArray2875[i_32_ + i_30_
								- 1 - i_41_]) * (long) (Class286.anIntArrayArray3090[0][i_41_])) >> 16);
					for (int i_42_ = 0; i_42_ < i_31_; i_42_++)
						i_40_ -= (int) (((long) anIntArray2875[i_32_ - 1
								- i_42_] * (long) (Class286.anIntArrayArray3090[1][i_42_])) >> 16);
