...
public class Class88 {
	...
	static final void method972(Class403 class403, int i) {
		try {
			...
			Class523.method6330(((Class390) class390).aClass105_4168, i_0_,
					i_1_, 1973544714);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("do.sv(").append(')').toString());
		}
	}

	static final void method973(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class12.aClass298_Sub44_9946.cpuClockSpeed * 399637415 < 512
					|| client.aBoolean8646 || client.aBoolean8662) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("do.akp(").append(')').toString());
		}
	}
