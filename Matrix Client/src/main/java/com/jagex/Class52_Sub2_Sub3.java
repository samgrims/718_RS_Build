package com.jagex;/* Class52_Sub2_Sub3 - Decompiled by JODE
...
public class Class52_Sub2_Sub3 extends Class52_Sub2 {
	...
	boolean method136() {
		...
		((Class52_Sub2_Sub3) this).anOpenGL9083
				.setSurface(((Class52_Sub2_Sub3) this).aLong9084);
	...
	void method582(int i, int i_0_) {
		if (((Class52_Sub2_Sub3) this).aBoolean9087)
			throw new IllegalStateException();
		((Class52_Sub2_Sub3) this).anOpenGL9083
				.surfaceResized(((Class52_Sub2_Sub3) this).aLong9084);
		method597();
		if (this == ((Class52_Sub2_Sub3) this).aClass_ra_Sub2_9081
				.method4992((short) 2050))
	...
	public int method580() {
		if (((Class52_Sub2_Sub3) this).aBoolean9087)
			throw new IllegalStateException();
		((Class52_Sub2_Sub3) this).anOpenGL9083
				.swapBuffers(((Class52_Sub2_Sub3) this).aLong9084);
		return 0;
	}

	Class52_Sub2_Sub3(Class_ra_Sub2 class_ra_sub2, Canvas canvas) {
		this(class_ra_sub2, canvas,
				((Class_ra_Sub2) class_ra_sub2).anOpenGL8116
	...
	public void method138() {
		if (((Class52_Sub2_Sub3) this).aBoolean9087)
			throw new IllegalStateException();
		((Class52_Sub2_Sub3) this).anOpenGL9083.releaseSurface(
				((Class52_Sub2_Sub3) this).aCanvas9082,
				((Class52_Sub2_Sub3) this).aLong9084);
