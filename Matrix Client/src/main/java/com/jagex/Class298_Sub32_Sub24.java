			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_4_ = 0; i_4_ < Class250.anInt2755 * -1474554145; i_4_++) {
					...
					if (i_5_ == 4096)
						...
						is[i_4_] = (is_1_[i_4_] * i_5_ + (4096 - i_5_)
								* is_2_[i_4_] >> 12);
				}
			}
			return is;
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_18_ = 0; i_18_ < -1474554145 * Class250.anInt2755; i_18_++) {
				...
				if (4096 == i_19_) {
					...
					is_9_[i_18_] = is_15_[i_18_] * i_20_ + i_19_
							* is_12_[i_18_] >> 12;
					is_10_[i_18_] = is_16_[i_18_] * i_20_ + i_19_
							* is_13_[i_18_] >> 12;
					is_11_[i_18_] = is_14_[i_18_] * i_19_ + is_17_[i_18_]
							* i_20_ >> 12;
				}
			}
		}
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_25_ = 0; i_25_ < Class250.anInt2755 * -1474554145; i_25_++) {
				...
				if (i_26_ == 4096)
					...
					is[i_25_] = (is_22_[i_25_] * i_26_ + (4096 - i_26_)
							* is_23_[i_25_]) >> 12;
			}
		}
		return is;
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_30_ = 0; i_30_ < Class250.anInt2755 * -1474554145; i_30_++) {
				...
				if (i_31_ == 4096)
					...
					is[i_30_] = (is_27_[i_30_] * i_31_ + (4096 - i_31_)
							* is_28_[i_30_]) >> 12;
			}
		}
		return is;
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_45_ = 0; i_45_ < -1474554145 * Class250.anInt2755; i_45_++) {
					...
					if (4096 == i_46_) {
						...
						is_36_[i_45_] = (is_42_[i_45_] * i_47_ + i_46_
								* is_39_[i_45_] >> 12);
						is_37_[i_45_] = (is_43_[i_45_] * i_47_ + i_46_
								* is_40_[i_45_] >> 12);
						is_38_[i_45_] = (is_41_[i_45_] * i_46_ + is_44_[i_45_]
								* i_47_ >> 12);
					}
				}
			}
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_60_ = 0; i_60_ < -1474554145 * Class250.anInt2755; i_60_++) {
				...
				if (4096 == i_61_) {
					...
					is_51_[i_60_] = is_57_[i_60_] * i_62_ + i_61_
							* is_54_[i_60_] >> 12;
					is_52_[i_60_] = is_58_[i_60_] * i_62_ + i_61_
							* is_55_[i_60_] >> 12;
					is_53_[i_60_] = is_56_[i_60_] * i_61_ + is_59_[i_60_]
							* i_62_ >> 12;
				}
			}
		}
