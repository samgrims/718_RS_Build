		...
		try {
			...
			Class359
					.method4291(
							...
							((Class403) class403).aBoolean5261, class403,
							2022077336);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uz.aoo(").append(')').toString());
		}
	}
	...
	static final void method6279(boolean bool, int i) {
		try {
			...
			for (;;) {
				if (stream
						.method3660(
								(-866602563 * (((Class25) client.aClass25_8711).anInt336)),
								(byte) -70) < 15) {
					if (i != 596994841)
						break;
					return;
				...
				if (null != class365_sub1_sub1_sub2_sub1.aClass503_10190
						&& class365_sub1_sub1_sub2_sub1.aClass503_10190
								.method6242((byte) 88))
					Class244
							.method2330(class365_sub1_sub1_sub2_sub1, (byte) 40);
				...
				class365_sub1_sub1_sub2_sub1.method4464((Class15.aClass507_224
						.method6269(stream.readBits(15), 229452067)), 1407104224);
				int i_7_;
				if (bool) {
				...
				class365_sub1_sub1_sub2_sub1
						.method4421(
								...
								-1253182390);
				class365_sub1_sub1_sub2_sub1.anInt10115 = (-1186616623 * (-1927065533
						* (class365_sub1_sub1_sub2_sub1.aClass503_10190.anInt6181) << 3));
				if (bool_4_)
					class365_sub1_sub1_sub2_sub1.method4415(i_5_, true,
							-2079607043);
				class365_sub1_sub1_sub2_sub1
						.method4456(
								i_8_,
								...
								1 == i_10_, class365_sub1_sub1_sub2_sub1
										.getSize(), (byte) 58);
				if (class365_sub1_sub1_sub2_sub1.aClass503_10190
						.method6242((byte) -9))
					Class391.method4884(class365_sub1_sub1_sub2_sub1.plane,
							(class365_sub1_sub1_sub2_sub1.scenePositionXQueue[0]),
							(class365_sub1_sub1_sub2_sub1.scenePositionYQueue[0]),
							0, null, class365_sub1_sub1_sub2_sub1, null,
							(byte) -66);
			}
			stream.finishBitAccess((byte) 38);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uz.jo(").append(')').toString());
		}
	}

	static final void method6280(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class495
					.method6195((byte) -1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uz.acr(").append(')').toString());
		}
	}

	public static void method6281(int i, int i_11_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(20,
					(long) i);
			class298_sub37_sub12.method3445(-1607796466);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uz.ax(").append(')').toString());
		}
	}

	static void method6282(int i, boolean bool, int i_12_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(22,
					(long) i);
			class298_sub37_sub12.method3449((byte) 61);
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 = (bool ? 1
					: 0) * 1274450087;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uz.ai(").append(')').toString());
		}
	}
}
