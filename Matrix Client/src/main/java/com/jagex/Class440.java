...
public final class Class440 {
	...
	public Class298 method5856(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("se.k(").append(')').toString());
		}
	}

	public Class298 method5857(byte i) {
		try {
			if (1311298783 * ((Class440) this).anInt5581 > 0
					&& (((Class440) this).aClass298_5579 != (((Class440) this).aClass298Array5576[((Class440) this).anInt5581 * 1311298783 - 1]))) {
	...
	static final void method5859(Class403 class403, byte i) {
		try {
			...
			Class102 class102 = Class298_Sub40_Sub13.method3517(i_10_,
					689328854);
			String string = "";
	...
	public static void method5860(Interface22 interface22, byte i) {
		try {
			...
			((IcmpService_Sub1) IcmpService_Sub1.anIcmpService_Sub1_8551).aList8552
					.add(interface22);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("se.i(").append(')').toString());
	...
	public static Class428[] method5861(int i) {
		try {
			return (new Class428[] { Class428.aClass428_6618,
					Class428.aClass428_6619, Class428.aClass428_6620,
					Class428.aClass428_6617, Class428.aClass428_6616,
					Class428.aClass428_6621 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("se.a(").append(')').toString());
		}
	...
	public static void method5862(int i, int i_11_, int i_12_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(18,
					(long) i_11_ << 32 | (long) i);
			class298_sub37_sub12.method3445(-777100649);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("se.ao(").append(')').toString());
		}
	}
}
