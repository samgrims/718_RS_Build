package com.jagex;/* Class351 - Decompiled by JODE
...
public class Class351 {
	...
	boolean method4222(GraphicsToolkit class_ra, long l) {
		...
		if (((Class351) this).aBoolean3770) {
			...
			while (iterator.hasNext()) {
				...
				for (int i_0_ = 0; i_0_ < (((Class342) class342).aClass182_3656.anInt1852 * 1095253617); i_0_++)
					class342.method4147(class_ra, l, 1,
							!((Class351) this).aBoolean3761, (byte) 63);
			}
			((Class351) this).aBoolean3770 = false;
		}
		Iterator iterator = ((Class351) this).aList3766.iterator();
		while (iterator.hasNext()) {
			Class342 class342 = (Class342) iterator.next();
			class342.method4147(class_ra, l, i,
					!((Class351) this).aBoolean3761, (byte) 45);
		}
	...
	void method4223() {
		...
		for (int i = 0; i < ((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762.length; i++) {
			if (((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762[i] != null) {
				((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762[i]
						.method3726();
		...
		if (class85s != null) {
			for (int i = 0; (i < class85s.length && i != 32 && ((Class351) this).anInt3760 != 32); i++) {
				if (!aBooleanArray3774[i]) {
					Class342 class342 = new Class342(class_ra, class85s[i],
							this, ((Class351) this).aLong3773);
	...
	public Class69 method4226() {
		...
		for (int i = 0; i < ((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762.length; i++) {
			if (((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762[i] != null
					&& (((Class302_Sub3_Sub1_Sub1) ((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762[i]).aClass342_10037) != null)
				((Class351) this).aClass69_3765.aClass448_680.method5908(
						((Class351) this).aClass302_Sub3_Sub1_Sub1Array3762[i],
						(byte) -89);
		}
	...
	void method4228(Class331 class331, GraphicsToolkit class_ra) {
		...
		while (iterator.hasNext()) {
			Class342 class342 = (Class342) iterator.next();
			class342
					.method4148(class331, class_ra, ((Class351) this).aLong3764);
		}
	}
	...
	public void method4231(GraphicsToolkit class_ra, long l, Class85[] class85s,
			Class68[] class68s, boolean bool) {
		if (!aBoolean3772) {
