...
public class Class265 {
	...
	int method2517() {
		int i;
		for (i = 0; ((Class265) this).anIntArray2839[i] >= 0; i = (Class298_Sub23
				.method3063() != 0 ? ((Class265) this).anIntArray2839[i]
				: i + 1)) {
			/* empty */
		}
	...
	Class265() {
		...
		if (bool) {
			...
			while (i < ((Class265) this).anInt2844) {
				int i_1_ = (Class298_Sub23.method3070(Class87.method970(
						((Class265) this).anInt2844 - i, -187995264)));
			...
			for (int i = 0; i < ((Class265) this).anInt2844; i++) {
				if (bool_3_ && Class298_Sub23.method3063() == 0)
					...
					((Class265) this).anIntArray2841[i] = Class298_Sub23
							.method3070(5) + 1;
			}
		}
		method2518();
			...
			if (i == 1) {
				for (int i_9_ = 0; i_9_ < ((Class265) this).anInt2844; i_9_++) {
					...
					for (int i_12_ = 0; i_12_ < ((Class265) this).anInt2840; i_12_++) {
						...
						float f_14_ = (((float) ((Class265) this).anIntArray2842[i_13_] * f_4_)
								+ f + f_10_);
				...
				for (int i_15_ = 0; i_15_ < ((Class265) this).anInt2844; i_15_++) {
					...
					for (int i_18_ = 0; i_18_ < ((Class265) this).anInt2840; i_18_++) {
						float f_19_ = (((float) ((Class265) this).anIntArray2842[i_17_] * f_4_)
								+ f + f_16_);
	...
	static int method2520(int i, int i_38_) {
		int i_39_;
		for (i_39_ = (int) Math.pow((double) i, 1.0 / (double) i_38_) + 1; Class70
				.method804(i_39_, i_38_, (short) 27381) > i; i_39_--) {
			/* empty */
		}
		return i_39_;
	}
