...
public class Class142 {
		...
		try {
			if (Class8.aString101.length() != 0) {
				Class255.method2435(new StringBuilder().append("--> ").append(
						Class8.aString101).toString(), 1401138202);
	...
	static final void method1569(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ft.jf(").append(')').toString());
		}
	}

	static final void method1570(int i, int i_2_, int i_3_, int i_4_,
			boolean bool, int i_5_) {
		try {
			if (client.aClass283_8716.method2675(-1611682495) == null)
				Class373.aClass_ra4071.method5015(i, i_2_, i_3_, i_4_,
						-16777216, (byte) 7);
			else {
				...
				if (bool_6_)
					...
					if (null != Class287.myPlayer
							&& ((int) class217.aFloat2451 - (Class287.myPlayer
									.getSize() - 1) * 256) >> 9 == Class3.anInt62 * 2076926079
							&& (((int) class217.aFloat2454 - (Class287.myPlayer
									.getSize() - 1) * 256) >> 9 == -376303645
									* Class3.anInt54)) {
					...
					Class298_Sub36.method3401(i, i_2_, i_3_, i_4_, true,
							646093136);
					...
					if (Class298_Sub1.anInt7164 * -863531439 == 4) {
						...
						if (client.aBooleanArray8684[4]
								&& client.anIntArray8925[4] + 128 > i_7_)
							i_7_ = 128 + client.anIntArray8925[4];
						int i_8_ = ((-1419578297 * client.anInt8744 + (int) client.aFloat8949) & 0x3fff);
						Class482.method6121(1103750049 * Class75.anInt708,
								Class356.method4271((int) class217.aFloat2451,
										(int) class217.aFloat2454,
										Class99.anInt952 * 1855729883,
										-1979916029) - 200,
								Class106.anInt1309 * 1346160791, i_7_, i_8_,
								(i_7_ >> 3) * 3 + 600 << 2, i_4_, -1059521295);
					...
					for (int i_16_ = 0; i_16_ < 5; i_16_++) {
						if (client.aBooleanArray8684[i_16_]) {
							int i_17_ = (int) ((Math.random() * (double) (2 * (client.anIntArray8860[i_16_]) + 1))
									- (double) (client.anIntArray8860[i_16_]) + ((Math
									.sin((double) (client.anIntArray8790[i_16_])
											* ((double) (client.anIntArray8926[i_16_]) / 100.0))) * (double) (client.anIntArray8925[i_16_])));
							if (i_16_ == 0)
					...
					if (Class367.anInt4000 * -1740717447 > ((client.aClass283_8716
							.method2675(-1611682495).anInt3514) * 1988988347 << 9) - 1)
						Class367.anInt4000 = (((client.aClass283_8716
								.method2675(-1611682495).anInt3514) * 1988988347 << 9) - 1) * 547882953;
					if (-299812095 * Class146.anInt1575 < 0)
						Class146.anInt1575 = 0;
					if (-299812095 * Class146.anInt1575 > ((client.aClass283_8716
							.method2675(-1611682495).anInt3549) * 1340714547 << 9) - 1)
						Class146.anInt1575 = (((client.aClass283_8716
								.method2675(-1611682495).anInt3549) * 1340714547 << 9) - 1) * 309839105;
					...
					Class385 class385 = client.aClass283_8716.method2640(
							(byte) 15).method4316((byte) -16);
					...
					client.aClass222_8871
							.method2071(
									0.0F,
									-1.0F,
									0.0F,
									Class220
											.method2049(-(Class135.anInt6384 * -1847894591) & 0x3fff));
					client.aClass222_8871
							.method2071(
									-1.0F,
									0.0F,
									0.0F,
									Class220
											.method2049(-(client.anInt8756 * -104436553) & 0x3fff));
					client.aClass222_8871
							.method2071(
									0.0F,
									0.0F,
									-1.0F,
									Class220
											.method2049(-(-1466297851 * Class229.anInt6458) & 0x3fff));
					Class373.aClass_ra4071.method5043(client.aClass222_8871);
					Class82_Sub7.method889(client.aClass233_8658, true,
							(float) (i_3_ / 2), (float) (i_4_ / 2),
							(float) (-2134375937 * client.anInt8940 << 1),
							(float) (-2134375937 * client.anInt8940 << 1),
							i_3_, i_4_, 1807453020);
					Class373.aClass_ra4071.method5182(client.aClass233_8658);
					if (class385.method4710((byte) -25) != null) {
						Class373.aClass_ra4071.IA(1.0F);
						Class373.aClass_ra4071.m(16777215, 0.0F, 0.0F, 1.0F,
								0.0F, 0.0F);
						class385.method4710((byte) -99).method2591(
								Class373.aClass_ra4071,
								Class163.anInt1685 * -1285178091 << 3, i, i_2_,
								i_3_, i_4_, client.anInt8756 * -104436553,
								Class135.anInt6384 * -1847894591,
								Class229.anInt6458 * -1466297851, i_18_, true,
								false, (byte) -49);
					} else
						Class373.aClass_ra4071.ba(3, i_18_);
					Class298_Sub40_Sub13.method3518(client.aClass222_8871,
							client.aClass233_8658, i_3_, i_4_, -1854574289);
					client.aClass283_8716.method2640((byte) -11).method4323(
							client.aClass283_8716, -1036263435);
					byte i_19_ = (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub17_7565
							.method5689(-2013953489) == 2 ? (byte) (-1953789277 * client.anInt8777)
							: (byte) 1);
					client.aClass283_8716
							...
							.method4040(
									...
									Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub9_7555
											.method5655(2137164627) == 0, true,
									0, true);
					client.anInt8723 += -2109562397;
					Class247.method2365(170542119);
					if (0 == -1233866115 * client.anInt8752) {
						Class223.method2084(i, i_2_, i_3_, i_4_, 256, 256,
								-16777216);
						Class240.method2232(i, i_2_, i_3_, i_4_, 256, 256,
								(byte) 46);
						Class492.method6182(i, i_2_, i_3_, i_4_, 256, 256,
								996259282);
						Class251.method2406(i, i_2_, i_3_, i_4_, 373406666);
					}
					client.aClass283_8716.method2675(-1611682495).method4010(
							843420871);
					...
					if (client.aBoolean8663
							&& Class248.aClass247_2752.method2348(1533564172) == 0)
					...
					Class82_Sub7.method889(client.aClass233_8658, false,
							(float) (i_3_ / 2 + i), (float) (i_4_ / 2 + i_2_),
							(float) (-2134375937 * client.anInt8940 << 1),
							(float) (-2134375937 * client.anInt8940 << 1),
							i_3_, i_4_, -725589740);
					Class373.aClass_ra4071.method5182(client.aClass233_8658);
