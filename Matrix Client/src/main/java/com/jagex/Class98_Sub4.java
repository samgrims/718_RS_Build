	...
	void method1054(int i, int i_1_, byte i_2_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yy.a(").append(')').toString());
		}
	}

	Class98_Sub4(int i, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_,
