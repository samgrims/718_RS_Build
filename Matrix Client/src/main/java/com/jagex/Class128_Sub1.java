	...
	public Class146 method49(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("zp.f(").append(')').toString());
		}
	}

	Class128_Sub1(Class139 class139, Class133 class133, int i, int i_0_,
