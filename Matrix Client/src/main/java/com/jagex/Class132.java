...
public class Class132 {
		...
		try {
			if (i == 1)
				...
				for (int i_3_ = 0; i_3_ < i_2_; i_3_++)
					((Class132) this).anIntArray1507[i_3_] = class298_sub53
				...
				for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
					((Class132) this).aShortArray1501[i_5_] = (short) class298_sub53
							.readUnsignedShort();
					((Class132) this).aShortArray1502[i_5_] = (short) class298_sub53
							.readUnsignedShort();
				}
			} else if (i == 41) {
				...
				for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
					((Class132) this).aShortArray1503[i_7_] = (short) class298_sub53
							.readUnsignedShort();
					((Class132) this).aShortArray1504[i_7_] = (short) class298_sub53
							.readUnsignedShort();
				}
			} else if (i >= 60 && i < 70)
				((Class132) this).anIntArray1505[i - 60] = class298_sub53
						.readBigSmart(1235052657);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fi.f(").append(')').toString());
		}
	}

	public Class64 method1474(byte i) {
		try {
			if (((Class132) this).anIntArray1507 == null)
				return null;
			Class64[] class64s = new Class64[((Class132) this).anIntArray1507.length];
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_8_ = 0; i_8_ < ((Class132) this).anIntArray1507.length; i_8_++)
					class64s[i_8_] = Class64
							.method751(
									(((Class144) ((Class132) this).aClass144_1500).aClass243_1560),
									(((Class132) this).anIntArray1507[i_8_]), 0);
			}
			...
			if (((Class132) this).aShortArray1501 != null) {
				for (int i_10_ = 0; i_10_ < ((Class132) this).aShortArray1501.length; i_10_++)
					class64.method756(((Class132) this).aShortArray1501[i_10_],
							(((Class132) this).aShortArray1502[i_10_]));
			}
			if (((Class132) this).aShortArray1503 != null) {
				for (int i_11_ = 0; i_11_ < ((Class132) this).aShortArray1503.length; i_11_++)
					class64.method752(((Class132) this).aShortArray1503[i_11_],
							(((Class132) this).aShortArray1504[i_11_]));
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fi.p(").append(')').toString());
		}
	}
		...
		try {
			...
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_12_ = 0; i_12_ < 5; i_12_++) {
					if (-1 != ((Class132) this).anIntArray1505[i_12_]
							&& !(((Class144) ((Class132) this).aClass144_1500).aClass243_1560
									.method2290(
											((Class132) this).anIntArray1505[i_12_],
											0, -1795823627)))
						bool = false;
				}
			}
	...
	public Class64 method1476(int i) {
		try {
			Class64[] class64s = new Class64[5];
			int i_13_ = 0;
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_14_ = 0; i_14_ < 5; i_14_++) {
					if (((Class132) this).anIntArray1505[i_14_] != -1)
						class64s[i_13_++] = Class64
								.method751(
										(((Class144) (((Class132) this).aClass144_1500)).aClass243_1560),
										(((Class132) this).anIntArray1505[i_14_]),
										0);
				}
			}
			...
			Class64 class64 = new Class64(class64s, i_13_);
			if (null != ((Class132) this).aShortArray1501) {
				for (int i_16_ = 0; i_16_ < ((Class132) this).aShortArray1501.length; i_16_++)
					class64.method756(((Class132) this).aShortArray1501[i_16_],
							(((Class132) this).aShortArray1502[i_16_]));
			}
			if (null != ((Class132) this).aShortArray1503) {
				for (int i_17_ = 0; i_17_ < ((Class132) this).aShortArray1503.length; i_17_++)
					class64.method752(((Class132) this).aShortArray1503[i_17_],
							(((Class132) this).aShortArray1504[i_17_]));
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fi.k(").append(')').toString());
		}
	}
		...
		try {
			...
			synchronized (((Class144) ((Class132) this).aClass144_1500).aClass243_1560) {
				for (int i_18_ = 0; i_18_ < ((Class132) this).anIntArray1507.length; i_18_++) {
					if (!((Class144) ((Class132) this).aClass144_1500).aClass243_1560
							.method2290(
									((Class132) this).anIntArray1507[i_18_], 0,
									-1755601406))
						bool = false;
				}
			}
