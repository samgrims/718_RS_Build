...
public class Class298_Sub37_Sub6 extends Class298_Sub37 {
		...
		try {
			if (-1132597157 * Class298_Sub32_Sub11.anInt9394 >= 0) {
				for (int i_0_ = 0; i_0_ < ((Class298_Sub37_Sub6) this).anIntArray9593.length; i_0_++) {
					if (!class243
							.method2290(
									(-1132597157 * (Class298_Sub32_Sub11.anInt9394)),
									(((Class298_Sub37_Sub6) this).anIntArray9593[i_0_]),
									-416567288))
						return false;
				}
			} else {
				for (int i_1_ = 0; i_1_ < ((Class298_Sub37_Sub6) this).anIntArray9593.length; i_1_++) {
					if (!class243
							.method2310(
									(((Class298_Sub37_Sub6) this).anIntArray9593[i_1_]),
									-457216440))
						return false;
				}
			}
			for (int i_2_ = 0; i_2_ < ((Class298_Sub37_Sub6) this).anIntArray9591.length; i_2_++) {
				if (!interface_ma.method170(
						(((Class298_Sub37_Sub6) this).anIntArray9591[i_2_]),
						(short) 5558))
					return false;
			}
			return true;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ail.a(").append(')').toString());
		}
	}

	int[] method3421(Class243 class243, Interface_ma interface_ma, double d,
			int i, int i_3_, boolean bool, int i_4_) {
		try {
			...
			for (int i_5_ = 0; i_5_ < (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592).length; i_5_++)
				((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[i_5_]
						.method3130(i, i_3_, -1661668864);
			...
			for (int i_7_ = 0; i_7_ < i_3_; i_7_++) {
				...
				if (((Class298_Sub37_Sub6) this).aClass298_Sub32_9589.aBoolean7382) {
					int[] is_11_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9589
							.method3131(i_7_, -1060810232);
					is_8_ = is_11_;
					is_9_ = is_11_;
					is_10_ = is_11_;
				} else {
					int[][] is_12_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9589
							.method3132(i_7_, (byte) -23);
					is_8_ = is_12_[0];
					is_9_ = is_12_[1];
					is_10_ = is_12_[2];
				}
				...
				if (((Class298_Sub37_Sub6) this).aClass298_Sub32_9588.aBoolean7382)
					is_13_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9588
							.method3131(i_7_, 991664315);
				else
					is_13_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9588
							.method3132(i_7_, (byte) -109)[0];
				if (bool)
					i_6_ = i_7_;
				for (int i_14_ = i - 1; i_14_ >= 0; i_14_--) {
					...
					if (i_15_ != 0 || 0 != i_16_ || 0 != i_17_) {
						...
						i_18_ = 0;
					is[i_6_++] = (i_18_ << 24) + (i_15_ << 16) + (i_16_ << 8)
							+ i_17_;
					if (bool)
						i_6_ += i - 1;
				}
			...
			for (int i_19_ = 0; i_19_ < (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592).length; i_19_++)
				((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[i_19_]
						.method3128(1881168514);
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ail.b(").append(')').toString());
		}
	}

	float[] method3422(Class243 class243, Interface_ma interface_ma, int i,
			int i_20_, boolean bool, int i_21_) {
		try {
			Class298_Sub32_Sub11.aClass243_9393 = class243;
			Class294.anInterface_ma3166 = interface_ma;
			for (int i_22_ = 0; i_22_ < (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592).length; i_22_++)
				((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[i_22_]
						.method3130(i, i_20_, -1661668864);
			...
			for (int i_24_ = 0; i_24_ < i_20_; i_24_++) {
				...
				int[] is_26_;
				if (((Class298_Sub37_Sub6) this).aClass298_Sub32_9589.aBoolean7382) {
					int[] is_27_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9589
							.method3131(i_24_, 376891989);
					is = is_27_;
					is_25_ = is_27_;
					is_26_ = is_27_;
				} else {
					int[][] is_28_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9589
							.method3132(i_24_, (byte) -81);
					is = is_28_[0];
					is_25_ = is_28_[1];
					is_26_ = is_28_[2];
				}
				int[] is_29_;
				if (((Class298_Sub37_Sub6) this).aClass298_Sub32_9588.aBoolean7382)
					is_29_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9588
							.method3131(i_24_, 1373971312);
				else
					is_29_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9588
							.method3132(i_24_, (byte) -16)[0];
				int[] is_30_;
				if (((Class298_Sub37_Sub6) this).aClass298_Sub32_9590.aBoolean7382)
					is_30_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9590
							.method3131(i_24_, -306931016);
				else
					is_30_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9590
							.method3132(i_24_, (byte) -17)[0];
				if (bool)
					i_23_ = i_24_ << 2;
			...
			for (int i_33_ = 0; i_33_ < (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592).length; i_33_++)
				((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[i_33_]
						.method3128(1881168514);
			return fs;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ail.p(").append(')').toString());
		}
	}
	...
	Class298_Sub37_Sub6(RsByteBuffer class298_sub53) {
		...
		((Class298_Sub37_Sub6) this).aClass298_Sub32_9589 = (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[class298_sub53
				.readUnsignedByte()]);
		((Class298_Sub37_Sub6) this).aClass298_Sub32_9588 = (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[class298_sub53
				.readUnsignedByte()]);
		((Class298_Sub37_Sub6) this).aClass298_Sub32_9590 = (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[class298_sub53
				.readUnsignedByte()]);
		is = null;
	}

	int[] method3423(Class243 class243, Interface_ma interface_ma, double d,
			int i, int i_44_, boolean bool, boolean bool_45_, int i_46_) {
		try {
			Class298_Sub32_Sub11.aClass243_9393 = class243;
			Class294.anInterface_ma3166 = interface_ma;
			for (int i_47_ = 0; i_47_ < (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592).length; i_47_++)
				((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[i_47_]
						.method3130(i, i_44_, -1661668864);
			Class496.method6202(d);
			...
			for (int i_52_ = 0; i_52_ < i_44_; i_52_++) {
				...
				int[] is_55_;
				if (((Class298_Sub37_Sub6) this).aClass298_Sub32_9589.aBoolean7382) {
					int[] is_56_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9589
							.method3131(i_52_, 1662825531);
					is_53_ = is_56_;
					is_54_ = is_56_;
					is_55_ = is_56_;
				} else {
					int[][] is_57_ = ((Class298_Sub37_Sub6) this).aClass298_Sub32_9589
							.method3132(i_52_, (byte) -95);
					is_53_ = is_57_[0];
					is_54_ = is_57_[1];
					is_55_ = is_57_[2];
				}
			...
			for (int i_63_ = 0; i_63_ < (((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592).length; i_63_++)
				((Class298_Sub37_Sub6) this).aClass298_Sub32Array9592[i_63_]
						.method3128(1881168514);
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ail.f(").append(')').toString());
		}
	}
}
