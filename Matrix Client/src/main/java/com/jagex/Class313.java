		...
		try {
			if (Class423.aClass437_5354.method5812((long) i) == null) {
				if (!client.aBoolean8806)
					...
					Class298_Sub49 class298_sub49 = (new Class298_Sub49(
							i,
							new Class308_Sub1(4096, Class517.aClass243_6270, i),
							i_0_, bool));
		...
		try {
			...
			if (Class398
					.method4920(
							...
							(short) 300))
				is = (Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(
								(int) ((((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661) * 2236412381003659263L)).anIntArray5767);
			else if (-1 != (((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9660)
					* -149710173)
				is = (Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(
								(((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9660 * -149710173)).anIntArray5767);
			else if (Class302
					.method3716(
							946432351 * (((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662),
							-838004269)) {
				...
				ObjectDefinitions class432 = (client.aClass283_8716
						.method2641(150013546)
						.getObjectDefinitions(
								(int) (2236412381003659263L * (((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661) >>> 32 & 0x7fffffffL)));
				if (class432.anIntArray5366 != null)
					class432 = class432.method5777(Class128.aClass148_6331,
							1956265286);
				if (null != class432)
