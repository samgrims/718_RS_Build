...
public class Class298_Sub23 extends Class298 {
	...
	void method3061(byte[] is) {
		...
		((Class298_Sub23) this).anInt7318 = class298_sub53
				.readInt((byte) 55);
		((Class298_Sub23) this).anInt7335 = class298_sub53
				.readInt((byte) 18);
		((Class298_Sub23) this).anInt7320 = class298_sub53
				.readInt((byte) -10);
		((Class298_Sub23) this).anInt7321 = class298_sub53
				.readInt((byte) -87);
	...
	public Class298_Sub26_Sub1 method3067(int[] is) {
		...
		return new Class298_Sub26_Sub1(((Class298_Sub23) this).anInt7318,
				is_8_, ((Class298_Sub23) this).anInt7320,
				((Class298_Sub23) this).anInt7321,
				((Class298_Sub23) this).aBoolean7336);
	}
	...
	static void method3069(byte[] is) {
		...
		for (int i = 0; i < 2; i++) {
			...
			for (int i_16_ = 0; i_16_ < i_14_; i_16_++) {
				fs[2 * i_16_] = (float) Math.cos((double) (4 * i_16_)
						* 3.141592653589793 / (double) i_12_);
				fs[2 * i_16_ + 1] = -(float) Math.sin((double) (4 * i_16_)
						* 3.141592653589793 / (double) i_12_);
			}
			float[] fs_17_ = new float[i_13_];
			for (int i_18_ = 0; i_18_ < i_14_; i_18_++) {
				fs_17_[2 * i_18_] = (float) Math.cos((double) (2 * i_18_ + 1)
						* 3.141592653589793 / (double) (2 * i_12_));
				fs_17_[2 * i_18_ + 1] = (float) Math
						.sin((double) (2 * i_18_ + 1) * 3.141592653589793
								/ (double) (2 * i_12_));
			}
			float[] fs_19_ = new float[i_14_];
			for (int i_20_ = 0; i_20_ < i_15_; i_20_++) {
				fs_19_[2 * i_20_] = (float) Math.cos((double) (4 * i_20_ + 2)
						* 3.141592653589793 / (double) i_12_);
				fs_19_[2 * i_20_ + 1] = -(float) Math
						.sin((double) (4 * i_20_ + 2) * 3.141592653589793
								/ (double) i_12_);
			}
	...
	float[] method3071(int i) {
		...
		method3063();
		int i_38_ = method3070(Class87.method970(anIntArray7333.length - 1,
				-1535771411));
		...
		if (bool_51_) {
			...
			for (int i_65_ = 0; i_65_ < i_55_; i_65_++) {
				...
				fs[4 * i_65_ + 3] = (f - f_67_) * f_69_ - (f_66_ - f_68_)
						* f_70_;
				fs[4 * i_65_ + 1] = (f_66_ - f_68_) * f_69_ + (f - f_67_)
						* f_70_;
			}
			...
			for (int i_72_ = 0; i_72_ < i_71_ - 3; i_72_++) {
				...
				for (int i_75_ = 0; i_75_ < 2 << i_72_; i_75_++) {
					...
					for (int i_78_ = 0; i_78_ < i_39_ >> i_72_ + 4; i_78_++) {
						...
						fs[i_77_ - 1 - i_79_] = (f - f_81_) * f_83_
								- (f_80_ - f_82_) * f_84_;
						fs[i_77_ - 3 - i_79_] = (f_80_ - f_82_) * f_83_
								+ (f - f_81_) * f_84_;
					}
				}
			}
			...
			for (int i_98_ = 0; i_98_ < i_54_; i_98_++) {
				fs[i_98_] = (fs[2 * i_98_ + i_50_] * fs_59_[2 * i_98_] + fs[2
						* i_98_ + 1 + i_50_]
						* fs_59_[2 * i_98_ + 1]);
				fs[i_50_ - 1 - i_98_] = (fs[2 * i_98_ + i_50_]
						* fs_59_[2 * i_98_ + 1] - fs[2 * i_98_ + 1 + i_50_]
						* fs_59_[2 * i_98_]);
			}
			...
			for (int i_103_ = i_43_; i_103_ < i_44_; i_103_++) {
				float f = (float) Math.sin(((double) (i_103_ - i_43_) + 0.5)
						/ (double) i_45_ * 0.5 * 3.141592653589793);
				aFloatArray7349[i_103_] *= (float) Math.sin(1.5707963267948966
						* (double) f * (double) f);
			}
			for (int i_104_ = i_46_; i_104_ < i_47_; i_104_++) {
				float f = (float) Math
						.sin((((double) (i_104_ - i_46_) + 0.5)
								/ (double) i_48_ * 0.5 * 3.141592653589793) + 1.5707963267948966);
				aFloatArray7349[i_104_] *= (float) Math.sin(1.5707963267948966
						* (double) f * (double) f);
			}
		}
		float[] fs = null;
		if (((Class298_Sub23) this).anInt7319 > 0) {
			...
			if (!((Class298_Sub23) this).aBoolean7338) {
				for (int i_106_ = 0; i_106_ < ((Class298_Sub23) this).anInt7337; i_106_++) {
					int i_107_ = (((Class298_Sub23) this).anInt7319 >> 1)
							+ i_106_;
