...
public class Class373 {
	...
	void method4603(byte i) {
		try {
			anInt4055 = (2109091647 * anInt4055 << 8 | -692668059
					* ((Class373) this).anInt4053) * 150814911;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pn.b(").append(')').toString());
		}
	}
	...
	void method4604(RsByteBuffer class298_sub53, int i, short i_0_) {
		try {
			if (i == 1)
				anInt4056 = Class112.method1240(class298_sub53
						.read24BitUnsignedInteger((byte) 45), (byte) 66)
						* -1294090885;
			else if (i == 2)
				...
				anInt4059 = Class112.method1240(class298_sub53
						.read24BitUnsignedInteger((byte) -44), (byte) 71)
						* -1749423345;
			else if (i == 8)
	...
	void method4605(RsByteBuffer class298_sub53, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pn.a(").append(')').toString());
		}
	}

	static final void method4606(IComponentDefinition class105, Class119 class119,
	...
	static final void method4607(Class403 class403, byte i) {
		try {
			...
			if (2 == client.anInt8942 * 1131012101
					&& i_2_ < -1054937867 * client.anInt8941)
	...
	static final void method4609(Class403 class403, int i) {
		try {
			boolean bool = false;
			String string = "";
			if (((Class403) class403).aClass214_5256 != null
					&& ((Class403) class403).aClass214_5256
							.method1985(592860146)) {
				File file = ((Class403) class403).aClass214_5256
						.method1986((short) -10504);
				if (null != file) {
					string = file.getPath();
					if (string == null)
						string = "";
	...
	static final void method4611(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1 == i_6_ ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pn.yz(").append(')').toString());
		}
	}
}
