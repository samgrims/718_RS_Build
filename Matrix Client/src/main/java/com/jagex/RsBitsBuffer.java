...
public class RsBitsBuffer extends RsByteBuffer {
	...
	static int[] anIntArray9782 = { 0, 1, 3, 7, 15, 31, 63, 127, 255, 511,
	...
	public int method3660(int i, byte i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hy(").append(')').toString());
		}
	}

	public boolean method3661(byte i) {
		try {
			int i_1_ = ((buffer[index * 385051775] - ((RsBitsBuffer) this).aClass449_9781
					.method5916((byte) 1)) & 0xff);
			if (i_1_ < 128)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hb(").append(')').toString());
		}
	}
	...
	public void method3662(byte[] is, int i, int i_2_, byte i_3_) {
		try {
			for (int i_4_ = 0; i_4_ < i_2_; i_4_++)
				is[i + i_4_] = (byte) ((buffer[(index += 116413311) * 385051775 - 1]) - ((RsBitsBuffer) this).aClass449_9781
						.method5914(223815758));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hj(").append(')').toString());
		}
	}
	...
	public int readBits(int numBits) {
		try {
			...
			for (/**/; numBits > i_7_; i_7_ = 8) {
				i_8_ += ((buffer[i_6_++] & anIntArray9782[i_7_]) << numBits
						- i_7_);
				numBits -= i_7_;
			}
			if (numBits == i_7_)
	...
	public void method3665(IsaacCipher isaacCipher, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hs(").append(')').toString());
		}
	}

	public int readUnsignedSmart(int i) {
		try {
			int i_9_ = ((buffer[(index += 116413311) * 385051775 - 1] - ((RsBitsBuffer) this).aClass449_9781
					.method5914(223815758)) & 0xff);
			if (i_9_ < 128)
				return i_9_;
			return ((i_9_ - 128 << 8) + (((buffer[(index += 116413311) * 385051775 - 1]) - ((RsBitsBuffer) this).aClass449_9781
					.method5914(223815758)) & 0xff));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hv(").append(')').toString());
		}
	}
	...
	public void initBitAccess(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hn(").append(')').toString());
		}
	}

	public void method3668(int i, byte i_10_) {
		try {
			buffer[(index += 116413311) * 385051775 - 1] = (byte) (i + ((RsBitsBuffer) this).aClass449_9781
					.method5914(223815758));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajm.hg(").append(')').toString());
		}
	}
}
