	...
	Class30_Sub1 method770() {
		if (((Class66_Sub1_Sub1) this).aClass30_Sub1_9089 == null) {
			...
			for (int i_0_ = 0; i_0_ < 6; i_0_++) {
				if (!interface_ma
						.method170(anIntArray9096[i_0_], (short) 19541))
					return null;
			...
			for (int i_2_ = 0; i_2_ < 6; i_2_++)
				anIntArrayArray9097[i_2_] = interface_ma.method171(
						anIntArray9096[i_2_], 1.0F, i, i, false, -244439227);
			((Class66_Sub1_Sub1) this).aClass30_Sub1_9089 = new Class30_Sub1(
					(((Class66_Sub1_Sub1) this).aClass_ra_Sub2_9092),
					Class55.aClass55_560, Class77.aClass77_717, i, bool,
					anIntArrayArray9097);
		}
		return ((Class66_Sub1_Sub1) this).aClass30_Sub1_9089;
	}

	Class66_Sub1_Sub1(Class_ra_Sub2 class_ra_sub2, int i, int i_3_, int i_4_,
	...
	Class30_Sub1 method769() {
		if (((Class66_Sub1_Sub1) this).aClass30_Sub1_9089 == null) {
			...
			for (int i_8_ = 0; i_8_ < 6; i_8_++) {
				if (!interface_ma
						.method170(anIntArray9096[i_8_], (short) 24122))
					return null;
			...
			for (int i_10_ = 0; i_10_ < 6; i_10_++)
				anIntArrayArray9097[i_10_] = interface_ma.method171(
						anIntArray9096[i_10_], 1.0F, i, i, false, 1735234411);
			((Class66_Sub1_Sub1) this).aClass30_Sub1_9089 = new Class30_Sub1(
					(((Class66_Sub1_Sub1) this).aClass_ra_Sub2_9092),
					Class55.aClass55_560, Class77.aClass77_717, i, bool,
					anIntArrayArray9097);
