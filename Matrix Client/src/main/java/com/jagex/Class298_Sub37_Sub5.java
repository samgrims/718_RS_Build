package com.jagex;/* Class298_Sub37_Sub5 - Decompiled by JODE
...
public class Class298_Sub37_Sub5 extends Class298_Sub37 {
	...
	boolean method3416(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			...
			Class298_Sub37_Sub15 class298_sub37_sub15_0_ = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) this).aClass461_9584
					.method5984(-1933327286));
			while (class298_sub37_sub15_0_ != null) {
				if (Class473
						.method6069(
								(((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 * 946432351),
								(((Class298_Sub37_Sub15) class298_sub37_sub15_0_).anInt9662 * 946432351),
								-537262415)) {
					Class63.method742(class298_sub37_sub15,
							class298_sub37_sub15_0_, (byte) -70);
					((Class298_Sub37_Sub5) this).anInt9583 += -130647835;
					return !bool;
				}
				class298_sub37_sub15_0_ = (Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) this).aClass461_9584
						.method5985(729407080);
				bool = false;
			}
			((Class298_Sub37_Sub5) this).aClass461_9584.method5982(
					class298_sub37_sub15, (byte) -34);
			((Class298_Sub37_Sub5) this).anInt9583 += -130647835;
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aij.f(").append(')').toString());
		}
	}
		...
		try {
			...
			if (-628325139 * ((Class298_Sub37_Sub5) this).anInt9583 == 0) {
				...
				Class436.aClass348_5464
						.method4194(
								this,
								((((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9666) * 6619564980435866523L));
				return false;
			}
			return i_1_ != method3417(-912976938);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aij.b(").append(')').toString());
		}
	}
	...
	static final void method3419(Class403 class403, int i) {
		try {
			...
			if (-1 != -1232467723 * class105.anInt1280)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -66163287
						* class105.anInt1281;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aij.ps(").append(')').toString());
		}
	}
}
