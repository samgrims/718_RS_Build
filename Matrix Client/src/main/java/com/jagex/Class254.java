	...
	static final void method2423(Class403 class403, short i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class483
					.method6127(Integer.valueOf(i_2_), (byte) 94) ? 1 : 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kq.vo(").append(')').toString());
		}
	}
	...
	static final void method2424(Class403 class403, short i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class364
					.method4334((char) i_3_, -401787251) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kq.aaz(").append(')').toString());
		}
	}
			...
			Class23
					.method377(
							...
							(String) (((Class403) class403).anObjectArray5240[-203050393
									* ((Class403) class403).anInt5241 + 2]),
							(((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) == 1,
							true, (byte) -43);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kq.afy(").append(')').toString());
		}
	}

	static final void method2426(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class459
					.method5977((byte) 79).method242(694163818);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kq.ahl(").append(')').toString());
		}
	}
