...
public class Class298_Sub2 extends Class298 {
	...
	static final void method2847(int i, int i_0_, int i_1_, int i_2_, byte i_3_) {
		try {
			if (i - i_1_ >= Class372_Sub1.anInt4051 * -1424479739
					&& i_1_ + i <= Class372_Sub1.anInt4048 * 1135094847
					&& i_0_ - i_1_ >= Class372_Sub1.anInt4049 * 1155384281
					&& i_0_ + i_1_ <= Class372_Sub1.anInt4050 * -1062447355)
				Class433.method5797(i, i_0_, i_1_, i_2_, -586727793);
			else
				Class308.method3782(i, i_0_, i_1_, i_2_, 179222192);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aad.x(").append(')').toString());
		}
	}
	...
	static final void method2850(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = Integer.toString(i_5_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aad.ze(").append(')').toString());
		}
	}
}
