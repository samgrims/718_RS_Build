...
public class Class298_Sub32_Sub11_Sub1 extends Class298_Sub32_Sub11 {
	int[][] method3205(int i) {
		...
		if (aClass239_7380.aBoolean2607 && method3203(1713215539)) {
			...
			int[] is_1_ = is[1];
			int[] is_2_ = is[2];
			int i_3_ = (((Class298_Sub32_Sub11_Sub1) this).anInt9397
					* -2125962517 * (i % (-2125962517 * ((Class298_Sub32_Sub11_Sub1) this).anInt9397)));
			for (int i_4_ = 0; i_4_ < Class250.anInt2755 * -1474554145; i_4_++) {
				int i_5_ = (((Class298_Sub32_Sub11_Sub1) this).anIntArray9398[i_4_
						% (1274885639 * (((Class298_Sub32_Sub11_Sub1) this).anInt9396))
						+ i_3_]);
	...
	int[][] method3132(int i, byte i_6_) {
		try {
			...
			if (aClass239_7380.aBoolean2607 && method3203(372008576)) {
				...
				int[] is_8_ = is[1];
				int[] is_9_ = is[2];
				int i_10_ = (((Class298_Sub32_Sub11_Sub1) this).anInt9397
						* -2125962517 * (i % (-2125962517 * ((Class298_Sub32_Sub11_Sub1) this).anInt9397)));
				for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
					int i_12_ = (((Class298_Sub32_Sub11_Sub1) this).anIntArray9398[i_11_
							% (1274885639 * (((Class298_Sub32_Sub11_Sub1) this).anInt9396))
							+ i_10_]);
	...
	int[][] method3206(int i) {
		...
		if (aClass239_7380.aBoolean2607 && method3203(-1769350678)) {
			...
			int[] is_14_ = is[1];
			int[] is_15_ = is[2];
			int i_16_ = (((Class298_Sub32_Sub11_Sub1) this).anInt9397
					* -2125962517 * (i % (-2125962517 * ((Class298_Sub32_Sub11_Sub1) this).anInt9397)));
			for (int i_17_ = 0; i_17_ < Class250.anInt2755 * -1474554145; i_17_++) {
				int i_18_ = (((Class298_Sub32_Sub11_Sub1) this).anIntArray9398[i_17_
						% (1274885639 * (((Class298_Sub32_Sub11_Sub1) this).anInt9396))
						+ i_16_]);
