package com.jagex;/* Class395 - Decompiled by JODE
...
public class Class395 {
	...
	public Class298_Sub37_Sub4 method4900(int i, int i_0_) {
		try {
			...
			synchronized (((Class395) this).aClass348_5191) {
				class298_sub37_sub4 = ((Class298_Sub37_Sub4) ((Class395) this).aClass348_5191
						.method4184((long) i));
				if (null == class298_sub37_sub4) {
					class298_sub37_sub4 = new Class298_Sub37_Sub4(i);
					((Class395) this).aClass348_5191.method4194(
							class298_sub37_sub4, (long) i);
				}
	...
	public void method4902(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qj.i(").append(')').toString());
		}
	}

	public Class395(Class411 class411, Class429 class429, Class243 class243,
			Class243 class243_2_, Class243 class243_3_) {
	...
	public Class391 method4903(int i, byte i_4_) {
		try {
			Class391 class391;
			synchronized (((Class395) this).aClass348_5192) {
				class391 = (Class391) ((Class395) this).aClass348_5192
						.method4184((long) i);
			}
			if (null != class391)
				return class391;
	...
	static final void method4905(Class403 class403, int i) {
		try {
			...
			if (class497.method6206(1883696427))
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = (Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(i_6_).method6041(i_7_,
						class497.aString6101, (short) 26472));
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(i_6_).method6037(i_7_,
						class497.anInt6100 * -388931549, -2143571113));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qj.aat(").append(')').toString());
		}
	}
