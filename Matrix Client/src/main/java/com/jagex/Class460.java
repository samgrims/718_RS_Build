...
public class Class460 implements Iterator {
	...
	public boolean hasNext() {
		try {
			...
			.append("sy.hasNext(").append(')').toString());
		}
	}
	...
	public Object next() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("sy.next(").append(')').toString());
		}
	}
	...
	public Class298 method5979(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("sy.u(").append(')').toString());
		}
	}

	static final void method5980(byte i) {
		try {
			if (1 != Class360.anInt3896 * -707576455
					&& 100 != Class360.anInt3896 * -707576455) {
				do {
					try {
						int i_0_;
						...
						if (Class360.aBoolean3886
								&& Class360.anInt3896 * -707576455 >= 62)
							i_0_ = 6000;
						if (-122629167 * Class360.anInt3868 != 264
								|| (203 != Class360.anInt3896 * -707576455 && 42 != -1372893999
								* Class360.anInt3871))
						...
						if (-1937798425 * Class360.anInt3900 > i_0_) {
							...
							if (Class360.anInt3904 * 1820934059 < 3) {
								if (264 == Class360.anInt3868 * -122629167)
									Class474.aClass471_5979
									.method6058(-281677177);
								else
									Class241.aClass471_2705
									.method6058(-213625938);
						...
						if (12 == Class360.anInt3896 * -707576455) {
							if (264 == -122629167 * Class360.anInt3868) //World login
								Class360.aClass25_3905.method389((Class264_Sub4
										.method2515(Class474.aClass471_5979
												.method6056(295506052), 15000,
												-649048480)),
												Class474.aClass471_5979.address,
												(byte) 0);
							else
								Class360.aClass25_3905.method389((Class264_Sub4
										.method2515(IPAddress.createSocket(AppletLoader.LOBBY_IP, AppletLoader.LOBBY_PORT), 15000,
												-649048480)),
												Class241.aClass471_2705.address,
												(byte) 0);
							Class360.aClass25_3905.method383((short) 8191);
							Class298_Sub36 class298_sub36 = Class82_Sub6
									.method885(-1825045529);
							if (Class360.aBoolean3886) {
								class298_sub36.out
								.writeByte(
										(Class211.aClass211_2413.anInt2418 * -1813470547));
								class298_sub36.out
								.writeShort(0, 16711935);
								int i_1_ = 385051775 * (class298_sub36.out.index);
								class298_sub36.out
								.writeInt(AppletLoader.REVISION, -1354427278);
								if (AppletLoader.SUB_REVISION != -1) {
									class298_sub36.out
									.writeInt(AppletLoader.SUB_REVISION, 376398822);
								}
								if (-122629167 * Class360.anInt3868 == 264)
									class298_sub36.out
									.writeByte((5 == client.anInt8752
									* -1233866115 ? 1 : 0));
								RsByteBuffer class298_sub53 = Class322
										.method3933(-1454924768);
								class298_sub53.writeByte(
										(2084404473 * (Class360.anInt3873)));
								class298_sub53.writeShort(
										(int) (Math.random() * 9.9999999E7),
										16711935);
								class298_sub53.writeByte(
										Class321.aClass429_3357
										.method242(694163818));
								class298_sub53.writeInt(
										(client.anInt8665 * -1154804873),
										-1393012818);
								for (int i_2_ = 0; i_2_ < 6; i_2_++)
									...
									.writeInt(
											(int) (Math.random() * 9.9999999E7),
											499420945);
								class298_sub53.writeLong(client.aLong8675
										* -8380697455384249973L);
								class298_sub53
								.writeByte(
										(-937307905 * (client.aClass411_8944.gameType)));
								class298_sub53.writeByte(
										(int) (Math.random() * 9.9999999E7));
								class298_sub53.applyRsa(
										(Class50.aBigInteger500),
										(Class50.aBigInteger503), 1533826109);
								class298_sub36.out
								.writeBytes(
										class298_sub53.buffer,
										0,
										385051775 * class298_sub53.index,
										(short) -29754);
								class298_sub36.out
								.method3593(
										385051775
										* (class298_sub36.out.index)
										- i_1_, 1585504133);
							} else
								class298_sub36.out
								.writeByte(
										(-1813470547 * Class211.aClass211_2416.anInt2418));
							Class360.aClass25_3905.method390(class298_sub36,
									(byte) -57);
							Class360.aClass25_3905.method386(-1781606732);
							Class360.anInt3896 = 1009016718;
						}
						if (Class360.anInt3896 * -707576455 == 30) {
							if (!Class360.aClass25_3905.method387(537308016)
									.isAvailable(1, (byte) -19))
								break;
							Class360.aClass25_3905
							.method387(537308016)
							.readBytes(
									(((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer),
									0, 1, (byte) 75);
						...
						if (-707576455 * Class360.anInt3896 == 44) {
							...
							((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index = ((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333
									.readUnsignedShort() * 116413311;
							Class360.anInt3896 = -1485208182;
						}
						if (Class360.anInt3896 * -707576455 == 58) {
							if (!Class360.aClass25_3905
									.method387(537308016)
									.isAvailable(
											(385051775 * (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index)),
											(byte) 6))
								break;
							Class360.aClass25_3905
							.method387(537308016)
							.readBytes(
									...
									(385051775 * (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index)),
									(byte) 33);
							((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333
							.method3610(Class360.anIntArray3889,
									642509947);
							((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index = 0;
							String string = ((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333
									.readJagString(681479919);
							((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index = 0;
							String string_4_ = Class212.aClass212_2430
									.method1951(-1670386026);
							if (!client.aBoolean8638
									|| !Class65.method762(string, 1, string_4_,
											-2049749087))
								Class273.method2559(
										string,
										true,
										Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
										.method5677(-671601354) == 5,
										string_4_, client.aBoolean8867,
										client.aBoolean8651, -1487322449);
							Class360.anInt3896 = 1226307758;
						}
						if (Class360.anInt3896 * -707576455 == 62) {
							if (!Class360.aClass25_3905.method387(537308016)
									.isAvailable(1, (byte) 73))
								break;
							Class360.aClass25_3905
							.method387(537308016)
							.readBytes(
						...
						if (Class360.anInt3896 * -707576455 == 72) {
							...
							.method3610(Class360.anIntArray3889,
									642509947);
							((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index = 0;
							Class360.aLong3874 = (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333
									.readLong((short) 27770) * -2742373017286080113L);
							Class360.aLong3911 = (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333
									.readLong((short) 10381) * 3207425516430892907L);
							Class360.anInt3896 = 1898985570;
						}
						if (-707576455 * Class360.anInt3896 == 82) {
							...
							if (264 == -122629167 * Class360.anInt3868) { //WORLD LOGIN
								...
								stream.writeByte(-1813470547
										* class211.anInt2418);
								stream.writeShort(0, 16711935);
								int i_5_ = (385051775 * stream.index);
								int i_6_ = (385051775 * stream.index);
								if (!Class360.aBoolean3886) {
									stream.writeInt(AppletLoader.REVISION, 711122101);
									if (AppletLoader.SUB_REVISION != -1) {
										stream.writeInt(AppletLoader.SUB_REVISION, 98092954);
									}
									stream.writeByte((client.anInt8752
											* -1233866115 == 5 ? 1 : 0));
									i_6_ = (385051775 * stream.index);
									RsByteBuffer class298_sub53 = Class_ta_Sub2
											.method6003(-2133378997);
									stream.writeBytes(
											class298_sub53.buffer,
											0,
									...
									stream.writeByte(
											((Class360.aLong3874 * 122690138525332847L) == -1L ? 1
													: 0));
								...
								stream.writeByte(
										Class190.method1859((byte) -90));
								stream.writeShort(-2110394505
										* Class462.anInt5683, 16711935);
								stream.writeShort(
										(Class298_Sub40_Sub9.anInt9716 * -1111710645),
										16711935);
								stream.writeByte(
										Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550
										.method5675(-217929740));
								Class10.method322(stream, (byte) 1); // writes
								// 24
								// bytes
								stream.writeString((client.aString8927),
										2114152304);
								stream.writeInt(-1154804873 * client.anInt8665,
										-1572632938);
								RsByteBuffer class298_sub53 = Class422_Sub25.aClass298_Sub48_8425
										.method3542(-611972750);
								stream.writeByte(
										385051775 * class298_sub53.index);
								stream.writeBytes(
								...
								if (AppletLoader.usingRS) {
									RsByteBuffer class298_sub53_7_ = (new RsByteBuffer(
											Class12.aClass298_Sub44_9946
											.method3530(-1431420237)));
									Class12.aClass298_Sub44_9946
									.writeMachineInformation(
											class298_sub53_7_,
											652337983);
									stream.writeBytes(
											class298_sub53_7_.buffer,
											0,
											class298_sub53_7_.buffer.length,
											(short) -1355);
								}
								stream.writeInt(
										((client.anInt8713) * -2059460167),
										-1287558190);
								stream.writeLong(client.aLong8645
										* -5648129435911399733L);
								stream.writeByte(null == client.aString8648 ? 0
										: 1);
								if (client.aString8648 != null)
									stream.writeString(client.aString8648,
											2119355084);
								stream.writeByte(
										(Class84.aClass305_770.method3747(
                                                "jagtheora", 1302159774) ? 1
														: 0));
								stream.writeByte(
										((client.aBoolean8638) ? 1 : 0));
								stream.writeByte(
										((client.aBoolean8958) ? 1 : 0));
								stream.writeByte(
										((Class350.anInt3758) * -180909151));
								stream.writeInt(1886068421 * client.anInt8654,
										576248494);
								stream.writeString((client.aString8655),
										2141094155);
								stream.writeByte(
										(null == Class386.aClass471_4146 || ((1606920449 * Class474.aClass471_5979.worldId) != (Class386.aClass471_4146.worldId * 1606920449))) ? 1
												: 0);
								AccountCreationStage.writeCacheCRCs(stream, -956052447);
								stream.method3611(Class360.anIntArray3889,
										i_6_, 385051775 * stream.index,
										1729780581);
								stream.method3593(
										(385051775 * stream.index - i_5_),
										1585504133);
							} else { //LOBBY LOGIN
								Class211 class211;
								if (Class360.aBoolean3886)
								...
								if (!Class360.aBoolean3886) {
									stream.writeInt(AppletLoader.REVISION, -452164382);
									if (AppletLoader.SUB_REVISION != -1) {
										stream.writeInt(AppletLoader.SUB_REVISION, 317411115);
									}
						...
						if (94 == -707576455 * Class360.anInt3896) {
							if (!Class360.aClass25_3905.method387(537308016)
									.isAvailable(1, (byte) -69))
								break;
							Class360.aClass25_3905.method387(537308016).readBytes((((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer),
									0, 1, (byte) -72);
							...
							if (21 == loginOpcode)
								...
								if (loginOpcode == 2)
									...
									if (loginOpcode == 23
											&& (1820934059 * Class360.anInt3904 < 3)) {
										Class360.anInt3900 = 0;
										Class360.anInt3904 += -72367357;
										Class360.anInt3896 = -455386772;
										Class360.aClass25_3905
										...
										if (loginOpcode == 42) {
											...
											if (Class360.aBoolean3870
													&& !Class360.aBoolean3886
													&& -1 != (2084404473 * Class360.anInt3873)
													&& 35 == loginOpcode) {
						...
						if (Class360.anInt3896 * -707576455 == 117) {
							Class360.aClass25_3905.method383((short) 8191);
							Class298_Sub36 class298_sub36 = Class82_Sub6
									.method885(-1106381844);
							RsBitsBuffer class298_sub53_sub2 = class298_sub36.out;
							class298_sub53_sub2.method3665(
									(Class360.aClass25_3905.aClass449_330),
									(byte) 41);
							class298_sub53_sub2
							.method3668(
									(-1813470547 * (Class211.aClass211_2419.anInt2418)),
									(byte) 1);
							Class360.aClass25_3905.method390(class298_sub36,
									(byte) -122);
							...
							if (Class360.aClass25_3905.method387(537308016)
									.isAvailable(2, (byte) 92)) {
								Class360.aClass25_3905
								.method387(537308016)
								.readBytes(
										(((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer),
										0, 2, (byte) 31);
								Class360.anInt3866 = ((((((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer[0]) & 0xff) << 8) + ((((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer[1]) & 0xff))
										* -1156978587;
								Class360.anInt3896 = 1443598798;
							}
							...
							if (29 == Class197.anInt1992 * 1892081585) {
								if (!Class360.aClass25_3905
										.method387(537308016).isAvailable(1,
												(byte) 78))
									break;
								Class360.aClass25_3905
								.method387(537308016)
								...
								if (!Class360.aClass25_3905
										.method387(537308016).isAvailable(3,
												(byte) -85))
									break;
								Class360.aClass25_3905
								.method387(537308016)
								...
								throw new IllegalStateException();
							Class360.anInt3896 = -395862839;
							Class78.method845(1892081585 * Class197.anInt1992,
									-28417078);
							Class360.aClass25_3905.method384((byte) 7);
							ClientScriptsExecutor.method4693(1976641602);
						} else if (137 == Class360.anInt3896 * -707576455) { //if sucefull world login, index 2
							if (Class360.aClass25_3905.method387(537308016)
									.isAvailable(1, (byte) -1)) {
							...
							if (-707576455 * Class360.anInt3896 == 148) { //if world login
								RsBitsBuffer stream = (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333);
								if (264 == Class360.anInt3868 * -122629167) { //world login, 264
									if (!Class360.aClass25_3905.method387(
											537308016).isAvailable(
													-1359010095 * Class360.loginConfigsSize,
													(byte) 68))
										break;
									Class360.aClass25_3905.method387(537308016).readBytes(stream.buffer, 0, Class360.loginConfigsSize * -1359010095, (byte) 13);
									stream.index = 0;
									client.playerRights = (stream
											.readUnsignedByte() * 1835619115);
									client.anInt8932 = (stream
											.readUnsignedByte() * -418443653);
									client.aBoolean8811 = stream
											.readUnsignedByte() == 1;
									client.aBoolean8812 = stream
											.readUnsignedByte() == 1;
									client.aBoolean8813 = stream
											.readUnsignedByte() == 1;
									client.aBoolean8802 = stream
											.readUnsignedByte() == 1;
									client.playerIndex = (stream
											.readUnsignedShort() * 1448461709);
									client.aBoolean8807 = stream
											.readUnsignedByte() == 1;
									Class298_Sub41.anInt7456 = (stream
											.read24BitInteger((byte) -39) * 777394511);
									client.isMemberWorld = stream
											.readUnsignedByte() == 1;
									Class112.aString1369 = stream
											.readString(-796084606);
									client.aClass283_8716.method2641(
											-1352577967).method5790(
													client.isMemberWorld, 915103443);
									Class62.aClass248_612
									.method2384((short) 206)
									.method2641(-884206015)
									.method5790(client.isMemberWorld,
											915103443);
									Class298_Sub32_Sub14.aClass477_9400
									.method6092(client.isMemberWorld,
											798055588);
									Class15.aClass507_224.method6270(
											client.isMemberWorld, (byte) -2);
								} else { //lobby login
									if (!Class360.aClass25_3905.method387(
											537308016).isAvailable(Class360.loginConfigsSize * -1359010095, (byte) -27))
										break;
									Class360.aClass25_3905.method387(537308016).readBytes(stream.buffer, 
											0, Class360.loginConfigsSize * -1359010095, (byte) 29); 
									stream.index = 0;
									...
									if ((Class242.aClass401_2708 != Class401.aClass401_6552)
											&& ((Class242.aClass401_2708 != Class401.aClass401_6554) || (1806357379 * client.playerRights < 2))
											&& (Class474.aClass471_5979.method6057(Class474.aClass471_5976,	2123928060))) {
										Class380.method4678(-1667448332);
									}
								}
								if (client.aBoolean8811 && !client.aBoolean8813
										|| client.aBoolean8807) {
									try {
								...
								if (264 == Class360.anInt3868 * -122629167) //World login
							...
							if (-707576455 * Class360.anInt3896 == 176) {
								...
								((Class25) Class360.aClass25_3905).INCOMMING_PACKET = (Class510
										.method6290(-1456212765)[stream
										                         .readUnsignedSmart(250607366)]); //receives packet id
								((Class25) Class360.aClass25_3905).anInt336 = (stream
										.readUnsignedShort() * -1265692267); //stream required size, prob packet size
							...
							if (158 == -707576455 * Class360.anInt3896) {
								if (Class360.aClass25_3905
										.method387(537308016)
										.isAvailable(
												(-866602563 * (((Class25) Class360.aClass25_3905).anInt336)),
												(byte) -22)) {
									Class360.aClass25_3905
									.method387(537308016)
									.readBytes(
									...
									Class51.decodeLswp(
											(((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333),
											837096225);
									int i_16_ = packetSize
											- (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index)
											* 385051775;
									RsBitsBuffer stream = new RsBitsBuffer(
											i_16_);
									System.arraycopy(
											(((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer),
											((((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index) * 385051775),
											stream.buffer,
											0, i_16_);
									...
									if ((((Class25) Class360.aClass25_3905).INCOMMING_PACKET) == IncommingPacket.LOAD_MAP_SCENE_DYNAMIC_PACKET)
										...
										.sendMapScene(
												new Class267(
														(Class266.LOAD_MAP_SCENE_DYNAMIC),
														stream),
														-1991819579);
									else
										client.aClass283_8716
										.sendMapScene(
												new Class267(
														(Class266.LOAD_MAP_SCENE_NORMAL),
														stream),
														-1991819579);
									if (packetSize != (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index) * 385051775)
										throw new RuntimeException(
												new StringBuilder()
												.append(385051775 * (((Class25) (Class360.aClass25_3905)).aClass298_Sub53_Sub2_333.index))
												.append(" ")
												.append(packetSize)
												.toString());
									((Class25) Class360.aClass25_3905).INCOMMING_PACKET = null;
								...
								if (-2 == (-866602563 * (((Class25) Class360.aClass25_3905).anInt336))) {
									if (!Class360.aClass25_3905.method387(
											537308016).isAvailable(2, (byte) 39))
										break;
									Class360.aClass25_3905
									.method387(537308016)
									.readBytes(
											...
											0, 2, (byte) 9);
									((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index = 0;
									((Class25) Class360.aClass25_3905).anInt336 = (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333
											.readUnsignedShort() * -1265692267);
								}
								if (Class360.aClass25_3905
										.method387(537308016)
										.isAvailable(
									...
									.readBytes(
											(((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.buffer),
											0,
											(((Class25) Class360.aClass25_3905).anInt336)
											* -866602563,
											(byte) -73);
									((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index = 0;
									...
									if ((385051775 * (((Class25) Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index)) != i_17_)
										throw new RuntimeException(
												new StringBuilder()
												.append((((Class25) (Class360.aClass25_3905)).aClass298_Sub53_Sub2_333.index) * 385051775)
												.append(" ")
												.append(i_17_)
												.toString());
									((Class25) Class360.aClass25_3905).INCOMMING_PACKET = null;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("sy.c(").append(')').toString());
		}
	}

	static void method5981(boolean bool, boolean bool_18_, String string,
			String string_19_, long l) {
		try {
			...
			if (!Class360.aBoolean3870
					&& (Class360.username.equals("") || Class360.password
							.equals("")))
