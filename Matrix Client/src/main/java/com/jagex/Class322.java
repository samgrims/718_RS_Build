...
public class Class322 {
	...
	static final void method3930(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nk.wv(").append(')').toString());
		}
	}

	public static Class505 method3931(Class243 class243, int i, int i_1_,
			byte i_2_) {
		try {
	...
	static final void method3932(long l) {
		try {
			if (client.aClass283_8716.method2675(-1611682495) != null) {
				if (4 == -863531439 * Class298_Sub1.anInt7164
						|| 5 == Class298_Sub1.anInt7164 * -863531439)
			...
			int i_3_ = (Class287.myPlayer
					.getSize() << 8);
			Class217 class217 = (Class287.myPlayer
					.method4337().aClass217_2599);
			Class341.method4144(
					(Class287.myPlayer.plane),
					i_3_ + (int) class217.aFloat2451, (int) class217.aFloat2454
							+ i_3_, client.anInt8961 * 614680345, (short) 8192);
			client.anInt8961 = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nk.ia(").append(')').toString());
		}
	}
