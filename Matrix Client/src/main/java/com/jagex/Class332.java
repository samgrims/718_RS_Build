...
public class Class332 {
	...
	final boolean method4064(int i, int i_0_, int i_1_, int i_2_, int i_3_,
			int i_4_, int i_5_, int i_6_, int i_7_) {
		if (i > 2001 || i_0_ > 2001 || i_1_ > 2001 || i_2_ > 2001
				|| i_3_ > 2001 || i_4_ > 2001)
			return false;
		if (i < -2001 || i_0_ < -2001 || i_1_ < -2001 || i_2_ < -2001
				|| i_3_ < -2001 || i_4_ < -2001)
		...
		if (((Class332) this).anInt3572 == 2) {
			int i_8_ = i_2_ + i
					* (((Class333) ((Class332) this).aClass333_3568).anInt3603);
			if (i_8_ >= 0
					&& i_8_ < (((Class333) ((Class332) this).aClass333_3568).anIntArray3599).length
					&& ((i_5_ << 8) - 38400 < (((Class333) ((Class332) this).aClass333_3568).anIntArray3599[i_8_])))
				return false;
			i_8_ = i_3_ + i_0_
					* (((Class333) ((Class332) this).aClass333_3568).anInt3603);
			if (i_8_ >= 0
					&& i_8_ < (((Class333) ((Class332) this).aClass333_3568).anIntArray3599).length
					&& ((i_6_ << 8) - 38400 < (((Class333) ((Class332) this).aClass333_3568).anIntArray3599[i_8_])))
				return false;
			i_8_ = i_4_ + i_1_
					* (((Class333) ((Class332) this).aClass333_3568).anInt3603);
			if (i_8_ >= 0
					&& i_8_ < (((Class333) ((Class332) this).aClass333_3568).anIntArray3599).length
					&& ((i_7_ << 8) - 38400 < (((Class333) ((Class332) this).aClass333_3568).anIntArray3599[i_8_])))
				return false;
		}
		int i_9_ = i_3_ - i_2_;
		int i_10_ = i_0_ - i;
		...
		if (i <= i_0_ && i <= i_1_) {
			...
			if (i_0_ < i_1_) {
				...
				if (i != i_0_ && i_17_ < i_15_ || i == i_0_ && i_17_ > i_16_) {
					...
					while (--i_0_ >= 0) {
						if (!method4065(
								(((Class333) ((Class332) this).aClass333_3568).anIntArray3599),
								i,
								0,
								(i_4_ >> 12) - 1,
								(i_2_ >> 12) + 1,
		...
		if (i_0_ <= i_1_) {
			...
			if (i_1_ < i) {
				...
				if (i_0_ != i_1_ && i_15_ < i_16_ || i_0_ == i_1_
						&& i_15_ > i_17_) {
					i -= i_1_;
					i_1_ -= i_0_;
		...
		while (--i_0_ >= 0) {
			if (!method4065(
					(((Class333) ((Class332) this).aClass333_3568).anIntArray3599),
					i_1_, 0, (i_4_ >> 12) - 1, (i_2_ >> 12) + 1, i_7_, i_19_,
					(((Class333) ((Class332) this).aClass333_3568).anInt3603)))
				return false;
			i_2_ += i_16_;
			i_4_ += i_17_;
		...
		while (--i >= 0) {
			if (!method4065(
					(((Class333) ((Class332) this).aClass333_3568).anIntArray3599),
					i_1_, 0, (i_4_ >> 12) - 1, (i_3_ >> 12) + 1, i_7_, i_19_,
					(((Class333) ((Class332) this).aClass333_3568).anInt3603)))
				return false;
			i_3_ += i_15_;
			i_4_ += i_17_;
	...
	final boolean method4065(int[] is, int i, int i_21_, int i_22_, int i_23_,
