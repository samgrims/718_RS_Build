			...
			if ((i_23_ & 0x2) == 0) {
				if ((i_23_ & 0x1) == 0) {
					for (int i_24_ = 0; i_24_ < i_22_; i_24_++)
						class89.aByteArray818[i_24_] = class298_sub53
								.readByte(-12558881);
				} else {
					for (int i_25_ = 0; i_25_ < class89.anInt812; i_25_++) {
						for (int i_26_ = 0; i_26_ < class89.anInt816; i_26_++)
							class89.aByteArray818[(i_25_ + i_26_
									* class89.anInt812)] = class298_sub53
									.readByte(-12558881);
					}
				}
			} else {
				...
				if ((i_23_ & 0x1) == 0) {
					for (int i_27_ = 0; i_27_ < i_22_; i_27_++)
						class89.aByteArray818[i_27_] = class298_sub53
								.readByte(-12558881);
					for (int i_28_ = 0; i_28_ < i_22_; i_28_++) {
						byte i_29_ = (class89.aByteArray819[i_28_] = class298_sub53
								.readByte(-12558881));
						bool = bool | i_29_ != -1;
					}
				} else {
	...
	public void method986(int i) {
		...
		if (anIntArray817.length < 255) {
			...
			if (i_62_ == -1) {
				...
				Class425.method5741(anIntArray817, 0, is, 0,
						anIntArray817.length);
				anIntArray817 = is;
				is[i_62_] = i;
			}
		} else {
		...
		for (int i_78_ = 0; i_78_ < anInt816; i_78_++) {
			for (int i_79_ = 0; i_79_ < anInt812; i_79_++) {
				...
				if (anIntArray817[i_80_] == 0) {
					if (i_79_ > 0
							&& anIntArray817[aByteArray818[i_77_ - 1] & 0xff] != 0)
						i_80_ = i_62_;
					else if (i_78_ > 0
							&& anIntArray817[(aByteArray818[i_77_ - anInt812] & 0xff)] != 0)
						i_80_ = i_62_;
					else if (i_79_ < anInt812 - 1
							&& (anIntArray817[aByteArray818[i_77_ + 1] & 0xff] != 0))
						i_80_ = i_62_;
					else if (i_78_ < anInt816 - 1
							&& anIntArray817[(aByteArray818[i_77_ + anInt812] & 0xff)] != 0)
						i_80_ = i_62_;
				}
				is[i_77_++] = (byte) i_80_;
	...
	public void method988(int i) {
		...
		for (int i_97_ = anInt816 - 1; i_97_ > 0; i_97_--) {
			...
			for (int i_99_ = anInt812 - 1; i_99_ > 0; i_99_--) {
				if (anIntArray817[aByteArray818[i_99_ + i_98_] & 0xff] == 0
						&& ((anIntArray817[aByteArray818[i_99_ + i_98_ - 1
								- anInt812] & 0xff]) != 0))
