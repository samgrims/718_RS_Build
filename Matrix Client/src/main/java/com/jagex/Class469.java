...
public class Class469 {
	...
	public Class469(Class429 class429, Class243 class243, Class243 class243_0_,
	...
	String method6044(Class367 class367, int[] is, long l) {
		try {
			if (((Class469) this).anInterface20_5780 != null) {
				String string = ((Class469) this).anInterface20_5780.method241(
						class367, is, l);
				if (string != null)
					return string;
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ti.f(").append(')').toString());
		}
	}

	public Class298_Sub37_Sub14 method6045(int i, short i_1_) {
		try {
			Class298_Sub37_Sub14 class298_sub37_sub14 = ((Class298_Sub37_Sub14) ((Class469) this).aClass348_5779
					.method4184((long) i));
			if (null != class298_sub37_sub14)
				return class298_sub37_sub14;
			byte[] is;
			if (i >= 32768)
				is = ((Class469) this).aClass243_5776.method2315(1, i & 0x7fff,
						(byte) -26);
			else
				is = ((Class469) this).aClass243_5778.method2315(1, i,
						(byte) -31);
			class298_sub37_sub14 = new Class298_Sub37_Sub14();
			((Class298_Sub37_Sub14) class298_sub37_sub14).aClass469_9651 = this;
			if (is != null)
				class298_sub37_sub14.method3457(new RsByteBuffer(is),
						1219453152);
			if (i >= 32768)
				class298_sub37_sub14.method3456(-877048074);
			((Class469) this).aClass348_5779.method4194(class298_sub37_sub14,
					(long) i);
			return class298_sub37_sub14;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ti.a(").append(')').toString());
		}
	}
	...
	public static int method6046(int i, int i_2_, byte i_3_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ti.u(").append(')').toString());
		}
	}

	static void method6047(GraphicsToolkit class_ra, Interface_ma interface_ma, int i,
		...
		try {
			...
			if (Class301_Sub1.anInt7624 * -1289394455 < 100) {
				...
				class_ra.method5019(i_10_ - 152, i_11_, 304, 34,
						client.aColorArray8701[745003679 * client.anInt8971]
								.getRGB(), 0);
				class_ra.B(i_10_ - 150, i_11_ + 2,
						Class301_Sub1.anInt7624 * 426783931, 30,
						client.aColorArray8689[745003679 * client.anInt8971]
								.getRGB(), 0);
				Class101.aClass264_1084.method2490(Tradution.aClass470_5938
						.method6049(Class321.aClass429_3357, -875414210),
						i_10_, i_11_ + i_9_,
						client.aColorArray8691[client.anInt8971 * 745003679]
								.getRGB(), -1, -863370132);
			} else {
				...
				Class301_Sub1.method3709(i_12_ + Class301_Sub1.anInt3245, i_13_
						+ Class301_Sub1.anInt3238, Class301_Sub1.anInt3245
						+ i_14_, i_15_ + Class301_Sub1.anInt3238, i, i_5_, i_6_
						+ i, 1 + (i_5_ + i_7_));
				...
				if (client.aBoolean8667) {
					...
					Class343.aClass264_3673.method2474(new StringBuilder()
							.append("Fps:").append(
									914379507 * Class291.anInt6467).toString(),
							i_16_, i_17_, 16776960, -1, (byte) -35);
					i_17_ -= 15;
					Runtime runtime = Runtime.getRuntime();
					int i_18_ = (int) ((runtime.totalMemory() - runtime
							.freeMemory()) / 1024L);
					int i_19_ = 16776960;
					if (i_18_ > 65536)
						i_19_ = 16711680;
					Class343.aClass264_3673.method2474(new StringBuilder()
							.append("Mem:").append(i_18_).append("k")
							.toString(), i_16_, i_17_, i_19_, -1, (byte) -2);
					i_17_ -= 15;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ti.bv(").append(')').toString());
		}
	}

	static MapDetails method6048(Class243 class243, int i, int i_20_,
                                 int i_21_) {
		try {
			RsByteBuffer class298_sub53 = new RsByteBuffer(class243
					.method2315(i, i_20_, (byte) 3));
			MapDetails class298_sub37_sub13 = (new MapDetails(
					i_20_, class298_sub53.readString(-1014876746),
					class298_sub53.readString(-346433981), class298_sub53
							.readInt((byte) -81), class298_sub53
							.readInt((byte) 27), class298_sub53
							.readUnsignedByte() == 1, class298_sub53
							.readUnsignedByte(), class298_sub53
							.readUnsignedByte()));
			int i_22_ = class298_sub53.readUnsignedByte();
			for (int i_23_ = 0; i_23_ < i_22_; i_23_++)
				((MapDetails) class298_sub37_sub13).aClass453_9642
						.method5935(new Class298_Sub42(class298_sub53
								.readUnsignedByte(), class298_sub53
								.readUnsignedShort(), class298_sub53
								.readUnsignedShort(), class298_sub53
								.readUnsignedShort(), class298_sub53
								.readUnsignedShort(), class298_sub53
								.readUnsignedShort(), class298_sub53
