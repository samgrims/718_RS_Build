		...
		try {
			...
			if (((Class298_Sub37_Sub4) this).aByteArrayArray9581 == null) {
				synchronized (Class317.aClass243_3321) {
					if (!Class317.aClass243_3321
							.method2291(
									1899473659 * ((Class298_Sub37_Sub4) this).anInt9580,
									334179097)) {
						boolean bool = false;
						return bool;
					}
					int[] is = (Class317.aClass243_3321
							.method2307(
					...
					for (int i_0_ = 0; i_0_ < is.length; i_0_++)
						((Class298_Sub37_Sub4) this).aByteArrayArray9581[i_0_] = (Class317.aClass243_3321
								.method2315(
										(1899473659 * ((Class298_Sub37_Sub4) this).anInt9580),
										is[i_0_], (byte) -7));
				}
			...
			synchronized (Class317.aClass243_3321) {
				...
				is = Class317.aClass243_3321.method2307(
						(((Class298_Sub37_Sub4) this).anInt9580 * 1899473659),
						-2046558264);
			}
			for (int i_4_ = 0; i_4_ < is.length; i_4_++) {
				...
				for (Class298_Sub15 class298_sub15_7_ = (Class298_Sub15) class458
						.method5967(2084946117); class298_sub15_7_ != null; class298_sub15_7_ = (Class298_Sub15) class458
						.method5969((byte) -23)) {
				...
				if (null == class298_sub15) {
					synchronized (aClass243_9582) {
						class298_sub15 = (new Class298_Sub15(i_6_,
								aClass243_9582.method2294(i_6_, (byte) 34)));
					}
					class458.method5968(class298_sub15, 805140432);
				}
				((Class298_Sub37_Sub4) this).aClass96Array9579[is[i_4_]] = new Class96(
						is_5_, class298_sub15);
			}
			((Class298_Sub37_Sub4) this).aByteArrayArray9581 = null;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aih.f(").append(')').toString());
		}
	}
