package com.jagex;/* Class422 - Decompiled by JODE
...
public abstract class Class422 {
	...
	static final void method5618(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rm.amc(").append(')').toString());
		}
	}

	static int method5619(CharSequence charsequence, int i, boolean bool,
			int i_4_) {
		try {
			if (i < 2 || i > 36)
