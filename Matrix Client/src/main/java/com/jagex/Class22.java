...
public class Class22 {
	...
	static Class115[] method370(int i) {
		try {
			return (new Class115[] { Class115.aClass115_1385,
					Class115.aClass115_1386, Class115.aClass115_1388,
					Class115.aClass115_1384, Class115.aClass115_1383 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aw.a(").append(')').toString());
		}
	}
	...
	static void method372(RsByteBuffer buffer, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aw.b(").append(')').toString());
		}
	}

	static final void method373(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.aStringArray1195 = null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aw.jx(").append(')').toString());
		}
	}
	...
	static final void method374(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556
					.method5633(-863865720) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aw.ajp(").append(')').toString());
		}
	}
}
