...
public class Class281 {
	...
	Class281() {
		...
		for (int i_23_ = 0; i_23_ < i_20_; i_23_++) {
			((Class281) this).anIntArray2993[i_23_] = Class298_Sub23
					.method3070(3) + 1;
			int i_24_ = (((Class281) this).anIntArray2989[i_23_] = Class298_Sub23
					.method3070(2));
			if (i_24_ != 0)
				((Class281) this).anIntArray2991[i_23_] = Class298_Sub23
						.method3070(8);
			i_24_ = 1 << i_24_;
		...
		for (int i_29_ = 0; i_29_ < i_19_; i_29_++) {
			...
			for (int i_31_ = 0; i_31_ < ((Class281) this).anIntArray2993[i_30_]; i_31_++)
				((Class281) this).anIntArray2990[i_27_++] = Class298_Sub23
						.method3070(i_26_);
		}
	...
	boolean method2613() {
		...
		for (int i_36_ = 0; i_36_ < ((Class281) this).anIntArray2992.length; i_36_++) {
			...
			int i_41_ = 0;
			if (i_39_ > 0)
				i_41_ = Class298_Sub23.aClass265Array7328[((Class281) this).anIntArray2991[i_37_]]
						.method2517();
			for (int i_42_ = 0; i_42_ < i_38_; i_42_++) {
				int i_43_ = (((Class281) this).anIntArrayArray2996[i_37_][i_41_
						& i_40_]);
				i_41_ >>>= i_39_;
				anIntArray2998[i_35_++] = (i_43_ >= 0 ? Class298_Sub23.aClass265Array7328[i_43_]
						.method2517()
						: 0);
			}
		}
	...
	void method2614(float[] fs, int i) {
		...
		for (int i_46_ = 2; i_46_ < i_44_; i_46_++) {
			...
			int i_49_ = method2611(anIntArray2997[i_47_],
					anIntArray2998[i_47_], anIntArray2997[i_48_],
					anIntArray2998[i_48_], anIntArray2997[i_46_]);
			...
			if (i_50_ != 0) {
				...
				if (i_50_ >= i_53_)
					anIntArray2998[i_46_] = (i_51_ > i_52_ ? i_50_ - i_52_
							+ i_49_ : i_49_ - i_50_ + i_51_ - 1);
				else
					anIntArray2998[i_46_] = ((i_50_ & 0x1) != 0 ? i_49_
							- (i_50_ + 1) / 2 : i_49_ + i_50_ / 2);
			} else {
	...
	static {
		aFloatArray2994 = (new float[] { 1.0649863E-7F, 1.1341951E-7F,
				...
				0.035545226F, 0.037855156F, 0.0403152F, 0.042935107F,
				0.045725275F, 0.048696756F, 0.05186135F, 0.05523159F,
				0.05882085F, 0.062643364F, 0.06671428F, 0.07104975F,
				0.075666964F, 0.08058423F, 0.08582105F, 0.09139818F,
				0.097337745F, 0.1036633F, 0.11039993F, 0.11757434F,
				0.12521498F, 0.13335215F, 0.14201812F, 0.15124726F,
				0.16107617F, 0.1715438F, 0.18269168F, 0.19456401F, 0.20720787F,
				0.22067343F, 0.23501402F, 0.25028655F, 0.26655158F,
	...
	void method2616(int i, int i_68_, int i_69_, int i_70_, float[] fs,
			int i_71_) {
