...
public class Class370 {
	...
	public Class376 method4576(int i, int i_1_) {
		try {
			Class376 class376;
			synchronized (((Class370) this).aClass348_4029) {
				class376 = (Class376) ((Class370) this).aClass348_4029
						.method4184((long) i);
			}
			if (null != class376)
				return class376;
	...
	public static void method4578(int i, boolean bool, int i_2_) {
		try {
			Class371.method4584(i, Tradution.aClass470_5874.method6049(
					Class321.aClass429_3357, -875414210), bool, (byte) 31);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pj.fw(").append(')').toString());
		}
	}

	static void method4579(int i, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_, Class435 class435, byte i_8_) {
		try {
			Class298_Sub1 class298_sub1 = null;
			for (Class298_Sub1 class298_sub1_9_ = ((Class298_Sub1) Class298_Sub1.aClass453_7162
					.method5939(1766612795)); class298_sub1_9_ != null; class298_sub1_9_ = ((Class298_Sub1) Class298_Sub1.aClass453_7162
					.method5944(49146))) {
				if (i == (2108312995 * ((Class298_Sub1) class298_sub1_9_).anInt7151)
						&& i_3_ == 634196087 * class298_sub1_9_.anInt7150
						&& i_4_ == class298_sub1_9_.anInt7155 * -2146829167
						&& -431456739
								* (((Class298_Sub1) class298_sub1_9_).anInt7157) == i_5_) {
			...
			if (null == class298_sub1) {
				...
				Class298_Sub1.aClass453_7162.method5935(class298_sub1,
						1693481470);
			}
