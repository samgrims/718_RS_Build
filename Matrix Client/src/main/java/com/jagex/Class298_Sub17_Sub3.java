...
public class Class298_Sub17_Sub3 extends Class298_Sub17 {
	...
	void method2917(RsByteBuffer class298_sub53, int i) {
		try {
			((Class298_Sub17_Sub3) this).anInt9201 = class298_sub53
					.readUnsignedShort() * 2081754389;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agk.a(").append(')').toString());
		}
	}

	void method2918(Class298_Sub25 class298_sub25, int i) {
		try {
			class298_sub25.method3100(
					(((Class298_Sub17_Sub3) this).anInt9201 * -528950723),
					-554375757);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agk.f(").append(')').toString());
		}
	}
