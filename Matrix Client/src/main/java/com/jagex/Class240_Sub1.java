...
public class Class240_Sub1 extends Class240 {
	...
	void method2234(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_,
			Class289 class289, int i_3_) {
		try {
			Interface3 interface3 = method2241(i, i_0_, i_1_, i_2_, 1530247338);
			if (null != interface3) {
				ObjectDefinitions class432 = (((Class240_Sub1) this).aClass433_7072
						.getObjectDefinitions(interface3.method32((byte) 80)));
				...
				if (i_0_ == 0) {
					...
					if (0 != class432.anInt5380 * -2144543407)
						class289.method2743(i_1_, i_2_, i_4_, i_5_,
								class432.aBoolean5424, !class432.aBoolean5416,
								(byte) 108);
					if (-1508517619 * class432.anInt5376 == 1) {
						if (0 == i_5_)
							aClass331_2619.aClass333_3512.method4068(1, i,
									i_1_, i_2_);
						else if (1 == i_5_)
							aClass331_2619.aClass333_3512.method4068(2, i,
									i_1_, 1 + i_2_);
						else if (2 == i_5_)
							aClass331_2619.aClass333_3512.method4068(1, i,
									i_1_ + 1, i_2_);
					...
					aClass331_2619.method4028(i, i_1_, i_2_,
							client.anInterface17_8960, (short) -414);
					if (0 != class432.anInt5380 * -2144543407
							&& (-1125834887 * class432.sizeX + i_1_ < anInt2627
									* -954368823)
							&& (-1125834887 * class432.sizeX + i_2_ < anInt2628 * 181474463)
							&& (-565161399 * class432.sizeY + i_1_ < anInt2627
									* -954368823)
							&& (-565161399 * class432.sizeY + i_2_ < 181474463 * anInt2628))
						class289.method2736(i_1_, i_2_, class432.sizeX
					...
					if (Class424.aClass424_6595.anInt6613 * -1976050083 == i_4_) {
						if ((i_5_ & 0x1) == 0)
							...
							aClass331_2619.aClass333_3512.method4068(16, i,
									i_1_, i_2_);
					}
				} else if (3 == i_0_) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.cr(").append(')').toString());
		}
	}

	public final void method2235(GraphicsToolkit class_ra,
			RsByteBuffer class298_sub53, int i, int i_6_, byte i_7_) {
		try {
			if (!aBoolean2629) {
				boolean bool = false;
				...
				while_0_: do {
					for (;;) {
						...
						if (i_8_ == 0) {
							if (class385 == null)
								class385 = new Class385(class298_sub53,
										(((Class240_Sub1) this).aClass364_7080));
							else
								class385
										.method4706(
												class298_sub53,
							...
							if (i_9_ > 0) {
								for (int i_10_ = 0; i_10_ < i_9_; i_10_++) {
									Class321 class321 = new Class321(
											class_ra,
											(-1688804109 * (aClass331_2619.anInt3504)),
											class298_sub53, 2);
									if (589172669 * class321.anInt3351 == 31) {
										Class493 class493 = (Class237.aClass499_6668
												.method6214(
														class298_sub53
																.readUnsignedShort(),
														-1728729634));
										class321
												.method3917(
														class493.anInt6088 * 1438741121,
														class493.anInt6087
																* -2095379959,
														2096922993 * class493.anInt6085,
														1418726113 * class493.anInt6086,
														320507599);
									}
									if (class_ra.method5048() > 0) {
										Class298_Sub10 class298_sub10 = class321.aClass298_Sub10_3337;
										int i_11_ = (class298_sub10
												.method2895(823958259) + (i << 9));
										int i_12_ = (class298_sub10
												.method2897((byte) 113) + (i_6_ << 9));
										int i_13_ = i_11_ >> 9;
										int i_14_ = i_12_ >> 9;
										if (i_13_ >= 0
												&& i_14_ >= 0
												&& i_13_ < -954368823
														* anInt2627
												&& i_14_ < 181474463 * anInt2628) {
											class298_sub10
													.method2899(
															i_11_,
															((anIntArrayArrayArray2653[(class321.anInt3345 * -1565952249)][i_13_][i_14_]) - (class298_sub10
																	.method2894(1382635254))),
															i_12_, (byte) 37);
											aClass331_2619.method4051(class321,
													763639750);
										}
									}
								}
							...
							if (class385 == null)
								class385 = new Class385();
							class385.method4712(class298_sub53,
									(((Class240_Sub1) this).aClass364_7080),
									(byte) 11);
						} else {
							if (129 != i_8_)
							...
							for (int i_15_ = 0; i_15_ < 4; i_15_++) {
								byte i_16_ = class298_sub53
										.readByte(-12558881);
								if (i_16_ == 0
										&& (null != aByteArrayArrayArray2631[i_15_])) {
									int i_17_ = i;
									int i_18_ = i + 64;
									int i_19_ = i_6_;
									int i_20_ = 64 + i_6_;
									...
									if (aByteArrayArrayArray2631[i_15_] == null)
										aByteArrayArrayArray2631[i_15_] = (new byte[anInt2627
												* -954368823 + 1][1 + anInt2628 * 181474463]);
									for (int i_21_ = 0; i_21_ < 64; i_21_ += 4) {
										for (int i_22_ = 0; i_22_ < 64; i_22_ += 4) {
											byte i_23_ = class298_sub53
													.readByte(-12558881);
											for (int i_24_ = i_21_ + i; i_24_ < 4 + (i_21_ + i); i_24_++) {
												for (int i_25_ = i_22_ + i_6_; (i_25_ < 4 + (i_6_ + i_22_)); i_25_++) {
													if (i_24_ >= 0
															&& (i_24_ < (-954368823 * anInt2627))
															&& i_25_ >= 0
															&& (i_25_ < (181474463 * anInt2628)))
									...
									if (i_15_ > 0) {
										...
										if (i_26_ < 0)
											i_26_ = 0;
										else if (i_26_ >= anInt2627
												* -954368823)
											i_26_ = anInt2627 * -954368823;
										if (i_27_ < 0)
											i_27_ = 0;
										else if (i_27_ >= anInt2627
												* -954368823)
				...
				if (class385 != null) {
					for (int i_30_ = 0; i_30_ < 8; i_30_++) {
						for (int i_31_ = 0; i_31_ < 8; i_31_++) {
							...
							if (i_32_ >= 0
									&& i_32_ < anInt2627 * -954368823 >> 3
									&& i_33_ >= 0
									&& i_33_ < anInt2628 * 181474463 >> 3)
								((Class240_Sub1) this).aClass364_7080
										.method4319(i_32_, i_33_, class385,
												(byte) -2);
						}
					}
				}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.ck(").append(')').toString());
		}
	}

	public final void method2236(GraphicsToolkit class_ra,
			RsByteBuffer class298_sub53, int i, int i_39_, int i_40_,
		...
		try {
			if (!aBoolean2629) {
				...
				while_1_: do {
					for (;;) {
						...
						if (0 == i_48_) {
										...
										class321
												.method3917(
														...
														-2095379959
																* class493.anInt6087,
														2096922993 * class493.anInt6085,
														class493.anInt6086 * 1418726113,
														-1699648006);
									}
									if (class_ra.method5048() > 0) {
										Class298_Sub10 class298_sub10 = class321.aClass298_Sub10_3337;
										int i_51_ = (class298_sub10
												.method2895(823958259) >> 9);
										int i_52_ = (class298_sub10
												.method2897((byte) 113) >> 9);
										if (i_41_ == (class321.anInt3345 * -1565952249)
												&& i_51_ >= i_46_
												&& i_51_ < i_46_ + 8
												&& i_52_ >= i_47_
												&& i_52_ < i_47_ + 8) {
											int i_53_ = ((i_39_ << 9) + (Class219
													.method2045(
															(class298_sub10
																	.method2895(823958259)) & 0xfff,
															(class298_sub10
																	.method2897((byte) 107)) & 0xfff,
															i_44_, (byte) 91)));
											int i_54_ = ((i_40_ << 9) + (method2233(
															(class298_sub10
																	.method2895(823958259)) & 0xfff,
															(class298_sub10
																	.method2897((byte) 68)) & 0xfff,
															i_44_,
															(short) 27107)));
											i_51_ = i_53_ >> 9;
											i_52_ = i_54_ >> 9;
											if (i_51_ >= 0
													...
													&& (i_51_ < anInt2627
															* -954368823)
													&& (i_52_ < anInt2628 * 181474463)) {
												class298_sub10
														.method2899(
																i_53_,
																((anIntArrayArrayArray2653[i_41_][i_51_][i_52_]) - (class298_sub10
																		.method2894(-2061162182))),
																i_54_,
																(byte) -72);
												aClass331_2619.method4051(
														class321, -1995203079);
											}
										}
									}
							...
							int i_55_ = 0;
							for (/**/; i_55_ < 4; i_55_++) {
								byte i_56_ = class298_sub53
										.readByte(-12558881);
								if (i_56_ == 0
										&& null != aByteArrayArrayArray2631[i]) {
									if (i_55_ <= i_41_) {
										int i_57_ = i_39_;
										int i_58_ = i_39_ + 7;
										int i_59_ = i_40_;
										...
										if (i_57_ < 0)
											i_57_ = 0;
										else if (i_57_ >= -954368823
												* anInt2627)
											i_57_ = -954368823 * anInt2627;
										if (i_58_ < 0)
											i_58_ = 0;
										else if (i_58_ >= -954368823
												* anInt2627)
									...
									if (null == aByteArrayArrayArray2631[i])
										aByteArrayArrayArray2631[i] = (new byte[-954368823
												* anInt2627 + 1][1 + 181474463 * anInt2628]);
									for (int i_61_ = 0; i_61_ < 64; i_61_ += 4) {
										for (int i_62_ = 0; i_62_ < 64; i_62_ += 4) {
											byte i_63_ = class298_sub53
													.readByte(-12558881);
											if (i_55_ <= i_41_) {
												for (int i_64_ = i_61_; i_64_ < 4 + i_61_; i_64_++) {
													for (int i_65_ = i_62_; i_65_ < i_62_ + 4; i_65_++) {
														if (i_64_ >= i_46_
																...
																&& i_65_ >= i_47_
																&& (i_65_ < 8 + i_47_)) {
															int i_66_ = (i_39_ + (Class402
																	.method4941(
																			(i_64_ & 0x7),
																			(i_65_ & 0x7),
																			i_44_,
																			-1280307862)));
															int i_67_ = (i_40_ + (Class472
																	.method6064(
																			(i_64_ & 0x7),
																			(i_65_ & 0x7),
																			i_44_,
																			(byte) -51)));
															if (i_66_ >= 0
																	&& (i_66_ < (-954368823 * anInt2627))
																	&& i_67_ >= 0
																	&& (i_67_ < (anInt2628 * 181474463))) {
				...
				if (class385 != null)
					((Class240_Sub1) this).aClass364_7080.method4319(
							i_39_ >> 3, i_40_ >> 3, class385, (byte) -31);
				if (!bool && aByteArrayArrayArray2631 != null
						&& null != aByteArrayArrayArray2631[i]) {
					int i_68_ = i_39_ + 7;
					int i_69_ = i_40_ + 7;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.cn(").append(')').toString());
		}
	}

	public final void method2237(GraphicsToolkit class_ra, byte[] is, int i,
			int i_72_, Class289[] class289s, int i_73_) {
		try {
			...
			for (;;) {
				...
				for (;;) {
					...
					if (i_84_ > 0 && i_85_ > 0
							&& i_84_ < -954368823 * anInt2627 - 1
							&& i_85_ < anInt2628 * 181474463 - 1) {
						...
						method2243(class_ra, i_80_, i_80_, i_84_, i_85_, i_74_,
								i_83_, i_82_, class289, -1, 1769761748);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.cc(").append(')').toString());
		}
	}

	public final void method2238(GraphicsToolkit class_ra, byte[] is, int i,
			int i_87_, int i_88_, int i_89_, int i_90_, int i_91_, int i_92_,
			Class289[] class289s, int i_93_) {
		try {
			RsByteBuffer class298_sub53 = new RsByteBuffer(is);
			int i_94_ = -1;
			for (;;) {
				...
				for (;;) {
					...
					if (i_89_ == i_100_ && i_99_ >= i_90_ && i_99_ < 8 + i_90_
							&& i_98_ >= i_91_ && i_98_ < 8 + i_91_) {
						ObjectDefinitions class432 = ((Class240_Sub1) this).aClass433_7072
								.getObjectDefinitions(i_94_);
						int i_104_ = (i_87_ + Class415.method5587(i_99_ & 0x7,
								i_98_ & 0x7, i_92_,
								(-1125834887 * class432.sizeX),
								(class432.sizeY * -565161399), i_103_,
								181137699));
						int i_105_ = i_88_
								+ Class315.method3833(i_99_ & 0x7, i_98_ & 0x7,
										i_92_,
										(class432.sizeX * -1125834887),
										(class432.sizeY * -565161399),
										i_103_, 1981614763);
						if (i_104_ > 0 && i_105_ > 0
								&& i_104_ < -954368823 * anInt2627 - 1
								&& i_105_ < 181474463 * anInt2628 - 1) {
							Class289 class289 = null;
							if (!aBoolean2629) {
								int i_106_ = i;
							...
							method2243(class_ra, i, i, i_104_, i_105_, i_94_,
									i_92_ + i_103_ & 0x3, i_102_, class289, -1,
									2074281649);
						}
					}
				}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.ca(").append(')').toString());
		}
	}

	boolean method2239(GraphicsToolkit class_ra, int i, int i_107_, boolean bool,
			ObjectDefinitions class432, int i_108_, int i_109_, int i_110_, int i_111_,
			int i_112_, int i_113_, int i_114_, int i_115_, boolean bool_116_,
			...
			if (-1976050083 * Class424.aClass424_6614.anInt6613 == i) {
				...
				if (bool) {
					Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = new Class365_Sub1_Sub5_Sub1(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i, i_107_, bool_116_);
					...
					class365_sub1_sub5 = new Class365_Sub1_Sub5_Sub2(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i, i_107_, i_108_);
				aClass331_2619.method4020(i_109_, i_114_, i_115_,
						class365_sub1_sub5, null, (byte) 53);
				if (0 == i_107_) {
					...
					if (i_120_ == 1 && !aBoolean2629)
						aClass331_2619.aClass333_3512.method4067(1, i_109_,
								i_114_, i_115_, 201968507 * class432.anInt5387,
								-1994960695 * class432.anInt5388);
				} else if (i_107_ == 1) {
					if (aBoolean2632 && class432.aBoolean5405) {
					...
					if (i_120_ == 1 && !aBoolean2629)
						aClass331_2619.aClass333_3512.method4067(2, i_109_,
								i_114_, 1 + i_115_,
								class432.anInt5387 * 201968507,
								-(class432.anInt5388 * -1994960695));
				} else if (i_107_ == 2) {
					if (aBoolean2632 && class432.aBoolean5405) {
						class_xa.LA(i_114_ + 1, i_115_, 50);
					...
					if (1 == i_120_ && !aBoolean2629)
						aClass331_2619.aClass333_3512.method4067(2, i_109_,
								i_114_, i_115_, class432.anInt5387 * 201968507,
								class432.anInt5388 * -1994960695);
				}
				if (0 != -2144543407 * class432.anInt5380 && class289 != null)
					class289.method2732(i_114_, i_115_, i, i_107_,
							class432.aBoolean5424, !class432.aBoolean5416,
							(byte) 0);
				if (-448694871 * class432.anInt5391 != 64)
					aClass331_2619.method4023(i_109_, i_114_, i_115_,
			...
			if (i == -1976050083 * Class424.aClass424_6592.anInt6613) {
				...
				if (bool) {
					...
					class365_sub1_sub5 = new Class365_Sub1_Sub5_Sub2(
							...
							aBoolean2629, i, i_107_, i_108_);
				aClass331_2619.method4020(i_109_, i_114_, i_115_,
						class365_sub1_sub5, null, (byte) 117);
			...
			if (i == -1976050083 * Class424.aClass424_6593.anInt6613) {
				...
				if (bool) {
					Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = new Class365_Sub1_Sub5_Sub1(
							...
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i, 4 + i_107_, bool_116_);
					Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1_123_ = new Class365_Sub1_Sub5_Sub1(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i, i_121_, bool_116_);
					...
					if (class365_sub1_sub5_sub1_123_.method39(-1782980621))
						class365_sub1_sub5_sub1_123_.method33(class_ra,
								-2050070618);
					class365_sub1_sub5 = class365_sub1_sub5_sub1;
					...
					class365_sub1_sub5 = new Class365_Sub1_Sub5_Sub2(
							...
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i, 4 + i_107_, i_108_);
					class365_sub1_sub5_122_ = new Class365_Sub1_Sub5_Sub2(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i, i_121_, i_108_);
				}
				aClass331_2619.method4020(i_109_, i_114_, i_115_,
						class365_sub1_sub5, class365_sub1_sub5_122_, (byte) 48);
				if ((class432.anInt5376 * -1508517619 == 1 || aBoolean7073
						&& -1 == -1508517619 * class432.anInt5376)
						&& !aBoolean2629) {
					if (0 == i_107_) {
						aClass331_2619.aClass333_3512.method4067(1, i_109_,
								i_114_, i_115_, class432.anInt5387 * 201968507,
						...
						aClass331_2619.aClass333_3512.method4067(1, i_109_,
								1 + i_114_, i_115_,
								201968507 * class432.anInt5387, -1994960695
										* class432.anInt5388);
						aClass331_2619.aClass333_3512.method4067(2, i_109_,
								i_114_, i_115_, 201968507 * class432.anInt5387,
								class432.anInt5388 * -1994960695);
			...
			if (i == -1976050083 * Class424.aClass424_6594.anInt6613) {
				...
				if (bool) {
					...
					class365_sub1_sub5 = new Class365_Sub1_Sub5_Sub2(
							...
							aBoolean2629, i, i_107_, i_108_);
				aClass331_2619.method4020(i_109_, i_114_, i_115_,
						class365_sub1_sub5, null, (byte) 58);
				if (class432.aBoolean5405 && aBoolean2632) {
					if (0 == i_107_)
						class_xa.LA(i_114_, 1 + i_115_, 50);
					else if (i_107_ == 1)
			...
			if (i == -1976050083 * Class424.aClass424_6595.anInt6613) {
				...
				if (bool) {
					Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = new Class365_Sub1_Sub1_Sub6(
							...
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i_114_, i_114_, i_115_, i_115_, i,
							i_107_, bool_116_);
					...
					class365_sub1_sub1 = new Class365_Sub1_Sub1_Sub5(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_109_, i_110_, i_111_, i_112_, i_113_,
							aBoolean2629, i_114_, i_117_ + i_114_ - 1, i_115_,
							i_115_ + i_118_ - 1, i, i_107_, i_108_);
				...
				if (1 == class432.anInt5376 * -1508517619 && !aBoolean2629) {
					...
					if ((i_107_ & 0x1) == 0)
						...
						i_124_ = 16;
					aClass331_2619.aClass333_3512.method4067(i_124_, i_109_,
							i_114_, i_115_, class432.anInt5387 * 201968507, 0);
				}
				if (class432.anInt5380 * -2144543407 != 0 && null != class289)
					class289.method2741(i_114_, i_115_, i_117_, i_118_,
							class432.aBoolean5424, !class432.aBoolean5416,
							(byte) 2);
				if (class432.anInt5391 * -448694871 != 64)
					aClass331_2619.method4023(i_109_, i_114_, i_115_,
							class432.anInt5391 * -448694871, (byte) 23);
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.ce(").append(')').toString());
		}
	}

	boolean method2240(GraphicsToolkit class_ra, int i, int i_125_, boolean bool,
		...
		try {
			if (i == -1976050083 * Class424.aClass424_6596.anInt6613) {
				...
				if (bool) {
					Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = new Class365_Sub1_Sub3_Sub2(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, 0, 0, i, i_125_);
					...
					class365_sub1_sub3 = new Class365_Sub1_Sub3_Sub1(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, 0, 0, i, i_125_, i_126_);
				aClass331_2619.method4021(i_127_, i_132_, i_133_,
			...
			if (i == Class424.aClass424_6601.anInt6613 * -1976050083) {
				...
				if (null != interface3)
					i_135_ = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(
							interface3.method32((byte) 27)).anInt5391)
							* -448694871 + 1;
				Class365_Sub1_Sub3 class365_sub1_sub3;
				if (bool) {
					Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = (new Class365_Sub1_Sub3_Sub2(
							...
							((Class240_Sub1) this).aClass433_7072, class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, anIntArray7078[i_125_] * i_135_,
							anIntArray7075[i_125_] * i_135_, i, i_125_));
					...
					class365_sub1_sub3 = (new Class365_Sub1_Sub3_Sub1(
							...
							((Class240_Sub1) this).aClass433_7072, class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, i_135_ * anIntArray7078[i_125_],
							i_135_ * anIntArray7075[i_125_], i, i_125_, i_126_));
				aClass331_2619.method4021(i_127_, i_132_, i_133_,
			...
			if (-1976050083 * Class424.aClass424_6598.anInt6613 == i) {
				...
				if (interface3 != null)
					i_136_ = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(
							interface3.method32((byte) 14)).anInt5391)
							* -448694871 / 2 + 1;
				Class365_Sub1_Sub3 class365_sub1_sub3;
				if (bool) {
					Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = (new Class365_Sub1_Sub3_Sub2(
							...
							((Class240_Sub1) this).aClass433_7072, class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, i_136_ * anIntArray7078[i_125_],
							i_136_ * anIntArray7075[i_125_], i, i_125_ + 4));
					...
					class365_sub1_sub3 = (new Class365_Sub1_Sub3_Sub1(
							...
							((Class240_Sub1) this).aClass433_7072, class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, i_136_ * anIntArray7074[i_125_],
							anIntArray7081[i_125_] * i_136_, i, i_125_ + 4,
							i_126_));
				aClass331_2619.method4021(i_127_, i_132_, i_133_,
			...
			if (-1976050083 * Class424.aClass424_6599.anInt6613 == i) {
				...
				if (bool) {
					...
					class365_sub1_sub3 = new Class365_Sub1_Sub3_Sub1(
							...
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, 0, 0, i, i_137_ + 4, i_126_);
				aClass331_2619.method4021(i_127_, i_132_, i_133_,
			...
			if (Class424.aClass424_6600.anInt6613 * -1976050083 == i) {
				...
				int i_139_ = 33;
				Interface3 interface3 = ((Interface3) aClass331_2619
						.method4031(i_127_, i_132_, i_133_, 2110046759));
				if (null != interface3)
					i_139_ = (((Class240_Sub1) this).aClass433_7072.getObjectDefinitions(
							interface3.method32((byte) 14)).anInt5391)
							* -448694871 / 2 + 1;
				Class365_Sub1_Sub3 class365_sub1_sub3;
				...
				if (bool) {
					Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = (new Class365_Sub1_Sub3_Sub2(
							...
							((Class240_Sub1) this).aClass433_7072, class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, i_139_ * anIntArray7074[i_125_],
							anIntArray7081[i_125_] * i_139_, i, i_125_ + 4));
					Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2_141_ = new Class365_Sub1_Sub3_Sub2(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, 0, 0, i, i_138_ + 4);
					...
					Class365_Sub1_Sub3_Sub1 class365_sub1_sub3_sub1 = (new Class365_Sub1_Sub3_Sub1(
							aClass331_2619, class_ra,
							((Class240_Sub1) this).aClass433_7072, class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, i_139_ * anIntArray7074[i_125_],
							i_139_ * anIntArray7081[i_125_], i, i_125_ + 4,
							i_126_));
					Class365_Sub1_Sub3_Sub1 class365_sub1_sub3_sub1_142_ = new Class365_Sub1_Sub3_Sub1(
							aClass331_2619, class_ra,
							(((Class240_Sub1) this).aClass433_7072), class432,
							i_127_, i_128_, i_129_, i_130_, i_131_,
							aBoolean2629, 0, 0, i, 4 + i_138_, i_126_);
					class365_sub1_sub3 = class365_sub1_sub3_sub1;
					class365_sub1_sub3_140_ = class365_sub1_sub3_sub1_142_;
				}
				aClass331_2619
						.method4021(i_127_, i_132_, i_133_, class365_sub1_sub3,
								class365_sub1_sub3_140_, 1357750473);
				return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.cb(").append(')').toString());
		}
	}
	...
	Interface3 method2241(int i, int i_143_, int i_144_, int i_145_, int i_146_) {
		try {
			...
			if (i_143_ == 0)
				interface3 = (Interface3) aClass331_2619.method4031(i, i_144_,
						i_145_, 212388673);
			if (1 == i_143_)
				interface3 = (Interface3) aClass331_2619.method4033(i, i_144_,
						i_145_, 1080081135);
			if (i_143_ == 2)
				interface3 = ((Interface3) aClass331_2619.method4035(i, i_144_,
						i_145_, client.anInterface17_8960, -1336288750));
			if (i_143_ == 3)
				interface3 = (Interface3) aClass331_2619.method4058(i, i_144_,
						i_145_, (byte) 50);
			return interface3;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.cu(").append(')').toString());
		}
	}
					...
					for (int i_147_ = 0; i_147_ < anInt2627 * -954368823; i_147_++) {
						for (int i_148_ = 0; i_148_ < anInt2628 * 181474463; i_148_++) {
							if (((aClass244_2635.aByteArrayArrayArray2731[1][i_147_][i_148_]) & 0x2) == 2)
								aClass331_2619.method4011(i_147_, i_148_,
										-1135071672);
						}
					}
				}
					...
					for (int i_150_ = 0; i_150_ <= anInt2628 * 181474463; i_150_++) {
						for (int i_151_ = 0; i_151_ <= anInt2627 * -954368823; i_151_++) {
							if (((aByteArrayArrayArray2637[i_149_][i_151_][i_150_]) & 0x4) != 0) {
								...
								int i_154_ = i_150_;
								int i_155_;
								for (i_155_ = i_150_; (i_154_ > 0
										&& ((aByteArrayArrayArray2637[i_149_][i_151_][i_154_ - 1]) & 0x4) != 0 && i_155_
										- i_154_ < 10); i_154_--) {
									/* empty */
								}
								for (/**/; (i_155_ < 181474463 * anInt2628
										&& ((aByteArrayArrayArray2637[i_149_][i_151_][i_155_ + 1]) & 0x4) != 0 && i_155_
										- i_154_ < 10); i_155_++) {
									/* empty */
								}
								while_2_: for (/**/; i_152_ > 0
										&& i_153_ - i_152_ < 10; i_152_--) {
								...
								while_3_: for (/**/; (i_153_ < anInt2627
										* -954368823 && i_153_ - i_152_ < 10); i_153_++) {
								...
								if ((1 + (i_155_ - i_154_))
									...
									aClass331_2619.aClass333_3512
											.method4070(4, i_149_, i_152_ << 9,
													(i_153_ << 9) + 512,
													i_154_ << 9,
													512 + (i_155_ << 9),
													i_158_, i_158_);
	...
	final void method2243(GraphicsToolkit class_ra, int i, int i_161_, int i_162_,
			int i_163_, int i_164_, int i_165_, int i_166_, Class289 class289,
			int i_167_, int i_168_) {
		try {
			if (i_161_ < -1281303921 * ((Class240_Sub1) this).anInt7082)
				((Class240_Sub1) this).anInt7082 = 272172143 * i_161_;
			ObjectDefinitions class432 = ((Class240_Sub1) this).aClass433_7072
					.getObjectDefinitions(i_164_);
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557
					.method5687(1871358652) != 0
					|| !class432.aBoolean5432) {
				int i_169_;
				int i_170_;
				...
				int i_175_ = ((class_xa.method6341(i_171_, i_173_, (byte) -48)
						+ class_xa.method6341(i_172_, i_173_, (byte) -81)
						+ class_xa.method6341(i_171_, i_174_, (byte) -94) + class_xa
						.method6341(i_172_, i_174_, (byte) -87)) >> 2);
				int i_176_ = (i_169_ << 8) + (i_162_ << 9);
				int i_177_ = (i_170_ << 8) + (i_163_ << 9);
				boolean bool = aBoolean2632 && !aBoolean2629
						&& class432.aBoolean5385;
				if (class432.method5784(-1167401239))
					Class391.method4884(i_161_, i_162_, i_163_, i_165_,
							class432, null, null, (byte) 37);
				boolean bool_178_ = (-1 == i_167_
						&& !class432.method5779(934270378)
				...
				if (!aBoolean7084
					...
					if (i_166_ == -1976050083
						...
						if ((Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547
								...
								|| -2144543407 * class432.anInt5380 == 1
								|| class432.aBoolean5410) {
							Class365_Sub1_Sub2 class365_sub1_sub2;
							if (bool_178_) {
								Class365_Sub1_Sub2_Sub2 class365_sub1_sub2_sub2 = (new Class365_Sub1_Sub2_Sub2(
										aClass331_2619, class_ra,
										((Class240_Sub1) this).aClass433_7072,
										class432, i_161_, i, i_176_, i_175_,
										i_177_, aBoolean2629, i_165_, bool));
								if (class365_sub1_sub2_sub2
										.method39(-1997643666))
									class365_sub1_sub2_sub2.method33(class_ra,
											-2091324745);
								class365_sub1_sub2 = class365_sub1_sub2_sub2;
							} else
								class365_sub1_sub2 = (new Class365_Sub1_Sub2_Sub1(
										aClass331_2619, class_ra,
										((Class240_Sub1) this).aClass433_7072,
										class432, i_161_, i, i_176_, i_175_,
										i_177_, aBoolean2629, i_165_, i_167_));
							aClass331_2619.method4057(i_161_, i_162_, i_163_,
									class365_sub1_sub2, 1853221006);
							if (1 == class432.anInt5380 * -2144543407
									&& null != class289)
						...
						int i_179_;
						if (bool_178_) {
							Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6_180_ = (new Class365_Sub1_Sub1_Sub6(
									aClass331_2619, class_ra,
									((Class240_Sub1) this).aClass433_7072,
									class432, i_161_, i, i_176_, i_175_,
									i_177_, aBoolean2629, i_162_, i_162_
											+ i_169_ - 1, i_163_, i_170_
											+ i_163_ - 1, i_166_, i_165_, bool));
							i_179_ = class365_sub1_sub1_sub6_180_
									.method4493((short) 230);
							...
							class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(
									...
									class432, i_161_, i, i_176_, i_175_,
									i_177_, aBoolean2629, i_162_, i_162_
											+ i_169_ - 1, i_163_, i_163_
											+ i_170_ - 1, i_166_, i_165_,
									i_167_));
							i_179_ = 15;
						}
						if (aClass331_2619.method4022(class365_sub1_sub1,
								false, (byte) 0)) {
							if (class365_sub1_sub1_sub6 != null
									&& class365_sub1_sub1_sub6
											.method39(-2136957466))
								class365_sub1_sub1_sub6.method33(class_ra,
										-2130479152);
							if (class432.aBoolean5405 && aBoolean2632) {
								if (i_179_ > 30)
									i_179_ = 30;
								for (int i_181_ = 0; i_181_ <= i_169_; i_181_++) {
									for (int i_182_ = 0; i_182_ <= i_170_; i_182_++)
										class_xa.LA(i_162_ + i_181_, i_182_
												+ i_163_, i_179_);
								}
							}
						}
						if (class432.anInt5380 * -2144543407 != 0
								&& null != class289)
							class289.method2741(i_162_, i_163_, i_169_, i_170_,
									class432.aBoolean5424,
									!class432.aBoolean5416, (byte) 15);
					} else if (Class111.method1236(i_166_, -865214392)
							|| Class207.method1930(i_166_, (byte) -21)) {
						Class365_Sub1_Sub1 class365_sub1_sub1;
						if (bool_178_) {
							Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = (new Class365_Sub1_Sub1_Sub6(
									aClass331_2619, class_ra,
									((Class240_Sub1) this).aClass433_7072,
									class432, i_161_, i, i_176_, i_175_,
									i_177_, aBoolean2629, i_162_, i_169_
											+ i_162_ - 1, i_163_, i_170_
											+ i_163_ - 1, i_166_, i_165_, bool));
							...
							class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(
									...
									i_177_, aBoolean2629, i_162_, i_162_
											...
											+ i_170_ - 1, i_166_, i_165_,
									i_167_));
						aClass331_2619.method4022(class365_sub1_sub1, false,
								(byte) 0);
						if (aBoolean2632
								&& !aBoolean2629
						...
						if (0 != class432.anInt5380 * -2144543407
							...
							class289.method2741(i_162_, i_163_, i_169_, i_170_,
									class432.aBoolean5424,
									!class432.aBoolean5416, (byte) 4);
					} else if (method2239(class_ra, i_166_, i_165_, bool_178_,
							class432, i_167_, i_161_, i, i_176_, i_175_,
							i_177_, i_162_, i_163_, bool, class_xa, class289,
							i_169_, i_170_, (byte) -37)
							|| method2240(class_ra, i_166_, i_165_, bool_178_,
									class432, i_167_, i_161_, i, i_176_,
									i_175_, i_177_, i_162_, i_163_, -1189422227)) {
						/* empty */
					}
				}
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.ci(").append(')').toString());
		}
	}

	public Class240_Sub1(Class331 class331, Class433 class433, int i,
			int i_183_, int i_184_, boolean bool, Class244 class244,
			Class364 class364) {
		super(class331, i, i_183_, i_184_, bool, Class504.aClass375_6196,
				Class151.aClass451_6358, class244);
		((Class240_Sub1) this).aClass433_7072 = class433;
		((Class240_Sub1) this).aClass364_7080 = class364;
	}

	static final void method2244(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1200 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.anIntArray1258 = is;
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.oy(").append(')').toString());
		}
	}
	...
	static final void method2246(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (1548853569 * class105.anInt1184 == 1 ? class105.anInt1151 * 572201537
					: -1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaa.pn(").append(')').toString());
		}
	}
}
