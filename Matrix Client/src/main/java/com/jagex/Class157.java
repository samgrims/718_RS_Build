...
public class Class157 {
	...
	Interface9_Impl2 method1695(int i, int i_0_) {
		...
		if (!((Class157) this).anInterface_ma1614.method170(i, (short) 28916))
			return null;
		Class53 class53 = ((Class157) this).anInterface_ma1614.method174(i,
				828461869);
		if (i_0_ == -1)
			i_0_ = (class53.aBoolean518 ? 64
					: (((Class_ra_Sub3) ((Class157) this).aClass_ra_Sub3_1615).anInt8271));
		Interface9_Impl2 interface9_impl2;
		if (!class53.aBoolean543
				|| !((Class157) this).aClass_ra_Sub3_1615.method5054()) {
			int[] is;
			if (class53.anInt528 * -2138060883 == 2
					|| !Class298_Sub32_Sub31.method3339(class53.aByte529,
							-2037069646))
				is = ((Class157) this).anInterface_ma1614.method172(i, 0.7F,
						i_0_, i_0_, false, (byte) 2);
			else
				is = ((Class157) this).anInterface_ma1614.method171(i, 0.7F,
						i_0_, i_0_, true, -470804931);
			interface9_impl2 = ((Class157) this).aClass_ra_Sub3_1615
					.method5350(i_0_, i_0_, true, is);
		} else {
			float[] fs = ((Class157) this).anInterface_ma1614.method181(i,
					0.7F, i_0_, i_0_, false, (byte) -110);
			interface9_impl2 = ((Class157) this).aClass_ra_Sub3_1615
					.method5352(Class55.aClass55_557, i_0_, i_0_, true, fs);
		}
