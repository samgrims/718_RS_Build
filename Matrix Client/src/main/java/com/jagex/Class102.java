...
public class Class102 {
	...
	void method1082(int i, int i_0_, String string, String string_1_,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ed.a(").append(')').toString());
		}
	}

	Class102(int i, int i_7_, String string, String string_8_,
			String string_9_, String string_10_, int i_11_, String string_12_) {
				...
				Class357
						.method4276(
								Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub12_7543
										.method5669((byte) 92), -1, -1, false,
								2006169742);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ed.aej(").append(')').toString());
		}
	}
	...
	static final void method1084(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ed.ahj(").append(')').toString());
		}
	}

	static final void method1085(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1173 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -1041514725;
			Tradution.method6054(class105, -1371264268);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ed.db(").append(')').toString());
		}
	}
}
