...
public class Class298_Sub19_Sub3 extends Class298_Sub19 {
			...
			if (!((Class298_Sub19_Sub3) this).aBoolean9256) {
				for (;;) {
					...
					if (((((Class298_Sub30) class298_sub30).aShortArrayArray7368[0]).length - ((Class298_Sub19_Sub3) this).anInt9261 * 223474833) > i) {
						((Class298_Sub19_Sub3) this).anInt9261 += i
								* -491238287;
						break;
					}
	...
	Class298_Sub30 method3032(int i, double d) {
		try {
			...
			Class298_Sub30 class298_sub30 = ((Class298_Sub30) aClass253_9258
					.method2413(Long.valueOf(l), (byte) -35));
			if (null != class298_sub30) {
				((Class298_Sub30) class298_sub30).aDouble7367 = d;
				aClass253_9258.method2417(Long.valueOf(l), 1695283057);
			} else
				class298_sub30 = new Class298_Sub30(
						(new short[(((Class298_Sub19_Sub3) this).anInt9262) * 1472501875][i]),
						d);
			return class298_sub30;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aii.al(").append(')').toString());
		}
	}

	synchronized Class298_Sub30 method3033(int i) {
		try {
			return (Class298_Sub30) ((Class298_Sub19_Sub3) this).aClass453_9259
					.method5939(1766612795);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aii.ah(").append(')').toString());
		}
	}
	...
	synchronized void method3034(Class298_Sub30 class298_sub30, int i) {
		try {
			for (/**/; ((Class298_Sub19_Sub3) this).anInt9260 * 528037965 >= 100; ((Class298_Sub19_Sub3) this).anInt9260 -= -1862483835)
				((Class298_Sub19_Sub3) this).aClass453_9259
						.method5936(2084948407);
			((Class298_Sub19_Sub3) this).aClass453_9259.method5935(
					class298_sub30, -332995145);
			((Class298_Sub19_Sub3) this).anInt9260 += -1862483835;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aii.az(").append(')').toString());
		}
	}
	...
	synchronized double method3038(int i) {
		try {
			if (528037965 * ((Class298_Sub19_Sub3) this).anInt9260 < 1)
				return -1.0;
			Class298_Sub30 class298_sub30 = (Class298_Sub30) ((Class298_Sub19_Sub3) this).aClass453_9259
					.method5939(1766612795);
			if (null == class298_sub30)
				return -1.0;
		...
		try {
			...
			if (class298_sub30 != null) {
				...
				aClass253_9258.method2411(Long.valueOf(class298_sub30
						.method3112(-1380728898)), class298_sub30, (byte) 98);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aii.ai(").append(')').toString());
		}
	}
