...
public class Class298_Sub32_Sub16 extends Class298_Sub32 {
	...
	int[][] method3229(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			if (i_1_ > 0) {
				int i_3_ = i % i_1_;
				is_2_ = method3134(0,
						(i_3_ * (461985445 * Class250.anInt2756) / i_1_),
						(byte) 8);
			} else
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_13_) {
		try {
			switch (i) {
			case 1:
				((Class298_Sub32_Sub16) this).anInt9409 = class298_sub53
						.readUnsignedByte() * 853096051;
				break;
			case 0:
				((Class298_Sub32_Sub16) this).anInt9410 = class298_sub53
						.readUnsignedByte()
						* -637796475;
				break;
			}
	...
	int[][] method3132(int i, byte i_14_) {
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				if (i_16_ > 0) {
					int i_18_ = i % i_16_;
					is_17_ = method3134(0, i_18_
							* (461985445 * Class250.anInt2756) / i_16_,
							(byte) 8);
				} else
				...
				for (int i_25_ = 0; i_25_ < Class250.anInt2755 * -1474554145; i_25_++) {
					...
					if (i_15_ > 0) {
						...
						i_26_ = -1474554145 * Class250.anInt2755 * i_27_
								/ i_15_;
					} else
						i_26_ = 0;
	...
	int[] method3230(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			if (i_29_ > 0) {
				int i_31_ = i % i_29_;
				is_30_ = method3129(0, (i_31_
						* (Class250.anInt2756 * 461985445) / i_29_),
						-1887337990);
			} else
			...
			for (int i_32_ = 0; i_32_ < Class250.anInt2755 * -1474554145; i_32_++) {
				if (i_28_ > 0) {
					...
					is[i_32_] = is_30_[i_33_
							* (-1474554145 * Class250.anInt2755) / i_28_];
				} else
					is[i_32_] = is_30_[0];
			}
		}
	...
	int[] method3131(int i, int i_34_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				if (i_36_ > 0) {
					int i_38_ = i % i_36_;
					is_37_ = method3129(0, i_38_
							* (Class250.anInt2756 * 461985445) / i_36_,
							-1887337990);
				} else
				...
				for (int i_39_ = 0; i_39_ < Class250.anInt2755 * -1474554145; i_39_++) {
					if (i_35_ > 0) {
						...
						is[i_39_] = is_37_[i_40_
								* (-1474554145 * Class250.anInt2755) / i_35_];
					} else
						is[i_39_] = is_37_[0];
				}
			}
	...
	int[] method3233(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			if (i_42_ > 0) {
				int i_44_ = i % i_42_;
				is_43_ = method3129(0, (i_44_
						* (Class250.anInt2756 * 461985445) / i_42_),
						-1887337990);
			} else
			...
			for (int i_45_ = 0; i_45_ < Class250.anInt2755 * -1474554145; i_45_++) {
				if (i_41_ > 0) {
					...
					is[i_45_] = is_43_[i_46_
							* (-1474554145 * Class250.anInt2755) / i_41_];
				} else
					is[i_45_] = is_43_[0];
			}
		}
	...
	int[][] method3234(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			if (i_48_ > 0) {
				int i_50_ = i % i_48_;
				is_49_ = method3134(0, (i_50_
						* (461985445 * Class250.anInt2756) / i_48_), (byte) 8);
			} else
