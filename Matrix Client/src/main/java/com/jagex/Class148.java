...
public class Class148 implements Interface23 {
	...
	int[] anIntArray6652 = new int[-1085917127
			* Class440.aClass205_5582.anInt2339];
	static long aLong6653 = 1L;
	public int[] anIntArray6654 = new int[-1085917127
			* Class440.aClass205_5582.anInt2339];
	...
	public int method252(int i, byte i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.d(").append(')').toString());
		}
	}

	void setConfigByFileValue(int configId, int i_1_, int i_2_) {
		try {
			ConfigDefinitions class327 = Class472.aClass314_5965.getConfigDefinitions(configId,
					-781710328);
			...
			if (i_1_ < 0 || i_1_ > i_6_)
				i_1_ = 0;
			i_6_ <<= i_4_;
			method1605(i_3_, (((Class148) this).anIntArray6652[i_3_]
					& (i_6_ ^ 0xffffffff) | i_1_ << i_4_ & i_6_), (byte) 16);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.k(").append(')').toString());
		}
	}

	void method1603(int i) {
		try {
			for (int i_7_ = 0; i_7_ < Class440.aClass205_5582.anInt2339
					* -1085917127; i_7_++) {
	...
	void method1605(int i, int i_10_, byte i_11_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.p(").append(')').toString());
		}
	}

	public void method1606(int i, int i_12_, int i_13_) {
		try {
			ConfigDefinitions class327 = Class472.aClass314_5965.getConfigDefinitions(i,
					-781710328);
			...
			method1604(
					i_14_,
					(anIntArray6654[i_14_] & (i_17_ ^ 0xffffffff) | i_12_ << i_15_
							& i_17_), 681479919);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.i(").append(')').toString());
		}
	}
	...
	int method1607(boolean bool, int i) {
		try {
			...
			for (Class298_Sub33 class298_sub33 = (Class298_Sub33) (bool ? ((Class148) this).aClass437_6647
					.method5816(1646690306)
					: ((Class148) this).aClass437_6647.method5815((byte) 18)); class298_sub33 != null; class298_sub33 = (Class298_Sub33) ((Class148) this).aClass437_6647
					.method5815((byte) -66)) {
	...
	static final void method1609(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.ko(").append(')').toString());
		}
	}

	static final void method1610(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8665
					* -1154804873;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.uy(").append(')').toString());
		}
	}

	static final void method1611(Class403 class403, short i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8680 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.ahy(").append(')').toString());
		}
	}
	...
	static final void method1613(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1
					.method2845(i_32_, i_33_, false, false, 1482071907);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.ul(").append(')').toString());
		}
	}
	...
	public static void method1614(byte i) {
		try {
			if (null == Class231.aFrame2589) {
				...
				int i_36_ = (Class78.anInt733 * -639974669 - Class462.anInt5683
						* -2110394505 - i_34_);
				int i_37_ = (1282634425 * client.anInt6472 - -1111710645
						* Class298_Sub40_Sub9.anInt9716 - i_35_);
				if (i_34_ > 0 || i_36_ > 0 || i_35_ > 0 || i_37_ > 0) {
					try {
						...
						if (container == Class298_Sub36.aFrame7403) {
							Insets insets = Class298_Sub36.aFrame7403
									.getInsets();
							i_38_ = insets.left;
							i_39_ = insets.top;
						}
						...
						if (i_34_ > 0)
							graphics.fillRect(i_38_, i_39_, i_34_,
									client.anInt6472 * 1282634425);
						if (i_35_ > 0)
							graphics.fillRect(i_38_, i_39_, -639974669
									* Class78.anInt733, i_35_);
						if (i_36_ > 0)
							graphics.fillRect((i_38_ + Class78.anInt733
									* -639974669 - i_36_), i_39_, i_36_,
									client.anInt6472 * 1282634425);
						if (i_37_ > 0)
							graphics.fillRect(i_38_, (client.anInt6472
									* 1282634425 + i_39_ - i_37_), -639974669
									* Class78.anInt733, i_37_);
	...
	static final void method1615(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("g.cc(").append(')').toString());
		}
	}

	static final void method1616(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1284 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -1066050969;
