		...
		try {
			for (int i_0_ = 0; i_0_ < ((Class289) this).anInt3153 * 843157589; i_0_++) {
				for (int i_1_ = 0; i_1_ < -16196483
						* ((Class289) this).anInt3154; i_1_++) {
					if (i_0_ == 0
							|| i_1_ == 0
							|| i_0_ >= ((Class289) this).anInt3153 * 843157589 - 5
							|| i_1_ >= -16196483 * ((Class289) this).anInt3154
									- 5)
	...
	public void method2736(int i, int i_14_, int i_15_, int i_16_, int i_17_,
		...
		try {
			...
			for (int i_22_ = i; i_22_ < i + i_15_; i_22_++) {
				if (i_22_ >= 0
						&& i_22_ < 843157589 * ((Class289) this).anInt3153) {
					for (int i_23_ = i_14_; i_23_ < i_14_ + i_16_; i_23_++) {
						if (i_23_ >= 0
								&& i_23_ < ((Class289) this).anInt3154
										* -16196483)
	...
	public void method2741(int i, int i_60_, int i_61_, int i_62_,
		...
		try {
			...
			for (int i_66_ = i; i_66_ < i_61_ + i; i_66_++) {
				if (i_66_ >= 0
						&& i_66_ < 843157589 * ((Class289) this).anInt3153) {
					for (int i_67_ = i_60_; i_67_ < i_62_ + i_60_; i_67_++) {
						if (i_67_ >= 0
								&& i_67_ < -16196483
										* ((Class289) this).anInt3154)
