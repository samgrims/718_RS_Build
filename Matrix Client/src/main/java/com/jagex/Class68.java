package com.jagex;/* Class68 - Decompiled by JODE
...
public class Class68 {
	...
	static void method777(boolean bool,
			Class298_Sub19_Sub1 class298_sub19_sub1, int i) {
		try {
			Class300.aClass284_3212.method2679(class298_sub19_sub1, 547638939);
			if (bool)
				Class445.method5897(Class114.aClass243_1381,
						Class439.aClass243_5575, Class52.aClass243_507,
						class298_sub19_sub1, Class300.aClass284_3212,
						(byte) -102);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ct.p(").append(')').toString());
		}
	}
	...
	public static boolean method781(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ct.s(").append(')').toString());
		}
	}

	static final void method782(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1250 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ct.ny(").append(')').toString());
		}
	}

	static Class98_Sub3 method783(RsByteBuffer class298_sub53, int i) {
		try {
			return new Class98_Sub3(class298_sub53.readShort(1676982896),
					class298_sub53.readShort(1624262508), class298_sub53
							.readShort(1772094350), class298_sub53
							.readShort(1995341177), class298_sub53
							.read24BitUnsignedInteger((byte) -98), class298_sub53
							.read24BitUnsignedInteger((byte) -6), class298_sub53
							.readUnsignedByte());
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ct.r(").append(')').toString());
		}
	}
	...
	public static Class298_Sub50_Sub2 method785(int i, int i_4_, int i_5_,
			int i_6_, byte i_7_) {
		try {
			synchronized (Class298_Sub50_Sub2.aClass298_Sub50_Sub2Array9770) {
				...
				((Class298_Sub50_Sub2) class298_sub50_sub2).anInt9771 = i_5_
						* -398953071;
				((Class298_Sub50_Sub2) class298_sub50_sub2).anInt9772 = 1960569825 * i_6_;
				((Class298_Sub50_Sub2) class298_sub50_sub2).aLong9768 = Class122
						.method1319((byte) 1)
						* -212908250700906157L;
	...
	static final void method786(Class403 class403, byte i) {
		try {
			...
			Class21.method365(class105, class119, true, 2, class403,
					-1869405446);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ct.hb(").append(')').toString());
		}
	}
}
