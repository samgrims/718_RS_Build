...
public class Class479 {
	...
	public static Class479 aClass479_6023 = new Class479(
			Class463.aClass463_5687);
	...
	public void method6103(int i, int i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tt.b(").append(')').toString());
		}
	}

	public static Class479[] method6104(int i) {
		try {
			return (new Class479[] { aClass479_6023, aClass479_6004,
					aClass479_6005, aClass479_6012, aClass479_6006,
					aClass479_6008, aClass479_6009, aClass479_6032,
					aClass479_6011, aClass479_6007, aClass479_6013,
					aClass479_6014, aClass479_6017, aClass479_6016,
					aClass479_6015, aClass479_6018, aClass479_6019,
					aClass479_6020, aClass479_6021, aClass479_6030,
					aClass479_6025, aClass479_6024, aClass479_6022,
					aClass479_6003, aClass479_6027, aClass479_6028,
					aClass479_6029 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tt.a(").append(')').toString());
		}
	}
	...
	static final void method6105(Class403 class403, int i) {
		try {
			...
			Class102 class102 = Class298_Sub40_Sub13
					.method3517(i_1_, 431272670);
			int i_2_ = -1;
			if (null != class102)
