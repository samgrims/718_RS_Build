...
public class Class119 {
	...
	static final void method1298(IComponentDefinition class105, Class119 class119,
	...
	static long method1301(Interface3 interface3, int i, int i_3_, int i_4_) {
		try {
			...
			ObjectDefinitions class432 = client.aClass283_8716.method2641(-1623210152)
					.getObjectDefinitions(interface3.method32((byte) 18));
			long l_6_ = (long) (i | i_3_ << 7
					| interface3.method29(726839210) << 14
					| interface3.method30((short) 11182) << 20 | 0x40000000);
		...
		try {
			((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 2] = (Class316.aClass362_3318
					.method4307(
							...
							245040087).anIntArray4016[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1])]);
			((Class403) class403).anInt5239 -= -391880689;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ev.u(").append(')').toString());
		}
	}
