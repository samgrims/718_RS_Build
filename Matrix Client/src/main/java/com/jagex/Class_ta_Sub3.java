package com.jagex;/* Class_ta_Sub3 - Decompiled by JODE
...
public class Class_ta_Sub3 extends Class_ta {
	...
	Class_ta_Sub3(Class_ra_Sub3 class_ra_sub3, int i, int i_0_, int[] is) {
		((Class_ta_Sub3) this).anInterface9_Impl2_8444 = class_ra_sub3
				.method5350(i, i_0_, false, is);
		((Class_ta_Sub3) this).anInterface9_Impl2_8444.method80(false, false);
	}

	static Class_ta_Sub3 method6007(Class_ra_Sub3 class_ra_sub3, int i,
			int i_1_, int[] is, int[] is_2_) {
		if (class_ra_sub3
				.method5348(Class55.aClass55_567, Class77.aClass77_717)) {
	...
	Class_ta_Sub3(Class_ra_Sub3 class_ra_sub3, int i, int i_11_, byte[] is) {
		((Class_ta_Sub3) this).anInterface9_Impl2_8444 = class_ra_sub3
				.method5351(Class55.aClass55_567, i, i_11_, false, is);
		((Class_ta_Sub3) this).anInterface9_Impl2_8444.method80(false, false);
	}
}
