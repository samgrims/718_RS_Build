...
public class Class213_Sub2 extends Class213 {
	...
	void method1961(int i, int i_0_) {
		if (i != 0) {
			...
			((Class213_Sub2) this).anInt7066 = ((Class213_Sub2) this).anInt7070
					- (i_0_ < 0 ? -i_0_ : i_0_);
	...
	Class213_Sub2(int i, int i_1_, int i_2_, int i_3_, int i_4_, float f,
		...
		((Class213_Sub2) this).anInt7069 = ((Class213_Sub2) this).anInt7063 = (int) (Math
				.pow(0.5, (double) -f) * 4096.0);
	}
	...
	void method1970() {
		...
		method1976(((Class213_Sub2) this).anInt7071++,
				(byte) ((Class213_Sub2) this).anInt7068);
		((Class213_Sub2) this).anInt7068 = 0;
	}
