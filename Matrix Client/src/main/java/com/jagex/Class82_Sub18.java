...
public class Class82_Sub18 extends Class82 {
	...
	public void method869() {
		Class136.method1495(((Class82_Sub18) this).anInt6890 * 115033111, 0,
				((Class82_Sub18) this).anInt6891 * -1734052405, -649427988);
	}

	public void method866(int i) {
		try {
			Class136.method1495(((Class82_Sub18) this).anInt6890 * 115033111,
					0, ((Class82_Sub18) this).anInt6891 * -1734052405,
					-649427988);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yl.f(").append(')').toString());
		}
	}
	...
	Class82_Sub18(RsByteBuffer class298_sub53) {
		...
		((Class82_Sub18) this).anInt6891 = class298_sub53
				.readUnsignedByte() * 779683811;
	}
	...
	public static final void method922(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yl.hc(").append(')').toString());
		}
	}

	static final void method923(Class403 class403, short i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8638 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yl.afb(").append(')').toString());
		}
	}
}
