...
public class Class193 implements Interface7_Impl1 {
	...
	public boolean method71(int i, int i_0_, Source source) {
		if (method72(i, i_0_))
			return jagdx.a.f(IDirect3DVertexBuffer.Upload(
					((Class193) this).aLong8584, 0,
					((Class193) this).anInt8581,
					((Class193) this).aBoolean8583 ? 8192 : 0, source.f()));
		return false;
	}
	...
	public boolean method63(int i, int i_1_, long l) {
		return jagdx.a.f(IDirect3DVertexBuffer.Upload(
				((Class193) this).aLong8584, i, i_1_,
				((Class193) this).aBoolean8583 ? 8192 : 0, l));
	}

	void method1862() {
		if (((Class193) this).aLong8584 != 0L) {
			((Class193) this).aClass_ra_Sub3_Sub2_8579
					.method5552(((Class193) this).aLong8584);
			((Class193) this).aLong8584 = 0L;
			((Class193) this).anInt8582 = 0;
			((Class193) this).anInt8581 = 0;
		}
	...
	public long method62(int i, int i_2_) {
		return IDirect3DVertexBuffer.Lock(((Class193) this).aLong8584, i, i_2_,
				(((Class193) this).aBoolean8583 ? 8192 : 0));
	}
	...
	public boolean method70(int i, int i_3_) {
		...
		if (((Class193) this).anInt8581 > ((Class193) this).anInt8582) {
			...
			if (((Class193) this).aLong8584 != 0L)
				IUnknown.Release(((Class193) this).aLong8584);
			((Class193) this).aLong8584 = (IDirect3DDevice
					.CreateVertexBuffer(
							((Class_ra_Sub3_Sub2) ((Class193) this).aClass_ra_Sub3_Sub2_8579).aLong9847,
							((Class193) this).anInt8581, i_4_, 0, i_5_));
	...
	public boolean method73(int i, int i_7_) {
		...
		if (((Class193) this).anInt8581 > ((Class193) this).anInt8582) {
			...
			((Class193) this).aLong8584 = (IDirect3DDevice
					.CreateVertexBuffer(
							((Class_ra_Sub3_Sub2) ((Class193) this).aClass_ra_Sub3_Sub2_8579).aLong9847,
							((Class193) this).anInt8581, i_8_, 0, i_9_));
			((Class193) this).anInt8582 = ((Class193) this).anInt8581;
		}
		return ((Class193) this).aLong8584 != 0L;
	}
	...
	public boolean method67(int i, int i_10_, long l) {
		return jagdx.a.f(IDirect3DVertexBuffer.Upload(
				((Class193) this).aLong8584, i, i_10_,
				((Class193) this).aBoolean8583 ? 8192 : 0, l));
	}

	public long method68(int i, int i_11_) {
		return IDirect3DVertexBuffer.Lock(((Class193) this).aLong8584, i,
				i_11_, (((Class193) this).aBoolean8583 ? 8192 : 0));
	}
	...
	public boolean method72(int i, int i_12_) {
		...
		if (((Class193) this).anInt8581 > ((Class193) this).anInt8582) {
			...
			((Class193) this).aLong8584 = (IDirect3DDevice
					.CreateVertexBuffer(
							((Class_ra_Sub3_Sub2) ((Class193) this).aClass_ra_Sub3_Sub2_8579).aLong9847,
							((Class193) this).anInt8581, i_13_, 0, i_14_));
			((Class193) this).anInt8582 = ((Class193) this).anInt8581;
		}
		return ((Class193) this).aLong8584 != 0L;
	}
	...
	public boolean method61(int i, int i_15_, long l) {
		return jagdx.a.f(IDirect3DVertexBuffer.Upload(
				((Class193) this).aLong8584, i, i_15_,
				((Class193) this).aBoolean8583 ? 8192 : 0, l));
	}
}
