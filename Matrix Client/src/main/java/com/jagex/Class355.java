...
public class Class355 implements Interface19 {
	...
	public boolean method239(Class298_Sub50 class298_sub50,
			Interface16[] interface16s, int i, Class323 class323, int i_2_) {
		try {
			int[] is = ((Class355) this).anIntArray6524;
	...
	static final void method4264(Class403 class403, short i) {
		try {
			...
			Class497 class497 = Class92.aClass504_905.method6251(i_11_,
					-1869114423);
			if (class497.method6206(1883696427))
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = client.aClass283_8716
						.method2641(-1837734772).getObjectDefinitions(i_10_)
						.method5770(i_11_, class497.aString6101, 1595133323);
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (client.aClass283_8716
						.method2641(767453715).getObjectDefinitions(i_10_)
						.method5776(i_11_, class497.anInt6100 * -388931549,
								(byte) 2));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ov.abf(").append(')').toString());
		}
	}

	static void method4265(int i, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(8,
					(long) i);
			...
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609 = i_14_
					* -80288087;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ov.af(").append(')').toString());
		}
	}
}
