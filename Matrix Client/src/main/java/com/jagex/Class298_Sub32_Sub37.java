...
public class Class298_Sub32_Sub37 extends Class298_Sub32 {
	...
	int[] method3374(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_1_ = 0; i_1_ < Class250.anInt2755 * -1474554145; i_1_++) {
				...
				if (i_2_ > -121339323 * ((Class298_Sub32_Sub37) this).anInt9558
						&& i_2_ < 4096 - -121339323
								* ((Class298_Sub32_Sub37) this).anInt9558
						&& i_0_ > 2048 - (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
						&& i_0_ < 2048 + (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)) {
					int i_3_ = 2048 - i_2_;
					...
					is[i_1_] = i_4_
							/ (2048 - -121339323
									* (((Class298_Sub32_Sub37) this).anInt9558));
				} else if (i_0_ < (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
						|| i_0_ > 4096
								- (((Class298_Sub32_Sub37) this).anInt9558)
								* -121339323) {
					int i_5_ = i_2_ - 2048;
					...
					i_5_ <<= 12;
					is[i_1_] = i_5_
							/ (2048 - (((Class298_Sub32_Sub37) this).anInt9558)
									* -121339323);
				} else if (i_2_ < (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
						|| i_2_ > 4096
								- (((Class298_Sub32_Sub37) this).anInt9558)
								* -121339323) {
					int i_6_ = 2048 - i_0_;
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_7_) {
		try {
			switch (i) {
			case 0:
				((Class298_Sub32_Sub37) this).anInt9558 = class298_sub53
						.readUnsignedShort() * 2065121421;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahz.r(").append(')').toString());
		}
	}
	...
	int[] method3375(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_9_ = 0; i_9_ < Class250.anInt2755 * -1474554145; i_9_++) {
				...
				if ((i_10_ > -121339323
						* ((Class298_Sub32_Sub37) this).anInt9558)
						&& i_10_ < 4096 - -121339323
								* ((Class298_Sub32_Sub37) this).anInt9558
						&& i_8_ > 2048 - (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
						&& i_8_ < 2048 + (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)) {
					int i_11_ = 2048 - i_10_;
					i_11_ = i_11_ < 0 ? -i_11_ : i_11_;
					i_11_ <<= 12;
					i_11_ /= 2048 - -121339323
							* (((Class298_Sub32_Sub37) this).anInt9558);
					is[i_9_] = 4096 - i_11_;
				} else if (i_10_ > 2048 - -121339323
						* ((Class298_Sub32_Sub37) this).anInt9558
						&& i_10_ < 2048
								+ (((Class298_Sub32_Sub37) this).anInt9558)
								* -121339323) {
					...
					is[i_9_] = i_12_
							/ (2048 - -121339323
									* ((Class298_Sub32_Sub37) this).anInt9558);
				} else if (i_8_ < (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
						|| i_8_ > 4096
								- (((Class298_Sub32_Sub37) this).anInt9558)
								* -121339323) {
					...
					is[i_9_] = i_13_
							/ (2048 - (((Class298_Sub32_Sub37) this).anInt9558)
									* -121339323);
				} else if (i_10_ < (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
						|| i_10_ > 4096
								- (((Class298_Sub32_Sub37) this).anInt9558)
								* -121339323) {
					int i_14_ = 2048 - i_8_;
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_17_ = 0; i_17_ < Class250.anInt2755 * -1474554145; i_17_++) {
					...
					if (i_18_ > (-121339323 * ((Class298_Sub32_Sub37) this).anInt9558)
							&& i_18_ < 4096 - -121339323
									* ((Class298_Sub32_Sub37) this).anInt9558
							&& i_16_ > 2048
									- (((Class298_Sub32_Sub37) this).anInt9558)
									* -121339323
						...
						i_19_ <<= 12;
						i_19_ /= 2048 - -121339323
								* ((Class298_Sub32_Sub37) this).anInt9558;
						is[i_17_] = 4096 - i_19_;
					} else if (i_18_ > 2048 - (-121339323 * (((Class298_Sub32_Sub37) this).anInt9558))
							&& i_18_ < 2048
									+ (((Class298_Sub32_Sub37) this).anInt9558)
									* -121339323) {
						...
						is[i_17_] = i_20_
								/ (2048 - -121339323
										* ((Class298_Sub32_Sub37) this).anInt9558);
					} else if (i_16_ < (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
							|| i_16_ > 4096
									- (((Class298_Sub32_Sub37) this).anInt9558)
									* -121339323) {
						...
						is[i_17_] = i_21_
								/ (2048 - (((Class298_Sub32_Sub37) this).anInt9558)
										* -121339323);
					} else if (i_18_ < (((Class298_Sub32_Sub37) this).anInt9558 * -121339323)
							|| i_18_ > 4096
									- (((Class298_Sub32_Sub37) this).anInt9558)
									* -121339323) {
