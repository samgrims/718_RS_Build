...
public class ClientScriptMap {
	...
	void method6124(RsByteBuffer class298_sub53, int i, int i_2_) {
		try {
			if (1 == i)
				aChar6042 = Class493.method6190(class298_sub53
						.readByte(-12558881), 2015897871);
			else if (i == 2)
				aChar6037 = Class493.method6190(class298_sub53
						.readByte(-12558881), 1877656812);
			else if (3 == i)
				((ClientScriptMap) this).aString6043 = class298_sub53
						.readString(1756453424);
			else if (4 == i)
				((ClientScriptMap) this).anInt6038 = class298_sub53
						.readInt((byte) 94)
						* -1961153765;
			else if (i == 5 || i == 6) {
				((ClientScriptMap) this).anInt6036 = class298_sub53
						.readUnsignedShort()
						* -1158380671;
				((ClientScriptMap) this).aMap6040 = new HashMap(-1179140991
						* ((ClientScriptMap) this).anInt6036);
				for (int i_3_ = 0; i_3_ < ((ClientScriptMap) this).anInt6036
						* -1179140991; i_3_++) {
					...
					if (i == 5)
						...
						serializable = new Integer(class298_sub53
								.readInt((byte) -67));
					((ClientScriptMap) this).aMap6040.put(new Integer(i_4_),
							serializable);
				}
			} else if (7 == i || 8 == i) {
				...
				for (int i_6_ = 0; i_6_ < -1179140991
						* ((ClientScriptMap) this).anInt6036; i_6_++) {
					int i_7_ = class298_sub53.readUnsignedShort();
					if (i == 7)
						((ClientScriptMap) this).anObjectArray6041[i_7_] = class298_sub53
								.readString(1730348772);
					else
						((ClientScriptMap) this).anObjectArray6041[i_7_] = new Integer(
								class298_sub53.readInt((byte) -14));
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tx.f(").append(')').toString());
		}
	}
	...
	void method6130(int i) {
		try {
			...
			if (null != ((ClientScriptMap) this).anObjectArray6041) {
				...
				Iterator iterator = ((ClientScriptMap) this).aMap6040.entrySet()
						.iterator();
	...
	static void method6132(int i, int i_15_, int i_16_, byte i_17_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(11,
					(long) i);
