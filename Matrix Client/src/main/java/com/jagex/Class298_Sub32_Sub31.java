...
public class Class298_Sub32_Sub31 extends Class298_Sub32 {
	...
	void method3335(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub31) this).anInt9507 = class298_sub53
					.readUnsignedShort()
					* -1944832501;
			break;
		case 2:
			((Class298_Sub32_Sub31) this).anInt9509 = class298_sub53
					.readUnsignedShort() * 1715409727;
			break;
		case 1:
			((Class298_Sub32_Sub31) this).anInt9510 = class298_sub53
					.readUnsignedShort()
					* -1347820645;
			break;
		case 3:
			((Class298_Sub32_Sub31) this).anInt9508 = class298_sub53
					.readUnsignedShort() * 580600575;
			break;
		}
	}
	...
	int[] method3336(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			for (int i_0_ = 0; i_0_ < Class250.anInt2755 * -1474554145; i_0_++) {
				...
				int i_2_ = (((Class250.anIntArray2760[i] << 12) / (-1758059101 * ((Class298_Sub32_Sub31) this).anInt9507)) + ((Class298_Sub32_Sub31) this).anInt9508
						* -824460033);
				int i_3_ = i_1_;
				int i_4_ = i_2_;
				int i_5_ = i_1_;
				...
				is[i_0_] = (i_9_ < (((Class298_Sub32_Sub31) this).anInt9510 * 1781451411) - 1 ? ((i_9_ << 12) / (((Class298_Sub32_Sub31) this).anInt9510 * 1781451411))
						: 0);
			}
		}
		return is;
	...
	int[] method3337(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
				...
				int i_13_ = (((Class250.anIntArray2760[i] << 12) / (-1758059101 * ((Class298_Sub32_Sub31) this).anInt9507)) + ((Class298_Sub32_Sub31) this).anInt9508
						* -824460033);
				int i_14_ = i_12_;
				int i_15_ = i_13_;
				int i_16_ = i_12_;
				...
				is[i_11_] = (i_20_ < (((Class298_Sub32_Sub31) this).anInt9510 * 1781451411) - 1 ? ((i_20_ << 12) / (((Class298_Sub32_Sub31) this).anInt9510 * 1781451411))
						: 0);
			}
		}
		return is;
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				for (int i_22_ = 0; i_22_ < Class250.anInt2755 * -1474554145; i_22_++) {
					...
					is[i_22_] = (i_31_ < (((Class298_Sub32_Sub31) this).anInt9510 * 1781451411) - 1 ? ((i_31_ << 12) / (((Class298_Sub32_Sub31) this).anInt9510 * 1781451411))
							: 0);
				}
			}
			return is;
