...
public class Class44 {
	...
	void method489() {
		...
		for (int i = 0; i < ((Class44) this).anInt473; i++) {
			for (int i_0_ = 0; i_0_ < ((Class44) this).anInt468; i_0_++)
				((Class44) this).aClass31ArrayArray475[i_0_][i] = new Class31(
						((Class44) this).aClass_ra_Sub2_472, this,
						((Class44) this).aClass_xa_Sub3_470, i_0_, i,
						((Class44) this).anInt474, i_0_ * 128 + 1, i * 128 + 1);
		}
	}
					...
					while_60_: for (int i_9_ = i_7_; i_9_ < i_8_; i_9_++) {
						if (i_9_ - i >= -i_2_ && i_9_ - i <= i_2_) {
							for (int i_10_ = i_4_; i_10_ < i_5_; i_10_++) {
								if (i_10_ - i_1_ >= -i_2_
										&& i_10_ - i_1_ <= i_2_
										&& (bools[i_9_ - i + i_2_][i_10_ - i_1_
												+ i_2_])) {
									OpenGL.glMatrixMode(5890);
									OpenGL.glLoadIdentity();
									OpenGL.glScalef(f, f, 1.0F);
									OpenGL.glTranslatef((float) -i_6_ / f,
											(float) -i_3_ / f, 1.0F);
									OpenGL.glMatrixMode(5888);
									((Class44) this).aClass31ArrayArray475[i_6_][i_3_]
											.method432();
									break while_60_;
								}
							}
				...
				for (int i_14_ = 0; i_14_ < ((Class44) this).anInt468; i_14_++) {
					...
					for (int i_18_ = i_12_; i_18_ < i_13_; i_18_++) {
						if (i_18_ - i_1_ >= -i_2_ && i_18_ - i_1_ <= i_2_) {
							int i_19_ = (i_18_
									* ((((Class44) this).aClass_xa_Sub3_470.anInt6287) * -506105871) + i_16_);
							for (int i_20_ = i_16_; i_20_ < i_17_; i_20_++) {
								if (i_20_ - i >= -i_2_
										&& i_20_ - i <= i_2_
										&& (bools[i_20_ - i + i_2_][i_18_
												- i_1_ + i_2_])) {
					...
					if (i_15_ > 0) {
						...
						OpenGL.glLoadIdentity();
						OpenGL.glScalef(f, f, 1.0F);
						OpenGL.glTranslatef((float) -i_14_ / f, (float) -i_11_
								/ f, 1.0F);
						OpenGL.glMatrixMode(5888);
						((Class44) this).aClass31ArrayArray475[i_14_][i_11_]
								.method435(class298_sub53_sub1.buffer,
										i_15_);
					}
				}
			}
	...
	void method491(Class_na class_na, int i, int i_23_) {
		...
		if (i_27_ > 0 && i_26_ > 0) {
			method494(((Class44) this).aByteArray471,
					((Class_na_Sub1) class_na_sub1).aByteArray10017, i_25_,
	...
	boolean method492(Class_na class_na, int i, int i_34_) {
		...
		return method495(((Class44) this).aByteArray471, i_35_, i_37_, i_36_,
				i_38_, i_43_);
	}
	...
	Class44(Class_ra_Sub2 class_ra_sub2, Class_xa_Sub3 class_xa_sub3) {
		...
		((Class44) this).anInt469 = 2 + ((((Class44) this).aClass_xa_Sub3_470.anInt6287
				* -506105871 * (((Class44) this).aClass_xa_Sub3_470.anInt6288 * -1212653763)) >> (((Class_ra_Sub2) ((Class44) this).aClass_ra_Sub2_472).anInt8064));
		((Class44) this).anInt467 = 2 + ((((Class44) this).aClass_xa_Sub3_470.anInt6286
				* -1148794921 * (((Class44) this).aClass_xa_Sub3_470.anInt6288 * -1212653763)) >> (((Class_ra_Sub2) ((Class44) this).aClass_ra_Sub2_472).anInt8064));
		((Class44) this).aByteArray471 = new byte[((Class44) this).anInt469
				* ((Class44) this).anInt467];
		((Class44) this).anInt474 = (7 + (((Class_ra_Sub2) ((Class44) this).aClass_ra_Sub2_472).anInt8064) - ((Class44) this).aClass_xa_Sub3_470.anInt6289
				* -2137349879);
		((Class44) this).anInt468 = (((Class44) this).aClass_xa_Sub3_470.anInt6287
				* -506105871 >> ((Class44) this).anInt474);
		((Class44) this).anInt473 = (((Class44) this).aClass_xa_Sub3_470.anInt6286
				* -1148794921 >> ((Class44) this).anInt474);
	}

	static final void method493(byte[] is, byte[] is_44_, int i, int i_45_,
	...
	static final void method494(byte[] is, byte[] is_54_, int i, int i_55_,
	...
	static final boolean method495(byte[] is, int i, int i_64_, int i_65_,
			int i_66_, int i_67_) {
	...
	void method496(Class_na class_na, int i, int i_74_) {
		...
		if (i_78_ > 0 && i_77_ > 0) {
			method493(((Class44) this).aByteArray471,
					((Class_na_Sub1) class_na_sub1).aByteArray10017, i_76_,
					i_75_, i_78_, i_77_, i_79_, i_80_);
