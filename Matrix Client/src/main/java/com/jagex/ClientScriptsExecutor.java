...
public class ClientScriptsExecutor {
	...
	static void method4690(ClientScript class298_sub37_sub17, int i,
			Class403 class403, int i_0_) {
		try {
			...
			try {
				try {
					...
					for (;;) {
						...
						if (Class394.aClass394_4206 == class394
								&& (((Class403) class403).anInt5250
										* -932179775 == 0)) {
					...
					IPAddress.method6062(stringbuilder.toString(), exception,
							(short) -1126);
	...
	static final void method4691(Class403 class403, byte i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = ((Player) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242)
					.method4470(true, -1660599936);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("px.aom(").append(')').toString());
		}
	}

	static boolean method4692(CharSequence charsequence, int i, boolean bool,
			int i_2_) {
		try {
			if (i < 2 || i > 36)
	...
	static final void method4694(Class403 class403, byte i) {
		try {
			...
			if (client.aString8804 != null
					&& i_10_ < -1801543887 * Class489.anInt6071)
