...
public class Class298_Sub24_Sub3 extends Class298_Sub24 {
	...
	float method3084(int i) {
		try {
			if (!((Class298_Sub24_Sub3) this).aBoolean9293
					|| ((Class298_Sub24_Sub3) this).aTheoraInfo9284.a())
				return 0.0F;
	...
	public Object method3088(Interface15 interface15, int i) {
		try {
			if (null == ((Class298_Sub24_Sub3) this).aFrame9290)
				return null;
			if (!((Class298_Sub24_Sub3) this).aBoolean9299
					&& null != ((Class298_Sub24_Sub3) this).anObject9298)
				return ((Class298_Sub24_Sub3) this).anObject9298;
			((Class298_Sub24_Sub3) this).anObject9298 = (interface15.method214(
					((Class298_Sub24_Sub3) this).aFrame9290.pixels, 0,
					1264450863 * ((Class298_Sub24_Sub3) this).aFrame9290.a,
					((Class298_Sub24_Sub3) this).aFrame9290.a * 1264450863,
					-1459424961 * ((Class298_Sub24_Sub3) this).aFrame9290.f,
					false, 1108085908));
			((Class298_Sub24_Sub3) this).aBoolean9299 = false;
			return ((Class298_Sub24_Sub3) this).anObject9298;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajq.c(").append(')').toString());
		}
	}

	void method3077(OggPacket oggpacket) {
		if (!((Class298_Sub24_Sub3) this).aBoolean9293) {
			int i = (((Class298_Sub24_Sub3) this).aSetupInfo9285.decodeHeader(
					((Class298_Sub24_Sub3) this).aTheoraInfo9284,
					((Class298_Sub24_Sub3) this).aTheoraComment9296, oggpacket));
			if (0 == i) {
				((Class298_Sub24_Sub3) this).aBoolean9293 = true;
				if ((((Class298_Sub24_Sub3) this).aTheoraInfo9284.frameWidth > 2048)
						|| (((Class298_Sub24_Sub3) this).aTheoraInfo9284.frameHeight) > 1024)
					throw new IllegalStateException();
				((Class298_Sub24_Sub3) this).aDecoderContext9288 = new DecoderContext(
						(((Class298_Sub24_Sub3) this).aTheoraInfo9284),
						(((Class298_Sub24_Sub3) this).aSetupInfo9285));
				((Class298_Sub24_Sub3) this).aGranulePos9294 = new GranulePos();
				((Class298_Sub24_Sub3) this).aFrame9290 = new Frame(
						(((Class298_Sub24_Sub3) this).aTheoraInfo9284.frameWidth),
						(((Class298_Sub24_Sub3) this).aTheoraInfo9284.frameHeight));
				((Class298_Sub24_Sub3) this).anInt9295 = ((Class298_Sub24_Sub3) this).aDecoderContext9288
						.getMaxPostProcessingLevel() * 295322609;
				method3089(
						(-2058603981 * ((Class298_Sub24_Sub3) this).anInt9291),
						(byte) 77);
			} else if (i < 0)
				throw new IllegalStateException(new StringBuilder().append("")
						.append(i).toString());
		} else {
			((Class298_Sub24_Sub3) this).aLong9292 = Class122
					.method1319((byte) 1) * 4704549656485466045L;
			int i = (((Class298_Sub24_Sub3) this).aDecoderContext9288
					.decodePacketIn(oggpacket,
							((Class298_Sub24_Sub3) this).aGranulePos9294));
			if (i < 0)
				throw new IllegalStateException(new StringBuilder().append("")
						.append(i).toString());
			((Class298_Sub24_Sub3) this).aDecoderContext9288
					.granuleFrame(((Class298_Sub24_Sub3) this).aGranulePos9294);
			((Class298_Sub24_Sub3) this).aDouble9289 = (((Class298_Sub24_Sub3) this).aDecoderContext9288
					.granuleTime(((Class298_Sub24_Sub3) this).aGranulePos9294));
			...
			if (!((Class298_Sub24_Sub3) this).aBoolean9283
					|| oggpacket.isKeyFrame() == 1) {
				if (((Class298_Sub24_Sub3) this).aDecoderContext9288
						.decodeFrame(((Class298_Sub24_Sub3) this).aFrame9290) != 0)
					throw new IllegalStateException(new StringBuilder().append(
							"").append(i).toString());
	...
	void method3074(OggPacket oggpacket, int i) {
		try {
			if (!((Class298_Sub24_Sub3) this).aBoolean9293) {
				int i_0_ = (((Class298_Sub24_Sub3) this).aSetupInfo9285
						.decodeHeader(
								((Class298_Sub24_Sub3) this).aTheoraInfo9284,
								((Class298_Sub24_Sub3) this).aTheoraComment9296,
								oggpacket));
				if (0 == i_0_) {
					((Class298_Sub24_Sub3) this).aBoolean9293 = true;
					if ((((Class298_Sub24_Sub3) this).aTheoraInfo9284.frameWidth) > 2048
					...
					throw new IllegalStateException(new StringBuilder().append(
							"").append(i_0_).toString());
			} else {
				((Class298_Sub24_Sub3) this).aLong9292 = Class122
						.method1319((byte) 1) * 4704549656485466045L;
				int i_1_ = (((Class298_Sub24_Sub3) this).aDecoderContext9288
						.decodePacketIn(oggpacket,
								((Class298_Sub24_Sub3) this).aGranulePos9294));
				if (i_1_ < 0)
					throw new IllegalStateException(new StringBuilder().append(
							"").append(i_1_).toString());
				((Class298_Sub24_Sub3) this).aDecoderContext9288
						.granuleFrame(((Class298_Sub24_Sub3) this).aGranulePos9294);
				((Class298_Sub24_Sub3) this).aDouble9289 = (((Class298_Sub24_Sub3) this).aDecoderContext9288
						.granuleTime(((Class298_Sub24_Sub3) this).aGranulePos9294));
				...
				if (!((Class298_Sub24_Sub3) this).aBoolean9283
					...
					if ((((Class298_Sub24_Sub3) this).aDecoderContext9288
						...
						throw new IllegalStateException(new StringBuilder()
								.append("").append(i_1_).toString());
					((Class298_Sub24_Sub3) this).aBoolean9299 = true;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajq.f(").append(')').toString());
		}
	}
	...
	void method3089(int i, byte i_2_) {
		try {
			...
			if (((Class298_Sub24_Sub3) this).aBoolean9293) {
				if (-2058603981 * ((Class298_Sub24_Sub3) this).anInt9291 > -42840815
						* ((Class298_Sub24_Sub3) this).anInt9295)
					((Class298_Sub24_Sub3) this).anInt9291 = ((Class298_Sub24_Sub3) this).anInt9295
							* -679663701;
				if (-2058603981 * ((Class298_Sub24_Sub3) this).anInt9291 < 0)
					((Class298_Sub24_Sub3) this).anInt9291 = 0;
				((Class298_Sub24_Sub3) this).aDecoderContext9288
						.setPostProcessingLevel(-2058603981
								* ((Class298_Sub24_Sub3) this).anInt9291);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajq.q(").append(')').toString());
		}
	}
	...
	public static boolean method3090(int i, int i_3_) {
		try {
			if (Class87.anInt804 * 296787703 != i
					|| null == Class118.aClass88_1402) {
			...
			if (Class118.aClass88_1402 == Class88.aClass88_808) {
				...
				for (int i_5_ = 0; i_5_ < i_4_; i_5_++)
					Class87.aClass453_799.method5935(new Class298_Sub7(
							class298_sub53), -51345743);
