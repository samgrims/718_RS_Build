package com.jagex;/* Class298_Sub32_Sub30 - Decompiled by JODE
		...
		try {
			...
			if (aClass257_7384.aBoolean2810)
				Class425.method5740(is, 0, Class250.anInt2755 * -1474554145,
						Class250.anIntArray2760[i]);
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahs.i(").append(')').toString());
		}
	}
	...
	public static int method3334(Class243 class243, byte i) {
		try {
			...
			if (class243.method2310(Class74.anInt694 * -355151363, -457216440))
				i_1_++;
			if (class243
					.method2310(1838189665 * Class143.anInt1558, -457216440))
				i_1_++;
			if (class243
					.method2310(Class400.anInt5223 * 1862609057, -457216440))
				i_1_++;
			...
			if (class243.method2310(493809835 * Class257.anInt2802, -457216440))
				i_1_++;
			if (class243
					.method2310(1359711467 * Class237.anInt6667, -457216440))
				i_1_++;
