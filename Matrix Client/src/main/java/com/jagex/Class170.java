...
public final class Class170 {
	...
	static void method1808(int i) {
		try {
			if (Class436.aClass298_Sub37_Sub5_5472 != null) {
				...
				Class227.method2112(805710735 * Class461.anInt5681,
						Class501.anInt6119 * -1370784315,
						Class420.anInt5345 * 2054409059, Class389.anInt4166
								* -1855216229, (byte) 2);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ha.z(").append(')').toString());
		}
	}
	...
	static final void method1810(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ha.adx(").append(')').toString());
		}
	}

	public static void method1811(int i, Class243 class243, int i_2_, int i_3_,
			int i_4_, boolean bool, Class97 class97, byte i_5_) {
		try {
			if (i > 0) {
				...
				Class298_Sub24_Sub1.anInt9276 = (Class79.aClass298_Sub19_Sub1_737
						.method2953((byte) -72)
						/ i * 771950311);
				...
				Class477.method6096(class243, i_2_, i_3_, i_4_, bool,
						-1991321667);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ha.n(").append(')').toString());
		}
	}
					...
					if (1 == i && class105.anObjectArray1250 != null) {
						if (class105.anInt1154 * -1309843523 >= 0) {
							...
							if (class105_8_ == null
									...
									|| (-1309843523 * class105.anInt1154 >= class105_8_.aClass105Array1292.length))
								continue;
							if ((class105_8_.aClass105Array1292[-1309843523
	...
	static final void method1813(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ha.anj(").append(')').toString());
		}
	}

	static boolean method1814(Interface19 interface19,
			Class298_Sub50 class298_sub50, byte i) {
		try {
			return (interface19 != null && interface19.method239(
					class298_sub50, client.anInterface16Array8688,
					client.anInt8687 * -1625219821, Class372.aClass323_4052,
					-622376364));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ha.i(").append(')').toString());
		}
	}
	...
	static final void method1815(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub5
					.method882(i_10_, false, (byte) 63);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ha.ui(").append(')').toString());
		}
	}
}
