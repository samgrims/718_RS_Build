package com.jagex;/* Class300 - Decompiled by JODE
...
public class Class300 {
	...
	static final void method3684(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mm.nr(").append(')').toString());
		}
	}

	public static String method3685(long l, int i, boolean bool,
			Class429 class429, short i_1_) {
		try {
			char c = ',';
			char c_2_ = '.';
	...
	static void method3686(long l) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mm.k(").append(')').toString());
		}
	}

	public static void method3687(int i, int i_8_, int i_9_, int i_10_,
			int i_11_, int i_12_, String string, int i_13_) {
		try {
			...
			((Class302_Sub4) class302_sub4).anInt7655 = (i_11_ + client.anInt8884 * 443738891)
					* -1019659005;
