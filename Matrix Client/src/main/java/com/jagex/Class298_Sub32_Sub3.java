...
public class Class298_Sub32_Sub3 extends Class298_Sub32 {
	...
	void method3151() {
		if (null == ((Class298_Sub32_Sub3) this).anIntArrayArray9330)
			((Class298_Sub32_Sub3) this).anIntArrayArray9330 = new int[][] {
					{ 0, 0 }, { 4096, 4096 } };
	...
	final int[] method3152(int i, byte i_4_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("age.ac(").append(')').toString());
		}
	}

	void method3153(int i, RsByteBuffer class298_sub53) {
		if (0 == i) {
			((Class298_Sub32_Sub3) this).anInt9329 = class298_sub53
					.readUnsignedByte() * 417209465;
			((Class298_Sub32_Sub3) this).anIntArrayArray9330 = new int[class298_sub53
					.readUnsignedByte()][2];
			for (int i_5_ = 0; (i_5_ < ((Class298_Sub32_Sub3) this).anIntArrayArray9330.length); i_5_++) {
				((Class298_Sub32_Sub3) this).anIntArrayArray9330[i_5_][0] = class298_sub53
						.readUnsignedShort();
				((Class298_Sub32_Sub3) this).anIntArrayArray9330[i_5_][1] = class298_sub53
						.readUnsignedShort();
			}
		}
	}
		...
		try {
			if (0 == i) {
				...
				for (int i_40_ = 0; i_40_ < (((Class298_Sub32_Sub3) this).anIntArrayArray9330).length; i_40_++) {
					((Class298_Sub32_Sub3) this).anIntArrayArray9330[i_40_][0] = class298_sub53
							.readUnsignedShort();
					((Class298_Sub32_Sub3) this).anIntArrayArray9330[i_40_][1] = class298_sub53
							.readUnsignedShort();
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("age.r(").append(')').toString());
		}
	}
	...
	final void method3155(byte i) {
		try {
			...
			((Class298_Sub32_Sub3) this).anIntArray9328 = new int[] {
					is[0] + (is[0] - is_41_[0]), is[1] - is_41_[1] + is[1] };
			((Class298_Sub32_Sub3) this).anIntArray9324 = new int[] {
					is_42_[0] - is_43_[0] + is_42_[0],
					is_42_[1] + (is_42_[1] - is_43_[1]) };
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("age.bd(").append(')').toString());
		}
	}
	...
	void method3159(int i, RsByteBuffer class298_sub53) {
		if (0 == i) {
			...
			for (int i_47_ = 0; (i_47_ < ((Class298_Sub32_Sub3) this).anIntArrayArray9330.length); i_47_++) {
				((Class298_Sub32_Sub3) this).anIntArrayArray9330[i_47_][0] = class298_sub53
						.readUnsignedShort();
				((Class298_Sub32_Sub3) this).anIntArrayArray9330[i_47_][1] = class298_sub53
						.readUnsignedShort();
			}
		}
	}
