...
public class Class298_Sub6 extends Class298 {
	...
	boolean method2862(int i, int i_0_, byte i_1_) {
		try {
			if (i >= ((Class298_Sub6) this).anInt7209 * -321418373
					&& i <= -236078983 * ((Class298_Sub6) this).anInt7204
					&& i_0_ >= 2086933977 * ((Class298_Sub6) this).anInt7205
					&& i_0_ <= -1810755143 * ((Class298_Sub6) this).anInt7210)
				return true;
			if (i >= ((Class298_Sub6) this).anInt7211 * 1150354879
					&& i <= 957695249 * ((Class298_Sub6) this).anInt7208
					&& i_0_ >= ((Class298_Sub6) this).anInt7207 * -38089737
					&& i_0_ <= ((Class298_Sub6) this).anInt7203 * -1024506197)
				return true;
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaj.a(").append(')').toString());
		}
	}
