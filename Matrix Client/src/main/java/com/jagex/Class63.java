...
public class Class63 {
	...
	static final void method735(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = ((Class403) class403).aClass162_5252.aStringArray1671[i_0_];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("co.xk(").append(')').toString());
		}
	}
	...
	static final void method736(Class403 class403, int i) {
		try {
			...
			if (Class287.myPlayer != null
					&& null != (Class287.myPlayer.aString10200))
				string = Class287.myPlayer
						.method4470(true, -1868785236);
			else
				string = "";
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = string;
	...
	static final void method737(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (Class411
					.method5574(i_1_, 251900723) / 60000L);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("co.ake(").append(')').toString());
		}
	}
	...
	static void method738(int i, int i_2_, int i_3_) {
		try {
			if (-1909773881 * Class436.anInt5476 == 1)
				Class401.method4939(Class411.aClass298_Sub37_Sub15_5324, i,
						i_2_, (short) 916);
	...
	public static void method742(Class298_Sub37 class298_sub37,
			Class298_Sub37 class298_sub37_5_, byte i) {
		try {
