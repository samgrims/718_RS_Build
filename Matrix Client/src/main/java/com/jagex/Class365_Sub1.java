...
public abstract class Class365_Sub1 extends Class365 {
	...
	abstract void method4355(GraphicsToolkit class_ra, Class365_Sub1 class365_sub1_3_,
	...
	abstract void method4375(GraphicsToolkit class_ra,
			Class365_Sub1 class365_sub1_10_, int i, int i_11_, int i_12_,
			boolean bool);
	...
	abstract void method4388(GraphicsToolkit class_ra,
			Class365_Sub1 class365_sub1_14_, int i, int i_15_, int i_16_,
			boolean bool);
	...
	static final void method4401(IComponentDefinition class105, Class119 class119,
				...
				class105
						.method1115(
								...
								(String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751)
										* -203050393]), 1110385787);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adp.is(").append(')').toString());
		}
	}
		...
		try {
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub21_7580
				...
				Class62.aClass248_612.method2385(new Class267(
						Class266.aClass266_2852, null), -1108671657);
			else {
