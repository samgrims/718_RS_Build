...
public final class Class501 {
	...
	public void method6222(Object object, Object object_0_, int i) {
		try {
			...
			int i_2_ = i_1_
					& (((Class501) this).aWeakReference_Sub1Array6121.length - 1);
			WeakReference_Sub1 weakreference_sub1 = ((Class501) this).aWeakReference_Sub1Array6121[i_2_];
			if (weakreference_sub1 == null) {
				((Class501) this).aWeakReference_Sub1Array6121[i_2_] = new WeakReference_Sub1(
						object, (((Class501) this).aReferenceQueue6120), i_1_,
						object_0_);
				...
				for (;;) {
					...
					if ((((WeakReference_Sub1) weakreference_sub1).aWeakReference_Sub1_6302) == null) {
						((WeakReference_Sub1) weakreference_sub1).aWeakReference_Sub1_6302 = new WeakReference_Sub1(
								object,
								(((Class501) this).aReferenceQueue6120), i_1_,
								object_0_);
						((Class501) this).anInt6118 += -1233820543;
	...
	void method6223(int i) {
		try {
			for (;;) {
				WeakReference_Sub1 weakreference_sub1 = ((WeakReference_Sub1) ((Class501) this).aReferenceQueue6120
						.poll());
				if (weakreference_sub1 == null)
					break;
	...
	public ArrayList method6224(int i) {
		try {
			...
			ArrayList arraylist = new ArrayList(
					((Class501) this).anInt6118 * 2061425537);
	...
	public static void method6227(boolean bool, int i) {
		try {
			...
			Class287.myPlayer = new Player(
					null);
			Class287.myPlayer
					.method4341((float) (client.aClass283_8716
							.method2629(-1895849411) * 512 / 2), 0.0F,
							(float) (client.aClass283_8716
									.method2630(501771104) * 512 / 2));
			Class287.myPlayer.scenePositionXQueue[0] = client.aClass283_8716
					.method2629(-1873805931) / 2;
			Class287.myPlayer.scenePositionYQueue[0] = client.aClass283_8716
					.method2630(2001443939) / 2;
			...
			client.aClass283_8716.method2640((byte) -45)
					.method4324(-1834713428);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("us.fs(").append(')').toString());
		}
	}
	...
	static boolean method6229(RsBitsBuffer class298_sub53_sub2, int i,
			int i_14_) {
		try {
			...
			if (0 == i_15_) {
				...
				if (bool)
					Class10.anIntArray140[(Class10.anInt139 += 867608709)
							* -1281683379 - 1] = i;
				if (null != client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i])
					throw new RuntimeException();
				Class410 class410 = Class10.aClass410Array138[i];
				Player class365_sub1_sub1_sub2_sub2 = (client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805[i] = (new Player(
				...
				if (null != Class10.aClass298_Sub53Array133[i])
					class365_sub1_sub1_sub2_sub2.sendAppearence(
							Class10.aClass298_Sub53Array133[i], (byte) 3);
				class365_sub1_sub1_sub2_sub2.method4415(-1000138653
						* ((Class410) class410).anInt5286, true, 1449559817);
				class365_sub1_sub1_sub2_sub2.anInt10090 = -790543005
						* ((Class410) class410).anInt5285;
				...
				int i_22_ = (i_20_ << 6) + i_16_ - class341.gameSceneBaseX
						* -1760580017;
				int i_23_ = (i_21_ << 6) + i_17_ - 283514611
				...
				if (client.aClass283_8716.method2654(1040339757).method2320(
						i_22_, i_23_, -937818147))
			...
			if (1 == i_15_) {
				...
				((Class410) Class10.aClass410Array138[i]).anInt5288 = (((i_24_
						+ (i_25_ >> 28) & 0x3) << 28) + (i_25_ & 0xfffffff)) * 1896571807;
				return false;
			}
			if (i_15_ == 2) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("us.k(").append(')').toString());
		}
	}

	static void method6230(int i, String string, int i_41_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(2,
					(long) i);
			class298_sub37_sub12.method3449((byte) 54);
			((Class298_Sub37_Sub12) class298_sub37_sub12).aString9611 = string;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("us.at(").append(')').toString());
		}
	}

	static void method6231(File file, byte[] is, int i, int i_42_)
			throws IOException {
		try {
