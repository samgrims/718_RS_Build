package com.jagex;/* Class516 - Decompiled by JODE
		...
		try {
			if (!string.equals("")) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.JOIN_FRIEND_CHAT_PACKET, class25.aClass449_330,
						(byte) 113);
				class298_sub36.out.writeByte(Class58
						.method693(string, 148630832));
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vs.ma(").append(')').toString());
		}
	}

	static final void method6300(int i, int i_1_, int i_2_, int i_3_,
			Class435 class435, byte i_4_) {
		try {
			if (i_2_ >= 1
					&& i_3_ >= 1
					&& i_2_ <= client.aClass283_8716.method2629(-1894377459) - 2
					&& i_3_ <= client.aClass283_8716.method2630(793681614) - 2) {
				if (client.aClass283_8716.method2675(-1611682495) != null) {
					Interface3 interface3 = client.aClass283_8716.method2644(
							112641684).method2241(i, i_1_, i_2_, i_3_,
							2002986961);
					if (interface3 != null) {
						if (interface3 instanceof Class365_Sub1_Sub1_Sub5)
							((Class365_Sub1_Sub1_Sub5) interface3).method4486(
									class435, -1857916290);
						else if (interface3 instanceof Class365_Sub1_Sub2_Sub1)
							((Class365_Sub1_Sub2_Sub1) interface3).method4495(
									class435, (byte) 0);
						else if (interface3 instanceof Class365_Sub1_Sub5_Sub2)
							((Class365_Sub1_Sub5_Sub2) interface3).method4530(
									class435, -772948139);
						else if (interface3 instanceof Class365_Sub1_Sub3_Sub1)
							((Class365_Sub1_Sub3_Sub1) interface3).method4504(
									class435, (byte) 11);
					}
				}
			}
