...
public abstract class Class481 {
	...
	Socket method6110(int i) throws IOException {
		try {
			return new Socket(((Class481) this).aString6034,
					98195689 * ((Class481) this).anInt6033);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tv.b(").append(')').toString());
		}
	}
		...
		try {
			...
			for (int i_0_ = 0; i_0_ < client.anInt8808 * -976358333; i_0_++) {
				...
				if (0 != (mask & 0x80)) { //Face location - ordinal 3
					npc.anInt10179 = (stream
							.readUnsignedShort128(-1091754982) * 1312461425);
					npc.anInt10180 = (stream
							.readUnsignedShortLE128(1478539457) * 2139727009);
				}
				...
				if ((mask & 0x200) != 0) { //Set render animation id - ordinal 5
				...
				if ((mask & 0x1000) != 0) {// ordinal 8
					...
					if (1 == (i_21_ & 0x1))
						...
						long l = ((long) npcIndex | (long) ((npc.anInt10182 += -230300471)
								* -156273287 - 1) << 32);
						npc.aClass498_10181 = new Class498(
								l, is, is_23_, is_25_);
					}
				}
				...
				if ((mask & 0x1) != 0) {//Transform NPC id - ordinal 22
					...
					if (npc.aClass503_10190.method6242((byte) 23)) {
						Class391.method4884(npc.plane, npc.scenePositionXQueue[0], npc.scenePositionYQueue[0],
										0, null, npc, null, (byte) 68);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tv.kd(").append(')').toString());
		}
	}
}
