...
public class Class434 {
	...
	static boolean method5802(int i) {
		try {
			return Class492.method6184(Class144.aClass381_1563.aClass355_4115,
					1089632340);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ry.b(").append(')').toString());
		}
	}
	...
	static final void method5803(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class390
					.method4867(i_2_, -1, -574024132) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ry.bz(").append(')').toString());
		}
	}
}
