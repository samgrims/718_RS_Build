...
public class Class165 implements Interface5 {
	...
	static final void method1781(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gt.gs(").append(')').toString());
		}
	}

	static void method1782(long[] ls, Object[] objects, int i, int i_1_,
			int i_2_) {
		try {
			if (i < i_1_) {
				int i_3_ = (i + i_1_) / 2;
		...
		try {
			...
			for (int i_10_ = 0; i_10_ < (-888767613 * Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength); i_10_++) {
				ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(i_10_, true);
				if (1343198193 * class468.anInt5724 >= 0
						|| 1585491093 * class468.anInt5747 >= 0)
					is[i_9_++] = i_10_;
			}
