...
public class Class464 {
	...
	Class464(ItemDefinitions class468) {
		...
		if (((ItemDefinitions) class468).aShortArray5706 != null) {
			...
			System.arraycopy(((ItemDefinitions) class468).aShortArray5706, 0,
					aShortArray5698, 0, aShortArray5698.length);
		}
		if (null != ((ItemDefinitions) class468).aShortArray5712) {
			...
			System.arraycopy(((ItemDefinitions) class468).aShortArray5712, 0,
					aShortArray5699, 0, aShortArray5699.length);
		}
	}
