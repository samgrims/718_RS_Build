		...
		try {
			if (i > i_0_)
				Class82_Sub22.method940(
						(Class372_Sub2.anIntArrayArray4047[i_1_]), i_0_, i,
						i_2_, 1232193960);
			else
				Class82_Sub22.method940(
						(Class372_Sub2.anIntArrayArray4047[i_1_]), i, i_0_,
						i_2_, 583868785);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tn.n(").append(')').toString());
		}
	}
