package com.jagex;/* Class422_Sub4 - Decompiled by JODE
...
public class Class422_Sub4 extends Class422 {
	...
	public void method5637(int i) {
		try {
			if (aClass298_Sub48_5346.method3543(-463714341).method5594(
					1268482556) < 245)
				anInt5350 = 0;
	...
	public int method5612(int i, int i_0_) {
		try {
			if (aClass298_Sub48_5346.method3543(-2143176849).method5594(
					1386061533) < 245)
				return 3;
			return 1;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ade.f(").append(')').toString());
		}
	}
	...
	int method5611(int i) {
		try {
			if (aClass298_Sub48_5346.method3543(-1188800813).method5594(
					1637246770) < 245)
				return 0;
			return 2;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ade.a(").append(')').toString());
		}
	}

	public boolean method5638(byte i) {
		try {
			if (aClass298_Sub48_5346.method3543(-325188584).method5594(
					2056702911) < 245)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ade.z(").append(')').toString());
		}
	}
