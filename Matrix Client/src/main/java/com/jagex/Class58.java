package com.jagex;/* Class58 - Decompiled by JODE
...
public class Class58 {
	...
	public static int method692(int i, int i_2_, int i_3_) {
		try {
			int i_4_ = i_2_ >>> 24;
			int i_5_ = 255 - i_4_;
			i_2_ = ((i_2_ & 0xff00ff) * i_4_ & ~0xff00ff | i_4_
					* (i_2_ & 0xff00) & 0xff0000) >>> 8;
			return i_2_
					+ ((i_5_ * (i & 0xff00ff) & ~0xff00ff | (i & 0xff00) * i_5_
							& 0xff0000) >>> 8);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ci.d(").append(')').toString());
		}
	}
	...
	public static Class134 method695(RsByteBuffer class298_sub53, int i) {
		try {
			...
			Class139 class139 = (Class491.method6176((byte) 12)[class298_sub53
					.readUnsignedByte()]);
			Class133 class133 = (Class113.method1255(334501262)[class298_sub53
					.readUnsignedByte()]);
			...
			return new Class134(i_6_, class139, class133, i_7_, i_8_, i_9_,
					i_10_, i_11_, i_12_, i_13_, bool);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ci.a(").append(')').toString());
		}
	}
}
