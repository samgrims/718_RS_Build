...
public class Class78 {
	...
	public boolean method843(Class78 class78_6_, byte i) {
		try {
			return (class78_6_.anInt726 * -1212608691 == -1212608691 * anInt726
					&& (1996750669 * class78_6_.anInt725 == anInt725 * 1996750669)
					&& (anInt727 * -1475891183 == -1475891183
							* class78_6_.anInt727)
					&& (((Class78) this).anInt728 * -1761932591 == ((Class78) class78_6_).anInt728
							* -1761932591)
					&& anInt729 * -28774789 == -28774789 * class78_6_.anInt729
					&& 484707881 * anInt730 == 484707881 * class78_6_.anInt730 && (class78_6_.anInt732
					* -1637742683 == anInt732 * -1637742683));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dd.a(").append(')').toString());
		}
	}
	...
	static final void method846(Class403 class403, short i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.anIntArray8829[i_8_];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
