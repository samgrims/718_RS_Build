...
public class Class298_Sub32_Sub22 extends Class298_Sub32 {
		...
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_8_ = 0; i_8_ < Class250.anInt2755 * -1474554145; i_8_++) {
					...
					if (i_9_ < ((Class298_Sub32_Sub22) this).anInt9463
							* -583223949)
						...
						is_5_[i_8_] = i_9_;
					if (i_10_ < -583223949
							* ((Class298_Sub32_Sub22) this).anInt9463)
						...
						is_6_[i_8_] = i_10_;
					if (i_11_ < ((Class298_Sub32_Sub22) this).anInt9463
							* -583223949)
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_14_ = 0; i_14_ < -1474554145 * Class250.anInt2755; i_14_++) {
					...
					if (i_15_ < ((Class298_Sub32_Sub22) this).anInt9463
							* -583223949)
						is[i_14_] = -583223949
								* (((Class298_Sub32_Sub22) this).anInt9463);
	...
	void method3274(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub22) this).anInt9463 = class298_sub53
					.readUnsignedShort() * 380991419;
			break;
		case 1:
			((Class298_Sub32_Sub22) this).anInt9465 = class298_sub53
					.readUnsignedShort()
					* -784826695;
			break;
		case 2:
	...
	int[][] method3275(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_23_ = 0; i_23_ < Class250.anInt2755 * -1474554145; i_23_++) {
				...
				if (i_24_ < ((Class298_Sub32_Sub22) this).anInt9463
						* -583223949)
					is_20_[i_23_] = ((Class298_Sub32_Sub22) this).anInt9463
							* -583223949;
	...
	int[] method3276(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_28_ = 0; i_28_ < -1474554145 * Class250.anInt2755; i_28_++) {
				...
				if (i_29_ < ((Class298_Sub32_Sub22) this).anInt9463
						* -583223949)
					is[i_28_] = -583223949
							* ((Class298_Sub32_Sub22) this).anInt9463;
	...
	int[] method3277(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_31_ = 0; i_31_ < -1474554145 * Class250.anInt2755; i_31_++) {
				...
				if (i_32_ < ((Class298_Sub32_Sub22) this).anInt9463
						* -583223949)
					is[i_31_] = -583223949
							* ((Class298_Sub32_Sub22) this).anInt9463;
	...
	int[][] method3279(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_40_ = 0; i_40_ < Class250.anInt2755 * -1474554145; i_40_++) {
				...
				if (i_41_ < ((Class298_Sub32_Sub22) this).anInt9463
						* -583223949)
					is_37_[i_40_] = ((Class298_Sub32_Sub22) this).anInt9463
							* -583223949;
