...
public class IPAddress {
	...
	public Socket method6056(int i) throws IOException {
		try {
	/*		if (!((IPAdress) this).aBoolean5952)
				return new Socket(
						InetAddress.getByName(address),
						(((IPAdress) this).aBoolean5956 ? anInt5955 * 1407732809
								: anInt5954 * -346820395));
			return Class292.method2815(
					address,
	...
	public boolean method6057(IPAddress class471_0_, int i) {
		try {
			if (null == class471_0_)
				return false;
			return ((worldId * 1606920449 == class471_0_.worldId * 1606920449) && address
					.equals(class471_0_.address));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tk.b(").append(')').toString());
		}
	}
	...
	static final void method6059(Class403 class403, int i) {
		try { 
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(i_1_).anInt5721) * 785788887;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tk.aad(").append(')').toString());
		}
	}
		...
		try {
			try {
				...
				if (null != string) {
					if (throwable != null)
						string_2_ = new StringBuilder().append(string_2_)
								.append(" | ").toString();
					string_2_ = new StringBuilder().append(string_2_).append(
							string).toString();
				}
				...
				if (RuntimeException_Sub2.anApplet6306 != null) {
					...
					URL url = (new URL(
							RuntimeException_Sub2.anApplet6306.getCodeBase(),
							new StringBuilder()
