package com.jagex;/* Class451 - Decompiled by JODE
...
public class Class451 {
	...
	public Class443 method5932(int i, byte i_1_) {
		try {
			Class443 class443;
			synchronized (((Class451) this).aClass348_5640) {
				class443 = (Class443) ((Class451) this).aClass348_5640
						.method4184((long) i);
			}
			if (class443 != null)
				return class443;
			...
			synchronized (((Class451) this).aClass243_5639) {
				is = (((Class451) this).aClass243_5639.method2315(-1006924897
						* SignLink.aClass120_1428.anInt1460, i, (byte) -122));
			}
	...
	public Class451(Class411 class411, Class429 class429, Class243 class243) {
		...
		((Class451) this).aClass243_5639
				.filesCount(
						(-1006924897 * (SignLink.aClass120_1428.anInt1460)),
						-978414795);
	}
	...
	static final void method5933(Class403 class403, int i) {
		try {
			...
			if (class497.method6206(1883696427))
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class501.aClass395_6122
						.method4903(i_2_, (byte) -26).method4877(i_3_,
								class497.aString6101, -130818690);
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class501.aClass395_6122
						.method4903(i_2_, (byte) 51).method4881(i_3_,
						-388931549 * class497.anInt6100, 240769181));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sp.abq(").append(')').toString());
		}
	}
		...
		try {
			...
			if (null == class298_sub41)
				Class391.method4884(class365_sub1_sub1_sub2_sub2.plane,
						...
						(class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0]), 0,
						null, null, class365_sub1_sub1_sub2_sub2, (byte) 58);
			else
				class298_sub41.method3519(-1931224140);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sp.u(").append(')').toString());
		}
	}
}
