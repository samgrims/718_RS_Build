...
public class Class298_Sub32_Sub4 extends Class298_Sub32 {
	...
	int[][] method3161(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_7_ = 0; i_7_ < Class250.anInt2755 * -1474554145; i_7_++) {
				...
				((Class298_Sub32_Sub4) this).anInt9340 += ((Class298_Sub32_Sub4) this).anInt9335
						* -480504993;
				((Class298_Sub32_Sub4) this).anInt9339 += 1401525773 * ((Class298_Sub32_Sub4) this).anInt9336;
				((Class298_Sub32_Sub4) this).anInt9332 += -1298028627
						* ((Class298_Sub32_Sub4) this).anInt9337;
				...
				method3162(1081228573 * ((Class298_Sub32_Sub4) this).anInt9340,
						-736197367 * ((Class298_Sub32_Sub4) this).anInt9339,
						-469731721 * ((Class298_Sub32_Sub4) this).anInt9332,
						182018145);
				is_4_[i_7_] = -1916696729
						* ((Class298_Sub32_Sub4) this).anInt9341;
		...
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_16_ = 0; i_16_ < Class250.anInt2755 * -1474554145; i_16_++) {
					method3165(is_10_[i_16_], is_11_[i_16_], is_12_[i_16_],
							-128256883);
					((Class298_Sub32_Sub4) this).anInt9340 += ((Class298_Sub32_Sub4) this).anInt9335
							* -480504993;
					((Class298_Sub32_Sub4) this).anInt9339 += 1401525773 * ((Class298_Sub32_Sub4) this).anInt9336;
					...
					if (-469731721 * ((Class298_Sub32_Sub4) this).anInt9332 > 4096)
						((Class298_Sub32_Sub4) this).anInt9332 = 607416320;
					method3162(
							1081228573 * ((Class298_Sub32_Sub4) this).anInt9340,
							-736197367 * ((Class298_Sub32_Sub4) this).anInt9339,
							-469731721 * ((Class298_Sub32_Sub4) this).anInt9332,
							-1235292265);
					is_13_[i_16_] = -1916696729
							* ((Class298_Sub32_Sub4) this).anInt9341;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agg.k(").append(')').toString());
		}
	}

	void method3162(int i, int i_17_, int i_18_, int i_19_) {
		try {
			int i_20_ = (i_18_ <= 2048 ? i_18_ * (4096 + i_17_) >> 12 : i_18_
					+ i_17_ - (i_17_ * i_18_ >> 12));
			if (i_20_ > 0) {
				i *= 6;
				...
				switch (i_23_) {
				case 0:
					((Class298_Sub32_Sub4) this).anInt9341 = -1501846441
							* i_20_;
				...
				case 3:
					...
					break;
				case 1:
					((Class298_Sub32_Sub4) this).anInt9341 = i_27_
							* -1501846441;
					((Class298_Sub32_Sub4) this).anInt9342 = -721593745 * i_20_;
					((Class298_Sub32_Sub4) this).anInt9343 = i_21_ * 1447533195;
					break;
				case 4:
					((Class298_Sub32_Sub4) this).anInt9341 = i_26_
							* -1501846441;
					((Class298_Sub32_Sub4) this).anInt9342 = -721593745 * i_21_;
					((Class298_Sub32_Sub4) this).anInt9343 = i_20_ * 1447533195;
					break;
				case 2:
					((Class298_Sub32_Sub4) this).anInt9341 = i_21_
							* -1501846441;
					((Class298_Sub32_Sub4) this).anInt9342 = -721593745 * i_20_;
					((Class298_Sub32_Sub4) this).anInt9343 = i_26_ * 1447533195;
				}
			} else
				((Class298_Sub32_Sub4) this).anInt9341 = (((Class298_Sub32_Sub4) this).anInt9342 = (((Class298_Sub32_Sub4) this).anInt9343 = i_18_ * 1447533195)
						* -1366585299) * 1319430297;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agg.am(").append(')').toString());
		}
	}
	...
	void method3163(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub4) this).anInt9335 = class298_sub53
					.readShort(1756517638)
					* -479167509;
			break;
		case 2:
			((Class298_Sub32_Sub4) this).anInt9337 = ((class298_sub53
					.readByte(-12558881) << 12) / 100 * -91159229);
			break;
		case 1:
			((Class298_Sub32_Sub4) this).anInt9336 = ((class298_sub53
					.readByte(-12558881) << 12) / 100 * 634933469);
			break;
		}
	}
	...
	void method3165(int i, int i_28_, int i_29_, int i_30_) {
		try {
			...
			((Class298_Sub32_Sub4) this).anInt9332 = -745389241
					* ((i_31_ + i_32_) / 2);
			if (((Class298_Sub32_Sub4) this).anInt9332 * -469731721 > 0
					&& -469731721 * ((Class298_Sub32_Sub4) this).anInt9332 < 4096)
				((Class298_Sub32_Sub4) this).anInt9339 = (-1734174407 * ((i_33_ << 12) / ((((Class298_Sub32_Sub4) this).anInt9332 * -469731721) <= 2048 ? (((Class298_Sub32_Sub4) this).anInt9332 * -939463442)
						: 8192 - (((Class298_Sub32_Sub4) this).anInt9332 * -939463442))));
			else
				((Class298_Sub32_Sub4) this).anInt9339 = 0;
			if (i_33_ > 0) {
				...
				if (i == i_31_)
					((Class298_Sub32_Sub4) this).anInt9340 = -1453036235
							* (i_28_ == i_32_ ? i_36_ + 20480 : 4096 - i_35_);
				else if (i_28_ == i_31_)
					((Class298_Sub32_Sub4) this).anInt9340 = ((i_29_ == i_32_ ? i_34_ + 4096
							: 12288 - i_36_) * -1453036235);
				else
					((Class298_Sub32_Sub4) this).anInt9340 = -1453036235
							* (i_32_ == i ? i_35_ + 12288 : 20480 - i_34_);
	...
	int[][] method3166(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_44_ = 0; i_44_ < Class250.anInt2755 * -1474554145; i_44_++) {
				method3165(is_38_[i_44_], is_39_[i_44_], is_40_[i_44_],
						-128256883);
				((Class298_Sub32_Sub4) this).anInt9340 += ((Class298_Sub32_Sub4) this).anInt9335
						* -480504993;
				((Class298_Sub32_Sub4) this).anInt9339 += 1401525773 * ((Class298_Sub32_Sub4) this).anInt9336;
