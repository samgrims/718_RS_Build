...
public class Class4 {
	int[] anIntArray69;
	static int anInt70 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\u00a3$%^&*()-_=+[{]};:'@#~,<.>/?\\| \u00c4\u00cb\u00cf\u00d6\u00dc\u00e4\u00eb\u00ef\u00f6\u00fc\u00ff\u00df\u00c1\u00c0\u00c9\u00c8\u00cd\u00cc\u00d3\u00d2\u00da\u00d9\u00e1\u00e0\u00e9\u00e8\u00ed\u00ec\u00f3\u00f2\u00fa\u00f9\u00c2\u00ca\u00ce\u00d4\u00db\u00e2\u00ea\u00ee\u00f4\u00fb\u00c6\u00e6\u00e3\u00c3\u00f5\u00d5\u00e7\u00c7"
			.length();
	...
	void method304(GraphicsToolkit class_ra, String string, int[] is, int i, int i_0_,
		...
		for (int i_2_ = 0; i_2_ < string.length(); i_2_++) {
			...
			if (bool)
				((Class4) this).aClass57Array73[i_3_].method631(i + 1,
						i_0_ + 1, 0, -16777216, 1);
			((Class4) this).aClass57Array73[i_3_]
					.method631(i, i_0_, 0, i_1_, 1);
			i += ((Class4) this).anIntArray69[i_3_];
		}
	}

	void method305(GraphicsToolkit class_ra, Font font, FontMetrics fontmetrics,
		...
		graphics.drawString(
				new StringBuilder().append(c).append("").toString(), 0, i_6_);
		if (bool)
			graphics.drawString(new StringBuilder().append(c).append("")
					.toString(), 1, i_6_);
		int[] is = new int[i_4_ * i_7_];
		PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, i_4_, i_7_,
				is, 0, i_4_);
		try {
		...
		((Class4) this).aClass57Array73[i] = class_ra.method5031(is, 0, i_4_,
				i_4_, i_7_, -939201391);
	}
			...
			if (!((Class4) this).aBoolean72) {
				...
				for (int i_18_ = 0; i_18_ < anInt70; i_18_++)
					method305(
							...
							fontmetrics,
							"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\u00a3$%^&*()-_=+[{]};:'@#~,<.>/?\\| \u00c4\u00cb\u00cf\u00d6\u00dc\u00e4\u00eb\u00ef\u00f6\u00fc\u00ff\u00df\u00c1\u00c0\u00c9\u00c8\u00cd\u00cc\u00d3\u00d2\u00da\u00d9\u00e1\u00e0\u00e9\u00e8\u00ed\u00ec\u00f3\u00f2\u00fa\u00f9\u00c2\u00ca\u00ce\u00d4\u00db\u00e2\u00ea\u00ee\u00f4\u00fb\u00c6\u00e6\u00e3\u00c3\u00f5\u00d5\u00e7\u00c7"
									.charAt(i_18_), i_18_, true);
			}
		}
	}

	void method308(GraphicsToolkit class_ra, String string, int i, int i_19_,
			int i_20_, boolean bool) {
		int i_21_ = method307(string) / 2;
		class_ra.qa(((Class4) this).anIntArray77);
		if (i - i_21_ <= ((Class4) this).anIntArray77[2]
				&& i + i_21_ >= ((Class4) this).anIntArray77[0]
				&& (i_19_ - ((Class4) this).anInt76 <= ((Class4) this).anIntArray77[3])
				&& (i_19_ + ((Class4) this).anInt74 >= ((Class4) this).anIntArray77[1]))
			method304(class_ra, string, ((Class4) this).anIntArray77,
					i - i_21_, i_19_, i_20_, bool);
	}
