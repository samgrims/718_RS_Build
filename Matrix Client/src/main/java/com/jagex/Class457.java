...
public class Class457 {
	...
	public void method5960() {
		try {
			if (((Class457) this).aDisplayMode5667 != null) {
				((Class457) this).aGraphicsDevice5666
						.setDisplayMode(((Class457) this).aDisplayMode5667);
				if (!((Class457) this).aGraphicsDevice5666.getDisplayMode()
						.equals(((Class457) this).aDisplayMode5667))
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sv.exit(").append(')').toString());
		}
	}

	public int[] method5961() {
		try {
			DisplayMode[] displaymodes = ((Class457) this).aGraphicsDevice5666
					.getDisplayModes();
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sv.listmodes(").append(')').toString());
		}
	}

	public void method5962(Frame frame, int i, int i_0_, int i_1_, int i_2_) {
		try {
			((Class457) this).aDisplayMode5667 = ((Class457) this).aGraphicsDevice5666
					.getDisplayMode();
			...
			if (0 == i_2_) {
				...
				for (int i_4_ = 0; i_4_ < displaymodes.length; i_4_++) {
					if (displaymodes[i_4_].getWidth() == i
							&& displaymodes[i_4_].getHeight() == i_0_
							&& displaymodes[i_4_].getBitDepth() == i_1_) {
						int i_5_ = displaymodes[i_4_].getRefreshRate();
						if (!bool
								|| Math.abs(i_5_ - i_3_) < Math
										.abs(i_2_ - i_3_)) {
							i_2_ = i_5_;
							bool = true;
						}
			...
			((Class457) this).aGraphicsDevice5666
					.setDisplayMode(new DisplayMode(i, i_0_, i_1_, i_2_));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sv.enter(").append(')').toString());
		}
	}
	...
	public Class457() throws Exception {
		...
		((Class457) this).aGraphicsDevice5666 = graphicsenvironment
