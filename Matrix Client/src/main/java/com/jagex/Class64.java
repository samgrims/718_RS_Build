package com.jagex;/* Class64 - Decompiled by JODE
...
public class Class64 {
	...
	public Class64(int i, int i_0_, int i_1_) {
		anInt614 = 0;
		anInt626 = 0;
		anInt621 = 0;
		aByte632 = (byte) 0;
	...
	public Class64(Class64[] class64s, int i) {
		anInt614 = 0;
		anInt626 = 0;
		anInt621 = 0;
		aByte632 = (byte) 0;
		...
		for (int i_10_ = 0; i_10_ < i; i_10_++) {
			Class64 class64_11_ = class64s[i_10_];
			if (class64_11_ != null) {
		...
		for (int i_12_ = 0; i_12_ < i; i_12_++) {
			...
			Class64 class64_14_ = class64s[i_12_];
			if (class64_14_ != null) {
				if (class64_14_.aClass84Array649 != null) {
					for (int i_15_ = 0; i_15_ < class64_14_.aClass84Array649.length; i_15_++) {
						...
						aClass84Array649[i_4_++] = class84.method945(
								(class84.anInt767 * 1512514121 + anInt621),
								214949543);
					}
				}
				for (int i_16_ = 0; i_16_ < class64_14_.anInt621; i_16_++) {
					...
					aShortArray644[anInt621] = (short) method743(class64_14_,
							class64_14_.aShortArray644[i_16_], i_13_);
					aShortArray646[anInt621] = (short) method743(class64_14_,
							class64_14_.aShortArray646[i_16_], i_13_);
					aShortArray624[anInt621] = (short) method743(class64_14_,
							class64_14_.aShortArray624[i_16_], i_13_);
				...
				if (class64_14_.aClass85Array647 != null) {
					for (int i_17_ = 0; i_17_ < class64_14_.aClass85Array647.length; i_17_++) {
						int i_18_ = method743(class64_14_,
								(class64_14_.aClass85Array647[i_17_].anInt773)
										* -710317103, i_13_);
						int i_19_ = method743(
								class64_14_,
								(class64_14_.aClass85Array647[i_17_].anInt774) * 1705862021,
								i_13_);
						int i_20_ = method743(
								class64_14_,
								(class64_14_.aClass85Array647[i_17_].anInt775) * 1636170731,
								i_13_);
						aClass85Array647[i_2_] = class64_14_.aClass85Array647[i_17_]
								.method954(i_18_, i_19_, i_20_, -1991744488);
						i_2_++;
					}
				}
				if (class64_14_.aClass68Array613 != null) {
					for (int i_21_ = 0; i_21_ < class64_14_.aClass68Array613.length; i_21_++) {
						int i_22_ = method743(class64_14_,
								(class64_14_.aClass68Array613[i_21_].anInt674)
										* -180596249, i_13_);
						aClass68Array613[i_3_] = class64_14_.aClass68Array613[i_21_]
								.method776(i_22_, (byte) 0);
						i_3_++;
					}
				}
			}
		...
		for (int i_24_ = 0; i_24_ < i; i_24_++) {
			...
			Class64 class64_26_ = class64s[i_24_];
			if (class64_26_ != null) {
				for (int i_27_ = 0; i_27_ < class64_26_.anInt621; i_27_++) {
					if (bool_7_)
						aByteArray635[i_23_++] = (byte) ((class64_26_.aByteArray635 != null && (class64_26_.aByteArray635[i_27_] != -1)) ? (class64_26_.aByteArray635[i_27_] + anInt634)
								: -1);
				}
				for (int i_28_ = 0; i_28_ < class64_26_.anInt634; i_28_++) {
					byte i_29_ = (aByteArray622[anInt634] = class64_26_.aByteArray622[i_28_]);
					if (i_29_ == 0) {
						aShortArray623[anInt634] = (short) method743(
								class64_26_,
								(class64_26_.aShortArray623[i_28_]), i_25_);
						aShortArray636[anInt634] = (short) method743(
								class64_26_,
								(class64_26_.aShortArray636[i_28_]), i_25_);
						aShortArray638[anInt634] = (short) method743(
								class64_26_,
								(class64_26_.aShortArray638[i_28_]), i_25_);
					}
					if (i_29_ >= 1 && i_29_ <= 3) {
	...
	final int method743(Class64 class64_30_, int i, short i_31_) {
		...
		for (int i_35_ = 0; i_35_ < anInt614; i_35_++) {
			if (i_32_ == anIntArray616[i_35_] && i_33_ == anIntArray642[i_35_]
					&& i_34_ == anIntArray618[i_35_]) {
		...
		anIntArray619[anInt614] = (class64_30_.anIntArray619 != null ? class64_30_.anIntArray619[i]
				: -1);
		return anInt614++;
	}

	void method744(RsByteBuffer class298_sub53,
			RsByteBuffer class298_sub53_36_) {
		short i = 0;
		short i_37_ = 0;
		short i_38_ = 0;
		int i_39_ = 0;
	...
	void method745(RsByteBuffer class298_sub53,
			RsByteBuffer class298_sub53_43_,
			RsByteBuffer class298_sub53_44_,
			RsByteBuffer class298_sub53_45_,
			RsByteBuffer class298_sub53_46_, RsByteBuffer class298_sub53_47_) {
		for (int i = 0; i < anInt634; i++) {
			int i_48_ = aByteArray622[i] & 0xff;
			if (i_48_ == 0) {
				aShortArray623[i] = (short) class298_sub53
						.readUnsignedShort();
				aShortArray636[i] = (short) class298_sub53
						.readUnsignedShort();
				aShortArray638[i] = (short) class298_sub53
						.readUnsignedShort();
			}
			if (i_48_ == 1) {
				aShortArray623[i] = (short) class298_sub53_43_
						.readUnsignedShort();
				aShortArray636[i] = (short) class298_sub53_43_
						.readUnsignedShort();
				aShortArray638[i] = (short) class298_sub53_43_
						.readUnsignedShort();
				if (anInt630 < 15) {
					anIntArray639[i] = class298_sub53_44_
							.readUnsignedShort();
					if (anInt630 < 14)
						anIntArray640[i] = class298_sub53_44_
								.readUnsignedShort();
					else
						anIntArray640[i] = class298_sub53_44_
								.read24BitUnsignedInteger((byte) -55);
					anIntArray641[i] = class298_sub53_44_
							.readUnsignedShort();
				} else {
			...
			if (i_48_ == 2) {
				...
				if (anInt630 < 15) {
					...
					if (anInt630 < 14)
						...
						anIntArray640[i] = class298_sub53_44_
								.read24BitUnsignedInteger((byte) -37);
					anIntArray641[i] = class298_sub53_44_
							.readUnsignedShort();
				} else {
					anIntArray639[i] = class298_sub53_44_
							.read24BitUnsignedInteger((byte) -91);
			...
			if (i_48_ == 3) {
				...
				if (anInt630 < 15) {
					...
					if (anInt630 < 14)
						...
						anIntArray640[i] = class298_sub53_44_
								.read24BitUnsignedInteger((byte) 6);
					anIntArray641[i] = class298_sub53_44_
							.readUnsignedShort();
				} else {
					anIntArray639[i] = class298_sub53_44_
							.read24BitUnsignedInteger((byte) -35);
					anIntArray640[i] = class298_sub53_44_
							.read24BitUnsignedInteger((byte) -11);
					anIntArray641[i] = class298_sub53_44_
							.read24BitUnsignedInteger((byte) -24);
				}
				aByteArray645[i] = class298_sub53_45_.readByte(-12558881);
				aByteArray628[i] = class298_sub53_46_.readByte(-12558881);
				anIntArray637[i] = class298_sub53_47_.readByte(-12558881);
	...
	void method746(byte[] is) {
		...
		for (int i_79_ = 0; i_79_ < anInt614; i_79_++) {
			...
			if (i_57_ == 1)
				anIntArray619[i_79_] = class298_sub53_53_
						.readUnsignedByte();
		}
		...
		for (int i_84_ = 0; i_84_ < anInt621; i_84_++) {
			aShortArray629[i_84_] = (short) class298_sub53
					.readUnsignedShort();
			if (i == 1) {
		...
		for (int i_93_ = 0; i_93_ < anInt634; i_93_++) {
			...
			aShortArray623[i_93_] = (short) class298_sub53
					.readUnsignedShort();
			aShortArray636[i_93_] = (short) class298_sub53
					.readUnsignedShort();
			aShortArray638[i_93_] = (short) class298_sub53
					.readUnsignedShort();
		}
		if (aByteArray635 != null) {
			...
			for (int i_95_ = 0; i_95_ < anInt621; i_95_++) {
				...
				if (i_96_ != 255) {
					if (((aShortArray623[i_96_] & 0xffff) == aShortArray644[i_95_])
							&& ((aShortArray636[i_96_] & 0xffff) == aShortArray646[i_95_])
							&& ((aShortArray638[i_96_] & 0xffff) == aShortArray624[i_95_]))
	...
	public int method747(int i, int i_97_, int i_98_) {
		for (int i_99_ = 0; i_99_ < anInt614; i_99_++) {
			if (anIntArray616[i_99_] == i && anIntArray642[i_99_] == i_97_
					&& anIntArray618[i_99_] == i_98_)
				return i_99_;
		}
	...
	public int method748(int i, int i_100_, int i_101_, byte i_102_,
			byte i_103_, short i_104_, byte i_105_, short i_106_) {
	...
	public static Class64 method751(Class243 class243, int i, int i_120_) {
		byte[] is = class243.method2315(i, i_120_, (byte) -97);
		if (is == null)
			return null;
		return new Class64(is);
	}
	...
	public void method754(int i, int i_126_, int i_127_) {
		if (i_127_ != 0) {
			...
			for (int i_130_ = 0; i_130_ < anInt614; i_130_++) {
				int i_131_ = ((anIntArray642[i_130_] * i_128_ + anIntArray616[i_130_]
						* i_129_) >> 14);
				anIntArray642[i_130_] = (anIntArray642[i_130_] * i_129_ - anIntArray616[i_130_]
						* i_128_) >> 14;
		...
		if (i != 0) {
			...
			for (int i_134_ = 0; i_134_ < anInt614; i_134_++) {
				int i_135_ = ((anIntArray642[i_134_] * i_133_ - anIntArray618[i_134_]
						* i_132_) >> 14);
				anIntArray618[i_134_] = (anIntArray642[i_134_] * i_132_ + anIntArray618[i_134_]
						* i_133_) >> 14;
		...
		if (i_126_ != 0) {
			...
			for (int i_138_ = 0; i_138_ < anInt614; i_138_++) {
				int i_139_ = ((anIntArray618[i_138_] * i_136_ + anIntArray616[i_138_]
						* i_137_) >> 14);
				anIntArray618[i_138_] = (anIntArray618[i_138_] * i_137_ - anIntArray616[i_138_]
						* i_136_) >> 14;
	...
	public byte method757(short i, short i_144_, short i_145_, short i_146_,
			short i_147_, short i_148_, byte i_149_, byte i_150_, byte i_151_) {
		if (anInt634 >= 255)
	...
	void method758(byte[] is) {
		...
		if (anInt634 > 0) {
			...
			for (int i_174_ = 0; i_174_ < anInt634; i_174_++) {
				byte i_175_ = (aByteArray622[i_174_] = class298_sub53
						.readByte(-12558881));
				if (i_175_ == 0)
					i_171_++;
		...
		for (int i_202_ = 0; i_202_ < anInt614; i_202_++) {
			...
			if (i_165_ == 1)
				anIntArray619[i_202_] = class298_sub53_155_
						.readUnsignedByte();
		}
		...
		for (int i_207_ = 0; i_207_ < anInt621; i_207_++) {
			aShortArray629[i_207_] = (short) class298_sub53
					.readUnsignedShort();
			if (bool)
				aByteArray625[i_207_] = class298_sub53_152_
						.readByte(-12558881);
			if (i_161_ == 255)
				aByteArray633[i_207_] = class298_sub53_153_
						.readByte(-12558881);
			if (i_162_ == 1)
				aByteArray627[i_207_] = class298_sub53_154_
						.readByte(-12558881);
			if (i_163_ == 1)
				anIntArray631[i_207_] = class298_sub53_155_
						.readUnsignedByte();
			if (i_164_ == 1)
				aShortArray617[i_207_] = (short) (class298_sub53_156_
						.readUnsignedShort() - 1);
			if (aByteArray635 != null) {
				if (aShortArray617[i_207_] != -1)
					aByteArray635[i_207_] = (byte) (class298_sub53_157_
							.readUnsignedByte() - 1);
				else
		...
		method745(class298_sub53, class298_sub53_152_, class298_sub53_153_,
				class298_sub53_154_, class298_sub53_155_, class298_sub53_156_);
			...
			if (i_208_ > 0) {
				...
				for (int i_209_ = 0; i_209_ < i_208_; i_209_++) {
					...
					if (i_161_ == 255)
						...
						i_212_ = (byte) i_161_;
					aClass85Array647[i_209_] = new Class85(i_210_,
							aShortArray644[i_211_], aShortArray646[i_211_],
							aShortArray624[i_211_], i_212_);
				}
			}
		...
		if (bool_159_) {
			...
			if (i_217_ > 0) {
				...
				for (int i_218_ = 0; i_218_ < i_217_; i_218_++) {
					...
					aClass84Array649[i_218_] = new Class84(i_219_, i_220_,
							i_221_, i_222_);
				}
			}
		}
