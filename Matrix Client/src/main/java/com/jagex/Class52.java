	...
	static final void method554(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = Class248.decryptStringMessage(string, 757970283);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cb.zc(").append(')').toString());
		}
	}
