package com.jagex;/* Class21 - Decompiled by JODE
...
public class Class21 {
	...
	public static void method364(Class243 class243, int i, int i_0_, int i_1_,
			boolean bool, Class298_Sub19_Sub1 class298_sub19_sub1, int i_2_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("av.b(").append(')').toString());
		}
	}

	static final void method365(IComponentDefinition class105, Class119 class119,
			boolean bool, int i, Class403 class403, int i_3_) {
		try {
	...
	static final void method367(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (GraphicsToolkit.aClass256_5315
					.method2441(i_7_, -1634888229).aCharArray9595[i_8_]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("av.acy(").append(')').toString());
		}
	}
