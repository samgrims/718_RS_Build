...
public final class Class315 {
		...
		try {
			...
			if (SubIncommingPacket.aClass206_2347 == class206) {
				...
				if (client.aClass283_8716.method2674(-586078948) != Class266.aClass266_2846)
					Tradution.method6055(Class375.basePlane * -191892109, i_13_,
							i_14_, i_11_, i_9_, i_10_, i_7_, -1921538188);
				...
				if (1 == (i_22_ & 0x1))
					Class370.method4579(-191892109 * Class375.basePlane, i_19_,
							i_20_, i_17_, i_21_, i_16_, null, (byte) -43);
				else {
					int[] is = null;
					if ((i_22_ & 0x2) == 2) {
						is = new int[i_23_];
						for (int i_28_ = 0; i_28_ < i_23_; i_28_++)
							is[i_28_] = class298_sub53_sub2
									.readInt((byte) -37);
					}
					short[] is_29_ = null;
					if (4 == (i_22_ & 0x4)) {
						...
						for (int i_30_ = 0; i_30_ < i_26_; i_30_++)
							is_29_[i_30_] = (short) class298_sub53_sub2
									.readUnsignedShort();
					}
					short[] is_31_ = null;
					if (8 == (i_22_ & 0x8)) {
						...
						for (int i_32_ = 0; i_32_ < i_27_; i_32_++)
							is_31_[i_32_] = (short) class298_sub53_sub2
									.readUnsignedShort();
					}
					Class370
							.method4579(
									-191892109 * Class375.basePlane,
									i_19_,
									i_20_,
									i_17_,
									i_21_,
									i_16_,
									new Class435(
											(Class298_Sub1.aLong7163 * -5796734886992507517L),
											is, is_29_, is_31_), (byte) 8);
				...
				if (client.aClass283_8716.method2674(99999280).method2522(
						(byte) -3)
						|| (i_38_ >= 0
								&& i_39_ >= 0
								&& (i_38_ < client.aClass283_8716
										.method2629(-1871735876)) && (i_39_ < client.aClass283_8716
								.method2630(-164212893))))
					Class420.method5606(-191892109 * Class375.basePlane, i_38_,
							i_39_, i_36_, -1, i_34_, i_35_, 322889547);
				...
				if (client.aClass283_8716.method2674(-135283377) != Class266.aClass266_2846) {
					if (i_41_ >= 0
							&& i_42_ >= 0
							&& (i_41_ < client.aClass283_8716
									.method2629(-2115187525))
							&& i_42_ < client.aClass283_8716
									.method2630(1222512663)
							&& i_43_ >= 0
							&& i_44_ >= 0
							&& (i_43_ < client.aClass283_8716
									.method2629(-2121627992))
							&& (i_44_ < client.aClass283_8716
									.method2630(-2081531222)) && i_46_ != 65535) {
						i_41_ = 256 + 512 * i_41_;
						i_42_ = 256 + 512 * i_42_;
						i_43_ = 256 + i_43_ * 512;
						i_44_ = i_44_ * 512 + 256;
						...
						Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(
								...
								i_46_, -191892109 * Class375.basePlane,
								Class375.basePlane * -191892109, i_41_, i_42_,
								i_47_, i_49_ + client.anInt8884 * 443738891,
								client.anInt8884 * 443738891 + i_50_, i_51_,
								i_52_, 0, i_45_, i_48_, bool, -1));
						class365_sub1_sub1_sub1.method4405(i_43_, i_44_,
								Class356.method4271(i_43_, i_44_,
										(-191892109 * Class375.basePlane),
										-1671970391)
										- i_48_, 443738891 * client.anInt8884
										+ i_49_, -53743739);
						client.aClass453_8824
								.method5935(new Class298_Sub37_Sub2(
										class365_sub1_sub1_sub1), 719403792);
					}
				}
				...
				boolean bool = (i_56_ >= 0
						&& i_54_ >= 0
						&& i_56_ < client.aClass283_8716
								.method2629(-2010293889) && (i_54_ < client.aClass283_8716
						.method2630(-747226515)));
				if (bool
						|| client.aClass283_8716.method2674(131556130)
								.method2522((byte) -65)) {
					Class411
							.method5576(Class375.basePlane * -191892109, i_57_,
									i_55_, new Class298_Sub12(i_59_, i_58_),
									-369193084);
					if (bool)
						Class173.method1820(-191892109 * Class375.basePlane,
								i_56_, i_54_, 1649431547);
				}
				...
				if (null != client.aClass437_8685) {
					Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685
							.method5812((long) (-191892109 * Class375.basePlane << 28
									| i_64_ << 14 | i_66_))));
					if (class298_sub2 != null) {
						for (Class298_Sub12 class298_sub12 = ((Class298_Sub12) class298_sub2.aClass453_7166
								.method5939(1766612795)); null != class298_sub12; class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166
								.method5944(49146)) {
							if ((class298_sub12.anInt7257 * 1768239597 == (i_67_ & 0x7fff))
									&& (567630807 * ((Class298_Sub12) class298_sub12).anInt7256 == i_68_)) {
								class298_sub12.method2839(-1460969981);
								((Class298_Sub12) class298_sub12).anInt7256 = i_69_
										* -1076181017;
								Class411.method5576(
										(Class375.basePlane * -191892109),
										i_66_, i_64_, class298_sub12,
										-2035381169);
								break;
							}
						}
						if (i_65_ >= 0
								&& i_63_ >= 0
								&& i_65_ < client.aClass283_8716
										.method2629(-2131588637)
								&& i_63_ < client.aClass283_8716
										.method2630(-523876912))
							Class173.method1820(
									(-191892109 * Class375.basePlane), i_65_,
									i_63_, 1760601086);
					}
				}
				...
				if (client.aClass283_8716.method2674(1533260419) != Class266.aClass266_2846)
					Class300.method3687(-191892109 * Class375.basePlane, i_71_,
							i_72_, i_74_, i_73_, i_75_, string, 1332190940);
				...
				if (client.aClass283_8716.method2674(39788259).method2522(
						(byte) 29)
						|| (i_77_ >= 0
								&& i_78_ >= 0
								&& (i_77_ < client.aClass283_8716
										.method2629(-2063854515)) && (i_78_ < client.aClass283_8716
								.method2630(-1828303048))))
					Class420.method5606(-191892109 * Class375.basePlane, i_77_,
							i_78_, i_82_, i_83_, i_80_, i_81_, 2010363527);
				...
				if (i_84_ != -442628795 * client.playerIndex) {
					boolean bool = (i_90_ >= 0
							&& i_88_ >= 0
							&& i_90_ < client.aClass283_8716
									.method2629(-2004210913) && i_88_ < client.aClass283_8716
							.method2630(133385720));
					if (bool
							|| client.aClass283_8716.method2674(1297675002)
									.method2522((byte) -41)) {
						Class411.method5576(-191892109 * Class375.basePlane,
								i_91_, i_89_, new Class298_Sub12(i_85_, i_86_),
								1214818737);
						if (bool)
							Class173.method1820(
									(Class375.basePlane * -191892109), i_90_,
									i_88_, 1328737922);
					}
				}
				...
				if (client.aClass283_8716.method2674(781301439) != Class266.aClass266_2846) {
					if (i_93_ >= 0
							&& i_94_ >= 0
							&& i_93_ < client.aClass283_8716
									.method2629(-2097499815) * 2
							&& i_94_ < client.aClass283_8716
									.method2629(-1925634796) * 2
							&& i_98_ >= 0
							&& i_99_ >= 0
							&& i_98_ < client.aClass283_8716
									.method2630(-2066893296) * 2
							&& (i_99_ < client.aClass283_8716
									.method2630(1895360083) * 2)
							&& 65535 != i_102_) {
						i_93_ *= 256;
						i_94_ = 256 * i_94_;
						i_98_ = 256 * i_98_;
						...
						i_108_ <<= 2;
						Class437
								.method5818(i_102_, i_100_, i_101_, i_97_,
										i_103_, i_104_, i_93_, i_94_, i_98_,
										i_99_, i_105_, i_106_, i_107_, i_108_,
										bool, 618819500);
					}
				}
			} else if (SubIncommingPacket.aClass206_2353 == class206) {
				int i_109_ = class298_sub53_sub2.readUnsignedByte();
				int i_110_ = ClanSettings.baseTileX * 134435705
						+ (i_109_ >> 4 & 0x7);
				...
				if (client.aClass283_8716.method2674(569302746) != Class266.aClass266_2846) {
					if (i_110_ >= 0
							&& i_111_ >= 0
							&& (i_110_ < client.aClass283_8716
									.method2629(-2099610751))
							&& (i_111_ < client.aClass283_8716
									.method2630(-358830712))) {
						int i_119_ = 1 + i_114_;
						if ((Class287.myPlayer.scenePositionXQueue[0]) >= i_110_
								- i_119_
								&& (Class287.myPlayer.scenePositionXQueue[0]) <= i_119_
										+ i_110_
								&& (Class287.myPlayer.scenePositionYQueue[0]) >= i_111_
										- i_119_
								&& (Class287.myPlayer.scenePositionYQueue[0]) <= i_119_
										+ i_111_)
							Class69
									.method789(
											i_112_,
											...
											i_116_,
											i_117_,
											((-191892109 * Class375.basePlane << 24)
													+ (i_110_ << 16)
													+ (i_111_ << 8) + i_114_),
											i_118_, -1062229425);
					}
				...
				int i_121_ = 134435705 * ClanSettings.baseTileX
						+ (i_120_ >> 4 & 0x7);
				...
				if (client.aClass283_8716.method2674(1544127575) != Class266.aClass266_2846) {
					if (i_121_ >= 0
							&& i_122_ >= 0
							&& (i_121_ < client.aClass283_8716
									.method2629(-2060803867))
							&& (i_122_ < client.aClass283_8716
									.method2630(210266167))) {
						if (-1 == i_123_) {
							Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (client.aClass437_8825
									.method5812((long) (i_121_ << 16 | i_122_))));
							...
							if (i_129_ < 3
									&& client.aClass283_8716.method2654(
											1627070231).method2320(i_121_,
											i_122_, 575492228))
								i_129_++;
							Class365_Sub1_Sub1_Sub3 class365_sub1_sub1_sub3 = (new Class365_Sub1_Sub1_Sub3(
									client.aClass283_8716
											.method2675(-1611682495), i_123_,
									i_125_, -191892109 * Class375.basePlane,
									i_129_, i_127_, Class356.method4271(i_127_,
											i_128_,
											(Class375.basePlane * -191892109),
											-1861382449)
											- i_124_, i_128_, i_121_, i_121_,
									i_122_, i_122_, i_126_, false));
							client.aClass437_8825.method5817(
									(new Class298_Sub37_Sub3(
											class365_sub1_sub1_sub3)),
									(long) (i_121_ << 16 | i_122_));
						}
					}
				}
			} else if (SubIncommingPacket.aClass206_2342 == class206) {
				int i_130_ = class298_sub53_sub2.readUnsignedByte();
				int i_131_ = (i_130_ >> 4 & 0x7) + 134435705
						* ClanSettings.baseTileX;
				...
				if (client.aClass283_8716.method2674(39884684) != Class266.aClass266_2846) {
					if (i_131_ >= 0
							&& i_132_ >= 0
							&& (i_131_ < client.aClass283_8716
									.method2629(-2049168352))
							&& (i_132_ < client.aClass283_8716
									.method2630(91496889))) {
						int i_140_ = i_135_ + 1;
						if ((Class287.myPlayer.scenePositionXQueue[0]) >= i_131_
								- i_140_
								&& (Class287.myPlayer.scenePositionXQueue[0]) <= i_140_
										+ i_131_
								&& (Class287.myPlayer.scenePositionYQueue[0]) >= i_132_
										- i_140_
								&& (Class287.myPlayer.scenePositionYQueue[0]) <= i_140_
										+ i_132_)
							Class336_Sub4
									.method4103(
											i_133_,
				...
				int i_145_ = 134435705 * ClanSettings.baseTileX
						+ (i_142_ >> 4 & 0x7);
				int i_146_ = i_145_ + -1760580017 * class341.gameSceneBaseX;
				Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685
						.method5812((long) (Class375.basePlane * -191892109 << 28
								| i_144_ << 14 | i_146_))));
				if (class298_sub2 != null) {
					for (Class298_Sub12 class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166
					...
					if (i_145_ >= 0
							&& i_143_ >= 0
							&& (i_145_ < client.aClass283_8716
									.method2629(-1929078790))
							&& (i_143_ < client.aClass283_8716
									.method2630(-999181271)))
						Class173.method1820(Class375.basePlane * -191892109,
								i_145_, i_143_, 547814341);
				}
			} else {
				IPAddress.method6062(new StringBuilder().append("").append(
						class206).toString(), new RuntimeException(),
						(short) -20731);
	...
	static void method3835(int i, int i_147_, int i_148_, int i_149_,
			int i_150_, byte i_151_) {
		try {
			if (i_148_ <= Class372_Sub3.anInt4050 * -1062447355
					&& i_149_ >= 1155384281 * Class372_Sub3.anInt4049) {
				boolean bool;
				...
				if (i_148_ >= Class372_Sub3.anInt4049 * 1155384281)
					Class82_Sub22.method940(
							(Class372_Sub3.anIntArrayArray4047[i_148_++]), i,
							i_147_, i_150_, -1668539966);
				else
					i_148_ = Class372_Sub3.anInt4049 * 1155384281;
				if (i_149_ <= -1062447355 * Class372_Sub3.anInt4050)
					Class82_Sub22.method940(
							(Class372_Sub3.anIntArrayArray4047[i_149_--]), i,
							i_147_, i_150_, 172166528);
				else
	...
	static final void method3836(int i, int i_156_, int i_157_, int i_158_,
			int i_159_, int i_160_, byte i_161_) {
		try {
			...
			int i_168_ = -1;
			int i_169_ = -1;
			if (i_156_ >= Class372_Sub1.anInt4049 * 1155384281
					&& i_156_ <= Class372_Sub1.anInt4050 * -1062447355) {
				int[] is = Class372_Sub1.anIntArrayArray4047[i_156_];
				int i_170_ = Class463.method6012(i - i_157_,
						(-1424479739 * Class372_Sub1.anInt4051),
						1135094847 * Class372_Sub1.anInt4048, -1212608691);
				int i_171_ = Class463.method6012(i + i_157_,
						(Class372_Sub1.anInt4051 * -1424479739),
						1135094847 * Class372_Sub1.anInt4048, -1212608691);
				int i_172_ = Class463.method6012(i - i_163_,
						(-1424479739 * Class372_Sub1.anInt4051),
						Class372_Sub1.anInt4048 * 1135094847, -1212608691);
				int i_173_ = Class463.method6012(i + i_163_,
						(Class372_Sub1.anInt4051 * -1424479739),
						1135094847 * Class372_Sub1.anInt4048, -1212608691);
				Class82_Sub22.method940(is, i_170_, i_172_, i_159_, 1255708006);
				Class82_Sub22
						.method940(is, i_172_, i_173_, i_158_, -1330979432);
			...
			while (i_164_ > i_162_) {
				...
				if (i_165_ >= 0) {
					...
					if (i_175_ >= Class372_Sub1.anInt4049 * 1155384281
							&& i_174_ <= -1062447355 * Class372_Sub1.anInt4050) {
						if (i_164_ >= i_163_) {
							int i_176_ = (Class463.method6012(i_162_ + i,
									Class372_Sub1.anInt4051 * -1424479739,
									1135094847 * Class372_Sub1.anInt4048,
									-1212608691));
							int i_177_ = (Class463.method6012(i - i_162_,
									Class372_Sub1.anInt4051 * -1424479739,
									1135094847 * Class372_Sub1.anInt4048,
									-1212608691));
							if (i_175_ <= -1062447355 * Class372_Sub1.anInt4050)
								Class82_Sub22
										.method940(
												(Class372_Sub1.anIntArrayArray4047[i_175_]),
												i_177_, i_176_, i_159_,
												-587973246);
							if (i_174_ >= 1155384281 * Class372_Sub1.anInt4049)
								Class82_Sub22
										.method940(
												(Class372_Sub1.anIntArrayArray4047[i_174_]),
												i_177_, i_176_, i_159_,
												458640866);
						} else {
							int i_178_ = Class372_Sub1.anIntArray7727[i_164_];
							int i_179_ = (Class463.method6012(i_162_ + i,
									Class372_Sub1.anInt4051 * -1424479739,
									1135094847 * Class372_Sub1.anInt4048,
									-1212608691));
							int i_180_ = Class463.method6012(i - i_162_,
									(Class372_Sub1.anInt4051 * -1424479739),
									(Class372_Sub1.anInt4048 * 1135094847),
									-1212608691);
							int i_181_ = Class463.method6012(i_178_ + i,
									(Class372_Sub1.anInt4051 * -1424479739),
									(Class372_Sub1.anInt4048 * 1135094847),
									-1212608691);
							int i_182_ = (Class463.method6012(i - i_178_,
									-1424479739 * Class372_Sub1.anInt4051,
									1135094847 * Class372_Sub1.anInt4048,
									-1212608691));
							if (i_175_ <= Class372_Sub1.anInt4050 * -1062447355) {
								int[] is = (Class372_Sub1.anIntArrayArray4047[i_175_]);
								Class82_Sub22.method940(is, i_180_, i_182_,
										i_159_, -328560892);
								Class82_Sub22.method940(is, i_182_, i_181_,
										i_158_, 859736172);
								Class82_Sub22.method940(is, i_181_, i_179_,
										i_159_, -1686922326);
							}
							if (i_174_ >= 1155384281 * Class372_Sub1.anInt4049) {
				...
				if (i_184_ >= Class372_Sub1.anInt4049 * 1155384281
						&& i_183_ <= -1062447355 * Class372_Sub1.anInt4050) {
					int i_185_ = i_164_ + i;
					int i_186_ = i - i_164_;
					if (i_185_ >= -1424479739 * Class372_Sub1.anInt4051
							&& i_186_ <= 1135094847 * Class372_Sub1.anInt4048) {
						i_185_ = Class463.method6012(i_185_,
								(-1424479739 * Class372_Sub1.anInt4051),
								(1135094847 * Class372_Sub1.anInt4048),
								-1212608691);
						i_186_ = Class463.method6012(i_186_,
								(Class372_Sub1.anInt4051 * -1424479739),
								(Class372_Sub1.anInt4048 * 1135094847),
								-1212608691);
						if (i_162_ < i_163_) {
							int i_187_ = (i_166_ < i_162_ ? Class372_Sub1.anIntArray7727[i_162_]
									: i_166_);
							int i_188_ = (Class463.method6012(i + i_187_,
									Class372_Sub1.anInt4051 * -1424479739,
									1135094847 * Class372_Sub1.anInt4048,
									-1212608691));
							int i_189_ = (Class463.method6012(i - i_187_,
									-1424479739 * Class372_Sub1.anInt4051,
									Class372_Sub1.anInt4048 * 1135094847,
									-1212608691));
							if (i_184_ <= Class372_Sub1.anInt4050 * -1062447355) {
								int[] is = (Class372_Sub1.anIntArrayArray4047[i_184_]);
								Class82_Sub22.method940(is, i_186_, i_189_,
										i_159_, -1634458137);
								Class82_Sub22.method940(is, i_189_, i_188_,
										i_158_, -656430266);
								Class82_Sub22.method940(is, i_188_, i_185_,
										i_159_, -455567963);
							}
							...
							if (i_184_ <= Class372_Sub1.anInt4050 * -1062447355)
								Class82_Sub22
										.method940(
												(Class372_Sub1.anIntArrayArray4047[i_184_]),
												i_186_, i_185_, i_159_,
												-2102947655);
							if (i_183_ >= Class372_Sub1.anInt4049 * 1155384281)
								Class82_Sub22
										.method940(
												(Class372_Sub1.anIntArrayArray4047[i_183_]),
												i_186_, i_185_, i_159_,
												-372087596);
						}
					}
