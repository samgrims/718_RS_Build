package com.jagex;/* Class3 - Decompiled by JODE
...
public class Class3 {
	...
	public static void method300(int i) {
		try {
			...
			try {
				class476 = Class86.method962("",
						client.aClass411_8944.aString5317, true, -1804643872);
				RsByteBuffer class298_sub53 = Class422_Sub25.aClass298_Sub48_8425
						.method3542(-804179286);
				class476.method6078(class298_sub53.buffer, 0,
						class298_sub53.index * 385051775, -1257925796);
	...
	static final void method303(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class494
					.method6192(string, -1912416826) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ad.vj(").append(')').toString());
		}
	}
}
