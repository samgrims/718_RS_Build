	...
	void method6196(RsByteBuffer class298_sub53, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ul.a(").append(')').toString());
		}
	}

	public boolean method6197(byte i) {
		try {
			return ((Class487) ((Class496) this).aClass487_6095).aClass243_6068
					.method2310(anInt6097 * 1690480405, -457216440);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ul.p(").append(')').toString());
		}
	}

	public Class57 method6198(GraphicsToolkit class_ra, int i, boolean bool, byte i_1_) {
		try {
			long l = (long) (anInt6097 * 1690480405 | i << 16
					| (bool ? 262144 : 0) | class_ra.anInt5298 * 580915349 << 19);
			Class57 class57 = (Class57) ((Class487) ((Class496) this).aClass487_6095).aClass348_6065
					.method4184(l);
			if (class57 != null)
				return class57;
			if (!((Class487) ((Class496) this).aClass487_6095).aClass243_6068
					.method2310(anInt6097 * 1690480405, -457216440))
				return null;
			IndexedImage class89 = IndexedImage
					.method987(
							(((Class487) (((Class496) this).aClass487_6095)).aClass243_6068),
							1690480405 * anInt6097, 0);
			if (null != class89) {
			...
			if (class57 != null)
				((Class487) ((Class496) this).aClass487_6095).aClass348_6065
						.method4194(class57, l);
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ul.b(").append(')').toString());
		}
	}
	...
	static final void method6201(Class403 class403, int i) {
		try {
			...
			if (i_8_ >= 1 && i_8_ <= 2) {
				...
				Class422_Sub25.aClass298_Sub48_8425
						.method3540(
								Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub12_7574,
								i_8_, 837898760);
				Class3.method300(656179282);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ul.afu(").append(')').toString());
		}
	}
		...
		try {
			if (Class298_Sub37_Sub6.aDouble9587 != d) {
				for (int i = 0; i < 256; i++) {
					...
					Class298_Sub37_Sub6.anIntArray9586[i] = i_9_ > 255 ? 255
							: i_9_;
				}
	...
	static final void method6203(Class403 class403, int i) {
		try {
			...
			if (class105.aStringArray1195 == null
					|| i_11_ >= class105.aStringArray1195.length
				...
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class105.aStringArray1195[i_11_];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ul.sg(").append(')').toString());
		}
	}
}
