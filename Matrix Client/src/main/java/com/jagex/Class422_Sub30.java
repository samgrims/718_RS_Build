package com.jagex;/* Class422_Sub30 - Decompiled by JODE
	...
	static final void method5732(int i) {
		try {
			...
			while (iterator.hasNext()) {
				Class298_Sub37_Sub3 class298_sub37_sub3 = (Class298_Sub37_Sub3) iterator
						.next();
				...
				if (class365_sub1_sub1_sub3.method4484(1662190190)) {
					...
					client.aClass283_8716.method2675(-1611682495).method4022(
							class365_sub1_sub1_sub3, true, (byte) 0);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aez.ik(").append(')').toString());
		}
	}
}
