...
public class Class168 {
	...
	void method1789() {
		if (((Class168) this).anInterface7_Impl1_1722 == null) {
			((Class168) this).anInterface7_Impl1_1722 = ((Class168) this).aClass_ra_Sub3_1717
					.method5382(false);
			...
			((Class168) this).anInterface7_Impl1_1722.method63(0, bytebuffer
					.position(),
					((Class168) this).aClass_ra_Sub3_1717.aLong8217);
			((Class168) this).aClass153_1726 = (((Class168) this).aClass_ra_Sub3_1717
					.method5404(new Class181[] { new Class181(
	...
	void method1790() {
		...
		for (int i_1_ = 0; i_1_ < i; i_1_++) {
			Class150 class150 = (Class150) ((Class168) this).aVector1715
					.elementAt(i_1_);
			int i_2_ = class150.method1624();
			boolean bool = i_1_ == i - 1;
			for (int i_3_ = 0; i_3_ < i_2_; i_3_++) {
				if (bool && i_3_ == i_2_ - 1)
					((Class168) this).aClass_ra_Sub3_1717.method5005(
							((Class168) this).aClass52_Sub1_1712, (byte) -60);
				else
					((Class168) this).aClass52_Sub1_1712.method563(0,
							((Class168) this).anInterface8_Impl1_Impl1_1724);
				...
				class150.method1633(i_3_, ((Class168) this).aClass52_Sub1_1712,
						interface9_impl2_impl1,
						(((Class168) this).anInterface8_Impl1_Impl2_1719),
						(((Class168) this).anInterface9_Impl2_Impl1_1711));
				method1797();
	...
	void method1791() {
		...
		((Class168) this).aClass52_Sub1_1712 = ((Class168) this).aClass_ra_Sub3_1717
				.method5094();
		((Class168) this).anInterface9_Impl2_Impl1_1713 = (((Class168) this).aClass_ra_Sub3_1717
				.method5356(Class55.aClass55_557,
						((Class168) this).aClass77_1727,
						((Class168) this).anInt1720,
						((Class168) this).anInt1721));
		((Class168) this).anInterface8_Impl1_Impl1_1716 = ((Class168) this).anInterface9_Impl2_Impl1_1713
				.method117(0);
		((Class168) this).anInterface9_Impl2_Impl1_1714 = (((Class168) this).aClass_ra_Sub3_1717
				.method5356(Class55.aClass55_557,
						((Class168) this).aClass77_1727,
						((Class168) this).anInt1720,
						((Class168) this).anInt1721));
		((Class168) this).anInterface8_Impl1_Impl1_1724 = ((Class168) this).anInterface9_Impl2_Impl1_1714
				.method117(0);
		((Class168) this).anInterface9_Impl2_Impl1_1711 = (((Class168) this).aClass_ra_Sub3_1717
				.method5356(Class55.aClass55_557,
						((Class168) this).aClass77_1727,
						((Class168) this).anInt1720,
						((Class168) this).anInt1721));
		((Class168) this).anInterface8_Impl1_Impl1_1718 = ((Class168) this).anInterface9_Impl2_Impl1_1711
				.method117(0);
		((Class168) this).anInterface8_Impl1_Impl2_1719 = (((Class168) this).aClass_ra_Sub3_1717
				.method5186(((Class168) this).anInt1720,
						((Class168) this).anInt1721));
		int i = ((Class168) this).aVector1715.size();
		for (int i_5_ = 0; i_5_ < i; i_5_++) {
			Class150 class150 = (Class150) ((Class168) this).aVector1715
					.elementAt(i_5_);
			class150.method1621(((Class168) this).anInt1720,
					((Class168) this).anInt1721);
		}
	}
	...
	void method1797() {
		((Class168) this).aClass_ra_Sub3_1717.method5383(0,
				((Class168) this).anInterface7_Impl1_1722);
		((Class168) this).aClass_ra_Sub3_1717
				.method5455(((Class168) this).aClass153_1726);
		((Class168) this).aClass_ra_Sub3_1717.method5398(
				Class187.aClass187_1907, 0, 1);
	}

	boolean method1798(int i, int i_8_, int i_9_, int i_10_) {
		if (((Class168) this).aVector1715.isEmpty())
			return false;
		if (((Class168) this).anInt1720 != i_9_
				|| (((Class168) this).anInt1721 != i_10_ && (((Class168) this).aClass_ra_Sub3_1717 instanceof Class_ra_Sub3_Sub1))) {
		...
		((Class168) this).aClass52_Sub1_1712.method563(0,
				((Class168) this).anInterface8_Impl1_Impl1_1718);
		if (((Class168) this).anInterface8_Impl1_Impl2_1719 != null)
			((Class168) this).aClass52_Sub1_1712
					.method558(((Class168) this).anInterface8_Impl1_Impl2_1719);
		((Class168) this).aClass_ra_Sub3_1717.method5143(
				((Class168) this).aClass52_Sub1_1712, (byte) 22);
