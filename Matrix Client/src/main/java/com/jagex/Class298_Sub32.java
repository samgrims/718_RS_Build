...
public abstract class Class298_Sub32 extends Class298 {
	...
	final int[] method3129(int i, int i_0_, int i_1_) {
		try {
			if (!((Class298_Sub32) this).aClass298_Sub32Array7371[i].aBoolean7382)
				return (((Class298_Sub32) this).aClass298_Sub32Array7371[i]
						.method3132(i_0_, (byte) -85)[0]);
			return ((Class298_Sub32) this).aClass298_Sub32Array7371[i]
					.method3131(i_0_, 891860141);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abq.b(").append(')').toString());
		}
	}

	void method3130(int i, int i_2_, int i_3_) {
		try {
			int i_4_ = (255 == ((Class298_Sub32) this).anInt7381 * -1006569959 ? i_2_
					: ((Class298_Sub32) this).anInt7381 * -1006569959);
			if (aBoolean7382)
	...
	final int[][] method3134(int i, int i_7_, byte i_8_) {
		try {
			if (((Class298_Sub32) this).aClass298_Sub32Array7371[i].aBoolean7382) {
				int[] is = ((Class298_Sub32) this).aClass298_Sub32Array7371[i]
						.method3131(i_7_, 1101139178);
				int[][] is_9_ = new int[3][];
				is_9_[0] = is;
				is_9_[1] = is;
				is_9_[2] = is;
			...
			return ((Class298_Sub32) this).aClass298_Sub32Array7371[i]
					.method3132(i_7_, (byte) -94);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abq.p(").append(')').toString());
		}
	}
