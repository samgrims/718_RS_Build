...
public class Class278 {
	...
	Class278(RsByteBuffer class298_sub53) {
		for (int i = 0; i < 10; i++) {
			...
			if (i_0_ != 0) {
				...
				((Class278) this).aClass268Array2969[i]
						.method2530(class298_sub53);
			}
		}
	...
	public Class298_Sub26_Sub1 method2601() {
		byte[] is = method2603();
		return new Class298_Sub26_Sub1(22050, is,
				(22050 * ((Class278) this).anInt2968 / 1000),
				(22050 * ((Class278) this).anInt2966 / 1000));
	}

	public final int method2602() {
		int i = 9999999;
		for (int i_1_ = 0; i_1_ < 10; i_1_++) {
			if (((Class278) this).aClass268Array2969[i_1_] != null
					&& (((Class268) ((Class278) this).aClass268Array2969[i_1_]).anInt2874) / 20 < i)
				i = (((Class268) ((Class278) this).aClass268Array2969[i_1_]).anInt2874) / 20;
		}
		if (((Class278) this).anInt2968 < ((Class278) this).anInt2966
				&& ((Class278) this).anInt2968 / 20 < i)
	...
	final byte[] method2603() {
		...
		for (int i_3_ = 0; i_3_ < 10; i_3_++) {
			if (((Class278) this).aClass268Array2969[i_3_] != null
					&& ((((Class268) ((Class278) this).aClass268Array2969[i_3_]).anInt2873) + (((Class268) ((Class278) this).aClass268Array2969[i_3_]).anInt2874)) > i)
		...
		for (int i_5_ = 0; i_5_ < 10; i_5_++) {
			if (((Class278) this).aClass268Array2969[i_5_] != null) {
				...
				int[] is_8_ = (((Class278) this).aClass268Array2969[i_5_]
						.method2531(
								i_6_,
								((Class268) (((Class278) this).aClass268Array2969[i_5_])).anInt2873));
