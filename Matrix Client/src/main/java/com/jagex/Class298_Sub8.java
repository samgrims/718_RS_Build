...
public abstract class Class298_Sub8 extends Class298 {
	...
	abstract void method2872(int i, Class30_Sub2 class30_sub2,
			Class30_Sub2 class30_sub2_1_);
	...
	abstract void method2877(int i, Class30_Sub2 class30_sub2,
			Class30_Sub2 class30_sub2_2_);

	abstract void method2878(int i, Class30_Sub2 class30_sub2,
			Class30_Sub2 class30_sub2_3_);
