package com.jagex;/* Class391 - Decompiled by JODE
...
public class Class391 {
		...
		try {
			if (1 == i) {
				...
				for (int i_3_ = 0; i_3_ < i_2_; i_3_++)
					anIntArray4169[i_3_] = class298_sub53
							.readUnsignedShort();
				anIntArray4172 = new int[i_2_];
				for (int i_4_ = 0; i_4_ < i_2_; i_4_++)
					anIntArray4172[i_4_] = class298_sub53
							.readUnsignedShort();
				for (int i_5_ = 0; i_5_ < i_2_; i_5_++)
					anIntArray4172[i_5_] = ((class298_sub53
							.readUnsignedShort() << 16) + anIntArray4172[i_5_]);
			} else if (2 == i)
				...
				anInt4178 = class298_sub53.readUnsignedByte()
						* -1501035895;
			else if (6 == i)
				...
				anInt4189 = class298_sub53.readUnsignedByte()
						* -1424483545;
			else if (i == 11)
				...
				for (int i_9_ = 0; i_9_ < i_8_; i_9_++)
					anIntArray4174[i_9_] = class298_sub53
							.readUnsignedShort();
				for (int i_10_ = 0; i_10_ < i_8_; i_10_++)
					anIntArray4174[i_10_] = ((class298_sub53
							.readUnsignedShort() << 16) + anIntArray4174[i_10_]);
			} else if (13 == i) {
				...
				for (int i_12_ = 0; i_12_ < i_11_; i_12_++) {
					...
					if (i_13_ > 0) {
						...
						anIntArrayArray4187[i_12_][0] = class298_sub53
								.read24BitUnsignedInteger((byte) -28);
						for (int i_14_ = 1; i_14_ < i_13_; i_14_++)
							anIntArrayArray4187[i_12_][i_14_] = class298_sub53
									.readUnsignedShort();
					}
				}
			} else if (14 == i)
				...
				anIntArray4188[class298_sub53.readUnsignedByte()] = class298_sub53
						.readUnsignedByte();
			} else if (20 == i) {
	...
	public boolean method4880(int i) {
		try {
			...
			for (int i_22_ = 0; i_22_ < is.length; i_22_++) {
				int i_23_ = is[i_22_];
				if (((Class391) this).aClass395_4170.method4900(i_23_ >>> 16,
						-1720040211) == null)
					bool = false;
			}
			return bool;
	...
	static final void method4883(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qe.akz(").append(')').toString());
		}
	}

	public static void method4884(int i, int i_27_, int i_28_, int i_29_,
			ObjectDefinitions class432,
			NPC class365_sub1_sub1_sub2_sub1,
		...
		try {
			...
			if (class432 != null) {
				...
				((Class298_Sub41) class298_sub41).anInt7427 = 305826635 * (i_27_
						+ i_31_ << 9);
				((Class298_Sub41) class298_sub41).anInt7428 = -1647445571
						* (i_28_ + i_32_ << 9);
				...
				((Class298_Sub41) class298_sub41).anInt7430 = 1644605369 * (-161350689
						* class432.anInt5408 << 9);
				((Class298_Sub41) class298_sub41).anInt7449 = class432.anInt5425
						* -1807698503;
				...
				((Class298_Sub41) class298_sub41).anInt7452 = -1937096719
						* class432.anInt5439;
				((Class298_Sub41) class298_sub41).anInt7441 = 1100795 * class432.anInt5438;
				((Class298_Sub41) class298_sub41).anInt7429 = 406226903 * (-282587873
						* class432.anInt5437 << 9);
				...
				if (null != ((Class298_Sub41) class298_sub41).anIntArray7432)
					((Class298_Sub41) class298_sub41).anInt7454 = (((-15898815 * ((Class298_Sub41) class298_sub41).anInt7450) + (int) (Math
				...
				Class298_Sub41.aClass453_7421.method5935(class298_sub41,
						2135348486);
				...
				if (class503 != null) {
					((Class298_Sub41) class298_sub41).anInt7427 = 305826635 * (class503.anInt6187
							* -2095128707 + i_27_ << 9);
					((Class298_Sub41) class298_sub41).anInt7428 = (-1647445571 * (i_28_
							+ -2095128707 * class503.anInt6187 << 9));
					((Class298_Sub41) class298_sub41).anInt7443 = Class125
							.method1398(class365_sub1_sub1_sub2_sub1,
									2096811251) * 502744039;
					...
					((Class298_Sub41) class298_sub41).anInt7429 = (-1422618341
							* class503.anInt6175 << 9) * 406226903;
				}
				Class298_Sub41.aClass453_7455.method5935(class298_sub41,
						387904128);
				...
				((Class298_Sub41) class298_sub41).anInt7427 = ((i_27_ + class365_sub1_sub1_sub2_sub2
						.getSize()) << 9) * 305826635;
				((Class298_Sub41) class298_sub41).anInt7428 = ((i_28_ + class365_sub1_sub1_sub2_sub2
						.getSize()) << 9)
						* -1647445571;
				((Class298_Sub41) class298_sub41).anInt7443 = Class375
						.method4652(class365_sub1_sub1_sub2_sub2, 2035612836) * 502744039;
				...
				((Class298_Sub41) class298_sub41).anInt7449 = -1138033583
						* class365_sub1_sub1_sub2_sub2.anInt10215;
		...
		try {
			...
			for (Class322 class322 = class326.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
				...
				if (class365_sub1_sub1 instanceof Entity) {
					...
					int i_39_ = ((class365_sub1_sub1_sub2_38_
							.getSize() - 1) * 256 + 252);
					Class217 class217 = (class365_sub1_sub1_sub2_38_
					...
					if (i_40_ <= i_34_ && i_41_ <= i_35_ && i_42_ >= i_34_
							&& i_43_ >= i_35_) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qe.id(").append(')').toString());
		}
	}

	static final void method4887(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			class105.aBoolean1171 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
			Tradution.method6054(class105, 2128713505);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qe.ds(").append(')').toString());
		}
	}
