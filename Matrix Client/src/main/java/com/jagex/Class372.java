...
public class Class372 {
	...
	static final void method4587(Class403 class403, int i) {
		try {
			...
			Class97_Sub1.method1043(((i_0_ >> 14 & 0x3fff) - class341.gameSceneBaseX
					* -1760580017),
					((i_0_ & 0x3fff) - 283514611 * class341.gameSceneBaseY),
					i_1_ << 2, i_2_, i_3_, false);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pl.aga(").append(')').toString());
		}
	}

	static final void method4588(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569
					.method5716((byte) -30);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	public static boolean method4589(int i, String string, int i_4_) {
		try {
			...
			if (Class242.aClass401_2708 != Class401.aClass401_6557) {
				Class474.aClass471_5979.anInt5954 = (815680320 + -1670427267
						* Class474.aClass471_5979.worldId);
	...
	public static Class243 method4590(Class111 class111, boolean bool, int i,
		...
		try {
			if (null == Class373.aClass242_Sub1Array4072)
				Class373.aClass242_Sub1Array4072 = new Class242_Sub1[Class356
						.method4268(1608416895)];
			Class329 class329 = null;
			int i_7_ = class111.method1233(958180062);
			if (null != client.aClass484_6476)
				class329 = new Class329(i_7_, client.aClass484_6476,
						Class497.aClass484Array6106[i_7_], 1500000);
			Class373.aClass242_Sub1Array4072[i_7_] = Class203.aClass225_2337
					.method2095(i_7_, class329,
							(Class365_Sub1_Sub3_Sub2.aClass329_9933), 311001416);
	...
	public static void method4591(IComponentDefinition[] class105s, int i, int i_8_,
			int i_9_, boolean bool, short i_10_) {
		try {
