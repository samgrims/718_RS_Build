...
public abstract class Class374 {
	...
	abstract void method4612(RsByteBuffer class298_sub53,
			Class298_Sub50 class298_sub50);
	...
	int method4615(Class298_Sub50 class298_sub50, int i, byte i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("po.p(").append(')').toString());
		}
	}

	abstract int method4616(int i);

	abstract void method4617(RsByteBuffer class298_sub53,
	...
	void method4620(Class298_Sub50 class298_sub50, int i) {
		try {
			((Class374) this).aClass453_4074.method5935(class298_sub50,
					357494730);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("po.b(").append(')').toString());
		}
	}
		...
		try {
			if (method4619(-304373014)) {
				...
				while (iterator.hasNext()) {
					Class298_Sub50 class298_sub50 = (Class298_Sub50) iterator
							.next();
					if (class298_sub36 != null
							&& (385051775 * (class298_sub36.out.index) - i_1_) >= 252 - (6 + method4616(-1861387813))) {
						if (i <= 775068819)
					...
					if (i_5_ < -1)
						...
						i_5_ = 65534;
					if (i_5_ == 954406595 * ((Class374) this).anInt4073
							&& -782291875 * ((Class374) this).anInt4077 == i_4_)
						...
						if (-1L != (((Class374) this).aLong4075 * 8383148474145196457L)) {
							...
							i_7_ = i_4_
									- (-782291875 * ((Class374) this).anInt4077);
						...
						if (i_8_ < 8 && i_6_ >= -32 && i_6_ <= 31
							...
							class298_sub36.out
									.writeByte(128 + i_8_);
							class298_sub36.out
									.writeShort((i_6_ << 8) + i_7_, 16711935);
						} else if (i_8_ < 32) {
							class298_sub36.out
									.writeByte(i_8_ + 192);
							if (-1 == i_5_ || -1 == i_4_)
								class298_sub36.out
										.writeInt(-2147483648, -1667030496);
							else
								class298_sub36.out
										.writeInt(i_5_ | i_4_ << 16,
												-1192850117);
						} else {
							class298_sub36.out
									.writeShort((i_8_ & 0x1fff) + 57344,
											16711935);
							if (i_5_ == -1 || i_4_ == -1)
								class298_sub36.out
										.writeInt(-2147483648, -1243424394);
							else
								class298_sub36.out
										.writeInt(i_5_ | i_4_ << 16, 84476800);
						}
						i_3_++;
						method4617(class298_sub36.out,
								class298_sub50, (byte) 0);
						((Class374) this).aLong4075 = (class298_sub50
								.method3549((byte) 123) * 142159167877835417L);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("po.a(").append(')').toString());
		}
	}

	abstract void method4627(RsByteBuffer class298_sub53,
			Class298_Sub50 class298_sub50);
	...
	abstract void method4630(RsByteBuffer class298_sub53,
			Class298_Sub50 class298_sub50);

	abstract Class298_Sub36 method4631();

	abstract void method4632(RsByteBuffer class298_sub53,
			Class298_Sub50 class298_sub50);
	...
	static final void method4636(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("po.yq(").append(')').toString());
		}
	}

	static final void method4637(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass298_Sub25_5237.aByte7355;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("po.xq(").append(')').toString());
		}
	}
