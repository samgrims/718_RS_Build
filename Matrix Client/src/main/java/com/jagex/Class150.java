package com.jagex;/* Class150 - Decompiled by JODE
...
public abstract class Class150 {
	...
	abstract void method1630(int i, Class52_Sub1 class52_sub1,
			Interface9_Impl2 interface9_impl2,
			Interface8_Impl1_Impl2 interface8_impl1_impl2,
			Interface9_Impl2 interface9_impl2_2_);

	abstract void method1631(int i);

	abstract void method1632(int i);

	abstract void method1633(int i, Class52_Sub1 class52_sub1,
			Interface9_Impl2 interface9_impl2,
			Interface8_Impl1_Impl2 interface8_impl1_impl2,
			Interface9_Impl2 interface9_impl2_3_);
