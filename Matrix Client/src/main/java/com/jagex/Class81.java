...
public class Class81 {
	...
	public static void method858(GraphicsToolkit class_ra, int[] is, int i,
			int[] is_0_, int[] is_1_) {
		method859(class_ra, is, 0, is.length, i, is_0_, is_1_);
	}

	static void method859(GraphicsToolkit class_ra, int[] is, int i, int i_2_,
			int i_3_, int[] is_4_, int[] is_5_) {
		int[] is_6_ = new int[4];
		class_ra.qa(is_6_);
