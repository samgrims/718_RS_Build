...
public class Class356 {
	...
	static final void method4269(Class403 class403, int i) {
		try {
			...
			int i_2_ = -1;
			int i_3_ = -1;
			Class117 class117 = class105.method1116(Class373.aClass_ra4071,
					193353438);
			if (class117 != null) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ow.py(").append(')').toString());
		}
	}

	static final void method4270(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1177 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.anIntArray1188 = is;
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ow.lm(").append(')').toString());
		}
	}
	...
	public static final int method4271(int i, int i_4_, int i_5_, int i_6_) {
		try {
			...
			int i_8_ = i_4_ >> 9;
			if (i_7_ < 0 || i_8_ < 0
					|| i_7_ > client.aClass283_8716.method2629(-1956967905) - 1
					|| i_8_ > client.aClass283_8716.method2630(1920772834) - 1)
				return 0;
			int i_9_ = i_5_;
			if (i_9_ < 3
					&& ((client.aClass283_8716.method2654(2001279106).aByteArrayArrayArray2731[1][i_7_][i_8_]) & 0x2) != 0)
				i_9_++;
			return client.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i_9_]
					.method6340(i, i_4_, -1909964281);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ow.jx(").append(')').toString());
		}
	}
	...
	static final void method4272(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1248
					* -1523987341;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ow.rg(").append(')').toString());
		}
	}

	static final void method4273(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8643 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ow.uk(").append(')').toString());
		}
	}
}
