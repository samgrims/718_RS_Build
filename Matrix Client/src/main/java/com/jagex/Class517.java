...
public class Class517 {
	...
	public Class520 method6307(int i, int i_1_) {
		try {
			Class520 class520;
			synchronized (((Class517) this).aClass348_6267) {
				class520 = (Class520) ((Class517) this).aClass348_6267
						.method4184((long) i);
			}
			if (class520 != null)
				return class520;
		...
		try {
			if (Class522.aClass453_6283.method5948(1828905535) != 0) {
				if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571
						.method5677(-627187888) == 0) {
					for (Class298_Sub14 class298_sub14 = (Class298_Sub14) Class522.aClass453_6283
							.method5939(1766612795); null != class298_sub14; class298_sub14 = ((Class298_Sub14) Class522.aClass453_6283
							.method5944(49146))) {
						Class298_Sub32_Sub14.aClass477_9400
								.method6086(
										class_ra,
										class_ra,
										(-1979936541 * ((Class298_Sub14) class298_sub14).anInt7264),
										(((Class298_Sub14) class298_sub14).anInt7261 * -751580615),
										(1613862267 * ((Class298_Sub14) class298_sub14).anInt7263),
										(((Class298_Sub14) class298_sub14).anInt7260 * -944151257),
										false,
										false,
										(-1216336855 * ((Class298_Sub14) class298_sub14).anInt7262),
					...
					if (null == Class522.aClass_ra6285) {
						...
						Class522.aClass_ra6285 = Class523.method6334(0, canvas,
								Class253.anInterface_ma2785,
								Class82_Sub6.aClass243_6844, 0, -753690122);
						Class522.aClass264_6284 = (Class522.aClass_ra6285
								.method5092(Class322.method3931(
										Class173.aClass243_1758,
										(399302739 * Class74.anInt691), 0,
										(byte) 78), IndexedImage.method993(
										Class158.idx8,
										Class74.anInt691 * 399302739, 0), true));
					}
					for (Class298_Sub14 class298_sub14 = (Class298_Sub14) Class522.aClass453_6283
							.method5939(1766612795); null != class298_sub14; class298_sub14 = ((Class298_Sub14) Class522.aClass453_6283
							.method5944(49146))) {
						Class298_Sub32_Sub14.aClass477_9400
								.method6086(
										Class522.aClass_ra6285,
										class_ra,
										(((Class298_Sub14) class298_sub14).anInt7264 * -1979936541),
										(((Class298_Sub14) class298_sub14).anInt7261 * -751580615),
										(((Class298_Sub14) class298_sub14).anInt7263 * 1613862267),
										(((Class298_Sub14) class298_sub14).anInt7260 * -944151257),
										false,
										false,
										(-1216336855 * ((Class298_Sub14) class298_sub14).anInt7262),
	...
	static final void method6309(Class403 class403, int i) {
		try {
			...
			if (class497.method6206(1883696427))
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class15.aClass507_224
						.method6269(i_2_, 745591351).method6245(i_3_,
								class497.aString6101, 1273707892);
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (Class15.aClass507_224
						.method6269(i_2_, 1830480683).method6239(i_3_,
						-388931549 * class497.anInt6100, (byte) 106));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vt.abu(").append(')').toString());
		}
	}
			...
			if (Class435.method5804(client.anInt8752 * -1233866115, (byte) -21)) {
				...
				for (int i_4_ = 0; i_4_ < class25s.length; i_4_++) {
					...
					if (class25.anInt339 * 2033675053 < 50 && !bool)
						return;
					class25.anInt339 = 0;
					if (!class25.aBoolean347
							&& class25.method387(537308016) != null) {
						Class298_Sub36 class298_sub36 = Class18.method359(
								OutcommingPacket.PING_PACKET, class25.aClass449_330,
								(byte) 20);
