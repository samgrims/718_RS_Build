package com.jagex;/* Class158 - Decompiled by JODE
...
public class Class158 implements Interface5 {
	...
	static final void method1699(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1209 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gl.ln(").append(')').toString());
		}
	}
