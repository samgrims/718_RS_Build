...
public abstract class Class246 implements Interface7 {
	...
	public boolean method67(int i, int i_0_, long l) {
		...
		if (((Class246) this).anInt6395 > 0) {
			OpenGL.glBindBufferARB(((Class246) this).anInt6393,
					((Class246) this).anInt6395);
			OpenGL.glBufferSubDataARBa(((Class246) this).anInt6393, i, i_0_, l);
		} else
			((Class246) this).aNativeHeapBuffer6390.f.copy(
					((Class246) this).aNativeHeapBuffer6390.f() + (long) i, l,
					i_0_);
		return true;
	}
	...
	long method2332() {
		return (((Class246) this).anInt6395 == 0 ? ((Class246) this).aNativeHeapBuffer6390
				.f()
				: 0L);
	}
	...
	void method113(int i) {
		if (i > ((Class246) this).anInt6397) {
			...
			if (((Class246) this).anInt6395 > 0) {
				OpenGL.glBindBufferARB(((Class246) this).anInt6393,
						((Class246) this).anInt6395);
				OpenGL.glBufferDataARBub(((Class246) this).anInt6393, i, null,
						0, (((Class246) this).aBoolean6396 ? 35040 : 35044));
				((Class246) this).aClass_ra_Sub3_Sub1_6392.anInt8224 += i
						- ((Class246) this).anInt6397;
			} else
				((Class246) this).aNativeHeapBuffer6390 = ((Class246) this).aClass_ra_Sub3_Sub1_6392
						.method5517(i, false);
	...
	boolean method2334(int i, Source source) {
		if (i > ((Class246) this).anInt6397) {
			...
			if (((Class246) this).anInt6395 > 0) {
				OpenGL.glBindBufferARB(((Class246) this).anInt6393,
						((Class246) this).anInt6395);
				OpenGL.glBufferDataARBa(((Class246) this).anInt6393, i, source
						.f(), (((Class246) this).aBoolean6396 ? 35040 : 35044));
				((Class246) this).aClass_ra_Sub3_Sub1_6392.anInt8224 += i
						- ((Class246) this).anInt6394;
			} else {
				((Class246) this).aNativeHeapBuffer6390 = ((Class246) this).aClass_ra_Sub3_Sub1_6392
						.method5517(i, false);
			...
			OpenGL.glBindBufferARB(((Class246) this).anInt6393,
					((Class246) this).anInt6395);
			OpenGL.glBufferSubDataARBa(((Class246) this).anInt6393, 0,
					((Class246) this).anInt6394, source.f());
			((Class246) this).aClass_ra_Sub3_Sub1_6392.anInt8224 += i
					- ((Class246) this).anInt6394;
		} else {
			((Class246) this).aNativeHeapBuffer6390 = ((Class246) this).aClass_ra_Sub3_Sub1_6392
	...
	void b() {
		if (((Class246) this).anInt6395 > 0) {
			((Class246) this).aClass_ra_Sub3_Sub1_6392.method5536(
					((Class246) this).anInt6395, ((Class246) this).anInt6394);
