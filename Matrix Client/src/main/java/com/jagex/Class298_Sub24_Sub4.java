...
public class Class298_Sub24_Sub4 extends Class298_Sub24 {
	...
	void method3074(OggPacket oggpacket, int i) {
		try {
			if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0
					|| "SUB".equals(((Class298_Sub24_Sub4) this).aString9305)) {
				RsByteBuffer class298_sub53 = new RsByteBuffer(oggpacket
						.getData());
				...
				if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
					...
					if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 == 0) {
						...
						((Class298_Sub24_Sub4) this).anInt9302 = class298_sub53
								.method3600(1431459183) * 33758645;
						((Class298_Sub24_Sub4) this).anInt9308 = (class298_sub53
								.method3600(-150244186) * 1857578037);
						if ((((Class298_Sub24_Sub4) this).anInt9302 * -180836195) == 0
								|| (((Class298_Sub24_Sub4) this).anInt9308 * 2110967325) == 0)
							throw new IllegalStateException();
						RsByteBuffer class298_sub53_1_ = new RsByteBuffer(
								16);
						class298_sub53.readBytes(
								(class298_sub53_1_.buffer), 0, 16,
								-953523806);
						((Class298_Sub24_Sub4) this).aString9304 = class298_sub53_1_
								.readString(-1838621769);
						class298_sub53_1_.index = 0;
						class298_sub53.readBytes(
								(class298_sub53_1_.buffer), 0, 16,
								-953523806);
						((Class298_Sub24_Sub4) this).aString9305 = class298_sub53_1_
								.readString(1476138543);
					}
				} else {
					if (0 == i_0_) {
						...
						if (i_4_ < 0
								|| i_4_ > (class298_sub53.buffer.length - 385051775 * class298_sub53.index))
							throw new IllegalStateException();
						((Class298_Sub24_Sub4) this).aString9300 = Class214
								.method1995((class298_sub53.buffer),
		...
		if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0
			...
			if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
				...
				if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 == 0) {
					class298_sub53.index += -1617461143;
					((Class298_Sub24_Sub4) this).anInt9302 = class298_sub53
							.method3600(-1960945614) * 33758645;
					((Class298_Sub24_Sub4) this).anInt9308 = class298_sub53
							.method3600(1105841706) * 1857578037;
					if ((((Class298_Sub24_Sub4) this).anInt9302 * -180836195 == 0)
							|| (((Class298_Sub24_Sub4) this).anInt9308 * 2110967325 == 0))
						throw new IllegalStateException();
					RsByteBuffer class298_sub53_5_ = new RsByteBuffer(16);
					class298_sub53.readBytes(class298_sub53_5_.buffer,
							0, 16, -953523806);
					((Class298_Sub24_Sub4) this).aString9304 = class298_sub53_5_
							.readString(-2059271269);
					class298_sub53_5_.index = 0;
					class298_sub53.readBytes(class298_sub53_5_.buffer,
							0, 16, -953523806);
					((Class298_Sub24_Sub4) this).aString9305 = class298_sub53_5_
							.readString(254290400);
				}
			} else {
				if (0 == i) {
					...
					if (i_8_ < 0
							|| i_8_ > (class298_sub53.buffer.length - 385051775 * class298_sub53.index))
						throw new IllegalStateException();
					((Class298_Sub24_Sub4) this).aString9300 = Class214
							.method1995(class298_sub53.buffer,
									(class298_sub53.index * 385051775),
		...
		if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0
			...
			if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
				...
				if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 == 0) {
					class298_sub53.index += -1617461143;
					((Class298_Sub24_Sub4) this).anInt9302 = class298_sub53
							.method3600(-1885777054) * 33758645;
					((Class298_Sub24_Sub4) this).anInt9308 = class298_sub53
							.method3600(-1908777764) * 1857578037;
					if ((((Class298_Sub24_Sub4) this).anInt9302 * -180836195 == 0)
							|| (((Class298_Sub24_Sub4) this).anInt9308 * 2110967325 == 0))
						throw new IllegalStateException();
					RsByteBuffer class298_sub53_9_ = new RsByteBuffer(16);
					class298_sub53.readBytes(class298_sub53_9_.buffer,
							0, 16, -953523806);
					((Class298_Sub24_Sub4) this).aString9304 = class298_sub53_9_
							.readString(933165446);
					class298_sub53_9_.index = 0;
					class298_sub53.readBytes(class298_sub53_9_.buffer,
							0, 16, -953523806);
					((Class298_Sub24_Sub4) this).aString9305 = class298_sub53_9_
							.readString(-1680071522);
				}
			} else {
				if (0 == i) {
					...
					if (i_12_ < 0
							|| i_12_ > (class298_sub53.buffer.length - 385051775 * class298_sub53.index))
						throw new IllegalStateException();
					((Class298_Sub24_Sub4) this).aString9300 = Class214
							.method1995(class298_sub53.buffer,
									(class298_sub53.index * 385051775),
		...
		if (((Class298_Sub24_Sub4) this).anInt7352 * -1312498565 <= 0
			...
			if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 <= 8) {
				...
				if (-1312498565 * ((Class298_Sub24_Sub4) this).anInt7352 == 0) {
					class298_sub53.index += -1617461143;
					((Class298_Sub24_Sub4) this).anInt9302 = class298_sub53
							.method3600(-1909623846) * 33758645;
					((Class298_Sub24_Sub4) this).anInt9308 = class298_sub53
							.method3600(1996267542) * 1857578037;
					if ((((Class298_Sub24_Sub4) this).anInt9302 * -180836195 == 0)
							|| (((Class298_Sub24_Sub4) this).anInt9308 * 2110967325 == 0))
						throw new IllegalStateException();
					RsByteBuffer class298_sub53_13_ = new RsByteBuffer(16);
					class298_sub53.readBytes(
							(class298_sub53_13_.buffer), 0, 16,
							-953523806);
					((Class298_Sub24_Sub4) this).aString9304 = class298_sub53_13_
							.readString(-1904784161);
					class298_sub53_13_.index = 0;
					class298_sub53.readBytes(
							(class298_sub53_13_.buffer), 0, 16,
							-953523806);
					((Class298_Sub24_Sub4) this).aString9305 = class298_sub53_13_
							.readString(333136246);
				}
			} else {
				if (0 == i) {
					...
					if (i_16_ < 0
							|| i_16_ > (class298_sub53.buffer.length - 385051775 * class298_sub53.index))
						throw new IllegalStateException();
					((Class298_Sub24_Sub4) this).aString9300 = Class214
							.method1995(class298_sub53.buffer,
									(class298_sub53.index * 385051775),
