...
public final class Class450 {
	...
	public static int method5921(byte[] is, int i, byte[] is_0_, int i_1_,
			int i_2_) {
	...
	static void method5923(Class439 class439) {
		...
		while (bool_35_) {
			...
			((Class439) class439).anInt5554 = (((Class439) class439).anInt5554
					* -1963861893 << 8 | i_37_ & 0xff)
					* -1428404557;
			...
			for (int i_55_ = 0; i_55_ < i_43_; i_55_++) {
				...
				method5928(((Class439) class439).anIntArrayArray5565[i_55_],
						((Class439) class439).anIntArrayArray5540[i_55_],
						((Class439) class439).anIntArrayArray5572[i_55_],
						((Class439) class439).aByteArrayArray5549[i_55_],
						i_56_, i_57_, i_42_);
			...
			int i_69_;
			int i_70_;
			for (i_70_ = method5927(i_68_, class439); i_70_ > is[i_68_]; i_70_ = i_70_ << 1
					| i_69_) {
				i_68_++;
			...
			while (i_71_ != i_59_) {
				if (i_71_ == 0 || i_71_ == 1) {
					...
					if (i_75_ < 16) {
						...
						i_36_ = (((Class439) class439).aByteArray5568[i_76_
								+ i_75_]);
						for (/**/; i_75_ > 3; i_75_ -= 4) {
						...
						for (/**/; i_75_ > 0; i_75_--)
							((Class439) class439).aByteArray5568[i_76_ + i_75_] = (((Class439) class439).aByteArray5568[i_76_
									+ i_75_ - 1]);
						...
						if (((Class439) class439).anIntArray5569[0] == 0) {
							...
							for (int i_81_ = 15; i_81_ >= 0; i_81_--) {
								for (int i_82_ = 15; i_82_ >= 0; i_82_--) {
									((Class439) class439).aByteArray5568[i_63_] = (((Class439) class439).aByteArray5568[(((Class439) class439).anIntArray5569[i_81_])
											+ i_82_]);
									i_63_--;
								}
			...
			((Class439) class439).anInt5556 = ((Class439.anIntArray5560[((Class439) class439).anInt5554
					* -1963861893]) >> 8)
					* -1642553995;
			((Class439) class439).anInt5555 = 0;
			((Class439) class439).anInt5556 = Class439.anIntArray5560[(((Class439) class439).anInt5556 * 1501792989)]
					* -1642553995;
			...
			method5922(class439);
			if ((((Class439) class439).anInt5555 * 849607515 == ((Class439) class439).anInt5574
					* -69219207 + 1)
					&& ((Class439) class439).anInt5571 * -966285967 == 0)
				bool_35_ = true;
			else
				bool_35_ = false;
		}
	...
	static void method5925(Class439 class439) {
		...
		for (int i = 0; i < 256; i++) {
			if (((Class439) class439).aBooleanArray5573[i]) {
				((Class439) class439).aByteArray5564[((Class439) class439).anInt5561
						* -2130856323] = (byte) i;
	...
	static int method5927(int i, Class439 class439) {
		for (;;) {
			if (((Class439) class439).anInt5552 * 1660824337 >= i) {
				int i_88_ = ((((Class439) class439).anInt5551 * -1710803227 >> ((Class439) class439).anInt5552
						* 1660824337 - i) & (1 << i) - 1);
				((Class439) class439).anInt5552 -= i * -360700431;
				return i_88_;
			}
			((Class439) class439).anInt5551 = ((((Class439) class439).anInt5551
					* -1710803227 << 8 | (((Class439) class439).aByteArray5536[((Class439) class439).anInt5543
					* -1070677121]) & 0xff) * 1040750317);
	...
	static void method5928(int[] is, int[] is_89_, int[] is_90_, byte[] is_91_,
