...
public class Class298_Sub8_Sub1 extends Class298_Sub8 {
	...
	boolean method2869() {
		if ((((Class_ra_Sub2) ((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222).aBoolean8170)
				&& ((Class_ra_Sub2) ((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222).aBoolean8093
				&& ((Class_ra_Sub2) (((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222)).aBoolean8133) {
			((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179 = new Class52_Sub1_Sub2(
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222);
			((Class298_Sub8_Sub1) this).aClass30_Sub2_9180 = new Class30_Sub2(
					(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222), 3553,
					Class55.aClass55_557, Class77.aClass77_714, 256, 256);
			((Class298_Sub8_Sub1) this).aClass30_Sub2_9180.method420(false,
					false);
			((Class298_Sub8_Sub1) this).aClass30_Sub2_9181 = new Class30_Sub2(
					(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222), 3553,
					Class55.aClass55_557, Class77.aClass77_714, 256, 256);
			((Class298_Sub8_Sub1) this).aClass30_Sub2_9181.method420(false,
					false);
			((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5143(
					((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179,
					(byte) 112);
			((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179
					.method563(0,
							((Class298_Sub8_Sub1) this).aClass30_Sub2_9180
									.method423(0));
			((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179
					.method563(1,
							((Class298_Sub8_Sub1) this).aClass30_Sub2_9181
									.method423(0));
			((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179.method572(0);
			if (!((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179
					.method560()) {
				((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5005(
						((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179,
						(byte) -107);
				return false;
			}
			((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5005(
					((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179,
					(byte) -15);
			((Class298_Sub8_Sub1) this).aClass29_9175 = (Class29
					.method406(
							((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222,
							(new Class48[] { Class48
									.method526(
			...
			((Class298_Sub8_Sub1) this).aClass29_9189 = (Class29
					.method406(
							((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222,
							(new Class48[] { Class48
									.method526(
					...
					.method406(
							...
							(new Class48[] { Class48
									.method526(
											...
											35632,
											"uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") })));
			return (((Class298_Sub8_Sub1) this).aClass29_9189 != null
					&& ((Class298_Sub8_Sub1) this).aClass29_9175 != null
					&& ((Class298_Sub8_Sub1) this).aClass29_9183 != null && ((Class298_Sub8_Sub1) this).aClass29_9187 != null);
		}
		return false;
	}
	...
	void method2871(int i, int i_0_) {
		...
		int i_1_ = Class422_Sub4.method5639(
				((Class298_Sub8_Sub1) this).anInt9185, 1918937807);
		int i_2_ = Class422_Sub4.method5639(
				((Class298_Sub8_Sub1) this).anInt9184, 1314388027);
		if (((Class298_Sub8_Sub1) this).anInt9188 != i_1_
			...
			if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
				for (int i_3_ = 0; i_3_ < (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190).length; i_3_++)
					((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_3_]
							.method408();
				((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 = null;
			}
			if (i_1_ > 256 || i_2_ > 256) {
				...
				if (((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170 == null)
					((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170 = new Class52_Sub1_Sub2(
							((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222);
				...
				i_6_ = 0;
				while (i_4_ > 256 || i_5_ > 256) {
					((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_6_++] = new Class30_Sub2(
							(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222),
							3553, Class55.aClass55_557, Class77.aClass77_714,
							i_4_, i_5_);
					if (i_4_ > 256)
						i_4_ >>= 1;
					if (i_5_ > 256)
	...
	void method2883(int i, int i_7_) {
		...
		int i_8_ = Class422_Sub4.method5639(
				((Class298_Sub8_Sub1) this).anInt9185, 1360936610);
		int i_9_ = Class422_Sub4.method5639(
				((Class298_Sub8_Sub1) this).anInt9184, 1074782076);
		if (((Class298_Sub8_Sub1) this).anInt9188 != i_8_
				|| ((Class298_Sub8_Sub1) this).anInt9186 != i_9_) {
			if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
				for (int i_10_ = 0; i_10_ < (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190).length; i_10_++)
					((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_10_]
							.method408();
				((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 = null;
			}
			if (i_8_ > 256 || i_9_ > 256) {
				...
				i_13_ = 0;
				while (i_11_ > 256 || i_12_ > 256) {
					((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_13_++] = new Class30_Sub2(
							(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222),
							3553, Class55.aClass55_557, Class77.aClass77_714,
							i_11_, i_12_);
					if (i_11_ > 256)
	...
	void method2878(int i, Class30_Sub2 class30_sub2,
			Class30_Sub2 class30_sub2_14_) {
		...
		if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
			((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5143(
					((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170,
					(byte) 9);
			int i_15_ = Class422_Sub4.method5639(
					(((Class298_Sub8_Sub1) this).anInt9185), 2071757561);
			int i_16_ = Class422_Sub4.method5639(
					(((Class298_Sub8_Sub1) this).anInt9184), 1398420241);
			int i_17_ = 0;
			while (i_15_ > 256 || i_16_ > 256) {
				...
				((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170
						.method563(
								0,
								((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_17_]
										.method423(0));
				if (i_17_ == 0) {
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
					...
					OpenGL.glTexCoord2f(
							(float) (((Class298_Sub8_Sub1) this).anInt9185),
							0.0F);
					OpenGL.glVertex2i(1, 0);
					OpenGL.glTexCoord2f(
							(float) (((Class298_Sub8_Sub1) this).anInt9185),
							(float) (((Class298_Sub8_Sub1) this).anInt9184));
					...
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
							.method5256(((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_17_ - 1]);
					OpenGL.glBegin(7);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					OpenGL.glVertex2i(0, 0);
			...
			OpenGL.glUniform1i(OpenGL.glGetUniformLocation(i_18_, "sceneTex"),
					0);
			OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_18_, "params"),
					aFloat9173, 0.0F, 0.0F);
			OpenGL.glBegin(7);
			OpenGL.glTexCoord2f(0.0F, 0.0F);
			OpenGL.glVertex2i(0, 0);
			OpenGL.glTexCoord2f(1.0F, 0.0F);
			...
			OpenGL.glUniform1i(OpenGL.glGetUniformLocation(i_19_, "sceneTex"),
					0);
			OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_19_, "params"),
					aFloat9173, 0.0F, 0.0F);
			OpenGL.glBegin(7);
			OpenGL.glTexCoord2f(0.0F, 0.0F);
			OpenGL.glVertex2i(0, 0);
			OpenGL.glTexCoord2f((float) ((Class298_Sub8_Sub1) this).anInt9185,
					0.0F);
			OpenGL.glVertex2i(1, 0);
			OpenGL.glTexCoord2f((float) ((Class298_Sub8_Sub1) this).anInt9185,
					(float) ((Class298_Sub8_Sub1) this).anInt9184);
		...
		((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
				.method5256(((Class298_Sub8_Sub1) this).aClass30_Sub2_9180);
		...
		OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_20_, "step"),
		...
		((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179.method572(0);
		((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
				.method5256(((Class298_Sub8_Sub1) this).aClass30_Sub2_9181);
		OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_20_, "step"), 0.0F,
				0.00390625F, 0.0F);
		OpenGL.glBegin(7);
		OpenGL.glTexCoord2f(0.0F, 0.0F);
		OpenGL.glVertex2i(0, 0);
		...
		((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5005(
				((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9179, (byte) 2);
		...
		OpenGL.glUniform3f(OpenGL.glGetUniformLocation(i_21_, "params"),
				aFloat9171, aFloat9172, 0.0F);
		((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5255(1);
		((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
				.method5256(((Class298_Sub8_Sub1) this).aClass30_Sub2_9180);
		((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5255(0);
	...
	void method2877(int i, Class30_Sub2 class30_sub2,
			Class30_Sub2 class30_sub2_22_) {
		OpenGL.glPushAttrib(2048);
		OpenGL.glMatrixMode(5889);
		OpenGL.glPushMatrix();
		OpenGL.glLoadIdentity();
		...
		if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
			((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5143(
					((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170,
					(byte) -3);
			int i_23_ = Class422_Sub4.method5639(
					(((Class298_Sub8_Sub1) this).anInt9185), 1462499323);
			int i_24_ = Class422_Sub4.method5639(
					(((Class298_Sub8_Sub1) this).anInt9184), 1465383629);
			int i_25_ = 0;
			while (i_23_ > 256 || i_24_ > 256) {
				...
				((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170
						.method563(
								0,
								((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_25_]
										.method423(0));
				if (i_25_ == 0) {
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
							.method5256(class30_sub2);
					...
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
							.method5256(((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_25_ - 1]);
					OpenGL.glBegin(7);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					OpenGL.glVertex2i(0, 0);
					OpenGL.glTexCoord2f(1.0F, 0.0F);
	...
	void method2872(int i, Class30_Sub2 class30_sub2,
			Class30_Sub2 class30_sub2_30_) {
		OpenGL.glPushAttrib(2048);
		OpenGL.glMatrixMode(5889);
		OpenGL.glPushMatrix();
		OpenGL.glLoadIdentity();
		...
		if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
			((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222.method5143(
					((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170,
					(byte) 61);
			int i_31_ = Class422_Sub4.method5639(
					(((Class298_Sub8_Sub1) this).anInt9185), 1385804775);
			int i_32_ = Class422_Sub4.method5639(
					(((Class298_Sub8_Sub1) this).anInt9184), 1199238042);
			int i_33_ = 0;
			while (i_31_ > 256 || i_32_ > 256) {
				...
				((Class298_Sub8_Sub1) this).aClass52_Sub1_Sub2_9170
						.method563(
								0,
								((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_33_]
										.method423(0));
				if (i_33_ == 0) {
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
							.method5256(class30_sub2);
					...
					((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222
							.method5256(((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_33_ - 1]);
					OpenGL.glBegin(7);
					OpenGL.glTexCoord2f(0.0F, 0.0F);
					OpenGL.glVertex2i(0, 0);
					OpenGL.glTexCoord2f(1.0F, 0.0F);
	...
	void method2885(int i, int i_38_) {
		...
		int i_39_ = Class422_Sub4.method5639(
				((Class298_Sub8_Sub1) this).anInt9185, 1657798261);
		int i_40_ = Class422_Sub4.method5639(
				((Class298_Sub8_Sub1) this).anInt9184, 1091426304);
		if (((Class298_Sub8_Sub1) this).anInt9188 != i_39_
				|| ((Class298_Sub8_Sub1) this).anInt9186 != i_40_) {
			if (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 != null) {
				for (int i_41_ = 0; i_41_ < (((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190).length; i_41_++)
					((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_41_]
							.method408();
				((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190 = null;
			}
			if (i_39_ > 256 || i_40_ > 256) {
				...
				i_44_ = 0;
				while (i_42_ > 256 || i_43_ > 256) {
					((Class298_Sub8_Sub1) this).aClass30_Sub2Array9190[i_44_++] = new Class30_Sub2(
							(((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222),
							3553, Class55.aClass55_557, Class77.aClass77_714,
							i_42_, i_43_);
					if (i_42_ > 256)
	...
	boolean method2890() {
		return (((Class_ra_Sub2) ((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222).aBoolean8170
				&& ((Class_ra_Sub2) (((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222)).aBoolean8093 && ((Class_ra_Sub2) (((Class298_Sub8_Sub1) this).aClass_ra_Sub2_7222)).aBoolean8133);
	}
}
