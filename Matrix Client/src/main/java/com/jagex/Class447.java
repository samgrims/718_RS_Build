package com.jagex;/* Class447 - Decompiled by JODE
...
public class Class447 implements Iterator {
	...
	public Object next() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sl.next(").append(')').toString());
		}
	}
	...
	public void remove() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sl.remove(").append(')').toString());
		}
	}
	...
	public boolean hasNext() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sl.hasNext(").append(')').toString());
		}
	}
	...
	public static void method5905(int i) {
		try {
			for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482
					.method5984(1694693115)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482
					.method5985(283371396))) {
				if ((-628325139 * ((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583) > 1) {
					...
					Class436.aClass348_5464
							.method4194(
									class298_sub37_sub5,
									(((Class298_Sub37_Sub15) (Class298_Sub37_Sub15) (((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)).aLong9666 * 6619564980435866523L));
					((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584
							.method5988(2069073381);
				}
			}
