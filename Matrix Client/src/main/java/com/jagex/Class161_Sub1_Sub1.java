...
public class Class161_Sub1_Sub1 extends Class161_Sub1 {
	...
	public void method1738(int i, int i_0_, byte i_1_) {
		try {
			...
			((Class161_Sub1_Sub1) this).aFloatArray9129[3] = f
					* (float) aClass_ra_Sub3_1648.anInt8342 % 1.0F;
			if (!((Class161_Sub1_Sub1) this).aClass159_9122.aBoolean1621) {
				int i_4_ = (int) ((float) aClass_ra_Sub3_1648.anInt8342 * f_2_ * 16.0F);
				aClass_ra_Sub3_1648
						.method5358(((Class161_Sub1_Sub1) this).aClass159_9122.anInterface9_Impl2Array1624[i_4_ % 16]);
			} else
				((Class161_Sub1_Sub1) this).aFloat9131 = (float) ((double) f_2_
						* (double) aClass_ra_Sub3_1648.anInt8342 % 1.0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("afj.ac(").append(')').toString());
		}
	}

	boolean method1736() throws Exception_Sub2 {
		((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9125 = aClass123_7033
				.method1360("WorldMatrix", -867744099);
		((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9123 = aClass123_7033
				.method1360("WVPMatrix", -250672432);
		((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9127 = aClass123_7033
				.method1360("UGenerationPlane", -1602523427);
		((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9126 = aClass123_7033
				.method1360("VGenerationPlane", 1186138394);
		((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9119 = aClass123_7033
				.method1360("Time", -2093315319);
		((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9120 = aClass123_7033
				.method1360("billowSampler3D", -1560961563);
		if (((Class161_Sub1_Sub1) this).aClass159_9122.aBoolean1621) {
			((Class161_Sub1_Sub1) this).aClass110_9130 = aClass123_7033
					.method1327("Waterfall3D", (byte) 0);
			aClass123_7033
					.method1331(((Class161_Sub1_Sub1) this).aClass110_9130);
		} else {
			((Class161_Sub1_Sub1) this).aClass110_9118 = aClass123_7033
					.method1327("Waterfall2D", (byte) -112);
			aClass123_7033
					.method1331(((Class161_Sub1_Sub1) this).aClass110_9118);
		}
		return true;
	}
	...
	public void method1739(int i) {
		try {
			...
			if (((Class161_Sub1_Sub1) this).aClass159_9122.aBoolean1621)
				aClass123_7033
						.method1341(
								(((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9120),
								0,
								(((Class161_Sub1_Sub1) this).aClass159_9122.anInterface9_Impl3_1625),
								-1892543284);
			aClass123_7033.method1368(
					(((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9125),
					aClass233_9121, 600012267);
			aClass123_7033.method1368(
					(((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9123),
					aClass233_9124, 600012267);
			aClass123_7033.method1339(
					((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9127,
					new Class232(
							((Class161_Sub1_Sub1) this).aFloatArray9128[0],
							((Class161_Sub1_Sub1) this).aFloatArray9128[1],
							((Class161_Sub1_Sub1) this).aFloatArray9128[2],
							((Class161_Sub1_Sub1) this).aFloatArray9128[3]),
					1385384483);
			aClass123_7033.method1339(
					((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9126,
					new Class232(
							((Class161_Sub1_Sub1) this).aFloatArray9129[0],
							((Class161_Sub1_Sub1) this).aFloatArray9129[1],
							((Class161_Sub1_Sub1) this).aFloatArray9129[2],
							((Class161_Sub1_Sub1) this).aFloatArray9129[3]),
					560835049);
			aClass123_7033.method1339(
					(((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9119),
					new Class232((((Class161_Sub1_Sub1) this).aFloat9131),
							0.0F, 0.0F, 0.0F), -247168453);
			aClass_ra_Sub3_1648.method5392(Class187.aClass187_1907,
					anInt9132 * 540763355, anInt9133 * -754699637, anInt9134
							* -863719041, anInt9135 * 507848871);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("afj.am(").append(')').toString());
		}
	}

	public Class161_Sub1_Sub1(Class_ra_Sub3 class_ra_sub3, Class159 class159)
		...
		if (((Class161_Sub1_Sub1) this).aClass159_9122.method1704()
				&& class_ra_sub3.method5295())
	...
	boolean method1726() throws Exception_Sub2 {
		try {
			((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9125 = aClass123_7033
					.method1360("WorldMatrix", -2088418999);
			((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9123 = aClass123_7033
					.method1360("WVPMatrix", -363138804);
			((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9127 = aClass123_7033
					.method1360("UGenerationPlane", 1661649711);
			((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9126 = aClass123_7033
					.method1360("VGenerationPlane", 2031421483);
			((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9119 = aClass123_7033
					.method1360("Time", 293420542);
			((Class161_Sub1_Sub1) this).aClass298_Sub31_Sub1_9120 = aClass123_7033
					.method1360("billowSampler3D", 2054271289);
			if (((Class161_Sub1_Sub1) this).aClass159_9122.aBoolean1621) {
				((Class161_Sub1_Sub1) this).aClass110_9130 = aClass123_7033
						.method1327("Waterfall3D", (byte) -79);
				aClass123_7033
						.method1331(((Class161_Sub1_Sub1) this).aClass110_9130);
			} else {
				((Class161_Sub1_Sub1) this).aClass110_9118 = aClass123_7033
						.method1327("Waterfall2D", (byte) -52);
				aClass123_7033
						.method1331(((Class161_Sub1_Sub1) this).aClass110_9118);
			}
			return true;
