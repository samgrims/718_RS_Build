...
public class Class318_Sub1 extends Class318 {
	...
	public void method3866(byte[] is, int i, int i_0_) throws IOException {
		((Class318_Sub1) this).aClass330_7690.method3998(is, i, i_0_,
				-1957971249);
	}

	public boolean isAvailable(int i, byte i_1_) throws IOException {
		try {
			return ((Class318_Sub1) this).aClass316_7689.method3840(i,
					1797469509);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acl.f(").append(')').toString());
		}
	}
	...
	public int method3857(int i) throws IOException {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acl.b(").append(')').toString());
		}
	}

	public int readBytes(byte[] is, int i, int i_2_, byte i_3_)
			throws IOException {
		try {
			return ((Class318_Sub1) this).aClass316_7689.method3843(is, i,
					i_2_, (byte) 54);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acl.p(").append(')').toString());
		}
	}

	public void method3868(byte[] is, int i, int i_4_, int i_5_)
			throws IOException {
		try {
			((Class318_Sub1) this).aClass330_7690.method3998(is, i, i_4_,
					-2010830691);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acl.i(").append(')').toString());
		}
	}
	...
	protected void finalize() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acl.finalize(").append(')').toString());
		}
	}
	...
	Class318_Sub1(Socket socket, int i) throws IOException {
		...
		((Class318_Sub1) this).aClass316_7689 = new Class316(
				((Class318_Sub1) this).aSocket7688.getInputStream(), i);
		((Class318_Sub1) this).aClass330_7690 = new Class330(
				((Class318_Sub1) this).aSocket7688.getOutputStream(), i);
	}
	...
	public int method3864(byte[] is, int i, int i_6_) throws IOException {
		return ((Class318_Sub1) this).aClass316_7689.method3843(is, i, i_6_,
				(byte) 88);
	}

	public void method3865(byte[] is, int i, int i_7_) throws IOException {
		((Class318_Sub1) this).aClass330_7690.method3998(is, i, i_7_,
				-1140067311);
	}

	public int method3869(byte[] is, int i, int i_8_) throws IOException {
		return ((Class318_Sub1) this).aClass316_7689.method3843(is, i, i_8_,
				(byte) 44);
	}

	public void method3862(byte[] is, int i, int i_9_) throws IOException {
		((Class318_Sub1) this).aClass330_7690.method3998(is, i, i_9_,
				-629136417);
	}
