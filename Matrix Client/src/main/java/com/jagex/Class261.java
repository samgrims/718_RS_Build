...
public final class Class261 implements Comparable {
	...
	int method2462(Class261 class261_0_, int i) {
		try {
			if (-547428082756159857L * ((Class261) this).aLong2821 < -547428082756159857L
					* ((Class261) class261_0_).aLong2821)
				return -1;
			if (-547428082756159857L * ((Class261) this).aLong2821 > -547428082756159857L
					* ((Class261) class261_0_).aLong2821)
				return 1;
	...
	public int compareTo(Object object) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kx.compareTo(").append(')').toString());
		}
	}
	...
	public boolean equals(Object object) {
		try {
			if (object instanceof Class261)
				return ((Class261) this).anObject2824
						.equals(((Class261) (Class261) object).anObject2824);
			throw new IllegalArgumentException();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kx.equals(").append(')').toString());
		}
	}

	static final void method2463(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1120 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kx.lv(").append(')').toString());
		}
	}
