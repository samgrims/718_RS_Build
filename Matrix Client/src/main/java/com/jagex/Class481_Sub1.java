...
public class Class481_Sub1 extends Class481 {
	...
	Socket method6114(String string, int i, String string_0_, int i_1_)
			throws IOException {
		try {
			...
			if (null == string_0_)
				outputstream.write(new StringBuilder().append("CONNECT ")
						.append(((Class481_Sub1) this).aString6034).append(":")
						.append(98195689 * ((Class481_Sub1) this).anInt6033)
						.append(" HTTP/1.0\n\n").toString().getBytes(
								Charset.forName("ISO-8859-1")));
			else
				outputstream.write(new StringBuilder().append("CONNECT ")
						.append(((Class481_Sub1) this).aString6034).append(":")
						.append(((Class481_Sub1) this).anInt6033 * 98195689)
			...
			if (null != string_2_) {
				if (string_2_.startsWith("HTTP/1.0 200")
						|| string_2_.startsWith("HTTP/1.1 200"))
					return socket;
				if (string_2_.startsWith("HTTP/1.0 407")
						|| string_2_.startsWith("HTTP/1.1 407")) {
					int i_3_ = 0;
					String string_4_ = "proxy-authenticate: ";
					for (string_2_ = bufferedreader.readLine(); string_2_ != null
							&& i_3_ < 50; i_3_++) {
						if (string_2_.toLowerCase().startsWith(string_4_)) {
							string_2_ = string_2_.substring(string_4_.length())
									.trim();
				...
				try {
					...
					if (object != null) {
						...
						if (((Boolean) method_6_.invoke(object, new Object[0]))
								.booleanValue()) {
							Method method_7_ = var_class.getDeclaredMethod(
									"getHeaderName", new Class[0]);
							method_7_.setAccessible(true);
							Method method_8_ = (var_class
									.getDeclaredMethod(
											"getHeaderValue",
											(new Class[] {
													java.net.URL.class,
							...
							String string_9_ = ((String) method_7_.invoke(
									object, new Object[0]));
							String string_10_ = ((String) (method_8_
									.invoke(
											object,
											(new Object[] {
													new URL(
															new StringBuilder()
																	.append(
																			"https://")
																	.append(
																			((Class481_Sub1) this).aString6034)
																	.append("/")
																	.toString()),
													"https" }))));
							string = new StringBuilder().append(string_9_)
									.append(": ").append(string_10_).toString();
						}
					}
				} catch (Exception exception) {
					/* empty */
				}
				return method6114(inetsocketaddress.getHostName(),
						inetsocketaddress.getPort(), string, -1832604571);
			}
			if (proxy.type() == Proxy.Type.SOCKS) {
				Socket socket = new Socket(proxy);
				socket.connect(new InetSocketAddress(
						(((Class481_Sub1) this).aString6034),
						(98195689 * (((Class481_Sub1) this).anInt6033))));
				return socket;
			}
			return null;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aes.r(").append(')').toString());
		}
	}
	...
	public Socket method6112() throws IOException {
		...
		List list_12_;
		try {
			list = (((Class481_Sub1) this).aProxySelector8445.select(new URI(
					new StringBuilder().append(bool_11_ ? "https" : "http")
							.append("://").append(
									((Class481_Sub1) this).aString6034)
							.toString())));
			list_12_ = (((Class481_Sub1) this).aProxySelector8445
					.select(new URI(new StringBuilder().append(
							bool_11_ ? "http" : "https").append("://").append(
							((Class481_Sub1) this).aString6034).toString())));
	...
	public Socket method6111(int i) throws IOException {
		try {
			...
			List list_17_;
			try {
				list = (((Class481_Sub1) this).aProxySelector8445
						.select(new URI(new StringBuilder().append(
								bool_16_ ? "https" : "http").append("://")
								.append(((Class481_Sub1) this).aString6034)
								.toString())));
				list_17_ = (((Class481_Sub1) this).aProxySelector8445
						.select(new URI(new StringBuilder().append(
