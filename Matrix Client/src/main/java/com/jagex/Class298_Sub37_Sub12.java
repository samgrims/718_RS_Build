...
public class Class298_Sub37_Sub12 extends Class298_Sub37 {
	...
	void method3445(int i) {
		try {
			aLong7406 = ((aLong7406 * -5533549728640346679L
					& ~0x7fffffffffffffffL | Class122.method1319((byte) 1) + 500L) * 1476940603538232441L);
			aClass461_9607.method5982(this, (byte) -90);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ais.bf(").append(')').toString());
		}
	}
