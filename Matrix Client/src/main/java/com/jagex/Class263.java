...
public abstract class Class263 implements Interface9 {
	...
	public void method123() {
		...
		OpenGL.glBindTexture(((Class263) this).anInt6415,
				((Class263) this).anInt6417);
	}
	...
	void method2467() {
		...
		if (((Class263) this).aClass179_6418 == Class179.aClass179_1812) {
			OpenGL.glTexParameteri(((Class263) this).anInt6415, 10241,
					(((Class263) this).aBoolean6411 ? 9987 : 9729));
			OpenGL.glTexParameteri(((Class263) this).anInt6415, 10240, 9729);
		} else {
			OpenGL.glTexParameteri(((Class263) this).anInt6415, 10241,
					(((Class263) this).aBoolean6411 ? 9984 : 9728));
		...
		for (;;) {
			OpenGL
					.glTexImage2Di(
							...
							Class_ra_Sub3_Sub1.method5533(
									((Class263) this).aClass55_6419,
									(((Class263) this).aClass77_6420)),
							i_2_,
							i_3_,
							0,
							32993,
							((Class_ra_Sub3_Sub1) ((Class263) this).aClass_ra_Sub3_Sub1_6422).anInt9841,
							is_8_, 0);
			if (i_5_ <= 1)
				break;
			int i_10_ = 0;
			...
			for (int i_13_ = 0; i_13_ < i_7_; i_13_++) {
				for (int i_14_ = 0; i_14_ < i_6_; i_14_++) {
					...
					i_21_ += i_18_ >> 8 & 0xff;
					i_22_ += i_18_ & 0xff;
					is_9_[i_10_++] = ((i_19_ & 0x3fc) << 22
							| (i_20_ & 0x3fc) << 14 | (i_21_ & 0x3fc) << 6 | (i_22_ & 0x3fc) >> 2);
				}
				i_11_ += i_2_;
				i_12_ += i_2_;
			}
	...
	void method2469(int i, int i_24_, int i_25_, float[] fs) {
		...
		for (;;) {
			OpenGL.glTexImage2Df(i, i_27_, Class_ra_Sub3_Sub1.method5533(
					((Class263) this).aClass55_6419,
					(((Class263) this).aClass77_6420)), i_24_, i_25_, 0,
					Class_ra_Sub3_Sub1
							.method5532(((Class263) this).aClass55_6419), 5126,
					fs_31_, 0);
			if (i_28_ <= 1)
				break;
	...
	int method2471() {
		int i = (((Class263) this).aClass55_6419.anInt556 * 845115459
				* (((Class263) this).aClass77_6420.anInt724 * 685647847) * ((Class263) this).anInt6416);
	...
	public void d() {
		if (((Class263) this).anInt6417 > 0) {
			((Class263) this).aClass_ra_Sub3_Sub1_6422.method5529(
					((Class263) this).anInt6417, method2471());
	...
	void method2472(int i, int i_43_, int i_44_, byte[] is) {
		...
		for (;;) {
			OpenGL.glTexImage2Dub(i, i_46_, Class_ra_Sub3_Sub1.method5533(
					((Class263) this).aClass55_6419,
					(((Class263) this).aClass77_6420)), i_43_, i_44_, 0,
					Class_ra_Sub3_Sub1
							.method5532(((Class263) this).aClass55_6419), 5121,
					is_50_, 0);
			if (i_47_ <= 1)
				break;
	...
	Class263(Class_ra_Sub3_Sub1 class_ra_sub3_sub1, int i, Class55 class55,
			Class77 class77, int i_61_, boolean bool) {
