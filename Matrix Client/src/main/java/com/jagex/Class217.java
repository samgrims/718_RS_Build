...
public class Class217 {
	...
	public static final Class217 method2011(Class217 class217,
			Class217 class217_11_) {
	...
	public final float method2012() {
		return (float) Math.sqrt((double) (aFloat2451 * aFloat2451 + aFloat2455
				* aFloat2455 + aFloat2454 * aFloat2454));
	}
	...
	public void method2013(Class217 class217_14_) {
		method2007(class217_14_.aFloat2451, class217_14_.aFloat2455,
				class217_14_.aFloat2454);
	}

	public String toString() {
		return new StringBuilder().append(aFloat2451).append(", ").append(
				aFloat2455).append(", ").append(aFloat2454).toString();
	}

	final void method2014(Class218 class218) {
		Class218 class218_15_ = Class218.method2020(aFloat2451, aFloat2455,
				aFloat2454, 0.0F);
		...
		method2007(((Class218) class218_17_).aFloat2461,
				((Class218) class218_17_).aFloat2458,
				((Class218) class218_17_).aFloat2462);
	...
	public final void method2016(Class222 class222) {
		...
		aFloat2451 = (((Class222) class222).aFloat2494 * f
				+ ((Class222) class222).aFloat2496 * f_19_
				+ ((Class222) class222).aFloat2499 * aFloat2454 + ((Class222) class222).aFloat2492);
		aFloat2455 = (((Class222) class222).aFloat2502 * f
				+ ((Class222) class222).aFloat2497 * f_19_
				+ ((Class222) class222).aFloat2500 * aFloat2454 + ((Class222) class222).aFloat2503);
		aFloat2454 = (((Class222) class222).aFloat2495 * f
				+ ((Class222) class222).aFloat2498 * f_19_
				+ ((Class222) class222).aFloat2501 * aFloat2454 + ((Class222) class222).aFloat2493);
	}
	...
	public final void method2018(Class222 class222) {
		...
		aFloat2451 = (((Class222) class222).aFloat2494 * f
				+ ((Class222) class222).aFloat2496 * f_20_ + ((Class222) class222).aFloat2499
				* aFloat2454);
		aFloat2455 = (((Class222) class222).aFloat2502 * f
				+ ((Class222) class222).aFloat2497 * f_20_ + ((Class222) class222).aFloat2500
				* aFloat2454);
		aFloat2454 = (((Class222) class222).aFloat2495 * f
				+ ((Class222) class222).aFloat2498 * f_20_ + ((Class222) class222).aFloat2501
				* aFloat2454);
	}
}
