package com.jagex;/* Class422_Sub3 - Decompiled by JODE
...
public class Class422_Sub3 extends Class422 {
	...
	public int method5616(int i) {
		if (0 != i
				&& aClass298_Sub48_5346.aClass422_Sub10_7548
						.method5661((byte) 108) == 2)
			return 3;
		if (i == 0
				|| aClass298_Sub48_5346.aClass422_Sub28_7573
						.method5724(1875039574) == 1)
			return 1;
		return 2;
	}
	...
	public int method5612(int i, int i_0_) {
		try {
			if (0 != i
					&& aClass298_Sub48_5346.aClass422_Sub10_7548
							.method5661((byte) 10) == 2)
				return 3;
			if (i == 0
					|| aClass298_Sub48_5346.aClass422_Sub28_7573
							.method5724(948081550) == 1)
				return 1;
			return 2;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("add.f(").append(')').toString());
		}
	}
	...
	int method5611(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("add.a(").append(')').toString());
		}
	}

	public void method5634(byte i) {
		try {
			if (0 != anInt5350 * -1598873795
					&& aClass298_Sub48_5346.aClass422_Sub28_7573
							.method5724(1435565446) != 1)
				anInt5350 = 0;
			if (0 != anInt5350 * -1598873795
					&& aClass298_Sub48_5346.aClass422_Sub10_7548
							.method5661((byte) 20) == 2)
				anInt5350 = 0;
			if (-1598873795 * anInt5350 < 0 || -1598873795 * anInt5350 > 1)
				anInt5350 = method5611(-1720172189) * 1886334997;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("add.s(").append(')').toString());
		}
	}
