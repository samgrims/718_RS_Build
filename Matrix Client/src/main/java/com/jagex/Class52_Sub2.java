package com.jagex;/* Class52_Sub2 - Decompiled by JODE
		...
		try {
			...
			try {
				...
				RsByteBuffer class298_sub53 = new RsByteBuffer(
						client.anInt8890 * 260699542 + 3);
				class298_sub53.writeByte(1);
				class298_sub53.writeShort(client.anInt8890 * -672377959,
						16711935);
				for (int i_8_ = 0; i_8_ < Class374.anIntArray4078.length; i_8_++) {
					if (Class254.aBooleanArray2790[i_8_]) {
						...
						class298_sub53.writeInt(
								(Class374.anIntArray4078[i_8_]), -679720276);
					}
				}
				class476.method6078(class298_sub53.buffer, 0,
						385051775 * class298_sub53.index, 840147185);
