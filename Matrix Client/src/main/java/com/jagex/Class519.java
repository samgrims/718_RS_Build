	...
	public byte[] method6317(byte[] is, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vv.a(").append(')').toString());
		}
	}

	public void method6318(RsByteBuffer class298_sub53, byte[] is, int i) {
		try {
			if (31 != (class298_sub53.buffer[class298_sub53.index * 385051775])
					|| -117 != (class298_sub53.buffer[class298_sub53.index * 385051775 + 1]))
				throw new RuntimeException("");
			if (((Class519) this).anInflater6273 == null)
				((Class519) this).anInflater6273 = new Inflater(true);
			try {
				((Class519) this).anInflater6273
						.setInput(
								class298_sub53.buffer,
								10 + 385051775 * class298_sub53.index,
								(class298_sub53.buffer.length - (8 + (385051775 * class298_sub53.index + 10))));
	...
	static final String[] method6319(String[] strings, int i) {
		try {
			...
			for (int i_5_ = 0; i_5_ < 5; i_5_++) {
				strings_4_[i_5_] = new StringBuilder().append(i_5_).append(" ")
						.toString();
				if (null != strings && strings[i_5_] != null)
					strings_4_[i_5_] = new StringBuilder().append(
							strings_4_[i_5_]).append(strings[i_5_]).toString();
			}
			return strings_4_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vv.ly(").append(')').toString());
		}
	}
}
