...
public class Class372_Sub3 extends Class372 {
	...
	static void method4599(int i) {
		try {
			Class8.anInt106 = (-445162670 + (-123784141
					* Class82_Sub19_Sub1.aClass505_9111.anInt6202 + (Class82_Sub19_Sub1.aClass505_9111.anInt6197 * -1877198679)));
			...
			Class255.method2435(Tradution.aClass470_5950.method6049(
					Class321.aClass429_3357, -875414210), 1099175264);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adx.b(").append(')').toString());
		}
	}

	static final void method4600(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -560594807
					* Class388.anInt4152;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adx.amp(").append(')').toString());
		}
	}
	...
	static final void method4601(Class403 class403, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adx.dk(").append(')').toString());
		}
	}

	static final void method4602(IComponentDefinition class105, Class119 class119,
