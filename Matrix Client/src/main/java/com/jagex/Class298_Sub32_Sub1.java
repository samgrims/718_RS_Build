...
public class Class298_Sub32_Sub1 extends Class298_Sub32 {
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_0_) {
		try {
			if (i == 0)
				((Class298_Sub32_Sub1) this).anInt9319 = class298_sub53
						.readUnsignedShort() * 1334499193;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agb.r(").append(')').toString());
		}
	}
	...
	int[] method3139(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			int[] is_1_ = method3129(0,
					i - 1 & -289063255 * Class250.anInt2758, -1887337990);
			int[] is_2_ = method3129(0, i, -1887337990);
			int[] is_3_ = method3129(0,
					i + 1 & Class250.anInt2758 * -289063255, -1887337990);
			for (int i_4_ = 0; i_4_ < -1474554145 * Class250.anInt2755; i_4_++) {
				...
				int i_6_ = (585425609 * ((Class298_Sub32_Sub1) this).anInt9319 * (is_2_[i_4_
						+ 1 & Class250.anInt2753 * -901777799] - (is_2_[i_4_
						- 1 & -901777799 * Class250.anInt2753])));
				int i_7_ = i_6_ >> 12;
				int i_8_ = i_5_ >> 12;
				int i_9_ = i_7_ * i_7_ >> 12;
				int i_10_ = i_8_ * i_8_ >> 12;
				int i_11_ = (int) (Math
						.sqrt((double) ((float) (i_9_ + i_10_ + 4096) / 4096.0F)) * 4096.0);
	...
	int[] method3140(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			int[] is_13_ = method3129(0, i - 1 & -289063255
					* Class250.anInt2758, -1887337990);
			int[] is_14_ = method3129(0, i, -1887337990);
			int[] is_15_ = method3129(0, i + 1 & Class250.anInt2758
			...
			for (int i_16_ = 0; i_16_ < -1474554145 * Class250.anInt2755; i_16_++) {
				...
				int i_18_ = (585425609 * ((Class298_Sub32_Sub1) this).anInt9319 * (is_14_[i_16_
						+ 1 & Class250.anInt2753 * -901777799] - (is_14_[i_16_
						- 1 & -901777799 * Class250.anInt2753])));
				int i_19_ = i_18_ >> 12;
				int i_20_ = i_17_ >> 12;
				...
				int i_23_ = (int) (Math
						.sqrt((double) ((float) (i_21_ + i_22_ + 4096) / 4096.0F)) * 4096.0);
	...
	int[] method3131(int i, int i_25_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				int[] is_26_ = method3129(0, i - 1 & -289063255
						* Class250.anInt2758, -1887337990);
				int[] is_27_ = method3129(0, i, -1887337990);
				int[] is_28_ = method3129(0, i + 1 & Class250.anInt2758
						* -289063255, -1887337990);
				for (int i_29_ = 0; i_29_ < -1474554145 * Class250.anInt2755; i_29_++) {
					...
					int i_31_ = (585425609 * ((Class298_Sub32_Sub1) this).anInt9319 * ((is_27_[i_29_
							+ 1 & Class250.anInt2753 * -901777799]) - is_27_[(i_29_ - 1 & -901777799
							* Class250.anInt2753)]));
					int i_32_ = i_31_ >> 12;
					int i_33_ = i_30_ >> 12;
					int i_34_ = i_32_ * i_32_ >> 12;
					int i_35_ = i_33_ * i_33_ >> 12;
					int i_36_ = (int) (Math.sqrt((double) ((float) (i_34_
							+ i_35_ + 4096) / 4096.0F)) * 4096.0);
