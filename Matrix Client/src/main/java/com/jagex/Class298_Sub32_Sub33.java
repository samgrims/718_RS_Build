...
public class Class298_Sub32_Sub33 extends Class298_Sub32 {
	...
	void method3346(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 6:
			((Class298_Sub32_Sub33) this).anInt9531 = class298_sub53
					.readUnsignedByte() * 1663137711;
			break;
		case 7:
			((Class298_Sub32_Sub33) this).anInt9532 = class298_sub53
					.readUnsignedShort() * 741927281;
			break;
		case 1:
			((Class298_Sub32_Sub33) this).anInt9526 = class298_sub53
					.readUnsignedShort()
					* -8002361;
			break;
		case 0:
			((Class298_Sub32_Sub33) this).anInt9525 = class298_sub53
					.readUnsignedByte()
					* -653192821;
			break;
		case 4:
			((Class298_Sub32_Sub33) this).anInt9519 = class298_sub53
					.readUnsignedShort() * 1340421019;
			break;
		case 3:
			((Class298_Sub32_Sub33) this).anInt9528 = class298_sub53
					.readUnsignedShort()
					* -2128158391;
			break;
		case 5:
			((Class298_Sub32_Sub33) this).anInt9530 = class298_sub53
					.readUnsignedShort()
					* -420846851;
			break;
		case 2:
			((Class298_Sub32_Sub33) this).anInt9523 = class298_sub53
					.readUnsignedShort() * 334398233;
			break;
		case 8:
			((Class298_Sub32_Sub33) this).anInt9533 = class298_sub53
					.readUnsignedShort() * 1393727635;
			break;
		}
	}
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				if (i_13_ <= 1)
					return is_1_[i];
				((Class298_Sub32_Sub33) this).anInt9534 = ((-1474554145
						* Class250.anInt2755 / 8 * (((Class298_Sub32_Sub33) this).anInt9530 * -1630516651)) >> 12) * 800544861;
				int i_14_ = 1 + -1474554145 * Class250.anInt2755 / i_10_;
				int[][] is_15_ = new int[i_14_][3];
				int[][] is_16_ = new int[i_14_][3];
				Random random = new Random(
						(long) ((((Class298_Sub32_Sub33) this).anInt9525) * -2017522141));
				for (;;) {
					int i_17_ = i_10_
							+ Class298_Sub19_Sub3.method3039(random, i_11_
									- i_10_, (byte) 36);
					int i_18_ = i_12_
							+ Class298_Sub19_Sub3.method3039(random, i_13_
									- i_12_, (byte) -88);
							...
							for (int i_29_ = 0; i_29_ <= i_23_; i_29_++) {
								...
								if (i_31_ != i_20_) {
									...
									if (i_26_ < i_24_) {
										...
										i_34_ = Math.max(i_26_, i_32_);
										i_35_ = Class250.anInt2755
												* -1474554145;
									}
									method3349(random, is_1_, i_34_ + i_4_,
											i_31_, i_35_ - i_34_,
											i_20_ - i_31_, -1120469720);
								}
							}
						}
						i_6_ = i_21_;
					...
					if (Class250.anInt2755 * -1474554145 == i_19_) {
						method3349(random, is_1_, i_3_ + i_5_, i_20_, i_17_,
								i_18_, -22985350);
						if (bool) {
							if (i_0_ == -484575331)
						...
						i_9_ = 0;
						i_4_ = i_3_;
						i_3_ = Class298_Sub19_Sub3.method3039(random,
								(-1474554145 * (Class250.anInt2755)),
								(byte) -66);
						i_2_ = i_3_ - i_4_;
						i_5_ = 0;
						int i_38_ = i_2_;
	...
	int[] method3347(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			Random random = new Random(
					(long) (((Class298_Sub32_Sub33) this).anInt9525 * -2017522141));
			for (;;) {
				int i_57_ = (i_50_ + Class298_Sub19_Sub3.method3039(random,
						i_51_ - i_50_, (byte) -66));
				int i_58_ = (i_52_ + Class298_Sub19_Sub3.method3039(random,
						i_53_ - i_52_, (byte) -28));
					...
					if (i_61_ != i_46_) {
						...
						for (int i_69_ = 0; i_69_ <= i_63_; i_69_++) {
							...
							if (i_71_ != i_60_) {
								...
								method3349(random, is_41_, i_74_ + i_44_,
										i_71_, i_75_ - i_74_, i_60_ - i_71_,
										-1679820011);
							}
						}
					}
				...
				if (Class250.anInt2755 * -1474554145 == i_59_) {
					method3349(random, is_41_, i_43_ + i_45_, i_60_, i_57_,
							i_58_, -764186178);
					if (bool)
						break;
					bool = true;
					...
					i_49_ = 0;
					i_44_ = i_43_;
					i_43_ = Class298_Sub19_Sub3.method3039(random,
							(-1474554145 * (Class250.anInt2755)), (byte) -49);
					i_42_ = i_43_ - i_44_;
					i_45_ = 0;
					int i_78_ = i_42_;
					if (i_78_ < 0)
	...
	int[] method3348(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			Random random = new Random(
					(long) (((Class298_Sub32_Sub33) this).anInt9525 * -2017522141));
			for (;;) {
				int i_98_ = (i_91_ + Class298_Sub19_Sub3.method3039(random,
						i_92_ - i_91_, (byte) 96));
				int i_99_ = (i_93_ + Class298_Sub19_Sub3.method3039(random,
						i_94_ - i_93_, (byte) 8));
					...
					if (i_102_ != i_87_) {
						...
						for (int i_110_ = 0; i_110_ <= i_104_; i_110_++) {
							...
							if (i_112_ != i_101_) {
								...
								method3349(random, is_82_, i_115_ + i_85_,
										i_112_, i_116_ - i_115_, i_101_
												- i_112_, 167475133);
							}
						}
					}
				...
				if (Class250.anInt2755 * -1474554145 == i_100_) {
					method3349(random, is_82_, i_84_ + i_86_, i_101_, i_98_,
							i_99_, 1099535944);
					if (bool)
						break;
					bool = true;
					...
					i_90_ = 0;
					i_85_ = i_84_;
					i_84_ = Class298_Sub19_Sub3.method3039(random,
							(-1474554145 * (Class250.anInt2755)), (byte) -56);
					i_83_ = i_84_ - i_85_;
					i_86_ = 0;
					int i_119_ = i_83_;
					if (i_119_ < 0)
	...
	final void method3349(Random random, int[][] is, int i, int i_122_,
			int i_123_, int i_124_, int i_125_) {
		try {
			int i_126_ = (((Class298_Sub32_Sub33) this).anInt9533 * -2052438629 > 0 ? (4096 - Class298_Sub19_Sub3
					.method3039(
							random,
							(((Class298_Sub32_Sub33) this).anInt9533 * -2052438629),
							(byte) 90))
					: 4096);
			int i_127_ = ((908540917 * ((Class298_Sub32_Sub33) this).anInt9534 * (((Class298_Sub32_Sub33) this).anInt9532 * 19183505)) >> 12);
			int i_128_ = (((Class298_Sub32_Sub33) this).anInt9534 * 908540917 - (i_127_ > 0 ? Class298_Sub19_Sub3
					.method3039(random, i_127_, (byte) -95)
					: 0));
						...
						if (i_135_ < i_132_) {
							...
							if ((((Class298_Sub32_Sub33) this).anInt9531 * 1833451343) == 0) {
								for (int i_138_ = 0; i_138_ < i_131_; i_138_++) {
									...
									is_136_[(i + i_138_ & (-901777799 * Class250.anInt2753))] = is_136_[(i_123_
											+ i - i_138_ - 1 & (Class250.anInt2753 * -901777799))] = i_139_
											* i_137_ >> 12;
								}
							} else {
								for (int i_140_ = 0; i_140_ < i_131_; i_140_++) {
									...
									is_136_[i_140_ + i
											& (Class250.anInt2753 * -901777799)] = is_136_[(i_123_
											+ i - i_140_ - 1 & (Class250.anInt2753 * -901777799))] = i_141_ < i_137_ ? i_141_
											: i_137_;
								}
							}
							if (i_133_ + i_134_ > -1474554145
									* Class250.anInt2755) {
								int i_142_ = (Class250.anInt2755 * -1474554145 - i_133_);
								Class425.method5740(is_136_, i_133_, i_142_,
										i_137_);
								Class425.method5740(is_136_, 0,
										i_134_ - i_142_, i_137_);
							} else
								Class425.method5740(is_136_, i_133_, i_134_,
										i_137_);
						} else {
							...
							if (i_143_ < i_132_) {
								...
								if ((((Class298_Sub32_Sub33) this).anInt9531 * 1833451343) == 0) {
									for (int i_145_ = 0; i_145_ < i_131_; i_145_++) {
										...
										is_136_[(i_145_ + i & (Class250.anInt2753 * -901777799))] = is_136_[(i
												+ i_123_ - i_145_ - 1 & (Class250.anInt2753 * -901777799))] = i_146_
												* i_144_ >> 12;
									}
								} else {
									for (int i_147_ = 0; i_147_ < i_131_; i_147_++) {
										int i_148_ = i_126_ * i_147_ / i_131_;
										is_136_[(i_147_ + i & (-901777799 * Class250.anInt2753))] = is_136_[(i
												+ i_123_ - i_147_ - 1 & (Class250.anInt2753 * -901777799))] = (i_148_ < i_144_ ? i_148_
												: i_144_);
									}
								}
								if (i_133_ + i_134_ > -1474554145
										* Class250.anInt2755) {
									int i_149_ = (-1474554145
											* Class250.anInt2755 - i_133_);
									Class425.method5740(is_136_, i_133_,
											i_149_, i_144_);
									Class425.method5740(is_136_, 0, i_134_
											- i_149_, i_144_);
								} else
									Class425.method5740(is_136_, i_133_,
											i_134_, i_144_);
								...
								for (int i_150_ = 0; i_150_ < i_131_; i_150_++)
									is_136_[(i_150_ + i & (-901777799 * Class250.anInt2753))] = is_136_[(i
											+ i_123_ - i_150_ - 1 & (Class250.anInt2753 * -901777799))] = i_126_
											* i_150_ / i_131_;
								if (i_133_ + i_134_ > Class250.anInt2755
										* -1474554145) {
									int i_151_ = (Class250.anInt2755
											* -1474554145 - i_133_);
									Class425.method5740(is_136_, i_133_,
											i_151_, i_126_);
									Class425.method5740(is_136_, 0, i_134_
