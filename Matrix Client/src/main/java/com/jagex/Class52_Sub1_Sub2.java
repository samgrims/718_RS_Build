...
public class Class52_Sub1_Sub2 extends Class52_Sub1 {
	...
	public void method563(int i, Interface8_Impl1_Impl1 interface8_impl1_impl1) {
		...
		if (interface8_impl1_impl1 != null) {
			if ((((Class52_Sub1_Sub2) this).anInt9062 | i_0_) != i_0_) {
				if ((((Class52_Sub1_Sub2) this).anInt9060 != interface8_impl1_impl1_impl2
						.a())
						|| (((Class52_Sub1_Sub2) this).anInt9065 != interface8_impl1_impl1_impl2
								.f()))
					throw new RuntimeException();
			} else {
				((Class52_Sub1_Sub2) this).anInt9065 = interface8_impl1_impl1_impl2
						.f();
				((Class52_Sub1_Sub2) this).anInt9060 = interface8_impl1_impl1_impl2
						.a();
				if (this == ((Class52_Sub1_Sub2) this).aClass_ra_Sub2_9061
						.method4992((short) -4129))
	...
	public void method135() {
		if (((Class52_Sub1_Sub2) this).anInt9057 != 0) {
			((Class52_Sub1_Sub2) this).aClass_ra_Sub2_9061
					.method5249(((Class52_Sub1_Sub2) this).anInt9057);
	...
	boolean method136() {
		OpenGL
				.glBindFramebufferEXT(36160,
						((Class52_Sub1_Sub2) this).anInt9057);
		for (int i = 0; i < 4; i++) {
	...
	void method570(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_,
			boolean bool, boolean bool_6_) {
		if (bool | bool_6_) {
			int i_7_ = ((Class52_Sub1_Sub2) this).anInt9065;
			int i_8_ = ((Class52_Sub1_Sub2) this).aClass_ra_Sub2_9061
					.method4992((short) -16350).method552();
			int i_9_ = 0;
			if (bool_6_)
				i_9_ |= 0x100;
			if (bool)
			...
			OpenGL.glBindFramebufferEXT(36008,
					((Class52_Sub1_Sub2) this).anInt9057);
			OpenGL.glBlitFramebufferEXT(i, i_7_ - i_1_ - i_3_, i + i_2_, i_7_
					- i_1_, i_4_, i_8_ - i_5_ - i_3_, i_4_ + i_2_, i_8_ - i_5_,
					i_9_, 9728);
	...
	void method571() {
		if (((Class52_Sub1_Sub2) this).anInterface8_Impl1_Impl1_Impl2_9064 == null)
			...
			((Class52_Sub1_Sub2) this).anInterface8_Impl1_Impl1_Impl2_9064
					.method3(36096);
	}
