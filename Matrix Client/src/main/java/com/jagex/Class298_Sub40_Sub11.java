...
public class Class298_Sub40_Sub11 extends Class298_Sub40 {
	...
	void method3508(RsByteBuffer class298_sub53, int i) {
		try {
			((Class298_Sub40_Sub11) this).anInt9723 = class298_sub53
					.readUnsignedShort()
					* -977594491;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agr.a(").append(')').toString());
		}
	}

	void method3511(ClanSettings class162) {
		class162.method1765(
				(-142522035 * ((Class298_Sub40_Sub11) this).anInt9723),
				1943804872);
	}
