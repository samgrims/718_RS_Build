		...
		try {
			...
			if (throwable instanceof RuntimeException_Sub2) {
				...
				string = new StringBuilder()
						.append(
								((RuntimeException_Sub2) runtimeexception_sub2).aString6308)
						.append(" | ").toString();
			...
			for (;;) {
				...
				string_5_ = string_5_
						.substring(string_5_.lastIndexOf('\t') + 1);
