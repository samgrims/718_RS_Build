...
public class ConfigDefinitions {
	...
	public static void method3977(Class331 class331, GraphicsToolkit class_ra, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nq.b(").append(')').toString());
		}
	}

	static final void method3978(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1291 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nq.lt(").append(')').toString());
		}
	}
	...
	public static void method3979(boolean bool, byte[] is, int i) {
		try {
			...
			if (bool) {
				...
				Class325.aLong3454 = Class122.method1319((byte) 1)
						* -4824082235216898149L;
				aClass298_Sub53_3471 = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nq.p(").append(')').toString());
		}
	}
	...
	static Class298_Sub32 method3981(RsByteBuffer class298_sub53, int i) {
		try {
			...
			Class298_Sub32 class298_sub32 = Class234
					.method2182(i_4_, (byte) 11);
			((Class298_Sub32) class298_sub32).anInt7381 = class298_sub53
					.readUnsignedByte()
					* -2127296983;
	...
	static final void method3982(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nq.afl(").append(')').toString());
		}
	}

	static void method3983(int i) {
		try {
			Class436.aClass298_Sub37_Sub15_5466 = (new Class298_Sub37_Sub15(
					Tradution.aClass470_5934.method6049(Class321.aClass429_3357,
							-875414210), "", -1808468501 * client.anInt8937,
					1006, -1, 0L, 0, 0, true, false, 0L, true));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nq.k(").append(')').toString());
		}
	}
