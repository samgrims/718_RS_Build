...
public abstract class Class_na extends Class298_Sub37 {
	...
	public static final void method3479(boolean bool, int i, byte i_2_) {
		try {
			...
			if (null != class298_sub25 && i >= 0
					&& i < 649879491 * class298_sub25.anInt7356) {
				...
				if (-1 == class163.aByte1683) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(
							OutcommingPacket.aClass198_2035, class25.aClass449_330,
							(byte) 56);
					class298_sub36.out.writeByte(
							3 + Class58.method693(string, -175153344));
					class298_sub36.out.writeByte(
							bool ? 1 : 0);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("na.mw(").append(')').toString());
		}
	}

	static final void method3480(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8845
					* -363202459;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("na.uf(").append(')').toString());
		}
	}
}
