...
public class Class223 implements Interface24 {
		...
		try {
			...
			Class320
					.method3913(
							...
							(((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]),
							(((Class403) class403).anIntArray5244[2 + ((Class403) class403).anInt5239 * 681479919]),
							(((Class403) class403).anIntArray5244[3 + ((Class403) class403).anInt5239 * 681479919]),
							false, 256, 1465436328);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jl.ty(").append(')').toString());
		}
	}
			...
			for (;;) {
				try {
					...
					PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0,
							i_2_, i_3_, is_4_, 0, i_2_);
					pixelgrabber.grabPixels();
					class57 = Class373.aClass_ra4071.method5031(is_4_, 0, i_2_,
							i_2_, i_3_, 708696378);
					break;
	...
	static final void method2083(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jl.du(").append(')').toString());
		}
	}

	static final void method2084(int i, int i_6_, int i_7_, int i_8_, int i_9_,
			int i_10_, int i_11_) {
		try {
			for (Class302_Sub4 class302_sub4 = ((Class302_Sub4) client.aClass442_8650
					.method5868(-16777216)); null != class302_sub4; class302_sub4 = (Class302_Sub4) client.aClass442_8650
					.method5872(1278684124)) {
				if (client.anInt8884 * 443738891 >= 591467947 * ((Class302_Sub4) class302_sub4).anInt7655)
					class302_sub4.method3714(1699061251);
				else {
					Class139
							.method1549(
									(((Class302_Sub4) class302_sub4).anInt7653 * 1759796085),
									256 + ((((Class302_Sub4) class302_sub4).anInt7652 * 1495033107) << 9),
									256 + ((-1852462101 * ((Class302_Sub4) class302_sub4).anInt7656) << 9),
									587842750 * ((Class302_Sub4) class302_sub4).anInt7654,
									-549885479);
					Class101.aClass264_1084
							.method2490(
									((Class302_Sub4) class302_sub4).aString7657,
									(int) ((float) i + client.aFloatArray8891[0]),
									(int) (client.aFloatArray8891[1] + (float) i_6_),
									~0xffffff
											| 1160845051
											* ((Class302_Sub4) class302_sub4).anInt7651,
									0, 8619684);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jl.ji(").append(')').toString());
		}
	}
