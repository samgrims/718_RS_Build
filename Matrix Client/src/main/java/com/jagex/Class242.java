package com.jagex;/* Class242 - Decompiled by JODE
...
public abstract class Class242 {
	...
	static final void method2268(Class403 class403, int i) {
		try {
			...
			Class238
					.method2200(
							class139s[(((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239])],
							(class133s[(((Class403) class403).anIntArray5244[1 + 681479919 * ((Class403) class403).anInt5239])]),
							...
							(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 5]),
							(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 6]),
							(((Class403) class403).anIntArray5244[7 + 681479919 * ((Class403) class403).anInt5239]),
							(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 8]),
							(((Class403) class403).anIntArray5244[9 + 681479919 * ((Class403) class403).anInt5239]),
							(((Class403) class403).anIntArray5244[10 + 681479919 * ((Class403) class403).anInt5239]),
							-1940539575);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kd.se(").append(')').toString());
		}
	}

	static void method2269(int i, int i_6_, int i_7_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(13,
					(long) i);
			class298_sub37_sub12.method3449((byte) 67);
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 = i_6_ * 1274450087;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kd.aq(").append(')').toString());
		}
	}
}
