...
public class Class298_Sub32_Sub29 extends Class298_Sub32 {
	...
	void method3318(int i, RsByteBuffer class298_sub53) {
		if (i == 0)
			((Class298_Sub32_Sub29) this).anInt9503 = class298_sub53
					.readUnsignedShort() * 1358727707;
	}
	...
	int[][] method3132(int i, byte i_0_) {
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				int i_1_ = (((Class298_Sub32_Sub29) this).anInt9504
						* -1304311833 * ((-275760121
						* ((Class298_Sub32_Sub29) this).anInt9506 != Class250.anInt2756 * 461985445) ? (((Class298_Sub32_Sub29) this).anInt9506
						* -275760121 * i / (461985445 * Class250.anInt2756))
						: i));
				int[] is_2_ = is[0];
				int[] is_3_ = is[1];
				int[] is_4_ = is[2];
				if (Class250.anInt2755 * -1474554145 == ((Class298_Sub32_Sub29) this).anInt9504
						* -1304311833) {
					...
					for (int i_7_ = 0; i_7_ < -1474554145 * Class250.anInt2755; i_7_++) {
						int i_8_ = (i_7_
								* (((Class298_Sub32_Sub29) this).anInt9504 * -1304311833) / (Class250.anInt2755 * -1474554145));
						int i_9_ = (((Class298_Sub32_Sub29) this).anIntArray9505[i_1_
								+ i_8_]);
	...
	void method3130(int i, int i_10_, int i_11_) {
		try {
			...
			if (((Class298_Sub32_Sub29) this).anInt9503 * -69124077 >= 0
					&& null != Class294.anInterface_ma3166) {
				int i_12_ = ((Class294.anInterface_ma3166.method174(-69124077
						* ((Class298_Sub32_Sub29) this).anInt9503, 816226410).aBoolean518) ? 64
						: 128);
				((Class298_Sub32_Sub29) this).anIntArray9505 = (Class294.anInterface_ma3166
						.method171(-69124077
								* ((Class298_Sub32_Sub29) this).anInt9503,
	...
	int[][] method3322(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int i_13_ = (((Class298_Sub32_Sub29) this).anInt9504 * -1304311833 * ((-275760121
					* ((Class298_Sub32_Sub29) this).anInt9506 != Class250.anInt2756 * 461985445) ? (((Class298_Sub32_Sub29) this).anInt9506
					* -275760121 * i / (461985445 * Class250.anInt2756))
					: i));
			int[] is_14_ = is[0];
			...
			if (Class250.anInt2755 * -1474554145 == ((Class298_Sub32_Sub29) this).anInt9504
				...
				for (int i_19_ = 0; i_19_ < -1474554145 * Class250.anInt2755; i_19_++) {
					int i_20_ = (i_19_
							* (((Class298_Sub32_Sub29) this).anInt9504 * -1304311833) / (Class250.anInt2755 * -1474554145));
					int i_21_ = (((Class298_Sub32_Sub29) this).anIntArray9505[i_13_
							+ i_20_]);
	...
	int[][] method3323(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int i_22_ = (((Class298_Sub32_Sub29) this).anInt9504 * -1304311833 * ((-275760121
					* ((Class298_Sub32_Sub29) this).anInt9506 != Class250.anInt2756 * 461985445) ? (((Class298_Sub32_Sub29) this).anInt9506
					* -275760121 * i / (461985445 * Class250.anInt2756))
					: i));
			int[] is_23_ = is[0];
			...
			if (Class250.anInt2755 * -1474554145 == ((Class298_Sub32_Sub29) this).anInt9504
				...
				for (int i_28_ = 0; i_28_ < -1474554145 * Class250.anInt2755; i_28_++) {
					int i_29_ = (i_28_
							* (((Class298_Sub32_Sub29) this).anInt9504 * -1304311833) / (Class250.anInt2755 * -1474554145));
					int i_30_ = (((Class298_Sub32_Sub29) this).anIntArray9505[i_22_
							+ i_29_]);
	...
	void method3324(int i, int i_31_) {
		...
		if (((Class298_Sub32_Sub29) this).anInt9503 * -69124077 >= 0
				&& null != Class294.anInterface_ma3166) {
			int i_32_ = ((Class294.anInterface_ma3166.method174(-69124077
					* ((Class298_Sub32_Sub29) this).anInt9503, 1192750196).aBoolean518) ? 64
					: 128);
			((Class298_Sub32_Sub29) this).anIntArray9505 = (Class294.anInterface_ma3166
					.method171(-69124077
							* ((Class298_Sub32_Sub29) this).anInt9503, 1.0F,
							i_32_, i_32_, false, -234790231));
	...
	void method3330(int i, int i_34_) {
		...
		if (((Class298_Sub32_Sub29) this).anInt9503 * -69124077 >= 0
				&& null != Class294.anInterface_ma3166) {
			int i_35_ = ((Class294.anInterface_ma3166.method174(-69124077
					* ((Class298_Sub32_Sub29) this).anInt9503, 607579585).aBoolean518) ? 64
					: 128);
			((Class298_Sub32_Sub29) this).anIntArray9505 = (Class294.anInterface_ma3166
					.method171(-69124077
							* ((Class298_Sub32_Sub29) this).anInt9503, 1.0F,
							i_35_, i_35_, false, 626013006));
