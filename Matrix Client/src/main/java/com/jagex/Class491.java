...
public class Class491 {
	...
	public Class492 method6172(int i, int i_0_) {
		try {
			Class492 class492;
			synchronized (((Class491) this).aClass348_6079) {
				class492 = (Class492) ((Class491) this).aClass348_6079
						.method4184((long) i);
			}
			if (null != class492)
				return class492;
			...
			synchronized (((Class491) this).aClass243_6076) {
				is = (((Class491) this).aClass243_6076.method2315(-1006924897
						* SignLink.aClass120_1438.anInt1460, i, (byte) -68));
			}
	...
	public void method6174(int i, byte i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uf.b(").append(')').toString());
		}
	}

	public Class491(Class411 class411, Class429 class429, Class243 class243,
		...
		((Class491) this).aClass243_6076.filesCount(
				(SignLink.aClass120_1438.anInt1460) * -1006924897, -1015661848);
	}
	...
	static final void method6175(long l) {
		try {
			...
			int i_3_ = client.anInt8742 * 1874511679
					+ (int) class217.aFloat2454;
			if (Class75.anInt708 * 1103750049 - i < -2000
					|| Class75.anInt708 * 1103750049 - i > 2000
					|| Class106.anInt1309 * 1346160791 - i_3_ < -2000
					|| Class106.anInt1309 * 1346160791 - i_3_ > 2000) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uf.hx(").append(')').toString());
		}
	}

	public static Class139[] method6176(byte i) {
		try {
			return (new Class139[] { Class139.aClass139_1547,
					Class139.aClass139_1546, Class139.aClass139_1545 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uf.a(").append(')').toString());
		}
