...
public class Class207 {
	...
	void method1928(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
				aChar2358 = Class493.method6190(class298_sub53
						.readByte(-12558881), 2055712019);
			else if (5 == i)
				anInt2359 = class298_sub53.readUnsignedShort() * 1981336427;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("is.f(").append(')').toString());
		}
	}
	...
	static final void method1929(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1154
					* -1309843523;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("is.pr(").append(')').toString());
		}
	}
	...
	static int method1931(Class343_Sub1 class343_sub1,
			Class343_Sub1 class343_sub1_3_, int i, boolean bool, int i_4_) {
		try {
			if (1 == i) {
			...
			if (i == 2)
				return Class26.method397(
						(class343_sub1.method4163(1486003850).aString3819),
						(class343_sub1_3_.method4163(1779443598).aString3819),
						Class321.aClass429_3357, -1018238154);
			if (3 == i) {
				...
				if (class343_sub1_3_.aString7719.equals("-"))
					return bool ? 1 : -1;
				return Class26.method397(class343_sub1.aString7719,
						class343_sub1_3_.aString7719, Class321.aClass429_3357,
						-1275230374);
			}
			if (i == 4)
				return (class343_sub1.method4157(-963368374) ? class343_sub1_3_
						.method4157(740881863) ? 0 : 1 : class343_sub1_3_
						.method4157(229552705) ? -1 : 0);
			if (i == 5)
				return (class343_sub1.method4155((byte) -26) ? class343_sub1_3_
						.method4155((byte) 52) ? 0 : 1 : class343_sub1_3_
						.method4155((byte) -31) ? -1 : 0);
			if (i == 6)
				return (class343_sub1.method4156(1077942153) ? class343_sub1_3_
						.method4156(1938157273) ? 0 : 1 : class343_sub1_3_
						.method4156(807716549) ? -1 : 0);
			if (i == 7)
				return (class343_sub1.method4158(1154945223) ? class343_sub1_3_
						.method4158(1235018049) ? 0 : 1 : class343_sub1_3_
						.method4158(2089010141) ? -1 : 0);
			if (i == 8) {
			...
			return (-15394297 * class343_sub1.anInt7717 - -15394297
					* class343_sub1_3_.anInt7717);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("is.q(").append(')').toString());
		}
	}
	...
	static final void method1932(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("is.fk(").append(')').toString());
		}
	}

	public static String method1933(Class298_Sub37_Sub15 class298_sub37_sub15,
			int i) {
		try {
	...
	static final void method1935(Class403 class403, byte i) {
		try {
			...
			else if (6 == 154600941 * Class12.aClass298_Sub44_9946.anInt7492
