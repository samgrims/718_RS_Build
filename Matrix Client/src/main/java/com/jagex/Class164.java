...
public class Class164 {
	...
	void method1778(Class137 class137) {
		method1779(class137, ((Class164) this).anInterface7_Impl2_1695, 0,
				((Class164) this).anInt1694);
	}

	void method1779(Class137 class137, Interface7_Impl2 interface7_impl2,
			int i, int i_0_) {
		if (i_0_ > 0) {
			method1780();
			...
			class137.anInt1533 = (((Class164) this).anInt1698
					- ((Class164) this).anInt1697 + 1);
	...
	Class164(Class_ra_Sub3 class_ra_sub3, Class169 class169,
			Class_xa_Sub1 class_xa_sub1, int i, int i_1_, int i_2_, int i_3_,
			int i_4_) {
		...
		if (i_6_ > 0) {
			...
			((Class164) this).anInterface7_Impl2_1695 = ((Class164) this).aClass_ra_Sub3_1696
					.method5381(false);
			...
			for (int i_12_ = 0; i_12_ < i_5_; i_12_++) {
				int i_13_ = ((i_8_ + i_12_)
						* (class_xa_sub1.anInt6287 * -506105871) + i_7_);
			...
			((Class164) this).anInterface7_Impl2_1695.method63(0, bytebuffer
					.position(),
					((Class164) this).aClass_ra_Sub3_1696.aLong8217);
	...
	void method1780() {
		if (((Class164) this).aBoolean1692) {
			...
			if (((Class164) this).anInterface9_Impl2_1686 != null
				...
				((Class164) this).anInt1693 = i;
				int i_21_ = 0;
				i_18_ = (((Class164) this).anInt1690 + ((Class164) this).anInt1688
						* i_17_);
				if (((Class164) this).aClass_ra_Sub3_1696.method5348(
						Class55.aClass55_567, Class77.aClass77_717)) {
					...
					if (((Class164) this).anInterface9_Impl2_1686 == null) {
						((Class164) this).anInterface9_Impl2_1686 = (((Class164) this).aClass_ra_Sub3_1696
								.method5351(Class55.aClass55_567, 128, 128,
										false, aByteArray1691));
						((Class164) this).anInterface9_Impl2_1686.method80(
								false, false);
					} else
						((Class164) this).anInterface9_Impl2_1686.method82(0,
								0, 128, 128, aByteArray1691,
								Class55.aClass55_567, 0, 128);
				} else {
					...
					if (((Class164) this).anInterface9_Impl2_1686 == null) {
						((Class164) this).anInterface9_Impl2_1686 = ((Class164) this).aClass_ra_Sub3_1696
								.method5350(128, 128, false, anIntArray1699);
						((Class164) this).anInterface9_Impl2_1686.method80(
								false, false);
					} else
						((Class164) this).anInterface9_Impl2_1686.method81(0,
								0, 128, 128, anIntArray1699, 0, 128);
				}
			}
		}
	}
