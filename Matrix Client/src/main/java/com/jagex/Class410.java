...
public class Class410 {
	...
	static final void method4980(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("r.agk(").append(')').toString());
		}
	}

	static final void method4981(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			class105.anInt1170 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -695431873;
	...
	static final void method4983(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("r.aew(").append(')').toString());
		}
	}

	static final void method4984(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			...
			class105.anObjectArray1247 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("r.oj(").append(')').toString());
		}
	}
