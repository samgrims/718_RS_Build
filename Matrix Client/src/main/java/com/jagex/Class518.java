	...
	public Class298_Sub37_Sub10 method6311(int i, int i_0_) {
		try {
			...
			synchronized (((Class518) this).aClass348_6272) {
				class298_sub37_sub10 = ((Class298_Sub37_Sub10) ((Class518) this).aClass348_6272
						.method4184((long) i));
			}
			...
			if (null != is)
				class298_sub37_sub10.method3444(new RsByteBuffer(is),
						(byte) -66);
			synchronized (((Class518) this).aClass348_6272) {
				((Class518) this).aClass348_6272.method4194(
						class298_sub37_sub10, (long) i);
			}
			return class298_sub37_sub10;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vu.a(").append(')').toString());
		}
	}
	...
	public static boolean method6313(int i, int i_2_) {
		try {
			for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480
				...
				if (Class302
						.method3716(
								(((Class298_Sub37_Sub15) class298_sub37_sub15).anInt9662 * 946432351),
								-77764350)
						&& ((long) i == (((Class298_Sub37_Sub15) class298_sub37_sub15).aLong9661) * 2236412381003659263L))
					return true;
			}
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vu.j(").append(')').toString());
		}
	}

	static void method6314(int i, int i_3_) {
		try {
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub30_7575
					.method5730(1899706472) == 0)
				i = -1;
			if (client.anInt8834 * 1396956439 != i) {
				if (-1 != i) {
					Class492 class492 = Class_na.aClass491_9686.method6172(i,
							16711935);
					IndexedImage class89 = class492.method6181(1479362312);
					if (class89 != null) {
						Class82_Sub23.aClass295_6921.method2828(
								Class52_Sub2_Sub1.aCanvas9079, class89
										.method990(), class89.method983(),
								class89.method994(), new Point(
										class492.anInt6084 * -1954213555,
										-326899251 * class492.anInt6081));
				...
				if (i == -1 && client.anInt8834 * 1396956439 != -1) {
					Class82_Sub23.aClass295_6921.method2828(
							(Class52_Sub2_Sub1.aCanvas9079), null, -1, -1,
							new Point());
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vu.gv(").append(')').toString());
		}
	}

	static final void method6315(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1251 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -1448553585;
			Tradution.method6054(class105, -1832191963);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vu.fn(").append(')').toString());
		}
	}
