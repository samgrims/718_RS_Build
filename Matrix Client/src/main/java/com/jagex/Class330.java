		...
		try {
			...
			synchronized (this) {
				if (null != ((Class330) this).anIOException3501)
					throw new IOException(((Class330) this).anIOException3501
							.toString());
				int i_2_;
				if (825739053 * ((Class330) this).anInt3497 <= 517453779 * ((Class330) this).anInt3500)
					i_2_ = (((Class330) this).anInt3497
							* 825739053
							+ (75932039 * ((Class330) this).anInt3499 - ((Class330) this).anInt3500 * 517453779) - 1);
				else
					i_2_ = (825739053 * ((Class330) this).anInt3497
							- ((Class330) this).anInt3500 * 517453779 - 1);
				if (i_2_ < i_0_)
					throw new IOException("");
				if (((Class330) this).anInt3500 * 517453779 + i_0_ <= 75932039 * ((Class330) this).anInt3499)
					System.arraycopy(is, i, ((Class330) this).aByteArray3498,
							517453779 * ((Class330) this).anInt3500, i_0_);
				else {
					int i_3_ = (((Class330) this).anInt3499 * 75932039 - ((Class330) this).anInt3500 * 517453779);
					System.arraycopy(is, i, ((Class330) this).aByteArray3498,
							((Class330) this).anInt3500 * 517453779, i_3_);
					System.arraycopy(is, i_3_ + i,
							((Class330) this).aByteArray3498, 0, i_0_ - i_3_);
				}
				((Class330) this).anInt3500 = ((i_0_ + 517453779 * ((Class330) this).anInt3500)
						% (75932039 * ((Class330) this).anInt3499) * -255412133);
				this.notifyAll();
			}
			...
			do {
				...
				try {
					if (i + ((Class330) this).anInt3497 * 825739053 <= 75932039 * ((Class330) this).anInt3499)
						((Class330) this).anOutputStream3496.write(
								((Class330) this).aByteArray3498,
								((Class330) this).anInt3497 * 825739053, i);
					else {
						int i_4_ = (75932039 * ((Class330) this).anInt3499 - ((Class330) this).anInt3497 * 825739053);
						((Class330) this).anOutputStream3496.write(
								((Class330) this).aByteArray3498,
								((Class330) this).anInt3497 * 825739053, i_4_);
						((Class330) this).anOutputStream3496.write(
								((Class330) this).aByteArray3498, 0, i - i_4_);
					}
				} catch (IOException ioexception) {
					synchronized (this) {
						((Class330) this).anIOException3501 = ioexception;
				...
				synchronized (this) {
					((Class330) this).anInt3497 = ((825739053 * ((Class330) this).anInt3497 + i)
							% (((Class330) this).anInt3499 * 75932039) * 1059266725);
				}
			} while (!method3999(-1331950055));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nt.run(").append(')').toString());
		}
	}
	...
	static final boolean method4006(int i, int i_6_, Class336 class336,
		...
		try {
			...
			while (i_15_ != i_14_) {
				...
				if (i_10_ > 0
						&& 0 == Class285.anIntArrayArray3076[i_10_ - 1][i_11_]
						&& (is[i_16_ - 1][i_17_] & 0x42240000) == 0) {
				...
				if (i_11_ > 0
						&& Class285.anIntArrayArray3076[i_10_][i_11_ - 1] == 0
						&& 0 == (is[i_16_][i_17_ - 1] & 0x40a40000)) {
					Class285.routeFinderXArray[i_14_] = i_8_;
				...
				if (i_11_ < 127
						&& 0 == Class285.anIntArrayArray3076[i_10_][i_11_ + 1]
						&& (is[i_16_][1 + i_17_] & 0x48240000) == 0) {
					Class285.routeFinderXArray[i_14_] = i_8_;
				...
				if (i_10_ > 0
						&& i_11_ > 0
						&& Class285.anIntArrayArray3076[i_10_ - 1][i_11_ - 1] == 0
						&& (is[i_16_ - 1][i_17_ - 1] & 0x43a40000) == 0
						&& (is[i_16_ - 1][i_17_] & 0x42240000) == 0
						&& 0 == (is[i_16_][i_17_ - 1] & 0x40a40000)) {
					Class285.routeFinderXArray[i_14_] = i_8_ - 1;
					Class285.routeFinderYArray[i_14_] = i_9_ - 1;
				...
				if (i_10_ < 127
						&& i_11_ > 0
						&& 0 == Class285.anIntArrayArray3076[1 + i_10_][i_11_ - 1]
						&& (is[i_16_ + 1][i_17_ - 1] & 0x60e40000) == 0
						&& (is[i_16_ + 1][i_17_] & 0x60240000) == 0
						&& (is[i_16_][i_17_ - 1] & 0x40a40000) == 0) {
					Class285.routeFinderXArray[i_14_] = i_8_ + 1;
					Class285.routeFinderYArray[i_14_] = i_9_ - 1;
					i_14_ = i_14_ + 1 & 0xfff;
				...
				if (i_10_ > 0
						&& i_11_ < 127
						&& Class285.anIntArrayArray3076[i_10_ - 1][1 + i_11_] == 0
						&& (is[i_16_ - 1][1 + i_17_] & 0x4e240000) == 0
						&& (is[i_16_ - 1][i_17_] & 0x42240000) == 0
						&& 0 == (is[i_16_][1 + i_17_] & 0x48240000)) {
					Class285.routeFinderXArray[i_14_] = i_8_ - 1;
					Class285.routeFinderYArray[i_14_] = i_9_ + 1;
					i_14_ = i_14_ + 1 & 0xfff;
				...
				if (i_10_ < 127
						&& i_11_ < 127
						&& Class285.anIntArrayArray3076[1 + i_10_][1 + i_11_] == 0
						&& 0 == (is[1 + i_16_][1 + i_17_] & 0x78240000)
						&& 0 == (is[1 + i_16_][i_17_] & 0x60240000)
						&& 0 == (is[i_16_][i_17_ + 1] & 0x48240000)) {
