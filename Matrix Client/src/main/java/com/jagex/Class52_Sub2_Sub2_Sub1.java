package com.jagex;/* Class52_Sub2_Sub2_Sub1 - Decompiled by JODE
...
public class Class52_Sub2_Sub2_Sub1 extends Class52_Sub2_Sub2 {
	...
	public void method138() {
		((Class52_Sub2_Sub2_Sub1) this).anOpenGL9988.releaseSurface(
				((Class52_Sub2_Sub2_Sub1) this).aCanvas9991,
				((Class52_Sub2_Sub2_Sub1) this).aLong9989);
	}

	Class52_Sub2_Sub2_Sub1(Class_ra_Sub3_Sub1 class_ra_sub3_sub1,
	...
	void method595() {
		Dimension dimension = ((Class52_Sub2_Sub2_Sub1) this).aCanvas9991
				.getSize();
	...
	boolean method136() {
		return (((Class52_Sub2_Sub2_Sub1) this).anOpenGL9988
				.setSurface(((Class52_Sub2_Sub2_Sub1) this).aLong9989) && super
				.method136());
	}
	...
	void method582(int i, int i_2_) {
		((Class52_Sub2_Sub2_Sub1) this).anOpenGL9988
				.surfaceResized(((Class52_Sub2_Sub2_Sub1) this).aLong9989);
		method595();
	...
	public int method580() {
		((Class52_Sub2_Sub2_Sub1) this).anOpenGL9988
				.swapBuffers(((Class52_Sub2_Sub2_Sub1) this).aLong9989);
		return 0;
	}
	...
	Class52_Sub2_Sub2_Sub1(Class_ra_Sub3_Sub1 class_ra_sub3_sub1, Canvas canvas) {
		this(class_ra_sub3_sub1, canvas,
				((Class_ra_Sub3_Sub1) class_ra_sub3_sub1).anOpenGL9826
