...
public class Class231 {
		...
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318
					.method4307(
							...
							245040087).method4569(Class128.aClass148_6331,
							-1502876946) ? 1 : 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jt.q(").append(')').toString());
		}
	}
	...
	static final void method2130(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub8_7566
					.method5653(-621430736) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jt.ani(").append(')').toString());
		}
	}

	static final void method2131(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1267 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jt.mz(").append(')').toString());
		}
	}
	...
	static final void method2132(byte i, int i_0_) {
		try {
			...
			if (is == null) {
				is = (new byte[4][client.aClass283_8716.method2629(-1981468107)][client.aClass283_8716
						.method2630(1256544033)]);
				client.aClass283_8716.method2643(is, 1496940593);
			}
			for (int i_1_ = 0; i_1_ < 4; i_1_++) {
				for (int i_2_ = 0; i_2_ < client.aClass283_8716
						.method2629(-2064419081); i_2_++) {
					for (int i_3_ = 0; i_3_ < client.aClass283_8716
							.method2630(764955570); i_3_++)
						is[i_1_][i_2_][i_3_] = i;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jt.im(").append(')').toString());
		}
	}
		...
		try {
			...
			if (Class287.myPlayer.aClass366_10209 != null)
				Class287.myPlayer.aClass366_10209
						.method4539(i_4_, i_5_, (byte) 108);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jt.co(").append(')').toString());
		}
	}
	...
	static final void method2134(Class403 class403, int i) {
		try {
			...
			if (client.anInt8942 * 1131012101 == 2
					&& i_6_ < -1054937867 * client.anInt8941) {
