...
public class Class159 {
	...
	Class159(Class_ra_Sub3 class_ra_sub3) {
		...
		if (aBoolean1621
				&& !((Class159) this).aClass_ra_Sub3_1618.method5349(
						Class55.aClass55_565, Class77.aClass77_717))
			aBoolean1621 = false;
		if (aBoolean1621
				|| ((Class159) this).aClass_ra_Sub3_1618.method5348(
						Class55.aClass55_565, Class77.aClass77_717)) {
			method1706();
			if (!aBoolean1621) {
				((Class159) this).anInterface9_Impl2Array1620 = new Interface9_Impl2[16];
				for (int i = 0; i < 16; i++) {
					byte[] is = Class415.method5586(anObject1622, i * 32768,
							32768, (byte) 1);
					((Class159) this).anInterface9_Impl2Array1620[i] = (((Class159) this).aClass_ra_Sub3_1618
							.method5351(Class55.aClass55_565, 128, 128, true,
									is));
				}
				anInterface9_Impl2Array1624 = new Interface9_Impl2[16];
				for (int i = 0; i < 16; i++) {
					byte[] is = Class415.method5586(anObject1628, i * 32768,
							32768, (byte) 1);
					anInterface9_Impl2Array1624[i] = (((Class159) this).aClass_ra_Sub3_1618
							.method5351(Class55.aClass55_565, 128, 128, true,
									is));
				}
			} else {
				byte[] is = Class338
						.method4114(anObject1622, false, 1565550558);
				((Class159) this).anInterface9_Impl3_1623 = (((Class159) this).aClass_ra_Sub3_1618
						.method5416(Class55.aClass55_565, 128, 128, 16, true,
								is));
				is = Class338.method4114(anObject1628, false, -1292209598);
				anInterface9_Impl3_1625 = (((Class159) this).aClass_ra_Sub3_1618
						.method5416(Class55.aClass55_565, 128, 128, 16, true,
								is));
			}
		}
	...
	public boolean method1704() {
		return (aBoolean1621 ? ((Class159) this).anInterface9_Impl3_1623 != null
				: ((Class159) this).anInterface9_Impl2Array1620 != null);
	}
	...
	public boolean method1705() {
		...
		if (anInterface9_Impl3_1626 == null) {
			if (anObject1629 == null) {
				byte[] is = Class306.method3756(128, 128, 16, 8,
						new Class307_Sub1(419684), 4.0F, 4.0F, 16.0F, 0.5F,
						0.6F);
			...
			for (int i_1_ = 0; i_1_ < 16; i_1_++) {
				...
				for (int i_4_ = 0; i_4_ < 128; i_4_++) {
					...
					for (int i_8_ = 0; i_8_ < 128; i_8_++) {
						float f = (float) ((is[i_6_ + i_8_] & 0xff) - (is[i_7_
								+ i_8_] & 0xff));
						float f_9_ = (float) ((is[i_5_ + (i_8_ - 1 & 0x7f)] & 0xff) - (is[i_5_
								+ (i_8_ + 1 & 0x7f)] & 0xff));
						float f_10_ = (float) (128.0 / Math.sqrt((double) (f_9_
								* f_9_ + 16384.0F + f * f)));
			...
			anInterface9_Impl3_1626 = (((Class159) this).aClass_ra_Sub3_1618
					.method5416(Class55.aClass55_557, 128, 128, 16, true, is_0_));
		}
