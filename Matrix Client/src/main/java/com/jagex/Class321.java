...
public class Class321 {
	...
	void method3915(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.b(").append(')').toString());
		}
	}

	void method3916(GraphicsToolkit class_ra, int i, int i_0_, int i_1_, int i_2_,
			int i_3_, int i_4_) {
		try {
			aClass298_Sub10_3337 = class_ra.method5049(i, i_0_, i_1_, i_2_,
					i_3_, 1.0F);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.a(").append(')').toString());
		}
	}
	...
	void method3918(int i, boolean bool, byte i_9_) {
		try {
			int i_10_;
			if (!bool) {
				int i_11_ = ((((Class321) this).anInt3354 * 240739725 + i
						* (-195574461 * ((Class321) this).anInt3353) / 50) & 0x7ff);
				...
				i_10_ = 2048;
			aClass298_Sub10_3337.method2896(
					((float) ((-1796735565 * ((Class321) this).anInt3352
							* i_10_ >> 11) + ((Class321) this).anInt3327
							* -884690819) / 2048.0F), (byte) 3);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.p(").append(')').toString());
		}
	}

	public Class321(GraphicsToolkit class_ra, int i, RsByteBuffer class298_sub53,
			int i_12_) {
		...
		i_16_ = (1 << i >> 1) + (i_16_ << i);
		int i_22_ = (Class294.anIntArray3165 != null ? (Class294.anIntArray3165[class298_sub53
				.readUnsignedShort()])
				: (Class379.anIntArray4096[Class173.method1823(class298_sub53
						.readUnsignedShort(), (byte) 0) & 0xffff]));
	...
	static final void method3919(Class403 class403, int i) {
		try {
			...
			if (null != client.aString8804
					&& i_24_ < -1801543887 * Class489.anInt6071)
	...
	static final void method3921(Class403 class403, int i) {
		try {
			...
			String string_25_ = ((String) (((Class403) class403).anObjectArray5240[-203050393
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = new StringBuilder().append(string)
					.append(string_25_).toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.zt(").append(')').toString());
		}
	}
	...
	static final void method3922(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class77
					.method841(i_26_, i_27_, (byte) -125) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.afa(").append(')').toString());
		}
	}
	...
	static final void method3924(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.ady(").append(')').toString());
		}
	}

	static final void method3925(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.iy(").append(')').toString());
		}
	}

	static final void method3926(int i, int i_35_, int i_36_, int i_37_,
			int i_38_) {
		try {
			if (i_36_ >= Class372_Sub2.anInt4049 * 1155384281
					&& i_36_ <= Class372_Sub2.anInt4050 * -1062447355) {
				i = Class463.method6012(i, -1424479739
						* Class372_Sub2.anInt4051,
						1135094847 * Class372_Sub2.anInt4048, -1212608691);
				i_35_ = Class463.method6012(i_35_,
						(Class372_Sub2.anInt4051 * -1424479739),
						Class372_Sub2.anInt4048 * 1135094847, -1212608691);
				Class474.method6072(i, i_35_, i_36_, i_37_, 181729650);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.q(").append(')').toString());
		}
	}
		...
		try {
			...
			try {
				if (i == 1)
					...
					Class255.method2435(new StringBuilder().append("").append(
							914379507 * Class291.anInt6467).toString(),
							1771664525);
				else if (i == 24) {
					Class333 class333 = (client.aClass283_8716
							.method2675(-1611682495).aClass333_3512);
					...
					int i_41_ = (int) ((runtime.totalMemory() - runtime
							.freeMemory()) / 1024L);
					Class255.method2435(new StringBuilder().append("").append(
							i_41_).toString(), 1598262745);
				} else if (10 == i) {
					Class373.method4610(1839277481);
					for (int i_42_ = 0; i_42_ < 10; i_42_++)
						System.gc();
					Runtime runtime = Runtime.getRuntime();
					int i_43_ = (int) ((runtime.totalMemory() - runtime
							.freeMemory()) / 1024L);
					Class255.method2435(new StringBuilder().append("").append(
							i_43_).toString(), 840220855);
					Class234.method2183(-792495658);
					Class373.method4610(-1340221001);
					for (int i_44_ = 0; i_44_ < 10; i_44_++)
						System.gc();
					i_43_ = (int) ((runtime.totalMemory() - runtime
							.freeMemory()) / 1024L);
					Class255.method2435(new StringBuilder().append("").append(
							i_43_).toString(), 1145170625);
				} else if (15 == i)
					Class255.method2435((Class84.aClass305_770
							.method264(-242181565) ? "Success" : "Failure"),
							1719326530);
				else if (2 == i)
					...
					Class52_Sub2_Sub1.aCanvas9079.setLocation(
							1898544019 * Class291.anInt6473,
							540368727 * Class291.anInt6474);
				else if (i == 23)
					Class365_Sub1.method4403((byte) -117);
				else if (21 == i) {
					client.aClass283_8716.aLong3045 = Class122
							.method1319((byte) 1) * 3385627052850178407L;
					...
					Class255.method2435(new StringBuilder().append(
							(int) class217.aFloat2451 >> 9).append(" ").append(
							(int) class217.aFloat2454 >> 9).toString(),
							2030018099);
				} else if (i == 7) {
					Class217 class217 = (Class287.myPlayer
							.method4337().aClass217_2599);
									...
									new StringBuilder()
											...
											.append(
													client.aClass283_8716
															.method2675(-1611682495).aClass_xaArray3517[(Class287.myPlayer.plane)]
															.method6341(
					...
					Class255.method2435(
							new StringBuilder().append(
									IComponentDefinition.aClass348_1135
											.method4192(-262201221))
									.append(" ").append(
											IComponentDefinition.aClass348_1135
													.method4188(-480173906))
									.toString(), 1301637250);
					Class255.method2435(
							new StringBuilder().append(
									IComponentDefinition.aClass348_1138
											.method4192(509188014)).append(" ")
									.append(
											IComponentDefinition.aClass348_1138
													.method4188(2067697941))
									.toString(), 1826870364);
					Class255.method2435(new StringBuilder().append(
							Class298_Sub32_Sub14.aClass477_9400.aClass340_5995
									.method4135()).append(" ").append(
							Class298_Sub32_Sub14.aClass477_9400.aClass340_5995
									.method4133()).toString(), 1449325870);
				} else if (i == 6)
				...
				Class255.method2435(Tradution.aClass470_5782.method6049(
						aClass429_3357, -875414210), 1297300690);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nj.h(").append(')').toString());
		}
	}
}
