...
public class Class463 {
	...
	static void method6014(int i, int i_8_, int i_9_, int i_10_) {
		try {
			if (1008 == i)
				Class126.method1405(Class502.aClass502_6715, i_8_, i_9_,
						67564061);
			else if (i == 1009)
				Class126.method1405(Class502.aClass502_6717, i_8_, i_9_,
						-679680198);
			else if (i == 1010)
				Class126.method1405(Class502.aClass502_6714, i_8_, i_9_,
						-1335757742);
			else if (1011 == i)
				Class126.method1405(Class502.aClass502_6726, i_8_, i_9_,
						-1097682484);
			else if (i == 1012)
				Class126.method1405(Class502.aClass502_6729, i_8_, i_9_,
						-1428410660);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tc.cm(").append(')').toString());
		}
	}
}
