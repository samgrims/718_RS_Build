...
public class Class339 {
	...
	public Class352 method4116(int i, int i_0_) {
		try {
			...
			synchronized (((Class339) this).aClass348_3633) {
				class352 = (Class352) ((Class339) this).aClass348_3633
						.method4184((long) i);
			}
			if (null != class352)
				return class352;
			...
			synchronized (((Class339) this).aClass243_3634) {
				is = (((Class339) this).aClass243_3634.method2315(-1006924897
						* Class120.aClass120_1441.anInt1460, i, (byte) -50));
			}
	...
	public void method4120(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("od.i(").append(')').toString());
		}
	}

	public Class339(Class411 class411, Class429 class429, Class243 class243,
			Class243 class243_4_) {
		((Class339) this).aClass243_3634 = class243;
		((Class339) this).aClass243_3638 = class243_4_;
		((Class339) this).aClass243_3634.filesCount(
				(-1006924897 * (Class120.aClass120_1441.anInt1460)),
				-1187243048);
	}
	...
	static final void method4123(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("od.ux(").append(')').toString());
		}
	}

	static final void method4124(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub14.anInt6875
					* 1196508279 + Class301.anInt3245;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1882038855
					* Class376.anInt4090 + Class301.anInt3238;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("od.adq(").append(')').toString());
		}
	}
		...
		try {
			for (;;) {
				...
				case 0:
					...
					Class87.anInt801 = class298_sub53.readUnsignedShort()
							* -196096943;
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4126(Class403 class403, int i) {
		try {
			...
			((Class403) class403).aClass177_5243.anInt1787 = (((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)])
					* -1496580327;
			((Class403) class403).aClass177_5243.aClass298_Sub37_Sub14_1788 = Class447.aClass469_5618
					.method6045(
							(-2034569943 * (((Class403) class403).aClass177_5243.anInt1787)),
							(short) -31803);
			((Class403) class403).aClass177_5243.anIntArray1789 = new int[((Class403) class403).aClass177_5243.aClass298_Sub37_Sub14_1788
					.method3461((short) -407)];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("od.ace(").append(')').toString());
		}
	}
}
