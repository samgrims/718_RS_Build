...
public class Class_na_Sub1 extends Class_na {
		...
		if (i <= i_2_ && i <= i_3_) {
			if (i_2_ < i_3_) {
				...
				if (i != i_2_ && i_9_ < i_7_ || i == i_2_ && i_9_ > i_8_) {
					...
					while (--i_2_ >= 0) {
						method3484(((Class_na_Sub1) this).aByteArray10017, i,
								0, i_6_ >> 16, i_4_ >> 16);
						i_6_ += i_9_;
						i_4_ += i_7_;
						i += ((Class_na_Sub1) this).anInt10013;
			...
			if (i_3_ < i) {
				...
				if (i_2_ != i_3_ && i_7_ < i_8_ || i_2_ == i_3_ && i_7_ > i_9_) {
					...
					while (--i_3_ >= 0) {
						method3484(((Class_na_Sub1) this).aByteArray10017,
								i_2_, 0, i_4_ >> 16, i_5_ >> 16);
						i_4_ += i_7_;
						i_5_ += i_8_;
						i_2_ += ((Class_na_Sub1) this).anInt10013;
					}
			...
			if (i_8_ < i_9_) {
				...
				while (--i >= 0) {
					method3484(((Class_na_Sub1) this).aByteArray10017, i_3_, 0,
							i_5_ >> 16, i_6_ >> 16);
					i_5_ += i_8_;
					i_6_ += i_9_;
					i_3_ += ((Class_na_Sub1) this).anInt10013;
	...
	static final void method3484(byte[] is, int i, int i_10_, int i_11_,
			int i_12_) {
		if (i_11_ < i_12_) {
			i += i_11_;
			i_10_ = i_12_ - i_11_ >> 2;
