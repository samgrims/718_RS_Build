...
public class Class522 {
	...
	static int method6324(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("w.k(").append(')').toString());
		}
	}

	public static Class282[] method6325(byte i) {
		try {
			return (new Class282[] { Class282.aClass282_6540,
					Class282.aClass282_6543, Class282.aClass282_6541,
					Class282.aClass282_6545 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("w.a(").append(')').toString());
		}
	}

	static final void method6326(IComponentDefinition class105, Class119 class119,
	...
	public static Class343_Sub1 method6328(byte i) {
		try {
			return Class226
					.method2105(
							(1606920449 * Class474.aClass471_5979.worldId),
							(byte) 52);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("w.d(").append(')').toString());
		}
	}
}
