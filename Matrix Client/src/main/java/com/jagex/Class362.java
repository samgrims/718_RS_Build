package com.jagex;/* Class362 - Decompiled by JODE
...
public class Class362 {
	...
	int method4308(Interface23 interface23, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pb.f(").append(')').toString());
		}
	}

	public Class362(Class411 class411, Class429 class429, Class243 class243,
			boolean bool) {
		...
		if (((Class362) this).aClass243_3917 != null)
			((Class362) this).anInt3916 = (((Class362) this).aClass243_3917
					.filesCount(
							-1006924897 * SignLink.aClass120_1440.anInt1460,
							-941078932)) * 70760625;
		else
		...
		if (bool) {
			...
			for (int i = 0; i < ((Class362) this).anInt3916 * 1223397457; i++) {
				...
				synchronized (((Class362) this).aClass243_3917) {
					is = (((Class362) this).aClass243_3917.method2315(
							SignLink.aClass120_1440.anInt1460 * -1006924897, i,
							(byte) -67));
				}
	...
	static final void method4309(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_4_ == 0 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pb.ys(").append(')').toString());
		}
	}
	...
	static final void method4312(Class403 class403, byte i) {
		try {
			...
			if (2 == 1131012101 * client.anInt8942
