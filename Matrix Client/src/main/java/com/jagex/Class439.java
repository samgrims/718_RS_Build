...
public final class Class439 {
	...
	public static final void method5850(String string, int i) {
		try {
			if (null != string) {
				if ((-1054937867 * client.anInt8941 >= 200 && !client.aBoolean8807)
						|| -1054937867 * client.anInt8941 >= 200)
					Class264.method2492(4, (Tradution.aClass470_5831.method6049(
							Class321.aClass429_3357, -875414210)), (byte) -99);
				else {
					String string_0_ = Class173.method1824(string, 554575211);
					if (null != string_0_) {
						for (int i_1_ = 0; i_1_ < client.anInt8941
								* -1054937867; i_1_++) {
							String string_2_ = Class173.method1824(
									(client.aStringArray8704[i_1_]), 460678269);
							if (null != string_2_
							...
							if (client.aStringArray8945[i_1_] != null) {
								String string_3_ = Class173.method1824(
										(client.aStringArray8945[i_1_]),
										-1697709934);
								if (string_3_ != null
						...
						for (int i_4_ = 0; i_4_ < -548972447 * client.anInt8952; i_4_++) {
							String string_5_ = Class173.method1824(
									(client.aStringArray8859[i_4_]), 629913933);
							if (null != string_5_
								...
								Class264
										.method2492(
												...
												new StringBuilder()
														.append(
																Tradution.aClass470_5929
																		.method6049(
																				Class321.aClass429_3357,
																				-875414210))
														.append(string)
														.append(
																Tradution.aClass470_5930
																		.method6049(
																				Class321.aClass429_3357,
																				-875414210))
														.toString(), (byte) -89);
							...
							if (null != client.aStringArray8955[i_4_]) {
								String string_6_ = Class173.method1824(
										(client.aStringArray8955[i_4_]),
										-1007795446);
								if (string_6_ != null
						...
						if (Class173
								.method1824(
										...
										-712250197).equals(string_0_))
							Class264.method2492(4, (Tradution.aClass470_5919
							...
							Class298_Sub36 class298_sub36 = Class18.method359(
									OutcommingPacket.ADD_FRIEND_PACKET,
									class25.aClass449_330, (byte) 14);
							class298_sub36.out
									.writeByte(Class58.method693(string,
											-92805385));
							class298_sub36.out
									.writeString(string, 2126537806);
			...
			if (i != client.anInt8752 * -1233866115) {
				...
				if (i == 4 || 6 == i)
					Class147.method1601((byte) -8);
						...
						&& -1233866115 * client.anInt8752 != 16)
				...
				boolean bool = (7 == i || Class413.method5584(i, 2038230333) || Class299
						.method3682(i, 1765230881));
				boolean bool_8_ = (7 == -1233866115 * client.anInt8752
						|| Class413.method5584(client.anInt8752 * -1233866115,
								2005988447) || Class299.method3682(-1233866115
						* client.anInt8752, 1765230881));
				if (bool != bool_8_) {
					if (bool) {
						Class300.anInt3207 = Class300.anInt3210 * 1701432991;
						if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587
								.method5726(-2145576299) != 0) {
							Class431
									.method5767(
											2,
											Class374_Sub1.aClass243_7731,
											782166935 * Class300.anInt3210,
											0,
											Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587
													.method5726(-2142499578),
											false, 1118626209);
