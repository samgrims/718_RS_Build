package com.jagex;/* Class422_Sub17 - Decompiled by JODE
...
public class Class422_Sub17 extends Class422 {
	...
	public void method5688(int i) {
		try {
			if (aClass298_Sub48_5346.aClass422_Sub10_7548
					.method5661((byte) 108) == 2
					&& -1598873795 * anInt5350 == 2)
	...
	static final void method5690(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adw.ago(").append(')').toString());
		}
	}
}
