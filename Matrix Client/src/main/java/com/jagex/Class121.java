package com.jagex;/* Class121 - Decompiled by JODE
...
final class Class121 implements Interface4 {
	...
	static Class298_Sub48 method1315(int i) {
		try {
			...
			Class298_Sub48 class298_sub48 = new Class298_Sub48(
					client.aClass411_8944, 0);
			try {
				...
				for (int i_2_ = 0; i_2_ < is.length; i_2_ += i_1_) {
					i_1_ = class476.method6081(is, i_2_, is.length - i_2_,
							(short) 4730);
					if (-1 == i_1_)
						throw new IOException();
				}
				class298_sub48 = new Class298_Sub48(new RsByteBuffer(is),
						client.aClass411_8944, 0);
