...
public class Class389 {
	...
	public Class398 method4857(int i, int i_0_) {
		try {
			Class398 class398;
			synchronized (((Class389) this).aClass348_4161) {
				class398 = (Class398) ((Class389) this).aClass348_4161
						.method4184((long) i);
			}
			if (class398 != null)
				return class398;
	...
	public void method4860(int i, int i_2_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qc.f(").append(')').toString());
		}
	}

	public Class389(Class411 class411, Class429 class429, Class243 class243,
			Class243 class243_3_) {
	...
	static final void method4861(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qc.ly(").append(')').toString());
		}
	}

	static final void method4862(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.aBoolean1165 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) == 1;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qc.cr(").append(')').toString());
		}
	}
	...
	static final void method4864(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (GraphicsToolkit.aClass256_5315
					.method2441(i_4_, 2021332528).aCharArray9597[i_5_]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qc.acp(").append(')').toString());
		}
	}
