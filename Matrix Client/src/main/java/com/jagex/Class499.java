...
public class Class499 {
	...
	public Class499(Class411 class411, Class429 class429, Class243 class243) {
		...
		((Class499) this).aClass243_6112.method2316(
	...
	public Class493 method6214(int i, int i_0_) {
		try {
			Class493 class493;
			synchronized (((Class499) this).aClass348_6111) {
				class493 = (Class493) ((Class499) this).aClass348_6111
						.method4184((long) i);
			}
			if (class493 != null)
				return class493;
	...
	public void method6215(int i, int i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uq.b(").append(')').toString());
		}
	}

	static Class411[] method6216(byte i) {
		try {
			return (new Class411[] { Class411.aClass411_5318,
					Class411.aClass411_5320, Class411.aClass411_5316,
					Class411.aClass411_5319, Class411.aClass411_5321 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uq.a(").append(')').toString());
		}
	...
	static final void method6217(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uq.wg(").append(')').toString());
		}
	}

	static final void method6218(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1264 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uq.lu(").append(')').toString());
		}
	}
}
