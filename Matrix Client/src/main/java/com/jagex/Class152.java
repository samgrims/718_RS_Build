...
public class Class152 {
	...
	void method1650(RsByteBuffer class298_sub53, byte i) {
		try {
			((Class152) this).aLong1592 = (class298_sub53
					.readLong((short) 9142) * 1517159550238851441L);
			((Class152) this).aLong1588 = (class298_sub53
					.readLong((short) 28083) * 8735484037837793267L);
			for (int i_0_ = class298_sub53.readUnsignedByte(); i_0_ != 0; i_0_ = class298_sub53
					.readUnsignedByte()) {
				...
				((Class152) this).aClass453_1587.method5935(class298_sub17,
						120722253);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ge.a(").append(')').toString());
		}
	}
	...
	public void method1651(Class298_Sub25 class298_sub25, byte i) {
		try {
			...
			for (Class298_Sub17 class298_sub17 = (Class298_Sub17) ((Class152) this).aClass453_1587
					.method5939(1766612795); class298_sub17 != null; class298_sub17 = ((Class298_Sub17) ((Class152) this).aClass453_1587
					.method5944(49146)))
				class298_sub17.method2918(class298_sub25, -2022437727);
			((Class298_Sub25) class298_sub25).aLong7361 += 8816161044679006451L;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ge.f(").append(')').toString());
		}
	}
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (!bool) {
					...
					Class344.anInt3681 = 2027155497 * (Class344.anInt3681
							* -1264407527 + 1 & (Class65.anIntArray658[Class344.anInt3675 * 1197525581]));
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	static final void method1653(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -2067054685
					* Class52_Sub2.anInt6815;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ge.amo(").append(')').toString());
		}
	}
	...
	static void method1655(Class302_Sub5 class302_sub5, int i) {
		try {
			...
			if (1585762285 * Class302_Sub5.anInt7662 < 20) {
				Class302_Sub5.aClass442_7661.method5870(class302_sub5,
						-104859728);
				Class302_Sub5.anInt7662 += 1704977893;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ge.p(").append(')').toString());
		}
	}

	static final void method1656(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7583
					.method5726(-2143087996);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ge.akl(").append(')').toString());
		}
	}
}
