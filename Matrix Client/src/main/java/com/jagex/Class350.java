	...
	void method4206(RsByteBuffer class298_sub53, int i, int i_0_) {
		try {
			if (1 == i) {
				...
				anInt3736 = (short) (class298_sub53.readUnsignedByte() * 4)
						* -1453025501;
			} else if (i == 27) {
				...
				for (int i_2_ = 0; i_2_ < 6; i_2_++)
					anIntArrayArray3710[i_1_][i_2_] = class298_sub53
							.readShort(2080193946);
			} else if (i == 28) {
				...
				anInt3750 = class298_sub53.readUnsignedShort()
						* -1803824059;
			else if (36 == i)
				...
				for (int i_6_ = 0; i_6_ < i_5_; i_6_++) {
					anIntArray3712[i_6_] = class298_sub53
				...
				for (int i_10_ = 0; i_10_ < 3; i_10_++)
					anIntArrayArray3753[i_9_][i_10_] = class298_sub53
							.readShort(1788063911);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("op.f(").append(')').toString());
		}
	}
	...
	public Class222[] method4207(byte i) {
		try {
			...
			for (int i_11_ = 0; i_11_ < anIntArrayArray3710.length; i_11_++) {
				...
				if (i_12_ == 0 && 0 == i_13_ && 0 == i_14_ && 0 == i_15_
						&& 0 == i_16_ && i_17_ == 0) {
					if (i <= 12)
					...
					if (0 != i_15_)
						class222.method2071(1.0F, 0.0F, 0.0F, Class220
								.method2049(i_15_));
					if (0 != i_16_)
						class222.method2071(0.0F, 1.0F, 0.0F, Class220
								.method2049(i_16_));
					class222.method2064((float) i_12_, (float) i_13_,
							(float) i_14_);
				}
			}
			return ((Class350) this).aClass222Array3718;
	...
	static final void method4212(Class403 class403, short i) {
		try {
			...
			String string = (String) (((Class403) class403).anObjectArray5240[((Class403) class403).anInt5241
					* -203050393]);
			String string_27_ = ((String) (((Class403) class403).anObjectArray5240[1
					+ ((Class403) class403).anInt5241 * -203050393]));
			if (string.length() <= 500 && string_27_.length() <= 500)
				Class291.method2791(i_26_, string, string_27_, 600657777);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("op.aps(").append(')').toString());
		}
	}
	...
	static final void method4217(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547
					.method5612(i_32_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("op.aoc(").append(')').toString());
		}
	}
	...
	static void method4218(int i) {
		try {
			...
			if (-917301319 * Class8.anInt104 != -1
					&& (3224865510845692061L * Class146.aLong1576 < Class122
							.method1319((byte) 1))) {
				for (int i_33_ = Class8.anInt104 * -917301319; i_33_ < Class8.aStringArray109.length; i_33_++) {
					if (Class8.aStringArray109[i_33_].startsWith("pause")) {
						...
						try {
							i_34_ = Integer
									.parseInt(Class8.aStringArray109[i_33_]
											.substring(6));
						} catch (Exception exception) {
							/* empty */
						}
						Class255.method2435(new StringBuilder().append(
								"Pausing for ").append(i_34_).append(
								" seconds...").toString(), 270683370);
			...
			if (0 != 1170859143 * client.anInt8682) {
				...
				if (Class8.anInt103 * -1731316011 >= Class8.anInt102
						* -2035787443)
				...
				if (i_36_ == 80)
					...
					if (Class365_Sub1_Sub5_Sub2.aClipboard9941 != null) {
						...
						for (int i_38_ = Class8.aStringArray107.length - 1; i_38_ >= 0; i_38_--) {
							if (Class8.aStringArray107[i_38_] != null
									&& Class8.aStringArray107[i_38_].length() > 0)
								string = new StringBuilder().append(string)
										.append(Class8.aStringArray107[i_38_])
										.append('\n').toString();
						}
						Class365_Sub1_Sub5_Sub2.aClipboard9941.setContents(
								new StringSelection(string), null);
					}
				} else if (67 == i_36_ && 0 != (i_37_ & 0x4)) {
					if (Class365_Sub1_Sub5_Sub2.aClipboard9941 != null) {
						try {
							Transferable transferable = Class365_Sub1_Sub5_Sub2.aClipboard9941
									.getContents(null);
							if (transferable != null) {
								String string = (String) (transferable
										.getTransferData(DataFlavor.stringFlavor));
								if (null != string) {
									String[] strings = (Class365_Sub1_Sub3_Sub1
											.method4508(string, '\n',
													1017779885));
					...
					Class8.aString101 = new StringBuilder().append(
							Class8.aString101.substring(0,
									((-1182747927 * Class8.anInt99) - 1)))
							.append(
									Class8.aString101.substring(Class8.anInt99
											* -1182747927)).toString();
					Class8.anInt99 -= 1914783065;
				} else if (101 == i_36_
						&& (-1182747927 * Class8.anInt99 < Class8.aString101
								.length()))
					Class8.aString101 = new StringBuilder()
							.append(
									Class8.aString101.substring(0, -1182747927
											* Class8.anInt99))
							.append(
									Class8.aString101
											.substring(1 + (Class8.anInt99 * -1182747927)))
							.toString();
					...
					Class8.anInt99 = Class8.aString101.length() * 1914783065;
						...
						&& (-1217082313 * Class8.anInt105 < Class8.aStringArray107.length)) {
					...
					Class8.anInt99 = Class8.aString101.length() * 1914783065;
				} else if (ObjectDefinitions.method5788(c, (short) 160)
						|| "\\/.:, _-+[]~@".indexOf(c) != -1) {
					Class8.aString101 = new StringBuilder().append(
							Class8.aString101.substring(0, -1182747927
									* Class8.anInt99)).append(
							client.anInterface16Array8710[i_35_]
									.method217((byte) 9)).append(
							Class8.aString101.substring(Class8.anInt99
									* -1182747927)).toString();
					Class8.anInt99 += 1914783065;
				}
