...
public class Class509 {
	...
	void method6283(RsByteBuffer class298_sub53, int i) {
		try {
			anInterface5Array6217 = new Interface5[class298_sub53
					.readUnsignedByte()];
			Class146[] class146s = Class521.method6323(1755655127);
			for (int i_0_ = 0; i_0_ < anInterface5Array6217.length; i_0_++)
				anInterface5Array6217[i_0_] = method6284(class298_sub53,
						(class146s[class298_sub53.readUnsignedByte()]),
						-1580077477);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("va.a(").append(')').toString());
		}
	}

	Interface5 method6284(RsByteBuffer class298_sub53, Class146 class146,
			int i) {
		try {
			...
			if (class146 == Class146.aClass146_1565)
				return Class503.method6247(class298_sub53, 1486124265);
	...
	static final void method6285(Class403 class403, byte i) {
		try {
			...
			ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
					i_1_);
			if (i_2_ >= 1 && i_2_ <= 5
					&& class468.aStringArray5723[i_2_ - 1] != null)
