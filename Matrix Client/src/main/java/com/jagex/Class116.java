...
public class Class116 {
	...
	void method1264(int i, int i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("es.b(").append(')').toString());
		}
	}

	public void method1265(int i, String string, Class298_Sub31 class298_sub31,
			int i_1_) {
		try {
			Class298_Sub31 class298_sub31_2_ = method1263(string, -1827449503);
			if (null != class298_sub31_2_
					&& i != (((Class298_Sub31) class298_sub31_2_).anInt7369 * -1836037967))
		...
		try {
			if (null != class365_sub1_sub1_sub2.anIntArray10092
				...
				for (int i_10_ = 0; i_10_ < class365_sub1_sub1_sub2.anIntArray10092.length; i_10_++) {
					...
					if (-1 == i_11_) {
						if (!class365_sub1_sub1_sub2.method4417(i_10_, -1,
								(byte) 65))
							bool = false;
					} else {
						bool = false;
						...
						if (i_14_ != 0 || 0 != i_15_)
							class365_sub1_sub1_sub2
									.method4417(
											i_10_,
											(int) (Math.atan2((double) i_14_,
													(double) i_15_) * 2607.5945876176133) & 0x3fff,
											(byte) 21);
					}
				}
				if (bool) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("es.hw(").append(')').toString());
		}
	}

	static final void method1271(IComponentDefinition class105, Class119 class119,
	...
	public static void method1272(int i) {
		try {
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					...
					1, -225463890);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub9_7555, 1,
					-1836206886);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					...
					1, -408534755);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581, 2,
					902985868);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub15_7560,
					1, -598361107);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub5_7572, 2,
					-1383392801);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556, 1,
					-906948807);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					...
					0, 1421186288);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563, 2,
					540542372);
			Class422_Sub25.aClass298_Sub48_8425
					.method3540(
							Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558,
							-160182505 * Class115.aClass115_1383.anInt1387,
							-1761179616);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub8_7566, 0,
					-255450456);
			Class422_Sub25.aClass298_Sub48_8425.method3540(
