...
public class Class359 implements Interface19 {
	...
	public boolean method239(Class298_Sub50 class298_sub50,
			Interface16[] interface16s, int i, Class323 class323, int i_1_) {
		try {
			for (int i_2_ = 0; i_2_ < i && i_2_ < interface16s.length; i_2_++) {
				...
				} else if ((interface16.method218((byte) -42) == 843745169 * ((Class359) this).anInt6526)
						&& (interface16.method220((byte) 0) == ((Class359) this).anInt6527
								* -1785843037))
					return true;
			}
			return false;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oz.a(").append(')').toString());
		}
	}

	public boolean method238(Class298_Sub50 class298_sub50,
			Interface16[] interface16s, int i, Class323 class323) {
		for (int i_3_ = 0; i_3_ < i && i_3_ < interface16s.length; i_3_++) {
			Interface16 interface16 = interface16s[i_3_];
			if (interface16 != null
					&& (interface16.method218((byte) -70) == 843745169 * ((Class359) this).anInt6526)
					&& (interface16.method220((byte) 0) == ((Class359) this).anInt6527
							* -1785843037))
				return true;
		}
	...
	public boolean method237(Class298_Sub50 class298_sub50,
			Interface16[] interface16s, int i, Class323 class323) {
		for (int i_4_ = 0; i_4_ < i && i_4_ < interface16s.length; i_4_++) {
			Interface16 interface16 = interface16s[i_4_];
			if (interface16 != null
					&& (interface16.method218((byte) -60) == 843745169 * ((Class359) this).anInt6526)
					&& (interface16.method220((byte) 0) == ((Class359) this).anInt6527
							* -1785843037))
				return true;
		}
	...
	static void method4291(Class119 class119, int i, int i_5_, int i_6_,
			boolean bool, Class403 class403, int i_7_) {
		try {
			if (i_5_ == 0)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oz.z(").append(')').toString());
		}
	}

	static final void method4292(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1270 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oz.nh(").append(')').toString());
		}
	}
	...
	public static void method4294(int i) {
		try {
			...
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557
					.method5687(1870666602) == 0)
				i_12_ |= 0x40;
			Class369.method4572(i_12_, -1404267888);
			client.aClass283_8716.method2641(2004012946).method5791(i_12_,
					-1760580017);
			Class62.aClass248_612.method2384((short) 206).method2641(
					-1884844132).method5791(i_12_, -1760580017);
		...
		try {
			...
			if (14 != -1233866115 * client.anInt8752
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2028,
						client.aClass25_8693.aClass449_330, (byte) 66);
