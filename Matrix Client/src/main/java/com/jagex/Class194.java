...
public class Class194 {
	...
	static final void method1864(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("if.oa(").append(')').toString());
		}
	}

	static final void method1865(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1.anInt7164
					* -863531439 == 4 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("if.agy(").append(')').toString());
		}
	}
	...
	static final void method1866(Class403 class403, int i) {
		try {
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563,
					i_1_, 965049953);
			Class3.method300(656179282);
			client.aBoolean8666 = false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("if.aih(").append(')').toString());
		}
	}
	...
	public static PathStrategy method1867(int i, int i_2_, int i_3_, int i_4_,
		...
		try {
			...
			((Class336_Sub2) Class315.aClass336_Sub2_3309).anInt7714 = -2142070477
					* i_5_;
			return Class315.aClass336_Sub2_3309;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("if.k(").append(')').toString());
		}
	}
	...
	static final void method1869(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("if.pd(").append(')').toString());
		}
	}

	static final void method1870(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			class105.anInt1232 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -7527659;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("if.jq(").append(')').toString());
		}
	}
}
