...
public class Class352 {
	...
	void method4235(RsByteBuffer class298_sub53, int i, short i_1_) {
		try {
			if (1 == i)
				...
				((Class352) this).anInt3797 = class298_sub53
						.readUnsignedShort() * 1896723045;
				if (65535 == -539447443 * ((Class352) this).anInt3797)
					((Class352) this).anInt3797 = -1896723045;
				((Class352) this).anInt3798 = class298_sub53
						.readUnsignedShort()
						* -1225014007;
				if (-869705415 * ((Class352) this).anInt3798 == 65535)
					((Class352) this).anInt3798 = 1225014007;
				((Class352) this).anInt3795 = class298_sub53
						.readInt((byte) -62)
						* -166802393;
				((Class352) this).anInt3796 = class298_sub53
						.readInt((byte) -20)
						* -1288246043;
			} else if (i >= 10 && i <= 14)
				aStringArray3778[i - 10] = class298_sub53
						.readString(-1381247713);
			else if (i == 15) {
				int i_3_ = class298_sub53.readUnsignedByte();
				anIntArray3803 = new int[2 * i_3_];
				for (int i_4_ = 0; i_4_ < 2 * i_3_; i_4_++)
					anIntArray3803[i_4_] = class298_sub53
							.readShort(1914193224);
				...
				((Class352) this).anInt3794 = class298_sub53
						.readBigSmart(1235052657)
						* -1998808761;
			else if (19 == i)
				anInt3817 = class298_sub53.readUnsignedShort()
						* -1012984825;
			else if (20 == i) {
				((Class352) this).anInt3801 = class298_sub53
						.readUnsignedShort()
						* -1125434795;
				if (((Class352) this).anInt3801 * 769127165 == 65535)
					((Class352) this).anInt3801 = 1125434795;
				((Class352) this).anInt3790 = class298_sub53
						.readUnsignedShort()
						* -1435131889;
				if (-1461367057 * ((Class352) this).anInt3790 == 65535)
					((Class352) this).anInt3790 = 1435131889;
				((Class352) this).anInt3815 = class298_sub53
						.readInt((byte) 28) * 1428832641;
				((Class352) this).anInt3800 = class298_sub53
						.readInt((byte) 99) * 1701861307;
			} else if (i == 21)
				...
				anInt3788 = class298_sub53.readUnsignedByte()
						* -1952866083;
			} else if (i == 24) {
		...
		try {
			if (null != anIntArray3803) {
				for (int i_12_ = 0; i_12_ < anIntArray3803.length; i_12_ += 2) {
					...
					else if (anIntArray3803[1 + i_12_] > -1294057761
							* anInt3807)
	...
	public boolean method4237(Interface23 interface23, int i) {
		try {
			...
			if (-1 != -869705415 * ((Class352) this).anInt3798)
				i_13_ = interface23.method252(
						(-869705415 * ((Class352) this).anInt3798), (byte) 44);
			else if (-1 != -539447443 * ((Class352) this).anInt3797)
				i_13_ = interface23.method250(
						(-539447443 * ((Class352) this).anInt3797), (byte) 24);
			else
				return true;
			if (i_13_ < 338289559 * ((Class352) this).anInt3795
					|| i_13_ > -959385363 * ((Class352) this).anInt3796)
				return false;
			boolean bool = false;
			int i_14_;
			if (-1461367057 * ((Class352) this).anInt3790 != -1)
				i_14_ = interface23.method252(
						(((Class352) this).anInt3790 * -1461367057), (byte) 17);
			else if (-1 != ((Class352) this).anInt3801 * 769127165)
				i_14_ = interface23.method250(
						(((Class352) this).anInt3801 * 769127165), (byte) 72);
			else
				return true;
			if (i_14_ < ((Class352) this).anInt3815 * 372768385
					|| i_14_ > 520017267 * ((Class352) this).anInt3800)
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("or.p(").append(')').toString());
		}
	}
	...
	public Class57 method4238(GraphicsToolkit class_ra, boolean bool, int i) {
		try {
			...
			Class57 class57 = (Class57) ((Class339) ((Class352) this).aClass339_3776).aClass348_3635
					.method4184((long) i_16_);
			if (class57 != null)
				return class57;
			if (!((Class339) ((Class352) this).aClass339_3776).aClass243_3638
					.method2310(i_15_, -457216440))
				return null;
			IndexedImage class89 = IndexedImage
					.method987(
							(((Class339) (((Class352) this).aClass339_3776)).aClass243_3638),
							i_15_, 0);
			if (class89 != null) {
				class57 = class_ra.method5125(class89, true);
				((Class339) ((Class352) this).aClass339_3776).aClass348_3635
						.method4194(class57, (long) i_16_);
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("or.i(").append(')').toString());
		}
	}
	...
	public Class57 method4240(GraphicsToolkit class_ra, int i) {
		try {
			Class57 class57 = ((Class57) (((Class339) ((Class352) this).aClass339_3776).aClass348_3635
					.method4184((long) (((Class352) this).anInt3794 * 1027948663 | 0x20000 | class_ra.anInt5298 * 580915349 << 29))));
			if (null != class57)
				return class57;
			((Class339) ((Class352) this).aClass339_3776).aClass243_3638
					.method2310(1027948663 * ((Class352) this).anInt3794,
							-457216440);
			IndexedImage class89 = IndexedImage
					.method987(
							(((Class339) ((Class352) this).aClass339_3776).aClass243_3638),
							((Class352) this).anInt3794 * 1027948663, 0);
			if (class89 != null) {
				class57 = class_ra.method5125(class89, true);
				((Class339) ((Class352) this).aClass339_3776).aClass348_3635
						.method4194(
								class57,
								(long) (((Class352) this).anInt3794 * 1027948663 | 0x20000 | class_ra.anInt5298 * 580915349 << 29));
			}
			return class57;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("or.k(").append(')').toString());
		}
	}
		...
		try {
			...
			Class320
					.method3913(
							...
							(((Class403) class403).anIntArray5244[2 + ((Class403) class403).anInt5239 * 681479919]),
							(((Class403) class403).anIntArray5244[3 + 681479919 * ((Class403) class403).anInt5239]),
							false,
							(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 + 4]),
							2026903657);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("or.to(").append(')').toString());
		}
	}
	...
	static final void method4243(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class300.aClass518_3217
					.method6311(i_20_, 614874976).anInt9604) * 1317156085;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("or.ta(").append(')').toString());
		}
	}
	...
	static final void method4247(Class403 class403, byte i) {
		try {
			...
			Class107.aShortArray1315[(((Class403) class403).anIntArray5244[(681479919 * ((Class403) class403).anInt5239)])] = (short) Class86
					.method964(
	...
	static final void method4248(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = (Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(i_24_).aString5707);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("or.aaj(").append(')').toString());
		}
	}
}
