...
public class Class173 {
	...
	public static void method1820(int i, int i_5_, int i_6_, int i_7_) {
		try {
			...
			if (client.aClass283_8716.method2675(-1611682495) != null
					&& (client.aClass283_8716.method2674(-257896295) != Class266.aClass266_2846)
					&& i_5_ >= 0 && i_6_ >= 0
					&& i_5_ < client.aClass283_8716.method2629(-1890552944)
				...
				if (class298_sub2 == null)
					...
					if (class298_sub12 == null)
						client.aClass283_8716.method2675(-1611682495)
								.method4059(i, i_5_, i_6_, (byte) 28);
					else {
						Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1 = ((Class365_Sub1_Sub4_Sub1) client.aClass283_8716
								.method2675(-1611682495).method4059(i, i_5_,
										i_6_, (byte) 119));
						if (class365_sub1_sub4_sub1 == null)
							class365_sub1_sub4_sub1 = (new Class365_Sub1_Sub4_Sub1(
									client.aClass283_8716
											.method2675(-1611682495),
									i_5_ << 265,
									client.aClass283_8716
											.method2675(-1611682495).aClass_xaArray3517[i]
											.method6341(i_5_, i_6_, (byte) -15),
									i_6_ << 265, i, i));
						else {
							...
							class365_sub1_sub4_sub1.aClass331_7722 = client.aClass283_8716
									.method2675(-1611682495);
						}
						...
						while_66_: do {
							...
							while_65_: do {
								do {
									class298_sub12_11_ = ((Class298_Sub12) class298_sub2.aClass453_7166
											.method5944(49146));
							...
							class365_sub1_sub4_sub1.anInt10145 = -1936319903
									* ((Class298_Sub12) class298_sub12_11_).anInt7256;
							for (;;) {
								Class298_Sub12 class298_sub12_12_ = ((Class298_Sub12) class298_sub2.aClass453_7166
										.method5944(49146));
								...
								if (class298_sub12_12_.anInt7257 * 1768239597 != -441234013
										* (class365_sub1_sub4_sub1.anInt10152)) {
						...
						int i_13_ = Class356.method4271(256 + (i_5_ << 9),
								256 + (i_6_ << 9), i, -859881334);
						class365_sub1_sub4_sub1.method4341(
								(float) (i_5_ << 265), (float) i_13_,
								(float) (i_6_ << 265));
						class365_sub1_sub4_sub1.anInt10142 = 0;
						class365_sub1_sub4_sub1.plane = (byte) i;
						class365_sub1_sub4_sub1.aByte7724 = (byte) i;
						if (client.aClass283_8716.method2654(361928521)
								.method2320(i_5_, i_6_, -1635198415))
							class365_sub1_sub4_sub1.aByte7724++;
						client.aClass283_8716.method2675(-1611682495)
								.method4053(i, i_5_, i_6_, i_13_,
										class365_sub1_sub4_sub1, 1648403764);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public static final void method1822(int viewLocalX, int viewLocalY, int viewZ, int speed1,
			int speed2, byte i_23_) {
		try {
			...
			if (Class427.anInt5362 * 1179258959 >= 100) {
				...
				int i_26_ = (Class356.method4271(i_24_, i_25_,
						Class99.anInt952 * 1855729883, -1477224800) - Class18.anInt255 * 771695069);
				...
				int i_30_ = (int) Math.sqrt((double) (i_29_ * i_29_ + i_27_
						* i_27_));
				client.anInt8756 = ((int) (Math.atan2((double) i_28_,
						(double) i_30_) * 2607.5945876176133) & 0x3fff)
						* -648269561;
				Class135.anInt6384 = ((int) (Math.atan2((double) i_27_,
						(double) i_29_) * -2607.5945876176133) & 0x3fff)
						* -1587695039;
	...
	static final void method1825(Class403 class403, int i) {
		try {
			...
			Class52_Sub1_Sub1.method568(class105, class119, class403,
					(byte) -37);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("he.dj(").append(')').toString());
		}
	}
	...
	static void method1826(int i) {
		try {
			...
			if (1265667685 * Class301_Sub1.anInt7626 >= 0
					&& 1265667685 * Class301_Sub1.anInt7626 != 0) {
				Class370.method4578(1265667685 * Class301_Sub1.anInt7626,
						false, 622850291);
				Class301_Sub1.anInt7626 = -485258093;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("he.cs(").append(')').toString());
		}
	}
}
