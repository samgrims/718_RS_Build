...
public class Class325 {
	...
	void method3961(RsByteBuffer class298_sub53, int i, int i_0_) {
		try {
			if (1 == i)
				((Class325) this).anInt3450 = class298_sub53
						.readUnsignedShort() * 192677437;
			else if (2 == i) {
				((Class325) this).anIntArray3451 = new int[class298_sub53
						.readUnsignedByte()];
				for (int i_1_ = 0; i_1_ < ((Class325) this).anIntArray3451.length; i_1_++)
					((Class325) this).anIntArray3451[i_1_] = class298_sub53
							.readUnsignedShort();
			} else if (3 == i)
				((Class325) this).anInt3449 = class298_sub53
						.readUnsignedByte()
						* -2100310889;
			else if (4 == i)
				((Class325) this).aClass320_3452 = ((Class320) Class422_Sub20
						.method5701(Class74.method825(-151911925),
								class298_sub53.readUnsignedByte(), (byte) 2));
			else if (5 == i)
				((Class325) this).anInt3453 = class298_sub53
						.readBigSmart(1235052657)
						* -544205675;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("no.f(").append(')').toString());
		}
	}
	...
	static final void method3965(Class403 class403, int i) {
		try {
			...
			Class102 class102 = Class298_Sub40_Sub13.method3517(i_9_,
					1408826506);
			String string = "";
