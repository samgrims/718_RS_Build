...
public class Class422_Sub23 extends Class422 {
	...
	static final void method5710(int i) {
		try {
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub17_7565
					.method5689(-2013953489) == 2) {
				byte[][][] is = client.aClass283_8716.method2642(899241973);
				byte i_2_ = (byte) (-1953789277 * client.anInt8777 - 4 & 0xff);
				int i_3_ = (-1953789277 * client.anInt8777 % client.aClass283_8716
						.method2629(-2129604944));
				for (int i_4_ = 0; i_4_ < 4; i_4_++) {
					for (int i_5_ = 0; i_5_ < client.aClass283_8716
							.method2630(-605085367); i_5_++)
				...
				if (Class99.anInt952 * 1855729883 != 3) {
					...
					Class244 class244 = client.aClass283_8716
							.method2654(688600578);
					Class331 class331 = client.aClass283_8716
							.method2675(-1611682495);
					while_15_: do {
						if (Class298_Sub1.anInt7164 * -863531439 == 4
								|| Class100.anInt1081 * 1329981847 != -1) {
							...
							if (((class244.aByteArrayArrayArray2731[1855729883 * Class99.anInt952][i_7_ >> 9][i_8_ >> 9]) & 0x4) != 0)
								Class143.method1577(
										class331.aClass326ArrayArrayArray3516,
										0, i_7_ >> 9, i_8_ >> 9, false,
										-777988087);
								...
								if (0 == i_13_
										&& 0 == i_14_
										|| i_13_ <= -client.aClass283_8716
												.method2629(-1952640446)
										|| i_13_ >= client.aClass283_8716
												.method2629(-2135239698)
										|| i_14_ <= -client.aClass283_8716
												.method2630(115807107)
										|| i_14_ >= client.aClass283_8716
												.method2630(-1212701794)) {
							...
							int i_19_ = (Class356.method4271(Class367.anInt4000
									* -1740717447, Class146.anInt1575
									* -299812095,
									Class99.anInt952 * 1855729883, -1780642340));
							if (i_19_ - Class110.anInt6403 * 1449634147 < 3200
									&& ((class244.aByteArrayArrayArray2731[Class99.anInt952 * 1855729883][Class367.anInt4000
											* -1740717447 >> 9][-299812095
											* Class146.anInt1575 >> 9]) & 0x4) != 0)
								Class143.method1577(
										class331.aClass326ArrayArrayArray3516,
										1,
										Class367.anInt4000 * -1740717447 >> 9,
										-299812095 * Class146.anInt1575 >> 9,
										false, -777988087);
						}
					} while (false);
				}
