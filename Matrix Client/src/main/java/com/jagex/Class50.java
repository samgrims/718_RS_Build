...
public class Class50 {
	...
	static {
		...
		new BigInteger(
				"bcbc4d92251300b3c4ade65fa1d315d66e370f300925dc949024628fa32b66d253fb8d2813c775c5c97d32a6bc8aeea94bbd3ae869330b2b4bcf7adc5aea89f5",
				16);
	}
	...
	public static IComponentDefinition getIComponentDefinitions(int parentHash, byte dummyValue) {
		try {
			...
			if (null == Class389.aClass119Array4165[parentId]
					|| (Class389.aClass119Array4165[parentId].method1297(parentHash,
							(short) 3713) == null)) {
				boolean bool = Class378.method4671(parentId, null, -957339129);
				if (!bool)
					return null;
			}
			return Class389.aClass119Array4165[parentId].method1297(parentHash,
					(short) 19883);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.f(").append(')').toString());
		}
	}
	...
	public static void method530(int i, int i_2_) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(
					...
					client.aClass25_8711.aClass449_330, (byte) 24);
			class298_sub36.out.writeInt(-1, -106491517);
			client.aClass25_8711.method390(class298_sub36, (byte) -71);
			Class298_Sub37_Sub10.aClass95_9602 = new Class95(
					Class374_Sub1.aClass243_7731, i);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.ax(").append(')').toString());
		}
	}
	...
	static final void method532(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1168328513
					* client.anInt8837;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.abh(").append(')').toString());
		}
	}
	...
	static void method533(long[] ls, int[] is, int i, int i_3_, int i_4_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.d(").append(')').toString());
		}
	}

	static void method534(byte i) {
		try {
			Class121.anIntArray6321 = Class365_Sub1_Sub3_Sub2.method4513(2048,
					35, 8, 8, 4, 0.4F, true, 33985);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.i(").append(')').toString());
		}
	}

	static final void method535(int i, byte i_12_) {
		try {
			int i_13_ = (client.anInt8884 * 443738891 - client.anInt8921
					* -1656615113);
			if (i_13_ >= 100) {
				...
				if (client.aBooleanArray8684[4]
						&& 128 + client.anIntArray8925[4] > i_14_)
					i_14_ = 128 + client.anIntArray8925[4];
				int i_15_ = ((int) client.aFloat8949 + -1419578297
						* client.anInt8744 & 0x3fff);
				Class217 class217 = (Class287.myPlayer
						.method4337().aClass217_2599);
				Class482
						.method6121(1103750049 * Class75.anInt708, Class356
								.method4271((int) class217.aFloat2451,
										(int) class217.aFloat2454,
										1855729883 * Class99.anInt952,
										-1800819540) - 200,
								1346160791 * Class106.anInt1309, i_14_, i_15_,
								600 + (i_14_ >> 3) * 3 << 2, i, -1059521295);
				float f = 1.0F - ((float) ((100 - i_13_) * ((100 - i_13_) * (100 - i_13_))) / 1000000.0F);
				Class367.anInt4000 = ((int) ((float) (Class301_Sub1.anInt7639 * -1806467999) + f
						* (float) (Class367.anInt4000 * -1740717447 - (-1806467999 * Class301_Sub1.anInt7639))) * 547882953);
				Class110.anInt6403 = (1078403147 * (int) ((float) (1449634147 * Class110.anInt6403 - 2032233737 * Class409.anInt5284)
						* f + (float) (Class409.anInt5284 * 2032233737)));
				Class146.anInt1575 = ((int) (f
						* (float) (Class146.anInt1575 * -299812095 - (1368015401 * Class82_Sub2.anInt6822)) + (float) (1368015401 * Class82_Sub2.anInt6822)) * 309839105);
				client.anInt8756 = ((int) ((float) (-104436553
						* client.anInt8756 - Class21.anInt277 * 827399463)
						* f + (float) (Class21.anInt277 * 827399463)) * -648269561);
				int i_16_ = (Class135.anInt6384 * -1847894591 - -883946017
						* Class298_Sub9.anInt7228);
				if (i_16_ > 8192)
					i_16_ -= 16384;
				else if (i_16_ < -8192)
					i_16_ += 16384;
				...
				Class135.anInt6384 = -1587695039
						* (-1847894591 * Class135.anInt6384 & 0x3fff);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.hz(").append(')').toString());
		}
	}
	...
	static final void method536(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252
					.method1752(i_17_, i_18_, i_19_, 1489690746);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("c.xr(").append(')').toString());
		}
	}
