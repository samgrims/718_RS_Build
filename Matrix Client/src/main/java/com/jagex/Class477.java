...
public class Class477 {
		...
		try {
			...
			if(!forceNew) {
				synchronized (((Class477) this).aClass348_5993) {
					itemdefinition = (ItemDefinitions) ((Class477) this).aClass348_5993
							.method4184((long) itemId);
				}
			...
			itemdefinition.aStringArray5723 = (String[]) ((Class477) this).aStringArray5988
					.clone();
			itemdefinition.aStringArray5732 = (String[]) ((Class477) this).aStringArray6000
					.clone();
			if (null != is)
			...
			if (-1 != itemdefinition.anInt5755 * -1673957995)
				itemdefinition.method6027(getItemDefinitions(
						(itemdefinition.anInt5755 * -1673957995), forceNew),
						getItemDefinitions(809765849 * itemdefinition.anInt5709, forceNew),
						219692629);
			if (itemdefinition.anInt5719 * 465190555 != -1)
				itemdefinition.method6039(getItemDefinitions(itemdefinition.anInt5719 * 465190555, forceNew), getItemDefinitions(
						(-783380935 * (((ItemDefinitions) itemdefinition).anInt5756)), forceNew), -1676050822);
			if (-1 != 2083650097 * itemdefinition.anInt5770)
				itemdefinition.method6036(getItemDefinitions(itemdefinition.anInt5770 * 2083650097, forceNew), getItemDefinitions(
						(1981372535 * (((ItemDefinitions) itemdefinition).anInt5769)), forceNew), -1733915014);
			if (!((Class477) this).aBoolean5999 && itemdefinition.aBoolean5731) {
				...
				if (null != ((ItemDefinitions) itemdefinition).aClass437_5766) {
					boolean bool = false;
					for (Class298 class298 = ((ItemDefinitions) itemdefinition).aClass437_5766
							.method5816(1739772889); class298 != null; class298 = ((ItemDefinitions) itemdefinition).aClass437_5766
							.method5815((byte) -94)) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tq.a(").append(')').toString());
		}
	}

	public Class57 method6085(GraphicsToolkit class_ra, int i, int i_1_, int i_2_,
			int i_3_, int i_4_, Class366 class366, int i_5_) {
		try {
			((Class465) ((Class477) this).aClass465_5996).anInt6519 = -973477563
					* class_ra.anInt5298;
			((Class465) ((Class477) this).aClass465_5996).anInt6514 = i * 1541800549;
			((Class465) ((Class477) this).aClass465_5996).anInt6515 = -1199949713
					* i_1_;
			...
			return (Class57) aClass340_5995
					.method4134(((Class477) this).aClass465_5996);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tq.f(").append(')').toString());
		}
	}

	public Class57 method6086(GraphicsToolkit class_ra, GraphicsToolkit class_ra_6_, int i,
			int i_7_, int i_8_, int i_9_, boolean bool, boolean bool_10_,
			int i_11_, Class264 class264, Class366 class366, int i_12_) {
		try {
			if (!bool_10_) {
				Class57 class57 = method6085(class_ra_6_, i, i_7_, i_8_, i_9_,
						i_11_, class366, 467134725);
				if (null != class57)
					return class57;
			}
			...
			if (i_7_ > 1 && ((ItemDefinitions) class468).anIntArray5752 != null) {
				...
				for (int i_14_ = 0; i_14_ < 10; i_14_++) {
					if (i_7_ >= ((ItemDefinitions) class468).anIntArray5753[i_14_]
							&& 0 != ((ItemDefinitions) class468).anIntArray5753[i_14_])
						i_13_ = ((ItemDefinitions) class468).anIntArray5752[i_14_];
				}
				if (i_13_ != -1)
					class468 = getItemDefinitions(i_13_);
			}
			int[] is = class468.method6031(class_ra, class_ra_6_, i_7_, i_8_,
					i_9_, bool, i_11_, class264, class366, 1026825677);
			if (null == is)
				return null;
			Class57 class57;
			if (bool_10_)
			...
			if (!bool_10_) {
				...
				((Class465) class465).anInt6519 = -973477563
						* class_ra_6_.anInt5298;
	...
	public void method6089(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tq.d(").append(')').toString());
		}
	}

	public Class477(Class411 class411, Class429 class429, boolean bool,
			Class504 class504, Class243 class243, Class243 class243_16_) {
		...
		if (((Class477) this).aClass411_5998 == Class411.aClass411_5320)
			((Class477) this).aStringArray5988 = (new String[] {
					null,
					null,
					Tradution.aClass470_5790.method6049(
							(((Class477) this).aClass429_5997), -875414210),
					null,
					null,
			...
			((Class477) this).aStringArray5988 = (new String[] {
					...
					Tradution.aClass470_5790.method6049(
							(((Class477) this).aClass429_5997), -875414210),
					null, null, null });
		((Class477) this).aStringArray6000 = (new String[] {
				null,
				null,
				null,
				null,
				Tradution.aClass470_5939.method6049(
						(((Class477) this).aClass429_5997), -875414210) });
	}
	...
	static final void method6095(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tq.aku(").append(')').toString());
		}
	}

	public static void method6096(Class243 class243, int i, int i_21_,
			int i_22_, boolean bool, int i_23_) {
		try {
