...
public class Class293 {
	...
	static final void method2819(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class348
					.method4197(i_0_, i_1_, true, (byte) 12);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("me.tw(").append(')').toString());
		}
	}
	...
	static void method2823(int i, boolean bool, byte i_3_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("me.u(").append(')').toString());
		}
	}

	static void method2824(int i, int i_5_, int i_6_, int i_7_, int i_8_,
			int i_9_, int i_10_, int i_11_, int i_12_, byte i_13_) {
		try {
			if (i != i_6_ || i_7_ != i_5_ || i_8_ != i_10_ || i_9_ != i_11_) {
				...
				for (int i_28_ = 128; i_28_ <= 4096; i_28_ += 128) {
					...
					Class224.method2093(i_14_, i_15_, i_37_, i_38_, i_12_,
							-1007757292);
					i_14_ = i_37_;
					i_15_ = i_38_;
				}
