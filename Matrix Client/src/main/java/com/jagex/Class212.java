...
public class Class212 {
	...
	public String method1951(int i) {
		try {
			return new StringBuilder().append("_").append(
					368445667 * ((Class212) this).anInt2432).toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iy.a(").append(')').toString());
		}
	}
	...
	public void method1952(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iy.i(").append(')').toString());
		}
	}

	public Object method1953(Object[] objects, int i) throws Throwable {
		try {
			return Class466.method6022(ClientScriptMap.anApplet6044,
					method1951(-1115089525), objects, (byte) 42);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iy.f(").append(')').toString());
		}
	}

	public Object method1954(int i) throws Throwable {
		try {
			return Class466.method6021(ClientScriptMap.anApplet6044,
					method1951(-1685973242), (short) 7317);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iy.b(").append(')').toString());
		}
	}
