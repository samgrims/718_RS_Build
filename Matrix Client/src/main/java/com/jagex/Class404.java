...
public class Class404 implements Runnable {
	...
	public void run() {
		try {
			for (;;) {
				...
				synchronized (((Class404) this).aQueue5265) {
					Object object;
					for (object = ((Class404) this).aQueue5265.poll(); null == object; object = ((Class404) this).aQueue5265
							.poll()) {
						try {
				...
				try {
					byte[] is = InetAddress.getByName(
							((Class396) class396).aString5194).getAddress();
	...
	static final void method4950(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(i_1_).anInt5733)
					* -906758929;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qu.aai(").append(')').toString());
		}
	}
	...
	static final void method4951(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7570
					.method5677(-1832021198);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qu.akf(").append(')').toString());
		}
	}
		...
		try {
			...
			while (0L != l) {
				...
				if (c == '_') {
					...
					stringbuilder.setCharAt(i_4_, Character
							.toUpperCase(stringbuilder.charAt(i_4_)));
					c = '\u00a0';
				}
				stringbuilder.append(c);
			}
			stringbuilder.reverse();
			stringbuilder.setCharAt(0, Character.toUpperCase(stringbuilder
					.charAt(0)));
	...
	static final void method4953(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1232467723
					* class105.anInt1280;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qu.pv(").append(')').toString());
		}
	}
