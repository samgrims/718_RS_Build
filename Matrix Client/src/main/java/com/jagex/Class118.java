...
public final class Class118 {
	...
	static final void method1287(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eu.dq(").append(')').toString());
		}
	}

	static final void method1288(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1240 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eu.kk(").append(')').toString());
		}
	}
	...
	static final void method1290(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(i_2_).anInt5735) * 1671807857;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eu.aao(").append(')').toString());
		}
	}
	...
	static final void method1292(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((Class403) class403).aClass162_5252
					.method1751(
							(String) (((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 -= 969361751) * -203050393)]),
							131072));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eu.xt(").append(')').toString());
		}
	}

	public static void method1293(int i, int i_3_, int i_4_) {
		try {
			Class301_Sub1.anInt7632 = (i - Class301_Sub1.anInt3245)
					* -433609607;
			Class301_Sub1.anInt7627 = (i_3_ - Class301_Sub1.anInt3238)
					* -789877945;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eu.ct(").append(')').toString());
		}
	}
