...
public class Class51 {
	...
	static final void decodeLswp(RsBitsBuffer class298_sub53_sub2, int i) {
		try {
			...
			player.scenePositionXQueue[0] = i_4_
					- -1760580017 * class341.gameSceneBaseX;
			player.scenePositionYQueue[0] = i_5_
					- class341.gameSceneBaseY * 283514611;
			player
					.method4341(
							(float) ((player.scenePositionXQueue[0] << 9) + (player
									.getSize() << 8)),
							(player.method4343().aClass217_2599.aFloat2455),
							(float) ((player.scenePositionYQueue[0] << 9) + (player
									.getSize() << 8)));
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ca.a(").append(')').toString());
		}
	}

	static final void method542(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550
