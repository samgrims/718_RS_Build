...
public final class Class406 {
	...
	static final void method4960(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (l + l
					* l_0_ / 100L);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qw.yx(").append(')').toString());
		}
	}
		...
		try {
			...
			for (int i_4_ = 0; i_4_ < client.anInt8708 * -1508392173; i_4_++) {
				...
				if (-1402769421 * class365_sub1_sub1_sub2_sub1.anInt10075 != client.anInt8707 * 440189755) {
					if (Class436.aBoolean5478
							&& Class518.method6313(i_5_, 351851633))
						Class194.method1868(2025307040);
					if (class365_sub1_sub1_sub2_sub1.aClass503_10190
							.method6242((byte) 32))
			...
			if (bool_3_) {
				...
				client.anInt8772 = (client.aClass437_8696
						.method5814(1946710966) * -118843751);
				int i_7_ = 0;
			...
			if (385051775 * (((Class25) client.aClass25_8711).aClass298_Sub53_Sub2_333.index) != ((Class25) client.aClass25_8711).anInt336
					* -866602563) {
			/*	throw new RuntimeException(
						new StringBuilder()
								.append(
										385051775 * (((Class25) client.aClass25_8711).aClass298_Sub53_Sub2_333.index))
								.append(" ")
								.append(
										-866602563
												* ((Class25) client.aClass25_8711).anInt336)
								.toString());*/
			}
			...
			if (0 != (client.anInt8772 * 1962237353 - -1230451913
					* client.anInt8703)) {
				/*throw new RuntimeException(new StringBuilder().append("")
						.append(
								client.anInt8772 * 1962237353
										- (-1230451913 * client.anInt8703))
						.toString());*/
			}
			for (int i_10_ = 0; i_10_ < client.anInt8772 * 1962237353; i_10_++) {
				if (-1402769421
						* ((Entity) (client.aClass298_Sub29Array8816[i_10_].anObject7366)).anInt10075 != 440189755 * client.anInt8707) {
					/*throw new RuntimeException(
							new StringBuilder()
									.append("")
									.append(
											((Entity) (client.aClass298_Sub29Array8816[i_10_].anObject7366)).anInt10064 * 1888274983)
									.toString());*/
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qw.jq(").append(')').toString());
		}
	}

	public static final void method4963(int i, String string, Color color,
			Color color_11_, Color color_12_, byte i_13_) {
		try {
			do {
				try {
					Graphics graphics = Class52_Sub2_Sub1.aCanvas9079
							.getGraphics();
					...
					try {
						...
						Graphics graphics_14_ = Class298_Sub32_Sub22.anImage9468
								.getGraphics();
						graphics_14_.setColor(Color.black);
						graphics_14_.fillRect(0, 0, -2110394505
								* Class462.anInt5683,
								(Class298_Sub40_Sub9.anInt9716 * -1111710645));
						int i_15_ = Class462.anInt5683 * -2110394505 / 2 - 152;
						int i_16_ = (-1111710645
								* Class298_Sub40_Sub9.anInt9716 / 2 - 18);
						...
						if (Class291.aString6485 != null) {
							...
							graphics_14_.setColor(color_12_);
							graphics_14_
									.drawString(Class291.aString6485,
											(-2110394505 * Class462.anInt5683
													/ 2 - Class291.aString6485
													.length() * 6 / 2),
						...
						graphics.fillRect(0, 0, -2110394505
								* Class462.anInt5683,
								(Class298_Sub40_Sub9.anInt9716 * -1111710645));
						int i_17_ = -2110394505 * Class462.anInt5683 / 2 - 152;
						int i_18_ = (Class298_Sub40_Sub9.anInt9716
								* -1111710645 / 2 - 18);
						...
						graphics.fillRect(i * 3 + (i_17_ + 2), 2 + i_18_,
								300 - i * 3, 30);
						...
						if (null != Class291.aString6485) {
							...
							graphics
									.drawString(
											Class291.aString6485,
											((Class462.anInt5683 * -2110394505 / 2) - Class291.aString6485
													.length() * 6 / 2),
											(Class298_Sub40_Sub9.anInt9716
													* -1111710645 / 2) - 26);
						}
						graphics
								.drawString(string, i_17_
										+ ((304 - string.length() * 6) / 2),
										22 + i_18_);
						break;
					}
