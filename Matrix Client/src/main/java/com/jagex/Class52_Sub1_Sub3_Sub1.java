...
public class Class52_Sub1_Sub3_Sub1 extends Class52_Sub1_Sub3 {
	...
	public void method563(int i, Interface8_Impl1_Impl1 interface8_impl1_impl1) {
		...
		if (interface8_impl1_impl1 != null) {
			if (((Class52_Sub1_Sub3_Sub1) this).anInt9972 != 0) {
				if ((((Class52_Sub1_Sub3_Sub1) this).anInt9976 != interface8_impl1_impl1_impl3
						.a())
						|| (((Class52_Sub1_Sub3_Sub1) this).anInt9973 != interface8_impl1_impl1_impl3
								.f()))
					throw new RuntimeException();
			} else {
				((Class52_Sub1_Sub3_Sub1) this).anInt9973 = interface8_impl1_impl1_impl3
						.f();
				((Class52_Sub1_Sub3_Sub1) this).anInt9976 = interface8_impl1_impl1_impl3
						.a();
				method573();
			}
		...
		if (this == ((Class52_Sub1_Sub3_Sub1) this).aClass_ra_Sub3_Sub1_9970
				.method4992((short) -4810))
			method575(i);
		else
	...
	void method574() {
		if (((Class52_Sub1_Sub3_Sub1) this).anInterface8_Impl1_Impl1_Impl3_9975 == null)
			...
			((Class52_Sub1_Sub3_Sub1) this).anInterface8_Impl1_Impl1_Impl3_9975
					.method167(36096);
	}

	public void method138() {
		if (((Class52_Sub1_Sub3_Sub1) this).anInt9974 != 0) {
			((Class52_Sub1_Sub3_Sub1) this).aClass_ra_Sub3_Sub1_9970
					.method5528(((Class52_Sub1_Sub3_Sub1) this).anInt9974);
	...
	boolean method136() {
		OpenGL.glBindFramebufferEXT(36160,
				((Class52_Sub1_Sub3_Sub1) this).anInt9974);
		for (int i = 0; i < 4; i++) {
