...
public class Class309_Sub1 extends Class309 {
	...
	Class309_Sub1() {
		...
		((Class309_Sub1) this).aLong7677 = System.nanoTime()
				* -5945124749373967719L;
		...
		try {
			...
			do {
				...
				((Class309_Sub1) this).aLong7680 += 1084187842630379629L * l;
					...
					&& ((3383889029778923877L * ((Class309_Sub1) this).aLong7680) < (4255909063329169833L * ((Class309_Sub1) this).aLong7677)));
			if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L < ((Class309_Sub1) this).aLong7677 * 4255909063329169833L)
				((Class309_Sub1) this).aLong7680 = ((Class309_Sub1) this).aLong7677 * 923002373878029557L;
			return i;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaf.i(").append(')').toString());
		}
	}
	...
	long method3794(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaf.k(").append(')').toString());
		}
	}

	long method3796() {
		((Class309_Sub1) this).aLong7677 += method3805(-1990505491)
				* -5945124749373967719L;
		if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L > ((Class309_Sub1) this).aLong7677 * 4255909063329169833L)
	...
	void method3798() {
		...
		if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L > 4255909063329169833L * ((Class309_Sub1) this).aLong7677)
			((Class309_Sub1) this).aLong7677 += (-8946266981622927523L
					* ((Class309_Sub1) this).aLong7680 - 1L * ((Class309_Sub1) this).aLong7677);
	}
	...
	long method3797() {
		((Class309_Sub1) this).aLong7677 += method3805(847126204)
				* -5945124749373967719L;
		if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L > ((Class309_Sub1) this).aLong7677 * 4255909063329169833L)
			return ((3383889029778923877L * ((Class309_Sub1) this).aLong7680 - 4255909063329169833L * ((Class309_Sub1) this).aLong7677) / 1000000L);
		return 0L;
	...
	int method3799(long l) {
		if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L > ((Class309_Sub1) this).aLong7677 * 4255909063329169833L) {
			((Class309_Sub1) this).aLong7676 += (((Class309_Sub1) this).aLong7680
					* -1779823502204740161L - ((Class309_Sub1) this).aLong7677 * 1974423410268347339L);
			((Class309_Sub1) this).aLong7677 += (-8946266981622927523L
					* ((Class309_Sub1) this).aLong7680 - ((Class309_Sub1) this).aLong7677 * 1L);
			((Class309_Sub1) this).aLong7680 += 1084187842630379629L * l;
			return 1;
		}
		int i = 0;
	...
	long method3795() {
		((Class309_Sub1) this).aLong7677 += method3805(195670472)
				* -5945124749373967719L;
		if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L > ((Class309_Sub1) this).aLong7677 * 4255909063329169833L)
			return ((3383889029778923877L * ((Class309_Sub1) this).aLong7680 - 4255909063329169833L * ((Class309_Sub1) this).aLong7677) / 1000000L);
		return 0L;
	...
	long method3805(int i) {
		try {
			...
			long l_0_ = l - -5561332595849817637L
					* ((Class309_Sub1) this).aLong7676;
			...
			long l_1_ = 0L;
			for (int i_2_ = 1; i_2_ <= -774573461
					* ((Class309_Sub1) this).anInt7681; i_2_++)
				l_1_ += (((Class309_Sub1) this).aLongArray7678[(578168601
						* ((Class309_Sub1) this).anInt7679 - i_2_ + 10) % 10]);
			return (l_1_ / (long) (-774573461 * ((Class309_Sub1) this).anInt7681));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaf.e(").append(')').toString());
		}
	}
	...
	void method3788(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaf.b(").append(')').toString());
		}
	}

	long method3789(int i) {
		try {
			((Class309_Sub1) this).aLong7677 += method3805(-99997412)
					* -5945124749373967719L;
			if (((Class309_Sub1) this).aLong7680 * 3383889029778923877L > ((Class309_Sub1) this).aLong7677 * 4255909063329169833L)
				return (3383889029778923877L * ((Class309_Sub1) this).aLong7680 - (4255909063329169833L * ((Class309_Sub1) this).aLong7677)) / 1000000L;
			return 0L;
	...
	public static SubIncommingPacket[] method3807(byte i) {
		try {
			return (new SubIncommingPacket[] { SubIncommingPacket.aClass206_2347,
					SubIncommingPacket.aClass206_2343, SubIncommingPacket.REMOVE_GROUND_ITEM_PACKET,
					SubIncommingPacket.DESTROY_OBJECT_PACKET, SubIncommingPacket.aClass206_2346,
					SubIncommingPacket.TILE_MESSAGE_PACKET, SubIncommingPacket.PROJECTILE_PACKET,
					SubIncommingPacket.aClass206_2356, SubIncommingPacket.SPAWN_OBJECT_PACKET,
					SubIncommingPacket.SEND_GROUND_ITEM_PACKET, SubIncommingPacket.aClass206_2357,
					SubIncommingPacket.aClass206_2353, SubIncommingPacket.aClass206_2354,
					SubIncommingPacket.aClass206_2342, SubIncommingPacket.aClass206_2348 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aaf.a(").append(')').toString());
		}
	}
}
