package com.jagex;/* Class122 - Decompiled by JODE
...
public class Class122 {
	...
	public static Class151 method1318(RsByteBuffer class298_sub53, byte i) {
		try {
			...
			Class139 class139 = (Class491.method6176((byte) 112)[class298_sub53
					.readUnsignedByte()]);
			Class133 class133 = (Class113.method1255(722680550)[class298_sub53
					.readUnsignedByte()]);
			...
			return new Class151(string, class139, class133, i_0_, i_1_, i_2_,
	...
	public static final synchronized long method1319(byte i) {
		try {
			...
			if (l < -1072184856876656313L * Class83.aLong763)
				Class83.aLong762 += (-7920182256634826327L * (-1072184856876656313L
						* Class83.aLong763 - l));
	...
	static final void method1320(
			...
			Entity class365_sub1_sub1_sub2_10_, int i,
	...
	static final void method1322(Class403 class403, short i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_21_ < i_22_ ? i_21_
					: i_22_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ey.or(").append(')').toString());
		}
	}
}
