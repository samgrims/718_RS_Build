...
public class Class446 implements Iterator {
	...
	public boolean hasNext() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sk.hasNext(").append(')').toString());
		}
	}
	...
	public void remove() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sk.remove(").append(')').toString());
		}
	}
	...
	public Object next() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sk.next(").append(')').toString());
		}
	}
