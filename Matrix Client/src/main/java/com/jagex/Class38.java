...
public class Class38 {
	...
	static final boolean method449(int i, int i_6_) {
		return ((i & 0x60000) != 0 | method468(i, i_6_) || method470(i, i_6_) || method447(
				i, i_6_));
	}
	...
	static final boolean method457(int i, int i_14_) {
		return ((method443(i, i_14_) | method444(i, i_14_) | method445(i, i_14_)) & method471(
				i, i_14_));
	}
	...
	static final boolean method464(int i, int i_21_) {
		return (((i & 0x2000) != 0 | method474(i, i_21_) | method454(i, i_21_)) & method475(
				i, i_21_));
	}
