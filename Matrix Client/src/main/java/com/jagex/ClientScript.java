...
public class ClientScript extends Class298_Sub37 {
	...
	Class394 method3474(RsByteBuffer class298_sub53, Class394[] class394s,
			byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aiz.a(").append(')').toString());
		}
	}

	void method3475(RsByteBuffer class298_sub53, int i, Class394 class394,
			byte i_10_) {
		try {
