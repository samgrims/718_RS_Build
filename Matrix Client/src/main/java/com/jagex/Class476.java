package com.jagex;/* Class476 - Decompiled by JODE
...
public final class Class476 {
	...
	final void method6077(long l) throws IOException {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tp.a(").append(')').toString());
		}
	}

	public final void method6078(byte[] is, int i, int i_0_, int i_1_)
			throws IOException {
		try {
			if ((-1855833292870549225L * ((Class476) this).aLong5985 + (long) i_0_) > ((Class476) this).aLong5983
					* -1095537870969537929L) {
				((Class476) this).aRandomAccessFile5984
						.seek(-1095537870969537929L
								* ((Class476) this).aLong5983);
	...
	public final long method6080(int i) throws IOException {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tp.p(").append(')').toString());
		}
	}

	public final int method6081(byte[] is, int i, int i_2_, short i_3_)
			throws IOException {
		try {
			int i_4_ = ((Class476) this).aRandomAccessFile5984
					.read(is, i, i_2_);
			if (i_4_ > 0)
	...
	protected void finalize() throws Throwable {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tp.finalize(").append(')').toString());
		}
	}
	...
	public Class476(File file, String string, long l) throws IOException {
		...
		if (file.length() > l)
			file.delete();
		((Class476) this).aRandomAccessFile5984 = new RandomAccessFile(file,
				string);
	...
	static final void method6082(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tp.ahm(").append(')').toString());
		}
	}

	static final void method6083(int i, int i_5_, int i_6_, int i_7_) {
		try {
			String string = new StringBuilder().append("tele ").append(i)
					.append(Class26.aString353).append(i_5_ >> 6).append(
							Class26.aString353).append(i_6_ >> 6).append(
							Class26.aString353).append(i_5_ & 0x3f).append(
							Class26.aString353).append(i_6_ & 0x3f).toString();
			System.out.println(string);
			Class419.method5605(string, true, false, 1405738364);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tp.gd(").append(')').toString());
		}
	}
}
