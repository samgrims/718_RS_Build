package com.jagex;/* Class203 - Decompiled by JODE
			...
			if (null != class298_sub37_sub17) {
				...
				for (int i_5_ = 1; i_5_ < parameters.length; i_5_++) {
					if (parameters[i_5_] instanceof Integer) {
						...
						if (-2147483643 == i_6_)
							i_6_ = (class298_sub46.aClass105_7525 != null ? -1309843523
									* (class298_sub46.aClass105_7525.anInt1154)
									: -1);
						if (-2147483642 == i_6_)
				...
				((Class403) class403).anInt5254 = ((Class298_Sub46) class298_sub46).anInt7524
						* -323690565;
				ClientScriptsExecutor.method4690(class298_sub37_sub17, i, class403,
						546888884);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("io.k(").append(')').toString());
		}
	}
		...
		try {
			try {
				if (1 == 617004265 * Class79.anInt734) {
					int i_8_ = Class79.aClass298_Sub19_Sub1_737
							.method2953((byte) -56);
					if (i_8_ > 0
							&& Class79.aClass298_Sub19_Sub1_737
									.method2985(747355627)) {
				...
				if (3 == Class79.anInt734 * 617004265) {
					int i_9_ = Class79.aClass298_Sub19_Sub1_737
							.method2953((byte) -5);
					if (i_9_ < Class79.anInt739 * 643426275
							&& Class79.aClass298_Sub19_Sub1_737
									.method2985(1822181710)) {
