package com.jagex;/* Class360 - Decompiled by JODE
...
public class Class360 {
	...
	static final void method4297(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (i_1_ != -1
					&& class390.method4867(i_0_, i_1_, -574024132) ? 1 : 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("p.br(").append(')').toString());
		}
	}
	...
	static final void method4299(Class403 class403, byte i) {
		try {
			...
			Class298_Sub39
					.method3507(class105, class119, class403, -2106555824);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("p.mc(").append(')').toString());
		}
	}
		...
		try {
			synchronized (ClientScriptsExecutor.aQueue4124) {
				...
				for (;;) {
					...
					if (point == null
							|| !Class52_Sub2_Sub1.aCanvas9079.isShowing()
						...
						} else if ((class298_sub50_sub2.method3547((byte) 16) < -2110394505
								* Class462.anInt5683)
								&& (class298_sub50_sub2.method3560(-1530423246) < (-1111710645 * Class298_Sub40_Sub9.anInt9716))
								&& class298_sub50_sub2.method3547((byte) 15) >= 0) {
							if (class298_sub50_sub2.method3560(-1205687296) < 0) {
								if (i >= 1930198567) {
									/* empty */
								}
							} else {
								int i_3_ = class298_sub50_sub2
										.method3546(-1372966703);
								if (class298_sub50_sub2.method3546(-1372966703) == -1)
									ClientScriptsExecutor.aClass374_Sub2_4121.method4620(
											class298_sub50_sub2, 2114184639);
								else if (Class128.method1437(i_3_, 763111254))
									ClientScriptsExecutor.aClass374_Sub2_4121.method4642(
											class298_sub50_sub2, (byte) 13);
							}
						}
					}
				}
