...
public class Class436 {
	...
	static final void method5805(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1249 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("s.mk(").append(')').toString());
		}
	}

	static final void method5806(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((Class403) class403).aClass298_Sub25_5237
					.method3097(
							(String) (((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 -= 969361751) * -203050393)]),
							(byte) -7));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("s.yv(").append(')').toString());
		}
	}
	...
	static final void method5807(Class403 class403, int i) {
		try {
			...
			if (i_0_ > 255 || i_0_ < 0)
				i_0_ = 0;
			if (i_0_ != Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub20_7578
					.method5700(-1514807660)) {
				Class422_Sub25.aClass298_Sub48_8425
						.method3540(
								Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub20_7578,
								i_0_, -1997480653);
	...
	static String method5808(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			...
			try {
				...
				class298_sub53.index += (Class106.aClass113_1308
						.method1245(class298_sub53.buffer,
								class298_sub53.index * 385051775, is, 0,
								i_2_, 200493148)) * 116413311;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("s.p(").append(')').toString());
		}
	}

	static final void method5809(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8807 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("s.uw(").append(')').toString());
		}
	}
