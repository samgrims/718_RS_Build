...
public class Class282 implements Interface21 {
	...
	static void method2618(Class298_Sub37_Sub15 class298_sub37_sub15, int i) {
		try {
			if (class298_sub37_sub15 != null) {
				Class436.aClass453_5480.method5935(class298_sub37_sub15,
						2096333345);
				...
				if (!((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9668
					...
					if (class298_sub37_sub5 == null) {
						class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass348_5464
								.method4184(l));
						if (class298_sub37_sub5 != null
				...
				if (class298_sub37_sub5.method3416(class298_sub37_sub15,
						-1961303764))
					Class75.method837(class298_sub37_sub5, 70180712);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ls.t(").append(')').toString());
		}
	}
	...
	static void method2620(Class403 class403, byte i) {
		try {
			Class369 class369 = Class316.aClass362_3318
					.method4307(
							(((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]),
							245040087);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class369.anIntArray4023 == null ? 0
					: class369.anIntArray4023.length);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ls.g(").append(')').toString());
		}
	}
	...
	public static void method2622(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ls.c(").append(')').toString());
		}
	}

	static final void method2623(int i, int i_4_, int i_5_, int i_6_, int i_7_) {
		try {
			if (i >= -1424479739 * Class372_Sub2.anInt4051
					&& i <= 1135094847 * Class372_Sub2.anInt4048) {
				i_4_ = Class463.method6012(i_4_,
						1155384281 * Class372_Sub2.anInt4049,
						(Class372_Sub2.anInt4050 * -1062447355), -1212608691);
				i_5_ = Class463.method6012(i_5_,
						1155384281 * Class372_Sub2.anInt4049,
						(-1062447355 * Class372_Sub2.anInt4050), -1212608691);
				Class492.method6183(i, i_4_, i_5_, i_6_, -1450466434);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ls.x(").append(')').toString());
		}
	}
