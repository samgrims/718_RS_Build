...
public class Interface extends Class298 {
	...
	public static void method3575(byte i) {
		try {
			...
			if (Class87.anInt801 * 57998513 != 0
					&& 0 != 1705830085 * Class87.anInt800) {
				client.aShort8839 = (short) 334;
				client.aShort8743 = (short) 334;
				client.aShort8935 = client.aShort8934 = (short) (Class87.anInt801
						* -369532416 / (1705830085 * Class87.anInt800));
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acs.p(").append(')').toString());
		}
	}
