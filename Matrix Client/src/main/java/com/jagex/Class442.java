...
public class Class442 {
	...
	static final void method5873(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sg.aes(").append(')').toString());
		}
	}

	static final void method5874(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class365_Sub1) ((Class403) class403).anInterface3_5233)
					.method4363((byte) 23);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sg.apc(").append(')').toString());
		}
	}

	static final void method5875(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8646 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sg.ako(").append(')').toString());
		}
	}
	...
	static final void method5877(Class403 class403, int i) {
		try {
			...
			if (class497.method6206(1883696427))
				((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = class105
						.method1109(i_2_, class497.aString6101, 2117840940);
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class105
						.method1117(i_2_, -388931549 * class497.anInt6100,
								-659898667);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sg.pi(").append(')').toString());
		}
	}

	static final void method5878(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class190
					.method1859((byte) -52);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sg.aex(").append(')').toString());
		}
	}
	...
	static final void method5879(int i) {
		try {
			...
			client.aClass283_8716.method2641(1725751477).method5794(5,
					(byte) 49);
