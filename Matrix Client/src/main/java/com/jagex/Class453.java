...
public class Class453 implements Iterable, Collection {
	...
	public void method5938(Class453 class453_2_, int i) {
		try {
			if (aClass298_5643 != aClass298_5643.aClass298_3187)
				method5937(class453_2_, aClass298_5643.aClass298_3187,
						(byte) -5);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.k(").append(')').toString());
		}
	}
	...
	public Iterator iterator() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.iterator(").append(')').toString());
		}
	}
	...
	public boolean isEmpty() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.isEmpty(").append(')').toString());
		}
	}
	...
	public boolean contains(Object object) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.contains(").append(')').toString());
		}
	}
	...
	public Object[] toArray() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.toArray(").append(')').toString());
		}
	}
	...
	public boolean remove(Object object) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.remove(").append(')').toString());
		}
	}
	...
	public boolean containsAll(Collection collection) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.containsAll(").append(')').toString());
		}
	}
	...
	public boolean addAll(Collection collection) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.addAll(").append(')').toString());
		}
	}
	...
	public boolean removeAll(Collection collection) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.removeAll(").append(')').toString());
		}
	}
	...
	public boolean retainAll(Collection collection) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.retainAll(").append(')').toString());
		}
	}
	...
	public void clear() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.clear(").append(')').toString());
		}
	}
	...
	public boolean equals(Object object) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.equals(").append(')').toString());
		}
	}
	...
	public int hashCode() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.hashCode(").append(')').toString());
		}
	}
	...
	public int size() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.size(").append(')').toString());
		}
	}
	...
	static final void method5950(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sr.ur(").append(')').toString());
		}
	}

	public static void method5951(int i, int i_7_, int i_8_, ObjectDefinitions class432,
			int i_9_) {
		try {
			for (Class298_Sub41 class298_sub41 = ((Class298_Sub41) Class298_Sub41.aClass453_7421
					...
					.method5944(49146))) {
				if (i == (-1926928785 * ((Class298_Sub41) class298_sub41).anInt7424)
						&& (((Class298_Sub41) class298_sub41).anInt7425 * -1808325887) == i_7_ << 9
						&& (((Class298_Sub41) class298_sub41).anInt7423 * 757346071 == i_8_ << 9)
						&& (class432.anInt5365 * 1181652947 == (((Class298_Sub41) class298_sub41).aClass432_7435.anInt5365) * 1181652947)) {
