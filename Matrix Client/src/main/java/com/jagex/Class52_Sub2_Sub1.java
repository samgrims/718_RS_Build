package com.jagex;/* Class52_Sub2_Sub1 - Decompiled by JODE
...
public abstract class Class52_Sub2_Sub1 extends Class52_Sub2 {
	...
	void method591(int i) {
		try {
			...
			if (((Class52_Sub2_Sub1) this).aBoolean9078)
				((Class52_Sub2_Sub1) this).aClass_ra_Sub1_9073.method5207(
						1038713159 * ((Class52_Sub2_Sub1) this).anInt9074,
						2061776189 * ((Class52_Sub2_Sub1) this).anInt9075,
						((Class52_Sub2_Sub1) this).anIntArray9076,
						((Class52_Sub2_Sub1) this).aFloatArray9077);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("afi.z(").append(')').toString());
		}
	}

	Class52_Sub2_Sub1(Class_ra_Sub1 class_ra_sub1, Canvas canvas, int i,
			int i_0_) {
	...
	final void method582(int i, int i_1_) {
		try {
			if (i != 1038713159 * ((Class52_Sub2_Sub1) this).anInt9074
					|| 2061776189 * ((Class52_Sub2_Sub1) this).anInt9075 != i_1_) {
				((Class52_Sub2_Sub1) this).anInt9074 = -1172842377 * i;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("afi.e(").append(')').toString());
		}
	}

	final void method583(int i, int i_2_) {
		if (i != 1038713159 * ((Class52_Sub2_Sub1) this).anInt9074
				|| 2061776189 * ((Class52_Sub2_Sub1) this).anInt9075 != i_2_) {
			((Class52_Sub2_Sub1) this).anInt9074 = -1172842377 * i;
