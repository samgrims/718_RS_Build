package com.jagex;/* Class163 - Decompiled by JODE
	...
	static int method1773(char c, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gq.a(").append(')').toString());
		}
	}

	static final void method1774(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 443738891 * client.anInt8884;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gq.tx(").append(')').toString());
		}
	}
