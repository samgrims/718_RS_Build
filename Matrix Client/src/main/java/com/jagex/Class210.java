package com.jagex;/* Class210 - Decompiled by JODE
...
public class Class210 {
	...
	static final void method1943(Class403 class403, byte i) {
		try {
			...
			Long var_long = (((Class403) class403).aClass162_5252.method1766(
					-937307905 * client.aClass411_8944.gameType << 16 | i_0_,
					-2092321657));
			long l;
			if (null == var_long)
				l = -1L;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iw.bn(").append(')').toString());
		}
	}

	static final void method1944(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub22_7586
					.method5706((byte) -7) == 1 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iw.aji(").append(')').toString());
		}
	}
	...
	static final void method1945(Class403 class403, int i) {
		try {
			...
			if (i_2_ == 690460599 * class468.anInt5736)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1953923599
						* class468.anInt5727;
			else if (i_2_ == class468.anInt5722 * 1689294225)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class468.anInt5728
						* -1824861577;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iw.aaq(").append(')').toString());
		}
	}
}
