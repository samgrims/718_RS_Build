...
public class Class47_Sub2 extends Class47 {
	...
	void method507(boolean bool) {
		Class30_Sub1 class30_sub1 = ((Class47_Sub2) this).aClass_ra_Sub2_491
				.method5280();
		if (((Class47_Sub2) this).aBoolean6753 && class30_sub1 != null) {
			float f = (1.0F + (1.0F - Math
					.abs(((Class_ra_Sub2) (((Class47_Sub2) this).aClass_ra_Sub2_491)).aFloatArray8124[1])) * 2.0F);
			...
			((Class47_Sub2) this).aClass_ra_Sub2_491
					.method5256(((Class45) ((Class47_Sub2) this).aClass45_6757).aClass30_Sub4_485);
			...
			OpenGL
					.glUniform3f(
							...
							-(((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[0]),
							-(((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[1]),
							-(((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloatArray8124[2]));
			OpenGL
					.glUniform4f(
							OpenGL.glGetUniformLocation(i, "sunColour"),
							(((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8125)
									* f,
							(((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8128)
									* f,
							(((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aFloat8191)
									* f, 1.0F);
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i, "sunExponent"),
							64.0F + Math
									.abs(((Class_ra_Sub2) (((Class47_Sub2) this).aClass_ra_Sub2_491)).aFloatArray8124[1]) * 928.0F);
	...
	void method516(int i, int i_0_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i_7_, "time"),
							(float) (i_1_
									* ((Class_ra_Sub2) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7_, "scale"), f);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7_,
					"breakWaterDepth"), (float) i_2_);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_7_,
					"breakWaterOffset"), f_3_);
			OpenGL.glUniform2f(OpenGL.glGetUniformLocation(i_7_,
					"waveIntensity"), f_5_, f_4_);
			OpenGL.glUniform1f(OpenGL
					.glGetUniformLocation(i_7_, "waveExponent"), (float) i_6_);
		}
	}
	...
	Class47_Sub2(Class_ra_Sub2 class_ra_sub2, Class45 class45) {
		...
		if ((((Class45) ((Class47_Sub2) this).aClass45_6757).aClass30_Sub4_485 != null)
				&& (((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aBoolean8183)
				&& (((Class_ra_Sub2) ((Class47_Sub2) this).aClass_ra_Sub2_491).aBoolean8093)) {
			...
			Class48 class48_24_ = (Class48
					.method526(
							...
							35632,
							"varying vec3 wvVertex;\nvarying float waterDepth;\nuniform vec3 sunDir;\nuniform vec4 sunColour;\nuniform float sunExponent;\nuniform vec2 waveIntensity;\nuniform float waveExponent;\nuniform float breakWaterDepth;\nuniform float breakWaterOffset;\nuniform sampler3D normalSampler;\nuniform samplerCube envMapSampler;\nvoid main() {\nvec4 wnNormal = texture3D(normalSampler, gl_TexCoord[0].xyz).rbga;\nwnNormal.xyz = 2.0*wnNormal.xyz-1.0;\nvec3 wnVector = normalize(wvVertex);\nvec3 wnReflection = reflect(wnVector, wnNormal.xyz);\nvec3 envColour = textureCube(envMapSampler, wnReflection).rgb;\nvec4 specularColour = sunColour*pow(clamp(-dot(sunDir, wnReflection), 0.0, 1.0), sunExponent);\nfloat shoreFactor = clamp(waterDepth/breakWaterDepth-breakWaterOffset*wnNormal.w, 0.0, 1.0);\nfloat waveFactor = pow(1.0-shoreFactor, waveExponent)-0.5;\nwaveFactor = -4.0*waveFactor*waveFactor+1.0;\nfloat ndote = dot(wnVector, wnNormal.xyz);\nfloat fresnel = pow(1.0-abs(ndote), 1.0);\nvec4 surfaceColour = mix(vec4(envColour, fresnel*shoreFactor), (waveIntensity.x*wnNormal.wwww)+waveIntensity.y, waveFactor)+specularColour*shoreFactor;\ngl_FragColor = vec4(mix(surfaceColour.rgb, gl_Fog.color.rgb, gl_FogFragCoord), surfaceColour.a);\n}\n"));
			((Class47_Sub2) this).aClass29_6754 = Class29.method406(
					((Class47_Sub2) this).aClass_ra_Sub2_491, new Class48[] {
							class48, class48_24_ });
	...
	void method513(int i, int i_25_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i_32_, "time"),
							(float) (i_26_
									* ((Class_ra_Sub2) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_32_, "scale"), f);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_32_,
					"breakWaterDepth"), (float) i_27_);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_32_,
					"breakWaterOffset"), f_28_);
			OpenGL.glUniform2f(OpenGL.glGetUniformLocation(i_32_,
					"waveIntensity"), f_30_, f_29_);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_32_,
					"waveExponent"), (float) i_31_);
		}
	}
	...
	void method502(int i, int i_33_) {
		if (((Class47_Sub2) this).aBoolean6755) {
			...
			OpenGL
					.glUniform1f(
							OpenGL.glGetUniformLocation(i_40_, "time"),
							(float) (i_34_
									* ((Class_ra_Sub2) (((Class47_Sub2) this).aClass_ra_Sub2_491)).anInt8062 % 40000) / 40000.0F);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_40_, "scale"), f);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_40_,
					"breakWaterDepth"), (float) i_35_);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_40_,
					"breakWaterOffset"), f_36_);
			OpenGL.glUniform2f(OpenGL.glGetUniformLocation(i_40_,
					"waveIntensity"), f_38_, f_37_);
			OpenGL.glUniform1f(OpenGL.glGetUniformLocation(i_40_,
					"waveExponent"), (float) i_39_);
		}
	}
