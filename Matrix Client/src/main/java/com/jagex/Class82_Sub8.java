...
public class Class82_Sub8 extends Class82 {
	...
	Class82_Sub8(RsByteBuffer class298_sub53, boolean bool) {
		...
		if (bool)
			((Class82_Sub8) this).aLong6853 = (0x100000000L | (long) i)
					* -3845001125918771665L;
		else
			((Class82_Sub8) this).aLong6853 = (long) i * -3845001125918771665L;
		((Class82_Sub8) this).anInt6854 = class298_sub53.readInt((byte) -88)
				* -914937375;
	}
	...
	static final void method894(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7570
					.method5612(i_2_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("xq.aoh(").append(')').toString());
		}
	}

	static void method895(int i, int i_3_, int i_4_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(6,
					(long) i);
			class298_sub37_sub12.method3449((byte) 15);
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 = i_3_ * 1274450087;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("xq.as(").append(')').toString());
		}
	}

	static void method896(int i, int i_5_, int i_6_, int i_7_, boolean bool,
			int i_8_) {
		try {
	...
	static final void method897(Class403 class403, byte i) {
		try {
			...
			else if (Class325.aLong3454 * -247648477838985581L > Class122
					.method1319((byte) 1) - 1000L)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 1;
			else {
				Class474.aBoolean5974 = true;
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2071,
						client.aClass25_8693.aClass449_330, (byte) 42);
				class298_sub36.out.writeInt(-1351839083
						* Class117.anInt1399, -933492277);
				client.aClass25_8693.method390(class298_sub36, (byte) -36);
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("xq.alo(").append(')').toString());
		}
	}
}
