package com.jagex;/* Interface_ma - Decompiled by JODE
...
public interface Interface_ma {
	...
	public int[] method171(int i, float f, int i_1_, int i_2_, boolean bool,
			int i_3_);

	public int[] method172(int i, float f, int i_4_, int i_5_, boolean bool,
			byte i_6_);
	...
	public float[] method181(int i, float f, int i_14_, int i_15_,
			boolean bool, byte i_16_);
