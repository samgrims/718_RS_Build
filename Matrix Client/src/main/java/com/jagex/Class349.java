...
public class Class349 {
	...
	public Class350 method4202(int i, byte i_1_) {
		try {
			Class350 class350;
			synchronized (((Class349) this).aClass348_3706) {
				class350 = (Class350) ((Class349) this).aClass348_3706
						.method4184((long) i);
			}
			if (class350 != null)
				return class350;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oo.a(").append(')').toString());
		}
	}

	public Class349(Class411 class411, Class429 class429, Class243 class243,
			Class405 class405) {
	...
	static final void method4203(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (((Class403) class403).aClass298_Sub25_5237.anInt7356 * 649879491);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oo.xp(").append(')').toString());
		}
	}
	...
	static final void method4205(Class403 class403, short i) {
		try {
			...
			if (Class452.aBoolean5642) {
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = null != Class231.aFrame2589 ? 1
						: 0;
			} else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("oo.aed(").append(')').toString());
		}
	}
}
