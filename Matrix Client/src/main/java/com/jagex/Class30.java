...
public abstract class Class30 {
	...
	Class30(Class_ra_Sub2 class_ra_sub2, int i, Class55 class55,
			Class77 class77, int i_0_, boolean bool) {
	...
	void method407() {
		...
		if (((Class30) this).aBoolean368) {
			OpenGL.glTexParameteri(((Class30) this).anInt372, 10241,
					((Class30) this).aBoolean379 ? 9987 : 9729);
			OpenGL.glTexParameteri(((Class30) this).anInt372, 10240, 9729);
		} else {
			OpenGL.glTexParameteri(((Class30) this).anInt372, 10241,
					((Class30) this).aBoolean379 ? 9984 : 9728);
	...
	static void method411(int i, int i_1_, int i_2_, int i_3_, int i_4_,
			int i_5_, int[] is) {
		...
		for (;;) {
			...
			for (int i_15_ = 0; i_15_ < i_9_; i_15_++) {
				for (int i_16_ = 0; i_16_ < i_8_; i_16_++) {
					...
					i_23_ += i_20_ >> 8 & 0xff;
					i_24_ += i_20_ & 0xff;
					is_11_[i_12_++] = ((i_21_ & 0x3fc) << 22
							| (i_22_ & 0x3fc) << 14 | (i_23_ & 0x3fc) << 6 | (i_24_ & 0x3fc) >> 2);
				}
				i_13_ += i_2_;
				i_14_ += i_2_;
			}
	...
	static void method412(int i, int i_26_, int i_27_, int i_28_,
			Class55 class55, byte[] is) {
		...
		for (;;) {
			OpenGL.glTexImage2Dub(i, i_30_, i_26_, i_27_, i_28_, 0,
					Class_ra_Sub2.method5228(class55), 5121, is_34_, 0);
			if (i_31_ <= 1)
				break;
	...
	static void method415(int i, int i_45_, int i_46_, int i_47_,
			Class55 class55, float[] fs) {
		...
		for (;;) {
			OpenGL.glTexImage2Df(i, i_49_, i_45_, i_46_, i_47_, 0,
					Class_ra_Sub2.method5228(class55), 5126, fs_53_, 0);
			if (i_50_ <= 1)
				break;
	...
	int method416() {
		int i = (((Class30) this).aClass55_377.anInt556 * 845115459
				* (((Class30) this).aClass77_378.anInt724 * 685647847) * ((Class30) this).anInt380);
		return ((Class30) this).aBoolean379 ? i * 4 / 3 : i;
	}

	void method417() {
		if (((Class30) this).anInt376 > 0) {
			((Class30) this).aClass_ra_Sub2_381.method5229(
					((Class30) this).anInt376, method416());
			((Class30) this).anInt376 = 0;
		}
	}
}
