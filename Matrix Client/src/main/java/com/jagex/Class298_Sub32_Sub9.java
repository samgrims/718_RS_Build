...
public class Class298_Sub32_Sub9 extends Class298_Sub32 {
	...
	int[] method3189(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			int[] is_0_ = method3129(0,
					(((Class298_Sub32_Sub9) this).aBoolean9389 ? -289063255
							* Class250.anInt2758 - i : i), -1887337990);
			if (((Class298_Sub32_Sub9) this).aBoolean9388) {
				...
				Class425.method5741(is_0_, 0, is, 0, -1474554145
						* Class250.anInt2755);
		}
		return is;
	}
	...
	int[][] method3190(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int[][] is_2_ = method3134(
					0,
					(((Class298_Sub32_Sub9) this).aBoolean9389 ? Class250.anInt2758
							* -289063255 - i
							: i), (byte) 8);
			int[] is_3_ = is_2_[0];
			int[] is_4_ = is_2_[1];
	...
	int[] method3131(int i, int i_11_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				int[] is_12_ = method3129(0,
						(((Class298_Sub32_Sub9) this).aBoolean9389 ? -289063255
								* Class250.anInt2758 - i : i), -1887337990);
				if (((Class298_Sub32_Sub9) this).aBoolean9388) {
					for (int i_13_ = 0; i_13_ < Class250.anInt2755
							* -1474554145; i_13_++)
						is[i_13_] = is_12_[-901777799 * Class250.anInt2753
								- i_13_];
				} else
					Class425.method5741(is_12_, 0, is, 0, -1474554145
							* Class250.anInt2755);
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agw.i(").append(')').toString());
		}
	}
	...
	void method3191(int i, RsByteBuffer class298_sub53) {
		...
		case 2:
			...
			break;
		case 0:
			((Class298_Sub32_Sub9) this).aBoolean9388 = class298_sub53
					.readUnsignedByte() == 1;
			break;
		case 1:
			((Class298_Sub32_Sub9) this).aBoolean9389 = class298_sub53
					.readUnsignedByte() == 1;
			break;
		}
	}
	...
	int[] method3192(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			if (((Class298_Sub32_Sub9) this).aBoolean9388) {
				...
				Class425.method5741(is_14_, 0, is, 0, -1474554145
						* Class250.anInt2755);
		}
		return is;
	}
	...
	int[][] method3132(int i, byte i_17_) {
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				int[] is_24_ = is[2];
				if (((Class298_Sub32_Sub9) this).aBoolean9388) {
					for (int i_25_ = 0; i_25_ < -1474554145
							* Class250.anInt2755; i_25_++) {
						is_22_[i_25_] = is_19_[Class250.anInt2753 * -901777799
								- i_25_];
						is_23_[i_25_] = is_20_[-901777799 * Class250.anInt2753
								- i_25_];
						is_24_[i_25_] = is_21_[Class250.anInt2753 * -901777799
								- i_25_];
					}
				} else {
					for (int i_26_ = 0; i_26_ < Class250.anInt2755
							* -1474554145; i_26_++) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			if (((Class298_Sub32_Sub9) this).aBoolean9388) {
				for (int i_34_ = 0; i_34_ < -1474554145 * Class250.anInt2755; i_34_++) {
					is_31_[i_34_] = is_28_[Class250.anInt2753 * -901777799
							- i_34_];
					is_32_[i_34_] = is_29_[-901777799 * Class250.anInt2753
							- i_34_];
					is_33_[i_34_] = is_30_[Class250.anInt2753 * -901777799
							- i_34_];
				}
			} else {
