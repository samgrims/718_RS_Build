...
public class Class298_Sub32_Sub28 extends Class298_Sub32 {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_6_ = i - 1615726345
						* (((Class298_Sub32_Sub28) this).anInt9500); (i_6_ <= (((Class298_Sub32_Sub28) this).anInt9500 * 1615726345 + i)); i_6_++) {
					int[] is_7_ = method3129(0, i_6_ & Class250.anInt2758
							* -289063255, -1887337990);
					...
					while (i_11_ < Class250.anInt2755 * -1474554145) {
						...
						i_9_ -= is_7_[(i_11_
								- (484472729 * (((Class298_Sub32_Sub28) this).anInt9499)) & -901777799
								* Class250.anInt2753)];
						i_11_++;
						i_9_ += is_7_[(i_11_
								+ (484472729 * (((Class298_Sub32_Sub28) this).anInt9499)) & Class250.anInt2753
								* -901777799)];
					}
					is_5_[(1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
							+ i_6_ - i)] = is_8_;
				}
	...
	int[][] method3132(int i, byte i_15_) {
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				int i_16_ = (1615726345
						* ((Class298_Sub32_Sub28) this).anInt9500 + 1615726345
						* ((Class298_Sub32_Sub28) this).anInt9500 + 1);
				...
				for (int i_21_ = i - 1615726345
						* ((Class298_Sub32_Sub28) this).anInt9500; (i_21_ <= (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500 + i)); i_21_++) {
					int[][] is_22_ = method3134(0, i_21_ & Class250.anInt2758
							* -289063255, (byte) 8);
					int[][] is_23_ = new int[3][Class250.anInt2755
							* -1474554145];
					int i_24_ = 0;
					int i_25_ = 0;
					int i_26_ = 0;
					...
					while (i_35_ < Class250.anInt2755 * -1474554145) {
						...
						int i_36_ = (i_35_ - 484472729
								* ((Class298_Sub32_Sub28) this).anInt9499 & Class250.anInt2753
								* -901777799);
						i_24_ -= is_27_[i_36_];
						i_25_ -= is_28_[i_36_];
						i_26_ -= is_29_[i_36_];
						i_36_ = (++i_35_ + 484472729
								* ((Class298_Sub32_Sub28) this).anInt9499 & Class250.anInt2753
								* -901777799);
						i_24_ += is_27_[i_36_];
						i_25_ += is_28_[i_36_];
					...
					is_20_[1615726345
							* (((Class298_Sub32_Sub28) this).anInt9500) + i_21_
							- i] = is_23_;
				}
				int[] is_37_ = is[0];
				int[] is_38_ = is[1];
	...
	int[] method3312(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_51_ = i
					- (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500); (i_51_ <= ((Class298_Sub32_Sub28) this).anInt9500
					* 1615726345 + i); i_51_++) {
				int[] is_52_ = method3129(0, i_51_ & Class250.anInt2758
						* -289063255, -1887337990);
				...
				while (i_56_ < Class250.anInt2755 * -1474554145) {
					...
					i_54_ -= is_52_[(i_56_ - 484472729
							* ((Class298_Sub32_Sub28) this).anInt9499 & -901777799
							* Class250.anInt2753)];
					i_56_++;
					i_54_ += is_52_[(i_56_ + 484472729
							* ((Class298_Sub32_Sub28) this).anInt9499 & Class250.anInt2753
				...
				is_50_[(1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
						+ i_51_ - i)] = is_53_;
			}
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_60_) {
		try {
			switch (i) {
			case 1:
				((Class298_Sub32_Sub28) this).anInt9500 = class298_sub53
						.readUnsignedByte()
						* -804145351;
				break;
			case 0:
				((Class298_Sub32_Sub28) this).anInt9499 = class298_sub53
						.readUnsignedByte()
						* -938414935;
				break;
			case 2:
	...
	int[][] method3313(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int i_61_ = (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
					+ 1615726345 * ((Class298_Sub32_Sub28) this).anInt9500 + 1);
			...
			for (int i_66_ = i
					- (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500); (i_66_ <= 1615726345
					* ((Class298_Sub32_Sub28) this).anInt9500 + i); i_66_++) {
				int[][] is_67_ = method3134(0, i_66_ & Class250.anInt2758
						* -289063255, (byte) 8);
				...
				is_65_[(1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
						+ i_66_ - i)] = is_68_;
			}
			int[] is_82_ = is[0];
			int[] is_83_ = is[1];
	...
	int[] method3316(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_96_ = i
					- (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500); (i_96_ <= ((Class298_Sub32_Sub28) this).anInt9500
					* 1615726345 + i); i_96_++) {
				int[] is_97_ = method3129(0, i_96_ & Class250.anInt2758
						* -289063255, -1887337990);
				...
				is_95_[(1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
						+ i_96_ - i)] = is_98_;
			}
	...
	int[][] method3317(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int i_105_ = (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
					+ 1615726345 * ((Class298_Sub32_Sub28) this).anInt9500 + 1);
			...
			for (int i_110_ = i
					- (1615726345 * ((Class298_Sub32_Sub28) this).anInt9500); (i_110_ <= 1615726345
					* ((Class298_Sub32_Sub28) this).anInt9500 + i); i_110_++) {
				int[][] is_111_ = method3134(0, i_110_ & Class250.anInt2758
						* -289063255, (byte) 8);
				...
				is_109_[(1615726345 * ((Class298_Sub32_Sub28) this).anInt9500
						+ i_110_ - i)] = is_112_;
			}
			int[] is_126_ = is[0];
			int[] is_127_ = is[1];
