		...
		try {
			if (null != class298_sub37_sub15
				...
				if (class198 != null) {
					...
					class298_sub36.out.writeShortLE(i_32_
							+ -1760580017 * class341.gameSceneBaseX, 1653379787);
					class298_sub36.out.writeShort(i_35_,
							16711935);
				...
				if (59 == i_34_) {
					...
					class298_sub36.out.writeShort128(
							client.anInt8906 * 1408085039);
					class298_sub36.out.writeShortLE(
				...
				if (i_34_ == 17) {
					...
					class298_sub36.out.writeShortLE128(i_32_
							+ class341.gameSceneBaseX * -1760580017);
					class298_sub36.out.writeShort128(
							283514611 * class341.gameSceneBaseY + i_33_);
					class298_sub36.out.writeIntLE(
							1262526353 * Class379.anInt4099, (byte) 1);
					class298_sub36.out.writeShort128(
							client.anInt8836 * 392084321);
					class298_sub36.out.writeShortLE128(i_35_);
