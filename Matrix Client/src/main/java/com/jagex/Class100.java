...
public class Class100 {
	...
	static final void method1075(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (GraphicsToolkit.aClass256_5315
					.method2441(i_0_, 537859491).anIntArray9598[i_1_]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eb.acu(").append(')').toString());
		}
	}
	...
	static final void method1077(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eb.aec(").append(')').toString());
		}
	}

	static final void method1078(Class403 class403, short i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class229
					.method2123(1029121048);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eb.adw(").append(')').toString());
		}
	}
}
