...
public class Class305 implements Interface27 {
	...
	public int method3743(String string) {
		...
		if (string_1_ == null) {
			string_1_ = new StringBuilder().append(
					((Class305) this).aString6736).append(string_0_).toString();
			if (!((Class305) this).aClass243_6735.method2300(string_1_, "",
					(byte) 15))
				return -1;
		}
		if (!((Class305) this).aClass243_6735
				.method2312(string_1_, -2138379227))
			return ((Class305) this).aClass243_6735.method2305(string_1_,
					-896654552);
		byte[] is = ((Class305) this).aClass243_6735.method2301(string_1_, "",
				1164372929);
		Object object = null;
		File file;
		try {
	...
	public int method3744(String string, int i) {
		try {
			...
			if (string_4_ == null) {
				string_4_ = new StringBuilder().append(
						((Class305) this).aString6736).append(string_3_)
						.toString();
				if (!((Class305) this).aClass243_6735.method2300(string_4_, "",
						(byte) -89))
					return -1;
			}
			if (!((Class305) this).aClass243_6735.method2312(string_4_,
					-2144191880))
				return ((Class305) this).aClass243_6735.method2305(string_4_,
						1762657326);
			byte[] is = ((Class305) this).aClass243_6735.method2301(string_4_,
					"", 829888057);
			Object object = null;
			File file;
			try {
	...
	public boolean method264(int i) {
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				hashtable.put(string, ((Class305) this).aHashtable6738
						.get(string));
			}
			try {
				...
				try {
					...
					while (enumeration.hasMoreElements()) {
						String string = (String) enumeration.nextElement();
						try {
							File file = (File) ((Class305) this).aHashtable6737
									.get(string);
							Class var_class_12_ = (Class) ((Class305) this).aHashtable6738
									.get(string);
							Vector vector = ((Vector) field.get(var_class_12_
									.getClassLoader()));
							for (int i_13_ = 0; i_13_ < vector.size(); i_13_++) {
								try {
									Object object = vector.elementAt(i_13_);
									Field field_14_ = object.getClass()
											.getDeclaredField("name");
									method.invoke(field_14_,
											(new Object[] { Boolean.TRUE }));
									try {
										String string_15_ = (String) field_14_
												.get(object);
										if (string_15_ != null
												&& (string_15_
			...
			try {
				...
				while (enumeration.hasMoreElements()) {
					...
					try {
						File file = ((File) ((Class305) this).aHashtable6737
								.get(string));
						Class var_class_19_ = ((Class) ((Class305) this).aHashtable6738
								.get(string));
						Vector vector = ((Vector) field.get(var_class_19_
								.getClassLoader()));
						for (int i = 0; i < vector.size(); i++) {
							try {
								Object object = vector.elementAt(i);
								Field field_20_ = object.getClass()
										.getDeclaredField("name");
								method.invoke(field_20_,
										new Object[] { Boolean.TRUE });
								try {
									String string_21_ = (String) field_20_
											.get(object);
									if (string_21_ != null
											&& (string_21_
													.equalsIgnoreCase(file
															.getCanonicalPath()))) {
										Field field_22_ = object.getClass()
												.getDeclaredField("handle");
										Method method_23_ = (object.getClass()
										...
										.invoke(
												...
												(new Object[] { Boolean.TRUE }));
										try {
											method_23_.invoke(object,
													new Object[0]);
											field_22_.set(object,
													new Integer(0));
											hashtable.remove(string);
										} catch (Throwable throwable) {
											/* empty */
	...
	public Class305(Class243 class243) {
		...
		if (Class495.aString6094.startsWith("win")
				|| Class495.aString6094.startsWith("windows 7"))
			...
			.toString();
		if (Class495.aString6093.startsWith("amd64")
				|| Class495.aString6093.startsWith("x86_64"))
			string = new StringBuilder().append(string).append("x86_64/")
			.toString();
		else if (Class495.aString6093.startsWith("i386")
				|| Class495.aString6093.startsWith("i486")
				|| Class495.aString6093.startsWith("i586")
				|| Class495.aString6093.startsWith("x86"))
			...
			try {
				...
				while (enumeration.hasMoreElements()) {
					...
					try {
						File file = ((File) ((Class305) this).aHashtable6737
								.get(string));
						Class var_class_25_ = ((Class) ((Class305) this).aHashtable6738
								.get(string));
						Vector vector = ((Vector) field.get(var_class_25_
								.getClassLoader()));
						for (int i = 0; i < vector.size(); i++) {
							try {
								Object object = vector.elementAt(i);
								Field field_26_ = object.getClass()
										.getDeclaredField("name");
								method.invoke(field_26_,
										new Object[] { Boolean.TRUE });
								try {
									String string_27_ = (String) field_26_
											.get(object);
									if (string_27_ != null
											&& (string_27_
													.equalsIgnoreCase(file
															.getCanonicalPath()))) {
										Field field_28_ = object.getClass()
												.getDeclaredField("handle");
										Method method_29_ = (object.getClass()
												.getDeclaredMethod("finalize",
														new Class[0]));
										method
										.invoke(
			...
			try {
				...
				while (enumeration.hasMoreElements()) {
					...
					try {
						File file = ((File) ((Class305) this).aHashtable6737
								.get(string));
						Class var_class_31_ = ((Class) ((Class305) this).aHashtable6738
								.get(string));
						Vector vector = ((Vector) field.get(var_class_31_
								.getClassLoader()));
						for (int i = 0; i < vector.size(); i++) {
							try {
								Object object = vector.elementAt(i);
								Field field_32_ = object.getClass()
										.getDeclaredField("name");
								method.invoke(field_32_,
										new Object[] { Boolean.TRUE });
								try {
									String string_33_ = (String) field_32_
											.get(object);
									if (string_33_ != null
											&& (string_33_
													.equalsIgnoreCase(file
															.getCanonicalPath()))) {
										Field field_34_ = object.getClass()
												.getDeclaredField("handle");
										Method method_35_ = (object.getClass()
												.getDeclaredMethod("finalize",
														new Class[0]));
										method
										.invoke(
										...
										.invoke(
												...
												(new Object[] { Boolean.TRUE }));
										try {
											method_35_.invoke(object,
													new Object[0]);
											field_34_.set(object,
													new Integer(0));
											hashtable.remove(string);
										} catch (Throwable throwable) {
											/* empty */
	...
	static final void method3750(Class403 class403, byte i) {
		try {
			Class79
			.method850(
					(((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242),
