...
public class Class500 {
	...
	public Class500(Class411 class411, Class429 class429, Class243 class243,
			boolean bool) {
		...
		if (bool) {
			...
			for (int i = 0; i < ((Class500) this).anInt6115 * 589337665; i++) {
				...
				if (null != is)
					class298_sub37_sub7.method3424(new RsByteBuffer(is),
							-2124220647);
	...
	static Class298_Sub36 method6220(byte i) {
		try {
			...
			return (Class298_Sub36.aClass298_Sub36Array7402[(Class298_Sub36.anInt7400 -= 265413783)
					* -848307417]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ur.a(").append(')').toString());
	...
	static void method6221(RsBitsBuffer class298_sub53_sub2, int i,
			int i_1_) {
		try {
			...
			if (0 == i_2_) {
				if (bool)
					...
					((Class410) class410).anInt5288 = (1896571807 * (((class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0] + class341.gameSceneBaseY * 283514611) >> 6) + ((class365_sub1_sub1_sub2_sub2.plane << 28) + ((-1760580017
							* class341.gameSceneBaseX + (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0])) >> 6 << 14))));
					if (-1 != (class365_sub1_sub1_sub2_sub2.anInt10221 * 1208589843))
						...
						((Class410) class410).anInt5286 = class365_sub1_sub1_sub2_sub2.aClass386_10084
								.method4719((byte) 0) * 481306955;
					...
					if (class365_sub1_sub1_sub2_sub2.anInt10214 * 780357347 > 0)
						Class_v.method3670(class365_sub1_sub1_sub2_sub2,
								(byte) -66);
				...
				if (bool) {
					...
					class365_sub1_sub1_sub2_sub2.method4471(i_4_, i_5_,
							(Class10.playersMovementTypes[i]), -2105155066);
			} else if (2 == i_2_) {
				...
				if (bool) {
					...
					class365_sub1_sub1_sub2_sub2.method4471(i_7_, i_8_,
							(Class10.playersMovementTypes[i]), -2092850777);
			} else {
				...
				if (0 == i_9_) {
					...
					if (bool) {
						class365_sub1_sub1_sub2_sub2.anInt10218 = -586951847
								* i_14_;
						class365_sub1_sub1_sub2_sub2.anInt10219 = i_15_
								* -682750645;
						class365_sub1_sub1_sub2_sub2.aBoolean10217 = true;
					} else
						class365_sub1_sub1_sub2_sub2.method4471(i_14_, i_15_,
								(Class10.playersMovementTypes[i]), -2123912900);
					...
					if (client.aClass283_8716.method2654(-232228879)
							.method2320(i_14_, i_15_, 1039567132))
						class365_sub1_sub1_sub2_sub2.aByte7724++;
					if (-442628795 * client.playerIndex == i
							&& (Class99.anInt952 * 1855729883 != class365_sub1_sub1_sub2_sub2.plane))
					...
					int i_20_ = ((i_18_
							+ (-1760580017 * class341.gameSceneBaseX + (class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0])) & 0x3fff) - class341.gameSceneBaseX
							* -1760580017);
					int i_21_ = ((i_19_
							+ (class341.gameSceneBaseY * 283514611 + (class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0])) & 0x3fff) - class341.gameSceneBaseY * 283514611);
					if (bool) {
						class365_sub1_sub1_sub2_sub2.anInt10218 = -586951847
								* i_20_;
						class365_sub1_sub1_sub2_sub2.anInt10219 = -682750645
								* i_21_;
						class365_sub1_sub1_sub2_sub2.aBoolean10217 = true;
					} else
						class365_sub1_sub1_sub2_sub2.method4471(i_20_, i_21_,
								(Class10.playersMovementTypes[i]), -2073670245);
					...
					if (client.aClass283_8716.method2654(934483887).method2320(
							i_20_, i_21_, 624472586))
						class365_sub1_sub1_sub2_sub2.aByte7724++;
