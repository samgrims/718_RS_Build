...
public class Class298_Sub37_Sub7 extends Class298_Sub37 {
	...
	public String method3427(int i, String string, byte i_8_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aim.p(").append(')').toString());
		}
	}

	public static void method3428(
			Entity class365_sub1_sub1_sub2, int[] is,
			int[] is_9_, int[] is_10_, int i) {
		try {
				...
				for (int i_15_ = 0; (0 != i_13_ && i_15_ < (class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112).length); i_13_ >>>= 1) {
					if ((i_13_ & 0x1) == 0) {
						...
						if (null != class438_sub2_sub1
								&& class438_sub2_sub1.method5819((byte) -110)) {
							if (i_12_ == class438_sub2_sub1
									.method5823(1502559146)) {
								if (0 == i_16_) {
									class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112[i_15_] = null;
							...
							} else if (-1445588039 * class391.anInt4178 >= ((class438_sub2_sub1
									.method5820(595695662).anInt4178) * -1445588039)) {
								class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112[i_15_] = null;
								class438_sub2_sub1 = null;
							}
						}
						if (class438_sub2_sub1 == null
		...
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = new StringBuilder().append(string)
					.append(Class128_Sub1.method1440(i_17_, true, (byte) 8))
					.toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aim.zy(").append(')').toString());
		}
	}
}
