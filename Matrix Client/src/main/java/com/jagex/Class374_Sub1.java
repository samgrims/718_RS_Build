...
public class Class374_Sub1 extends Class374 {
	...
	boolean method4634() {
		return (method4639((short) 10438) != null || (((Class374_Sub1) this).aLong4075 * 8383148474145196457L < Class122
				.method1319((byte) 1) - 2000L));
	}

	boolean method4619(int i) {
		try {
			return (method4639((short) 10071) != null || (((Class374_Sub1) this).aLong4075 * 8383148474145196457L < Class122
					.method1319((byte) 1) - 2000L));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adi.u(").append(')').toString());
		}
	}
	...
	Class298_Sub50 method4639(short i) {
		try {
			return ((Class298_Sub50) client.aClass453_8827
					.method5939(1766612795));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adi.az(").append(')').toString());
		}
	}

	Class298_Sub36 method4633(byte i) {
		try {
			return Class18.method359(OutcommingPacket.aClass198_1995,
					client.aClass25_8711.aClass449_330, (byte) 89);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adi.x(").append(')').toString());
		}
	}
	...
	void method4617(RsByteBuffer class298_sub53,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adi.k(").append(')').toString());
		}
	}

	boolean method4624() {
		return (method4639((short) -18072) != null || (((Class374_Sub1) this).aLong4075 * 8383148474145196457L < Class122
				.method1319((byte) 1) - 2000L));
	}
	...
	void method4621() {
		...
		if (class298_sub50 != null) {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2008,
					client.aClass25_8711.aClass449_330, (byte) 77);
			class298_sub36.out.writeInt(i_1_
					| i_0_ << 16, -1426845039);
	...
	void method4613() {
		...
		if (class298_sub50 != null) {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2008,
					client.aClass25_8711.aClass449_330, (byte) 71);
			class298_sub36.out.writeInt(i_4_
					| i_3_ << 16, -1629465959);
	...
	boolean method4623() {
		return (method4639((short) 8384) != null || (((Class374_Sub1) this).aLong4075 * 8383148474145196457L < Class122
				.method1319((byte) 1) - 2000L));
	}
	...
	void method4618(byte i) {
		try {
			...
			if (class298_sub50 != null) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2008,
						client.aClass25_8711.aClass449_330, (byte) 8);
				class298_sub36.out.writeInt(i_8_
						| i_7_ << 16, 121434419);
				class298_sub36.out.writeShort128(i_6_
						| i_9_ << 15);
				client.aClass25_8711.method390(class298_sub36, (byte) -44);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adi.d(").append(')').toString());
		}
	}
	...
	Class298_Sub36 method4625() {
		return Class18.method359(OutcommingPacket.aClass198_1995,
				client.aClass25_8711.aClass449_330, (byte) 126);
	}

	Class298_Sub36 method4631() {
		return Class18.method359(OutcommingPacket.aClass198_1995,
				client.aClass25_8711.aClass449_330, (byte) 67);
	}
	...
	void method4622() {
		...
		if (class298_sub50 != null) {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2008,
					client.aClass25_8711.aClass449_330, (byte) 43);
			class298_sub36.out.writeInt(i_11_
					| i_10_ << 16, -611244662);
	...
	static final void method4641(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adi.afv(").append(')').toString());
		}
	}
}
