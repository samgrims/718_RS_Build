...
public class Class111 {
	...
	static final void method1234(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_1_ == 5 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("en.ye(").append(')').toString());
		}
	}
	...
	static final void method1235(IComponentDefinition class105, Class403 class403, byte i) {
		try {
			Class505 class505 = class105.method1113(Class497.aClass197_6105,
					client.anInterface10_8700, (byte) 88);
			...
			int i_4_ = class505.method6261(class105.aString1212,
					class105.anInt1156 * -2093041337,
					class105.anInt1191 * 418216501, i_3_, i_2_,
					Class130_Sub2.aClass57Array6959, (byte) -62);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_4_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("en.qg(").append(')').toString());
		}
	}
