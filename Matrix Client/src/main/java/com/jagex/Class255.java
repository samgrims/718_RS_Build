package com.jagex;/* Class255 - Decompiled by JODE
...
public class Class255 implements Runnable {
	...
	Class298_Sub37_Sub16_Sub2 method2430(int i, Class329 class329, int i_1_) {
		try {
			...
			synchronized (((Class255) this).aClass461_2794) {
				for (Class298_Sub37_Sub16_Sub2 class298_sub37_sub16_sub2_2_ = ((Class298_Sub37_Sub16_Sub2) ((Class255) this).aClass461_2794
						.method5984(686363137)); class298_sub37_sub16_sub2_2_ != null; class298_sub37_sub16_sub2_2_ = ((Class298_Sub37_Sub16_Sub2) ((Class255) this).aClass461_2794
						.method5985(-852978429))) {
					if ((long) i == (-5533549728640346679L * class298_sub37_sub16_sub2_2_.aLong7406)
							&& class329 == (((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2_2_).aClass329_10010)
							&& -1906220653
									* (((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2_2_).anInt10006) == 2) {
			...
			((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aByteArray10011 = class329
					.method3992(i, -250604251);
			((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aBoolean9670 = false;
			((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aBoolean9672 = true;
			return class298_sub37_sub16_sub2;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kr.a(").append(')').toString());
		}
	}

	Class298_Sub37_Sub16_Sub2 method2431(int i, byte[] is, Class329 class329,
			int i_4_) {
		try {
			Class298_Sub37_Sub16_Sub2 class298_sub37_sub16_sub2 = new Class298_Sub37_Sub16_Sub2();
	...
	void method2432(Class298_Sub37_Sub16_Sub2 class298_sub37_sub16_sub2, byte i) {
		try {
			synchronized (((Class255) this).aClass461_2794) {
				((Class255) this).aClass461_2794.method5982(
						class298_sub37_sub16_sub2, (byte) -98);
				((Class255) this).anInt2793 += 872113935;
				((Class255) this).aClass461_2794.notifyAll();
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kr.p(").append(')').toString());
		}
	}
	...
	public void run() {
		try {
			while (!((Class255) this).aBoolean2791) {
				...
				synchronized (((Class255) this).aClass461_2794) {
					class298_sub37_sub16_sub2 = ((Class298_Sub37_Sub16_Sub2) ((Class255) this).aClass461_2794
							.method5983(-2118324639));
				...
				try {
					if (-1906220653
							* ((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).anInt10006 == 2)
						((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aClass329_10010
								.method3993(
										(int) (class298_sub37_sub16_sub2.aLong7406 * -5533549728640346679L),
										((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aByteArray10011,
										(((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aByteArray10011).length,
										267663991);
					else if (3 == (((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).anInt10006 * -1906220653))
						((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aByteArray10011 = (((Class298_Sub37_Sub16_Sub2) class298_sub37_sub16_sub2).aClass329_10010
								.method3992(
										(int) (-5533549728640346679L * class298_sub37_sub16_sub2.aLong7406),
										-250604251));
	...
	static final void method2434(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573
					.method5725((byte) 12) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kr.anz(").append(')').toString());
		}
	}
	...
	public static void method2435(String string, int i) {
		try {
			...
			client.aCalendar8758
					.setTime(new Date(Class122.method1319((byte) 1)));
			int i_5_ = client.aCalendar8758.get(11);
			int i_6_ = client.aCalendar8758.get(12);
			int i_7_ = client.aCalendar8758.get(13);
			String string_8_ = new StringBuilder().append(
					Integer.toString(i_5_ / 10)).append(i_5_ % 10).append(":")
					.append(i_6_ / 10).append(i_6_ % 10).append(":").append(
							i_7_ / 10).append(i_7_ % 10).toString();
			...
			for (int i_9_ = 0; i_9_ < strings.length; i_9_++) {
				...
				Class8.aStringArray107[0] = new StringBuilder().append(
						string_8_).append(": ").append(strings[i_9_])
						.toString();
				if (null != Class78.aFileOutputStream731) {
					try {
						Class78.aFileOutputStream731.write(Class77.method840(
								new StringBuilder().append(
										Class8.aStringArray107[0]).append("\n")
										.toString(), 6758905));
