...
public class Class98_Sub2 extends Class98 {
	...
	void method1054(int i, int i_1_, byte i_2_) {
		try {
			...
			Class264_Sub1.method2503(i_3_, i_5_, i_4_, i_6_,
					(1785836763 * ((Class98_Sub2) this).anInt947), -479015291);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yh.a(").append(')').toString());
		}
	}
	...
	void method1049(int i, int i_12_) {
		...
		Class264_Sub1.method2503(i_13_, i_15_, i_14_, i_16_,
				1785836763 * ((Class98_Sub2) this).anInt947, -1924061875);
	}
	...
	static final void method1062(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.CHAT_TYPE_PACKET, class25.aClass449_330, (byte) 56);
			class298_sub36.out.writeByte(i_26_);
			class25.method390(class298_sub36, (byte) -69);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yh.abr(").append(')').toString());
		}
	}
	...
	static final void method1063(Class403 class403, byte i) {
		try {
			String string = (String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751)
					* -203050393]);
			if (null != Class112.aString1369
					&& Class112.aString1369.equalsIgnoreCase(string))
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yh.vu(").append(')').toString());
		}
	}

	public static void method1064(Class502 class502, int i, int i_27_,
			Class400 class400, Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1,
			int i_28_) {
		try {
	...
	static void method1065(byte i) {
		try {
			for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482
					.method5984(-431286975)); null != class298_sub37_sub5; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482
					.method5985(-2120194897))) {
				if ((-628325139 * ((Class298_Sub37_Sub5) class298_sub37_sub5).anInt9583) > 1) {
					...
					Class436.aClass348_5464
							.method4194(
									class298_sub37_sub5,
									(6619564980435866523L * ((Class298_Sub37_Sub15) (Class298_Sub37_Sub15) (((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)).aLong9666));
					((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584
							.method5988(2132471610);
				}
			}
			...
			Class282
					.method2618(Class436.aClass298_Sub37_Sub15_5466, 1921095656);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yh.ax(").append(')').toString());
		}
	}
