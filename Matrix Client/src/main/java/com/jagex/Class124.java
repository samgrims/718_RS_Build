...
public class Class124 implements Runnable {
	...
	void method1381(String string, int i) {
		try {
			...
			if (((Class124) this).aString1478 != null) {
				try {
					((Class124) this).anInetAddress1477 = InetAddress
							.getByName(((Class124) this).aString1478);
	...
	void method1383(byte i) {
		try {
			if (((Class124) this).anInetAddress1477 != null) {
				try {
					byte[] is = ((Class124) this).anInetAddress1477
							.getAddress();
					((Class124) this).aLong1476 = ((long) Ping.a(is[0], is[1],
							is[2], is[3], 10000L) * 887263504067647559L);
	...
	static final void method1388(Class403 class403, int i) {
		try {
			...
			Class301_Sub1
					.method3713(6, i_2_ << 16 | i_3_, i_4_, "", -759655050);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("f.alw(").append(')').toString());
		}
	}
	...
	static final void method1389(
		...
		try {
			...
			int i_6_ = (class365_sub1_sub1_sub2.anInt10098 * -719582720 + class365_sub1_sub1_sub2
					.getSize() * 256);
			int i_7_ = (class365_sub1_sub1_sub2.anInt10100 * 1363846656 + class365_sub1_sub1_sub2
					.getSize() * 256);
			Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
			class365_sub1_sub1_sub2
					.method4341(
							(float) ((i_6_ - (int) class217.aFloat2451) / i_5_ + (int) class217.aFloat2451),
							(float) (int) class217.aFloat2455,
							(float) ((int) class217.aFloat2454 + (i_7_ - (int) class217.aFloat2454)
									/ i_5_));
			class365_sub1_sub1_sub2.anInt10124 = 0;
			class365_sub1_sub1_sub2
					.method4414((class365_sub1_sub1_sub2.anInt10104)
							* -251594591, (byte) 1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("f.he(").append(')').toString());
		}
	}
}
