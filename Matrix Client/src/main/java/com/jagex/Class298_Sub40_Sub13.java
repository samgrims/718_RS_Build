...
public class Class298_Sub40_Sub13 extends Class298_Sub40 {
	...
	void method3508(RsByteBuffer class298_sub53, int i) {
		try {
			((Class298_Sub40_Sub13) this).anInt9731 = class298_sub53
					.readInt((byte) -19)
					* -1426634659;
			((Class298_Sub40_Sub13) this).anInt9730 = class298_sub53
					.readInt((byte) 80) * 771945371;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agz.a(").append(')').toString());
		}
	}
	...
	void method3509(RsByteBuffer class298_sub53) {
		((Class298_Sub40_Sub13) this).anInt9731 = class298_sub53
				...
				* -1426634659;
		((Class298_Sub40_Sub13) this).anInt9730 = class298_sub53
				.readInt((byte) 6) * 771945371;
	}

	void method3510(ClanSettings class162, byte i) {
		try {
			class162.method1761(
					(-814822411 * ((Class298_Sub40_Sub13) this).anInt9731),
					(((Class298_Sub40_Sub13) this).anInt9730 * 1839676051),
					(byte) 26);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agz.f(").append(')').toString());
		}
	}
	...
	public static Class102 method3517(int i, int i_0_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agz.k(").append(')').toString());
		}
	}

	static void method3518(Class222 class222, Class233 class233, int i,
			int i_1_, int i_2_) {
		try {
