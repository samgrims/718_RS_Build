package com.jagex;/* Class198 - Decompiled by JODE
	...
	static final void method1889(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ij.ei(").append(')').toString());
		}
	}

	static final void method1890(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1244 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ij.ky(").append(')').toString());
		}
	}

	static final void method1891(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass298_Sub25_5237.aByte7360;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ij.xb(").append(')').toString());
		}
	}
					...
					.method847(
							Class411
									.method5574(
											...
											2103151536),
							Class321.aClass429_3357.method242(694163818),
							-1841335173));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ij.zo(").append(')').toString());
		}
	}

	static final void method1893(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			class105.anInt1239 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * 476443207;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ij.ik(").append(')').toString());
		}
	}
}
