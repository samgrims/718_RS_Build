package com.jagex;/* Class112 - Decompiled by JODE
...
public class Class112 {
	...
	public Class112(int[] is) {
		...
		for (int i_5_ = 0; i_5_ < is.length; i_5_++) {
			int i_6_;
			for (i_6_ = is[i_5_] & i - 1; ((Class112) this).anIntArray1368[1 + (i_6_ + i_6_)] != -1; i_6_ = i_6_
					+ 1 & i - 1) {
				/* empty */
			}
	...
	static final void method1242(Class403 class403, int i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = Class22.method371(-1872384633)
					.toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("eo.agn(").append(')').toString());
		}
	}
