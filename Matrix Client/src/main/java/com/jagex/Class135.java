...
public class Class135 implements Interface6 {
	...
	public boolean method54() {
		return (((Class135) this).aClass243_6381.method2310(
				791455531 * ((Class135) this).aClass165_6382.anInt6365,
				-457216440));
	}
	...
	public void method58(boolean bool, byte i) {
		try {
			if (bool) {
				int i_0_ = ((Class462.anInt5683 * -2110394505 > client.anInt8794 * 775068819) ? Class462.anInt5683
						* -2110394505
						: 775068819 * client.anInt8794);
				int i_1_ = ((Class298_Sub40_Sub9.anInt9716 * -1111710645 > -791746413
						* client.anInt8803) ? Class298_Sub40_Sub9.anInt9716
						* -1111710645 : client.anInt8803 * -791746413);
				...
				((Class135) this).aClass57_6383.method633(i_4_, i_7_, i_5_,
						i_6_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fl.f(").append(')').toString());
		}
	}
	...
	public boolean method52(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fl.b(").append(')').toString());
		}
	}

	public void method55() {
		((Class135) this).aClass57_6383 = Class422_Sub10.method5663(
				((Class135) this).aClass243_6381,
				(((Class135) this).aClass165_6382.anInt6365) * 791455531,
				(byte) -99);
	}
	...
	public void method56(boolean bool) {
		if (bool) {
			int i = ((Class462.anInt5683 * -2110394505 > client.anInt8794 * 775068819) ? Class462.anInt5683
					* -2110394505
					: 775068819 * client.anInt8794);
			int i_8_ = ((Class298_Sub40_Sub9.anInt9716 * -1111710645 > -791746413
					* client.anInt8803) ? Class298_Sub40_Sub9.anInt9716
					* -1111710645 : client.anInt8803 * -791746413);
			...
			((Class135) this).aClass57_6383.method633(i_11_, i_14_, i_12_,
					i_13_);
		}
	}
	...
	static final void method1490(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1217 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -1455284437;
			Tradution.method6054(class105, -2049323512);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fl.gc(").append(')').toString());
		}
	}
	...
	static final void method1491(IComponentDefinition class105, Class403 class403, int i) {
		try {
			...
			Class503 class503 = Class15.aClass507_224.method6269(
					572201537 * class105.anInt1151, -1577596397);
			...
			if (i_16_ < 0 || i_16_ >= class503.anIntArray6129.length)
				throw new RuntimeException(new StringBuilder().append("")
						.append(i_16_).toString());
			class105.aClass498_1307.anIntArray6108[i_16_] = i_15_;
			Tradution.method6054(class105, 649700405);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fl.qt(").append(')').toString());
		}
	}

	static final void method1492(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (null != (Class287.myPlayer.aClass366_10209) && (Class287.myPlayer.aClass366_10209.aBoolean3977)) ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fl.ud(").append(')').toString());
		}
	}
	...
	static final void method1494(
		...
		try {
			...
			if ((int) class217.aFloat2451 < 512
					|| (int) class217.aFloat2454 < 512
				...
				class365_sub1_sub1_sub2
						.method4341(
								(float) (class365_sub1_sub1_sub2.scenePositionXQueue[0] * 512 + (class365_sub1_sub1_sub2
										.getSize() * 256)),
								class217.aFloat2455,
								(float) (512 * class365_sub1_sub1_sub2.scenePositionYQueue[0] + (class365_sub1_sub1_sub2
										.getSize() * 256)));
				class365_sub1_sub1_sub2.method4419(229400295);
			}
			if ((Class287.myPlayer == class365_sub1_sub1_sub2)
					&& ((int) class217.aFloat2451 < 6144
							|| (int) class217.aFloat2454 < 6144
							|| ((int) class217.aFloat2451 >= (client.aClass283_8716
			...
			int i_23_ = Class266
					.method2525(class365_sub1_sub1_sub2, 1199726988);
			Class116.method1270(class365_sub1_sub1_sub2, -1145965611);
			Class298_Sub32_Sub36.method3373(class365_sub1_sub1_sub2, i_19_,
					i_20_, i_23_, -830154452);
			...
			class218.method2032(Class220
					.method2049(class365_sub1_sub1_sub2.aClass386_10084
							.method4719((byte) 0)), Class220
					.method2049(class365_sub1_sub1_sub2.aClass386_10111
							.method4719((byte) 0)), Class220
					.method2049(class365_sub1_sub1_sub2.aClass386_10113
							.method4719((byte) 0)));
			class365_sub1_sub1_sub2.method4346(class218);
			class218.method2029();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fl.hn(").append(')').toString());
		}
	}
}
