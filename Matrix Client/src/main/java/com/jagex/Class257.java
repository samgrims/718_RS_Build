...
public class Class257 {
	...
	public final int[] method2448(int i, int i_1_) {
		try {
			if (((Class257) this).anInt2804 * -1845310689 != ((Class257) this).anInt2803 * 1036538653) {
				if (((Class257) this).anInt2804 * -1845310689 != 1) {
					...
					if (class298_sub39 == null) {
						aBoolean2810 = true;
						if (((Class257) this).anInt2808 * 851327335 >= -1845310689
								* ((Class257) this).anInt2804) {
							Class298_Sub39 class298_sub39_2_ = ((Class298_Sub39) ((Class257) this).aClass458_2809
									.method5964(975410288));
							class298_sub39 = new Class298_Sub39(
									i,
						...
						aBoolean2810 = false;
					((Class257) this).aClass458_2809.method5965(class298_sub39,
							943102582);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kt.f(").append(')').toString());
		}
	}

	public final int[][] method2449(int i) {
		try {
			if (1036538653 * ((Class257) this).anInt2803 != -1845310689
					* ((Class257) this).anInt2804)
	...
	Class257(int i, int i_4_, int i_5_) {
		...
		((Class257) this).anIntArrayArray2805 = new int[-1845310689
				* ((Class257) this).anInt2804][i_5_];
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = (Class316.aClass362_3318
					.method4307(
							...
							245040087).aStringArray4026[(((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239 - 1])]);
			((Class403) class403).anInt5239 -= -783761378;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kt.e(").append(')').toString());
		}
	}

	static final void method2451(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1271 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kt.ob(").append(')').toString());
		}
	}
	...
	static final void method2452(Class403 class403, int i) {
		try {
			...
			ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
					i_6_);
			if (-1673957995 * class468.anInt5755 >= 0
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kt.aag(").append(')').toString());
		}
	}

	static final void method2453(boolean bool, byte i) {
		try {
			Class95.method1033(client.WINDOW_PANE_ID * -257444687, -2110394505
					* Class462.anInt5683, Class298_Sub40_Sub9.anInt9716
					* -1111710645, bool, 1828905535);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kt.kg(").append(')').toString());
		}
	}
	...
	static final void method2454(Class403 class403, int i) {
		try {
			...
			MapDetails class298_sub37_sub13 = Class298_Sub7
					.method2864(-1164141102);
			if (null != class298_sub37_sub13) {
				boolean bool = class298_sub37_sub13.method3453(
						i_7_ >> 28 & 0x3, i_7_ >> 14 & 0x3fff, i_7_ & 0x3fff,
						Class388.anIntArray4156, 1911692873);
				if (bool) {
