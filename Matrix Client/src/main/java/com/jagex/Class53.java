					...
					if (class105_0_ != null) {
						if (class105_0_.itemSlots == class105_0_.aClass105Array1292) {
							...
							if (i_1_ < class105s.length) {
								Class425.method5737(class105s, 0, class105s, 1,
										i_1_);
		...
		try {
			...
			if (!client.aBoolean8938 || !client.aBoolean8855) {
				...
				if (Class82_Sub3.aClass105_6825 == client.aClass105_8712) {
					...
					i_6_ = (i_4_ - client.anInt8800 * 1325631359 + client.aClass105_8712.anInt1167
							* -1424956747);
				}
				if (!Class165.aClass319_6366.method3881((byte) 88)) {
					if (client.aBoolean8863) {
						...
						if (client.aClass105_8854 != null
								&& (client.method2808(client.aClass105_8850) != null))
							Class380.method4679(client.aClass105_8850,
									client.aClass105_8854, 1471379856);
					} else if ((2089115297 * client.anInt8830 == 1 || Class58
							.method694(-1591809416))
							&& Class436.anInt5506 * -278777595 > 2)
						Class63
								.method738(
										(-1040412347 * client.anInt8861 + -98735103
												* client.anInt8734),
										(client.anInt8862 * 601707167 + client.anInt8853
												* -938469429), -2029149482);
					else if (Class63.method740(2078410937))
						Class63.method738(
								(client.anInt8734 * -98735103 + -1040412347
										* client.anInt8861),
								(client.anInt8862 * 601707167 + -938469429
										* client.anInt8853), -2029149482);
					client.aClass105_8850 = null;
					client.aClass105_8712 = null;
				} else {
					if (379282043 * Class82_Sub22.anInt6917 > 2117401247 * client.aClass105_8850.anInt1235) {
						...
						if ((i_7_ > client.aClass105_8850.anInt1239
								* -1855449225)
								|| i_7_ < -(-1855449225 * client.aClass105_8850.anInt1239)
								|| i_8_ > (-1855449225 * client.aClass105_8850.anInt1239)
								|| i_8_ < -(-1855449225 * client.aClass105_8850.anInt1239))
							client.aBoolean8863 = true;
					}
					if (null != client.aClass105_8850.anObjectArray1291
							&& client.aBoolean8863) {
						Class298_Sub46 class298_sub46 = new Class298_Sub46();
						class298_sub46.aClass105_7525 = client.aClass105_8850;
						class298_sub46.anInt7526 = 622624491 * i_5_;
