...
public class Class18 {
	...
	Class18 method355(int i) {
		try {
			return new Class18(-1509687305 * ((Class18) this).anInt254,
					((Class18) this).aFloat245, ((Class18) this).aFloat248,
					-1848560027 * ((Class18) this).anInt247,
					((Class18) this).anInt244 * -1070844791,
					((Class18) this).anInt249 * -988477815);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("as.a(").append(')').toString());
		}
	}
	...
	static String method358(int i, int i_5_, byte i_6_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("as.bg(").append(')').toString());
		}
	}

	public static Class298_Sub36 method359(OutcommingPacket class198,
			IsaacCipher isaacCipher, byte i) {
		try {
			Class298_Sub36 class298_sub36 = Class500.method6220((byte) 56);
			((Class298_Sub36) class298_sub36).aClass198_7401 = class198;
			((Class298_Sub36) class298_sub36).anInt7397 = ((OutcommingPacket) class198).length
					* -1035235683;
			if (-1 == ((Class298_Sub36) class298_sub36).anInt7397 * 157188735)
				class298_sub36.out = new RsBitsBuffer(
						260);
				...
				class298_sub36.out = new RsBitsBuffer(
						260);
			class298_sub36.out.method3665(isaacCipher,
					(byte) 74);
			class298_sub36.out
					.method3668(
							(((OutcommingPacket) ((Class298_Sub36) class298_sub36).aClass198_7401).id)
									* -1687656101, (byte) -23);
	...
	static final void method361(Class403 class403, int i) {
		try {
			...
			if (99 == i_8_)
				...
				Class242_Sub1.method2282(i_8_, i_9_, "", "", "", string,
						-541387718);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("as.sy(").append(')').toString());
		}
	}

	public static void method362(String string, String string_10_, int i,
			boolean bool, int i_11_) {
		try {
			if (client.anInt8752 * -1233866115 == 8) {
				Class298_Sub36 class298_sub36 = method359(
						OutcommingPacket.aClass198_2072,
						client.aClass25_8693.aClass449_330, (byte) 19);
				class298_sub36.out
						.writeShort(0, 16711935);
				int i_12_ = (385051775 * class298_sub36.out.index);
				class298_sub36.out.writeString(string,
						2138689470);
				class298_sub36.out.writeString(string_10_,
						2115793947);
				class298_sub36.out.writeByte(i);
				class298_sub36.out.writeByte(bool ? 1
						: 0);
				class298_sub36.out.index += 814893177;
				class298_sub36.out
						.method3611(
								Class361.anIntArray3913,
								i_12_,
								(class298_sub36.out.index * 385051775),
								-1325657598);
				class298_sub36.out.method3593(385051775
