...
public class Class298_Sub32_Sub8 extends Class298_Sub32 {
	...
	void method3181(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 6:
			((Class298_Sub32_Sub8) this).anInt9379 = class298_sub53
					.readUnsignedShort() * 216958721;
			break;
		case 1:
			((Class298_Sub32_Sub8) this).anInt9376 = class298_sub53
					.readUnsignedByte() * 2087340231;
			break;
		case 0:
			((Class298_Sub32_Sub8) this).anInt9371 = class298_sub53
					.readUnsignedByte() * 427847093;
			break;
		case 5:
			((Class298_Sub32_Sub8) this).anInt9373 = class298_sub53
					.readUnsignedShort()
					* -83830103;
			break;
		case 4:
			((Class298_Sub32_Sub8) this).anInt9383 = class298_sub53
					.readUnsignedShort() * 414558029;
			break;
		case 3:
			((Class298_Sub32_Sub8) this).anInt9377 = class298_sub53
					.readUnsignedShort()
					* -984012539;
			break;
		case 2:
			((Class298_Sub32_Sub8) this).anInt9378 = class298_sub53
					.readUnsignedShort() * 1949794091;
			break;
		case 7:
			((Class298_Sub32_Sub8) this).anInt9375 = class298_sub53
					.readUnsignedShort() * 1258867389;
			break;
		}
	}
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				int i_1_ = 0;
				int i_2_;
				for (i_2_ = (((Class298_Sub32_Sub8) this).anInt9373
						* -887199335 + Class250.anIntArray2760[i]); i_2_ < 0; i_2_ += 4096) {
					/* empty */
				}
				...
				if (i_2_ > i_5_
						+ (((Class298_Sub32_Sub8) this).anInt9382 * -387493705)
						&& i_2_ < i_4_ - -387493705
								* (((Class298_Sub32_Sub8) this).anInt9382)) {
					for (int i_6_ = 0; i_6_ < Class250.anInt2755 * -1474554145; i_6_++) {
						int i_7_ = 0;
						int i_8_ = (bool ? (((Class298_Sub32_Sub8) this).anInt9383 * 642247045)
								: -(642247045 * ((Class298_Sub32_Sub8) this).anInt9383));
						int i_9_;
						for (i_9_ = (Class250.anIntArray2762[i_6_] + (i_8_
								* ((((Class298_Sub32_Sub8) this).anInt9368) * -934471691) >> 12)); i_9_ < 0; i_9_ += 4096) {
							/* empty */
						}
						...
						if (i_9_ > -387493705
								* (((Class298_Sub32_Sub8) this).anInt9382)
								+ i_11_
								&& i_9_ < i_12_
										- (-387493705 * (((Class298_Sub32_Sub8) this).anInt9382)))
							is[i_6_] = (((Class298_Sub32_Sub8) this).anIntArrayArray9364[i_3_][i_10_]);
						else
							is[i_6_] = 0;
					}
				} else
					Class425.method5740(is, 0,
							Class250.anInt2755 * -1474554145, 0);
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agu.i(").append(')').toString());
		}
	}
	...
	int[] method3182(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			if ((i_15_ > i_18_ + ((Class298_Sub32_Sub8) this).anInt9382
					* -387493705)
					&& i_15_ < i_17_ - -387493705
							* (((Class298_Sub32_Sub8) this).anInt9382)) {
				for (int i_19_ = 0; i_19_ < Class250.anInt2755 * -1474554145; i_19_++) {
					int i_20_ = 0;
					int i_21_ = (bool ? ((Class298_Sub32_Sub8) this).anInt9383 * 642247045
							: -(642247045 * ((Class298_Sub32_Sub8) this).anInt9383));
					int i_22_;
					...
					if (i_22_ > -387493705
							* (((Class298_Sub32_Sub8) this).anInt9382) + i_24_
							&& i_22_ < i_25_ - -387493705
									* ((Class298_Sub32_Sub8) this).anInt9382)
	...
	void method3183(short i) {
		try {
			Random random = new Random(
					(long) (1685453047 * (((Class298_Sub32_Sub8) this).anInt9376)));
			...
			((Class298_Sub32_Sub8) this).anIntArrayArray9381 = (new int[((Class298_Sub32_Sub8) this).anInt9376 * 1685453047][1
					+ ((Class298_Sub32_Sub8) this).anInt9371 * -327362403]);
			((Class298_Sub32_Sub8) this).anIntArrayArray9364 = (new int[1685453047 * ((Class298_Sub32_Sub8) this).anInt9376][((Class298_Sub32_Sub8) this).anInt9371
					* -327362403]);
			...
			for (int i_28_ = 0; i_28_ < 1685453047 * ((Class298_Sub32_Sub8) this).anInt9376; i_28_++) {
				if (i_28_ > 0) {
					...
					int i_30_ = (((Class298_Sub19_Sub3.method3039(random, 4096,
							(byte) -30) - 2048) * (((Class298_Sub32_Sub8) this).anInt9377 * -1888601139)) >> 12);
					i_29_ += i_30_ * i_27_ >> 12;
					((Class298_Sub32_Sub8) this).anIntArray9380[i_28_] = i_29_
							+ (((Class298_Sub32_Sub8) this).anIntArray9380[i_28_ - 1]);
				}
				((Class298_Sub32_Sub8) this).anIntArrayArray9381[i_28_][0] = 0;
				for (int i_31_ = 0; (i_31_ < ((Class298_Sub32_Sub8) this).anInt9371
						* -327362403); i_31_++) {
					if (i_31_ > 0) {
						int i_32_ = (-934471691 * ((Class298_Sub32_Sub8) this).anInt9368);
						int i_33_ = (((Class298_Sub19_Sub3.method3039(random,
								4096, (byte) -82) - 2048) * (((Class298_Sub32_Sub8) this).anInt9378 * -1484830845)) >> 12);
						i_32_ += i_33_ * i_26_ >> 12;
						((Class298_Sub32_Sub8) this).anIntArrayArray9381[i_28_][i_31_] = i_32_
								+ (((Class298_Sub32_Sub8) this).anIntArrayArray9381[i_28_][i_31_ - 1]);
					}
					((Class298_Sub32_Sub8) this).anIntArrayArray9364[i_28_][i_31_] = ((((Class298_Sub32_Sub8) this).anInt9375
							* -762707819 > 0) ? 4096 - (Class298_Sub19_Sub3
							.method3039(
									random,
									(((Class298_Sub32_Sub8) this).anInt9375 * -762707819),
									(byte) 23))
							: 4096);
				}
				((Class298_Sub32_Sub8) this).anIntArrayArray9381[i_28_][-327362403
						* ((Class298_Sub32_Sub8) this).anInt9371] = 4096;
			}
			((Class298_Sub32_Sub8) this).anIntArray9380[1685453047 * ((Class298_Sub32_Sub8) this).anInt9376] = 4096;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agu.ac(").append(')').toString());
		}
	}
	...
	int[] method3188(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			if ((i_35_ > i_38_ + ((Class298_Sub32_Sub8) this).anInt9382
					* -387493705)
					&& i_35_ < i_37_ - -387493705
							* (((Class298_Sub32_Sub8) this).anInt9382)) {
				for (int i_39_ = 0; i_39_ < Class250.anInt2755 * -1474554145; i_39_++) {
					int i_40_ = 0;
					int i_41_ = (bool ? ((Class298_Sub32_Sub8) this).anInt9383 * 642247045
							: -(642247045 * ((Class298_Sub32_Sub8) this).anInt9383));
					int i_42_;
					...
					if (i_42_ > -387493705
							* (((Class298_Sub32_Sub8) this).anInt9382) + i_44_
							&& i_42_ < i_45_ - -387493705
									* ((Class298_Sub32_Sub8) this).anInt9382)
