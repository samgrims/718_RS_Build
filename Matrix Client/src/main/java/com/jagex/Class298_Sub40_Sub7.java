...
public class Class298_Sub40_Sub7 extends Class298_Sub40 {
	...
	void method3512(RsByteBuffer class298_sub53) {
		((Class298_Sub40_Sub7) this).anInt9710 = class298_sub53
				.readUnsignedShort()
				* -489279757;
	}
	...
	void method3510(ClanSettings class162, byte i) {
		try {
			class162.method1768(
					(2034735675 * ((Class298_Sub40_Sub7) this).anInt9710),
					(byte) -37);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agm.f(").append(')').toString());
		}
	}
