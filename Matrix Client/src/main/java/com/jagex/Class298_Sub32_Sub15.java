...
public class Class298_Sub32_Sub15 extends Class298_Sub32 {
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_2_ = 0; i_2_ < Class250.anInt2755 * -1474554145; i_2_++)
					is[i_2_] = (((Class298_Sub32_Sub15) this).anInt9403
							* -646346179 + ((is_1_[i_2_] * (((Class298_Sub32_Sub15) this).anInt9406 * 836630389)) >> 12));
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahd.i(").append(')').toString());
		}
	}
		...
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
					...
					is_9_[i_11_] = (((Class298_Sub32_Sub15) this).anInt9403
							* -646346179 + ((836630389 * ((Class298_Sub32_Sub15) this).anInt9406 * is_6_[i_11_]) >> 12));
					is_10_[i_11_] = (-646346179
							* ((Class298_Sub32_Sub15) this).anInt9403 + ((is_7_[i_11_] * (836630389 * ((Class298_Sub32_Sub15) this).anInt9406)) >> 12));
				}
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahd.k(").append(')').toString());
		}
	}
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_12_) {
		try {
			switch (i) {
			case 1:
				((Class298_Sub32_Sub15) this).anInt9405 = class298_sub53
						.readUnsignedShort() * 1566671509;
				break;
			case 2:
				aBoolean7382 = class298_sub53.readUnsignedByte() == 1;
				break;
			case 0:
				((Class298_Sub32_Sub15) this).anInt9403 = class298_sub53
						.readUnsignedShort()
						* -947528427;
				break;
			}
	...
	int[][] method3221(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_20_ = 0; i_20_ < Class250.anInt2755 * -1474554145; i_20_++) {
				is_17_[i_20_] = (((is_14_[i_20_] * (836630389 * ((Class298_Sub32_Sub15) this).anInt9406)) >> 12) + ((Class298_Sub32_Sub15) this).anInt9403
						* -646346179);
				is_18_[i_20_] = (((Class298_Sub32_Sub15) this).anInt9403
						* -646346179 + ((836630389 * ((Class298_Sub32_Sub15) this).anInt9406 * is_15_[i_20_]) >> 12));
				is_19_[i_20_] = (-646346179
						* ((Class298_Sub32_Sub15) this).anInt9403 + ((is_16_[i_20_] * (836630389 * ((Class298_Sub32_Sub15) this).anInt9406)) >> 12));
			}
		}
		return is;
	}
	...
	int[] method3222(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_22_ = 0; i_22_ < Class250.anInt2755 * -1474554145; i_22_++)
				is[i_22_] = (((Class298_Sub32_Sub15) this).anInt9403
						* -646346179 + ((is_21_[i_22_] * (((Class298_Sub32_Sub15) this).anInt9406 * 836630389)) >> 12));
		}
		return is;
	}
	...
	int[][] method3227(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_30_ = 0; i_30_ < Class250.anInt2755 * -1474554145; i_30_++) {
				is_27_[i_30_] = (((is_24_[i_30_] * (836630389 * ((Class298_Sub32_Sub15) this).anInt9406)) >> 12) + ((Class298_Sub32_Sub15) this).anInt9403
						* -646346179);
				is_28_[i_30_] = (((Class298_Sub32_Sub15) this).anInt9403
						* -646346179 + ((836630389 * ((Class298_Sub32_Sub15) this).anInt9406 * is_25_[i_30_]) >> 12));
				is_29_[i_30_] = (-646346179
						* ((Class298_Sub32_Sub15) this).anInt9403 + ((is_26_[i_30_] * (836630389 * ((Class298_Sub32_Sub15) this).anInt9406)) >> 12));
			}
		}
		return is;
	}
	...
	int[] method3228(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_32_ = 0; i_32_ < Class250.anInt2755 * -1474554145; i_32_++)
				is[i_32_] = (((Class298_Sub32_Sub15) this).anInt9403
						* -646346179 + ((is_31_[i_32_] * (((Class298_Sub32_Sub15) this).anInt9406 * 836630389)) >> 12));
		}
		return is;
	}
}
