...
public final class Class70 {
	...
	public int method798(int i, int i_0_) {
		try {
			...
			Class207 class207 = Class440.aClass205_5582
					.method1914(i, 976929284);
			if ('i' != class207.aChar2358)
				return -1;
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cv.b(").append(')').toString());
		}
	}
	...
	public int method799(int i, int i_1_) {
		try {
			...
			int i_3_ = (31 == class327.anInt3470 * 1394539663 ? -1
					: (1 << 1 + class327.anInt3470 * 1394539663) - 1);
			return ((method798(i_2_, 1116679673) & i_3_) >>> -1528472107
					* class327.anInt3468);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cv.p(").append(')').toString());
		}
	}
	...
	static void method802(GraphicsToolkit class_ra, int i, int i_7_, int i_8_,
		...
		try {
				...
				if (-1 != -1204256389 * class432.anInt5400)
					...
					if (i_15_ == -1976050083
						...
						if (0 == i_14_)
							...
							class_ra.method5015(i_9_ + 3, i_10_ + 3, 1, 1,
									i_16_, (byte) 7);
						else if (3 == i_14_)
							class_ra.method5015(i_9_, 3 + i_10_, 1, 1, i_16_,
									(byte) 7);
			...
			interface3 = (Interface3) class331.method4035(i, i_7_, i_8_,
					client.anInterface17_8960, -1880419927);
			if (null != interface3) {
				ObjectDefinitions class432 = (client.aClass283_8716
						.method2641(-258471564).getObjectDefinitions(interface3
						.method32((byte) -26)));
				...
				if (-1204256389 * class432.anInt5400 != -1)
					...
					if (1532834983 * class432.anInt5382 > 0)
						i_19_ = -1179648;
					if (i_17_ == 0 || i_17_ == 2)
						class_ra.method5018(i_9_, 3 + i_10_, i_9_ + 3, i_10_,
								i_19_, 1835700999);
					else
						class_ra.method5018(i_9_, i_10_, 3 + i_9_, 3 + i_10_,
								i_19_, 1577612026);
				}
			}
			interface3 = (Interface3) class331.method4058(i, i_7_, i_8_,
					(byte) 125);
			if (null != interface3) {
				ObjectDefinitions class432 = (client.aClass283_8716
						.method2641(541526744).getObjectDefinitions(interface3
						.method32((byte) 49)));
				int i_20_ = interface3.method30((short) 12476) & 0x3;
				if (-1 != -1204256389 * class432.anInt5400)
					Class82.method871(class_ra, class432, i_20_, i_9_, i_10_,
							(byte) 79);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cv.u(").append(')').toString());
		}
	}

	public static void method803(int i, String string, int i_21_, int i_22_) {
		try {
			ClientScript class298_sub37_sub17 = Class86.method963(
					Class502.aClass502_6724, i, -1, -1048089766);
			if (class298_sub37_sub17 != null) {
				Class403 class403 = Class211.method1950(1034965053);
				((Class403) class403).anIntArray5248 = new int[class298_sub37_sub17.anInt9679
						* -1516159487];
				...
				ClientScriptsExecutor.method4690(class298_sub37_sub17, 200000, class403,
						-1502517885);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cv.n(").append(')').toString());
		}
	}
	...
	static void method805(byte i) {
		try {
			Class525.aClass486_6298 = AccountCreationStage.aClass486_6060;
	...
	public static final int method807(int i, int i_26_, int i_27_, int i_28_,
			int i_29_, byte i_30_) {
		try {
			if (client.aClass283_8716.method2675(-1611682495) == null)
				return 0;
			if (i_29_ < 3) {
				Class244 class244 = client.aClass283_8716
						.method2654(1767942332);
				int i_31_ = i >> 9;
				int i_32_ = i_26_ >> 9;
				if (i_27_ < 0
						|| i_28_ < 0
						|| (i_27_ > client.aClass283_8716
								.method2629(-1972690353) - 1)
						|| i_28_ > client.aClass283_8716.method2630(-61619148) - 1)
					return 0;
				if (i_31_ < 1
						|| i_32_ < 1
						|| (i_31_ > client.aClass283_8716
								.method2629(-1988640932) - 1)
						|| (i_32_ > client.aClass283_8716
								.method2630(-694658273) - 1))
					return 0;
			...
			return client.aClass283_8716.method2675(-1611682495).aClass_xaArray3517[i_29_]
					.method6340(i, i_26_, -1371980258);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cv.ja(").append(')').toString());
		}
	}

	public static void method808(int i, int i_37_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(10,
					(long) i);
			class298_sub37_sub12.method3445(-1412217447);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("cv.z(").append(')').toString());
		}
	}
}
