...
public class Class497 {
	...
	void method6205(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
				((Class497) this).aChar6099 = Class493.method6190(
						class298_sub53.readByte(-12558881), 1872893689);
			else if (2 == i)
	...
	static void method6208(String string, String string_2_, int i) {
		try {
			...
			HashTableIterator.method5981(false, false, string, string_2_, -1L);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
