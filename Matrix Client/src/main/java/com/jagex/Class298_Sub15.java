package com.jagex;/* Class298_Sub15 - Decompiled by JODE
...
public class Class298_Sub15 extends Class298 {
	...
	Class298_Sub15(int i, byte[] is) {
		...
		((Class298_Sub15) this).anInt7268 = class298_sub53
				.readUnsignedByte()
				* -1914825713;
		...
		for (int i_0_ = 0; i_0_ < 92429039 * ((Class298_Sub15) this).anInt7268; i_0_++) {
			((Class298_Sub15) this).anIntArray7278[i_0_] = class298_sub53
					.readUnsignedByte();
		...
		for (int i_1_ = 0; i_1_ < ((Class298_Sub15) this).anInt7268 * 92429039; i_1_++)
			((Class298_Sub15) this).aBooleanArray7275[i_1_] = class298_sub53
					.readUnsignedByte() == 1;
		for (int i_2_ = 0; i_2_ < ((Class298_Sub15) this).anInt7268 * 92429039; i_2_++)
			((Class298_Sub15) this).anIntArray7280[i_2_] = class298_sub53
					.readUnsignedShort();
		for (int i_3_ = 0; i_3_ < ((Class298_Sub15) this).anInt7268 * 92429039; i_3_++)
			((Class298_Sub15) this).anIntArrayArray7279[i_3_] = new int[class298_sub53
					.readUnsignedByte()];
		for (int i_4_ = 0; i_4_ < ((Class298_Sub15) this).anInt7268 * 92429039; i_4_++) {
			for (int i_5_ = 0; (i_5_ < ((Class298_Sub15) this).anIntArrayArray7279[i_4_].length); i_5_++)
				((Class298_Sub15) this).anIntArrayArray7279[i_4_][i_5_] = class298_sub53
						.readUnsignedByte();
		}
	}
	...
	static final void method2909(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBooleanArray8957[i_6_] ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aax.wu(").append(')').toString());
		}
	}
}
