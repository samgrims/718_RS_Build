package com.jagex;/* Class422_Sub5 - Decompiled by JODE
...
public class Class422_Sub5 extends Class422 {
	...
	public int method5616(int i) {
		if (i == 0
				|| aClass298_Sub48_5346.aClass422_Sub28_7573
						.method5724(2001855764) == 1)
			return 1;
		return 2;
	}
	...
	public int method5612(int i, int i_1_) {
		try {
			if (i == 0
					|| aClass298_Sub48_5346.aClass422_Sub28_7573
							.method5724(544778968) == 1)
				return 1;
			return 2;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adf.f(").append(')').toString());
		}
	}
		...
		try {
			if (client.aBoolean8835) {
				if (class105.anObjectArray1247 != null) {
					IComponentDefinition class105_2_ = Class140.method1558(
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.ITEM_ON_ITEM,
						client.aClass25_8711.aClass449_330, (byte) 35);
				class298_sub36.out.writeShort(-1232467723
						* class105.anInt1280, 16711935);
				class298_sub36.out.writeShortLE128(
						class105.anInt1154 * -1309843523);
				class298_sub36.out.writeInt(
						Class379.anInt4099 * 1262526353, -935068496);
				class298_sub36.out.writeInt(-440872681
						* class105.idHash, -1060289644);
	...
	static final void method5644(int i) {
		try {
			for (int i_3_ = Class128.aClass148_6331.method1607(true,
					-2004625733); i_3_ != -1; i_3_ = Class128.aClass148_6331
					.method1607(false, -1890624062)) {
			...
			for (Class298_Sub37_Sub12 class298_sub37_sub12 = Class97_Sub1
				...
				if (1 == i_4_) {
					...
					if (!((Class298_Sub37_Sub12) class298_sub37_sub12).aString9611
							.equals(class105.text)) {
					...
					if (class105.anInt1184 * 1548853569 != i_5_
							|| i_6_ != class105.anInt1151 * 572201537
					...
					if (class105.animation * 1347982601 != (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359) {
						if (479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 != -1) {
							if (null == class105.anim)
								class105.anim = new Class438_Sub1();
							class105.anim
									.update(
											(((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359,
											-1984687950);
						} else
							class105.anim = null;
						class105.animation = (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 1256289055;
					...
					if ((479598359 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 != class105.anInt1190 * 7329457)
							|| ((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608)
									* -1447843633 != class105.anInt1262
									* -1086526073)
							|| (-1074324071
									* ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609 != class105.anInt1284
									* -261021353)) {
						class105.anInt1190 = (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610)
								* -161133497;
						...
						if (-1232467723 * class105.anInt1280 != -1) {
							if (-692202853 * class105.anInt1221 > 0)
								class105.anInt1284 = (class105.anInt1284
										* 237251296
										/ (-692202853 * class105.anInt1221) * -1066050969);
							else if (class105.baseWidth * 1769572195 > 0)
								class105.anInt1284 = (class105.anInt1284
										* 237251296
					...
					if (((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359 != class105.anInt1280
							* -1232467723)
							|| (-1447843633
									* ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608 != -66163287
									* class105.anInt1281)) {
					...
					if ((-407676483 * class105.anInt1297 != (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359)
							|| ((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608)
									* -1447843633 != -1523987341
									* class105.anInt1248)
					...
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) l, (byte) 37);
					class105.aspectXType = (byte) 0;
					class105.x = ((class105.basePositionX = 1890691465 * ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * -1672688609);
					class105.aspectYType = (byte) 0;
					class105.y = (class105.basePositionY = (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608)
					...
					class105.monospaced = 1 == (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359;
				} else if (21 == i_4_) {
					...
					IComponentDefinition class105 = Class50.getIComponentDefinitions((int) l, (byte) 62);
					class105.anInt1289 = -696165999
							* ((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610;
				} else if (i_4_ == 18) {
					...
					class105
							.method1126(
									i_14_,
									(short) (479598359 * (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610)),
									(short) (-1447843633 * (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608)),
									-1799363747);
				} else if (19 == i_4_) {
					...
					class105
							.method1120(
									i_15_,
									(short) ((((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610) * 479598359),
									(short) (-1447843633 * (((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9608)),
									571287910);
				}
			}
