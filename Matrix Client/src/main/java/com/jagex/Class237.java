...
public class Class237 implements Interface24 {
	...
	public int method256(int i) {
		try {
			if (((Class237) this).aClass243_6665.method2313(
					((Class237) this).aString6666, 1689280899))
				return 100;
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jz.a(").append(')').toString());
		}
	}
	...
	public static Class296 method2192(Class243 class243, String string,
			boolean bool, int i) {
		try {
			...
			while (i_1_ < class296.anInt3169 * -1407078377) {
				RsByteBuffer class298_sub53 = new RsByteBuffer(class243
						.method2315(i_0_, is[i_2_++], (byte) -34));
	...
	static final void method2193(Class403 class403, int i) {
		try {
			...
			if (class298_sub52 == null) {
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub52.anInt7608
						* -530122905;
				int i_6_ = (class298_sub52.anInt7605 * -1740053407 << 28
						| (Class301.anInt3245 + 2122110429 * class298_sub52.anInt7607) << 14 | (Class301.anInt3238 + class298_sub52.anInt7610
						* -372920341));
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = i_6_;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jz.adg(").append(')').toString());
		}
	}

	static final void method2194(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8811
					&& !client.aBoolean8812 ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jz.amz(").append(')').toString());
		}
	}
		...
		try {
			...
			Class390.method4876(22050,
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub22_7586
							.method5706((byte) 39) == 1, 2, 1903660565);
			Class300.aClass284_3212 = Class75.method834(
					Class52_Sub2_Sub1.aCanvas9079, 0, 22050, -1188056324);
			Class68.method777(true, Class8.method318(null, -1296770048),
					1539003934);
			Class3.aClass284_68 = Class75.method834(
					Class52_Sub2_Sub1.aCanvas9079, 1, 2048, -1833287234);
			Class3.aClass284_68.method2679(Class285.aClass298_Sub19_Sub4_3083,
					2098926435);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jz.b(").append(')').toString());
		}
	}
	...
	public static void method2197(int i, byte i_9_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jz.e(").append(')').toString());
		}
	}

	static void method2198(int i, int i_10_, int i_11_, int i_12_, short i_13_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(19,
					(long) i_10_ << 32 | (long) i);
