...
public class Class273 {
	...
	public static void method2559(String string, boolean bool, boolean bool_0_,
			String string_1_, boolean bool_2_, boolean bool_3_, int i) {
		try {
			if (bool) {
				do {
					if (!bool_2_
	...
	static final void method2560(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class26
					.method397(
							...
							Class321.aClass429_3357, -1813623072);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("li.zz(").append(')').toString());
		}
	}
	...
	static final void method2561(Class403 class403, int i) {
		try {
			...
			if (client.aBoolean8638) {
				try {
					Object object = (Class212.aClass212_2426
							.method1953(
									(new Object[] {
											Integer
													.valueOf(Class298_Sub41.anInt7456 * 1914527151),
											(Boolean
													.valueOf(1 == (Class287.myPlayer.aByte10220))),
											Integer
													.valueOf(((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) }),
									-1838433046));
					if (null != object)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("li.ant(").append(')').toString());
		}
	}

	static void method2562(int i, int i_4_, int i_5_, boolean bool, int i_6_,
			boolean bool_7_, byte i_8_) {
		try {
			if (i < i_4_) {
				int i_9_ = (i + i_4_) / 2;
				int i_10_ = i;
				...
				for (int i_11_ = i; i_11_ < i_4_; i_11_++) {
					if (Class310.method3809(
							(Class474.aClass343_Sub1Array5975[i_11_]),
							class343_sub1, i_5_, bool, i_6_, bool_7_,
							-279850410) <= 0) {
				...
				method2562(1 + i_10_, i_4_, i_5_, bool, i_6_, bool_7_,
						(byte) 54);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("li.x(").append(')').toString());
		}
	}

	public static GraphicsToolkit method2563(Canvas canvas, Interface_ma interface_ma,
			int i, int i_13_, byte i_14_) {
		try {
			return new ja(canvas, interface_ma, i, i_13_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("li.a(").append(')').toString());
		}
	}
	...
	public static int method2565(short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("li.k(").append(')').toString());
		}
	}

	public static void method2566(RsByteBuffer class298_sub53, int i,
			byte i_18_) {
		try {
			Class298_Sub47 class298_sub47 = new Class298_Sub47();
			((Class298_Sub47) class298_sub47).anInt7538 = class298_sub53
					.readUnsignedByte()
					* -468176359;
			((Class298_Sub47) class298_sub47).anInt7542 = class298_sub53
					.readInt((byte) 43)
					* -530104791;
			...
			for (int i_19_ = 0; (i_19_ < ((Class298_Sub47) class298_sub47).anInt7538 * 719522345); i_19_++) {
				try {
					...
					if (i_20_ == 0 || i_20_ == 1 || 2 == i_20_) {
						...
						String string_21_ = class298_sub53
								.readString(-976277803);
						int i_22_ = 0;
						if (1 == i_20_)
						...
						if (Class136.method1498(string, (byte) 67)
								.getClassLoader() == null)
							throw new SecurityException();
						((Class298_Sub47) class298_sub47).aFieldArray7539[i_19_] = Class136
								.method1498(string, (byte) 81)
								.getDeclaredField(string_21_);
					} else if (i_20_ == 3 || 4 == i_20_) {
						String string = class298_sub53.readString(-1377559322);
						String string_23_ = class298_sub53
								.readString(1945683710);
						int i_24_ = class298_sub53.readUnsignedByte();
						String[] strings = new String[i_24_];
						for (int i_25_ = 0; i_25_ < i_24_; i_25_++)
							strings[i_25_] = class298_sub53
									.readString(-1854507369);
						String string_26_ = class298_sub53
								.readString(-1619475079);
						byte[][] is = new byte[i_24_][];
						if (i_20_ == 3) {
							for (int i_27_ = 0; i_27_ < i_24_; i_27_++) {
								int i_28_ = class298_sub53
										.readInt((byte) -44);
								is[i_27_] = new byte[i_28_];
								class298_sub53.readBytes(is[i_27_], 0, i_28_,
										-953523806);
							}
						}
						((Class298_Sub47) class298_sub47).anIntArray7537[i_19_] = i_20_;
						...
						for (int i_29_ = 0; i_29_ < i_24_; i_29_++)
							var_classes[i_29_] = Class136.method1498(
									strings[i_29_], (byte) 64);
						Class var_class = Class136.method1498(string_26_,
								(byte) 5);
						if (Class136.method1498(string, (byte) 23)
								.getClassLoader() == null)
							throw new SecurityException();
						Method[] methods = Class136.method1498(string,
								(byte) 42).getDeclaredMethods();
