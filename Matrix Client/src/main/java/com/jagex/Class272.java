...
public class Class272 {
	...
	Class298_Sub26_Sub1 method2549(int i, int i_0_, int[] is, int i_1_) {
		try {
			...
			i_2_ |= i << 16;
			long l = (long) i_2_;
			Class298_Sub26_Sub1 class298_sub26_sub1 = ((Class298_Sub26_Sub1) ((Class272) this).aClass440_2902
					.method5852(l));
			if (null != class298_sub26_sub1)
				return class298_sub26_sub1;
			if (is != null && is[0] <= 0)
				return null;
			Class278 class278 = Class278.method2604(
					((Class272) this).aClass243_2901, i, i_0_);
			if (class278 == null)
				return null;
	...
	Class298_Sub26_Sub1 method2550(int i, int i_3_, int[] is, int i_4_) {
		try {
			...
			if (is != null && is[0] <= 0)
				return null;
			Class298_Sub23 class298_sub23 = ((Class298_Sub23) ((Class272) this).aClass440_2899
					.method5852(l));
			if (class298_sub23 == null) {
				class298_sub23 = Class298_Sub23.method3065(
						(((Class272) this).aClass243_2900), i, i_3_);
	...
	static final void method2553(Class403 class403, int i) {
		try {
			...
			Class298_Sub43
					.method3527(class105, class119, class403, (byte) -127);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lh.el(").append(')').toString());
		}
	}
	...
	static final void method2554(Class403 class403, int i) {
		try {
			...
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.aClass198_2027,
					client.aClass25_8711.aClass449_330, (byte) 34);
