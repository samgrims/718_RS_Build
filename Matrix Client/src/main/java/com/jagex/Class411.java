...
public class Class411 {
	...
	public static Class411 aClass411_5320 = new Class411("matrix",
			"Matrix", 0);
	...
	public static long method5574(int i, int i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rb.r(").append(')').toString());
		}
	}

	static void method5575(Entity class365_sub1_sub1_sub2,
			int i, int i_2_) {
		try {
			if (null != class365_sub1_sub1_sub2.anIntArray10093) {
				...
				if (i_3_ != class365_sub1_sub1_sub2.aClass438_10078
					...
					class365_sub1_sub1_sub2.aClass438_10078.method5833(i_3_,
							class365_sub1_sub1_sub2.aClass438_10078
									.method5827((short) 758), -684011169);
		...
		try {
			...
			if (class298_sub2 == null) {
				...
				ItemDefinitions class468 = (Class298_Sub32_Sub14.aClass477_9400
						.getItemDefinitions(1768239597 * class298_sub12.anInt7257));
				...
				for (Class298_Sub12 class298_sub12_8_ = (Class298_Sub12) class298_sub2.aClass453_7166
						.method5939(1766612795); null != class298_sub12_8_; class298_sub12_8_ = ((Class298_Sub12) class298_sub2.aClass453_7166
						.method5944(49146))) {
					class468 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
	...
	static void method5579(int i) {
		try {
			...
			client.anInt8744 = ((int) (Math.random() * 80.0) - 40)
					* -1010535049;
			client.anInt8801 = ((int) (Math.random() * 120.0) - 60)
					* -1216239003;
			...
			client.aClass283_8716.method2640((byte) -46)
					.method4324(-1196946367);
			...
			Class82_Sub6.aString6845 = Tradution.aClass470_5854.method6049(
			...
			Class422_Sub25.aClass298_Sub48_8425.method3540(
					...
					Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub17_7564
							.method5689(-2013953489), 185315871);
			client.anInt8713 = 0;
	...
	static final void method5580(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class84.aClass305_770
