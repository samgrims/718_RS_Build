...
public class Class280 {
	...
	Class280() {
		...
		for (int i = 0; i < ((Class280) this).anInt2983 * 8; i++)
			((Class280) this).anIntArray2987[i] = ((is[i >> 3] & 1 << (i & 0x7)) != 0 ? Class298_Sub23
					.method3070(8)
					: -1);
	}
	...
	void method2609(float[] fs, int i, boolean bool) {
		...
		if (!bool) {
			...
			int i_4_ = ((Class280) this).anInt2981
					- ((Class280) this).anInt2982;
			...
			for (int i_6_ = 0; i_6_ < 8; i_6_++) {
				...
				while (i_7_ < i_5_) {
					if (i_6_ == 0) {
						int i_8_ = Class298_Sub23.aClass265Array7328[((Class280) this).anInt2986]
								.method2517();
						for (int i_9_ = i_3_ - 1; i_9_ >= 0; i_9_--) {
							if (i_7_ + i_9_ < i_5_)
								is[i_7_ + i_9_] = i_8_
										% ((Class280) this).anInt2983;
							i_8_ /= ((Class280) this).anInt2983;
						}
					}
					for (int i_10_ = 0; i_10_ < i_3_; i_10_++) {
						int i_11_ = is[i_7_];
						int i_12_ = (((Class280) this).anIntArray2987[i_11_ * 8
								+ i_6_]);
						if (i_12_ >= 0) {
							int i_13_ = (((Class280) this).anInt2982 + i_7_
									* ((Class280) this).anInt2984);
