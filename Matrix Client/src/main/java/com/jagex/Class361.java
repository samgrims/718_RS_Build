	...
	static final void method4303(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pa.mb(").append(')').toString());
		}
	}

	public static int method4304(CharSequence charsequence, int i, int i_0_,
			byte[] is, int i_1_, byte i_2_) {
		try {
			int i_3_ = i_0_ - i;
		...
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318
					.method4307(
							...
							245040087).method4562(Class128.aClass148_6331,
							-1717639697) ? 1 : 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pa.j(").append(')').toString());
		}
	}
		...
		try {
			if (i < i_5_) {
				...
				for (int i_10_ = i; i_10_ < i_5_; i_10_++) {
					if (null == string
							|| (null != strings[i_10_] && strings[i_10_]
									.compareTo(string) < (i_10_ & 0x1))) {
