	...
	public static int calculateRoute(int startX, int startY, int size, Class336 class336,
		...
		try {
			...
			if (size == 1)
				...
				bool_6_ = Class228.method2120(startX, startY, class336, planeClipData,
						-1327541421);
			else
				bool_6_ = Class372.method4593(startX, startY, size, class336,
					...
					for (int i_18_ = i_14_ - i_13_; i_18_ <= i_13_ + i_14_; i_18_++) {
						for (int i_19_ = i_15_ - i_13_; i_19_ <= i_15_ + i_13_; i_19_++) {
							...
							if (i_20_ >= 0
									...
									&& i_20_ < 128
									&& i_21_ < 128
									&& (Class285.anIntArrayArray3080[i_20_][i_21_] < 100)) {
								int i_22_ = 0;
								if (i_18_ < i_14_)
									i_22_ = i_14_ - i_18_;
								...
								if (i_24_ < i_11_
										|| (i_24_ == i_11_ && (Class285.anIntArrayArray3080[i_20_][i_21_]) < i_12_)) {
									i_11_ = i_24_;
			...
			int i_27_;
			int i_26_ = (i_27_ = Class285.anIntArrayArray3076[i_9_ - i_7_][i_10_
					- i_8_]);
	...
	static final void method3404(Class403 class403, byte i) {
		try {
			...
			if (class298_sub37_sub13 == null) {
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (-2052483955
						* class298_sub37_sub13.anInt9647 - class298_sub37_sub13.anInt9650 * 1364716801);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abv.adj(").append(')').toString());
		}
	}

	static Class98_Sub2 method3405(RsByteBuffer class298_sub53, int i) {
		try {
			return new Class98_Sub2(class298_sub53.readShort(1780611979),
					class298_sub53.readShort(2084327915), class298_sub53
							.readShort(1750072102), class298_sub53
							.readShort(1941131752), class298_sub53
							.read24BitUnsignedInteger((byte) 56), class298_sub53
							.readUnsignedByte());
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abv.r(").append(')').toString());
		}
	}
}
