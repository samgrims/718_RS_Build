...
public class Class298_Sub32_Sub27 extends Class298_Sub32 {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			if (aClass257_7384.aBoolean2810)
				Class425.method5740(is, 0, -1474554145 * Class250.anInt2755,
						(((Class298_Sub32_Sub27) this).anInt9497 * -945993703));
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahp.i(").append(')').toString());
		}
	}
	...
	void method3310(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 0:
			((Class298_Sub32_Sub27) this).anInt9497 = ((class298_sub53
					.readUnsignedByte() << 12) / 255 * 1128895529);
		}
	}
