...
public abstract class Class323 {
		...
		try {
			...
			if (Class452.aBoolean5642) {
				...
				for (int i_4_ = 0; i_4_ < class456s.length; i_4_++) {
					...
					if (i_1_ == class456.anInt5663 * 28445523
							&& class456.anInt5665 * 262154323 == i_2_) {
						i_3_ = i_4_;
						break;
					}
				}
	...
	static final void method3947(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nl.gx(").append(')').toString());
		}
	}

	static void method3948(GraphicsToolkit class_ra, int i, int i_5_, int i_6_,
		...
		try {
			...
			class_ra.method5014(1 + i, 18 + i_5_, i_6_ - 2, i_7_ - 19, i_9_,
					-1588493317);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nl.aq(").append(')').toString());
		}
	}
	...
	static final void method3949(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class505
					.method6259(string, i_11_, Class130_Sub2.aClass57Array6959,
							-1274509130);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nl.zn(").append(')').toString());
		}
	}
}
