...
public class Class298_Sub32_Sub11 extends Class298_Sub32 {
	...
	void method3201(int i, RsByteBuffer class298_sub53) {
		if (0 == i)
			((Class298_Sub32_Sub11) this).anInt9395 = class298_sub53
					.readUnsignedShort()
					* -715315885;
	}
	...
	boolean method3203(int i) {
		try {
			...
			if (-2121898277 * ((Class298_Sub32_Sub11) this).anInt9395 >= 0) {
				IndexedImage class89 = (anInt9394 * -1132597157 >= 0 ? IndexedImage
						.method987(
								aClass243_9393,
								-1132597157 * anInt9394,
								(-2121898277 * (((Class298_Sub32_Sub11) this).anInt9395)))
						: IndexedImage.method979(aClass243_9393,
								(((Class298_Sub32_Sub11) this).anInt9395)
										* -2121898277));
				class89.method984();
				((Class298_Sub32_Sub11) this).anIntArray9398 = class89
						.method990();
				((Class298_Sub32_Sub11) this).anInt9396 = -506570825
						* class89.anInt812;
				((Class298_Sub32_Sub11) this).anInt9397 = -274319933
						* class89.anInt816;
				return true;
			}
			return false;
	...
	int[][] method3132(int i, byte i_1_) {
		try {
			...
			if (aClass239_7380.aBoolean2607 && method3203(-2021836506)) {
				...
				int[] is_3_ = is[1];
				int[] is_4_ = is[2];
				int i_5_ = (1274885639 * ((Class298_Sub32_Sub11) this).anInt9396 * ((461985445 * Class250.anInt2756 != (-2125962517 * ((Class298_Sub32_Sub11) this).anInt9397)) ? (((Class298_Sub32_Sub11) this).anInt9397
						* -2125962517 * i / (Class250.anInt2756 * 461985445))
						: i));
				if (((Class298_Sub32_Sub11) this).anInt9396 * 1274885639 == -1474554145
						* Class250.anInt2755) {
					...
					for (int i_8_ = 0; i_8_ < -1474554145 * Class250.anInt2755; i_8_++) {
						int i_9_ = (i_8_
								* (((Class298_Sub32_Sub11) this).anInt9396 * 1274885639) / (Class250.anInt2755 * -1474554145));
						int i_10_ = (((Class298_Sub32_Sub11) this).anIntArray9398[i_9_
								+ i_5_]);
	...
	int[][] method3205(int i) {
		...
		if (aClass239_7380.aBoolean2607 && method3203(1831903701)) {
			...
			int[] is_12_ = is[1];
			int[] is_13_ = is[2];
			int i_14_ = (1274885639 * ((Class298_Sub32_Sub11) this).anInt9396 * ((461985445 * Class250.anInt2756 != (-2125962517 * ((Class298_Sub32_Sub11) this).anInt9397)) ? (((Class298_Sub32_Sub11) this).anInt9397
					* -2125962517 * i / (Class250.anInt2756 * 461985445))
					: i));
			if (((Class298_Sub32_Sub11) this).anInt9396 * 1274885639 == -1474554145
					* Class250.anInt2755) {
				...
				for (int i_17_ = 0; i_17_ < -1474554145 * Class250.anInt2755; i_17_++) {
					int i_18_ = (i_17_
							* (((Class298_Sub32_Sub11) this).anInt9396 * 1274885639) / (Class250.anInt2755 * -1474554145));
					int i_19_ = (((Class298_Sub32_Sub11) this).anIntArray9398[i_18_
							+ i_14_]);
	...
	int[][] method3206(int i) {
		...
		if (aClass239_7380.aBoolean2607 && method3203(508632010)) {
			...
			int[] is_21_ = is[1];
			int[] is_22_ = is[2];
			int i_23_ = (1274885639 * ((Class298_Sub32_Sub11) this).anInt9396 * ((461985445 * Class250.anInt2756 != (-2125962517 * ((Class298_Sub32_Sub11) this).anInt9397)) ? (((Class298_Sub32_Sub11) this).anInt9397
					* -2125962517 * i / (Class250.anInt2756 * 461985445))
					: i));
			if (((Class298_Sub32_Sub11) this).anInt9396 * 1274885639 == -1474554145
					* Class250.anInt2755) {
				...
				for (int i_26_ = 0; i_26_ < -1474554145 * Class250.anInt2755; i_26_++) {
					int i_27_ = (i_26_
							* (((Class298_Sub32_Sub11) this).anInt9396 * 1274885639) / (Class250.anInt2755 * -1474554145));
					int i_28_ = (((Class298_Sub32_Sub11) this).anIntArray9398[i_27_
							+ i_23_]);
