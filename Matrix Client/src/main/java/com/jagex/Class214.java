...
public class Class214 implements Runnable {
	...
	static final void method1988(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("j.fl(").append(')').toString());
		}
	}

	static final void method1989(IComponentDefinition class105, Class119 class119,
			Class403 class403, byte i) {
		try {
			class105.anInt1272 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -1122372539;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("j.kb(").append(')').toString());
		}
	}
	...
	static final void method1992(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = (((Class403) class403).aClass298_Sub25_5237.aClass163Array7359[i_0_].aString1681);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("j.xm(").append(')').toString());
		}
	}
		...
		try {
			...
			while (i_5_ < i_6_) {
				...
				if (i_7_ < 128) {
					...
					if (1 + i_5_ < i_6_ && (is[i_5_] & 0xc0) == 128
							&& 128 == (is[1 + i_5_] & 0xc0)) {
					...
					if (2 + i_5_ < i_6_ && 128 == (is[i_5_] & 0xc0)
							&& 128 == (is[i_5_ + 1] & 0xc0)
							&& (is[i_5_ + 2] & 0xc0) == 128) {
						i_8_ = ((i_7_ & 0x7) << 18 | (is[i_5_++] & 0x3f) << 12
								| (is[i_5_++] & 0x3f) << 6 | is[i_5_++] & 0x3f);
