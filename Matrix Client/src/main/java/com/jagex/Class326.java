...
public class Class326 {
	...
	static final void method3970(Class403 class403, byte i) {
		try {
			...
			String string_21_ = ((String) (((Class403) class403).anObjectArray5240[-203050393
					* ((Class403) class403).anInt5241 + 1]));
			Class358
					.method4288(string, i_19_ == 1, i_20_, string_21_, 37914209);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class344.anInt3688 * 367592105;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("np.abb(").append(')').toString());
		}
	}
	...
	static final void method3971(Class403 class403, short i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub5_7572
					.method5612(i_22_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("np.aoa(").append(')').toString());
		}
	}
	...
	static final void method3972(Class403 class403, byte i) {
		try {
			...
			Class21
					.method365(class105, class119, true, 1, class403,
							1939929714);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("np.hy(").append(')').toString());
		}
	}
