...
public abstract class Class318 {
	...
	public abstract int readBytes(byte[] is, int i, int i_1_, byte i_2_)
			throws IOException;
	...
	public abstract void method3862(byte[] is, int i, int i_3_)
			throws IOException;

	public abstract void method3863();

	public abstract int method3864(byte[] is, int i, int i_4_)
			throws IOException;

	public abstract void method3865(byte[] is, int i, int i_5_)
			throws IOException;

	public abstract void method3866(byte[] is, int i, int i_6_)
			throws IOException;

	public abstract void method3867(byte i);

	public abstract void method3868(byte[] is, int i, int i_7_, int i_8_)
			throws IOException;

	public abstract int method3869(byte[] is, int i, int i_9_)
			throws IOException;
	...
	static final void method3870(Class403 class403, int i) {
		try {
			if (client.anInt8942 * 1131012101 == 0)
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = client.anInt8941
						* -1054937867;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ng.vb(").append(')').toString());
		}
	}
	...
	static final void method3871(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (i_11_ - i_10_)
					* (i_14_ - i_12_) / (i_13_ - i_12_) + i_10_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ng.yo(").append(')').toString());
		}
	}
	...
	public static Container method3874(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ng.t(").append(')').toString());
		}
	}

	static final void method3875(IComponentDefinition class105, Class119 class119,
