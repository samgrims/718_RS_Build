...
public class Class377 {
	...
	public Class377(Class243 class243) {
		byte[] is = class243.method2294(
				(Class380.aClass380_4100.anInt4108 * -363169051), (byte) 11);
	...
	void method4661(RsByteBuffer class298_sub53, int i) {
		try {
			for (;;) {
				...
				if (1 == i_0_)
					anInterface19_4091 = ObjectDefinitions.method5786(class298_sub53,
							(byte) -47);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pr.a(").append(')').toString());
		}
	}
	...
	static final void method4663(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub10_7548
					.method5660(-575221319) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pr.anr(").append(')').toString());
		}
	}
	...
	public static String method4664(long l) {
		try {
			...
			while (0L != l) {
				...
				l /= 37L;
				stringbuilder
						.append(Class420.aCharArray5342[(int) (l_3_ - 37L * l)]);
			}
			return stringbuilder.reverse().toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pr.f(").append(')').toString());
		}
	}

	static final void method4665(IComponentDefinition class105, Class119 class119,
	...
	static final void method4667(Class403 class403, int i) {
		try {
			...
			if (2 == 1131012101 * client.anInt8942 && i_5_ >= 0
					&& i_5_ < client.anInt8941 * -1054937867)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = client.aBooleanArray8722[i_5_] ? 1
						: 0;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pr.wt(").append(')').toString());
		}
	}
	...
	static final void method4668(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = ((Class403) class403).aClass162_5252.aStringArray1668[i_6_];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pr.xw(").append(')').toString());
		}
	}
}
