...
public class Class304 {
	...
	static final void method3739(Class403 class403, int i) {
		try {
			...
			Class21
					.method365(class105, class119, true, 0, class403,
							1313790889);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mq.hj(").append(')').toString());
		}
	}
	...
	public static Class128 method3741(RsByteBuffer class298_sub53, int i) {
		try {
			...
			return new Class128_Sub1(class128.aClass139_6322,
					...
					class128.anInt6324 * 782326281, i_5_, i_6_, i_7_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mq.i(").append(')').toString());
		}
	}

	static String method3742(long l) {
		try {
			return Class92.method1003(new Date(l),
					"EEE dd-MMM-yyyy HH:mm:ss zzz", -1799547908);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mq.no(").append(')').toString());
		}
	}
}
