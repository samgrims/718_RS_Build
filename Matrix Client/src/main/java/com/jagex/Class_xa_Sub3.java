...
public class Class_xa_Sub3 extends Class_xa {
	...
	public Class_na aa(int i, int i_2_, Class_na class_na) {
		...
		if (class_na_sub1 != null && class_na_sub1.method3481(i_3_, i_3_)) {
			...
			class_na_sub1_4_ = new Class_na_Sub1(
					((Class_xa_Sub3) this).aClass_ra_Sub2_8535, i_3_, i_3_);
		class_na_sub1_4_.method3485(0, 0, i_3_, i_3_);
		method6375(class_na_sub1_4_, i, i_2_);
		return class_na_sub1_4_;
	}

	public void ad(Class_na class_na, int i, int i_5_, int i_6_, int i_7_,
			boolean bool) {
		if (((Class_xa_Sub3) this).aClass44_8541 != null && class_na != null) {
			int i_8_ = (i
					- (i_5_
							* (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).anInt8066) >> 8) >> ((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).anInt8064);
			int i_9_ = (i_6_
					- (i_5_
							* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8026) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			((Class_xa_Sub3) this).aClass44_8541
					.method491(class_na, i_8_, i_9_);
		}
	}

	public void SA() {
		if (((Class_xa_Sub3) this).anInt8543 > 0) {
			byte[][] is = (new byte[anInt6287 * -506105871 + 1][anInt6286
					* -1148794921 + 1]);
			for (int i = 1; i < anInt6287 * -506105871; i++) {
				for (int i_10_ = 1; i_10_ < anInt6286 * -1148794921; i_10_++)
					is[i][i_10_] = (byte) (((((Class_xa_Sub3) this).aByteArrayArray8545[i - 1][i_10_]) >> 2)
							+ ((((Class_xa_Sub3) this).aByteArrayArray8545[i + 1][i_10_]) >> 3)
							+ ((((Class_xa_Sub3) this).aByteArrayArray8545[i][i_10_ - 1]) >> 2)
							+ ((((Class_xa_Sub3) this).aByteArrayArray8545[i][i_10_ + 1]) >> 3) + ((((Class_xa_Sub3) this).aByteArrayArray8545[i][i_10_]) >> 1));
			}
			((Class_xa_Sub3) this).aClass298Array8534 = new Class298[((Class_xa_Sub3) this).aClass440_8549
					.method5855(1429819619)];
			((Class_xa_Sub3) this).aClass440_8549.method5854(
					((Class_xa_Sub3) this).aClass298Array8534, 2105233647);
			for (int i = 0; i < ((Class_xa_Sub3) this).aClass298Array8534.length; i++)
				((Class298_Sub5) ((Class_xa_Sub3) this).aClass298Array8534[i])
						.method2859(((Class_xa_Sub3) this).anInt8543);
			int i = 24;
			if (((Class_xa_Sub3) this).anIntArrayArrayArray8533 != null)
				i += 4;
			if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0)
				i += 12;
			NativeHeapBuffer nativeheapbuffer = ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).aNativeHeap8181
					.f(((Class_xa_Sub3) this).anInt8543 * i, false);
			Stream stream = new Stream(nativeheapbuffer);
			Class298_Sub5[] class298_sub5s = new Class298_Sub5[((Class_xa_Sub3) this).anInt8543];
			int i_11_ = Class422_Sub4.method5639(
					(((Class_xa_Sub3) this).anInt8543 / 4), 1715118458);
			if (i_11_ < 1)
				i_11_ = 1;
			...
			for (int i_13_ = 0; i_13_ < anInt6287 * -506105871; i_13_++) {
				for (int i_14_ = 0; i_14_ < anInt6286 * -1148794921; i_14_++) {
					if ((((Class_xa_Sub3) this).anIntArrayArrayArray8528[i_13_][i_14_]) != null) {
						...
						int[] is_20_ = ((((Class_xa_Sub3) this).anIntArrayArrayArray8532 != null) ? (((Class_xa_Sub3) this).anIntArrayArrayArray8532[i_13_][i_14_])
								: null);
						int[] is_21_ = ((((Class_xa_Sub3) this).anIntArrayArrayArray8533 != null) ? (((Class_xa_Sub3) this).anIntArrayArrayArray8533[i_13_][i_14_])
								: null);
						if (is_18_ == null)
							is_18_ = is_19_;
						...
						short[] is_40_ = (((Class_xa_Sub3) this).aShortArrayArray8550[i_14_
								* (anInt6287 * -506105871) + i_13_] = new short[is_19_.length]);
						for (int i_41_ = 0; i_41_ < is_19_.length; i_41_++) {
							...
							long l = ((long) i_47_ << 48 | (long) i_46_ << 32
									| (long) (i_44_ << 16) | (long) i_45_);
							...
							if (i_49_ == 0 && i_50_ == 0) {
								...
								i_51_ -= i_33_;
									...
									&& i_50_ == anInt6288 * -1212653763) {
								f_54_ = f_24_;
								f_55_ = f_25_;
								f_56_ = f_26_;
								i_51_ -= i_34_;
							} else if (i_49_ == anInt6288 * -1212653763
									&& i_50_ == anInt6288 * -1212653763) {
								f_54_ = f_27_;
								f_55_ = f_28_;
								f_56_ = f_29_;
								...
								int i_65_ = i_33_
										+ ((i_36_ - i_33_) * i_49_ >> anInt6289
												* -2137349879);
								int i_66_ = i_34_
										+ ((i_35_ - i_34_) * i_49_ >> anInt6289
												* -2137349879);
								i_51_ -= i_65_
										+ ((i_66_ - i_65_) * i_50_ >> anInt6289
												* -2137349879);
							}
							if (i_46_ != -1) {
								...
								if (i_67_ < 2)
									...
									i_67_ = 126;
								i_52_ = (Class294.anIntArray3165[i_46_ & 0xff80
										| i_67_]);
								if ((((Class_xa_Sub3) this).anInt8523 & 0x7) == 0) {
									f_53_ = ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[0])
											* f_54_
											+ (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[1])
											* f_55_ + (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[2])
											* f_56_);
									f_53_ = (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8130 + (f_53_ * (f_53_ > 0.0F ? (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8131)
											: (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8132))));
								}
							}
							Class298 class298 = null;
							if (((i_42_ & ((Class_xa_Sub3) this).anInt8521 - 1) == 0)
									&& ((i_43_ & ((Class_xa_Sub3) this).anInt8521 - 1) == 0))
							...
							if (class298 == null) {
								...
								if (i_47_ != i_46_) {
									...
									if (i_70_ < 2)
										...
										i_70_ = 126;
									i_69_ = (Class294.anIntArray3165[i_47_
											& 0xff80 | i_70_]);
									if ((((Class_xa_Sub3) this).anInt8523 & 0x7) == 0) {
										float f_71_ = ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[0])
												* f_54_
												+ (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[1])
												* f_55_ + ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[2]) * f_56_));
										f_71_ = ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8130) + (f_53_ * (f_53_ > 0.0F ? (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8131)
												: (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8132))));
								...
								if (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aBoolean8143) {
									...
									stream.d((float) (method6340(i_42_, i_43_,
											-1789282838) + i_48_));
									...
									if ((((Class_xa_Sub3) this).anIntArrayArrayArray8533) != null)
										stream
												.d(is_21_ != null ? (float) (is_21_[i_41_] - 1)
														: 0.0F);
									if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0) {
										stream.d(f_54_);
										stream.d(f_55_);
									...
									stream.u((float) (method6340(i_42_, i_43_,
											-1884194336) + i_48_));
									...
									if ((((Class_xa_Sub3) this).anIntArrayArrayArray8533) != null)
										stream
												.u(is_21_ != null ? (float) (is_21_[i_41_] - 1)
														: 0.0F);
									if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0) {
										stream.u(f_54_);
										stream.u(f_55_);
								...
								class440.method5858(new Class298_Sub20(
										is_40_[i_41_]), l);
							} else {
								is_40_[i_41_] = ((Class298_Sub20) class298).aShort7314;
								i_68_ = is_40_[i_41_] & 0xffff;
								if (i_46_ != -1
										&& ((class298_sub5s_15_[i_41_].pointer * 7051297995265073167L) < (class298_sub5s[i_68_].pointer * 7051297995265073167L)))
									class298_sub5s[i_68_] = class298_sub5s_15_[i_41_];
							}
							for (int i_75_ = 0; i_75_ < i_37_; i_75_++)
								class298_sub5s_12_[i_75_].method2857(i_68_,
										i_52_, i_51_, f_53_);
			...
			for (int i_77_ = 0; i_77_ < anInt6287 * -506105871; i_77_++) {
				for (int i_78_ = 0; i_78_ < anInt6286 * -1148794921; i_78_++) {
					short[] is_79_ = (((Class_xa_Sub3) this).aShortArrayArray8550[i_78_
							* (anInt6287 * -506105871) + i_77_]);
					if (is_79_ != null) {
						int i_80_ = 0;
						int i_81_ = 0;
						while (i_81_ < is_79_.length) {
							...
							if (class298_sub5_85_ != null) {
								class298_sub5_85_.method2856(i_77_, i_78_,
										i_80_);
								if (class298_sub5_87_ == null
										|| ((class298_sub5_85_.pointer * 7051297995265073167L) < (class298_sub5_87_.pointer * 7051297995265073167L)))
									class298_sub5_87_ = class298_sub5_85_;
							}
							if (class298_sub5_86_ != null) {
								class298_sub5_86_.method2856(i_77_, i_78_,
										i_80_);
								if (class298_sub5_87_ == null
										|| ((class298_sub5_86_.pointer * 7051297995265073167L) < (class298_sub5_87_.pointer * 7051297995265073167L)))
							...
							if (class298_sub5_87_ != null) {
								...
								class298_sub5_87_.method2856(i_77_, i_78_,
										i_80_);
							}
							i_80_++;
						}
			...
			stream.x();
			((Class_xa_Sub3) this).anInterface1_8538 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
					.method5245(i, nativeheapbuffer, stream.f(), false);
			if (((Class_xa_Sub3) this).anInterface1_8538 instanceof Class40_Sub2)
				nativeheapbuffer.t();
			((Class_xa_Sub3) this).aClass32_8539 = new Class32(
					((Class_xa_Sub3) this).anInterface1_8538, 5126, 3, 0);
			((Class_xa_Sub3) this).aClass32_8540 = new Class32(
					((Class_xa_Sub3) this).anInterface1_8538, 5121, 4, 12);
			int i_88_;
			if (((Class_xa_Sub3) this).anIntArrayArrayArray8533 != null) {
				((Class_xa_Sub3) this).aClass32_8517 = new Class32(
						((Class_xa_Sub3) this).anInterface1_8538, 5126, 3, 16);
				i_88_ = 28;
			} else {
				((Class_xa_Sub3) this).aClass32_8517 = new Class32(
						((Class_xa_Sub3) this).anInterface1_8538, 5126, 2, 16);
				i_88_ = 24;
			}
			if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0)
				((Class_xa_Sub3) this).aClass32_8519 = new Class32(
						((Class_xa_Sub3) this).anInterface1_8538, 5126, 3,
						i_88_);
			...
			for (int i_89_ = 0; i_89_ < ((Class_xa_Sub3) this).aClass298Array8534.length; i_89_++) {
				...
				ls[i_89_] = class298_sub5.pointer * 7051297995265073167L;
				class298_sub5.method2860(((Class_xa_Sub3) this).anInt8526);
			}
			Class365_Sub1_Sub3_Sub1.method4507(ls,
					(((Class_xa_Sub3) this).aClass298Array8534), (byte) -115);
	...
	public void method6351(int i, int i_90_, int i_91_, int i_92_, int i_93_,
			int i_94_, int i_95_, boolean[][] bools) {
		Class52 class52 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
				.method4992((short) 23850);
		if (((Class_xa_Sub3) this).anInt8543 > 0 && class52 != null) {
			...
			aFloatArray8524[0] = (float) i_91_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method545());
			aFloatArray8524[1] = 0.0F;
			aFloatArray8524[2] = 0.0F;
			aFloatArray8524[3] = 0.0F;
			aFloatArray8524[4] = 0.0F;
			aFloatArray8524[5] = (float) i_91_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method552());
			...
			aFloatArray8524[12] = -1.0F
					- (((float) (i_92_ * i_91_) / 128.0F - (float) (i * 2)) / (float) class52
							.method545());
			aFloatArray8524[13] = 1.0F - (((float) (2 * i_90_) + (float) (i_95_ * i_91_) / 128.0F) / (float) class52
					.method552());
			...
			if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0) {
				...
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5248(
					((Class_xa_Sub3) this).aClass32_8539,
					((Class_xa_Sub3) this).aClass32_8519,
					((Class_xa_Sub3) this).aClass32_8540,
					((Class_xa_Sub3) this).aClass32_8517);
			if ((((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).aClass298_Sub53_Sub1_8197.buffer).length < ((Class_xa_Sub3) this).anInt8525 * 2)
				((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).aClass298_Sub53_Sub1_8197 = new RsFloatBuffer(
						((Class_xa_Sub3) this).anInt8525 * 2);
			else
						...
						if (bools[i_103_ - i_92_][i_101_ - i_93_]) {
							...
							if (is != null) {
								for (int i_104_ = 0; i_104_ < is.length; i_104_++) {
									class298_sub53_sub1.method3587(
											(is[i_104_] & 0xffff), 1368367793);
									i_96_++;
								}
							}
						}
			...
			if (i_96_ > 0) {
				Class46_Sub1 class46_sub1 = new Class46_Sub1(
						(((Class_xa_Sub3) this).aClass_ra_Sub2_8535), 5123,
						class298_sub53_sub1.buffer,
						(class298_sub53_sub1.index * 385051775));
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5254(
						class46_sub1, 4, 0, i_96_);
			}
		}
	}

	void method6374(int i, int i_105_, int i_106_, boolean[][] bools,
			boolean bool, int i_107_) {
		if (((Class_xa_Sub3) this).aClass298Array8534 != null) {
			...
			for (int i_116_ = i_109_; i_116_ <= i_113_; i_116_++) {
				...
				for (int i_118_ = i_111_; i_118_ <= i_114_; i_118_++) {
					if (bools_117_[i_118_ - i_112_])
						is[i_115_++] = i_118_ * (anInt6287 * -506105871)
								+ i_116_;
				}
			}
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5252();
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535
					.method5262((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0);
			for (int i_119_ = 0; i_119_ < ((Class_xa_Sub3) this).aClass298Array8534.length - 0; i_119_++)
				((Class298_Sub5) ((Class_xa_Sub3) this).aClass298Array8534[i_119_])
						.method2861(is, i_115_);
			if (!((Class_xa_Sub3) this).aClass458_8536.method5970((byte) 115)) {
				...
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535
						.c(
								0,
								i_121_,
								((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8195);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5281(false);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5266(128);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5275(-2);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535
						.method5256(((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).aClass30_Sub2_8140);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5258(8448,
						7681);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5259(0, 34166,
						770);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5286(0, 34167,
						770);
				for (Class298 class298 = ((Class_xa_Sub3) this).aClass458_8536
						.method5967(1797943581); class298 != null; class298 = ((Class_xa_Sub3) this).aClass458_8536
						.method5969((byte) -37)) {
					Class298_Sub3 class298_sub3 = (Class298_Sub3) class298;
					class298_sub3.method2852(i, i_105_, i_106_, bools);
				}
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5259(0, 5890,
						768);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5286(0, 5890,
						770);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5256(null);
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535
						.c(
			...
			if (((Class_xa_Sub3) this).aClass44_8541 != null) {
				...
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5248(
						((Class_xa_Sub3) this).aClass32_8539, null, null,
						((Class_xa_Sub3) this).aClass32_8517);
				((Class_xa_Sub3) this).aClass44_8541.method490(i, i_105_,
						i_106_, bools, bool);
				OpenGL.glPopMatrix();
			}
		}
	...
	public void method6339(int i, int i_122_, int i_123_, int i_124_,
			int i_125_, int i_126_, int i_127_, boolean[][] bools) {
		Class52 class52 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
				.method4992((short) -628);
		if (((Class_xa_Sub3) this).anInt8543 > 0 && class52 != null) {
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5291();
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5226(false);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
			...
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5275(-2);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5256(null);
			aFloatArray8524[0] = (float) i_123_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method545());
			aFloatArray8524[1] = 0.0F;
			aFloatArray8524[2] = 0.0F;
			aFloatArray8524[3] = 0.0F;
			aFloatArray8524[4] = 0.0F;
			aFloatArray8524[5] = (float) i_123_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method552());
			aFloatArray8524[6] = 0.0F;
			aFloatArray8524[7] = 0.0F;
			...
			aFloatArray8524[11] = 0.0F;
			aFloatArray8524[12] = -1.0F
					- ((float) (i_124_ * i_123_) / 128.0F - (float) (i * 2))
					/ (float) class52.method545();
			aFloatArray8524[13] = 1.0F - (((float) (2 * i_122_) + (float) (i_127_ * i_123_) / 128.0F) / (float) class52
					.method552());
			aFloatArray8524[14] = 0.0F;
			aFloatArray8524[15] = 1.0F;
			OpenGL.glMatrixMode(5889);
	...
	public Class_na w(int i, int i_137_, Class_na class_na) {
		...
		if (class_na_sub1 != null && class_na_sub1.method3481(i_138_, i_138_)) {
			...
			class_na_sub1_139_ = new Class_na_Sub1(
					((Class_xa_Sub3) this).aClass_ra_Sub2_8535, i_138_, i_138_);
	...
	void method6375(Class_na_Sub1 class_na_sub1, int i, int i_140_) {
		...
		while (i_146_ < i_142_) {
			...
			if (((i_147_ - i_149_) * (i_150_ - i_152_) - (i_150_ - i_148_)
					* (i_151_ - i_149_)) > 0)
				class_na_sub1.method3483(i_148_, i_150_, i_152_, i_147_,
						i_149_, i_151_);
		}
	}

	public void method6338(int i, int i_153_, int i_154_, boolean[][] bools,
			boolean bool, int i_155_) {
		method6374(i, i_153_, i_154_, bools, bool, i_155_);
	}

	public void method6335(int i, int i_156_, int[] is, int[] is_157_,
			int[] is_158_, int[] is_159_, int[] is_160_, int[] is_161_,
			int[] is_162_, int[] is_163_, Class78 class78, boolean bool) {
		Interface_ma interface_ma = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535.anInterface_ma5299;
		if (is_159_ != null
				&& ((Class_xa_Sub3) this).anIntArrayArrayArray8533 == null)
			((Class_xa_Sub3) this).anIntArrayArrayArray8533 = new int[anInt6287
					* -506105871][anInt6286 * -1148794921][];
		if (is_157_ != null
				&& ((Class_xa_Sub3) this).anIntArrayArrayArray8532 == null)
			((Class_xa_Sub3) this).anIntArrayArrayArray8532 = new int[anInt6287
					* -506105871][anInt6286 * -1148794921][];
		...
		for (int i_164_ = 0; i_164_ < is_160_.length; i_164_++) {
			...
			if ((((Class_xa_Sub3) this).anInt8523 & 0x20) != 0 && i_165_ != -1
					&& interface_ma.method174(i_165_, 602140986).aBoolean524) {
				i_166_ = 128;
				i_165_ = -1;
			}
			long l = ((long) (class78.anInt727 * -1475891183) << 48
					| (long) (class78.anInt725 * 1996750669) << 42
					| (long) (class78.anInt726 * -1212608691) << 28
					| (long) (i_166_ << 14) | (long) i_165_);
			Class298 class298;
			for (class298 = ((Class_xa_Sub3) this).aClass440_8549.method5852(l); class298 != null; class298 = ((Class_xa_Sub3) this).aClass440_8549
					.method5853(-1829773748)) {
				Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
				if (((Class298_Sub5) class298_sub5).anInt7199 == i_165_
						&& (((Class298_Sub5) class298_sub5).aFloat7196 == (float) i_166_)
						&& ((Class298_Sub5) class298_sub5).aClass78_7198
								.method843(class78, (byte) -48))
					break;
			}
			if (class298 == null) {
				class298_sub5s[i_164_] = new Class298_Sub5(this, i_165_,
						i_166_, class78);
				((Class_xa_Sub3) this).aClass440_8549.method5858(
						class298_sub5s[i_164_], l);
			} else
	...
	public void NA(Class_na class_na, int i, int i_167_, int i_168_,
		...
		if (((Class_xa_Sub3) this).aClass44_8541 != null && class_na != null) {
			...
			int i_171_ = (i_168_
					- (i_167_
							* (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).anInt8026) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			((Class_xa_Sub3) this).aClass44_8541.method491(class_na, i_170_,
					i_171_);
		}
	}

	public void method6342(Class298_Sub10 class298_sub10, int[] is) {
		((Class_xa_Sub3) this).aClass458_8536.method5968(new Class298_Sub3(
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535, this,
				class298_sub10, is), 136823922);
	}

	public void method6356(int i, int i_172_, int[] is, int[] is_173_,
			int[] is_174_, int[] is_175_, int[] is_176_, int[] is_177_,
			int[] is_178_, int[] is_179_, int[] is_180_, int[] is_181_,
			int[] is_182_, Class78 class78, boolean bool) {
		...
		method6335(i, i_172_, is_184_, is_190_, is_185_, is_191_, is_186_,
				is_187_, is_188_, is_189_, class78, bool);
	}

	public void method6343(int i, int i_197_, int[] is, int[] is_198_,
			int[] is_199_, int[] is_200_, int[] is_201_, int[] is_202_,
			int[] is_203_, int[] is_204_, int[] is_205_, int[] is_206_,
			int[] is_207_, Class78 class78, boolean bool) {
		...
		method6335(i, i_197_, is_209_, is_215_, is_210_, is_216_, is_211_,
				is_212_, is_213_, is_214_, class78, bool);
	}

	public void method6350(int i, int i_222_, int i_223_, int i_224_,
			int i_225_, int i_226_, int i_227_, boolean[][] bools) {
		Class52 class52 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
				.method4992((short) 8066);
		if (((Class_xa_Sub3) this).anInt8543 > 0 && class52 != null) {
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5291();
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5226(false);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
			...
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5275(-2);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5256(null);
			aFloatArray8524[0] = (float) i_223_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method545());
			aFloatArray8524[1] = 0.0F;
			aFloatArray8524[2] = 0.0F;
			aFloatArray8524[3] = 0.0F;
			aFloatArray8524[4] = 0.0F;
			aFloatArray8524[5] = (float) i_223_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method552());
			aFloatArray8524[6] = 0.0F;
			aFloatArray8524[7] = 0.0F;
			...
			aFloatArray8524[11] = 0.0F;
			aFloatArray8524[12] = -1.0F
					- ((float) (i_224_ * i_223_) / 128.0F - (float) (i * 2))
					/ (float) class52.method545();
			aFloatArray8524[13] = 1.0F - (((float) (2 * i_222_) + (float) (i_227_ * i_223_) / 128.0F) / (float) class52
					.method552());
			aFloatArray8524[14] = 0.0F;
			aFloatArray8524[15] = 1.0F;
			OpenGL.glMatrixMode(5889);
			...
			if (i_228_ > 0) {
				Class46_Sub1 class46_sub1 = new Class46_Sub1(
						...
						(class298_sub53_sub1.index * 385051775));
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5254(
						class46_sub1, 4, 0, i_228_);
			}
		}
	}

	public void method6359(int i, int i_237_, int[] is, int[] is_238_,
			int[] is_239_, int[] is_240_, int[] is_241_, int[] is_242_,
			int[] is_243_, int[] is_244_, Class78 class78, boolean bool) {
		Interface_ma interface_ma = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535.anInterface_ma5299;
		if (is_240_ != null
				&& ((Class_xa_Sub3) this).anIntArrayArrayArray8533 == null)
			((Class_xa_Sub3) this).anIntArrayArrayArray8533 = new int[anInt6287
		...
		for (int i_245_ = 0; i_245_ < is_241_.length; i_245_++) {
			...
			if ((((Class_xa_Sub3) this).anInt8523 & 0x20) != 0 && i_246_ != -1
					&& interface_ma.method174(i_246_, 620135548).aBoolean524) {
				i_247_ = 128;
				i_246_ = -1;
			}
			long l = ((long) (class78.anInt727 * -1475891183) << 48
					| (long) (class78.anInt725 * 1996750669) << 42
					| (long) (class78.anInt726 * -1212608691) << 28
					| (long) (i_247_ << 14) | (long) i_246_);
			Class298 class298;
			for (class298 = ((Class_xa_Sub3) this).aClass440_8549.method5852(l); class298 != null; class298 = ((Class_xa_Sub3) this).aClass440_8549
					.method5853(-2069832948)) {
				Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
				if (((Class298_Sub5) class298_sub5).anInt7199 == i_246_
						&& (((Class298_Sub5) class298_sub5).aFloat7196 == (float) i_247_)
						&& ((Class298_Sub5) class298_sub5).aClass78_7198
								.method843(class78, (byte) 30))
					break;
			}
			if (class298 == null) {
				class298_sub5s[i_245_] = new Class298_Sub5(this, i_246_,
						i_247_, class78);
				((Class_xa_Sub3) this).aClass440_8549.method5858(
						class298_sub5s[i_245_], l);
			} else
	...
	public void method6346(int i, int i_248_, int[] is, int[] is_249_,
			int[] is_250_, int[] is_251_, int[] is_252_, int[] is_253_,
			int[] is_254_, int[] is_255_, Class78 class78, boolean bool) {
		Interface_ma interface_ma = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535.anInterface_ma5299;
		if (is_251_ != null
				&& ((Class_xa_Sub3) this).anIntArrayArrayArray8533 == null)
			((Class_xa_Sub3) this).anIntArrayArrayArray8533 = new int[anInt6287
		...
		for (int i_256_ = 0; i_256_ < is_252_.length; i_256_++) {
			...
			if ((((Class_xa_Sub3) this).anInt8523 & 0x20) != 0 && i_257_ != -1
					&& interface_ma.method174(i_257_, 1671695698).aBoolean524) {
				i_258_ = 128;
				i_257_ = -1;
			}
			long l = ((long) (class78.anInt727 * -1475891183) << 48
					| (long) (class78.anInt725 * 1996750669) << 42
					| (long) (class78.anInt726 * -1212608691) << 28
					| (long) (i_258_ << 14) | (long) i_257_);
			Class298 class298;
			for (class298 = ((Class_xa_Sub3) this).aClass440_8549.method5852(l); class298 != null; class298 = ((Class_xa_Sub3) this).aClass440_8549
					.method5853(-1821853943)) {
				Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
				if (((Class298_Sub5) class298_sub5).anInt7199 == i_257_
						&& (((Class298_Sub5) class298_sub5).aFloat7196 == (float) i_258_)
						&& ((Class298_Sub5) class298_sub5).aClass78_7198
								.method843(class78, (byte) -53))
					break;
			}
			if (class298 == null) {
				class298_sub5s[i_256_] = new Class298_Sub5(this, i_257_,
						i_258_, class78);
				((Class_xa_Sub3) this).aClass440_8549.method5858(
						class298_sub5s[i_256_], l);
			} else
	...
	public Class_na l(int i, int i_259_, Class_na class_na) {
		...
		if (class_na_sub1 != null && class_na_sub1.method3481(i_260_, i_260_)) {
			...
			class_na_sub1_261_ = new Class_na_Sub1(
					((Class_xa_Sub3) this).aClass_ra_Sub2_8535, i_260_, i_260_);
		...
		if (((Class_xa_Sub3) this).anInt8543 > 0) {
			...
			for (int i = 1; i < anInt6287 * -506105871; i++) {
				for (int i_262_ = 1; i_262_ < anInt6286 * -1148794921; i_262_++)
					is[i][i_262_] = (byte) (((((Class_xa_Sub3) this).aByteArrayArray8545[i - 1][i_262_]) >> 2)
							+ ((((Class_xa_Sub3) this).aByteArrayArray8545[i + 1][i_262_]) >> 3)
							+ ((((Class_xa_Sub3) this).aByteArrayArray8545[i][i_262_ - 1]) >> 2)
							+ ((((Class_xa_Sub3) this).aByteArrayArray8545[i][i_262_ + 1]) >> 3) + ((((Class_xa_Sub3) this).aByteArrayArray8545[i][i_262_]) >> 1));
			}
			((Class_xa_Sub3) this).aClass298Array8534 = new Class298[((Class_xa_Sub3) this).aClass440_8549
					.method5855(-575368869)];
			((Class_xa_Sub3) this).aClass440_8549.method5854(
					((Class_xa_Sub3) this).aClass298Array8534, 2072858153);
			for (int i = 0; i < ((Class_xa_Sub3) this).aClass298Array8534.length; i++)
				((Class298_Sub5) ((Class_xa_Sub3) this).aClass298Array8534[i])
						.method2859(((Class_xa_Sub3) this).anInt8543);
			int i = 24;
			...
			Stream stream = new Stream(nativeheapbuffer);
			Class298_Sub5[] class298_sub5s = new Class298_Sub5[((Class_xa_Sub3) this).anInt8543];
			int i_263_ = Class422_Sub4.method5639(
					(((Class_xa_Sub3) this).anInt8543 / 4), 1877653209);
			if (i_263_ < 1)
				i_263_ = 1;
			...
			for (int i_265_ = 0; i_265_ < anInt6287 * -506105871; i_265_++) {
				for (int i_266_ = 0; i_266_ < anInt6286 * -1148794921; i_266_++) {
					if ((((Class_xa_Sub3) this).anIntArrayArrayArray8528[i_265_][i_266_]) != null) {
						...
						int[] is_272_ = ((((Class_xa_Sub3) this).anIntArrayArrayArray8532 != null) ? (((Class_xa_Sub3) this).anIntArrayArrayArray8532[i_265_][i_266_])
								: null);
						int[] is_273_ = ((((Class_xa_Sub3) this).anIntArrayArrayArray8533 != null) ? (((Class_xa_Sub3) this).anIntArrayArrayArray8533[i_265_][i_266_])
								: null);
						if (is_270_ == null)
							is_270_ = is_271_;
						...
						short[] is_292_ = (((Class_xa_Sub3) this).aShortArrayArray8550[i_266_
								* (anInt6287 * -506105871) + i_265_] = new short[is_271_.length]);
						for (int i_293_ = 0; i_293_ < is_271_.length; i_293_++) {
							...
							long l = ((long) i_299_ << 48 | (long) i_298_ << 32
									| (long) (i_296_ << 16) | (long) i_297_);
							...
							if (i_301_ == 0 && i_302_ == 0) {
								...
								i_303_ -= i_285_;
									...
									&& i_302_ == anInt6288 * -1212653763) {
								f_306_ = f_276_;
								f_307_ = f_277_;
								f_308_ = f_278_;
								i_303_ -= i_286_;
							} else if (i_301_ == anInt6288 * -1212653763
									&& i_302_ == anInt6288 * -1212653763) {
								f_306_ = f_279_;
								f_307_ = f_280_;
								f_308_ = f_281_;
								...
								float f_312_ = f_274_ + (f_283_ - f_274_)
										* f_309_;
								float f_313_ = f_275_ + (f_284_ - f_275_)
										* f_309_;
								float f_314_ = f_276_ + (f_279_ - f_276_)
										* f_309_;
								float f_315_ = f_277_ + (f_280_ - f_277_)
										* f_309_;
								float f_316_ = f_278_ + (f_281_ - f_278_)
										* f_309_;
								f_306_ = f_311_ + (f_314_ - f_311_) * f_310_;
								f_307_ = f_312_ + (f_315_ - f_312_) * f_310_;
								f_308_ = f_313_ + (f_316_ - f_313_) * f_310_;
								int i_317_ = i_285_
										+ ((i_288_ - i_285_) * i_301_ >> anInt6289
												* -2137349879);
								int i_318_ = i_286_
										+ ((i_287_ - i_286_) * i_301_ >> anInt6289
												* -2137349879);
								i_303_ -= i_317_
										+ ((i_318_ - i_317_) * i_302_ >> anInt6289
												* -2137349879);
							}
							if (i_298_ != -1) {
								...
								if (i_319_ < 2)
									...
									i_319_ = 126;
								i_304_ = (Class294.anIntArray3165[i_298_
										& 0xff80 | i_319_]);
								if ((((Class_xa_Sub3) this).anInt8523 & 0x7) == 0) {
									f_305_ = ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[0])
											* f_306_
											+ (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[1])
											* f_307_ + (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[2])
											* f_308_);
									f_305_ = (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8130 + (f_305_ * (f_305_ > 0.0F ? (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8131)
											: (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8132))));
								}
							}
							Class298 class298 = null;
							if ((i_294_ & ((Class_xa_Sub3) this).anInt8521 - 1) == 0
									&& ((i_295_ & ((Class_xa_Sub3) this).anInt8521 - 1) == 0))
								class298 = class440.method5852(l);
							int i_320_;
							if (class298 == null) {
								int i_321_;
								if (i_299_ != i_298_) {
									...
									if (i_322_ < 2)
										...
										i_322_ = 126;
									i_321_ = (Class294.anIntArray3165[i_299_
											& 0xff80 | i_322_]);
									if ((((Class_xa_Sub3) this).anInt8523 & 0x7) == 0) {
										float f_323_ = ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[0])
												* f_306_
												+ (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[1])
												* f_307_ + ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloatArray8124[2]) * f_308_));
										f_323_ = ((((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8130) + (f_305_ * (f_305_ > 0.0F ? (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8131)
												: (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aFloat8132))));
								...
								if (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).aBoolean8143) {
									...
									stream.d((float) (method6340(i_294_,
											i_295_, -1419532745) + i_300_));
									...
									if ((((Class_xa_Sub3) this).anIntArrayArrayArray8533) != null)
										stream
												.d(is_273_ != null ? (float) (is_273_[i_293_] - 1)
														: 0.0F);
									if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0) {
										stream.d(f_306_);
										stream.d(f_307_);
									...
									stream.u((float) (method6340(i_294_,
											i_295_, -2119264527) + i_300_));
									...
									if ((((Class_xa_Sub3) this).anIntArrayArrayArray8533) != null)
										stream
												.u(is_273_ != null ? (float) (is_273_[i_293_] - 1)
														: 0.0F);
									if ((((Class_xa_Sub3) this).anInt8523 & 0x7) != 0) {
										stream.u(f_306_);
										stream.u(f_307_);
								...
								if (i_298_ != -1
										&& ((class298_sub5s_267_[i_293_].pointer * 7051297995265073167L) < (class298_sub5s[i_320_].pointer * 7051297995265073167L)))
									class298_sub5s[i_320_] = class298_sub5s_267_[i_293_];
							}
							for (int i_327_ = 0; i_327_ < i_289_; i_327_++)
								class298_sub5s_264_[i_327_].method2857(i_320_,
										i_304_, i_303_, f_305_);
							((Class_xa_Sub3) this).anInt8525++;
						}
					}
				}
			...
			for (int i_329_ = 0; i_329_ < anInt6287 * -506105871; i_329_++) {
				for (int i_330_ = 0; i_330_ < anInt6286 * -1148794921; i_330_++) {
					short[] is_331_ = (((Class_xa_Sub3) this).aShortArrayArray8550[i_330_
							* (anInt6287 * -506105871) + i_329_]);
					if (is_331_ != null) {
						int i_332_ = 0;
						int i_333_ = 0;
						while (i_333_ < is_331_.length) {
							...
							if (class298_sub5 != null) {
								class298_sub5
										.method2856(i_329_, i_330_, i_332_);
								class298_sub5_339_ = class298_sub5;
							}
							if (class298_sub5_337_ != null) {
								class298_sub5_337_.method2856(i_329_, i_330_,
										i_332_);
								if (class298_sub5_339_ == null
										|| ((class298_sub5_337_.pointer * 7051297995265073167L) < (class298_sub5_339_.pointer * 7051297995265073167L)))
									class298_sub5_339_ = class298_sub5_337_;
							}
							if (class298_sub5_338_ != null) {
								class298_sub5_338_.method2856(i_329_, i_330_,
										i_332_);
								if (class298_sub5_339_ == null
										|| ((class298_sub5_338_.pointer * 7051297995265073167L) < (class298_sub5_339_.pointer * 7051297995265073167L)))
							...
							if (class298_sub5_339_ != null) {
								...
								class298_sub5_339_.method2856(i_329_, i_330_,
										i_332_);
							}
							i_332_++;
						}
			...
			for (int i_341_ = 0; i_341_ < ((Class_xa_Sub3) this).aClass298Array8534.length; i_341_++) {
				...
				ls[i_341_] = class298_sub5.pointer * 7051297995265073167L;
				class298_sub5.method2860(((Class_xa_Sub3) this).anInt8526);
			}
			Class365_Sub1_Sub3_Sub1.method4507(ls,
					(((Class_xa_Sub3) this).aClass298Array8534), (byte) -108);
			if (((Class_xa_Sub3) this).aClass44_8541 != null)
				((Class_xa_Sub3) this).aClass44_8541.method489();
		} else
			((Class_xa_Sub3) this).aClass44_8541 = null;
	...
	public void method6357(int i, int i_342_, int i_343_, boolean[][] bools,
			boolean bool, int i_344_) {
		method6374(i, i_342_, i_343_, bools, bool, i_344_);
	}

	public void method6345(int i, int i_345_, int[] is, int[] is_346_,
			int[] is_347_, int[] is_348_, int[] is_349_, int[] is_350_,
			int[] is_351_, int[] is_352_, Class78 class78, boolean bool) {
		Interface_ma interface_ma = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535.anInterface_ma5299;
		if (is_348_ != null
				&& ((Class_xa_Sub3) this).anIntArrayArrayArray8533 == null)
			((Class_xa_Sub3) this).anIntArrayArrayArray8533 = new int[anInt6287
		...
		for (int i_353_ = 0; i_353_ < is_349_.length; i_353_++) {
			...
			if ((((Class_xa_Sub3) this).anInt8523 & 0x20) != 0 && i_354_ != -1
					&& interface_ma.method174(i_354_, 156111587).aBoolean524) {
				i_355_ = 128;
				i_354_ = -1;
			}
			long l = ((long) (class78.anInt727 * -1475891183) << 48
					| (long) (class78.anInt725 * 1996750669) << 42
					| (long) (class78.anInt726 * -1212608691) << 28
					| (long) (i_355_ << 14) | (long) i_354_);
			Class298 class298;
			for (class298 = ((Class_xa_Sub3) this).aClass440_8549.method5852(l); class298 != null; class298 = ((Class_xa_Sub3) this).aClass440_8549
					.method5853(-2112383276)) {
				Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
				if (((Class298_Sub5) class298_sub5).anInt7199 == i_354_
						&& (((Class298_Sub5) class298_sub5).aFloat7196 == (float) i_355_)
						&& ((Class298_Sub5) class298_sub5).aClass78_7198
								.method843(class78, (byte) 12))
					break;
			}
			if (class298 == null) {
				class298_sub5s[i_353_] = new Class298_Sub5(this, i_354_,
						i_355_, class78);
				((Class_xa_Sub3) this).aClass440_8549.method5858(
						class298_sub5s[i_353_], l);
			} else
	...
	public void method6347(int i, int i_356_, int i_357_, int i_358_,
			int i_359_, int i_360_, int i_361_, boolean[][] bools) {
		Class52 class52 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
				.method4992((short) -5205);
		if (((Class_xa_Sub3) this).anInt8543 > 0 && class52 != null) {
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5291();
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5226(false);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
			...
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5275(-2);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5256(null);
			aFloatArray8524[0] = (float) i_357_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method545());
			aFloatArray8524[1] = 0.0F;
			aFloatArray8524[2] = 0.0F;
			aFloatArray8524[3] = 0.0F;
			aFloatArray8524[4] = 0.0F;
			aFloatArray8524[5] = (float) i_357_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method552());
			aFloatArray8524[6] = 0.0F;
			aFloatArray8524[7] = 0.0F;
			...
			aFloatArray8524[11] = 0.0F;
			aFloatArray8524[12] = -1.0F
					- ((float) (i_358_ * i_357_) / 128.0F - (float) (i * 2))
					/ (float) class52.method545();
			aFloatArray8524[13] = 1.0F - (((float) (2 * i_356_) + (float) (i_361_ * i_357_) / 128.0F) / (float) class52
					.method552());
			aFloatArray8524[14] = 0.0F;
			aFloatArray8524[15] = 1.0F;
			OpenGL.glMatrixMode(5889);
			...
			if (i_362_ > 0) {
				Class46_Sub1 class46_sub1 = new Class46_Sub1(
						...
						(class298_sub53_sub1.index * 385051775));
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5254(
						class46_sub1, 4, 0, i_362_);
			}
		}
	}

	public void method6349(int i, int i_371_, int i_372_, int i_373_,
			int i_374_, int i_375_, int i_376_, boolean[][] bools) {
		Class52 class52 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
				.method4992((short) -3637);
		if (((Class_xa_Sub3) this).anInt8543 > 0 && class52 != null) {
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5291();
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5226(false);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
			...
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5275(-2);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5256(null);
			aFloatArray8524[0] = (float) i_372_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method545());
			aFloatArray8524[1] = 0.0F;
			aFloatArray8524[2] = 0.0F;
			aFloatArray8524[3] = 0.0F;
			aFloatArray8524[4] = 0.0F;
			aFloatArray8524[5] = (float) i_372_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method552());
			aFloatArray8524[6] = 0.0F;
			aFloatArray8524[7] = 0.0F;
			...
			aFloatArray8524[11] = 0.0F;
			aFloatArray8524[12] = -1.0F
					- ((float) (i_373_ * i_372_) / 128.0F - (float) (i * 2))
					/ (float) class52.method545();
			aFloatArray8524[13] = 1.0F - (((float) (2 * i_371_) + (float) (i_376_ * i_372_) / 128.0F) / (float) class52
					.method552());
			aFloatArray8524[14] = 0.0F;
			aFloatArray8524[15] = 1.0F;
			OpenGL.glMatrixMode(5889);
			...
			if (i_377_ > 0) {
				Class46_Sub1 class46_sub1 = new Class46_Sub1(
						...
						(class298_sub53_sub1.index * 385051775));
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5254(
						class46_sub1, 4, 0, i_377_);
			}
		}
	}

	public boolean method6353(Class_na class_na, int i, int i_386_, int i_387_,
			int i_388_, boolean bool) {
		if (((Class_xa_Sub3) this).aClass44_8541 == null || class_na == null)
			return false;
		int i_389_ = (i
				- (i_386_
		...
		int i_390_ = (i_387_
				- (i_386_
						* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8026) >> 8) >> (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064));
		return ((Class_xa_Sub3) this).aClass44_8541.method492(class_na, i_389_,
				i_390_);
	}
	...
	public void method6358(Class298_Sub10 class298_sub10, int[] is) {
		((Class_xa_Sub3) this).aClass458_8536.method5968(new Class298_Sub3(
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535, this,
				class298_sub10, is), 2091242360);
	}

	public void method6352(int i, int i_391_, int i_392_, int i_393_,
			int i_394_, int i_395_, int i_396_, boolean[][] bools) {
		Class52 class52 = ((Class_xa_Sub3) this).aClass_ra_Sub2_8535
				.method4992((short) 8148);
		if (((Class_xa_Sub3) this).anInt8543 > 0 && class52 != null) {
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5291();
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5226(false);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5262(false);
			...
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5275(-2);
			((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5256(null);
			aFloatArray8524[0] = (float) i_392_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method545());
			aFloatArray8524[1] = 0.0F;
			aFloatArray8524[2] = 0.0F;
			aFloatArray8524[3] = 0.0F;
			aFloatArray8524[4] = 0.0F;
			aFloatArray8524[5] = (float) i_392_
					/ (128.0F * (float) (anInt6288 * -1212653763) * (float) class52
							.method552());
			aFloatArray8524[6] = 0.0F;
			aFloatArray8524[7] = 0.0F;
			...
			aFloatArray8524[11] = 0.0F;
			aFloatArray8524[12] = -1.0F
					- ((float) (i_393_ * i_392_) / 128.0F - (float) (i * 2))
					/ (float) class52.method545();
			aFloatArray8524[13] = 1.0F - (((float) (2 * i_391_) + (float) (i_396_ * i_392_) / 128.0F) / (float) class52
					.method552());
			aFloatArray8524[14] = 0.0F;
			aFloatArray8524[15] = 1.0F;
			OpenGL.glMatrixMode(5889);
			...
			if (i_397_ > 0) {
				Class46_Sub1 class46_sub1 = new Class46_Sub1(
						...
						(class298_sub53_sub1.index * 385051775));
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535.method5254(
						class46_sub1, 4, 0, i_397_);
			}
		}
	}

	public void method6337(int i, int i_406_, int[] is, int[] is_407_,
			int[] is_408_, int[] is_409_, int[] is_410_, int[] is_411_,
			int[] is_412_, int[] is_413_, int[] is_414_, int[] is_415_,
			int[] is_416_, Class78 class78, boolean bool) {
		...
		method6335(i, i_406_, is_418_, is_424_, is_419_, is_425_, is_420_,
				is_421_, is_422_, is_423_, class78, bool);
	}
	...
	public Class_na ax(int i, int i_431_, Class_na class_na) {
		...
		if (class_na_sub1 != null && class_na_sub1.method3481(i_432_, i_432_)) {
			...
			class_na_sub1_433_ = new Class_na_Sub1(
					((Class_xa_Sub3) this).aClass_ra_Sub2_8535, i_432_, i_432_);
		class_na_sub1_433_.method3485(0, 0, i_432_, i_432_);
		method6375(class_na_sub1_433_, i, i_431_);
		return class_na_sub1_433_;
	}

	Class_xa_Sub3(Class_ra_Sub2 class_ra_sub2, int i, int i_434_, int i_435_,
			int i_436_, int[][] is, int[][] is_437_, int i_438_) {
		...
		((Class_xa_Sub3) this).aFloatArrayArray8530 = (new float[anInt6287
				* -506105871 + 1][anInt6286 * -1148794921 + 1]);
		((Class_xa_Sub3) this).aFloatArrayArray8547 = (new float[anInt6287
				* -506105871 + 1][anInt6286 * -1148794921 + 1]);
		((Class_xa_Sub3) this).aFloatArrayArray8548 = (new float[anInt6287
				* -506105871 + 1][anInt6286 * -1148794921 + 1]);
		for (int i_439_ = 1; i_439_ < anInt6286 * -1148794921; i_439_++) {
			for (int i_440_ = 1; i_440_ < anInt6287 * -506105871; i_440_++) {
				...
				float f = (float) (1.0 / Math.sqrt((double) (i_441_ * i_441_
						+ 4 * i_438_ * i_438_ + i_442_ * i_442_)));
				((Class_xa_Sub3) this).aFloatArrayArray8530[i_440_][i_439_] = (float) i_441_
						* f;
				((Class_xa_Sub3) this).aFloatArrayArray8547[i_440_][i_439_] = (float) (-i_438_ * 2)
						* f;
				((Class_xa_Sub3) this).aFloatArrayArray8548[i_440_][i_439_] = (float) i_442_
						* f;
			}
		}
		((Class_xa_Sub3) this).aClass440_8549 = new Class440(128);
		if ((((Class_xa_Sub3) this).anInt8523 & 0x10) != 0)
			((Class_xa_Sub3) this).aClass44_8541 = new Class44(
					((Class_xa_Sub3) this).aClass_ra_Sub2_8535, this);
	}

	public void ak(Class_na class_na, int i, int i_443_, int i_444_,
			int i_445_, boolean bool) {
		if (((Class_xa_Sub3) this).aClass44_8541 != null && class_na != null) {
			int i_446_ = (i
					- (i_443_
							* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8066) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			int i_447_ = (i_444_
					- (i_443_
							* (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).anInt8026) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			((Class_xa_Sub3) this).aClass44_8541.method496(class_na, i_446_,
					i_447_);
		}
	}

	public boolean method6354(Class_na class_na, int i, int i_448_, int i_449_,
		...
		int i_452_ = (i_449_
				- (i_448_
						* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8026) >> 8) >> (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064));
		return ((Class_xa_Sub3) this).aClass44_8541.method492(class_na, i_451_,
				i_452_);
	}

	public boolean method6355(Class_na class_na, int i, int i_453_, int i_454_,
			int i_455_, boolean bool) {
		if (((Class_xa_Sub3) this).aClass44_8541 == null || class_na == null)
			return false;
		int i_456_ = (i
				- (i_453_
		...
		int i_457_ = (i_454_
				- (i_453_
						* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8026) >> 8) >> (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064));
		return ((Class_xa_Sub3) this).aClass44_8541.method492(class_na, i_456_,
				i_457_);
	}

	public void method6336(int i, int i_458_, int[] is, int[] is_459_,
			int[] is_460_, int[] is_461_, int[] is_462_, int[] is_463_,
			int[] is_464_, int[] is_465_, int[] is_466_, int[] is_467_,
			int[] is_468_, Class78 class78, boolean bool) {
		...
		method6335(i, i_458_, is_470_, is_476_, is_471_, is_477_, is_472_,
				is_473_, is_474_, is_475_, class78, bool);
	}

	public void method6348(int i, int i_483_, int i_484_, boolean[][] bools,
			boolean bool, int i_485_) {
	...
	public void av(Class_na class_na, int i, int i_488_, int i_489_,
			int i_490_, boolean bool) {
		if (((Class_xa_Sub3) this).aClass44_8541 != null && class_na != null) {
			int i_491_ = (i
					- (i_488_
							* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8066) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			int i_492_ = (i_489_
					- (i_488_
							* (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).anInt8026) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			((Class_xa_Sub3) this).aClass44_8541.method491(class_na, i_491_,
					i_492_);
		}
	}
	...
	public void method6344(Class298_Sub10 class298_sub10, int[] is) {
		((Class_xa_Sub3) this).aClass458_8536.method5968(new Class298_Sub3(
				((Class_xa_Sub3) this).aClass_ra_Sub2_8535, this,
				class298_sub10, is), 1011020488);
	}

	public void UA(Class_na class_na, int i, int i_493_, int i_494_,
			int i_495_, boolean bool) {
		if (((Class_xa_Sub3) this).aClass44_8541 != null && class_na != null) {
			int i_496_ = (i
					- (i_493_
							* (((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8066) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			int i_497_ = (i_494_
					- (i_493_
							* (((Class_ra_Sub2) (((Class_xa_Sub3) this).aClass_ra_Sub2_8535)).anInt8026) >> 8) >> ((Class_ra_Sub2) ((Class_xa_Sub3) this).aClass_ra_Sub2_8535).anInt8064);
			((Class_xa_Sub3) this).aClass44_8541.method496(class_na, i_496_,
					i_497_);
		}
	}
}
