...
public class Class427 {
	...
	public Class434 method5748(int i, int i_1_) {
		try {
			Class434 class434;
			synchronized (((Class427) this).aClass348_5360) {
				class434 = (Class434) ((Class427) this).aClass348_5360
						.method4184((long) i);
			}
			if (null != class434)
				return class434;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rr.a(").append(')').toString());
		}
	}

	static final void method5749(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = OutcommingPacket.anInt2099
					* -815951577;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rr.amt(").append(')').toString());
		}
	}
