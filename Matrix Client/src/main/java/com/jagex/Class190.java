...
public class Class190 {
	...
	void method1854(RsByteBuffer class298_sub53, int i, int i_1_) {
		try {
			if (1 == i)
				((Class190) this).anInt1922 = class298_sub53
						.readUnsignedShort() * 631997191;
			else if (2 == i)
				...
				anInt1936 = class298_sub53.readUnsignedByte()
						* -1434113687;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hy.p(").append(')').toString());
		}
	}

	void method1855(int i) {
		try {
			anInt1943 = (-738467127 * (Class220.anIntArray2474[((Class190) this).anInt1922
					* -1184073033 << 3]));
			long l = (long) (anInt1933 * 1776313545);
			long l_2_ = (long) (-739294135 * anInt1934);
			long l_3_ = (long) (anInt1935 * -1849369705);
			anInt1941 = (int) Math.sqrt((double) (l * l + l_2_ * l_2_ + l_3_
					* l_3_))
					* -1363693449;
	...
	static final void method1857(Class403 class403, int i) {
		try {
			...
			if (client.anInt8942 * 1131012101 != 0
					&& i_5_ < -548972447 * client.anInt8952) {
	...
	static final void method1858(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563
					.method5612(i_6_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hy.aos(").append(')').toString());
		}
	}
