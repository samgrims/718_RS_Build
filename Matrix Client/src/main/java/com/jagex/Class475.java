	...
	public ClientScriptMap getClientScriptMap(int id, int i_0_) {
		try {
			...
			synchronized (((Class475) this).aClass348_5982) {
				class483 = (ClientScriptMap) ((Class475) this).aClass348_5982
						.method4184((long) id);
			}
			if (null != class483)
				return class483;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("to.a(").append(')').toString());
		}
	}

	public static final void method6075(short i) {
		try {
			int i_1_ = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub17_7565
			...
			if (i_1_ == 0) {
				...
				Class231.method2132(
						(byte) (client.anInt8777 * -1953789277 - 4 & 0xff),
						1394791892);
