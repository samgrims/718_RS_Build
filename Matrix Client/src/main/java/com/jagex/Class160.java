...
public class Class160 {
	...
	public void method1707(ClanSettings class162, byte i) {
		try {
			if ((2334843941678543823L * ((ClanSettings) class162).aLong1663 != -6211723929392173281L
					* ((Class160) this).aLong1643)
					|| (((Class160) this).anInt1631 * 2001926135 != -934549233
							* ((ClanSettings) class162).anInt1653))
				throw new RuntimeException("");
			for (Class298_Sub40 class298_sub40 = (Class298_Sub40) ((Class160) this).aClass453_1632
					.method5939(1766612795); null != class298_sub40; class298_sub40 = ((Class298_Sub40) ((Class160) this).aClass453_1632
					.method5944(49146)))
				class298_sub40.method3510(class162, (byte) 1);
			((ClanSettings) class162).anInt1653 += 1441392111;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gn.f(").append(')').toString());
		}
	}
	...
	void method1708(RsByteBuffer stream, short i) {
		try {
			((Class160) this).aLong1643 = (stream
					.readLong((short) 21326) * 8254773464748362975L); //has to be 0 else crash
			((Class160) this).anInt1631 = stream.readInt((byte) -33) * 247396807;
			for (int i_0_ = stream.readUnsignedByte(); 0 != i_0_; i_0_ = stream
					.readUnsignedByte()) {
				...
				((Class160) this).aClass453_1632.method5935(class298_sub40,
						843424958);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("gn.a(").append(')').toString());
		}
	}
	...
	static final void method1709(Class403 class403, int i) {
		try {
			...
			ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(
					i_1_);
			if (i_2_ >= 1 && i_2_ <= 5
					&& null != class468.aStringArray5732[i_2_ - 1])
