package com.jagex;/* Class97 - Decompiled by JODE
	...
	static final void method1040(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dy.aln(").append(')').toString());
		}
	}

	static void method1041(int i, int i_3_) {
		try {
			if (Class372_Sub1.anIntArray7727 == null
					|| Class372_Sub1.anIntArray7727.length < i)
				Class372_Sub1.anIntArray7727 = new int[i];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dy.z(").append(')').toString());
		}
	}
		...
		try {
			if (8 == -1233866115 * client.anInt8752) {
				Class298_Sub36 class298_sub36 = Class18.method359(
						OutcommingPacket.aClass198_2037,
						client.aClass25_8693.aClass449_330, (byte) 6);
				class298_sub36.out
				...
				class298_sub36.out
						.method3611(
								...
								i_4_,
								(385051775 * class298_sub36.out.index),
								-1237713398);
