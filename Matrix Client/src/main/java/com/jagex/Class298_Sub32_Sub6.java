...
public class Class298_Sub32_Sub6 extends Class298_Sub32 {
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_0_) {
		try {
			switch (i) {
			case 1:
				((Class298_Sub32_Sub6) this).anInt9358 = class298_sub53
						.readUnsignedShort() * 1987830015;
				break;
			case 0:
				((Class298_Sub32_Sub6) this).anInt9356 = class298_sub53
						.readUnsignedShort()
						* -2038436167;
				break;
			case 4: {
			...
			case 3:
				((Class298_Sub32_Sub6) this).anInt9360 = class298_sub53
						.readUnsignedShort() * 2122574147;
				break;
			case 2:
				((Class298_Sub32_Sub6) this).anInt9357 = class298_sub53
						.readUnsignedShort()
						* -1725816691;
				break;
			}
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_10_ = 0; i_10_ < -1474554145 * Class250.anInt2755; i_10_++) {
					...
					if (i_12_ > (((Class298_Sub32_Sub6) this).anInt9356 * 1467725705)) {
						...
						i_12_ = i_13_
								- (((Class298_Sub32_Sub6) this).anIntArray9362[1]);
						if (i_12_ < 0)
							i_12_ = -i_12_;
						if (i_12_ > (((Class298_Sub32_Sub6) this).anInt9356 * 1467725705)) {
							is_7_[i_10_] = i_11_;
							...
							i_12_ = i_14_
									- (((Class298_Sub32_Sub6) this).anIntArray9362[2]);
							if (i_12_ < 0)
								i_12_ = -i_12_;
							if (i_12_ > (1467725705 * ((Class298_Sub32_Sub6) this).anInt9356)) {
								...
								is_7_[i_10_] = i_11_
										* ((((Class298_Sub32_Sub6) this).anInt9360) * -1157633173) >> 12;
								is_8_[i_10_] = i_13_
										* ((((Class298_Sub32_Sub6) this).anInt9357) * -620453307) >> 12;
								is_9_[i_10_] = i_14_
										* (-322756865 * (((Class298_Sub32_Sub6) this).anInt9358)) >> 12;
							}
						}
					}
				}
	...
	int[][] method3177(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_24_ = 0; i_24_ < -1474554145 * Class250.anInt2755; i_24_++) {
				...
				int i_26_ = i_25_
						- ((Class298_Sub32_Sub6) this).anIntArray9362[0];
				if (i_26_ < 0)
					i_26_ = -i_26_;
