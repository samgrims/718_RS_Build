package com.jagex;/* Class443 - Decompiled by JODE
...
public class Class443 {
	...
	void method5881(RsByteBuffer class298_sub53, int i, int i_8_) {
		try {
			if (1 == i) {
				((Class443) this).anInt5593 = class298_sub53
						.read24BitUnsignedInteger((byte) -8)
						* -1369220863;
				method5880(2106435329 * ((Class443) this).anInt5593,
						(byte) -123);
			} else if (2 == i) {
	...
	void method5882(RsByteBuffer class298_sub53, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sh.a(").append(')').toString());
		}
	}

	static void method5883(IComponentDefinition class105, Class_ta class_ta, int i,
			int i_10_, int i_11_, int i_12_, Class57 class57, byte i_13_) {
		try {
			if (null != class57) {
				int i_14_;
				...
				if (i_16_ <= i_15_ * i_15_) {
					...
					if (2 != Class298_Sub1.anInt7164 * -863531439) {
						i_17_ = 256 * i_17_
								/ (256 + client.anInt8749 * 356727603);
						i_18_ = 256 * i_18_
								/ (356727603 * client.anInt8749 + 256);
					}
	...
	static final void method5884(int i, int i_21_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sh.lf(").append(')').toString());
		}
	}

	static final void method5885(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class95.anInt923
					* -2009663223;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sh.ami(").append(')').toString());
		}
	}
	...
	static final void method5886(Class403 class403, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sh.vk(").append(')').toString());
		}
	}

	static final void method5887(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			Class127.method1423(class105, i_22_, i_23_, i_24_, class403,
					890851226);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sh.ke(").append(')').toString());
		}
	}
}
