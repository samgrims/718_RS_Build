...
public class Class298_Sub16 extends Class298 {
	...
	void method2910(int i) {
		((Class298_Sub16) this).aNativeHeapBuffer7293 = ((Class298_Sub16) this).aClass_ra_Sub3_7288
				.method5517(i * 4, true);
		((Class298_Sub16) this).aStream7285 = new Stream(
				((Class298_Sub16) this).aNativeHeapBuffer7293, 0, i * 4);
	}
	...
	void method2912(int i, int i_0_, int i_1_) {
		((Class298_Sub16) this).anIntArray7289[i_0_
				* (((Class298_Sub16) this).aClass_xa_Sub1_7283.anInt6287 * -506105871)
				+ i] |= 1 << i_1_;
	...
	void method2913(int i, int i_2_, int i_3_, float f) {
		if (((Class298_Sub16) this).anInt7284 != -1) {
			Class53 class53 = ((Class298_Sub16) this).aClass_ra_Sub3_7288.anInterface_ma5299
					.method174(((Class298_Sub16) this).anInt7284, 833044999);
	...
	void method2914(int i) {
		...
		((Class298_Sub16) this).anInterface7_Impl1_7287 = ((Class298_Sub16) this).aClass_ra_Sub3_7288
				.method5382(false);
		((Class298_Sub16) this).anInterface7_Impl1_7287.method71(i * 4, 4,
				((Class298_Sub16) this).aNativeHeapBuffer7293);
	...
	Class298_Sub16(Class_xa_Sub1 class_xa_sub1, int i, int i_23_,
			Class78 class78) {
		((Class298_Sub16) this).anInt7282 = 0;
		...
		((Class298_Sub16) this).anIntArray7289 = new int[(((Class298_Sub16) this).aClass_xa_Sub1_7283.anInt6287
				* -506105871 * (((Class298_Sub16) this).aClass_xa_Sub1_7283.anInt6286 * -1148794921))];
		byte i_24_ = 10;
		if (i >= 0) {
			Class53 class53 = ((Class298_Sub16) this).aClass_ra_Sub3_7288.anInterface_ma5299
					.method174(i, 1520533155);
