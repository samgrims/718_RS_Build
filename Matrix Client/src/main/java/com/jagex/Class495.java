				...
				if (string_0_ != null) {
					for (int i_1_ = 0; i_1_ < client.anInt8941 * -1054937867; i_1_++) {
						...
						String string_3_ = Class173.method1824(string_2_,
								-1598414380);
						if (Class396.method4910(string, string_0_, string_2_,
								string_3_, -1043868937)) {
							client.anInt8941 -= 560029533;
							for (int i_4_ = i_1_; i_4_ < -1054937867
									* client.anInt8941; i_4_++) {
							...
							Class298_Sub36 class298_sub36 = Class18.method359(
									OutcommingPacket.REMOVE_FRIEND_PACKET,
									class25.aClass449_330, (byte) 9);
							class298_sub36.out
									.writeByte(Class58.method693(string,
											2053997873));
							class298_sub36.out
									.writeString(string, 2123529676);
