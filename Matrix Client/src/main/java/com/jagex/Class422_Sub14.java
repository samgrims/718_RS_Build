package com.jagex;/* Class422_Sub14 - Decompiled by JODE
...
public class Class422_Sub14 extends Class422 {
	...
	public int method5612(int i, int i_0_) {
		try {
			if (i == 3
					&& !Class85.method955(399394159).method263("jagdx",
							953164074))
				return 3;
			return 2;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adq.f(").append(')').toString());
		}
	}
	...
	public void method5680(boolean bool, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adq.h(").append(')').toString());
		}
	}

	public int method5616(int i) {
		if (i == 3
				&& !Class85.method955(-91945670).method263("jagdx", 323040100))
			return 3;
		return 2;
	}
	...
	public boolean method5681(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adq.z(").append(')').toString());
		}
	}

	public static void method5682(int i, int i_2_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(12,
					(long) i);
			class298_sub37_sub12.method3445(-1192057817);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adq.j(").append(')').toString());
		}
	}
}
