...
public class Class513 implements Interface21 {
	...
	Class513(int i, int i_0_, String string, String string_1_, boolean bool,
			Class513[] class513s) {
	...
	static {
		...
		aClass513_6643 = new Class513(7, -1, "", "", true, new Class513[] {
				aClass513_6644, aClass513_6637, aClass513_6641, aClass513_6640,
				aClass513_6639 });
	}
	...
	public String toString() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vg.toString(").append(')').toString());
		}
	}
	...
	static final void method6292(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1155
					* -749038817;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vg.oh(").append(')').toString());
		}
	}
