...
public class ea extends Class264 implements Interface25 {
	...
	native void bf(ja var_ja, ba var_ba, byte[][] is, int[] is_0_, int[] is_1_,
			int[] is_2_, int[] is_3_);
	...
	void method2486(char c, int i, int i_10_, int i_11_, boolean bool,
			Class_ta class_ta, int i_12_, int i_13_) {
		P(c, i, i_10_, i_11_, bool, class_ta, i_12_, i_13_);
	}

	native void P(char c, int i, int i_14_, int i_15_, boolean bool,
	...
	void method2489(char c, int i, int i_22_, int i_23_, boolean bool,
			Class_ta class_ta, int i_24_, int i_25_) {
		P(c, i, i_22_, i_23_, bool, class_ta, i_24_, i_25_);
	}

	public native void z(boolean bool);

	native void am(ja var_ja, ba var_ba, byte[][] is, int[] is_26_,
			int[] is_27_, int[] is_28_, int[] is_29_);

	ea(ja var_ja, ba var_ba, Class505 class505, IndexedImage[] class89s,
			Class57[] class57s) {
	...
	native void bd(ja var_ja, ba var_ba, byte[][] is, int[] is_37_,
			int[] is_38_, int[] is_39_, int[] is_40_);

	native void be(ja var_ja, ba var_ba, byte[][] is, int[] is_41_,
			int[] is_42_, int[] is_43_, int[] is_44_);

	native void by(char c, int i, int i_45_, int i_46_, boolean bool,
			Class_ta class_ta, int i_47_, int i_48_);
}
