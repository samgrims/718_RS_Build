...
public class Class249 implements Interface_ma {
	...
	public int[] method173(int i, float f, int i_0_, int i_1_, boolean bool) {
		int[] is = (method2390(i, 354542821).method3421(
				((Class249) this).aClass243_6460, this, (double) f, i_0_, i_1_,
				((Class249) this).aClass53Array6462[i].aBoolean544, 795191351));
		return is;
	}
	...
	public Class53 method174(int i, int i_2_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.k(").append(')').toString());
		}
	}

	public Class249(Class243 class243, Class243 class243_3_,
			Class243 class243_4_) {
		((Class249) this).aClass243_6461 = class243_3_;
		((Class249) this).aClass243_6460 = class243_4_;
		RsByteBuffer class298_sub53 = new RsByteBuffer(class243.method2315(
				0, 0, (byte) -117));
		((Class249) this).anInt6463 = class298_sub53.readUnsignedShort() * 12939135;
		((Class249) this).aClass53Array6462 = new Class53[((Class249) this).anInt6463
				* -1882566529];
		...
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aBoolean524 = class298_sub53
						.readUnsignedByte() == 0;
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aBoolean518 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aBoolean538 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aByte534 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aByte533 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aByte529 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aByte536 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aShort532 = (short) class298_sub53
						.readUnsignedShort();
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aByte535 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aByte509 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aBoolean527 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aBoolean544 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aByte537 = class298_sub53
						.readByte(-12558881);
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aBoolean540 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].aBoolean541 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].aBoolean543 = class298_sub53
						.readUnsignedByte() == 1;
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (null != ((Class249) this).aClass53Array6462[i])
				((Class249) this).aClass53Array6462[i].anInt519 = class298_sub53
						.readUnsignedByte()
						* -39200327;
		}
		for (int i = 0; i < ((Class249) this).anInt6463 * -1882566529; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].anInt531 = class298_sub53
						.readInt((byte) -86)
						* -946109519;
		}
		for (int i = 0; i < -1882566529 * ((Class249) this).anInt6463; i++) {
			if (((Class249) this).aClass53Array6462[i] != null)
				((Class249) this).aClass53Array6462[i].anInt528 = class298_sub53
						.readUnsignedByte() * 980235301;
		}
	}

	public int[] method171(int i, float f, int i_5_, int i_6_, boolean bool,
			int i_7_) {
		try {
			int[] is = (method2390(i, 1119072054).method3423(
					((Class249) this).aClass243_6460, this, (double) f, i_5_,
					i_6_, bool,
					((Class249) this).aClass53Array6462[i].aBoolean544,
					-1817838295));
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.b(").append(')').toString());
		}
	}

	public int[] method172(int i, float f, int i_8_, int i_9_, boolean bool,
			byte i_10_) {
		try {
			int[] is = (method2390(i, 1019997631).method3421(
					((Class249) this).aClass243_6460, this, (double) f, i_8_,
					i_9_, ((Class249) this).aClass53Array6462[i].aBoolean544,
					-524170328));
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.p(").append(')').toString());
		}
	}

	Class298_Sub37_Sub6 method2390(int i, int i_11_) {
		try {
			Class298_Sub37 class298_sub37 = ((Class249) this).aClass354_6464
					.method4253((long) i);
			if (class298_sub37 != null)
				return (Class298_Sub37_Sub6) class298_sub37;
			byte[] is = ((Class249) this).aClass243_6461.method2294(i,
					(byte) 51);
			if (null == is)
				return null;
			Class298_Sub37_Sub6 class298_sub37_sub6 = new Class298_Sub37_Sub6(
					new RsByteBuffer(is));
			((Class249) this).aClass354_6464.method4255(class298_sub37_sub6,
					(long) i);
			return class298_sub37_sub6;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.w(").append(')').toString());
		}
	}

	public int[] method183(int i, float f, int i_12_, int i_13_, boolean bool) {
		int[] is = (method2390(i, 526499029).method3421(
				((Class249) this).aClass243_6460, this, (double) f, i_12_,
				i_13_, ((Class249) this).aClass53Array6462[i].aBoolean544,
				-1650198196));
		return is;
	}
	...
	public boolean method170(int i, short i_14_) {
		try {
			...
			return (class298_sub37_sub6 != null && class298_sub37_sub6
					.method3420((((Class249) this).aClass243_6460), this,
							(byte) -26));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.f(").append(')').toString());
		}
	}
	...
	public boolean method180(int i) {
		...
		return (class298_sub37_sub6 != null && class298_sub37_sub6.method3420(
				(((Class249) this).aClass243_6460), this, (byte) 78));
	}

	public int[] method178(int i, float f, int i_15_, int i_16_, boolean bool) {
		int[] is = (method2390(i, -345886802).method3421(
				((Class249) this).aClass243_6460, this, (double) f, i_15_,
				i_16_, ((Class249) this).aClass53Array6462[i].aBoolean544,
				-1164110413));
		return is;
	}

	public int[] method182(int i, float f, int i_17_, int i_18_, boolean bool) {
		int[] is = (method2390(i, -1131324471).method3421(
				((Class249) this).aClass243_6460, this, (double) f, i_17_,
				i_18_, ((Class249) this).aClass53Array6462[i].aBoolean544,
				-876617633));
		return is;
	}

	public float[] method181(int i, float f, int i_19_, int i_20_,
			boolean bool, byte i_21_) {
		try {
			float[] fs = (method2390(i, -1967108124).method3422(
					((Class249) this).aClass243_6460, this, i_19_, i_20_,
					((Class249) this).aClass53Array6462[i].aBoolean544,
					-1481337578));
			return fs;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.i(").append(')').toString());
		}
	}

	public float[] method179(int i, float f, int i_22_, int i_23_, boolean bool) {
		float[] fs = (method2390(i, 2055609416).method3422(
				((Class249) this).aClass243_6460, this, i_22_, i_23_,
				((Class249) this).aClass53Array6462[i].aBoolean544, -415868966));
		return fs;
	}

	public float[] method184(int i, float f, int i_24_, int i_25_, boolean bool) {
		float[] fs = (method2390(i, -1813054507)
				.method3422(((Class249) this).aClass243_6460, this, i_24_,
						i_25_,
						((Class249) this).aClass53Array6462[i].aBoolean544,
						-1304965359));
		return fs;
	...
	public int[] method190(int i, float f, int i_26_, int i_27_, boolean bool) {
		int[] is = (method2390(i, -212514005)
				.method3423(((Class249) this).aClass243_6460, this, (double) f,
						i_26_, i_27_, bool,
						((Class249) this).aClass53Array6462[i].aBoolean544,
						-1817838295));
		return is;
		...
		try {
			if (null != Class291.aClass484_6499) {
				try {
					...
					Class291.aClass484_6499.method6134(
							(class298_sub53.buffer), i, 24, 1376397510);
	...
	static final void method2392(Class394 class394, Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.g(").append(')').toString());
		}
	}

	static final void method2393(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1184 = 939239877;
			class105.anInt1151 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919])
					* -1825442367;
	...
	static final void method2394(Class403 class403, int i) {
		try {
			...
			Class422_Sub10
					.method5664(class105, class119, class403, -1389112437);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kk.nb(").append(')').toString());
		}
	}
}
