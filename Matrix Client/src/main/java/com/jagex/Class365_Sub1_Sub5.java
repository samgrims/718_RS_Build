...
public abstract class Class365_Sub1_Sub5 extends Class365_Sub1 {
	...
	boolean method4395() {
		...
		return (((Class331) aClass331_7722).aBooleanArrayArray3563[(583010427 * ((Class331) aClass331_7722).anInt3538 + (((int) class217.aFloat2451 >> -1688804109
				* aClass331_7722.anInt3504) - -804213305
				* ((Class331) aClass331_7722).anInt3553))][(((Class331) aClass331_7722).anInt3538 * 583010427 + (((int) class217.aFloat2454 >> -1688804109
				* aClass331_7722.anInt3504) - ((Class331) aClass331_7722).anInt3513 * 465603579))]);
	}

	int method4354(Class298_Sub10[] class298_sub10s, int i) {
		try {
			Class217 class217 = method4337().aClass217_2599;
			int i_0_ = ((int) class217.aFloat2451 >> -1688804109
					* aClass331_7722.anInt3504);
			int i_1_ = ((int) class217.aFloat2454 >> -1688804109
					* aClass331_7722.anInt3504);
			int i_2_ = 0;
			...
			if (4 == aShort9814
					&& i_0_ <= 1988988347 * aClass331_7722.anInt3514)
			...
			if (2 == aShort9814
					&& i_1_ <= aClass331_7722.anInt3549 * 1340714547)
				return method4392(i_0_, i_1_ + 1, class298_sub10s, 1978874084);
			if (16 == aShort9814 && i_0_ > 0
					&& i_1_ <= 1340714547 * aClass331_7722.anInt3549)
				return method4392(i_0_ - 1, 1 + i_1_, class298_sub10s,
						1964784017);
			if (32 == aShort9814
					&& i_0_ <= aClass331_7722.anInt3514 * 1988988347
					&& i_1_ <= aClass331_7722.anInt3549 * 1340714547)
				return method4392(i_0_ + 1, i_1_ + 1, class298_sub10s,
						2147063245);
	...
	boolean method4364(GraphicsToolkit class_ra, byte i) {
		try {
			Class217 class217 = method4337().aClass217_2599;
			return (aClass331_7722.aClass333_3512.method4072(this, aByte7724,
					((int) class217.aFloat2451 >> aClass331_7722.anInt3504
							* -1688804109),
					((int) class217.aFloat2454 >> -1688804109
							* aClass331_7722.anInt3504)));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajz.dl(").append(')').toString());
		}
	}
	...
	boolean method4360(int i) {
		try {
			Class217 class217 = method4337().aClass217_2599;
			return (((Class331) aClass331_7722).aBooleanArrayArray3563[(583010427 * ((Class331) aClass331_7722).anInt3538 + (((int) class217.aFloat2451 >> -1688804109
					* aClass331_7722.anInt3504) - (-804213305 * ((Class331) aClass331_7722).anInt3553)))][(((Class331) aClass331_7722).anInt3538 * 583010427 + (((int) class217.aFloat2454 >> -1688804109
					* aClass331_7722.anInt3504) - (((Class331) aClass331_7722).anInt3513 * 465603579)))]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajz.dq(").append(')').toString());
		}
	}

	int method4390(Class298_Sub10[] class298_sub10s) {
		Class217 class217 = method4337().aClass217_2599;
		int i = ((int) class217.aFloat2451 >> -1688804109
				* aClass331_7722.anInt3504);
		int i_4_ = ((int) class217.aFloat2454 >> -1688804109
				* aClass331_7722.anInt3504);
		int i_5_ = 0;
		...
		if (16 == aShort9814 && i > 0
				&& i_4_ <= 1340714547 * aClass331_7722.anInt3549)
			return method4392(i - 1, 1 + i_4_, class298_sub10s, 2048116357);
		if (32 == aShort9814 && i <= aClass331_7722.anInt3514 * 1988988347
				&& i_4_ <= aClass331_7722.anInt3549 * 1340714547)
		...
		if (aShort9814 == 64 && i <= aClass331_7722.anInt3514 * 1988988347
				&& i_4_ > 0)
	...
	Class365_Sub1_Sub5(Class331 class331, int i, int i_7_, int i_8_, int i_9_,
			int i_10_, int i_11_) {
		super(class331);
		plane = (byte) i_9_;
	...
	static final void method4522(Class403 class403, int i) {
		try {
			...
			if (null == class298_sub37_sub13) {
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (-1973484731
						* class298_sub37_sub13.anInt9644 >> 14 & 0x3fff);
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub13.anInt9644
						* -1973484731 & 0x3fff;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajz.adm(").append(')').toString());
		}
	}
}
