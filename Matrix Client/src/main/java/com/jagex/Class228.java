package com.jagex;/* Class228 - Decompiled by JODE
...
public class Class228 {
	...
	static final void method2116(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = stringbuilder.toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jq.aaf(").append(')').toString());
		}
	}
	...
	static final void method2118(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jq.gk(").append(')').toString());
		}
	}

	public static void method2119(Class391 class391, int i, int i_2_) {
		try {
			if (Class300.anInt3213 * -991384187 < 50
					&& (null != class391
							&& class391.anIntArrayArray4187 != null
							&& i < class391.anIntArrayArray4187.length && null != class391.anIntArrayArray4187[i])) {
				...
				if (null != class391.anIntArray4183
						&& class391.anIntArray4190 != null)
					i_7_ = Class391.method4888(class391.anIntArray4183[i],
							class391.anIntArray4190[i], 1444813491);
				if (class391.aBoolean4173)
					Class320.method3913(i_4_, i_5_, 0, 255, false, i_7_,
							1704835145);
				else
	...
	static int method2121(String string, byte[] is, int i, byte i_21_) {
		try {
			...
			for (int i_24_ = 0; i_24_ < i_23_; i_24_ += 4) {
				int i_25_ = Class163
						.method1773(string.charAt(i_24_), -40024446);
				int i_26_ = (i_24_ + 1 < i_23_ ? Class163.method1773(string
						.charAt(1 + i_24_), 1761771208) : -1);
				int i_27_ = (2 + i_24_ < i_23_ ? Class163.method1773(string
						.charAt(2 + i_24_), 623747518) : -1);
				int i_28_ = (i_24_ + 3 < i_23_ ? Class163.method1773(string
						.charAt(i_24_ + 3), 1229588136) : -1);
