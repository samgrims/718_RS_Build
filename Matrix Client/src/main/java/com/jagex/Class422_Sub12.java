package com.jagex;/* Class422_Sub12 - Decompiled by JODE
...
public class Class422_Sub12 extends Class422 {
	...
	int method5611(int i) {
		try {
			return (aClass298_Sub48_5346.method3543(-1069375007).method5593(
					900768224) ? 3 : 2);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adn.a(").append(')').toString());
		}
	}
	...
	public int method5669(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adn.z(").append(')').toString());
		}
	}

	int method5615() {
		return (aClass298_Sub48_5346.method3543(-427215761).method5593(
				1101125726) ? 3 : 2);
	}
	...
	static final void method5671(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Character
					.toLowerCase((char) i_2_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("adn.aav(").append(')').toString());
		}
	}
