...
public class Class87 {
	...
	static final void method969(Class403 class403, int i) {
		try {
			...
			Class298_Sub32_Sub5.method3174(class105, class119, class403,
					-1818514022);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dn.nx(").append(')').toString());
		}
	}
			...
			if (client.aBoolean8835) {
				...
				if (client.getIComponentSettings(class105).method3495(1299208806)
						...
						&& (null == class497 || (class105.method1117(
								...
								(class497.anInt6100 * -388931549), -659898667) != -388931549
								* class497.anInt6100)))
					Class234
							.method2174(
									client.aString8838,
									new StringBuilder().append(
											...
											.append(Class26.aString351).append(
													" ").append(
													class105.aString1228)
											.toString(),
				...
				if (string != null)
					Class234
							.method2174(
									string,
									class105.aString1228,
									Class69.method794(class105, i_8_,
											-1663637577),
									1007,
									class105.anInt1280 * -1232467723,
									(long) (1 + i_8_),
				...
				if (null != string_10_)
					Class234
							.method2174(
									string_10_,
									class105.aString1228,
									Class69.method794(class105, i_9_,
											-1654084952),
									57,
									class105.anInt1280 * -1232467723,
									(long) (1 + i_9_),
