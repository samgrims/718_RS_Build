...
public class Class134 implements Interface5 {
	...
	Class134(int i, Class139 class139, Class133 class133, int i_0_, int i_1_,
	...
	static final void method1487(Class403 class403, int i) {
		try {
			...
			Class21
					.method365(class105, class119, true, 2, class403,
							-445613711);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fk.hv(").append(')').toString());
		}
	}
