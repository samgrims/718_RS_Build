...
public class Class298_Sub32_Sub18 extends Class298_Sub32 {
	...
	void method3243(int i, RsByteBuffer class298_sub53) {
		switch (i) {
		case 3:
			((Class298_Sub32_Sub18) this).anInt9442 = class298_sub53
					.readUnsignedByte()
					* -190415455;
			break;
		case 0:
			((Class298_Sub32_Sub18) this).anInt9434 = class298_sub53
					.readUnsignedByte() * 56159889;
			break;
		case 1:
			((Class298_Sub32_Sub18) this).anInt9441 = class298_sub53
					.readUnsignedByte()
					* -518479681;
			break;
		}
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
					...
					if (716214897 * ((Class298_Sub32_Sub18) this).anInt9434 == 0)
						...
						i_14_ = (int) (Math
								.sqrt((double) ((float) i_15_ / 4096.0F)) * 4096.0);
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_18_ = 0; i_18_ < Class250.anInt2755 * -1474554145; i_18_++) {
				...
				if (716214897 * ((Class298_Sub32_Sub18) this).anInt9434 == 0)
					...
					i_21_ = (int) (Math
							.sqrt((double) ((float) i_22_ / 4096.0F)) * 4096.0);
