package com.jagex;/* Class288 - Decompiled by JODE
...
public abstract class Class288 implements Runnable {
	...
	static final void method2727(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ly.ahs(").append(')').toString());
		}
	}

	static final void method2728(IComponentDefinition class105, Class119 class119,
