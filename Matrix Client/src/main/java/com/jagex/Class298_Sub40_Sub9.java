...
public class Class298_Sub40_Sub9 extends Class298_Sub40 {
	...
	void method3509(RsByteBuffer class298_sub53) {
		((Class298_Sub40_Sub9) this).anInt9717 = class298_sub53
				.readUnsignedShort() * 203579807;
		((Class298_Sub40_Sub9) this).aByte9714 = class298_sub53
				.readByte(-12558881);
	}
	...
	void method3511(ClanSettings class162) {
		class162.method1769(
				(1481144927 * ((Class298_Sub40_Sub9) this).anInt9717),
				((Class298_Sub40_Sub9) this).aByte9714, (byte) -65);
	}
	...
	void method3510(ClanSettings class162, byte i) {
		try {
			class162.method1769(
					(1481144927 * ((Class298_Sub40_Sub9) this).anInt9717),
					((Class298_Sub40_Sub9) this).aByte9714, (byte) -101);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ago.f(").append(')').toString());
		}
	}
}
