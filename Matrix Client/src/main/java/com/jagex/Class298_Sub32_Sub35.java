...
public class Class298_Sub32_Sub35 extends Class298_Sub32 {
	...
	int[][] method3132(int i, byte i_0_) {
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				int[] is_1_ = method3129(0, i - 1 & -289063255
						* Class250.anInt2758, -1887337990);
				int[] is_2_ = method3129(0, i, -1887337990);
				int[] is_3_ = method3129(0, i + 1 & -289063255
						* Class250.anInt2758, -1887337990);
				int[] is_4_ = is[0];
				int[] is_5_ = is[1];
				int[] is_6_ = is[2];
				for (int i_7_ = 0; i_7_ < -1474554145 * Class250.anInt2755; i_7_++) {
					...
					int i_9_ = (((Class298_Sub32_Sub35) this).anInt9550 * 347966039 * (is_2_[i_7_
							+ 1 & -901777799 * Class250.anInt2753] - is_2_[(i_7_ - 1 & -901777799
							* Class250.anInt2753)]));
					int i_10_ = i_9_ >> 12;
					int i_11_ = i_8_ >> 12;
					...
					int i_14_ = (int) (Math
							.sqrt((double) ((float) (4096 + (i_13_ + i_12_)) / 4096.0F)) * 4096.0);
					int i_15_;
					int i_16_;
					int i_17_;
					if (i_14_ != 0) {
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_18_) {
		try {
			switch (i) {
			case 0:
				((Class298_Sub32_Sub35) this).anInt9550 = class298_sub53
						.readUnsignedShort() * 1837433191;
				break;
			case 1:
				((Class298_Sub32_Sub35) this).aBoolean9552 = class298_sub53
						.readUnsignedByte() == 1;
				break;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahx.r(").append(')').toString());
		}
	}
	...
	int[][] method3367(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int[] is_19_ = method3129(0, i - 1 & -289063255
					* Class250.anInt2758, -1887337990);
			int[] is_20_ = method3129(0, i, -1887337990);
			int[] is_21_ = method3129(0, i + 1 & -289063255
					* Class250.anInt2758, -1887337990);
			int[] is_22_ = is[0];
			int[] is_23_ = is[1];
			int[] is_24_ = is[2];
			for (int i_25_ = 0; i_25_ < -1474554145 * Class250.anInt2755; i_25_++) {
				...
				int i_27_ = (((Class298_Sub32_Sub35) this).anInt9550 * 347966039 * (is_20_[i_25_
						+ 1 & -901777799 * Class250.anInt2753] - (is_20_[i_25_
				...
				int i_32_ = (int) (Math
						.sqrt((double) ((float) (4096 + (i_31_ + i_30_)) / 4096.0F)) * 4096.0);
				int i_33_;
				int i_34_;
				int i_35_;
				if (i_32_ != 0) {
	...
	int[][] method3368(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int[] is_36_ = method3129(0, i - 1 & -289063255
					* Class250.anInt2758, -1887337990);
			int[] is_37_ = method3129(0, i, -1887337990);
			int[] is_38_ = method3129(0, i + 1 & -289063255
					* Class250.anInt2758, -1887337990);
			int[] is_39_ = is[0];
			int[] is_40_ = is[1];
			int[] is_41_ = is[2];
			for (int i_42_ = 0; i_42_ < -1474554145 * Class250.anInt2755; i_42_++) {
				...
				int i_44_ = (((Class298_Sub32_Sub35) this).anInt9550 * 347966039 * (is_37_[i_42_
						+ 1 & -901777799 * Class250.anInt2753] - (is_37_[i_42_
						- 1 & -901777799 * Class250.anInt2753])));
				int i_45_ = i_44_ >> 12;
				int i_46_ = i_43_ >> 12;
				...
				int i_49_ = (int) (Math
						.sqrt((double) ((float) (4096 + (i_48_ + i_47_)) / 4096.0F)) * 4096.0);
				int i_50_;
				int i_51_;
				int i_52_;
				if (i_49_ != 0) {
