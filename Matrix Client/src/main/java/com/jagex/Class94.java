	...
	void method1017(int i, int i_1_, int i_2_, int i_3_) {
		try {
			if (((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910 != null)
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.method4456(
						i, i_1_, i_2_, true,
						((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910
								.getSize(), (byte) 21);
			else {
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.plane = ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.aByte7724 = (byte) i;
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.method4472(
						i_1_, i_2_, -1945697758);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dv.b(").append(')').toString());
		}
	}
		...
		try {
			if (!aBoolean912) {
				...
				if (1762367763 * anInt909 >= 0) {
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910 = (new NPC(
							client.aClass283_8716.method2675(-1611682495), 25));
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10064 = ((Class94) this).anInt906 * 302956801;
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10075 = client.anInt8884
							* -128551287;
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910
							.method4464(Class15.aClass507_224.method6269(
									anInt909 * 1762367763, 1863267717),
									2139515630);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910
							.method4421(
									-2095128707
											* (((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.aClass503_10190.anInt6187),
									-1254496694);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10115 = -1186616623
							* (((((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.aClass503_10190.anInt6181) * -1927065533) << 3);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.anInt10071 = (((Class87.anInt803 += 2029434363)
							* -132903629 - 1) * -689024993);
				} else {
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911 = (new Player(
							client.aClass283_8716.method2675(-1611682495), 25));
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911
							.sendAppearence(Class128_Sub1.aClass298_Sub53_8555,
									(byte) 3);
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10064 = 302956801 * ((Class94) this).anInt906;
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10075 = -128551287
							* client.anInt8884;
					((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10071 = (((Class87.anInt803 += 2029434363)
							* -132903629 - 1) * -689024993);
				}
			}
			if (1762367763 * anInt909 >= 0) {
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.method4456(
						...
						((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910
								.getSize(), (byte) 43);
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub1_910.method4415(
						i_6_, true, 43552435);
			} else {
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.plane = ((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.aByte7724 = (byte) i_5_;
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.method4472(
						i, i_4_, -2044145189);
				((Class94) this).aClass365_Sub1_Sub1_Sub2_Sub2_911.method4415(
						i_6_, true, 1586583742);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dv.a(").append(')').toString());
		}
	}
		...
		try {
			if (anInt909 * 1762367763 >= 0) {
				Class503 class503 = Class15.aClass507_224.method6269(
						1762367763 * anInt909, 2059716043);
				boolean bool = class503.method6238(-1621243143);
				if (((Class94) this).anIntArray907 == null) {
					Class350 class350 = aClass349_913.method4202(
							(class503.anInt6132 * 525312939), (byte) 47);
					((Class94) this).anIntArray907 = class350
							.method4210(2115260709);
				}
				int[] is = ((Class94) this).anIntArray907;
				for (int i_8_ = 0; i_8_ < is.length; i_8_++) {
					int i_9_ = is[i_8_];
					bool &= Class501.aClass395_6122.method4903(i_9_, (byte) 66)
							.method4880(1245807797);
				}
				return bool;
			}
			return true;
	...
	static final void method1024(Class403 class403, int i) {
		try {
			IComponentDefinition.method1135(
					((Class365_Sub1) ((Class403) class403).anInterface3_5233),
					class403, -778688640);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dv.apd(").append(')').toString());
		}
	}
	...
	static final void method1026(Class403 class403, int i) {
		try {
			...
			if (-257444687 * client.WINDOW_PANE_ID != -1) {
				if (i_12_ == 0) {
					((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = client.WINDOW_PANE_ID
							* -257444687;
					return;
				}
				i_12_--;
