package com.jagex;/* Class96 - Decompiled by JODE
			...
			for (int i_4_ = 0; i_4_ < i; i_4_++) {
				...
				if (i_6_ > 0) {
					...
					if (i_5_ == 3 || i_5_ == 10)
						i_7_ = (short) 128;
					if ((i_6_ & 0x1) != 0)
						aShortArray926[i_1_] = (short) class298_sub53_0_
								.method3645(590991010);
					else
						aShortArray926[i_1_] = i_7_;
					if ((i_6_ & 0x2) != 0)
						aShortArray932[i_1_] = (short) class298_sub53_0_
								.method3645(590991010);
					else
						aShortArray932[i_1_] = i_7_;
					if ((i_6_ & 0x4) != 0)
						aShortArray928[i_1_] = (short) class298_sub53_0_
								.method3645(590991010);
					else
