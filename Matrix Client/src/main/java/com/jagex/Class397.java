...
public class Class397 {
	...
	public static void method4912(short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ql.m(").append(')').toString());
		}
	}

	public static final void method4913(byte i) {
		try {
			if (-1 != -591434031 * client.anInt8768
					&& client.anInt8769 * -839811113 != -1) {
				...
				for (int i_2_ = 0; i_2_ < 3; i_2_++) {
					int i_3_ = 3 * (client.anIntArrayArrayArray8767[client.anInt8768
							* -591434031][i_1_][i_2_]);
					int i_4_ = ((client.anIntArrayArrayArray8767[-591434031
							* client.anInt8768][1 + i_1_][i_2_]) * 3);
					int i_5_ = ((client.anIntArrayArrayArray8767[client.anInt8768
							* -591434031][2 + i_1_][i_2_]) - ((client.anIntArrayArrayArray8767[client.anInt8768
							* -591434031][3 + i_1_][i_2_]) - (client.anIntArrayArrayArray8767[-591434031
							* client.anInt8768][i_1_ + 2][i_2_]))) * 3;
					int i_6_ = (client.anIntArrayArrayArray8767[-591434031
							* client.anInt8768][i_1_][i_2_]);
					int i_7_ = i_4_ - i_3_;
					int i_8_ = i_3_ - 2 * i_4_ + i_5_;
					int i_9_ = i_4_
							+ ((client.anIntArrayArrayArray8767[client.anInt8768
									* -591434031][i_1_ + 2][i_2_]) - i_6_)
							- i_5_;
					fs[i_2_] = (f
				...
				Class146.anInt1575 = 309839105 * ((int) fs[2] - class341.gameSceneBaseY
						* -869407232);
				float[] fs_10_ = new float[3];
				int i_11_ = client.anInt8771 * 977380166;
				for (int i_12_ = 0; i_12_ < 3; i_12_++) {
					int i_13_ = ((client.anIntArrayArrayArray8767[-839811113
							* client.anInt8769][i_11_][i_12_]) * 3);
					int i_14_ = ((client.anIntArrayArrayArray8767[client.anInt8769
							* -839811113][1 + i_11_][i_12_]) * 3);
					int i_15_ = 3 * ((client.anIntArrayArrayArray8767[client.anInt8769
							* -839811113][2 + i_11_][i_12_]) - ((client.anIntArrayArrayArray8767[-839811113
							* client.anInt8769][3 + i_11_][i_12_]) - (client.anIntArrayArrayArray8767[-839811113
							* client.anInt8769][2 + i_11_][i_12_])));
					int i_16_ = (client.anIntArrayArrayArray8767[-839811113
							* client.anInt8769][i_11_][i_12_]);
					int i_17_ = i_14_ - i_13_;
					int i_18_ = i_15_ + (i_13_ - i_14_ * 2);
					int i_19_ = i_14_
							+ ((client.anIntArrayArrayArray8767[client.anInt8769
									* -839811113][2 + i_11_][i_12_]) - i_16_)
							- i_15_;
					fs_10_[i_12_] = (((float) i_17_ + (f * (float) i_19_ + (float) i_18_)
							* f)
							* f + (float) i_16_);
				}
				...
				client.anInt8756 = ((int) (Math.atan2((double) f_21_, d) * 2607.5945876176133) & 0x3fff)
						* -648269561;
				Class135.anInt6384 = ((int) (-Math.atan2((double) f_20_,
						(double) f_22_) * 2607.5945876176133) & 0x3fff)
						* -1587695039;
				Class229.anInt6458 = ((client.anIntArrayArrayArray8767[-591434031
						* client.anInt8768][i_1_][3]) + ((((client.anIntArrayArrayArray8767[-591434031
						* client.anInt8768][2 + i_1_][3]) - (client.anIntArrayArrayArray8767[client.anInt8768
						* -591434031][i_1_][3])) * (892197957 * client.anInt8857)) >> 16))
						* -851711283;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ql.hi(").append(')').toString());
		}
	}

	static void method4914(IComponentDefinition class105, Class117 class117, int i,
			int i_23_, int i_24_, int i_25_, int i_26_, long l) {
		try {
			...
			if ((long) i_27_ <= l) {
				...
				if (!class117.method1274(i_35_, i_37_, -1933314892)
					...
					class57.method654(i_35_ + i, i_37_ + i_23_,
							class117.aClass_ta1397, i, i_23_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ql.y(").append(')').toString());
		}
	}
}
