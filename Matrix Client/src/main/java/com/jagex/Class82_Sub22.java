...
public class Class82_Sub22 extends Class82 {
	...
	boolean method939() {
		Class398 class398 = (Class158_Sub1.aClass389_8568.method4857(
				1632084697 * ((Class82_Sub22) this).anInt6908, -1743709088));
		boolean bool = class398.method4919((byte) 119);
		Class391 class391 = Class501.aClass395_6122.method4903(
				class398.anInt5205 * 1505778629, (byte) -66);
	...
	Class82_Sub22(RsByteBuffer class298_sub53, int i, int i_0_) {
		...
		if (i == 0) {
			...
			((Class82_Sub22) this).anInt6905 = class298_sub53
					.readUnsignedShort()
					* -425099019;
		}
		if (0 == i_0_) {
			...
			((Class82_Sub22) this).anInt6909 = class298_sub53
					.readUnsignedShort() * 514357691;
		}
		if (i == 0 && i_0_ == 0)
			((Class82_Sub22) this).anInt6910 = class298_sub53
					.readUnsignedByte()
					* -776341541;
		else
			((Class82_Sub22) this).anInt6910 = 776341541;
		((Class82_Sub22) this).anInt6908 = class298_sub53
				.readUnsignedShort() * 587513193;
		((Class82_Sub22) this).anInt6916 = class298_sub53
				.readUnsignedByte()
				* -479097679;
		((Class82_Sub22) this).anInt6912 = class298_sub53
				.readUnsignedByte()
				* -666257507;
		...
		((Class82_Sub22) this).anInt6914 = class298_sub53
				.readUnsignedByte()
				* -757238655;
	}
	...
	boolean method870(int i) {
		try {
			Class398 class398 = Class158_Sub1.aClass389_8568.method4857(
					(1632084697 * ((Class82_Sub22) this).anInt6908),
					-1845152840);
			boolean bool = class398.method4919((byte) 118);
			Class391 class391 = Class501.aClass395_6122.method4903(
					class398.anInt5205 * 1505778629, (byte) -64);
			bool &= class391.method4880(1376129821);
			return bool;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yu.p(").append(')').toString());
		}
	}
	...
	public void method868() {
		...
		if (227468397 * ((Class82_Sub22) this).anInt6902 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[((Class82_Sub22) this).anInt6905
					* -153670819].method1015(1193612238);
		...
		if (916056717 * ((Class82_Sub22) this).anInt6907 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[((Class82_Sub22) this).anInt6909
					* -1629854861].method1015(143521447);
			Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
		...
		Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(
				...
				((Class82_Sub22) this).anInt6908 * 1632084697,
				i_4_,
				i_4_,
				i,
				i_3_,
				((Class82_Sub22) this).anInt6916 * 266943569 << 2,
				client.anInt8884 * 443738891,
				(929559909 * ((Class82_Sub22) this).anInt6904 + client.anInt8884 * 443738891),
				-1300008271 * ((Class82_Sub22) this).anInt6915, i_7_,
				((Class82_Sub22) this).anInt6905 * -153670819 + 1, 1
						+ -1629854861 * ((Class82_Sub22) this).anInt6909,
				((Class82_Sub22) this).anInt6912 * 172590773 << 2, false, 0));
		class365_sub1_sub1_sub1
				.method4405(
						i_5_,
						i_6_,
						172590773 * ((Class82_Sub22) this).anInt6912 << 2,
						(client.anInt8884 * 443738891 + 929559909 * ((Class82_Sub22) this).anInt6904),
						-414343918);
		client.aClass453_8824.method5935(new Class298_Sub37_Sub2(
				class365_sub1_sub1_sub1), 1292621740);
	}
	...
	public void method869() {
		...
		if (227468397 * ((Class82_Sub22) this).anInt6902 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[((Class82_Sub22) this).anInt6905
					* -153670819].method1015(1656183484);
			Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
			i = (int) class217.aFloat2451;
		...
		if (916056717 * ((Class82_Sub22) this).anInt6907 >= 0) {
			...
			Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[((Class82_Sub22) this).anInt6909
					* -1629854861].method1015(43837883);
			Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
		...
		Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(
				...
				client.anInt8884 * 443738891,
				(929559909 * ((Class82_Sub22) this).anInt6904 + client.anInt8884 * 443738891),
				-1300008271 * ((Class82_Sub22) this).anInt6915, i_12_,
				((Class82_Sub22) this).anInt6905 * -153670819 + 1, 1
						+ -1629854861 * ((Class82_Sub22) this).anInt6909,
				((Class82_Sub22) this).anInt6912 * 172590773 << 2, false, 0));
		class365_sub1_sub1_sub1
				.method4405(
						...
						1238518641);
		client.aClass453_8824.method5935(new Class298_Sub37_Sub2(
				class365_sub1_sub1_sub1), 489461607);
	}
	...
	public void method866(int i) {
		try {
			...
			if (227468397 * ((Class82_Sub22) this).anInt6902 >= 0) {
				...
				Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[((Class82_Sub22) this).anInt6905
						* -153670819].method1015(1024446891);
				Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
			...
			if (916056717 * ((Class82_Sub22) this).anInt6907 >= 0) {
				...
				Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[((Class82_Sub22) this).anInt6909
						* -1629854861].method1015(1821624579);
				Class217 class217 = class365_sub1_sub1_sub2.method4337().aClass217_2599;
			...
			Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(
					...
					client.anInt8884 * 443738891,
					(929559909 * ((Class82_Sub22) this).anInt6904 + client.anInt8884 * 443738891),
					-1300008271 * ((Class82_Sub22) this).anInt6915, i_18_,
					((Class82_Sub22) this).anInt6905 * -153670819 + 1, 1
							+ -1629854861 * ((Class82_Sub22) this).anInt6909,
					((Class82_Sub22) this).anInt6912 * 172590773 << 2, false, 0));
			class365_sub1_sub1_sub1
					.method4405(
							...
							1057769456);
			client.aClass453_8824.method5935(new Class298_Sub37_Sub2(
					class365_sub1_sub1_sub1), -428713736);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yu.f(").append(')').toString());
		}
	}
