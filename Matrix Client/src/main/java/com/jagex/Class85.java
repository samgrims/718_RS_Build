package com.jagex;/* Class85 - Decompiled by JODE
...
public class Class85 {
	...
	public Class182 method953(int i) {
		try {
			return Class151.method1643(((Class85) this).anInt778 * 108680029,
					675004457);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dl.a(").append(')').toString());
		}
	}

	Class85 method954(int i, int i_4_, int i_5_, int i_6_) {
		try {
			return new Class85(108680029 * ((Class85) this).anInt778, i, i_4_,
					i_5_, aByte780);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("dl.f(").append(')').toString());
		}
	}
