...
public class Class169 {
	...
	void method1799() {
		...
		for (int i = 0; i < ((Class169) this).anInt1731; i++) {
			for (int i_0_ = 0; i_0_ < ((Class169) this).anInt1732; i_0_++) {
				((Class169) this).aClass164ArrayArray1736[i_0_][i] = new Class164(
						((Class169) this).aClass_ra_Sub3_1733, this,
						((Class169) this).aClass_xa_Sub1_1729, i_0_, i,
						((Class169) this).anInt1735, i_0_ * 128 + 1,
						i * 128 + 1);
	...
	void method1800(Class137 class137, int i, int i_1_, int i_2_,
		...
		if (bool) {
						...
						while_64_: for (int i_9_ = i_7_; i_9_ < i_8_; i_9_++) {
							if (i_9_ - i >= -i_2_ && i_9_ - i <= i_2_) {
								for (int i_10_ = i_4_; i_10_ < i_5_; i_10_++) {
									if (i_10_ - i_1_ >= -i_2_
											&& i_10_ - i_1_ <= i_2_
											&& (bools[i_9_ - i + i_2_][i_10_
													- i_1_ + i_2_])) {
										class137.aClass233_1519.method2147(f,
												f, 1.0F, 1.0F);
										class137.aClass233_1519.aFloatArray2594[12] = (float) -i_6_;
										class137.aClass233_1519.aFloatArray2594[13] = (float) -i_3_;
										((Class169) this).aClass164ArrayArray1736[i_6_][i_3_]
												.method1778(class137);
										break while_64_;
									}
								}
					...
					if (class164 != null) {
						...
						for (int i_19_ = i_13_; i_19_ < i_14_; i_19_++) {
							if (i_19_ - i_1_ >= -i_2_ && i_19_ - i_1_ <= i_2_) {
								int i_20_ = i_19_
										* ((((Class169) this).aClass_xa_Sub1_1729.anInt6287) * -506105871)
										+ i_17_;
								for (int i_21_ = i_17_; i_21_ < i_18_; i_21_++) {
									if (i_21_ - i >= -i_2_
											&& i_21_ - i <= i_2_
											&& (bools[i_21_ - i + i_2_][i_19_
													- i_1_ + i_2_])) {
			...
			if (bytebuffer.position() != 0) {
				...
				Interface7_Impl2 interface7_impl2 = ((Class169) this).aClass_ra_Sub3_1733
						.method5312(i_24_ / 2);
				interface7_impl2.method63(0, i_24_,
						(((Class169) this).aClass_ra_Sub3_1733.aLong8217));
				int i_25_ = 0;
				i_11_ = 0;
					...
					for (int i_27_ = 0; i_27_ < ((Class169) this).anInt1732; i_27_++) {
						if (is[i_11_] != 0) {
							class137.aClass233_1519
									.method2147(f, f, 1.0F, 1.0F);
							class137.aClass233_1519.aFloatArray2594[12] = (float) -i_27_;
							class137.aClass233_1519.aFloatArray2594[13] = (float) -i_26_;
							((Class169) this).aClass164ArrayArray1736[i_27_][i_26_]
									.method1779(class137, interface7_impl2,
											i_25_, is[i_11_] / 3);
							i_25_ += is[i_11_];
						}
						i_11_++;
	...
	void method1801(Class_na class_na, int i, int i_28_) {
		...
		if (i_32_ > 0 && i_31_ > 0) {
			method1803(((Class169) this).aByteArray1734,
					((Class_na_Sub2) class_na_sub2).aByteArray10020, i_30_,
	...
	static final void method1803(byte[] is, byte[] is_48_, int i, int i_49_,
	...
	static final boolean method1804(byte[] is, int i, int i_58_, int i_59_,
			int i_60_, int i_61_) {
	...
	void method1805(Class_na class_na, int i, int i_68_) {
		...
		if (i_72_ > 0 && i_71_ > 0) {
			method1806(((Class169) this).aByteArray1734,
					((Class_na_Sub2) class_na_sub2).aByteArray10020, i_70_,
					i_69_, i_72_, i_71_, i_73_, i_74_);
			method1802(i, i_68_, i_72_, i_71_);
		}
	}

	static final void method1806(byte[] is, byte[] is_79_, int i, int i_80_,
	...
	Class169(Class_ra_Sub3 class_ra_sub3, Class_xa_Sub1 class_xa_sub1) {
		...
		((Class169) this).anInt1730 = 2 + ((((Class169) this).aClass_xa_Sub1_1729.anInt6287
				* -506105871 * (((Class169) this).aClass_xa_Sub1_1729.anInt6288 * -1212653763)) >> (((Class_ra_Sub3) ((Class169) this).aClass_ra_Sub3_1733).anInt8313));
		((Class169) this).anInt1728 = 2 + ((((Class169) this).aClass_xa_Sub1_1729.anInt6286
				* -1148794921 * (((Class169) this).aClass_xa_Sub1_1729.anInt6288 * -1212653763)) >> (((Class_ra_Sub3) ((Class169) this).aClass_ra_Sub3_1733).anInt8313));
		((Class169) this).aByteArray1734 = (new byte[((Class169) this).anInt1730
				* ((Class169) this).anInt1728]);
		...
		((Class169) this).anInt1732 = (((Class169) this).aClass_xa_Sub1_1729.anInt6287
				* -506105871 >> ((Class169) this).anInt1735);
		((Class169) this).anInt1731 = (((Class169) this).aClass_xa_Sub1_1729.anInt6286
				* -1148794921 >> ((Class169) this).anInt1735);
	}
	...
	boolean method1807(Class_na class_na, int i, int i_89_) {
		...
		return method1804(((Class169) this).aByteArray1734, i_90_, i_92_,
				i_91_, i_93_, i_98_);
	}
}
