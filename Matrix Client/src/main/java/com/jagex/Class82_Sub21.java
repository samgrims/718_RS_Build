...
public class Class82_Sub21 extends Class82 {
	...
	Class82_Sub21(RsByteBuffer class298_sub53) {
		...
		((Class82_Sub21) this).anInt6901 = class298_sub53
				.readUnsignedShort() * 855211779;
	}

	public void method866(int i) {
		try {
			Class87.aClass86Array798[((Class82_Sub21) this).anInt6901 * 297690027]
					.method959((byte) 12);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yt.f(").append(')').toString());
		}
	}
	...
	static final void method936(Class365_Sub1 class365_sub1, int i,
			boolean bool, int i_0_) {
		try {
			int i_1_;
			int i_2_;
			if (class365_sub1 instanceof Class365_Sub1_Sub1
					&& class365_sub1 instanceof Interface3) {
				Class365_Sub1_Sub1 class365_sub1_sub1 = (Class365_Sub1_Sub1) class365_sub1;
				int i_3_ = ((class365_sub1_sub1.aShort9796
						- class365_sub1_sub1.aShort9798 + 1) << 9);
			...
			Class125.method1400(class365_sub1.plane, i_1_, i_2_, 0, i,
					bool, 1992555297);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("yt.jg(").append(')').toString());
		}
	}
	...
	static final boolean method938(int i, int i_6_, boolean bool,
		...
		try {
			...
			if (i_8_ < 0
					|| i_8_ >= client.aClass283_8716.method2629(-2029828730)
					|| i_9_ < 0
					|| i_9_ >= client.aClass283_8716.method2630(911412275))
				return false;
			if (i < 0 || i >= client.aClass283_8716.method2629(-2140756422)
					|| i_6_ < 0
					|| i_6_ >= client.aClass283_8716.method2630(1432313507))
				return false;
			int i_10_ = (Class298_Sub37
					.calculateRoute(
							i_8_,
							i_9_,
							Class287.myPlayer
							...
							(client.aClass283_8716
									.getSceneClipDataPlane(
											Class287.myPlayer.plane)), bool,
							client.calculatedScenePositionXs, client.calculatedScenePositionYs));
			if (i_10_ < 1)
				return false;
