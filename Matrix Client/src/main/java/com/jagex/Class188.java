...
public class Class188 implements Iterator {
	...
	public void remove() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hw.remove(").append(')').toString());
		}
	}

	public boolean hasNext() {
		try {
			return (((Class188) this).anInt1912 * -1320296169 < -400292665
					* ((AbstractQueue_Sub1) (((Class188) this).anAbstractQueue_Sub1_1913)).anInt6314);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hw.hasNext(").append(')').toString());
		}
	}

	public Object next() {
		try {
			if (1539110513 * ((Class188) this).anInt1911 != -772584077
					* (((AbstractQueue_Sub1) ((Class188) this).anAbstractQueue_Sub1_1913).anInt6316))
			...
			if (((Class188) this).anInt1912 * -1320296169 < (((AbstractQueue_Sub1) ((Class188) this).anAbstractQueue_Sub1_1913).anInt6314 * -400292665)) {
				Object object = (((Class170) (((AbstractQueue_Sub1) ((Class188) this).anAbstractQueue_Sub1_1913).aClass170Array6313[((Class188) this).anInt1912
						* -1320296169])).anObject1738);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hw.next(").append(')').toString());
		}
	}
	...
	static final void method1851(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub6
					.method886(i_0_, i_1_, true, 15837685);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hw.td(").append(')').toString());
		}
	}
