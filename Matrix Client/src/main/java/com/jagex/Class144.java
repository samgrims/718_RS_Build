...
public class Class144 {
	...
	public Class132 method1579(int i, int i_0_) {
		try {
			...
			synchronized (((Class144) this).aClass348_1561) {
				class132 = (Class132) ((Class144) this).aClass348_1561
						.method4184((long) i);
			}
			if (class132 != null)
				return class132;
			...
			synchronized (((Class144) this).aClass243_1559) {
				is = (((Class144) this).aClass243_1559.method2315(
						SignLink.aClass120_1425.anInt1460 * -1006924897, i,
						(byte) -128));
			}
	...
	public void method1582(int i, int i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fv.b(").append(')').toString());
		}
	}

	public Class144(Class411 class411, Class429 class429, Class243 class243,
			Class243 class243_2_) {
		((Class144) this).aClass243_1559 = class243;
		((Class144) this).aClass243_1560 = class243_2_;
		((Class144) this).aClass243_1559.filesCount(
				(-1006924897 * (SignLink.aClass120_1425.anInt1460)),
				-2109974583);
	}
	...
	static final void method1583(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fv.fz(").append(')').toString());
		}
	}

	static final void method1584(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass162_5252.anInt1670 * 873199607;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fv.xc(").append(')').toString());
		}
	}
	...
	static final void method1585(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub10_7548
					.method5612(i_3_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fv.aog(").append(')').toString());
		}
	}
		...
		try {
			...
			if (class503.anIntArray6188 != null)
				class503 = class503.method6240(Class128.aClass148_6331,
						1999627505);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class503 != null ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fv.apl(").append(')').toString());
		}
	}
		...
		try {
			...
			if (Class287.myPlayer.aClass366_10209 != null)
				Class287.myPlayer.aClass366_10209
						.method4541(i_4_, i_5_,
								Class298_Sub32_Sub14.aClass477_9400, (byte) -1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fv.cv(").append(')').toString());
		}
	}
}
