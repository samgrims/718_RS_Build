	...
	public static byte[] method5586(Object object, int i, int i_0_, byte i_1_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rf.b(").append(')').toString());
		}
	}

	public static int method5587(int i, int i_2_, int i_3_, int i_4_, int i_5_,
			int i_6_, int i_7_) {
		try {
			if ((i_6_ & 0x1) == 1) {
				int i_8_ = i_4_;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rf.i(").append(')').toString());
		}
	}

	static String method5588(CharSequence charsequence, Class513 class513,
			byte i) {
		try {
			...
			int i_9_ = 0;
			int i_10_;
			for (i_10_ = charsequence.length(); i_9_ < i_10_
					&& ConfigDefinitions
							.method3980(charsequence.charAt(i_9_), 185580898); i_9_++) {
				/* empty */
			}
			for (/**/; (i_10_ > i_9_ && ConfigDefinitions.method3980(charsequence
					.charAt(i_10_ - 1), -1519613648)); i_10_--) {
				/* empty */
			}
