...
public class Class287 {
	...
	Class287() {
		...
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557
				.method5687(2133264539) == 1)
			anInt3099 = (int) (Math.random() * 6.0) * -359546329;
		else
			anInt3099 = (int) (Math.random() * 12.0) * -359546329;
	}

	public static boolean method2720(int i, int i_3_, int i_4_, int i_5_,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lx.t(").append(')').toString());
		}
	}

	static final void method2721(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1914527151 * Class298_Sub41.anInt7456;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lx.amv(").append(')').toString());
		}
	}
	...
	static final void method2723(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aClass251Array8920[i_12_].anInt2770 * 1869840307;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lx.yd(").append(')').toString());
		}
	}
}
