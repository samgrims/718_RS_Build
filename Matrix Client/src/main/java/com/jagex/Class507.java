...
public class Class507 {
	...
	public Class503 method6269(int i, int i_0_) {
		try {
			Class503 class503;
			synchronized (((Class507) this).aClass348_6206) {
				class503 = (Class503) ((Class507) this).aClass348_6206
						.method4184((long) i);
			}
			if (null != class503)
				return class503;
			...
			((Class503) class503).aClass507_6125 = this;
			class503.aStringArray6142 = (String[]) ((Class507) this).aStringArray6213
					.clone();
			if (is != null)
	...
	public void method6275(int i, int i_2_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uy.k(").append(')').toString());
		}
	}

	public Class507(Class411 class411, Class429 class429, boolean bool,
		...
		if (Class411.aClass411_5320 == ((Class507) this).aClass411_6205)
			((Class507) this).aStringArray6213 = (new String[] {
					...
					Tradution.aClass470_5905.method6049(
							(((Class507) this).aClass429_6212), -875414210) });
		else
			((Class507) this).aStringArray6213 = new String[] { null, null,
					null, null, null, null };
	}
