package com.jagex;/* Class178 - Decompiled by JODE
	...
	static final void method1834(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hk.wb(").append(')').toString());
		}
	}

	static final void method1835(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7584
					.method5726(-2143935557);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hk.ajx(").append(')').toString());
		}
	}
}
