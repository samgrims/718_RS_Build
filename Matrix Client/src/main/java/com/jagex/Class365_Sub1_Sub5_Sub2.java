...
public class Class365_Sub1_Sub5_Sub2 extends Class365_Sub1_Sub5 implements
	...
	Class335 method4370(GraphicsToolkit class_ra) {
		Class387 class387 = aClass60_9935.method700(class_ra, 2048, false,
				true, (byte) 90);
		if (class387 == null)
			return null;
	...
	void method4357(GraphicsToolkit class_ra, int i) {
		try {
			Class387 class387 = aClass60_9935.method700(class_ra, 262144, true,
					true, (byte) -57);
			if (class387 != null) {
				Class222 class222 = method4347();
				Class235 class235 = method4337();
	...
	boolean method4352(GraphicsToolkit class_ra, int i, int i_9_) {
		Class387 class387 = aClass60_9935.method700(class_ra, 131072, false,
				false, (byte) 94);
		if (class387 == null)
			return false;
	...
	boolean method4350(GraphicsToolkit class_ra, int i, int i_23_, byte i_24_) {
		try {
			Class387 class387 = aClass60_9935.method700(class_ra, 131072,
					false, false, (byte) 30);
			if (class387 == null)
				return false;
				...
				if (i == 0) {
					...
					if (null != string) {
						...
						Class264 class264 = (Class373.aClass_ra4071.method5092(
								class505, IndexedImage.method993(
										Class158.idx8,
