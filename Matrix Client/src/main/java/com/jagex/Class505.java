...
public class Class505 {
				...
				if (c == 60)
					...
					if (c == 62 && i_1_ != -1) {
						...
						if (string_6_.equals("lt"))
							...
							if (string_6_.startsWith("img=")
									&& null != interface28s) {
								try {
									int i_7_ = (Class216.method1998(string_6_
											.substring(4), (short) -2448));
					...
					if (-1 == i_1_) {
						i_3_ += ((((Class505) this).aByteArray6199[Class124
								.method1387(c, 1088430238) & 0xff]) & 0xff);
						if (((Class505) this).aByteArrayArray6198 != null
								&& i_2_ != -1)
	...
	public int method6255(int i, int i_8_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.i(").append(')').toString());
		}
	}

	public String method6256(String string, int i, Interface28[] interface28s,
			byte i_9_) {
		try {
			...
			for (int i_15_ = 0; i_15_ < i_13_; i_15_++) {
				...
				if (c == 60)
					...
					if (62 == c && i_10_ != -1) {
						...
						if (string_16_.equals("lt"))
							...
							if (string_16_.startsWith("img=")
									&& interface28s != null) {
								try {
									int i_17_ = (Class216.method1998(string_16_
											.substring(4), (short) 4410));
					...
					if (i_10_ == -1) {
						i_12_ += ((((Class505) this).aByteArray6199[Class124
								.method1387(c, 1088430238) & 0xff]) & 0xff);
						if (((Class505) this).aByteArrayArray6198 != null
								&& i_11_ != -1)
						...
						if (i_18_ > i)
							return new StringBuilder().append(string_14_)
									.append("...").toString();
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.u(").append(')').toString());
		}
	}

	public int method6257(String string, int[] is, String[] strings,
			Interface28[] interface28s, byte i) {
		try {
			return method6258(string, is, strings, interface28s, true,
					116413311);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.x(").append(')').toString());
		}
	}

	int method6258(String string, int[] is, String[] strings,
			Interface28[] interface28s, boolean bool, int i) {
		try {
			if (string == null)
				return 0;
			int i_19_ = 0;
			...
			for (int i_28_ = 0; i_28_ < i_27_; i_28_++) {
				int i_29_ = (Class124.method1387(string.charAt(i_28_),
						1088430238) & 0xff);
				int i_30_ = 0;
				if (60 == i_29_)
					i_24_ = i_28_;
					...
					if (-1 != i_24_) {
						...
						if (string_32_.equals("lt")) {
							...
							if (null != ((Class505) this).aByteArrayArray6198
									&& i_25_ != -1)
							...
							i_25_ = 174;
						} else if (string_32_.startsWith("img=")
								&& null != interface28s) {
							try {
								int i_33_ = Class216.method1998(string_32_
										.substring(4), (short) 14575);
					...
					if (i_30_ > 0) {
						...
						if (is != null) {
							...
							if (i_19_ > is[(i_26_ < is.length ? i_26_
									: is.length - 1)]) {
								if (i_21_ >= 0) {
									strings[i_26_] = string.substring(i_20_,
											i_21_ + 1 - i_23_);
									if (++i_26_ >= strings.length)
										return 0;
									i_20_ = i_21_ + 1;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.r(").append(')').toString());
		}
	}

	public int method6259(String string, int i, Interface28[] interface28s,
			int i_34_) {
		try {
			int i_35_ = method6257(string, new int[] { i }, aStringArray6201,
					interface28s, (byte) 91);
			int i_36_ = 0;
			for (int i_37_ = 0; i_37_ < i_35_; i_37_++) {
				int i_38_ = method6254(aStringArray6201[i_37_], interface28s,
						1319235613);
				if (i_38_ > i_36_)
					i_36_ = i_38_;
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.q(").append(')').toString());
		}
	}

	public int method6260(String string, int i, int i_39_,
			Interface28[] interface28s, int i_40_) {
		try {
			if (0 == i_39_)
				i_39_ = -2028004825 * anInt6200;
			int i_41_ = method6257(string, new int[] { i }, aStringArray6201,
					interface28s, (byte) 11);
			int i_42_ = (i_41_ - 1) * i_39_;
			return i_42_ + anInt6202 * 1110385787 + -1883958527 * anInt6197;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.s(").append(')').toString());
		}
	}
	...
	Class505(byte[] is) {
		...
		class298_sub53.readBytes(((Class505) this).aByteArray6199, 0, 256,
				-953523806);
		if (bool) {
			...
			for (int i_55_ = 0; i_55_ < 256; i_55_++) {
				if (i_55_ != 32) {
					for (int i_56_ = 0; i_56_ < 256; i_56_++) {
						if (i_56_ != 32)
							((Class505) this).aByteArrayArray6198[i_55_][i_56_] = (byte) Class25
									.method392(is_47_, is_51_, is_44_,
											(((Class505) this).aByteArray6199),
											is_43_, i_55_, i_56_, -2019008168);
					}
				}
			}
	...
	public int method6261(String string, int i, int i_57_, int i_58_,
			int i_59_, Interface28[] interface28s, byte i_60_) {
		try {
			if (0 == i_57_)
				i_57_ = -2028004825 * anInt6200;
			int i_61_ = method6257(string, new int[] { i }, aStringArray6201,
					interface28s, (byte) -28);
			if (0 == i_61_)
				return 0;
			if (i_59_ < 0)
				i_59_ = 0;
			...
			int i_64_ = 0;
			int i_65_;
			for (i_65_ = 0; i_65_ < i_58_ && i_63_ < string_62_.length(); i_65_ = method6254(
					string_62_.substring(0, ++i_63_), interface28s, 1319235613))
				i_64_ = i_65_;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.y(").append(')').toString());
		}
	}

	public int method6262(String string, int i, Interface28[] interface28s,
			int i_67_) {
		try {
			return method6257(string, new int[] { i }, aStringArray6201,
					interface28s, (byte) -64);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.n(").append(')').toString());
		}
	}

	public Point method6263(String string, int i, int i_68_, int i_69_,
			Interface28[] interface28s, int i_70_) {
		try {
			if (i_69_ <= 0)
			...
			int i_71_ = method6258(string, new int[] { i }, aStringArray6201,
					interface28s, false, 116413311);
			int i_72_ = 0;
			for (int i_73_ = 0; i_73_ < i_71_; i_73_++) {
				int i_74_ = aStringArray6201[i_73_].length();
				if (i_74_ + i_72_ > i_69_ || i_71_ - 1 == i_73_
						&& i_69_ == string.length()) {
	...
	static final void method6266(Class403 class403, byte i) {
		try {
			...
			Class497 class497 = Class92.aClass504_905.method6251(i_83_,
					381661715);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.hm(").append(')').toString());
		}
	}

	public static void method6267(Class298 class298, Class298 class298_85_,
			byte i) {
		try {
	...
	static final void method6268(Class403 class403, byte i) {
		try {
			...
			Class23
					.method377(
							(String) (((Class403) class403).anObjectArray5240[-203050393
									* ((Class403) class403).anInt5241]),
							(String) (((Class403) class403).anObjectArray5240[1
									+ -203050393
									* ((Class403) class403).anInt5241]),
							"",
							(((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 -= -391880689) * 681479919)]) == 1,
							false, (byte) -37);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("uw.aft(").append(')').toString());
		}
	}
}
