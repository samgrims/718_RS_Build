...
public class Class263_Sub2 extends Class263 implements Interface9_Impl3 {
	...
	Class263_Sub2(Class_ra_Sub3_Sub1 class_ra_sub3_sub1, Class55 class55,
			int i, int i_0_, int i_1_, boolean bool, byte[] is) {
		super(class_ra_sub3_sub1, 32879, class55, Class77.aClass77_717, i
				* i_0_ * i_1_, bool);
		...
		OpenGL.glTexImage3Dub(((Class263_Sub2) this).anInt6415, 0,
				(Class_ra_Sub3_Sub1.method5533(
						((Class263_Sub2) this).aClass55_6419,
						((Class263_Sub2) this).aClass77_6420)),
				((Class263_Sub2) this).anInt8634,
				((Class263_Sub2) this).anInt8635,
				((Class263_Sub2) this).anInt8633, 0, Class_ra_Sub3_Sub1
						.method5532(((Class263_Sub2) this).aClass55_6419),
				5121, is, 0);
