...
public class Class250 {
	...
	public static byte[] method2395(int i, byte i_0_) {
		try {
			Class298_Sub37_Sub11 class298_sub37_sub11 = (Class298_Sub37_Sub11) aClass354_2764
					.method4253((long) i);
			if (class298_sub37_sub11 == null) {
				...
				for (int i_2_ = 0; i_2_ < 255; i_2_++) {
					int i_3_ = 255 - i_2_;
					int i_4_ = Class298_Sub19_Sub3.method3039(random, i_3_,
							(byte) -16);
					byte i_5_ = is[i_4_];
					is[i_4_] = is[i_3_];
	...
	static final void method2399(Class403 class403, byte i) {
		try {
			...
			String string_11_ = ((String) (((Class403) class403).anObjectArray5240[-203050393
					* ((Class403) class403).anInt5241 + 1]));
			if (null != (Class287.myPlayer.aClass366_10209)
					&& (Class287.myPlayer.aClass366_10209.aBoolean3977))
