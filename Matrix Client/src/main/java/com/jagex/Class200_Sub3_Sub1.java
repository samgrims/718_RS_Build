...
public class Class200_Sub3_Sub1 extends Class200_Sub3 implements
	...
	public void method83(int i, int i_0_, int i_1_, int i_2_, int[] is, int i_3_) {
		long l = IDirect3DTexture.GetSurfaceLevel(
				((Class200_Sub3_Sub1) this).aLong6407, 0);
		long l_4_ = IDirect3DDevice
				.CreateRenderTarget(
						(((Class_ra_Sub3_Sub2) (((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410)).aLong9847),
						i_1_, i_2_, 21, 0, 0, true);
		if (jagdx.a
				.f(IDirect3DDevice
						.StretchRect(
								(((Class_ra_Sub3_Sub2) ((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410).aLong9847),
								l, i, i_0_, i_1_, i_2_, l_4_, 0, 0, i_1_, i_2_,
								1))) {
			IDirect3DSurface
					.Download(
							l_4_,
							...
							i_1_ * 4,
							16,
							(((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410.aLong8217));
			((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410.aByteBuffer8216
					.clear();
			((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410.aByteBuffer8216
					.asIntBuffer().get(is);
		}
	...
	public void method81(int i, int i_5_, int i_6_, int i_7_, int[] is,
			int i_8_, int i_9_) {
	...
	public void method101(int i, int i_10_, int i_11_, int i_12_, int[] is,
			int i_13_, int i_14_) {
	...
	public void method82(int i, int i_15_, int i_16_, int i_17_, byte[] is,
			Class55 class55, int i_18_, int i_19_) {
		super.method82(i, i_15_, i_16_, i_17_, is, class55, i_18_, i_19_);
	}

	public void method107(int i, int i_20_, int i_21_, int i_22_, int[] is,
			int i_23_) {
		long l = IDirect3DTexture.GetSurfaceLevel(
				((Class200_Sub3_Sub1) this).aLong6407, 0);
		long l_24_ = IDirect3DDevice
				.CreateRenderTarget(
						(((Class_ra_Sub3_Sub2) (((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410)).aLong9847),
						i_21_, i_22_, 21, 0, 0, true);
		if (jagdx.a
				.f(IDirect3DDevice
						.StretchRect(
								(((Class_ra_Sub3_Sub2) ((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410).aLong9847),
								l, i, i_20_, i_21_, i_22_, l_24_, 0, 0, i_21_,
								i_22_, 1))) {
			IDirect3DSurface
					.Download(
							l_24_,
	...
	public void method102(int i, int i_31_, int i_32_, int i_33_, int[] is,
			int i_34_, int i_35_) {
	...
	public void method104(int i, int i_36_, int i_37_, int i_38_, byte[] is,
			Class55 class55, int i_39_, int i_40_) {
	...
	public void method93(int i, int i_41_, int i_42_, int i_43_, int[] is,
			int i_44_) {
		long l = IDirect3DTexture.GetSurfaceLevel(
				((Class200_Sub3_Sub1) this).aLong6407, 0);
		long l_45_ = IDirect3DDevice
				.CreateRenderTarget(
						(((Class_ra_Sub3_Sub2) (((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410)).aLong9847),
						i_42_, i_43_, 21, 0, 0, true);
		if (jagdx.a
				.f(IDirect3DDevice
						.StretchRect(
								(((Class_ra_Sub3_Sub2) ((Class200_Sub3_Sub1) this).aClass_ra_Sub3_Sub2_6410).aLong9847),
								l, i, i_41_, i_42_, i_43_, l_45_, 0, 0, i_42_,
								i_43_, 1))) {
			IDirect3DSurface
					.Download(
							l_45_,
	...
	public void method87(int i, int i_46_, int i_47_, int i_48_, byte[] is,
	...
	public void method100(int i, int i_51_, int i_52_, int i_53_, byte[] is,
			Class55 class55, int i_54_, int i_55_) {
		super.method82(i, i_51_, i_52_, i_53_, is, class55, i_54_, i_55_);
	}

	Class200_Sub3_Sub1(Class_ra_Sub3_Sub2 class_ra_sub3_sub2, Class55 class55,
			Class77 class77, int i, int i_56_) {
