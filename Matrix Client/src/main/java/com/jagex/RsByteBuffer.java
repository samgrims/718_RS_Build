...
public class RsByteBuffer extends Class298 {
	...
	public void writeString(String string, int i) {
		try {
			...
			index += Class361.method4304(string, 0, string.length(),
					buffer, 385051775 * index, (byte) 41) * 116413311;
			buffer[(index += 116413311) * 385051775 - 1] = (byte) 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.z(").append(')').toString());
		}
	}
	...
	public int method3600(int i) {
		try {
			index += 465653244;
			return (((buffer[index * 385051775 - 1] & 0xff) << 24)
					+ ((buffer[index * 385051775 - 2] & 0xff) << 16)
					+ ((buffer[index * 385051775 - 3] & 0xff) << 8) + (buffer[385051775 * index - 4] & 0xff));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.ah(").append(')').toString());
		}
	}
	...
	public void method3610(int[] is, int i) {
		try {
			...
			for (int i_26_ = 0; i_26_ < i_25_; i_26_++) {
				...
				int i_31_ = 32;
				while (i_31_-- > 0) {
					i_28_ -= (i_27_ + (i_27_ << 4 ^ i_27_ >>> 5) ^ is[i_29_ >>> 11 & 0x3]
					+ i_29_);
					i_29_ -= i_30_;
					i_27_ -= (i_28_ + (i_28_ << 4 ^ i_28_ >>> 5) ^ i_29_
							+ is[i_29_ & 0x3]);
				}
				index -= 931306488;
	...
	public void method3611(int[] is, int i, int i_32_, int i_33_) {
		try {
			...
			for (int i_36_ = 0; i_36_ < i_35_; i_36_++) {
				...
				int i_41_ = 32;
				while (i_41_-- > 0) {
					i_37_ += ((i_38_ << 4 ^ i_38_ >>> 5) + i_38_ ^ is[i_39_ & 0x3]
					                                                  + i_39_);
					i_39_ += i_40_;
					i_38_ += ((i_37_ << 4 ^ i_37_ >>> 5) + i_37_ ^ i_39_
							+ is[i_39_ >>> 11 & 0x3]);
				}
				index -= 931306488;
	...
	public void method3612(int[] is, int i, int i_42_, int i_43_) {
		try {
			...
			for (int i_46_ = 0; i_46_ < i_45_; i_46_++) {
				...
				int i_51_ = 32;
				while (i_51_-- > 0) {
					i_48_ -= (i_47_ + (i_47_ << 4 ^ i_47_ >>> 5) ^ i_49_
							+ is[i_49_ >>> 11 & 0x3]);
					i_49_ -= i_50_;
					i_47_ -= (i_48_ + (i_48_ << 4 ^ i_48_ >>> 5) ^ is[i_49_ & 0x3]
					                                                  + i_49_);
				}
				index -= 931306488;
	...
	public int read24BitUnsignedInteger(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.ad(").append(')').toString());
		}
	}

	public int method3614(int i, int i_52_) {
		try {
			int i_53_ = Class11.method328(buffer, i,
					index * 385051775, -1501053505);
			writeInt(i_53_, 533083974);
			return i_53_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.bf(").append(')').toString());
		}
	}
	...
	public boolean method3615(byte i) {
		try {
			index -= 465653244;
			int i_54_ = Class11.method328(buffer, 0,
					385051775 * index, -395934040);
	...
	public int read24BitInteger(byte i) {
		try {
			index += 349239933;
			int i_59_ = (((buffer[index * 385051775 - 3] & 0xff) << 16)
					+ ((buffer[index * 385051775 - 2] & 0xff) << 8) + (buffer[385051775 * index - 1] & 0xff));
			if (i_59_ > 8388607)
				i_59_ -= 16777216;
			return i_59_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.av(").append(')').toString());
		}
	}
	...
	public int readIntLE(int i) {
		try {
			index += 465653244;
			return (((buffer[index * 385051775 - 3] & 0xff) << 8)
					+ (((buffer[index * 385051775 - 1] & 0xff) << 24) + ((buffer[index * 385051775 - 2] & 0xff) << 16)) + (buffer[index * 385051775 - 4] & 0xff));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.bj(").append(')').toString());
		}
	}
	...
	public int readIntV1(int i) {
		try {
			index += 465653244;
			return (((buffer[385051775 * index - 1] & 0xff) << 16)
					+ ((buffer[385051775 * index - 2] & 0xff) << 24)
					+ ((buffer[index * 385051775 - 4] & 0xff) << 8) + (buffer[index * 385051775 - 3] & 0xff));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.br(").append(')').toString());
		}
	}
	...
	public void putJagString(String string, short i) {
		try {
			...
			buffer[(index += 116413311) * 385051775 - 1] = (byte) 0;
			index += Class361.method4304(string, 0, string.length(),
					buffer, 385051775 * index, (byte) 102) * 116413311;
			buffer[(index += 116413311) * 385051775 - 1] = (byte) 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.c(").append(')').toString());
		}
	}
	...
	static final void method3653(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = string.toLowerCase();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.zd(").append(')').toString());
		}
	}
	...
	static final void method3654(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.dp(").append(')').toString());
		}
	}

	static final void method3655(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7549
					.method5674(-484902399) && Class373.aClass_ra4071
					.method5032()) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.anb(").append(')').toString());
		}
	}

	static void method3656(int i, int i_90_, int i_91_, short i_92_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(9,
					(long) i);
	...
	static final void method3657(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = new StringBuilder().append(string)
					.append((char) i_93_).toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("acx.za(").append(')').toString());
		}
	}
}
