...
public class Class227 {
	...
	static Class227[] method2109(int i) {
		try {
			return (new Class227[] { aClass227_2538, aClass227_2531,
					aClass227_2532, aClass227_2533, aClass227_2534,
					aClass227_2535, aClass227_2536, aClass227_2539,
					aClass227_2541, aClass227_2530, aClass227_2537,
					aClass227_2540, aClass227_2542, aClass227_2554,
					aClass227_2544, aClass227_2545, aClass227_2546,
					aClass227_2547 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jp.a(").append(')').toString());
		}
	}
	...
	Class227(int i, Tradution class470, Tradution class470_4_, int i_5_,
	...
	static {
		aClass227_2531 = new Class227(1, Tradution.aClass470_5878,
				Tradution.aClass470_5878, 2, 3);
		aClass227_2532 = new Class227(2, Tradution.aClass470_5878, 3);
		aClass227_2533 = new Class227(3, Tradution.aClass470_5878,
				Tradution.aClass470_5878, 3, 4);
		aClass227_2534 = new Class227(4, Tradution.aClass470_5878, 4);
		aClass227_2535 = new Class227(5, Tradution.aClass470_5878,
				Tradution.aClass470_5878, 4, 5);
		aClass227_2536 = new Class227(6, Tradution.aClass470_5878,
				Tradution.aClass470_5878, 5, 98, true, true);
		aClass227_2539 = new Class227(7, Tradution.aClass470_5878, 99);
		aClass227_2541 = new Class227(8, Tradution.aClass470_5878, 100);
		aClass227_2530 = new Class227(9, Tradution.aClass470_5834,
				Tradution.aClass470_5834, 0, 92, true, true);
		aClass227_2537 = new Class227(10, Tradution.aClass470_5834,
				Tradution.aClass470_5834, 92, 93);
		aClass227_2540 = new Class227(11, Tradution.aClass470_5834,
				Tradution.aClass470_5834, 94, 95);
		aClass227_2542 = new Class227(12, Tradution.aClass470_5834,
				Tradution.aClass470_5834, 96, 97);
	...
	static final void method2111(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1
					.method2845(i_8_, i_9_, true, false, 1482071907);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jp.ub(").append(')').toString());
		}
	}
		...
		try {
			for (int i_14_ = 0; i_14_ < client.anInt8686 * -112139815; i_14_++) {
				...
				if (rectangle.x + rectangle.width > i
						&& rectangle.x < i + i_11_
						&& rectangle.height + rectangle.y > i_10_
						&& rectangle.y < i_12_ + i_10_)
					client.aBooleanArray8900[i_14_] = true;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jp.kr(").append(')').toString());
		}
	}
	...
	static final void method2113(Class403 class403, int i) {
		try {
			...
			if (client.anInt8942 * 1131012101 == 2
					&& i_15_ < -1054937867 * client.anInt8941)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jp.wn(").append(')').toString());
		}
	}

	public static String method2114(CharSequence charsequence, int i) {
		try {
			String string = Class404.method4952(GraphicsToolkit.method5194(
					charsequence, (byte) -97));
			if (null == string)
				string = "";
			return string;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jp.p(").append(')').toString());
		}
	}
}
