...
public final class Class420 {
	static char[] aCharArray5342 = { '_', 'a', 'b', 'c', 'd', 'e', 'f', 'g',
	...
	public static void method5606(int i, int i_0_, int i_1_, int i_2_,
			int i_3_, int i_4_, int i_5_, int i_6_) {
		try {
			Class298_Sub1 class298_sub1 = null;
			for (Class298_Sub1 class298_sub1_7_ = ((Class298_Sub1) Class298_Sub1.aClass453_7152
					.method5939(1766612795)); class298_sub1_7_ != null; class298_sub1_7_ = ((Class298_Sub1) Class298_Sub1.aClass453_7152
					.method5944(49146))) {
				if ((2108312995 * ((Class298_Sub1) class298_sub1_7_).anInt7151 == i)
						&& 634196087 * class298_sub1_7_.anInt7150 == i_0_
						&& -2146829167 * class298_sub1_7_.anInt7155 == i_1_
						&& i_2_ == -431456739
								* (((Class298_Sub1) class298_sub1_7_).anInt7157)) {
			...
			if (class298_sub1 == null) {
				...
				if (i_0_ >= 0 && i_1_ >= 0
						&& i_0_ < client.aClass283_8716.method2629(-1908372692)
						&& i_1_ < client.aClass283_8716.method2630(629047644))
					Class117.method1285(class298_sub1, -162957807);
				Class298_Sub1.aClass453_7152.method5935(class298_sub1,
						1633204361);
			}
	...
	static final void method5607(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aClass251Array8920[i_8_].anInt2769 * 1383593425;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("rk.yf(").append(')').toString());
		}
	}
		...
		try {
			for (Class298_Sub1 class298_sub1 = ((Class298_Sub1) Class298_Sub1.aClass453_7152
				...
				if (!((Class298_Sub1) class298_sub1).aBoolean7160) {
					((Class298_Sub1) class298_sub1).aBoolean7159 = true;
					if (634196087 * class298_sub1.anInt7150 >= 0
							&& class298_sub1.anInt7155 * -2146829167 >= 0
							&& (634196087 * class298_sub1.anInt7150 < client.aClass283_8716
									.method2629(-1871526843))
