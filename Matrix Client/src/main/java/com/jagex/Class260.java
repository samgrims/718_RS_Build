package com.jagex;/* Class260 - Decompiled by JODE
	...
	static final void method2460(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558
					.method5666(-391880689) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kw.anw(").append(')').toString());
		}
	}

	static final void method2461(IComponentDefinition class105, Class119 class119,
