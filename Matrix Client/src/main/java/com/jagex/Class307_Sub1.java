...
public class Class307_Sub1 extends Class307 {
	static float[][] aFloatArrayArray7666 = {
	...
	void method3757(int i, int i_0_, int i_1_, int i_2_, float f, float f_3_,
				...
				fs[i_6_++] = f_5_
						* (method3760(
								(method3760(
										method3760(
												method3761(
														(((Class307_Sub1) this).anIntArray7667[i_31_
																+ i_25_]) & 0x7,
														f_34_, f_23_, f_14_),
												method3761(
														(((Class307_Sub1) this).anIntArray7667[i_32_
																+ i_25_]) & 0x7,
														f_33_, f_23_, f_14_),
												f_35_),
										method3760(
	...
	void method3758(int i, int i_44_, int i_45_, int i_46_, float f,
			float f_47_, float f_48_, float f_49_, float[] fs, int i_50_) {
		...
		for (int i_62_ = 0; i_62_ < i_45_; i_62_++) {
			...
			for (int i_73_ = 0; i_73_ < i_44_; i_73_++) {
				...
				i_75_ &= i_51_;
				i_76_ &= i_51_;
				fs[i_50_++] = (f_49_ * (method3760(
						(method3760(
								method3760(
										method3761(
												(((Class307_Sub1) this).anIntArray7667[i_75_
														+ i_69_]) & 0x7, f_78_,
												f_67_, f_58_),
										method3761(
												(((Class307_Sub1) this).anIntArray7667[i_76_
														+ i_69_]) & 0x7, f_77_,
												f_67_, f_58_), f_79_),
								method3760(
										method3761(
						...
						(method3760(
								...
								method3760(
										...
										method3761(
												(((Class307_Sub1) this).anIntArray7667[i_76_
														+ i_72_]) & 0x7, f_77_,
												f_66_, f_57_), f_79_), f_68_)),
						f_59_)));
			}
		}
	}

	void method3759(int i, int i_80_, int i_81_, int i_82_, float f,
			float f_83_, float f_84_, float f_85_, float[] fs, int i_86_) {
			...
			for (int i_109_ = 0; i_109_ < i_80_; i_109_++) {
				...
				fs[i_86_++] = (f_85_ * (method3760(
						(method3760(
								method3760(
										method3761(
												(((Class307_Sub1) this).anIntArray7667[i_111_
														+ i_105_]) & 0x7,
												f_114_, f_103_, f_94_),
										method3761(
												(((Class307_Sub1) this).anIntArray7667[i_112_
														+ i_105_]) & 0x7,
												f_113_, f_103_, f_94_), f_115_),
								method3760(
										method3761(
												(((Class307_Sub1) this).anIntArray7667[i_111_
														+ i_106_]) & 0x7,
