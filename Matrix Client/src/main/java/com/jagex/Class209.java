package com.jagex;/* Class209 - Decompiled by JODE
...
public class Class209 {
	...
	public static void method1938(Class391 class391, int i,
			Class365_Sub1 class365_sub1, int i_1_) {
		try {
			if (-991384187 * Class300.anInt3213 < 50
					&& (class391 != null
							&& null != class391.anIntArrayArray4187
							&& i < class391.anIntArrayArray4187.length && class391.anIntArrayArray4187[i] != null)) {
				...
				int i_7_ = 256;
				if (null != class391.anIntArray4183
						&& null != class391.anIntArray4190)
					i_7_ = ((int) (Math.random() * (double) (class391.anIntArray4190[i] - class391.anIntArray4183[i])) + class391.anIntArray4183[i]);
				int i_8_ = (class391.anIntArray4188 == null ? 255
						: class391.anIntArray4188[i]);
				if (i_5_ == 0) {
					if (Class287.myPlayer == class365_sub1) {
						if (class391.aBoolean4173)
							Class320.method3913(i_3_, i_4_, 0, i_8_, false,
									i_7_, 1619018556);
						else
							Class239.method2210(i_3_, i_4_, 0, i_8_, i_7_,
									1846790975);
					}
				} else if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7582
						.method5726(-2147180332) != 0) {
					...
					int i_11_ = ((Class287.myPlayer == class365_sub1) ? 0
							: (i_10_ << 8)
									+ ((i_9_ << 16) + (class365_sub1.plane << 24))
									+ i_5_);
					Class300.aClass297Array3214[(Class300.anInt3213 += -598588595)
							* -991384187 - 1] = new Class297(
							(class391.aBoolean4173 ? (byte) 2 : (byte) 1),
							i_3_, i_4_, 0, i_8_, i_11_, i_7_, class365_sub1);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iu.r(").append(')').toString());
		}
	}
	...
	public static PathStrategy setExtraRoutefinderData(int toX, int toY, int sizeX, int sizeY,
		...
		try {
			...
			((Class336_Sub5) Class315.aClass336_Sub5_3304).routeType = -1073204575
					* routeType;
			return Class315.aClass336_Sub5_3304;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("iu.p(").append(')').toString());
		}
	}
}
