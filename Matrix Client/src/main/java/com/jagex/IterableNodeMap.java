...
public final class IterableNodeMap implements Iterable {
	...
	public void method5811(byte i) {
		try {
			for (int i_0_ = 0; i_0_ < 577108745 * ((IterableNodeMap) this).anInt5515; i_0_++) {
				Class298 class298 = ((IterableNodeMap) this).aClass298Array5512[i_0_];
				for (;;) {
					...
					class298_1_.unlink(-1460969981);
				}
			}
			((IterableNodeMap) this).aClass298_5513 = null;
			((IterableNodeMap) this).aClass298_5516 = null;
	...
	public Class298 get(long l) {
		try {
			...
			Class298 class298 = ((this).aClass298Array5512[(int) (l & (long) (577108745 * ((IterableNodeMap) this).anInt5515 - 1))]);
			for ((this).aClass298_5513 = class298.aClass298_3187; ((IterableNodeMap) this).aClass298_5513 != class298; ((IterableNodeMap) this).aClass298_5513 = ((IterableNodeMap) this).aClass298_5513.aClass298_3187) {
				if ((((IterableNodeMap) this).aClass298_5513.pointer * 7051297995265073167L) == l) {
					Class298 class298_2_ = ((IterableNodeMap) this).aClass298_5513;
					((IterableNodeMap) this).aClass298_5513 = ((IterableNodeMap) this).aClass298_5513.aClass298_3187;
					return class298_2_;
				}
			}
	...
	public Class298 method5813(int i) {
		try {
			if (null == ((IterableNodeMap) this).aClass298_5513)
				return null;
			for (Class298 class298 = (((IterableNodeMap) this).aClass298Array5512[(int) ((((IterableNodeMap) this).aLong5514 * -6131383980927776151L) & (long) ((((IterableNodeMap) this).anInt5515 * 577108745) - 1))]); ((IterableNodeMap) this).aClass298_5513 != class298; ((IterableNodeMap) this).aClass298_5513 = ((IterableNodeMap) this).aClass298_5513.aClass298_3187) {
				if (((IterableNodeMap) this).aLong5514 * -6131383980927776151L == (((IterableNodeMap) this).aClass298_5513.pointer * 7051297995265073167L)) {
					Class298 class298_3_ = ((IterableNodeMap) this).aClass298_5513;
					((IterableNodeMap) this).aClass298_5513 = ((IterableNodeMap) this).aClass298_5513.aClass298_3187;
					return class298_3_;
				}
			}
	...
	public int method5814(int i) {
		try {
			int i_4_ = 0;
			for (int i_5_ = 0; i_5_ < ((IterableNodeMap) this).anInt5515 * 577108745; i_5_++) {
				Class298 class298 = ((IterableNodeMap) this).aClass298Array5512[i_5_];
	...
	public Class298 method5815(byte i) {
		try {
			if (-1375920843 * ((IterableNodeMap) this).anInt5517 > 0
					&& (((IterableNodeMap) this).aClass298_5516 != (((IterableNodeMap) this).aClass298Array5512[((IterableNodeMap) this).anInt5517
							* -1375920843 - 1]))) {
				Class298 class298 = ((IterableNodeMap) this).aClass298_5516;
				((IterableNodeMap) this).aClass298_5516 = class298.aClass298_3187;
				return class298;
			}
			while_102_: do {
				Class298 class298;
				do {
					if (((IterableNodeMap) this).anInt5517 * -1375920843 >= 577108745 * ((IterableNodeMap) this).anInt5515)
						break while_102_;
					class298 = (((IterableNodeMap) this).aClass298Array5512[((((IterableNodeMap) this).anInt5517 += -1552413411) * -1375920843) - 1].aClass298_3187);
				} while (class298 == (((IterableNodeMap) this).aClass298Array5512[-1375920843
						* ((IterableNodeMap) this).anInt5517 - 1]));
				((IterableNodeMap) this).aClass298_5516 = class298.aClass298_3187;
				return class298;
			} while (false);
			return null;
	...
	public Class298 method5816(int i) {
		try {
			((IterableNodeMap) this).anInt5517 = 0;
	...
	public void put(Class298 class298, long l) {
		try {
			if (null != class298.aClass298_3189)
				class298.unlink(-1460969981);
			Class298 class298_7_ = (((IterableNodeMap) this).aClass298Array5512[(int) (l & (long) (((IterableNodeMap) this).anInt5515 * 577108745 - 1))]);
			...
			class298.pointer = 4191220306876042991L * l;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	public IterableNodeMap(int i) {
		((IterableNodeMap) this).anInt5515 = 1594491705 * i;
		((IterableNodeMap) this).aClass298Array5512 = new Class298[i];
		for (int i_8_ = 0; i_8_ < i; i_8_++) {
			Class298 class298 = ((IterableNodeMap) this).aClass298Array5512[i_8_] = new Class298();
