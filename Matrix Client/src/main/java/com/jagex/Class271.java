...
public class Class271 {
	...
	static boolean method2543(int i, int i_0_, int i_1_, int i_2_) {
		try {
			...
			boolean bool = true;
			Interface3 interface3 = (Interface3) class331.method4031(i, i_0_,
					i_1_, 693483522);
			if (null != interface3)
				bool &= Class438_Sub2.method5849(interface3, (byte) -60);
			interface3 = (Interface3) class331.method4035(i, i_0_, i_1_,
					client.anInterface17_8960, 664102063);
			if (interface3 != null)
				bool &= Class438_Sub2.method5849(interface3, (byte) -4);
			interface3 = (Interface3) class331.method4058(i, i_0_, i_1_,
					(byte) 95);
			if (interface3 != null)
	...
	public static Class456[] method2545(byte i) {
		try {
			if (null == Class100.aClass456Array1080) {
				Class456[] class456s = Class111.method1238(
						Class389.aClass457_4164, (short) 486);
				Class456[] class456s_3_ = new Class456[class456s.length];
				int i_4_ = 0;
				int i_5_ = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub8_7566
						.method5654(-1747444886);
				while_69_: for (int i_6_ = 0; i_6_ < class456s.length; i_6_++) {
					Class456 class456 = class456s[i_6_];
					if (class456.anInt5664 * -1087459453 > 0
							&& -1087459453 * class456.anInt5664 < 24) {
						if (i == 0)
						...
						if (class456.anInt5665 * 262154323 < 600) {
							...
							for (int i_7_ = 0; i_7_ < i_4_; i_7_++) {
								...
								if ((class456.anInt5663 * 28445523 == 28445523 * class456_8_.anInt5663)
										&& (262154323 * class456_8_.anInt5665 == 262154323 * class456.anInt5665)) {
									if (-1087459453 * class456.anInt5664 > -1087459453
											* class456_8_.anInt5664)
				...
				System.arraycopy(class456s_3_, 0, Class100.aClass456Array1080,
						0, i_4_);
	...
	static final void method2546(int i) {
		try {
			...
			for (Class298_Sub1 class298_sub1 = ((Class298_Sub1) Class298_Sub1.aClass453_7162
					.method5939(1766612795)); class298_sub1 != null; class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7162
					.method5944(49146))
				Class225.method2099(class298_sub1, true, (byte) 8);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lg.i(").append(')').toString());
		}
	}
