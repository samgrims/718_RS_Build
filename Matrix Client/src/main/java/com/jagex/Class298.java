...
public class Class298 {
	...
	static final void method2841(Class403 class403, int i) {
		try {
			...
			Class298_Sub37_Sub10 class298_sub37_sub10 = (Class300.aClass518_3217
					.method6311(
			...
			int i_1_ = -1;
			for (int i_2_ = 0; i_2_ < -408056823
					* class298_sub37_sub10.anInt9605; i_2_++) {
	...
	static final void method2843(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mk.ajm(").append(')').toString());
		}
	}

	public static Class173 method2844(int i, int i_3_) {
		try {
			Class173 class173 = (Class173) Class173.aClass348_1749
					.method4184((long) i);
			if (class173 != null)
				return class173;
