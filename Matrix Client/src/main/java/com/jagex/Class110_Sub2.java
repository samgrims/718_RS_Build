package com.jagex;/* Class110_Sub2 - Decompiled by JODE
...
public class Class110_Sub2 extends Class110 {
	...
	Class110_Sub2(Class_ra_Sub3_Sub1 class_ra_sub3_sub1, Class108 class108) {
		...
		if (class108.aString1316 != null) {
			...
			if (class108.aClass122Array1319 != null) {
				...
				for (int i = 0; i < class122s.length; i++) {
					...
					stringbuilder.append(new StringBuilder().append("#define ")
							.append(class122.aString1465).append(" ").append(
									class122.aString1464).append('\n')
									.toString());
				}
			}
			stringbuilder.append(new String(class_ra_sub3_sub1
					.method5535(aString6400)));
		...
		if (class108.aString1318 != null) {
			...
			stringbuilder.append(new String(class_ra_sub3_sub1
					.method5535(aString6401)));
			((Class110_Sub2) this).aString8616 = stringbuilder.toString();
		}
		Class425.method5740(((Class110_Sub2) this).anIntArray8612, 0,
				((Class110_Sub2) this).anIntArray8612.length, -1);
	}

	void method1162(Class298_Sub31_Sub1 class298_sub31_sub1, float f,
			float f_0_, float f_1_) {
	...
	void method1176(Class298_Sub31_Sub1 class298_sub31_sub1, float f) {
		...
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f) {
				((Class110_Sub2) this).aFloatArray8621[i] = f;
				if ((class298_sub31_sub1.method3118(33040871) != Class100.aClass100_977)
						&& (class298_sub31_sub1.method3118(-548966323) != Class100.aClass100_1023))
					throw new IllegalArgumentException_Sub1(
							class298_sub31_sub1, "");
	...
	void method1164(Class298_Sub31_Sub1 class298_sub31_sub1, float[] fs, int i) {
		int i_7_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_7_ != -1)
	...
	void method1192(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(1145351512) != Class100.aClass100_963))
	...
	void method1166(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-1304354022) != Class100.aClass100_996))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
	...
	public void b() {
		if (((Class110_Sub2) this).anInt8608 != 0) {
			((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606
			.method5538(((Class110_Sub2) this).anInt8608);
			if (((Class110_Sub2) this).anInt8609 != 0)
				((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606
				.method5531((long) ((Class110_Sub2) this).anInt8609);
			if (((Class110_Sub2) this).anInt8615 != 0)
				((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606
				.method5531((long) ((Class110_Sub2) this).anInt8615);
	...
	void method1204(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(156069945) != Class100.aClass100_996))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform4fv(i, 4, class233.method2173(aFloatArray8614), 0);
	...
	void method1212(Class298_Sub31_Sub1 class298_sub31_sub1, int i,
		...
		int i_18_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_18_ != -1) {
			if (interface9 == null)
			...
			if (i < ((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606.anInt8347) {
				...
				((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606
				.method5358(interface9);
			} else {
				OpenGL.glActiveTexture(33984 + i);
				OpenGL.glBindTexture(
						(((Class263) (Class263) interface9).anInt6415),
						(((Class263) (Class263) interface9).anInt6417));
			}
	...
	public boolean method1209() {
		...
		((Class110_Sub2) this).anInt8609 = method1232(35633,
				((Class110_Sub2) this).aString8620, aString6400);
		((Class110_Sub2) this).anInt8615 = method1232(35632,
				((Class110_Sub2) this).aString8616, aString6401);
		if (((Class110_Sub2) this).anInt8609 == 0
				|| ((Class110_Sub2) this).anInt8615 == 0) {
			if (((Class110_Sub2) this).anInt8609 != 0)
		...
		if (((Class110_Sub2) this).anInt8609 != 0)
			OpenGL.glAttachShader(((Class110_Sub2) this).anInt8608,
					((Class110_Sub2) this).anInt8609);
		if (((Class110_Sub2) this).anInt8615 != 0)
			OpenGL.glAttachShader(((Class110_Sub2) this).anInt8608,
					((Class110_Sub2) this).anInt8615);
		OpenGL.glLinkProgram(((Class110_Sub2) this).anInt8608);
		OpenGL.glGetProgramiv(((Class110_Sub2) this).anInt8608, 35714,
				anIntArray8610, 0);
		if (anIntArray8610[0] == 0) {
			if (((Class110_Sub2) this).anInt8609 != 0) {
				OpenGL.glDetachShader(((Class110_Sub2) this).anInt8608,
						((Class110_Sub2) this).anInt8609);
				OpenGL.glDeleteShader(((Class110_Sub2) this).anInt8609);
			}
			if (((Class110_Sub2) this).anInt8615 != 0) {
		...
		int i = -1;
		for (int i_19_ = 0; i_19_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1328(-1467018991); i_19_++) {
			if (((Class110_Sub2) this).aClass123_Sub2_8607.method1369(i_19_,
					776391021) == this) {
				i = i_19_;
				break;
			}
		...
		int i_20_ = 0;
		int i_21_ = 0;
		for (int i_22_ = 0; i_22_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1323(-1707407208); i_22_++) {
			Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class110_Sub2) this).aClass123_Sub2_8607
					.method1352(i_22_, 444661617);
			if (class298_sub31_sub1 != null) {
				...
				if (class100 == Class100.aClass100_977
						|| class100 == Class100.aClass100_1023
						|| class100 == Class100.aClass100_1049
						|| class100 == Class100.aClass100_995
						|| class100 == Class100.aClass100_1001)
					i_20_ = Math.max(i_23_, i_20_);
				else
					i_21_ = Math.max(i_23_, i_21_);
			}
		}
		for (int i_24_ = 0; i_24_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1350((byte) -98); i_24_++) {
			Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class110_Sub2) this).aClass123_Sub2_8607
					.method1370(i_24_, 1888215794);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
	...
	public boolean method1180() {
		...
		OpenGL.glUseProgram(((Class110_Sub2) this).anInt8608);
		int i = -1;
		for (int i_27_ = 0; i_27_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1328(-1467018991); i_27_++) {
			if (((Class110_Sub2) this).aClass123_Sub2_8607.method1369(i_27_,
					992402337) == this) {
				i = i_27_;
				break;
			}
		...
		int i_28_ = 0;
		int i_29_ = 0;
		for (int i_30_ = 0; i_30_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1323(-392444295); i_30_++) {
			Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class110_Sub2) this).aClass123_Sub2_8607
					.method1352(i_30_, 444661617);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
		...
		for (int i_32_ = 0; i_32_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1350((byte) -19); i_32_++) {
			Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class110_Sub2) this).aClass123_Sub2_8607
					.method1370(i_32_, 1888215794);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
	...
	void method1183(Class298_Sub31_Sub1 class298_sub31_sub1, float f) {
		...
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f) {
				((Class110_Sub2) this).aFloatArray8621[i] = f;
				if ((class298_sub31_sub1.method3118(-1443132322) != Class100.aClass100_977)
						&& (class298_sub31_sub1.method3118(-248781322) != Class100.aClass100_1023))
					throw new IllegalArgumentException_Sub1(
							class298_sub31_sub1, "");
				OpenGL.glUniform1f(i, f);
			}
	...
	void method1207(Class298_Sub31_Sub1 class298_sub31_sub1, float f) {
		...
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f) {
				((Class110_Sub2) this).aFloatArray8621[i] = f;
				if ((class298_sub31_sub1.method3118(1050782678) != Class100.aClass100_977)
						&& (class298_sub31_sub1.method3118(-754995627) != Class100.aClass100_1023))
					throw new IllegalArgumentException_Sub1(
							class298_sub31_sub1, "");
				OpenGL.glUniform1f(i, f);
			}
	...
	void method1167(Class298_Sub31_Sub1 class298_sub31_sub1, int i,
			Interface9 interface9) {
		int i_41_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_41_ != -1) {
			if (interface9 == null)
				interface9 = (((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606.anInterface9_Impl2_8310);
	...
	void method1184(Class298_Sub31_Sub1 class298_sub31_sub1, int i,
			Interface9 interface9) {
		int i_42_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_42_ != -1) {
			if (interface9 == null)
				interface9 = (((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606.anInterface9_Impl2_8310);
	...
	void method1189(Class298_Sub31_Sub1 class298_sub31_sub1, float f,
			float f_47_, float f_48_, float f_49_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f
	...
	Class110_Sub2(Class_ra_Sub3_Sub1 class_ra_sub3_sub1,
			Class123_Sub2 class123_sub2, Class108 class108) {
	...
	void method1178(Class298_Sub31_Sub1 class298_sub31_sub1, float f,
			float f_52_, float f_53_, float f_54_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f
	...
	void method1193(Class298_Sub31_Sub1 class298_sub31_sub1, float f,
			float f_55_, float f_56_, float f_57_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f
	...
	void method1194(Class298_Sub31_Sub1 class298_sub31_sub1, float f,
			float f_58_, float f_59_, float f_60_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f
	...
	void method1177(Class298_Sub31_Sub1 class298_sub31_sub1, float[] fs, int i) {
		int i_61_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_61_ != -1)
	...
	void method1196(Class298_Sub31_Sub1 class298_sub31_sub1, float[] fs, int i) {
		int i_62_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_62_ != -1)
	...
	void method1198(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(205023346) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
	...
	void method1215(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-242428530) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
	...
	void method1200(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-405889299) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
	...
	void method1216(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-12138906) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
	...
	void method1181(Class298_Sub31_Sub1 class298_sub31_sub1, float f) {
		...
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f) {
				((Class110_Sub2) this).aFloatArray8621[i] = f;
				if ((class298_sub31_sub1.method3118(-1085365061) != Class100.aClass100_977)
						&& (class298_sub31_sub1.method3118(37824188) != Class100.aClass100_1023))
					throw new IllegalArgumentException_Sub1(
							class298_sub31_sub1, "");
				OpenGL.glUniform1f(i, f);
			}
	...
	void method1202(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-1779371622) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
	...
	void method1203(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-1672915271) != Class100.aClass100_996))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform4fv(i, 4, class233.method2173(aFloatArray8614), 0);
	...
	void method1187(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(941424226) != Class100.aClass100_996))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform4fv(i, 4, class233.method2173(aFloatArray8614), 0);
	...
	void method1190(Class298_Sub31_Sub1 class298_sub31_sub1, float f) {
		...
		if (i != -1) {
			if (((Class110_Sub2) this).aFloatArray8621[i] != f) {
				((Class110_Sub2) this).aFloatArray8621[i] = f;
				if ((class298_sub31_sub1.method3118(-1630439679) != Class100.aClass100_977)
						&& (class298_sub31_sub1.method3118(-142026573) != Class100.aClass100_1023))
					throw new IllegalArgumentException_Sub1(
							class298_sub31_sub1, "");
				OpenGL.glUniform1f(i, f);
			}
	...
	void method1208(Class298_Sub31_Sub1 class298_sub31_sub1, int i,
			Interface9 interface9) {
		int i_68_ = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1)
				.method3125();
		if (i_68_ != -1) {
			if (interface9 == null)
				interface9 = (((Class110_Sub2) this).aClass_ra_Sub3_Sub1_8606.anInterface9_Impl2_8310);
	...
	void method1197(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(123355562) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
	...
	static {
		aBoolean8622 = !Class110_Sub2.class
	...
	public boolean method1221() {
		...
		OpenGL.glUseProgram(((Class110_Sub2) this).anInt8608);
		int i = -1;
		for (int i_80_ = 0; i_80_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1328(-1467018991); i_80_++) {
			if (((Class110_Sub2) this).aClass123_Sub2_8607.method1369(i_80_,
					1618766328) == this) {
				i = i_80_;
				break;
			}
		...
		int i_81_ = 0;
		int i_82_ = 0;
		for (int i_83_ = 0; i_83_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1323(-851486259); i_83_++) {
			Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class110_Sub2) this).aClass123_Sub2_8607
					.method1352(i_83_, 444661617);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
		...
		for (int i_85_ = 0; i_85_ < ((Class110_Sub2) this).aClass123_Sub2_8607
				.method1350((byte) -85); i_85_++) {
			Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class110_Sub2) this).aClass123_Sub2_8607
					.method1370(i_85_, 1888215794);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
	...
	void method1201(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233) {
		if (!aBoolean8622
				&& (class298_sub31_sub1.method3118(-2072244145) != Class100.aClass100_963))
			throw new AssertionError();
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, class233.method2162(aFloatArray8614), 0);
