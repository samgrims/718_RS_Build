...
public class Class239 {
	...
	Class239(int i, int i_1_, int i_2_) {
		...
		((Class239) this).anIntArrayArrayArray2610 = new int[((Class239) this).anInt2609
				* -431482401][3][i_2_];
	...
	public final int[][][] method2204(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ka.b(").append(')').toString());
		}
	}

	public final int[][] method2205(int i, byte i_4_) {
		try {
			if (1714711935 * ((Class239) this).anInt2608 != ((Class239) this).anInt2609
					* -431482401) {
				if (((Class239) this).anInt2609 * -431482401 != 1) {
					...
					if (class298_sub27 == null) {
						aBoolean2607 = true;
						if (((Class239) this).anInt2612 * -1543676323 >= ((Class239) this).anInt2609
								* -431482401) {
							Class298_Sub27 class298_sub27_5_ = ((Class298_Sub27) ((Class239) this).aClass458_2614
									.method5964(-1469951766));
	...
	static void method2206(Class403 class403, int i) {
		try {
			...
			Class497 class497 = Class92.aClass504_905.method6251(i_7_,
					1588900320);
			if (class497.method6206(1883696427)) {
				...
				if (-1 == i_6_)
					...
					((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751) * -203050393) - 1] = Class316.aClass362_3318
							.method4307(i_6_, 245040087).method4570(i_7_,
									string, 1005518410);
			} else {
				...
				if (i_6_ == -1)
					...
					((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = Class316.aClass362_3318
							.method4307(i_6_, 245040087).method4568(i_7_, i_8_,
									(byte) -64);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ka.o(").append(')').toString());
		}
	}
	...
	static final void method2209(IComponentDefinition class105, Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ka.qr(").append(')').toString());
		}
	}

	public static Class297 method2210(int i, int i_13_, int i_14_, int i_15_,
			int i_16_, int i_17_) {
		try {
			if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7553
					.method5726(-2141800162) != 0
					&& i_13_ != 0
					&& Class300.anInt3213 * -991384187 < 50
					&& -1 != i) {
				Class297 class297 = new Class297((byte) 1, i, i_13_, i_14_,
						i_15_, 0, i_16_, null);
