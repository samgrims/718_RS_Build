			...
			do {
				if (1 == i)
					...
					for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
						anIntArray9599[i_7_] = class298_sub53
								.readUnsignedShort();
						byte i_8_ = class298_sub53.readByte(-12558881);
						aCharArray9595[i_7_] = (0 == i_8_ ? '\0' : Class493
								.method6190(i_8_, 1882768383));
					}
				} else if (i == 3) {
					...
					for (int i_10_ = 0; i_10_ < i_9_; i_10_++) {
						anIntArray9598[i_10_] = class298_sub53
								.readUnsignedShort();
						byte i_11_ = class298_sub53.readByte(-12558881);
						aCharArray9597[i_10_] = (0 == i_11_ ? '\0' : Class493
								.method6190(i_11_, 2133004777));
					}
				} else if (i == 4)
					break;
			} while (false);
		...
		try {
			...
			if (i_13_ == -1)
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = GraphicsToolkit.aClass256_5315
						.method2441(i_12_, -1823486068).method3433(
								(char) i_13_, -446763636);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ain.adt(").append(')').toString());
		}
	}
}
