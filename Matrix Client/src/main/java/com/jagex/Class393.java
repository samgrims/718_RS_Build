...
final class Class393 implements Runnable {
	public void run() {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qg.run(").append(')').toString());
		}
	}

	static final void method4890(Class403 class403, int i) {
		try {
			Class343_Sub1 class343_sub1 = Class365_Sub1_Sub5_Sub2
					.method4537(-1844616011);
			if (class343_sub1 != null) {
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class343_sub1.anInt7717
						* -15394297;
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -877023375
						* class343_sub1.anInt3670;
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = class343_sub1.anInt3666
						* -945794709;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qg.alh(").append(')').toString());
		}
	}

	static final void method4891(IComponentDefinition class105, Class119 class119,
	...
	static synchronized GraphicsToolkit method4892(int i, Canvas canvas,
			Interface_ma interface_ma, Class243 class243, int i_0_, int i_1_,
			int i_2_, int i_3_) {
		try {
			if (i == 0)
				return Class141.method1562(canvas, interface_ma, i_1_, i_2_,
						(byte) 88);
			if (i == 2)
				return Class273.method2563(canvas, interface_ma, i_1_, i_2_,
						(byte) -28);
			if (1 == i)
				return Class59.method696(canvas, interface_ma, i_0_);
			if (5 == i)
				return Class259
						.method2456(canvas, interface_ma, class243, i_0_);
			if (3 == i)
				return Class204
						.method1912(canvas, interface_ma, class243, i_0_);
			throw new IllegalArgumentException("");
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qg.f(").append(')').toString());
		}
	}
	...
	static final void method4893(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1297
					* -407676483;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qg.pl(").append(')').toString());
		}
	}
		...
		try {
			...
			if (0 == i_4_)
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = (int) Math
						.pow((double) i_4_, (double) i_5_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("qg.zb(").append(')').toString());
		}
	}
