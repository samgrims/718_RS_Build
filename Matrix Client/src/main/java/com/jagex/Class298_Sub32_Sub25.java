...
public class Class298_Sub32_Sub25 extends Class298_Sub32 {
	...
	final void method3299(int i, int i_13_, int i_14_) {
		try {
			...
			float f = (float) Math.atan2((double) (i_15_ - 2048),
					(double) (i_16_ - 2048));
			if ((double) f >= -3.141592653589793
				...
				anInt9481 = (Class250.anInt2756 * 461985445 - i_13_)
						* -1258206841;
			} else if (f >= 0.0F && (double) f <= 0.7853981633974483) {
				anInt9479 = (Class250.anInt2755 * -1474554145 - i) * 799198957;
				anInt9481 = -1258206841
						* (461985445 * Class250.anInt2756 - i_13_);
			} else if ((double) f >= 0.7853981633974483
					&& (double) f <= 1.5707963267948966) {
			...
			anInt9479 = 799198957 * (47038181 * anInt9479 & Class250.anInt2753
					* -901777799);
			anInt9481 = (anInt9481 * -927323081 & Class250.anInt2758
					* -289063255)
					* -1258206841;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahn.ac(").append(')').toString());
		}
	}
