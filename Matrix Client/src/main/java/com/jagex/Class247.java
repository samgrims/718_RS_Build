package com.jagex;/* Class247 - Decompiled by JODE
...
public abstract class Class247 {
	...
	Class298_Sub37_Sub16_Sub1 method2338(int i, int i_0_, byte i_1_,
		...
		try {
			...
			if (bool) {
				...
				((Class247) this).aClass461_2736.method5982(
						class298_sub37_sub16_sub1, (byte) -14);
			} else {
				if (method2341(144457290) >= 20)
					throw new RuntimeException();
				((Class247) this).aClass461_2738.method5982(
						class298_sub37_sub16_sub1, (byte) -22);
			}
			return class298_sub37_sub16_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.a(").append(')').toString());
		}
	}
	...
	boolean method2340(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.b(").append(')').toString());
		}
	}

	int method2341(int i) {
		try {
			return (((Class247) this).aClass461_2738.method5986((short) -13891) + ((Class247) this).aClass461_2732
					.method5986((short) -16314));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.p(").append(')').toString());
		}
	}
	...
	boolean method2347(byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.f(").append(')').toString());
		}
	}

	public int method2348(int i) {
		try {
			return (((Class247) this).aClass461_2736.method5986((short) -18478) + ((Class247) this).aClass461_2742
					.method5986((short) -10486));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.i(").append(')').toString());
		}
	}
	...
	static final void decodePlayerUpdate(RsBitsBuffer stream,
			int i, int i_3_) {
		try {
			Class10.anInt139 = 0;
	...
	static final void method2363(IComponentDefinition class105, Class119 class119,
	...
	public static int method2366(Class298_Sub37_Sub15 class298_sub37_sub15,
			byte i) {
		try {
	...
	static final void method2367(Class403 class403, int i) {
		try {
			...
			if (null == class298_sub52) {
				...
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -530122905
						* class298_sub52.anInt7608;
				int i_6_ = (-1740053407 * class298_sub52.anInt7605 << 28
						| (2122110429 * class298_sub52.anInt7607 + Class301.anInt3245) << 14 | (Class301.anInt3238 + -372920341
						* class298_sub52.anInt7610));
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = i_6_;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.adz(").append(')').toString());
		}
	}
	...
	static final void method2369(Class403 class403, int i) {
		try {
			Class390.method4875(Class_na.method3476(1476588124), class403,
					(byte) 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ki.uh(").append(')').toString());
		}
	}
	...
	static final void method2374(Class403 class403, int i) {
		try {
			...
			int i_24_ = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587
					.method5726(-2143149199);
			if (i_23_ != i_24_
					&& (Class300.anInt3210 * 782166935 == Class300.anInt3207
							* -1256171511)) {
				if (!Class435.method5804(client.anInt8752 * -1233866115,
						(byte) 33)) {
					if (0 == i_24_) {
						Class477.method6096(Class374_Sub1.aClass243_7731,
								-1256171511 * Class300.anInt3207, 0, i_23_,
								false, -2072200222);
				...
				Class422_Sub25.aClass298_Sub48_8425
						.method3540(
								Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7587,
								i_23_, -1422708524);
