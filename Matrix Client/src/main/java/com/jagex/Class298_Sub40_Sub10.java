...
public class Class298_Sub40_Sub10 extends Class298_Sub40 {
	...
	void method3509(RsByteBuffer class298_sub53) {
		((Class298_Sub40_Sub10) this).anInt9721 = class298_sub53
				.readUnsignedShort() * 703557345;
		((Class298_Sub40_Sub10) this).anInt9719 = class298_sub53
				.readInt((byte) -17)
				* -2070878551;
		((Class298_Sub40_Sub10) this).anInt9718 = class298_sub53
				.readUnsignedByte() * 1472973945;
		((Class298_Sub40_Sub10) this).anInt9720 = class298_sub53
				.readUnsignedByte()
				* -2026849051;
	}
	...
	void method3510(ClanSettings class162, byte i) {
		try {
			class162.method1767(
					((Class298_Sub40_Sub10) this).anInt9721 * 1553093921,
					1564286361 * ((Class298_Sub40_Sub10) this).anInt9719,
					-549921335 * ((Class298_Sub40_Sub10) this).anInt9718,
					-815095571 * ((Class298_Sub40_Sub10) this).anInt9720,
					1468096534);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agp.f(").append(')').toString());
		}
	}
	...
	static final void method3515(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("agp.aiz(").append(')').toString());
		}
	}
}
