package com.jagex;/* Class251 - Decompiled by JODE
...
public class Class251 {
	...
	static final void method2405(Class403 class403, int i) {
		try {
			...
			if (i_1_ + 1 >= (client.anIntArrayArrayArray8767[-591434031
					* client.anInt8768]).length >> 1)
				throw new RuntimeException();
			...
			if (1 + i_3_ >= (client.anIntArrayArrayArray8767[-839811113
					* client.anInt8769]).length >> 1)
				throw new RuntimeException();
	...
	static final void method2407(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557
					.method5612(i_10_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("km.aor(").append(')').toString());
		}
	}
		...
		try {
			...
			Class344
					.method4165(
							...
							(((Class403) class403).anIntArray5244[1 + (681479919 * ((Class403) class403).anInt5239)]),
							0, -1721946915);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("km.agz(").append(')').toString());
		}
	}
}
