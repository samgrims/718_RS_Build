...
public class Class298_Sub32_Sub34 extends Class298_Sub32 {
		...
		try {
			if (993272049 * ((Class298_Sub32_Sub34) this).anInt9544 > 0) {
				...
				for (int i_0_ = 0; (i_0_ < 832987241 * ((Class298_Sub32_Sub34) this).anInt9547); i_0_++) {
					((Class298_Sub32_Sub34) this).aShortArray9540[i_0_] = (short) (int) ((Math
							.pow(
									(double) ((float) (993272049 * (((Class298_Sub32_Sub34) this).anInt9544)) / 4096.0F),
									(double) i_0_)) * 4096.0);
					((Class298_Sub32_Sub34) this).aShortArray9541[i_0_] = (short) (int) Math
							.pow(2.0, (double) i_0_);
				}
			} else if (((Class298_Sub32_Sub34) this).aShortArray9540 != null
					&& (((Class298_Sub32_Sub34) this).anInt9547 * 832987241 == (((Class298_Sub32_Sub34) this).aShortArray9540).length)) {
				((Class298_Sub32_Sub34) this).aShortArray9541 = (new short[((Class298_Sub32_Sub34) this).anInt9547 * 832987241]);
				for (int i_1_ = 0; (i_1_ < ((Class298_Sub32_Sub34) this).anInt9547 * 832987241); i_1_++)
					((Class298_Sub32_Sub34) this).aShortArray9541[i_1_] = (short) (int) Math
							.pow(2.0, (double) i_1_);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahw.bd(").append(')').toString());
		}
	}

	int method3355(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_,
			int i_7_) {
		try {
			int i_8_ = i >> 12;
			int i_9_ = 1 + i_8_;
			...
			int i_13_ = (((Class298_Sub32_Sub34) this).aByteArray9542[i_8_
					+ i_3_] & 0x3);
			int i_14_;
			if (i_13_ <= 1)
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_18_) {
		try {
			switch (i) {
			case 2:
				((Class298_Sub32_Sub34) this).anInt9544 = class298_sub53
						.readShort(1683252364) * 52875281;
				if (993272049 * ((Class298_Sub32_Sub34) this).anInt9544 < 0) {
					((Class298_Sub32_Sub34) this).aShortArray9540 = new short[832987241 * (((Class298_Sub32_Sub34) this).anInt9547)];
					for (int i_19_ = 0; i_19_ < (832987241 * ((Class298_Sub32_Sub34) this).anInt9547); i_19_++)
						((Class298_Sub32_Sub34) this).aShortArray9540[i_19_] = (short) class298_sub53
								.readShort(2045257879);
				}
				break;
			case 1:
				((Class298_Sub32_Sub34) this).anInt9547 = class298_sub53
						.readUnsignedByte()
						* -1820512295;
				break;
			case 0:
				((Class298_Sub32_Sub34) this).aBoolean9548 = class298_sub53
						.readUnsignedByte() == 1;
				break;
			case 5:
				((Class298_Sub32_Sub34) this).anInt9546 = class298_sub53
						.readUnsignedByte() * 1143174821;
				break;
			case 4:
				((Class298_Sub32_Sub34) this).anInt9543 = class298_sub53
						.readUnsignedByte()
						* -1333197873;
				break;
			case 6:
				((Class298_Sub32_Sub34) this).anInt9545 = class298_sub53
						.readUnsignedByte() * 2124139087;
				break;
			case 3:
				((Class298_Sub32_Sub34) this).anInt9546 = ((((Class298_Sub32_Sub34) this).anInt9545 = class298_sub53
						.readUnsignedByte() * 2124139087) * -1849370933);
				break;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahw.r(").append(')').toString());
		}
	}
	...
	void method3356(int i, int[] is, int i_20_) {
		try {
			...
			if (((Class298_Sub32_Sub34) this).anInt9547 * 832987241 == 1) {
				...
				int i_24_ = (i_23_
						* (((Class298_Sub32_Sub34) this).anInt9545 * 963316911) >> 12);
				int i_25_ = (i_23_
						* (((Class298_Sub32_Sub34) this).anInt9546 * 1428128045) >> 12);
				...
				if (((Class298_Sub32_Sub34) this).aBoolean9548) {
					for (int i_32_ = 0; i_32_ < -1474554145
							* Class250.anInt2755; i_32_++) {
						int i_33_ = (1428128045 * ((Class298_Sub32_Sub34) this).anInt9546 * Class250.anIntArray2762[i_32_]);
						int i_34_ = method3355(i_23_ * i_33_ >> 12, i_26_,
								i_30_, i_31_, i_29_, i_25_, 1556942442);
						i_34_ = i_34_ * i_22_ >> 12;
						is[i_32_] = (i_34_ >> 1) + 2048;
					}
				} else {
					for (int i_35_ = 0; i_35_ < Class250.anInt2755
							* -1474554145; i_35_++) {
						int i_36_ = (((Class298_Sub32_Sub34) this).anInt9546 * 1428128045 * Class250.anIntArray2762[i_35_]);
						int i_37_ = method3355(i_36_ * i_23_ >> 12, i_26_,
								i_30_, i_31_, i_29_, i_25_, 1069393603);
				...
				if (i_38_ > 8 || i_38_ < -8) {
					...
					for (int i_48_ = 0; i_48_ < -1474554145
							* Class250.anInt2755; i_48_++) {
						int i_49_ = (1428128045 * ((Class298_Sub32_Sub34) this).anInt9546 * Class250.anIntArray2762[i_48_]);
						int i_50_ = method3355(i_49_ * i_39_ >> 12, i_42_,
								i_46_, i_47_, i_45_, i_41_, 818948604);
				...
				for (int i_51_ = 1; (i_51_ < 832987241 * ((Class298_Sub32_Sub34) this).anInt9547); i_51_++) {
					...
					if (i_38_ > 8 || i_38_ < -8) {
						...
						if (((Class298_Sub32_Sub34) this).aBoolean9548
								&& i_51_ == (((Class298_Sub32_Sub34) this).anInt9547) * 832987241 - 1) {
							for (int i_61_ = 0; i_61_ < -1474554145
									* Class250.anInt2755; i_61_++) {
								int i_62_ = (Class250.anIntArray2762[i_61_] * (1428128045 * (((Class298_Sub32_Sub34) this).anInt9546)));
								int i_63_ = method3355(i_62_ * i_52_ >> 12,
										i_55_, i_59_, i_60_, i_58_, i_54_,
										2029664133);
								i_63_ = is[i_61_] + (i_63_ * i_38_ >> 12);
								is[i_61_] = (i_63_ >> 1) + 2048;
							}
						} else {
							for (int i_64_ = 0; i_64_ < Class250.anInt2755
									* -1474554145; i_64_++) {
								int i_65_ = (Class250.anIntArray2762[i_64_] * (1428128045 * (((Class298_Sub32_Sub34) this).anInt9546)));
								int i_66_ = method3355(i_52_ * i_65_ >> 12,
										i_55_, i_59_, i_60_, i_58_, i_54_,
										1960253122);
	...
	void method3357(int i, RsByteBuffer class298_sub53) {
		...
		case 2:
			((Class298_Sub32_Sub34) this).anInt9544 = class298_sub53
					.readShort(2118380070) * 52875281;
			if (993272049 * ((Class298_Sub32_Sub34) this).anInt9544 < 0) {
				((Class298_Sub32_Sub34) this).aShortArray9540 = (new short[832987241 * ((Class298_Sub32_Sub34) this).anInt9547]);
				for (int i_67_ = 0; (i_67_ < 832987241 * ((Class298_Sub32_Sub34) this).anInt9547); i_67_++)
					((Class298_Sub32_Sub34) this).aShortArray9540[i_67_] = (short) class298_sub53
							.readShort(1991735410);
			}
			break;
		case 1:
			((Class298_Sub32_Sub34) this).anInt9547 = class298_sub53
	...
	int[] method3131(int i, int i_68_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahw.i(").append(')').toString());
		}
	}

	void method3358() {
		((Class298_Sub32_Sub34) this).aByteArray9542 = Class250.method2395(
				(((Class298_Sub32_Sub34) this).anInt9543 * -1656937681),
				(byte) 20);
	...
	void method3361(int i, RsByteBuffer class298_sub53) {
		...
		case 2:
			((Class298_Sub32_Sub34) this).anInt9544 = class298_sub53
					.readShort(2106445483) * 52875281;
			if (993272049 * ((Class298_Sub32_Sub34) this).anInt9544 < 0) {
				((Class298_Sub32_Sub34) this).aShortArray9540 = (new short[832987241 * ((Class298_Sub32_Sub34) this).anInt9547]);
				for (int i_72_ = 0; (i_72_ < 832987241 * ((Class298_Sub32_Sub34) this).anInt9547); i_72_++)
					((Class298_Sub32_Sub34) this).aShortArray9540[i_72_] = (short) class298_sub53
							.readShort(1806711607);
			}
			break;
		case 1:
			((Class298_Sub32_Sub34) this).anInt9547 = class298_sub53
	...
	static final void method3364(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1285 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahw.ng(").append(')').toString());
		}
	}
}
