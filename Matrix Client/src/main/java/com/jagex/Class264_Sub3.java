package com.jagex;/* Class264_Sub3 - Decompiled by JODE
...
public class Class264_Sub3 extends Class264 {
	...
	void g(char c, int i, int i_0_, int i_1_, boolean bool) {
		...
		((Class264_Sub3) this).aClass_ra_Sub2_7129
				.method5256(((Class264_Sub3) this).aClass30_Sub2_Sub1_7128);
		if (((Class264_Sub3) this).aBoolean7131 || bool) {
			((Class264_Sub3) this).aClass_ra_Sub2_7129.method5258(7681, 8448);
			((Class264_Sub3) this).aClass_ra_Sub2_7129
					.method5259(0, 34168, 768);
		} else
	...
	void method2489(char c, int i, int i_2_, int i_3_, boolean bool,
			Class_ta class_ta, int i_4_, int i_5_) {
		...
		OpenGL.glTexGenfv(8192, 9474, new float[] { f, 0.0F, 0.0F,
				(float) -i_4_ * f }, 0);
		OpenGL.glTexGenfv(8193, 9474, new float[] { 0.0F, f_6_, 0.0F,
				(float) -i_5_ * f_6_ }, 0);
	...
	void method2486(char c, int i, int i_7_, int i_8_, boolean bool,
		...
		OpenGL.glTexGenfv(8192, 9474, new float[] { f, 0.0F, 0.0F,
				(float) -i_9_ * f }, 0);
		OpenGL.glTexGenfv(8193, 9474, new float[] { 0.0F, f_11_, 0.0F,
				(float) -i_10_ * f_11_ }, 0);
		OpenGL.glEnable(3168);
		OpenGL.glEnable(3169);
	...
	Class264_Sub3(Class_ra_Sub2 class_ra_sub2, Class505 class505,
		...
		if (bool) {
			...
			((Class264_Sub3) this).aClass30_Sub2_Sub1_7128 = Class30_Sub2_Sub1
					.method428(class_ra_sub2, Class55.aClass55_567,
							Class77.aClass77_717, i_17_, i_17_, false, is,
			...
			((Class264_Sub3) this).aClass30_Sub2_Sub1_7128 = Class30_Sub2_Sub1
					.method425(class_ra_sub2, i_17_, i_17_, false, is, 0, 0);
		...
		for (int i_47_ = 0; i_47_ < 256; i_47_++) {
			...
			OpenGL
					.glTexCoord2f(
							f_54_,
							(((Class30_Sub2_Sub1) (((Class264_Sub3) this).aClass30_Sub2_Sub1_7128)).aFloat9051 - f_55_));
			OpenGL.glVertex2i(i_51_, i_50_);
			OpenGL
					.glTexCoord2f(
							f_54_,
							(((Class30_Sub2_Sub1) (((Class264_Sub3) this).aClass30_Sub2_Sub1_7128)).aFloat9051 - f_57_));
