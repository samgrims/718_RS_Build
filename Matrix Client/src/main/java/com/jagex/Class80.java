...
public class Class80 {
	...
	public static Class158 method853(RsByteBuffer class298_sub53, short i) {
		try {
			...
			Class139 class139 = (Class491.method6176((byte) 44)[class298_sub53
					.readUnsignedByte()]);
			Class133 class133 = (Class113.method1255(126968516)[class298_sub53
					.readUnsignedByte()]);
	...
	static final void method854(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class105.height * 457937409;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("df.qn(").append(')').toString());
		}
	}

	static final void method855(byte i) {
		try {
			for (Class302_Sub5 class302_sub5 = ((Class302_Sub5) client.aClass442_8781
					.method5871((byte) 3)); null != class302_sub5; class302_sub5 = ((Class302_Sub5) client.aClass442_8781
					.method5871((byte) 3)))
	...
	static final void method856(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = string.substring(i_18_, i_19_);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("df.aas(").append(')').toString());
		}
	}
}
