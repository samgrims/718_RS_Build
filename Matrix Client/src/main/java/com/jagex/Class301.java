...
public class Class301 {
	...
	static void method3689(GraphicsToolkit class_ra, int i, int i_0_, int i_1_,
			int i_2_) {
			...
			if (i_8_ > 0) {
				...
				if (i_9_ < 0 || i_9_ >= anInt3239) {
					for (int i_10_ = 0; i_10_ < i_4_; i_10_++) {
						int i_11_ = anInt3257
								- (i_2_ + i_0_ * (i_10_ + 1) >> 16);
						int i_12_ = anInt3257 - (i_2_ + i_0_ * i_10_ >> 16);
						int i_13_ = i_12_ - i_11_;
						int i_14_;
						if (((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639
								* -717907215 != -1)
							i_14_ = ~0xffffff
									| (((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639)
									* -717907215;
						...
						if (i_18_ > 0) {
							...
							if (i_21_ == 0 && i_22_ == 0 && object == null) {
								if ((((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639 * -717907215) != -1)
									i_21_ = (~0xffffff | (((MapDetails) aClass298_Sub37_Sub13_3218).anInt9639)
											* -717907215);
								else if ((i_5_ + anInt3230 & 0x4) != (i_15_
										+ anInt3241 & 0x4))
									i_21_ = -11840664;
								else
								...
								if (object instanceof Class298_Sub54) {
									...
									if (class298_sub54 != null)
										method3700(
												...
												i_21_,
												i_22_,
												aByteArray3246[i_20_],
												(((Class298_Sub54) class298_sub54).anIntArray7621),
												(((Class298_Sub54) class298_sub54).aByteArray7620),
												true);
								} else {
									Integer integer = (Integer) object;
									anIntArray3231[0] = integer.intValue();
									aByteArray3232[0] = aByteArray3250[i_20_];
									method3700(class_ra, i_6_, i_16_, i_8_,
											i_18_, i_21_, i_22_,
											aByteArray3246[i_20_],
											anIntArray3231, aByteArray3232,
											true);
								}
							} else
								method3700(class_ra, i_6_, i_16_, i_8_, i_18_,
										i_21_, i_22_, aByteArray3246[i_20_],
										null, null, true);
						}
					}
				}
							...
							if (i_32_ >= 0 && i_32_ < anInt3240) {
								...
								if (object != null) {
									if (object instanceof Class298_Sub54) {
										...
										Integer integer = (Integer) object;
										anIntArray3231[0] = integer.intValue();
										aByteArray3232[0] = (aByteArray3250[i_27_
												+ i_32_ * anInt3239]);
										method3701(class_ra, i_24_, i_29_,
												i_26_, i_31_, anIntArray3231,
												aByteArray3232);
									}
								} else
									method3701(class_ra, i_24_, i_29_, i_26_,
											i_31_, null, null);
							}
						}
					}
				...
				for (int i_39_ = i_34_; i_39_ <= i_36_; i_39_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							...
							int i_42_ = (i_40_
									+ ((Class312) class312).aByte3292
									- anInt3245 - anInt3230);
							int i_43_ = (i_41_
									+ ((Class312) class312).aByte3293
									- anInt3238 - anInt3242);
							int i_44_ = (i_1_ + i * i_42_ >> 16) + anInt3221;
							int i_45_ = (i_1_ + i * (i_42_ + 1) >> 16)
									+ anInt3221;
							int i_46_ = (anInt3257 - (i_2_ + i_0_ * (i_43_ + 1) >> 16));
							int i_47_ = anInt3257 - (i_2_ + i_0_ * i_43_ >> 16);
							method3700(class_ra, i_44_, i_46_, i_45_ - i_44_,
									i_47_ - i_46_,
									((Class312) class312).anInt3290,
									((Class312) class312).aByte3291 & 0xff,
									((Class312) class312).aByte3294,
									((Class312) class312).anIntArray3288,
									((Class312) class312).aByteArray3289, false);
						}
					}
				}
			}
				...
				for (int i_49_ = i_34_; i_49_ <= i_36_; i_49_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							...
							int i_55_ = (i_1_ + i * (i_52_ + 1) >> 16)
									+ anInt3221;
							int i_56_ = (anInt3257 - (i_2_ + i_0_ * (i_53_ + 1) >> 16));
							int i_57_ = anInt3257 - (i_2_ + i_0_ * i_53_ >> 16);
							method3701(class_ra, i_54_, i_56_, i_55_ - i_54_,
									i_57_ - i_56_,
									((Class312) class312).anIntArray3288,
									((Class312) class312).aByteArray3289);
						}
					}
				}
			}
	...
	public static void method3690(Class243 class243, Class375 class375,
			Class451 class451, Class433 class433, Class339 class339,
			Class487 class487, Interface23 interface23) {
	...
	public static Class461 method3693(int i, int i_59_) {
		...
		for (MapDetails class298_sub37_sub13 = ((MapDetails) aClass437_3226
				.method5816(1759050770)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) aClass437_3226
				.method5815((byte) -2))) {
			if (((MapDetails) class298_sub37_sub13).aBoolean9648
					&& class298_sub37_sub13.method3450(i, i_59_, (byte) 1))
	...
	static int method3694(Interface_ma interface_ma, int i, int i_60_, int i_61_) {
		...
		if (class373.anInt4059 * 1728947183 >= 0) {
			...
			i_63_ = (~0xffffff | (Class379.anIntArray4096[Class173.method1823(
					Class343.method4161(i_66_, 96, (byte) 86), (byte) 0) & 0xffff]));
		} else if (i_62_ >= 0)
			i_63_ = (~0xffffff | (Class379.anIntArray4096[Class173.method1823(
					Class343.method4161((interface_ma.method174(i_62_,
							201088475).aShort532), 96, (byte) 61), (byte) 0) & 0xffff]));
			...
			i_63_ = (~0xffffff | (Class379.anIntArray4096[Class173.method1823(
					Class343.method4161(i_69_, 96, (byte) 22), (byte) 0) & 0xffff]));
		}
		return i_63_;
	}

	static void method3695(GraphicsToolkit class_ra, RsByteBuffer class298_sub53,
			int i, int i_70_, int i_71_, int i_72_, int[] is, int[] is_73_) {
		...
		if ((i_74_ & 0x1) == 0) {
			...
			if (i_75_ != 62) {
				...
				if (bool) {
					...
					aByteArray3224[i_71_ + i_72_ * anInt3239] = class298_sub53
							.readByte(-12558881);
				}
			}
		} else {
			...
			for (int i_78_ = 0; i_78_ < i_76_; i_78_++) {
				...
				if (i_78_ == 0) {
					...
					if (i_82_ == 1) {
						anObjectArray3247[i_71_ + i_72_ * anInt3239] = new Integer(
								class298_sub53.readBigSmart(1235052657));
						aByteArray3250[i_71_ + i_72_ * anInt3239] = class298_sub53
								.readByte(-12558881);
					} else if (i_82_ > 1) {
						int[] is_83_ = new int[i_82_];
						byte[] is_84_ = new byte[i_82_];
						for (int i_85_ = 0; i_85_ < i_82_; i_85_++) {
							is_83_[i_85_] = class298_sub53
									.readBigSmart(1235052657);
							is_84_[i_85_] = class298_sub53
									.readByte(-12558881);
						}
						anObjectArray3247[i_71_ + i_72_ * anInt3239] = new Class298_Sub54(
								is_83_, is_84_);
					}
				} else {
					int[] is_86_ = null;
					...
					if (i_82_ > 0) {
						...
						for (int i_88_ = 0; i_88_ < i_82_; i_88_++) {
							is_86_[i_88_] = class298_sub53
									.readBigSmart(1235052657);
							is_87_[i_88_] = class298_sub53
									.readByte(-12558881);
						}
					}
					if ((anArrayListArrayArrayArray3249[i_78_ - 1][i
							- (anInt3245 >> 6)][i_70_ - (anInt3238 >> 6)]) == null)
						anArrayListArrayArrayArray3249[i_78_ - 1][i
								- (anInt3245 >> 6)][i_70_ - (anInt3238 >> 6)] = new ArrayList();
					Class312 class312 = new Class312(i_71_ & 0x3f,
							i_72_ & 0x3f, i_79_, i_80_, i_81_, is_86_, is_87_);
					anArrayListArrayArrayArray3249[i_78_ - 1][i
							- (anInt3245 >> 6)][i_70_ - (anInt3238 >> 6)]
							.add(class312);
				}
			}
		}
	...
	static void method3696(byte[] is, byte[] is_89_, short[] is_90_, int i,
			int i_91_) {
		...
		for (int i_97_ = -5; i_97_ < anInt3239; i_97_++) {
			...
			for (int i_100_ = 0; i_100_ < anInt3240; i_100_++) {
				if (i_98_ < anInt3239) {
					...
					if (i_101_ > 0) {
						Class443 class443 = aClass451_3219.method5932(
								i_101_ - 1, (byte) -1);
				...
				for (int i_108_ = -5; i_108_ < anInt3240; i_108_++) {
					...
					if (i_108_ >= 0 && i_107_ > 0) {
						if ((is[i_97_ + i_108_ * anInt3239] & 0xff) == 0) {
							...
							int i_112_ = (i_106_ == 0 ? 0 : Class401
									.method4933(i_103_ * 256 / i_106_, i_104_
											/ i_107_, i_105_ / i_107_,
											-235005806));
							...
							if (i_113_ < 0)
								...
								i_113_ = 127;
							int i_114_ = ((i_112_ + i & 0xfc00)
									+ (i_112_ & 0x380) + i_113_);
							int i_115_ = i_97_ + i_108_ * anInt3239;
							int i_116_ = (Class379.anIntArray4096[(Class173
									.method1823(Class290.method2749(i_114_, 96,
											1291456097), (byte) 0)) & 0xffff]);
	...
	static void method3697() {
		...
		for (int i = 0; i < aClass296_3235.anInt3169 * -1407078377; i++) {
			boolean bool = (aClass298_Sub37_Sub13_3218.method3453(
					aClass296_3235.anIntArray3168[i] >> 28 & 0x3,
					aClass296_3235.anIntArray3168[i] >> 14 & 0x3fff,
					aClass296_3235.anIntArray3168[i] & 0x3fff, is, 1112796822));
			if (bool) {
				Class298_Sub52 class298_sub52 = new Class298_Sub52(
						aClass296_3235.anIntArray3170[i]);
	...
	static void method3699(GraphicsToolkit class_ra, int i, int i_120_) {
		RsByteBuffer class298_sub53 = new RsByteBuffer(aClass243_3248
				.method2301(aClass298_Sub37_Sub13_3218.aString9640, "area",
						-1304297711));
			...
			if (class298_sub53.readUnsignedByte() == 0) {
				...
				for (int i_128_ = 0; i_128_ < 64; i_128_++) {
					for (int i_129_ = 0; i_129_ < 64; i_129_++) {
						...
						method3695(class_ra, class298_sub53, i_126_, i_127_,
								i_130_, i_131_, is, is_124_);
					}
				}
			} else {
				...
				for (int i_136_ = 0; i_136_ < 8; i_136_++) {
					for (int i_137_ = 0; i_137_ < 8; i_137_++) {
						int i_138_ = i_132_ * 64 + i_134_ * 8 + i_136_
								- anInt3245;
						int i_139_ = i_133_ * 64 + i_135_ * 8 + i_137_
								- anInt3238;
						method3695(class_ra, class298_sub53, i_132_, i_133_,
								i_138_, i_139_, is, is_124_);
					}
				}
			}
		}
				...
				for (int i_143_ = 0; i_143_ < anArrayListArrayArrayArray3249[i_140_][0].length; i_143_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							is_141_[(i_142_ * 64
									+ ((Class312) class312).aByte3292 + ((i_143_ * 64 + ((Class312) class312).aByte3293) * anInt3239))] = (byte) ((Class312) class312).anInt3290;
						}
					}
				}
			}
			...
			for (int i_144_ = 0; i_144_ < anArrayListArrayArrayArray3249[i_140_].length; i_144_++) {
				for (int i_145_ = 0; i_145_ < anArrayListArrayArrayArray3249[i_140_][0].length; i_145_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_146_ = (i_144_ * 64
									+ ((Class312) class312).aByte3292 + ((i_145_ * 64 + ((Class312) class312).aByte3293) * anInt3239));
	...
	static void method3700(GraphicsToolkit class_ra, int i, int i_147_, int i_148_,
			int i_149_, int i_150_, int i_151_, int i_152_, int[] is,
			byte[] is_153_, boolean bool) {
		if (bool || i_150_ != 0 || i_151_ > 0) {
			if (i_151_ == 0)
				...
				if (i_154_ == 0 || i_148_ <= 1 || i_149_ <= 1) {
					...
					int i_156_ = bool ? 0 : 1;
					Class252.method2409(class_ra, aByteArrayArrayArray3229,
							anInt3254, i, i_147_, i_150_,
							anIntArray3237[i_151_], i_148_, i_149_, i_154_,
							i_152_ >> 6 & 0x3, i_156_, (byte) 127);
				}
			}
		}
		if (is != null) {
						...
						if (i_160_ == (GameObjectType.aClass424_6614.anInt6613 * -1976050083)) {
							...
							if (i_162_ == 0 || i_162_ == 2) {
								...
								for (int i_164_ = 0; i_164_ < i_149_; i_164_++)
									class_ra.XA(i + i_164_, i_147_ + i_164_, 1,
											i_161_, 0);
							}
						}
					}
	...
	static void method3701(GraphicsToolkit class_ra, int i, int i_165_, int i_166_,
			int i_167_, int[] is, byte[] is_168_) {
		if (is != null) {
			for (int i_169_ = 0; i_169_ < is.length; i_169_++) {
				...
				if (i_170_ != -1) {
					Class496 class496 = aClass487_3225.method6159(i_170_,
							-2130050645);
					Class57 class57 = class496.method6198(class_ra,
							(class432.aBoolean5401 ? is_168_[i_169_] >> 6 & 0x3
									: 0),
							(class432.aBoolean5440 ? class432.aBoolean5404
									: false), (byte) -47);
					if (class57 != null) {
						...
						if (i_171_ != 0 && i_172_ != 0) {
							if (class496.anInt6096 * -2012904123 != 0)
								class57
										.method634(
												i,
												i_165_ - i_172_ + i_167_,
												i_171_,
												i_172_,
												0,
												(~0xffffff | (class496.anInt6096 * -2012904123)),
												1);
							else
								class57.method633(i, i_165_ - i_172_ + i_167_,
										i_171_, i_172_);
						}
					}
				}
	...
	static Class453 method3703(GraphicsToolkit class_ra, int i, int i_179_,
			int i_180_, int i_181_) {
		for (Class298_Sub52 class298_sub52 = (Class298_Sub52) aClass453_3236
				.method5939(1766612795); class298_sub52 != null; class298_sub52 = (Class298_Sub52) aClass453_3236
				.method5944(49146))
			method3704(class_ra, class298_sub52, i, i_179_, i_180_, i_181_);
		return aClass453_3236;
	}

	static void method3704(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52,
			int i, int i_182_, int i_183_, int i_184_) {
		class298_sub52.anInt7609 = (anInt3221 + (i_183_ + i
				* (class298_sub52.anInt7607 * 2122110429 - anInt3230) >> 16))
				* -1722635483;
		class298_sub52.anInt7606 = (anInt3257 - (i_184_ + i_182_
				* (class298_sub52.anInt7610 * -372920341 - anInt3242) >> 16))
				* -283355805;
	}
	...
	static void method3707(Interface_ma interface_ma, int i, int i_185_) {
		for (int i_186_ = 0; i_186_ < aClass375_3253.anInt4081 * 138682397; i_186_++)
			anIntArray3237[i_186_ + 1] = method3694(interface_ma, i_186_, i,
					i_185_);
	}

	public static MapDetails method3708(int i, int i_187_) {
		for (MapDetails class298_sub37_sub13 = ((MapDetails) aClass437_3226
				.method5816(1588897265)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) aClass437_3226
				.method5815((byte) -24))) {
			if (((MapDetails) class298_sub37_sub13).aBoolean9648
					&& class298_sub37_sub13.method3450(i, i_187_, (byte) -105))
				return class298_sub37_sub13;
		}
		return null;
	}

	static void method3709(int i, int i_188_, int i_189_, int i_190_,
					...
					if (object instanceof Class298_Sub54) {
						...
						if (class298_sub54 != null) {
							for (int i_196_ = 0; i_196_ < (((Class298_Sub54) class298_sub54).anIntArray7621).length; i_196_++) {
								ObjectDefinitions class432 = (aClass433_3220
										.getObjectDefinitions(
												(((Class298_Sub54) class298_sub54).anIntArray7621[i_196_])));
								int i_197_ = class432.anInt5399 * -1422593103;
								if (class432.anIntArray5366 != null) {
									class432 = (class432.method5777(
											anInterface23_3223, 2117091255));
									if (class432 != null)
										i_197_ = class432.anInt5399
												* -1422593103;
								}
								if (i_197_ != -1) {
									Class298_Sub52 class298_sub52 = new Class298_Sub52(
									...
									class298_sub52.anInt7610 = i_195_
											* -1686044477;
									aClass453_3236.method5935(class298_sub52,
											2035193574);
								}
							}
						}
						...
						while (iterator.hasNext()) {
							...
							if (((Class312) class312).anIntArray3288 != null) {
								for (int i_201_ = 0; i_201_ < (((Class312) class312).anIntArray3288).length; i_201_++) {
									ObjectDefinitions class432 = (aClass433_3220
											.getObjectDefinitions(
													(((Class312) class312).anIntArray3288[i_201_])));
									int i_202_ = class432.anInt5399
											* -1422593103;
									if (class432.anIntArray5366 != null) {
										class432 = (class432.method5777(
												anInterface23_3223, 984911486));
										if (class432 != null)
									...
									if (i_202_ != -1) {
										Class298_Sub52 class298_sub52 = new Class298_Sub52(
												i_202_);
										class298_sub52.anInt7607 = ((i_199_ + (anInt3245 >> 6))
												* 64
												+ (((Class312) class312).aByte3292) - anInt3245) * 898378357;
										class298_sub52.anInt7610 = ((i_200_ + (anInt3238 >> 6))
												* 64
												+ (((Class312) class312).aByte3293) - anInt3238)
												* -1686044477;
										aClass453_3236.method5935(
												class298_sub52, 1574718042);
									}
								}
							}
						}
	...
	static void method3711(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52,
			Class352 class352) {
		if (class352.anIntArray3803 != null) {
			...
			for (int i = 0; i < is.length / 2; i++) {
				...
				int i_204_ = (class352.anIntArray3803[i * 2 + 1] + class298_sub52.anInt7610
						* -372920341);
				is[i * 2] = anInt3221
						+ ((anInt3256 - anInt3221) * (i_203_ - anInt3230) / (anInt3252 - anInt3230));
				is[i * 2 + 1] = anInt3257
						- ((anInt3257 - anInt3255) * (i_204_ - anInt3242) / (anInt3241 - anInt3242));
			}
			...
			if (class352.anInt3806 * -972644285 > 0) {
				for (int i = 0; i < is.length / 2 - 1; i++) {
					...
					class_ra
							.method5039(
									...
									i_207_,
									i_208_,
									(class352.anIntArray3814[class352.aByteArray3777[i] & 0xff]),
									1, class352.anInt3806 * -972644285,
									class352.anInt3799 * 2123190239,
									class352.anInt3788 * -176015499);
				}
				...
				class_ra
						.method5039(
								...
								i_213_,
								i_214_,
								(class352.anIntArray3814[((class352.aByteArray3777[class352.aByteArray3777.length - 1]) & 0xff)]),
								1, class352.anInt3806 * -972644285,
								class352.anInt3799 * 2123190239,
								class352.anInt3788 * -176015499);
			} else {
