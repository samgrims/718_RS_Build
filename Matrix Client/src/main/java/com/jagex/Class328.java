...
public class Class328 {
	...
	Class328(Class331 class331, int i, int i_0_, int i_1_, int i_2_, int i_3_,
		...
		((Class328) this).aShort3487 = (short) (i_1_ >> -1688804109
				* class331.anInt3504);
		((Class328) this).aShort3481 = (short) (i_3_ >> -1688804109
				* class331.anInt3504);
		((Class328) this).aShort3480 = (short) (i_9_ >> -1688804109
				* class331.anInt3504);
		((Class328) this).aShort3483 = (short) (i_11_ >> class331.anInt3504
				* -1688804109);
	...
	static final void method3985(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nr.kz(").append(')').toString());
		}
	}

	static final void method3986(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.playerIndex
					* -442628795;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nr.vd(").append(')').toString());
		}
	}
	...
	static final void method3987(Class403 class403, byte i) {
		try {
			...
			String string = (String) (((Class403) class403).anObjectArray5240[((Class403) class403).anInt5241
					* -203050393]);
			String string_13_ = ((String) (((Class403) class403).anObjectArray5240[-203050393
					* ((Class403) class403).anInt5241 + 1]));
			Class63.method741(string, string_13_, 2101690439);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nr.agx(").append(')').toString());
		}
	}

	static final void method3988(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7570
					.method5681(-1938875884) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nr.aot(").append(')').toString());
		}
	}
		...
		try {
			...
			for (int i_15_ = 0; i_15_ < i_14_; i_15_++) {
				...
				if (37 == c && i_14_ > i_15_ + 2) {
					...
					if (0 != i_16_
							&& Class422_Sub29.method5729((byte) i_16_,
									(short) 18002))
						stringbuilder.append(Class493.method6190((byte) i_16_,
								2122534616));
					i_15_ += 2;
				} else if (c == 43)
					stringbuilder.append(' ');
	...
	static final void method3990(Class403 class403, int i) {
		try {
			...
			class105.aClass105Array1292[-1309843523
					* ((Class390) class390).aClass105_4168.anInt1154] = null;
			Tradution.method6054(class105, 575626440);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("nr.bt(").append(')').toString());
		}
	}
}
