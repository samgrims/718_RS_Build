...
public class Class375 {
	...
	public Class373 method4645(int i, int i_0_) {
		try {
			...
			synchronized (((Class375) this).aClass348_4079) {
				class373 = (Class373) ((Class375) this).aClass348_4079
						.method4184((long) i);
			}
			if (null != class373)
				return class373;
			...
			synchronized (((Class375) this).aClass243_4082) {
				is = (((Class375) this).aClass243_4082.method2315(
						Class120.aClass120_1439.anInt1460 * -1006924897, i,
						(byte) -18));
			}
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pp.a(").append(')').toString());
		}
	}

	public Class375(Class411 class411, Class429 class429, Class243 class243) {
		((Class375) this).aClass243_4082 = class243;
		anInt4081 = (((Class375) this).aClass243_4082.method2316(
				(-1006924897 * (Class120.aClass120_1439.anInt1460)), 774356441) * 1970250293);
	}
	...
	static final void method4649(Class403 class403, int i) {
		try {
			...
			if (class483.aChar6037 != i_2_)
				throw new RuntimeException();
			int[] is = class483
					.method6128(Integer.valueOf(i_4_), (short) 19520);
			int i_5_ = 0;
			if (is != null)
				i_5_ = is.length;
	...
	static final void method4651(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pp.afq(").append(')').toString());
		}
	}

	static int method4652(
			Player class365_sub1_sub1_sub2_sub2, int i) {
		try {
			int i_6_ = 1899133595 * class365_sub1_sub1_sub2_sub2.anInt10211;
			Class350 class350 = class365_sub1_sub1_sub2_sub2
					.method4426(657972326);
			int i_7_ = class365_sub1_sub1_sub2_sub2.aClass438_10077
					.method5823(1741170329);
			if (-1 == i_7_ || class365_sub1_sub1_sub2_sub2.aBoolean10094)
				i_6_ = 1728220219 * class365_sub1_sub1_sub2_sub2.anInt10194;
			else if (class350.anInt3721 * 230243963 == i_7_
					|| i_7_ == class350.anInt3749 * 491753731
					|| class350.anInt3724 * -783166629 == i_7_
					|| i_7_ == class350.anInt3746 * -2054940183)
				i_6_ = class365_sub1_sub1_sub2_sub2.anInt10212 * -978842273;
			else if (i_7_ == class350.anInt3755 * 328817727
					|| -1238642279 * class350.anInt3722 == i_7_
					|| 124010991 * class350.anInt3728 == i_7_
					|| -907666203 * class350.anInt3727 == i_7_)
				i_6_ = class365_sub1_sub1_sub2_sub2.anInt10210 * -1304250511;
			return i_6_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pp.r(").append(')').toString());
		}
	}
	...
	static final void method4654(int i, int i_8_, byte i_9_) {
		try {
			if (client.aClass411_8944 != Class411.aClass411_5316) {
				if (!Class82_Sub21.method938(i, i_8_, false, Class282
						.method2619(i, i_8_, 1, 1, 1978833308), -1273389367))
					Class82_Sub21.method938(i, i_8_, false, Class325
							.method3963(i, i_8_, 1, 1, 0, (byte) -5),
							1260408128);
			} else if (!Class82_Sub21.method938(i, i_8_, false, Class325
					.method3963(i, i_8_, 1, 1, 0, (byte) -71), 301836586))
				Class82_Sub21.method938(i, i_8_, false, Class282.method2619(i,
						i_8_, 1, 1, 1349485510), 605242163);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pp.jv(").append(')').toString());
		}
	}
}
