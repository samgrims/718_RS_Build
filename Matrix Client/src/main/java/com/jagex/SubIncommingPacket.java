...
public class SubIncommingPacket {
	...
	static void method1919(int i) {
		try {
			...
			try {
				class476 = Class86.method962("2",
						client.aClass411_8944.aString5317, false, -1804643872);
				byte[] is = new byte[(int) class476.method6080(-1608358371)];
				int i_0_;
				for (int i_1_ = 0; i_1_ < is.length; i_1_ += i_0_) {
					i_0_ = class476.method6081(is, i_1_, is.length - i_1_,
							(short) 1638);
					if (i_0_ == -1)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ir.r(").append(')').toString());
		}
	}

	static Class337[] method1920(int i) {
		try {
			return (new Class337[] { Class337.aClass337_3624,
					Class337.aClass337_3625, Class337.aClass337_3627 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ir.a(").append(')').toString());
		}
	}

	static final void method1921(byte i) {
		try {
			Class365_Sub1_Sub1_Sub6.method4494(Class373.aClass_ra4071,
					556951212);
			if (1855729883 * Class99.anInt952 != 191260743 * client.anInt8792)
				Class475.method6075((short) -2730);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ir.ga(").append(')').toString());
		}
	}
	...
	static Class98_Sub4 method1922(RsByteBuffer class298_sub53, int i) {
		try {
			return new Class98_Sub4(class298_sub53.readShort(1929673502),
					class298_sub53.readShort(1591525604), class298_sub53
							.readShort(1980414267), class298_sub53
							.readShort(1697989112), class298_sub53
							.readShort(1558777727), class298_sub53
							.readShort(1996690559), class298_sub53
							.readShort(1912436552), class298_sub53
							.readShort(1880856141), class298_sub53
							.read24BitUnsignedInteger((byte) -28), class298_sub53
							.readUnsignedByte());
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ir.r(").append(')').toString());
	...
	static final void method1923(int i) {
		try {
			if (Class299.method3682(-1233866115 * client.anInt8752, 1765230881)
					|| Class413.method5584(-1233866115 * client.anInt8752,
							1927636725))
				Class216.method2001(false, (byte) 23);
			else {
				Class422_Sub21.aClass318_8414 = client.aClass25_8711
						.method387(537308016);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ir.gk(").append(')').toString());
		}
	}

	static void sendSomethingOnIComponent(int interfaceHash, int i_2_, int value, int i_4_, int i_5_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(4,
					(long) interfaceHash);
			...
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609 = i_4_
					* -80288087;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ir.al(").append(')').toString());
		}
	}

	static void method1925(Class502 class502, int i, int i_6_,
			Class403 class403, int i_7_) {
		try {
			ClientScript class298_sub37_sub17 = Class86.method963(
					class502, i, i_6_, -1499442878);
			if (null == class298_sub37_sub17)
				...
				if ((class298_sub37_sub17.aClass502_9678 == Class502.aClass502_6727)
						|| (Class502.aClass502_6721 == class298_sub37_sub17.aClass502_9678)
						|| (Class502.aClass502_6718 == class298_sub37_sub17.aClass502_9678)) {
					int i_8_ = 0;
					int i_9_ = 0;
					...
					((Class403) class403).anIntArray5248[1] = (Class165.aClass319_6366
							.method3883((byte) -71) - i_9_);
