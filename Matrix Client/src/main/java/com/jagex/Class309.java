...
public abstract class Class309 {
			...
			if (Class287.myPlayer.aClass366_10209 != null) {
				for (int i_3_ = 0; i_3_ < Class132.anIntArray1506.length; i_3_++) {
					if (i_1_ == Class132.anIntArray1506[i_3_]) {
						Class287.myPlayer.aClass366_10209
								.method4538(i_3_, i_2_,
										Class212.aClass144_2433, -1907587275);
						return;
					}
				}
				for (int i_4_ = 0; i_4_ < Class132.anIntArray1499.length; i_4_++) {
					if (Class132.anIntArray1499[i_4_] == i_1_) {
						Class287.myPlayer.aClass366_10209
								.method4538(i_4_, i_2_,
										Class212.aClass144_2433, 909710113);
						break;
					}
				}
			}
	...
	static final void method3801(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mv.pk(").append(')').toString());
		}
	}

	static final void method3802(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			if (null == Class98_Sub2.aClass89_6932) {
				if (Class158.idx8.method2310(
						(Class410.anInt5290 * 2131310071), -457216440))
					Class98_Sub2.aClass89_6932 = IndexedImage.method979(
							Class158.idx8,
							Class410.anInt5290 * 2131310071);
				else
					bool = false;
			}
			if (Class422_Sub30.aClass89_8437 == null) {
				if (Class158.idx8.method2310(
						1636425877 * Class14.anInt174, -457216440))
					Class422_Sub30.aClass89_8437 = IndexedImage.method979(
							Class158.idx8,
							1636425877 * Class14.anInt174);
				else
					bool = false;
			}
			if (null == Class385.aClass89_4142) {
				if (Class158.idx8.method2310(
						(1475733439 * Class318.anInt3323), -457216440))
					Class385.aClass89_4142 = IndexedImage.method979(
							Class158.idx8,
							Class318.anInt3323 * 1475733439);
				else
					bool = false;
			}
			if (Class14.aClass505_176 == null) {
				if (Class173.aClass243_1758.method2310(Class14.anInt168
						* -227610265, -457216440))
					Class14.aClass505_176 = Class255.method2439(
							Class173.aClass243_1758, Class14.anInt168
									* -227610265, -1873768956);
				else
					bool = false;
			}
			if (Class14.aClass89Array169 == null) {
				if (Class158.idx8.method2310(-227610265
						* Class14.anInt168, -457216440))
					Class14.aClass89Array169 = IndexedImage.method981(
							Class158.idx8, -227610265
									* Class14.anInt168);
				else
					bool = false;
			}
