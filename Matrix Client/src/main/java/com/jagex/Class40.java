...
public abstract class Class40 {
	...
	Class40(Class_ra_Sub2 class_ra_sub2, int i, Buffer buffer, int i_0_,
			boolean bool) {
		...
		method478();
		OpenGL.glBufferDataARBa(i, ((Class40) this).anInt432, buffer.f(),
				((Class40) this).aBoolean438 ? 35040 : 35044);
	...
	void method479(byte[] is, int i) {
		...
		if (i > ((Class40) this).anInt432) {
			OpenGL.glBufferDataARBub(((Class40) this).anInt433, i, is, 0,
					(((Class40) this).aBoolean438 ? 35040 : 35044));
			((Class_ra_Sub2) ((Class40) this).aClass_ra_Sub2_437).anInt8112 += i
					- ((Class40) this).anInt432;
			((Class40) this).anInt432 = i;
		} else
			OpenGL.glBufferSubDataARBub(((Class40) this).anInt433, 0, i, is, 0);
	}

	Class40(Class_ra_Sub2 class_ra_sub2, int i, byte[] is, int i_1_,
			boolean bool) {
		((Class40) this).aClass_ra_Sub2_437 = class_ra_sub2;
		((Class40) this).anInt433 = i;
		...
		((Class40) this).anInt436 = anIntArray440[0];
		method478();
		OpenGL.glBufferDataARBub(i, ((Class40) this).anInt432, is, 0,
				((Class40) this).aBoolean438 ? 35040 : 35044);
		((Class_ra_Sub2) ((Class40) this).aClass_ra_Sub2_437).anInt8112 += ((Class40) this).anInt432;
	}
