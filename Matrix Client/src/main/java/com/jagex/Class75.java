...
public class Class75 {
	...
	Class75(RsByteBuffer class298_sub53) {
		...
		for (int i_2_ = 0; i_2_ < i; i_2_++) {
			((Class75) this).anIntArray705[i_2_] = class298_sub53
					.readUnsignedShort() - 5120;
			((Class75) this).anIntArray703[i_2_] = class298_sub53
					.readUnsignedShort() - 5120;
			((Class75) this).anIntArray702[i_2_] = class298_sub53
					.readShort(1563719109);
			((Class75) this).anIntArray704[i_2_] = class298_sub53
					.readUnsignedShort() - 5120;
			((Class75) this).anIntArray706[i_2_] = class298_sub53
					.readUnsignedShort() - 5120;
			((Class75) this).anIntArray701[i_2_] = class298_sub53
					.readShort(2133929202);
			((Class75) this).anIntArray707[i_2_] = class298_sub53
					.readShort(1967809784);
		}
	}

	public static final Class284 method834(Component component, int i,
			int i_3_, int i_4_) {
		try {
			...
			try {
				...
				((Class284) class284_sub1_5_).anIntArray3052 = new int[(Class284.aBoolean3047 ? 2
						: 1) * 256];
				...
				class284_sub1_5_
						.method2684((((Class284) class284_sub1_5_).anInt3046)
								* -1894797445, 557897773);
				if (-1869204691 * Class284.anInt3048 > 0
						&& null == Class284.aClass288_3057) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("da.f(").append(')').toString());
		}
	}

	static final void method835(IComponentDefinition class105, Class119 class119,
	...
	static void method837(Class298_Sub37_Sub5 class298_sub37_sub5, int i) {
		try {
			...
			for (Class298_Sub37_Sub5 class298_sub37_sub5_7_ = ((Class298_Sub37_Sub5) Class436.aClass461_5482
					.method5984(-1268764084)); class298_sub37_sub5_7_ != null; class298_sub37_sub5_7_ = ((Class298_Sub37_Sub5) Class436.aClass461_5482
					.method5985(-1549897657))) {
				if (Class473.method6069(class298_sub37_sub5
						.method3417(-610126190), class298_sub37_sub5_7_
						.method3417(-1229609996), -537262415)) {
					Class458.method5973(class298_sub37_sub5,
							class298_sub37_sub5_7_, -1541675772);
					bool = true;
					break;
				}
			}
			if (!bool)
				Class436.aClass461_5482.method5982(class298_sub37_sub5,
						(byte) -51);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("da.h(").append(')').toString());
		}
	}
