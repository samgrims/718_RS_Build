...
public class Class82_Sub5 extends Class82 {
	...
	public void method868() {
		Class87.aClass94Array794[796511923 * ((Class82_Sub5) this).anInt6836]
				.method1015(1745967363).method4430(
						((Class82_Sub5) this).aString6834,
						1847855163 * ((Class82_Sub5) this).anInt6835, 0,
						-1158638155 * ((Class82_Sub5) this).anInt6837,
						(byte) -93);
	}
	...
	public void method866(int i) {
		try {
			Class87.aClass94Array794[796511923 * ((Class82_Sub5) this).anInt6836]
					.method1015(1923584032).method4430(
							((Class82_Sub5) this).aString6834,
							1847855163 * ((Class82_Sub5) this).anInt6835, 0,
							-1158638155 * ((Class82_Sub5) this).anInt6837,
							(byte) -32);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("xj.f(").append(')').toString());
		}
	}

	Class82_Sub5(RsByteBuffer class298_sub53) {
		super(class298_sub53);
		((Class82_Sub5) this).anInt6836 = class298_sub53.readUnsignedShort()
				* -1921544069;
		((Class82_Sub5) this).aString6834 = class298_sub53
				.readString(-1733451894);
		((Class82_Sub5) this).anInt6835 = class298_sub53.readInt((byte) 92)
				* -170815245;
	...
	public void method869() {
		Class87.aClass94Array794[796511923 * ((Class82_Sub5) this).anInt6836]
				.method1015(946944575).method4430(
						((Class82_Sub5) this).aString6834,
						1847855163 * ((Class82_Sub5) this).anInt6835, 0,
						-1158638155 * ((Class82_Sub5) this).anInt6837,
						(byte) -33);
