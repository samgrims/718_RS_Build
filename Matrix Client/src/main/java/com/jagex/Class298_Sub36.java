...
public class Class298_Sub36 extends Class298 {
	...
	public static final void method3401(int i, int i_0_, int i_1_, int i_2_,
		...
		try {
			...
			if (i_4_ < 0)
				...
				i_4_ = 100;
			int i_5_ = (client.aShort8928 + (client.aShort8929 - client.aShort8928)
					* i_4_ / 100);
			...
			if (i_6_ < client.aShort8934) {
				...
				if (i_5_ > client.aShort8743) {
					...
					if (bool) {
						...
						Class373.aClass_ra4071.method5015(i, i_0_, i_8_, i_2_,
								-16777216, (byte) 7);
						Class373.aClass_ra4071.method5015(i_1_ + i - i_8_,
								i_0_, i_8_, i_2_, -16777216, (byte) 7);
					}
					i += i_8_;
					i_1_ -= i_8_ * 2;
				}
				...
				if (i_5_ < client.aShort8839) {
					...
					if (bool) {
						Class373.aClass_ra4071.L();
						Class373.aClass_ra4071.method5015(i, i_0_, i_1_, i_10_,
								-16777216, (byte) 7);
						Class373.aClass_ra4071.method5015(i, i_0_ + i_2_
								- i_10_, i_1_, i_10_, -16777216, (byte) 7);
					}
					i_0_ += i_10_;
					i_2_ -= i_10_ * 2;
				}
