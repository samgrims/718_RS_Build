	...
	static final void method4669(Class403 class403, byte i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = (((Class403) class403).anObjectArray5234[(((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259])]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ps.ap(").append(')').toString());
		}
	}
