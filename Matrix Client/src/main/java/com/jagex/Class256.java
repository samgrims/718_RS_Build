...
public class Class256 {
	...
	public Class298_Sub37_Sub8 method2441(int i, int i_0_) {
		try {
			Class298_Sub37_Sub8 class298_sub37_sub8 = ((Class298_Sub37_Sub8) ((Class256) this).aClass348_2798
					.method4184((long) i));
			if (null != class298_sub37_sub8)
				return class298_sub37_sub8;
			byte[] is;
			if (i >= 32768)
				is = ((Class256) this).aClass243_2797.method2315(0, i & 0x7fff,
						(byte) -102);
			else
				is = ((Class256) this).aClass243_2796.method2315(0, i,
						(byte) -91);
			class298_sub37_sub8 = new Class298_Sub37_Sub8();
			if (is != null)
				class298_sub37_sub8.method3430(new RsByteBuffer(is),
						754160666);
			if (i >= 32768)
				class298_sub37_sub8.method3432(-1787095576);
			((Class256) this).aClass348_2798.method4194(class298_sub37_sub8,
					(long) i);
			return class298_sub37_sub8;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ks.a(").append(')').toString());
		}
	}
	...
	static final void method2445(Class403 class403, int i) {
		try {
			...
			Class505 class505 = Class322.method3931(Class173.aClass243_1758,
					i_5_, 0, (byte) 57);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = class505
					.method6262(string, i_4_, Class130_Sub2.aClass57Array6959,
							1970071925);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ks.zf(").append(')').toString());
		}
	}
	...
	static int[] method2446(Class298_Sub36 class298_sub36, int i) {
		try {
			...
			class298_sub53.applyRsa(Class50.aBigInteger500,
					Class50.aBigInteger503, 1970926718);
			class298_sub36.out.writeBytes(
					class298_sub53.buffer, 0,
					385051775 * class298_sub53.index, (short) -19107);
			return is;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ks.s(").append(')').toString());
		}
	}
}
