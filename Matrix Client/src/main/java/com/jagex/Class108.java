package com.jagex;/* Class108 - Decompiled by JODE
...
public class Class108 {
	...
	static final void method1147(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8640 ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ek.abd(").append(')').toString());
		}
	}
	...
	static final void method1148(Class403 class403, int i) {
		try {
			...
			Class21
					.method365(class105, class119, false, 1, class403,
							233594133);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ek.he(").append(')').toString());
		}
	}
		...
		try {
			...
			if (i < 10000000)
				return new StringBuilder().append("<col=ffffff>").append(
						i / 1000).append(
						Tradution.aClass470_5920
								.method6049(class429, -875414210)).append(
						"</col>").toString();
			return new StringBuilder().append("<col=00ff80>").append(
					i / 1000000).append(
					Tradution.aClass470_5918.method6049(class429, -875414210))
					.append("</col>").toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ek.n(").append(')').toString());
		}
	}
	...
	static final void method1151(Class403 class403, int i) {
		try {
			if (Class68.aShortArray678 == null
					|| (Class242.anInt2709 * -316347407 >= Class344.anInt3688 * 367592105))
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ek.abw(").append(')').toString());
		}
	}

	static void method1152(int i, int i_6_, int i_7_) {
		try {
			Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(14,
					(long) i);
			class298_sub37_sub12.method3449((byte) 25);
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9610 = 1274450087 * i_6_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ek.ag(").append(')').toString());
		}
	}

	static void method1153(int i, int i_8_, int i_9_, int i_10_, int i_11_,
			int i_12_) {
		try {
			int i_13_ = 0;
			int i_14_ = i_10_;
			...
			Class82_Sub22.method940(
					(Class372_Sub1_Sub1.anIntArrayArray4047[i_8_]), i - i_9_,
					i_9_ + i, i_11_, -2115360638);
			while (i_14_ > 0) {
				if (i_20_ < 0) {
					while (i_20_ < 0) {
						i_20_ += i_24_;
				...
				int i_31_ = i - i_13_;
				Class82_Sub22.method940(
						(Class372_Sub1_Sub1.anIntArrayArray4047[i_28_]), i_31_,
						i_30_, i_11_, 756505397);
				Class82_Sub22.method940(
						(Class372_Sub1_Sub1.anIntArrayArray4047[i_29_]), i_31_,
						i_30_, i_11_, 931363895);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ek.at(").append(')').toString());
		}
	}
}
