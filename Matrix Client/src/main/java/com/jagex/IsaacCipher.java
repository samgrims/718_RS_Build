...
public final class IsaacCipher {
	...
	final void method5917(byte i) {
		try {
			...
			for (int i_11_ = 0; i_11_ < 256; i_11_++) {
				...
				if (0 == (i_11_ & 0x2)) {
					if (0 == (i_11_ & 0x1))
						((IsaacCipher) this).anInt5628 = (-840519441
								* ((IsaacCipher) this).anInt5628 ^ (((IsaacCipher) this).anInt5628
								* -840519441 << 13)) * 368737807;
					else
						((IsaacCipher) this).anInt5628 = (368737807 * (-840519441
								* ((IsaacCipher) this).anInt5628 ^ (-840519441
								* ((IsaacCipher) this).anInt5628 >>> 6)));
				} else if (0 == (i_11_ & 0x1))
					((IsaacCipher) this).anInt5628 = ((-840519441
							* ((IsaacCipher) this).anInt5628 ^ ((IsaacCipher) this).anInt5628
							* -840519441 << 2) * 368737807);
				else
					((IsaacCipher) this).anInt5628 = 368737807 * (((IsaacCipher) this).anInt5628
							* -840519441 ^ (((IsaacCipher) this).anInt5628 * -840519441) >>> 16);
				((IsaacCipher) this).anInt5628 += 368737807 * (((IsaacCipher) this).anIntArray5627[128 + i_11_ & 0xff]);
				int i_13_;
				((IsaacCipher) this).anIntArray5627[i_11_] = i_13_ = (149032115 * ((IsaacCipher) this).anInt5622 + (-840519441
						* ((IsaacCipher) this).anInt5628 + (((IsaacCipher) this).anIntArray5627[(i_12_ & 0x3fc) >> 2])));
	...
	static final void method5918(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sn.df(").append(')').toString());
		}
	}

	static Class52_Sub2_Sub1 method5919(Class_ra_Sub1 class_ra_sub1,
			Canvas canvas, int i, int i_14_, int i_15_) {
		try {
			Class52_Sub2_Sub1_Sub1 class52_sub2_sub1_sub1 = new Class52_Sub2_Sub1_Sub1(
					class_ra_sub1, canvas, i, i_14_);
			return class52_sub2_sub1_sub1;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sn.n(").append(')').toString());
		}
	}
	...
	static void method5920(int i) {
		try {
			try {
				...
				if (file.exists())
					Class291.aClass484_6499 = new Class484(new Class476(file,
							"rw", 25L), 24, 0);
				else {
					while_104_: for (int i_16_ = 0; i_16_ < Class68.aStringArray679.length; i_16_++) {
						for (int i_17_ = 0; i_17_ < Class216.aStringArray6657.length; i_17_++) {
							File file_18_ = new File(new StringBuilder()
									.append(Class216.aStringArray6657[i_17_])
									.append(Class68.aStringArray679[i_16_])
									.append(File.separatorChar).append(
											"random.dat").toString());
							if (file_18_.exists()) {
								Class291.aClass484_6499 = new Class484(
										new Class476(file_18_, "rw", 25L), 24,
										0);
								break while_104_;
							}
						}
