package com.jagex;/* Class_ra_Sub3_Sub2 - Decompiled by JODE
...
public class Class_ra_Sub3_Sub2 extends Class_ra_Sub3 {
	...
	Interface9_Impl2 method5439(Class55 class55, int i, int i_0_, boolean bool,
	...
	void method5441() {
		IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 14,
				aBoolean8277 && aBoolean8237);
	}

	Class_ra_Sub3_Sub2(int i, int i_3_, long l, long l_4_,
			D3DPRESENT_PARAMETERS d3dpresent_parameters, D3DCAPS d3dcaps,
			Interface_ma interface_ma, Class243 class243, int i_5_) {
		...
		try {
			...
			anInt8348 = (((Class_ra_Sub3_Sub2) this).aD3DCAPS9864.MaxActiveLights > 0 ? ((Class_ra_Sub3_Sub2) this).aD3DCAPS9864.MaxActiveLights
					: 8);
			...
			aBoolean8349 = true;
			aBoolean8350 = anInt8341 > 0
					|| (IDirect3D
							.CheckDeviceMultiSampleType(
									((Class_ra_Sub3_Sub2) this).aLong9852,
									((Class_ra_Sub3_Sub2) this).anInt9844,
									((Class_ra_Sub3_Sub2) this).anInt9871,
									(((Class_ra_Sub3_Sub2) this).aD3DPRESENT_PARAMETERS9848.BackBufferFormat),
									true, 2)) == 0;
	...
	void method5307() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(1904772578); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -5)) {
	...
	public void method5519(Class233 class233, Class233 class233_6_,
			Class233 class233_7_) {
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847,
				256, class233.aFloatArray2594);
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847, 2,
				class233_6_.aFloatArray2594);
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847, 3,
				class233_7_.aFloatArray2594);
	}

	boolean method5539() {
		int i = IDirect3DDevice
				.TestCooperativeLevel(((Class_ra_Sub3_Sub2) this).aLong9847);
		if (i == 0 || i == -2005530519) {
			IDirect3DDevice.SetDepthStencilSurface(
					(((Class_ra_Sub3_Sub2) this).aLong9847), 0L);
			for (int i_8_ = 0; i_8_ < 4; i_8_++)
				IDirect3DDevice.SetRenderTarget(
						(((Class_ra_Sub3_Sub2) this).aLong9847), i_8_, 0L);
			for (int i_9_ = 0; i_9_ < 4; i_9_++)
				IDirect3DDevice
						.SetStreamSource(
								(((Class_ra_Sub3_Sub2) this).aLong9847), i_9_,
								0L, 0, 0);
			for (int i_10_ = 0; i_10_ < 4; i_10_++)
				IDirect3DDevice.SetTexture(
						(((Class_ra_Sub3_Sub2) this).aLong9847), i_10_, 0L);
			IDirect3DDevice.SetIndices(((Class_ra_Sub3_Sub2) this).aLong9847,
					0L);
			method5306();
			...
			if (method5551(((Class_ra_Sub3_Sub2) this).anInt9844,
					((Class_ra_Sub3_Sub2) this).anInt9871,
					((Class_ra_Sub3_Sub2) this).aLong9852, anInt8341,
					(((Class_ra_Sub3_Sub2) this).aD3DPRESENT_PARAMETERS9848))) {
				int i_11_ = IDirect3DDevice
						.Reset(
								(((Class_ra_Sub3_Sub2) this).aLong9847),
								(((Class_ra_Sub3_Sub2) this).aD3DPRESENT_PARAMETERS9848));
				if (jagdx.a.f(i_11_)) {
					method5307();
					method5463();
	...
	void method5448() {
		if (aBoolean8214)
			IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 137,
					aBoolean8264 && !aBoolean8282);
	}

	public Class58 method4987() {
		D3DADAPTER_IDENTIFIER d3dadapter_identifier = new D3DADAPTER_IDENTIFIER();
		IDirect3D
				.GetAdapterIdentifier(((Class_ra_Sub3_Sub2) this).aLong9852,
						((Class_ra_Sub3_Sub2) this).anInt9844, 0,
						d3dadapter_identifier);
		return new Class58(d3dadapter_identifier.VendorID, "Direct3D", 9,
	...
	void method5540() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(2038971195); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) 3)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
	...
	public void method5075() {
		long l = IDirect3DDevice
				.CreateEventQuery(((Class_ra_Sub3_Sub2) this).aLong9847);
	...
	Interface9_Impl2 method5474(int i, int i_12_, boolean bool, int[] is,
			int i_13_, int i_14_) {
	...
	void method5343() {
		if (aBoolean8214) {
			...
			D3DLIGHT.SetDiffuse(((Class_ra_Sub3_Sub2) this).aLong9853, f
					* aFloat8362, f * aFloat8289, f * aFloat8290, 0.0F);
			D3DLIGHT.SetDiffuse(((Class_ra_Sub3_Sub2) this).aLong9867, f_16_
					* aFloat8362, f_16_ * aFloat8289, f_16_ * aFloat8290, 0.0F);
			((Class_ra_Sub3_Sub2) this).aBoolean9854 = false;
		}
	}
	...
	Class298_Sub21 method5541(Interface11 interface11) {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(1679619359); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -106)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
	...
	void method5542(Interface11 interface11) {
		if (method5541(interface11) == null)
			((Class_ra_Sub3_Sub2) this).aClass458_9851.method5968(
					new Class298_Sub21(interface11), 364496408);
	}
	...
	void method5347() {
		...
		for (i = 0; i < anInt8296; i++) {
			...
			D3DLIGHT.SetPosition(((Class_ra_Sub3_Sub2) this).aLong9863,
					(float) class298_sub10.method2895(823958259),
					(float) class298_sub10.method2894(-1488448874),
					(float) class298_sub10.method2897((byte) 58));
			D3DLIGHT.SetDiffuse(((Class_ra_Sub3_Sub2) this).aLong9863,
					(float) (i_18_ >> 16 & 0xff) * f,
					(float) (i_18_ >> 8 & 0xff) * f,
					(float) (i_18_ & 0xff) * f, 0.0F);
			D3DLIGHT.SetAttenuation(((Class_ra_Sub3_Sub2) this).aLong9863,
					0.0F, 0.0F, 1.0F / (float) (class298_sub10
							.method2900(-426177774) * class298_sub10
							.method2900(-311447466)));
			D3DLIGHT.SetRange(((Class_ra_Sub3_Sub2) this).aLong9863,
					(float) class298_sub10.method2900(-949255616));
			IDirect3DDevice.SetLight(((Class_ra_Sub3_Sub2) this).aLong9847,
					i_17_, ((Class_ra_Sub3_Sub2) this).aLong9863);
			IDirect3DDevice.LightEnable(((Class_ra_Sub3_Sub2) this).aLong9847,
					i_17_, true);
		}
		for (/**/; i < anInt8295; i++)
			IDirect3DDevice.LightEnable(((Class_ra_Sub3_Sub2) this).aLong9847,
	...
	public int[] aq(int i, int i_19_, int i_20_, int i_21_) {
		...
		long l = IDirect3DDevice.GetRenderTarget(
				((Class_ra_Sub3_Sub2) this).aLong9847, 0);
		long l_22_ = IDirect3DDevice.CreateRenderTarget(
				(((Class_ra_Sub3_Sub2) this).aLong9847), i_20_, i_21_, 21, 0,
				0, true);
		if (jagdx.a.f(IDirect3DDevice.StretchRect(
				(((Class_ra_Sub3_Sub2) this).aLong9847), l, i, i_19_, i_20_,
				i_21_, l_22_, 0, 0, i_20_, i_21_, 1))) {
			is = new int[i_20_ * i_21_];
			IDirect3DSurface.Download(l_22_, 0, 0, i_20_, i_21_, i_20_ * 4, 16,
					aLong8217);
	...
	public void ba(int i, int i_23_) {
		IDirect3DDevice.Clear(((Class_ra_Sub3_Sub2) this).aLong9847, i, i_23_,
				1.0F, 0);
	}

	void method5325() {
		if (aClass52_5292 != null)
			IDirect3DDevice.SetViewport(((Class_ra_Sub3_Sub2) this).aLong9847,
					anInt8275 + anInt8339, anInt8276 + anInt8272, anInt8273,
					anInt8239, aFloat8335, aFloat8258);
	}

	void method5326() {
		IDirect3DDevice.SetScissorRect(((Class_ra_Sub3_Sub2) this).aLong9847,
				anInt8275 + anInt8265, anInt8276 + anInt8263, anInt8234,
				anInt8241);
	}

	void method5327() {
		IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 174,
				aBoolean8254);
	}

	Interface9_Impl2 method5403(Class55 class55, int i, int i_24_,
			boolean bool, float[] fs, int i_25_, int i_26_) {
		return new Class200_Sub3(this, class55, i, i_24_, bool, fs, i_25_,
				i_26_);
	}

	void method5500() {
		IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 15,
				aBoolean8309);
	}

	public void method5300(Class233 class233, Class233 class233_27_,
			Class233 class233_28_) {
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847,
				256, class233.aFloatArray2594);
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847, 2,
				class233_27_.aFloatArray2594);
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847, 3,
				class233_28_.aFloatArray2594);
	}
	...
	void method5340() {
		IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 7,
				aBoolean8279);
	}
	...
	void method5411() {
		if (aBoolean8214) {
			D3DLIGHT.SetAmbient(((Class_ra_Sub3_Sub2) this).aLong9853,
					aFloat8362 * aFloat8291, aFloat8289 * aFloat8291,
					aFloat8290 * aFloat8291, 0.0F);
			((Class_ra_Sub3_Sub2) this).aBoolean9854 = false;
		}
	}
	...
	void method5320() {
		if (aBoolean8214 && !((Class_ra_Sub3_Sub2) this).aBoolean9854) {
			...
			IDirect3DDevice.LightEnable(((Class_ra_Sub3_Sub2) this).aLong9847,
					1, false);
			IDirect3DDevice.SetLight(((Class_ra_Sub3_Sub2) this).aLong9847, 0,
					((Class_ra_Sub3_Sub2) this).aLong9853);
			IDirect3DDevice.SetLight(((Class_ra_Sub3_Sub2) this).aLong9847, 1,
					((Class_ra_Sub3_Sub2) this).aLong9867);
			IDirect3DDevice.LightEnable(((Class_ra_Sub3_Sub2) this).aLong9847,
					0, true);
			IDirect3DDevice.LightEnable(((Class_ra_Sub3_Sub2) this).aLong9847,
					1, true);
	...
	Interface9_Impl3 method5344(Class55 class55, int i, int i_29_, int i_30_,
	...
	boolean method5348(Class55 class55, Class77 class77) {
		...
		return (jagdx.a.f(IDirect3D.GetAdapterDisplayMode(
				((Class_ra_Sub3_Sub2) this).aLong9852,
				((Class_ra_Sub3_Sub2) this).anInt9844, d3ddisplaymode)) && jagdx.a
				.f(IDirect3D.CheckDeviceFormat(
						((Class_ra_Sub3_Sub2) this).aLong9852,
						((Class_ra_Sub3_Sub2) this).anInt9844,
						((Class_ra_Sub3_Sub2) this).anInt9871,
						d3ddisplaymode.Format, 0, 3, method5546(class55,
								class77))));
	}
	...
	boolean method5349(Class55 class55, Class77 class77) {
		...
		return (jagdx.a.f(IDirect3D.GetAdapterDisplayMode(
				...
				.f(IDirect3D.CheckDeviceFormat(
						...
						((Class_ra_Sub3_Sub2) this).anInt9844,
						((Class_ra_Sub3_Sub2) this).anInt9871,
						d3ddisplaymode.Format, 0, 4, method5546(class55,
								class77))));
	}

	Interface9_Impl2 method5353(Class55 class55, Class77 class77, int i,
			int i_31_) {
		return new Class200_Sub3(this, class55, class77, i, i_31_);
	}

	Interface9_Impl2 method5355(int i, int i_32_, boolean bool, int[] is,
			int i_33_, int i_34_) {
	...
	void method5495() {
		if (aBoolean8214) {
			int i = (((Class_ra_Sub3_Sub2) this).aBooleanArray9845[anInt8325] ? method5561(aClass175Array8294[anInt8325])
					: 1);
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, 1, i);
		}
	}

	Interface9_Impl2 method5453(Class55 class55, int i, int i_35_,
			boolean bool, float[] fs, int i_36_, int i_37_) {
		return new Class200_Sub3(this, class55, i, i_35_, bool, fs, i_36_,
				i_37_);
	}

	Interface9_Impl2_Impl1 method5356(Class55 class55, Class77 class77, int i,
			int i_38_) {
	...
	final void method5543(long l) {
		...
		IDirect3DDevice.SetVertexShader(((Class_ra_Sub3_Sub2) this).aLong9847,
				l);
	}
	...
	final void method5485(int i, Class183 class183, boolean bool) {
		if (aBoolean8214) {
			...
			if (bool)
				i_39_ |= 0x10;
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, i_40_,
					method5547(class183) | i_39_);
		}
	}

	final void method5544(Class200 class200) {
		IDirect3DDevice.SetTexture(((Class_ra_Sub3_Sub2) this).aLong9847,
				anInt8325, class200.method1894());
		if (aBoolean8214
				&& !((Class_ra_Sub3_Sub2) this).aBooleanArray9845[anInt8325]) {
	...
	public void method5455(Class153 class153) {
		...
		IDirect3DDevice.SetVertexDeclaration(
				(((Class_ra_Sub3_Sub2) this).aLong9847),
				(((Class153_Sub2) class153_sub2).aLong8623));
	}

	static GraphicsToolkit method5545(Canvas canvas, Interface_ma interface_ma,
			Class243 class243, Integer integer) {
		...
		try {
			...
			if (!method5551(i, i_42_, l, integer.intValue(),
			...
			long l_44_ = 0L;
			try {
				l_44_ = IDirect3D.CreateDeviceContext(l, i, i_42_, canvas,
						i_43_ | 0x40, d3dpresent_parameters);
			} catch (u var_u) {
				l_44_ = IDirect3D.CreateDeviceContext(l, i, i_42_, canvas,
						i_43_ & ~0x100000 | 0x20, d3dpresent_parameters);
			}
			class_ra_sub3_sub2 = new Class_ra_Sub3_Sub2(i, i_42_, l, l_44_,
					d3dpresent_parameters, d3dcaps, interface_ma, class243,
					integer.intValue());
			if (!class_ra_sub3_sub2.aHashtable5313.containsKey(canvas)) {
				Class298_Sub19_Sub3.method3041(canvas, (short) 3524);
				class_ra_sub3_sub2.method5151(canvas,
						new Class52_Sub2_Sub2_Sub2(class_ra_sub3_sub2, canvas,
	...
	void method5422() {
		if (aBoolean8214) {
			D3DLIGHT.SetDirection(((Class_ra_Sub3_Sub2) this).aLong9853,
					-aFloatArray8283[0], -aFloatArray8283[1],
					-aFloatArray8283[2]);
			D3DLIGHT.SetDirection(((Class_ra_Sub3_Sub2) this).aLong9867,
					-aFloatArray8248[0], -aFloatArray8248[1],
					-aFloatArray8248[2]);
			((Class_ra_Sub3_Sub2) this).aBoolean9854 = false;
		}
	}
	...
	void method5486() {
		if (((Class_ra_Sub3_Sub2) this).aLong9849 == 0L
			...
			if (aClass171Array8305[anInt8325] == Class171.aClass171_1741)
				IDirect3DDevice
						.SetTransform(
								((Class_ra_Sub3_Sub2) this).aLong9847,
								16 + anInt8325,
								(aClass233Array8304[anInt8325]
										.method2166(((Class_ra_Sub3_Sub2) this).aFloatArray9868)));
			else
				IDirect3DDevice
						.SetTransform(
								((Class_ra_Sub3_Sub2) this).aLong9847,
								16 + anInt8325,
								(aClass233Array8304[anInt8325]
										.method2173(((Class_ra_Sub3_Sub2) this).aFloatArray9868)));
			...
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, 24, 0);
	...
	public Class66 method5179(Class66 class66, Class66 class66_45_, float f,
			Class66 class66_46_) {
	...
	void method5444() {
		if (aBoolean8214) {
			int i = (((Class_ra_Sub3_Sub2) this).aBooleanArray9845[anInt8325] ? method5561(aClass175Array8307[anInt8325])
					: 1);
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, 4, i);
		}
	}

	final void method5427(int i, Class183 class183, boolean bool,
			boolean bool_47_) {
		if (aBoolean8214) {
			int i_48_ = 0;
			int i_49_;
			...
			if (bool_47_)
				i_48_ |= 0x10;
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, i_49_,
					method5547(class183) | i_48_);
		}
	}
	...
	final void method5364(int i, Class183 class183, boolean bool) {
		if (aBoolean8214) {
			...
			if (bool)
				i_50_ |= 0x10;
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, i_51_,
					method5547(class183) | i_50_);
		}
	}

	final void method5369() {
		if (aBoolean8214)
			IDirect3DDevice.SetRenderState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), 60, anInt8274);
	}
	...
	void method5292(int i) {
		IDirect3DDevice.SetRenderState(((Class_ra_Sub3_Sub2) this).aLong9847,
				168, i);
	}
	...
	void method5376() {
		...
		case 3:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 19, 2);
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 20, 1);
			break;
		case 0:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 19, 5);
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 20, 6);
			break;
		case 1:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 19, 2);
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 20, 2);
			break;
		case 2:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 19, 9);
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 20, 2);
			break;
		}
		...
		case 2:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 207, 2);
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 208, 2);
			break;
		case 0:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 207, 1);
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 208, 1);
			break;
		case 1:
			IDirect3DDevice.SetRenderState(
					((Class_ra_Sub3_Sub2) this).aLong9847, 207, 2);
	...
	void method5305() {
		IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 27,
				aBoolean8245);
	}

	void method5379() {
		if (aBoolean8214)
			IDirect3DDevice.f(((Class_ra_Sub3_Sub2) this).aLong9847, 28,
					aBoolean8331 && aBoolean8278 && anInt8233 >= 0);
	}
	...
	void method5378() {
		...
		if (aBoolean8214) {
			IDirect3DDevice.a(((Class_ra_Sub3_Sub2) this).aLong9847, 36,
					aFloat8292);
			IDirect3DDevice.a(((Class_ra_Sub3_Sub2) this).aLong9847, 37,
					aFloat8336);
			IDirect3DDevice.SetRenderState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), 34, anInt8332);
		}
	}
	...
	public void method5383(int i, Interface7_Impl1 interface7_impl1) {
		...
		IDirect3DDevice.SetStreamSource(((Class_ra_Sub3_Sub2) this).aLong9847,
				i, ((Class193) class193).aLong8584, 0, class193.method1861());
	}

	void method5384(Interface7_Impl2 interface7_impl2) {
		IDirect3DDevice.SetIndices(((Class_ra_Sub3_Sub2) this).aLong9847,
				(((Class196) (Class196) interface7_impl2).aLong8590));
	}
	...
	public final void method5398(Class187 class187, int i, int i_52_) {
		...
		IDirect3DDevice.DrawPrimitive(((Class_ra_Sub3_Sub2) this).aLong9847,
				method5567(class187), i, i_52_);
	}

	public final void method5392(Class187 class187, int i, int i_53_,
			int i_54_, int i_55_) {
		if (((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860 != null)
			((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860.method1229();
		IDirect3DDevice.DrawIndexedPrimitive(
				(((Class_ra_Sub3_Sub2) this).aLong9847), method5567(class187),
				0, i, i_53_, i_54_, i_55_);
	}
	...
	static boolean method5551(int i, int i_61_, long l, int i_62_,
		...
		try {
			D3DDISPLAYMODE d3ddisplaymode = new D3DDISPLAYMODE();
			if (jagdx.a
					.a(IDirect3D.GetAdapterDisplayMode(l, i, d3ddisplaymode)))
				return false;
			while_16_: for (/**/; i_62_ >= 0; i_62_--) {
				if (i_62_ != 1) {
					i_65_ = 0 + i_62_;
					for (int i_66_ = 0; i_66_ < anIntArray9873.length; i_66_++) {
						if (IDirect3D.CheckDeviceType(l, i, i_61_,
								d3ddisplaymode.Format, anIntArray9873[i_66_],
								true) == 0
								&& IDirect3D.CheckDeviceFormat(l, i, i_61_,
										(d3ddisplaymode.Format), 1, 1,
										(anIntArray9873[i_66_])) == 0
								&& (i_62_ == 0 || (IDirect3D
										.CheckDeviceMultiSampleType(l, i,
												i_61_, anIntArray9873[i_66_],
												true, i_65_)) == 0)) {
							for (int i_67_ = 0; i_67_ < anIntArray9872.length; i_67_++) {
								if (IDirect3D.CheckDeviceFormat(l, i, i_61_,
										(d3ddisplaymode.Format), 2, 1,
										(anIntArray9872[i_67_])) == 0
										&& (IDirect3D.CheckDepthStencilMatch(l,
												i, i_61_,
												d3ddisplaymode.Format,
												anIntArray9873[i_66_],
												anIntArray9872[i_67_])) == 0
										&& (i_62_ == 0 || (IDirect3D
												.CheckDeviceMultiSampleType(l,
														i, i_61_,
														anIntArray9872[i_66_],
														true, i_65_)) == 0)) {
	...
	synchronized void method5552(long l) {
		if (((Class_ra_Sub3_Sub2) this).anInt9870 == ((Class_ra_Sub3_Sub2) this).anInt9869) {
			...
			System.arraycopy(((Class_ra_Sub3_Sub2) this).aLongArray9855, 0, ls,
					0, ((Class_ra_Sub3_Sub2) this).anInt9870);
	...
	static GraphicsToolkit method5553(Canvas canvas, Interface_ma interface_ma,
			Class243 class243, Integer integer) {
		Class_ra_Sub3_Sub2 class_ra_sub3_sub2 = null;
		...
		try {
			...
			d3dpresent_parameters.BackBufferCount = 1;
			d3dpresent_parameters.PresentationInterval = -2147483648;
			if (!method5551(i, i_69_, l, integer.intValue(),
					d3dpresent_parameters))
				throw new RuntimeException("");
			int i_70_ = 0;
			if ((d3dcaps.DevCaps & 0x100000) != 0)
			...
			long l_71_ = 0L;
			try {
				l_71_ = IDirect3D.CreateDeviceContext(l, i, i_69_, canvas,
						i_70_ | 0x40, d3dpresent_parameters);
			} catch (u var_u) {
				l_71_ = IDirect3D.CreateDeviceContext(l, i, i_69_, canvas,
						i_70_ & ~0x100000 | 0x20, d3dpresent_parameters);
			}
			class_ra_sub3_sub2 = new Class_ra_Sub3_Sub2(i, i_69_, l, l_71_,
					d3dpresent_parameters, d3dcaps, interface_ma, class243,
					integer.intValue());
			if (!class_ra_sub3_sub2.aHashtable5313.containsKey(canvas)) {
	...
	void method5554() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(1899920069); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -58)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
			interface11.method133();
	...
	public int[] ev(int i, int i_78_, int i_79_, int i_80_) {
		...
		long l = IDirect3DDevice.GetRenderTarget(
				((Class_ra_Sub3_Sub2) this).aLong9847, 0);
		long l_81_ = IDirect3DDevice.CreateRenderTarget(
				(((Class_ra_Sub3_Sub2) this).aLong9847), i_79_, i_80_, 21, 0,
				0, true);
		if (jagdx.a.f(IDirect3DDevice.StretchRect(
				(((Class_ra_Sub3_Sub2) this).aLong9847), l, i, i_78_, i_79_,
				i_80_, l_81_, 0, 0, i_79_, i_80_, 1))) {
			is = new int[i_79_ * i_80_];
			IDirect3DSurface.Download(l_81_, 0, 0, i_79_, i_80_, i_79_ * 4, 16,
					aLong8217);
			aByteBuffer8216.clear();
			aByteBuffer8216.asIntBuffer().get(is);
		}
	...
	public int[] eg(int i, int i_82_, int i_83_, int i_84_) {
		...
		long l = IDirect3DDevice.GetRenderTarget(
				((Class_ra_Sub3_Sub2) this).aLong9847, 0);
		long l_85_ = IDirect3DDevice.CreateRenderTarget(
				(((Class_ra_Sub3_Sub2) this).aLong9847), i_83_, i_84_, 21, 0,
				0, true);
		if (jagdx.a.f(IDirect3DDevice.StretchRect(
				(((Class_ra_Sub3_Sub2) this).aLong9847), l, i, i_82_, i_83_,
				i_84_, l_85_, 0, 0, i_83_, i_84_, 1))) {
			is = new int[i_83_ * i_84_];
			IDirect3DSurface.Download(l_85_, 0, 0, i_83_, i_84_, i_83_ * 4, 16,
					aLong8217);
			aByteBuffer8216.clear();
			aByteBuffer8216.asIntBuffer().get(is);
		}
	...
	public void fy(int i, int i_86_) {
		IDirect3DDevice.Clear(((Class_ra_Sub3_Sub2) this).aLong9847, i, i_86_,
				1.0F, 0);
	}

	public void fb(int i, int i_87_) {
		IDirect3DDevice.Clear(((Class_ra_Sub3_Sub2) this).aLong9847, i, i_87_,
				1.0F, 0);
	}

	public void fh(int i, int i_88_) {
		IDirect3DDevice.Clear(((Class_ra_Sub3_Sub2) this).aLong9847, i, i_88_,
				1.0F, 0);
	}

	public void fn(int i, int i_89_) {
		IDirect3DDevice.Clear(((Class_ra_Sub3_Sub2) this).aLong9847, i, i_89_,
				1.0F, 0);
	}

	public Class66 method4986(Class66 class66, Class66 class66_90_, float f,
			Class66 class66_91_) {
	...
	void method5556() {
		for (int i = 0; i < anInt8347; i++) {
			IDirect3DDevice.SetSamplerState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), i, 7, 2);
			IDirect3DDevice.SetSamplerState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), i, 6, 2);
			IDirect3DDevice.SetSamplerState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), i, 5, 2);
			IDirect3DDevice.SetSamplerState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), i, 1, 1);
			IDirect3DDevice.SetSamplerState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), i, 2, 1);
		...
		IDirect3DDevice.SetTextureStageState(
				(((Class_ra_Sub3_Sub2) this).aLong9847), 0, 6, 1);
		IDirect3DDevice.SetRenderState(((Class_ra_Sub3_Sub2) this).aLong9847,
				9, 2);
		IDirect3DDevice.SetRenderState(((Class_ra_Sub3_Sub2) this).aLong9847,
				23, 4);
	...
	void method5557() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(2106468652); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -100)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
			interface11.method135();
	...
	void method5558() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(2053650484); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -111)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
			interface11.method135();
	...
	void method5559() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(1978045823); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -62)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
			interface11.method133();
	...
	void method5560() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(2005791940); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -120)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
			interface11.method133();
	...
	public final void method5362(Class187 class187, int i, int i_93_,
			int i_94_, int i_95_) {
		if (((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860 != null)
			((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860.method1229();
		IDirect3DDevice.DrawIndexedPrimitive(
				(((Class_ra_Sub3_Sub2) this).aLong9847), method5567(class187),
				0, i, i_93_, i_94_, i_95_);
	}
	...
	void method5400() {
		...
		for (i = 0; i < anInt8296; i++) {
			...
			D3DLIGHT.SetPosition(((Class_ra_Sub3_Sub2) this).aLong9863,
					(float) class298_sub10.method2895(823958259),
					(float) class298_sub10.method2894(-1567954297),
					(float) class298_sub10.method2897((byte) 5));
			D3DLIGHT.SetDiffuse(((Class_ra_Sub3_Sub2) this).aLong9863,
					(float) (i_97_ >> 16 & 0xff) * f,
					(float) (i_97_ >> 8 & 0xff) * f,
					(float) (i_97_ & 0xff) * f, 0.0F);
			D3DLIGHT.SetAttenuation(((Class_ra_Sub3_Sub2) this).aLong9863,
					0.0F, 0.0F, 1.0F / (float) (class298_sub10
							.method2900(-62352346) * class298_sub10
							.method2900(-235041618)));
			D3DLIGHT.SetRange(((Class_ra_Sub3_Sub2) this).aLong9863,
					(float) class298_sub10.method2900(-970124596));
			IDirect3DDevice.SetLight(((Class_ra_Sub3_Sub2) this).aLong9847,
					i_96_, ((Class_ra_Sub3_Sub2) this).aLong9863);
			IDirect3DDevice.LightEnable(((Class_ra_Sub3_Sub2) this).aLong9847,
					i_96_, true);
		}
		for (/**/; i < anInt8295; i++)
	...
	Interface9_Impl2 method5433(Class55 class55, Class77 class77, int i,
			int i_98_) {
		return new Class200_Sub3(this, class55, class77, i, i_98_);
	}

	Interface9_Impl2 method5468(Class55 class55, int i, int i_99_,
			boolean bool, byte[] is, int i_100_, int i_101_) {
		return new Class200_Sub3(this, class55, i, i_99_, bool, is, i_100_,
				i_101_);
	}

	Interface9_Impl2 method5370(Class55 class55, int i, int i_102_,
			boolean bool, byte[] is, int i_103_, int i_104_) {
		return new Class200_Sub3(this, class55, i, i_102_, bool, is, i_103_,
				i_104_);
	}

	Interface9_Impl2 method5515(Class55 class55, int i, int i_105_,
			boolean bool, byte[] is, int i_106_, int i_107_) {
		return new Class200_Sub3(this, class55, i, i_105_, bool, is, i_106_,
				i_107_);
	}

	Interface9_Impl2 method5470(Class55 class55, int i, int i_108_,
			boolean bool, float[] fs, int i_109_, int i_110_) {
		return new Class200_Sub3(this, class55, i, i_108_, bool, fs, i_109_,
				i_110_);
	}

	Interface9_Impl2 method5471(Class55 class55, int i, int i_111_,
			boolean bool, float[] fs, int i_112_, int i_113_) {
		return new Class200_Sub3(this, class55, i, i_111_, bool, fs, i_112_,
				i_113_);
	}

	Interface9_Impl2 method5472(Class55 class55, int i, int i_114_,
			boolean bool, float[] fs, int i_115_, int i_116_) {
		return new Class200_Sub3(this, class55, i, i_114_, bool, fs, i_115_,
				i_116_);
	}

	void method5306() {
		for (Class298 class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5967(1665102883); class298 != null; class298 = ((Class_ra_Sub3_Sub2) this).aClass458_9851
				.method5969((byte) -18)) {
			Class298_Sub21 class298_sub21 = (Class298_Sub21) class298;
			Interface11 interface11 = ((Class298_Sub21) class298_sub21).anInterface11_7315;
			interface11.method135();
	...
	final void method5562(Class200_Sub3 class200_sub3) {
		...
		if (((Class_ra_Sub3_Sub2) this).aBooleanArray9862[anInt8325] != ((Class200_Sub3) class200_sub3).aBoolean8631) {
			IDirect3DDevice.SetSamplerState(
					((Class_ra_Sub3_Sub2) this).aLong9847, anInt8325, 1,
					((Class200_Sub3) class200_sub3).aBoolean8631 ? 1 : 3);
		...
		if (((Class_ra_Sub3_Sub2) this).aBooleanArray9856[anInt8325] != ((Class200_Sub3) class200_sub3).aBoolean8632) {
			IDirect3DDevice.SetSamplerState(
					((Class_ra_Sub3_Sub2) this).aLong9847, anInt8325, 2,
					((Class200_Sub3) class200_sub3).aBoolean8632 ? 1 : 3);
	...
	Interface9_Impl3 method5478(Class55 class55, int i, int i_118_, int i_119_,
			boolean bool, byte[] is) {
		return new Class200_Sub1(this, class55, i, i_118_, i_119_, bool, is);
	}

	Interface9_Impl2_Impl1 method5479(Class55 class55, Class77 class77, int i,
			int i_120_) {
	...
	void method5457() {
		if (aBoolean8214) {
			...
			D3DLIGHT.SetDiffuse(((Class_ra_Sub3_Sub2) this).aLong9853, f
					* aFloat8362, f * aFloat8289, f * aFloat8290, 0.0F);
			D3DLIGHT.SetDiffuse(((Class_ra_Sub3_Sub2) this).aLong9867, f_121_
					* aFloat8362, f_121_ * aFloat8289, f_121_ * aFloat8290,
					0.0F);
			((Class_ra_Sub3_Sub2) this).aBoolean9854 = false;
		}
	}

	Interface9_Impl2_Impl1 method5413(Class55 class55, Class77 class77, int i,
			int i_122_) {
	...
	final void method5482(int i, Class183 class183, boolean bool,
			boolean bool_123_) {
		if (aBoolean8214) {
			int i_124_ = 0;
			int i_125_;
			...
			if (bool_123_)
				i_124_ |= 0x10;
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, i_125_,
					(method5547(class183) | i_124_));
		}
	}

	final void method5319(int i, Class183 class183, boolean bool,
			boolean bool_126_) {
		if (aBoolean8214) {
			int i_127_ = 0;
			int i_128_;
			...
			if (bool_126_)
				i_127_ |= 0x10;
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, i_128_,
					(method5547(class183) | i_127_));
		}
	}
	...
	final void method5484(int i, Class183 class183, boolean bool) {
		if (aBoolean8214) {
			...
			if (bool)
				i_130_ |= 0x10;
			IDirect3DDevice.SetTextureStageState(
					(((Class_ra_Sub3_Sub2) this).aLong9847), anInt8325, i_131_,
					(method5547(class183) | i_130_));
		}
	}
	...
	Interface9_Impl3 method5416(Class55 class55, int i, int i_132_, int i_133_,
			boolean bool, byte[] is) {
	...
	public Class66 method5142(Class66 class66, Class66 class66_134_, float f,
			Class66 class66_135_) {
	...
	public final void method5514(Class187 class187, int i, int i_136_) {
		if (((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860 != null)
			((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860.method1229();
		IDirect3DDevice.DrawPrimitive(((Class_ra_Sub3_Sub2) this).aLong9847,
				method5567(class187), i, i_136_);
	}

	public final void method5354(Class187 class187, int i, int i_137_,
			int i_138_, int i_139_) {
		if (((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860 != null)
			((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860.method1229();
		IDirect3DDevice.DrawIndexedPrimitive(
				(((Class_ra_Sub3_Sub2) this).aLong9847), method5567(class187),
				0, i, i_137_, i_138_, i_139_);
	}

	public final void method5449(Class187 class187, int i, int i_140_,
			int i_141_, int i_142_) {
		if (((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860 != null)
			((Class_ra_Sub3_Sub2) this).aClass110_Sub1_9860.method1229();
		IDirect3DDevice.DrawIndexedPrimitive(
				(((Class_ra_Sub3_Sub2) this).aLong9847), method5567(class187),
				0, i, i_140_, i_141_, i_142_);
	}
	...
	Interface9_Impl2 method5473(int i, int i_143_, boolean bool, int[] is,
	...
	static GraphicsToolkit method5563(Canvas canvas, Interface_ma interface_ma,
			Class243 class243, Integer integer) {
		Class_ra_Sub3_Sub2 class_ra_sub3_sub2 = null;
		...
		try {
			...
			d3dpresent_parameters.BackBufferCount = 1;
			d3dpresent_parameters.PresentationInterval = -2147483648;
			if (!method5551(i, i_148_, l, integer.intValue(),
					d3dpresent_parameters))
				throw new RuntimeException("");
			int i_149_ = 0;
			if ((d3dcaps.DevCaps & 0x100000) != 0)
			...
			long l_150_ = 0L;
			try {
				l_150_ = IDirect3D.CreateDeviceContext(l, i, i_148_, canvas,
						i_149_ | 0x40, d3dpresent_parameters);
			} catch (u var_u) {
				l_150_ = IDirect3D.CreateDeviceContext(l, i, i_148_, canvas,
						i_149_ & ~0x100000 | 0x20, d3dpresent_parameters);
			}
			class_ra_sub3_sub2 = new Class_ra_Sub3_Sub2(i, i_148_, l, l_150_,
					d3dpresent_parameters, d3dcaps, interface_ma, class243,
					integer.intValue());
			if (!class_ra_sub3_sub2.aHashtable5313.containsKey(canvas)) {
	...
	public final void method5516(Class187 class187, int i, int i_151_,
		...
		IDirect3DDevice.DrawIndexedPrimitive(
				(((Class_ra_Sub3_Sub2) this).aLong9847), method5567(class187),
				0, i, i_151_, i_152_, i_153_);
	}

	Interface9_Impl2_Impl1 method5391(Class55 class55, Class77 class77, int i,
			int i_154_) {
	...
	public void method5520(Class233 class233, Class233 class233_156_,
			Class233 class233_157_) {
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847,
				256, class233.aFloatArray2594);
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847, 2,
				class233_156_.aFloatArray2594);
		IDirect3DDevice.SetTransform(((Class_ra_Sub3_Sub2) this).aLong9847, 3,
				class233_157_.aFloatArray2594);
	}
	...
	final void method5566(long l) {
		IDirect3DDevice
				.SetPixelShader(((Class_ra_Sub3_Sub2) this).aLong9847, l);
	}
