...
final class Class382 implements Interface22 {
	...
	public void method245(int i, int i_0_, int i_1_, short i_2_) {
		try {
			...
			synchronized (ClientScriptsExecutor.aQueue4124) {
				ClientScriptsExecutor.aQueue4124.add(Class68.method785(i_3_, i_4_, i_0_,
						i_1_, (byte) 15));
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pw.f(").append(')').toString());
		}
	}
	...
	public void method246(int i, int i_5_, int i_6_) {
		...
		int i_8_ = i & 0xffff;
		synchronized (ClientScriptsExecutor.aQueue4124) {
			ClientScriptsExecutor.aQueue4124.add(Class68.method785(i_7_, i_8_, i_5_, i_6_,
					(byte) 15));
		}
	}
	...
	static final void method4687(Class403 class403, int i) {
		try {
			...
			Class158.idx8.method2310(Class362.anInt3918 * 142643703,
					-457216440);
			Class158.idx8.method2310(
					Class422_Sub14.anInt8400 * 1757615047, -457216440);
			Class158.idx8.method2310(1049272911 * ClanSettings.anInt1680,
					-457216440);
			Class158.idx8.method2310(-745532315 * Class361.anInt3914,
					-457216440);
			Class158.idx8.method2310(Class260.anInt2820 * -684155443,
					-457216440);
			Class158.idx8.method2310(
					Class242.anInt2710 * -2085188617, -457216440);
			Class173.aClass243_1758.method2310(
					-2085188617 * Class242.anInt2710, -457216440);
	...
	static final void method4688(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_9_ > i_10_ ? i_9_
					: i_10_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pw.zw(").append(')').toString());
		}
	}
		...
		try {
			...
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = new StringBuilder().append(string)
					.append(i_11_).toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pw.zi(").append(')').toString());
		}
	}
}
