...
public abstract class Class365_Sub1_Sub1 extends Class365_Sub1 {
	...
	Class365_Sub1_Sub1(Class331 class331, int i, int i_0_, int i_1_, int i_2_,
			int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, boolean bool,
			byte i_8_) {
		super(class331);
		plane = (byte) i;
		aByte7724 = (byte) i_0_;
	...
	int method4354(Class298_Sub10[] class298_sub10s, int i) {
		try {
			...
			if (((Class365_Sub1_Sub1) this).aByte9800 != 0) {
				int i_16_ = (aShort9798 - -804213305
						* ((Class331) aClass331_7722).anInt3553);
	...
	boolean method4360(int i) {
		try {
				...
				for (int i_25_ = aShort9795; i_25_ <= aShort9797; i_25_++) {
					...
					if (i_26_ >= 0) {
						if (i_26_ >= (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
							...
							int i_27_ = (i_25_
									- (465603579 * ((Class331) aClass331_7722).anInt3513) + (((Class331) aClass331_7722).anInt3538 * 583010427));
							if (i_27_ >= 0) {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajf.dq(").append(')').toString());
		}
	}

	boolean method4359(GraphicsToolkit class_ra) {
		return aClass331_7722.aClass333_3512.method4074(aByte7724, aShort9798,
				aShort9796, aShort9795, aShort9797, method4358(class_ra,
						(byte) 93));
	}
	...
	int method4390(Class298_Sub10[] class298_sub10s) {
		...
		if (((Class365_Sub1_Sub1) this).aByte9800 != 0) {
			int i_34_ = (aShort9798 - -804213305
					* ((Class331) aClass331_7722).anInt3553);
	...
	boolean method4364(GraphicsToolkit class_ra, byte i) {
		try {
			return (aClass331_7722.aClass333_3512.method4074(aByte7724,
					aShort9798, aShort9796, aShort9795, aShort9797, method4358(
							class_ra, (byte) -61)));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ajf.dl(").append(')').toString());
		}
	}
	...
	boolean method4395() {
		for (int i = aShort9798; i <= aShort9796; i++) {
			for (int i_42_ = aShort9795; i_42_ <= aShort9797; i_42_++) {
				...
				if (i_43_ >= 0
						&& i_43_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
					int i_44_ = (i_42_ - 465603579
							* ((Class331) aClass331_7722).anInt3513 + (((Class331) aClass331_7722).anInt3538 * 583010427));
					if (i_44_ >= 0
							&& i_44_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length
							&& (((Class331) aClass331_7722).aBooleanArrayArray3563[i_43_][i_44_]))
						return true;
				}
			}
		}
	...
	boolean method4396() {
		for (int i = aShort9798; i <= aShort9796; i++) {
			for (int i_45_ = aShort9795; i_45_ <= aShort9797; i_45_++) {
				...
				if (i_46_ >= 0
						&& i_46_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
					int i_47_ = (i_45_ - 465603579
							* ((Class331) aClass331_7722).anInt3513 + (((Class331) aClass331_7722).anInt3538 * 583010427));
					if (i_47_ >= 0
							&& i_47_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length
							&& (((Class331) aClass331_7722).aBooleanArrayArray3563[i_46_][i_47_]))
						return true;
				}
			}
		}
	...
	boolean method4397() {
		for (int i = aShort9798; i <= aShort9796; i++) {
			for (int i_48_ = aShort9795; i_48_ <= aShort9797; i_48_++) {
				...
				if (i_49_ >= 0
						&& i_49_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length) {
					int i_50_ = (i_48_ - 465603579
							* ((Class331) aClass331_7722).anInt3513 + (((Class331) aClass331_7722).anInt3538 * 583010427));
					if (i_50_ >= 0
							&& i_50_ < (((Class331) aClass331_7722).aBooleanArrayArray3563).length
							&& (((Class331) aClass331_7722).aBooleanArrayArray3563[i_49_][i_50_]))
						return true;
				}
			}
		}
