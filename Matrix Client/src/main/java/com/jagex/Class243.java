...
public final class Class243 {
	...
	synchronized boolean method2284(int i) {
		try {
			if (((Class243) this).aClass226_2713 == null) {
				((Class243) this).aClass226_2713 = ((Class243) this).aClass242_2720
						.method2250(2102263091);
				if (((Class243) this).aClass226_2713 == null)
					return false;
				((Class243) this).anObjectArray2717 = new Object[-1583970959
						* (((Class226) (((Class243) this).aClass226_2713)).anInt2521)];
				((Class243) this).anObjectArrayArray2718 = new Object[-1583970959
						* (((Class226) (((Class243) this).aClass226_2713)).anInt2521)][];
			}
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.a(").append(')').toString());
		}
	}
	...
	synchronized boolean method2286(int i, int i_0_, byte i_1_) {
		try {
			...
			if (i < 0
					|| i_0_ < 0
					|| i >= (((Class226) ((Class243) this).aClass226_2713).anIntArray2517).length
					|| i_0_ >= (((Class226) ((Class243) this).aClass226_2713).anIntArray2517[i])) {
				if (aBoolean2721)
					throw new IllegalArgumentException(new StringBuilder()
							.append(i).append(" ").append(i_0_).toString());
				return false;
			}
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.p(").append(')').toString());
		}
	}
	...
	synchronized void method2287(int i, byte i_2_) {
		try {
			if (((Class243) this).aBoolean2715)
				((Class243) this).anObjectArray2717[i] = ((Class243) this).aClass242_2720
						.method2251(i, (byte) -83);
			else
				((Class243) this).anObjectArray2717[i] = Class158.method1702(
						((Class243) this).aClass242_2720.method2251(i,
								(byte) -115), false, (short) -5444);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.i(").append(')').toString());
		}
	}
	...
	public synchronized byte[] getFile(int i, int i_4_, int[] is, int i_5_) {
		try {
			...
			if (null == ((Class243) this).anObjectArrayArray2718[i]
					|| null == ((Class243) this).anObjectArrayArray2718[i][i_4_]) {
			...
			if (((Class243) this).anObjectArrayArray2718[i][i_4_] == null) {
				...
				is_6_ = Class338.method4114(
						(((Class243) this).anObjectArrayArray2718[i][i_4_]),
						false, -390800011);
				if (is_6_ == null)
					throw new RuntimeException("");
			}
	...
	public synchronized boolean method2290(int i, int i_7_, int i_8_) {
		try {
			if (!method2286(i, i_7_, (byte) 52))
				return false;
			if (((Class243) this).anObjectArrayArray2718[i] != null
					&& ((Class243) this).anObjectArrayArray2718[i][i_7_] != null)
				return true;
	...
	public boolean method2295(String string, int i) {
		try {
			...
			int i_17_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -1973803814),
							867865737));
			if (i_17_ < 0)
				return false;
			return true;
	...
	public int method2299(int i, int i_20_) {
		try {
			if (!method2284(-1669476342))
				return -1;
			int i_21_ = ((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(i, 1079998267);
			if (!method2309(i_21_, (byte) 1))
				return -1;
			return i_21_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.w(").append(')').toString());
		}
	}
	...
	public boolean method2300(String string, String string_22_, byte i) {
		try {
			...
			int i_23_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -1984349791),
							728033014));
			if (i_23_ < 0)
				return false;
			int i_24_ = (((Class226) ((Class243) this).aClass226_2713).aClass112Array2528[i_23_]
					.method1239(Class244.method2328(string_22_, -2081152646),
							2090644563));
			if (i_24_ < 0)
				return false;
			return true;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.o(").append(')').toString());
		}
	}

	public synchronized byte[] method2301(String string, String string_25_,
			int i) {
		try {
			...
			int i_26_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -1961901970),
							1404802795));
			if (!method2309(i_26_, (byte) 1))
				return null;
			int i_27_ = (((Class226) ((Class243) this).aClass226_2713).aClass112Array2528[i_26_]
					.method1239(Class244.method2328(string_25_, -2059879258),
							838109915));
			return method2315(i_26_, i_27_, (byte) -34);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.l(").append(')').toString());
		}
	}
	...
	boolean method2302(String string, String string_28_, int i) {
		try {
			...
			int i_29_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -2027002851),
							906979105));
			if (!method2309(i_29_, (byte) 1))
				return false;
			int i_30_ = (((Class226) ((Class243) this).aClass226_2713).aClass112Array2528[i_29_]
					.method1239(Class244.method2328(string_28_, -2028561031),
							2121455333));
			return method2290(i_29_, i_30_, -1219568896);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.ax(").append(')').toString());
		}
	}
	...
	public void method2304(String string, int i) {
		try {
			if (method2284(1339347995)) {
				string = string.toLowerCase();
				int i_32_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
						.method1239(Class244.method2328(string, -2097971535),
								1493933726));
				method2288(i_32_, (byte) 98);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.ae(").append(')').toString());
		}
	}
	...
	public int method2305(String string, int i) {
		try {
			if (!method2284(2032881212))
				return 0;
			string = string.toLowerCase();
			int i_33_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -2069451291),
							96817353));
			return method2303(i_33_, (byte) 1);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.ao(").append(')').toString());
		}
	}
	...
	synchronized boolean method2306(int i, int i_34_, int[] is, byte i_35_) {
		try {
			...
			byte[] is_40_;
			if (null != is
					&& (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
				is_40_ = Class338.method4114(
						(((Class243) this).anObjectArray2717[i]), true,
						-858479492);
				RsByteBuffer class298_sub53 = new RsByteBuffer(is_40_);
				class298_sub53.method3612(is, 5,
						class298_sub53.buffer.length, -1429633724);
			} else
				is_40_ = Class338.method4114(
						(((Class243) this).anObjectArray2717[i]), false,
						-144584373);
			byte[] is_41_;
			try {
				...
				throw Class346
						.method4175(
								...
								new StringBuilder()
										...
										.append(i)
										.append(" ")
										.append(is_40_.length)
										.append(" ")
										.append(
												Class271.method2548(is_40_,
														is_40_.length,
														-1914018334))
										.append(" ")
										.append(
										...
										.append(" ")
										.append(
												((Class226) ((Class243) this).aClass226_2713).anIntArray2522[i])
										.append(" ")
										.append(
												1600327191 * (((Class226) (((Class243) this).aClass226_2713)).anInt2513))
										.toString());
			}
			if (((Class243) this).aBoolean2715)
			...
			if (i_36_ > 1) {
				if (2 != ((Class243) this).anInt2719 * -1870742467) {
					...
					for (int i_51_ = 0; i_51_ < i_43_; i_51_++) {
						...
						for (int i_53_ = 0; i_53_ < i_36_; i_53_++) {
							...
							System.arraycopy(is_41_, i_50_, is_48_[i_53_],
									is_44_[i_53_], i_52_);
							is_44_[i_53_] += i_52_;
							i_50_ += i_52_;
						}
					...
					for (int i_54_ = 0; i_54_ < i_36_; i_54_++) {
						...
						if (-1870742467 * ((Class243) this).anInt2719 == 0)
							objects[i_55_] = Class158.method1702(is_48_[i_54_],
									false, (short) -26522);
						else
					...
					for (int i_66_ = 0; i_66_ < i_57_; i_66_++) {
						...
						for (int i_68_ = 0; i_68_ < i_36_; i_68_++) {
							...
							if (null == is_37_)
								...
								i_69_ = is_37_[i_68_];
							if (i_69_ == i_34_) {
								System.arraycopy(is_41_, i_65_, is_64_, i_58_,
										i_67_);
								i_58_ += i_67_;
							}
							i_65_ += i_67_;
				...
				if (0 == ((Class243) this).anInt2719 * -1870742467)
					objects[i_70_] = Class158.method1702(is_41_, false,
							(short) -11343);
				else
	...
	synchronized boolean method2308(int i, int i_73_, int[] is) {
		...
		if (null != is
				&& (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
			is_78_ = Class338.method4114(
					((Class243) this).anObjectArray2717[i], true, -1017882504);
			RsByteBuffer class298_sub53 = new RsByteBuffer(is_78_);
			class298_sub53.method3612(is, 5,
					class298_sub53.buffer.length, -2120558016);
		} else
			is_78_ = Class338.method4114(
					((Class243) this).anObjectArray2717[i], false, 959051680);
		byte[] is_79_;
		try {
			...
			throw Class346
					.method4175(
							...
							new StringBuilder()
									...
									.append(i)
									.append(" ")
									.append(is_78_.length)
									.append(" ")
									.append(
											Class271.method2548(is_78_,
													is_78_.length, -2111183372))
									.append(" ")
									.append(
											Class271.method2548(is_78_,
													is_78_.length - 2,
		...
		if (i_74_ > 1) {
			if (2 != ((Class243) this).anInt2719 * -1870742467) {
				...
				for (int i_89_ = 0; i_89_ < i_81_; i_89_++) {
					...
					for (int i_91_ = 0; i_91_ < i_74_; i_91_++) {
						...
						System.arraycopy(is_79_, i_88_, is_86_[i_91_],
								is_82_[i_91_], i_90_);
						is_82_[i_91_] += i_90_;
						i_88_ += i_90_;
					}
				...
				for (int i_92_ = 0; i_92_ < i_74_; i_92_++) {
					...
					if (null == is_75_)
						...
						i_93_ = is_75_[i_92_];
					if (-1870742467 * ((Class243) this).anInt2719 == 0)
						objects[i_93_] = Class158.method1702(is_86_[i_92_],
								false, (short) 3420);
					else
				...
				for (int i_104_ = 0; i_104_ < i_95_; i_104_++) {
					...
					for (int i_106_ = 0; i_106_ < i_74_; i_106_++) {
						...
						if (i_107_ == i_73_) {
							System.arraycopy(is_79_, i_103_, is_102_, i_96_,
									i_105_);
							i_96_ += i_105_;
						}
						i_103_ += i_105_;
			...
			if (null == is_75_)
				...
				i_108_ = is_75_[0];
			if (0 == ((Class243) this).anInt2719 * -1870742467)
				objects[i_108_] = Class158.method1702(is_79_, false,
						(short) -45);
			else
	...
	synchronized boolean method2309(int i, byte i_109_) {
		try {
			...
			if (i < 0
					|| i >= (((Class226) ((Class243) this).aClass226_2713).anIntArray2517).length
					|| 0 == (((Class226) ((Class243) this).aClass226_2713).anIntArray2517[i])) {
				if (aBoolean2721)
	...
	public int method2311(String string, int i) {
		try {
			if (!method2284(1289573635))
				return -1;
			string = string.toLowerCase();
			int i_111_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -2067562497),
							403552753));
	...
	public boolean method2312(String string, int i) {
		try {
			if (!method2284(-492791802))
				return false;
			string = string.toLowerCase();
			int i_112_ = (((Class226) ((Class243) this).aClass226_2713).aClass112_2520
					.method1239(Class244.method2328(string, -2120237955),
							187766103));
			return method2291(i_112_, 1717306833);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.ak(").append(')').toString());
		}
	}
	...
	synchronized boolean method2314(int i, int i_114_, int[] is) {
		...
		if (null != is
				&& (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
			is_119_ = Class338.method4114(
					((Class243) this).anObjectArray2717[i], true, 1730830793);
			RsByteBuffer class298_sub53 = new RsByteBuffer(is_119_);
			class298_sub53.method3612(is, 5,
					class298_sub53.buffer.length, -458895567);
		} else
			is_119_ = Class338.method4114(
					((Class243) this).anObjectArray2717[i], false, 235085962);
		byte[] is_120_;
		try {
		...
		if (i_115_ > 1) {
			if (2 != ((Class243) this).anInt2719 * -1870742467) {
				...
				for (int i_130_ = 0; i_130_ < i_122_; i_130_++) {
					...
					for (int i_132_ = 0; i_132_ < i_115_; i_132_++) {
						...
						System.arraycopy(is_120_, i_129_, is_127_[i_132_],
				...
				for (int i_133_ = 0; i_133_ < i_115_; i_133_++) {
					...
					if (-1870742467 * ((Class243) this).anInt2719 == 0)
						objects[i_134_] = Class158.method1702(is_127_[i_133_],
								false, (short) -1311);
					else
				...
				for (int i_145_ = 0; i_145_ < i_136_; i_145_++) {
					...
					for (int i_147_ = 0; i_147_ < i_115_; i_147_++) {
						...
						if (i_148_ == i_114_) {
							System.arraycopy(is_120_, i_144_, is_143_, i_137_,
									i_146_);
							i_137_ += i_146_;
						}
						i_144_ += i_146_;
			...
			if (null == is_116_)
				...
				i_149_ = is_116_[0];
			if (0 == ((Class243) this).anInt2719 * -1870742467)
				objects[i_149_] = Class158.method1702(is_120_, false,
						(short) 7031);
			else
	...
	public int filesCount(int i, int i_152_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.h(").append(')').toString());
		}
	}

	static final void method2317(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			class105.anObjectArray1273 = Class128_Sub2.method1441(string,
					class403, -2046058202);
			class105.aBoolean1238 = true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.nf(").append(')').toString());
		}
	}

	static final void method2318(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (int) (Class122
					.method1319((byte) 1) / 86400000L) - 11745;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ke.aka(").append(')').toString());
		}
	}
}
