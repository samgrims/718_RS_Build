...
public class Class244 {
	...
	public void method2319(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kf.a(").append(')').toString());
		}
	}

	public boolean method2320(int i, int i_3_, int i_4_) {
		try {
			if (i < 0 || i_3_ < 0 || i >= aByteArrayArrayArray2731[1].length
					|| i_3_ >= aByteArrayArrayArray2731[1][i].length)
				return false;
	...
	int method2322(int i, int i_11_, int i_12_, int i_13_) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kf.p(").append(')').toString());
		}
	}

	static final void method2323(IComponentDefinition class105, Class119 class119,
	...
	static final void method2325(Class403 class403, byte i) {
		try {
			...
			Class118.method1293(i_15_ >> 14 & 0x3fff, i_15_ & 0x3fff,
					-548972447);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kf.aeb(").append(')').toString());
		}
	}
	...
	public static int method2328(CharSequence charsequence, int i) {
		try {
			...
			for (int i_20_ = 0; i_20_ < i_18_; i_20_++)
				i_19_ = ((i_19_ << 5) - i_19_ + Class124.method1387(
						charsequence.charAt(i_20_), 1088430238));
			return i_19_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kf.r(").append(')').toString());
		}
	}
	...
	static final void method2329(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kf.bw(").append(')').toString());
		}
	}

	public static void method2330(
			NPC class365_sub1_sub1_sub2_sub1, byte i) {
		try {
