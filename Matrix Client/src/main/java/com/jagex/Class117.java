...
public class Class117 {
	...
	static boolean method1275(byte i) {
		try {
			return Class492.method6184(Class144.aClass381_1563.aClass355_4116,
					-1677177503);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("et.f(").append(')').toString());
		}
	}
	...
	static String method1276(String string, byte i) {
		try {
			...
			if (string.startsWith("directlogin ")) {
				...
				if (i_8_ >= 0) {
					...
					string = new StringBuilder().append(
							string.substring(0, i_8_)).append(" ").toString();
			...
			if (null != string_6_)
				return new StringBuilder().append(string_6_).append(string)
						.toString();
			return string;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("et.z(").append(')').toString());
		}
	}

	static final void method1277(Class403 class403, byte i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class435
					.method5804(-1233866115 * client.anInt8752, (byte) -20) ? 1
					: 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("et.afp(").append(')').toString());
		}
	}
	...
	public static void method1278(byte i) {
		try {
			for (Class298_Sub49 class298_sub49 = ((Class298_Sub49) Class423.aClass437_5354
					.method5816(2005270396)); null != class298_sub49; class298_sub49 = (Class298_Sub49) Class423.aClass437_5354
					.method5815((byte) 63))
				Class285
						.method2710(
	...
	public static void method1280(int i, int i_11_, int i_12_) {
		try {
			Class298_Sub36 class298_sub36 = Class18.method359(
					OutcommingPacket.DIALOGUE_CONTINUE_PACKET,
					client.aClass25_8711.aClass449_330, (byte) 84);
	...
	static final void method1281(Class403 class403, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("et.adn(").append(')').toString());
		}
	}

	static void method1282(IComponentDefinition[] class105s, IComponentDefinition class105,
			...
			if (class105 == client.GAME_SCREENINTERFACE) {
				...
				for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
					...
					if (class365_sub1_sub1_sub2_sub2 != null)
						class365_sub1_sub1_sub2_sub2.method4442(i_13_, i_14_,
								bool, 1554634008);
				}
	...
	static final void method1283(Class403 class403, int i) {
		try {
			...
			Class298_Sub32_Sub34.method3364(class105, class119, class403,
					-125767294);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("et.nl(").append(')').toString());
		}
	}
			...
			if (class331 != null) {
				...
				if (0 == ((Class298_Sub1) class298_sub1).anInt7157 * -431456739)
					interface3 = ((Interface3) class331
							.method4031(
									2108312995 * (((Class298_Sub1) class298_sub1).anInt7151),
									(class298_sub1.anInt7150 * 634196087),
									(-2146829167 * class298_sub1.anInt7155),
									1297068206));
				if (((Class298_Sub1) class298_sub1).anInt7157 * -431456739 == 1)
					interface3 = ((Interface3) class331
							.method4033(
									2108312995 * (((Class298_Sub1) class298_sub1).anInt7151),
									(634196087 * class298_sub1.anInt7150),
				...
				if (2 == -431456739 * ((Class298_Sub1) class298_sub1).anInt7157)
					interface3 = ((Interface3) (class331
							.method4035(
									...
									class298_sub1.anInt7150 * 634196087,
									-2146829167 * class298_sub1.anInt7155,
									client.anInterface17_8960, -2076271452)));
				if (-431456739 * ((Class298_Sub1) class298_sub1).anInt7157 == 3)
					interface3 = ((Interface3) class331
							.method4058(
									...
									(byte) 16));
				if (interface3 != null) {
					((Class298_Sub1) class298_sub1).anInt7148 = interface3
							.method32((byte) 29) * 1182121109;
					((Class298_Sub1) class298_sub1).anInt7154 = interface3
							.method29(726839210)
							* -723189599;
					((Class298_Sub1) class298_sub1).anInt7161 = interface3
							.method30((short) 24143) * 1338356755;
				} else {
