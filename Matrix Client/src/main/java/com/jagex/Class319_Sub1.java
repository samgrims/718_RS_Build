...
public class Class319_Sub1 extends Class319 implements MouseListener,
	...
	void method3906(int i) {
		try {
			if (null != ((Class319_Sub1) this).aComponent7702) {
				((Class319_Sub1) this).aComponent7702
	...
	void method3908(int i, int i_2_, int i_3_, int i_4_, int i_5_) {
		try {
			Class298_Sub50_Sub1 class298_sub50_sub1 = Class523.method6333(i,
					i_2_, i_3_, Class122.method1319((byte) 1), i_4_,
					-1798824718);
			((Class319_Sub1) this).aClass453_7691.method5935(
					class298_sub50_sub1, 534328737);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.ai(").append(')').toString());
		}
	}
	...
	public synchronized void mouseClicked(MouseEvent mouseevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseClicked(").append(')').toString());
		}
	}
	...
	public synchronized void mouseEntered(MouseEvent mouseevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseEntered(").append(')').toString());
		}
	}
	...
	public synchronized void mouseExited(MouseEvent mouseevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseExited(").append(')').toString());
		}
	}
	...
	public synchronized void mousePressed(MouseEvent mouseevent) {
		try {
			...
			if (1 == i)
				method3908(0, mouseevent.getX(), mouseevent.getY(), mouseevent
						.getClickCount(), 1989072538);
			else if (i == 4)
				method3908(2, mouseevent.getX(), mouseevent.getY(), mouseevent
						.getClickCount(), 1922972976);
			else if (2 == i)
				method3908(1, mouseevent.getX(), mouseevent.getY(), mouseevent
						.getClickCount(), 2016030026);
			((Class319_Sub1) this).anInt7693 = ((2114498315 * ((Class319_Sub1) this).anInt7693 | i) * 1282483363);
			if (mouseevent.isPopupTrigger())
				mouseevent.consume();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mousePressed(").append(')').toString());
		}
	}
	...
	public synchronized void mouseReleased(MouseEvent mouseevent) {
		try {
			...
			if ((i & 0x1) != 0)
				method3908(3, mouseevent.getX(), mouseevent.getY(), mouseevent
						.getClickCount(), 1931509920);
			if ((i & 0x4) != 0)
				method3908(5, mouseevent.getX(), mouseevent.getY(), mouseevent
						.getClickCount(), 1062616351);
			if ((i & 0x2) != 0)
				method3908(4, mouseevent.getX(), mouseevent.getY(), mouseevent
						.getClickCount(), 1204760399);
			((Class319_Sub1) this).anInt7693 = (((Class319_Sub1) this).anInt7693 * 2114498315 & (i ^ 0xffffffff)) * 1282483363;
			if (mouseevent.isPopupTrigger())
				mouseevent.consume();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseReleased(").append(')').toString());
		}
	}
	...
	public synchronized void mouseDragged(MouseEvent mouseevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseDragged(").append(')').toString());
		}
	}
	...
	public synchronized void mouseMoved(MouseEvent mouseevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseMoved(").append(')').toString());
		}
	}
	...
	public synchronized void mouseWheelMoved(MouseWheelEvent mousewheelevent) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.mouseWheelMoved(").append(')').toString());
		}
	}

	public synchronized void method3877() {
		((Class319_Sub1) this).anInt7694 = ((Class319_Sub1) this).anInt7698
				* -867321853;
		((Class319_Sub1) this).anInt7700 = ((Class319_Sub1) this).anInt7699
				* -1698396671;
	...
	public Class298_Sub50 method3896() {
		return ((Class298_Sub50) ((Class319_Sub1) this).aClass453_7697
				.method5936(2123266868));
	}

	public Class298_Sub50 method3885() {
		return ((Class298_Sub50) ((Class319_Sub1) this).aClass453_7697
				.method5936(2127727655));
	}
	...
	public Class298_Sub50 method3879(int i) {
		try {
			return (Class298_Sub50) ((Class319_Sub1) this).aClass453_7697
					.method5936(2114584348);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aci.r(").append(')').toString());
		}
	}
