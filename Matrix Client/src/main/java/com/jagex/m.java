...
public class m extends Class264 implements Interface25 {
	...
	void method2486(char c, int i, int i_4_, int i_5_, boolean bool,
	...
	native void n(ja var_ja, ba var_ba, byte[][] is, int[] is_10_,
	...
	m(ja var_ja, ba var_ba, Class505 class505, IndexedImage[] class89s,
			Class57[] class57s) {
	...
	native void bd(ja var_ja, ba var_ba, byte[][] is, int[] is_30_,
			int[] is_31_, int[] is_32_, int[] is_33_);

	native void bf(char c, int i, int i_34_, int i_35_, boolean bool,
			Class_ta class_ta, int i_36_, int i_37_);

	native void be(char c, int i, int i_38_, int i_39_, boolean bool,
			Class_ta class_ta, int i_40_, int i_41_);
}
