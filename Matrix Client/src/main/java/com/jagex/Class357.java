	...
	static final void method4274(Class403 class403, int i) {
		try {
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = ((Class403) class403).aClass162_5252.aString1654;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ox.xl(").append(')').toString());
		}
	}
	...
	static String method4275(long l, int i, short i_0_) {
		try {
			...
			return new StringBuilder().append(Integer.toString(i_1_ / 10))
					.append(i_1_ % 10).append("/").append(i_2_ / 10).append(
							i_2_ % 10).append("/").append(i_3_ % 100 / 10)
					.append(i_3_ % 10).toString();
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ox.p(").append(')').toString());
		}
	}

	public static void method4276(int i, int i_4_, int i_5_, boolean bool,
			int i_6_) {
		try {
			client.aLong8798 = 0L;
