...
public class Class26 {
	...
	static {
		...
		aString352 = ")";
		aString351 = "->";
		aString354 = AppletLoader.IP;//"127.0.0.1";
		aString350 = "<br>";
		aString356 = "</col>";
	}
	...
	static final void method396(Class403 class403, short i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242
					.method4363((byte) 51);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("b.apg(").append(')').toString());
		}
	}

	public static int method397(CharSequence charsequence,
			CharSequence charsequence_0_, Class429 class429, int i) {
		try {
			...
			while_59_: do {
				...
				for (;;) {
					...
					if (c_7_ != c_6_
							&& (Character.toUpperCase(c_6_) != Character
									.toUpperCase(c_7_))) {
				...
				return (Class367.method4550(c_6_, class429, 82862076) - Class367
						.method4550(c_7_, class429, -2040847947));
			} while (false);
			...
			for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
				...
				if (c_10_ != c_11_
					...
					if (c_11_ != c_10_)
						return (Class367.method4550(c_10_, class429,
								-1920723606) - Class367.method4550(c_11_,
								class429, -495715201));
				}
			}
			int i_12_ = i_1_ - i_2_;
			...
			for (int i_13_ = 0; i_13_ < i_8_; i_13_++) {
				...
				if (c_15_ != c_14_)
					return (Class367.method4550(c_14_, class429, -129620717) - Class367
							.method4550(c_15_, class429, -153765629));
			}
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("b.a(").append(')').toString());
		}
	}
	...
	static final void method399(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400
					.getItemDefinitions(i_18_).aBoolean5731) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("b.aak(").append(')').toString());
		}
	}
}
