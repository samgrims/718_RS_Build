...
public class Class141 implements Interface6 {
			...
			if (bool)
				Class373.aClass_ra4071
						.B(
								...
								1751631615 * ((Class141) this).aClass145_6389.anInt6344,
								0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fs.f(").append(')').toString());
		}
	}
	...
	public void method56(boolean bool) {
		if (bool)
			Class373.aClass_ra4071.B(0, 0, Class462.anInt5683 * -2110394505,
					(-1111710645 * Class298_Sub40_Sub9.anInt9716),
					1751631615 * (((Class141) this).aClass145_6389.anInt6344),
					0);
	}
		...
		try {
			if (null != Class300.aClass303_3202) {
				Class217 class217 = (Class217
						.method2005(Class287.myPlayer
								.method4337().aClass217_2599));
				Class341 class341 = client.aClass283_8716.method2628(681479919);
				class217.aFloat2451 += (float) (class341.gameSceneBaseX
						* -1760580017 << 9);
				class217.aFloat2454 += (float) (class341.gameSceneBaseY * 283514611 << 9);
				class217
						.method2010(
								(float) (((Class303) Class300.aClass303_3202).anInt3264 * -1640118043),
								class217.aFloat2455,
								(float) (((Class303) Class300.aClass303_3202).anInt3261 * 827958915));
				...
				if (f < (float) (-1052008745 * (((Class303) Class300.aClass303_3202).anInt3262)))
					...
					f_0_ = 1.0F
							- f
							/ (float) ((((Class303) Class300.aClass303_3202).anInt3260) * 356734275);
				}
				IComponentDefinition.method1136((int) (256.0F * f_0_), 497351807);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fs.h(").append(')').toString());
		}
	}

	public static GraphicsToolkit method1562(Canvas canvas, Interface_ma interface_ma,
	...
	static final void method1564(Class403 class403, int i) {
		try {
			...
			Class119 class119 = ((Class390) class390).aClass119_4167;
			Class21
					.method365(class105, class119, false, 0, class403,
							317795036);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("fs.hg(").append(')').toString());
		}
	}
