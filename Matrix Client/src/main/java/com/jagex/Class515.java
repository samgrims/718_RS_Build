...
public class Class515 {
	...
	public Class510[] method6294(int i, int i_0_) {
		try {
			...
			if (!((Class521) class521).aBoolean6279
					|| ((Class521) class521).aClass510Array6280.length <= 1)
			...
			System.arraycopy(((Class521) class521).aClass510Array6280, 0,
					class510s, 0, class510s.length);
			for (int i_2_ = i_1_; i_2_ < class510s.length; i_2_++) {
				int i_3_ = (Class298_Sub19_Sub3.method3039(random,
						class510s.length - i_1_, (byte) -54) + i_1_);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vo.b(").append(')').toString());
		}
	}

	public Class509 method6295(int i, byte i_4_) {
		try {
			byte[] is = ((Class515) this).aClass243_6229.method2315(i, 0,
					(byte) -111);
	...
	public Class515(Class411 class411, Class429 class429, Class243 class243) {
		...
		RsByteBuffer class298_sub53 = new RsByteBuffer(
				((Class515) this).aClass243_6229.method2315(0, 0, (byte) -99));
		int i = ((null == class298_sub53.buffer || class298_sub53.buffer.length < 1) ? -1
		...
		if (i < 4) {
			...
			if (bool) {
				...
				int i_11_;
				if (i > 2) {
					((Class515) this).anInt6232 = class298_sub53
							.readShort(1770899550) * 818506755;
				...
				for (int i_12_ = 0; i_12_ < i_8_; i_12_++) {
					...
					if (((Class515) this).anInt6232 * -644243797 == -1) {
						...
						((Class515) this).aClass521Array6230[i_13_] = new Class521(
								bool_14_, class510s);
					} else {
						class510s = new Class510[1 + i_15_];
						class510s[0] = new Class510(
								(-644243797 * ((Class515) this).anInt6232),
								i_10_, i_11_);
						for (int i_20_ = 0; i_20_ < i_15_; i_20_++) {
							...
							class510s[i_20_ + 1] = new Class510(i_21_, i_22_,
									i_23_);
						}
					}
					((Class515) this).aClass521Array6230[i_13_] = new Class521(
				...
				for (int i_24_ = 0; i_24_ < i_9_ + 1; i_24_++) {
					if (null == ((Class515) this).aClass521Array6230[i_24_])
						((Class515) this).aClass521Array6230[i_24_] = method6297(
								i_10_, i_11_, 1315448185);
				}
			} else {
				((Class515) this).aClass521Array6230 = new Class521[0];
				((Class515) this).anInt6232 = -818506755;
	...
	Class521 method6297(int i, int i_25_, int i_26_) {
		try {
			...
			Class510 class510 = new Class510(((Class515) this).anInt6232
					* -644243797, i, i_25_);
			return new Class521(false, new Class510[] { class510 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("vo.a(").append(')').toString());
		}
	}
