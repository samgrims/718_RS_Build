...
public class Class473 {
	...
	void method6066(RsByteBuffer class298_sub53, int i, int i_0_) {
		try {
			if (1 == i)
				aChar5968 = Class493.method6190(class298_sub53
						.readByte(-12558881), 2112352543);
			else if (i == 2)
				anInt5969 = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tm.f(").append(')').toString());
		}
	}
	...
	void method6067(RsByteBuffer class298_sub53, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tm.a(").append(')').toString());
		}
	}

	static final void method6068(
			Entity class365_sub1_sub1_sub2, byte i) {
		try {
			Class438 class438 = class365_sub1_sub1_sub2.aClass438_10077;
			if (class438.method5819((byte) -67)
					&& class438.method5822(1, 1987990558)
					&& class438.method5832(-1549707079)) {
				if (class365_sub1_sub1_sub2.aBoolean10094) {
					class438.method5841(class365_sub1_sub1_sub2.method4426(
							-646688457).method4208(-2063556157), false, true,
							(byte) 71);
			...
			for (int i_2_ = 0; i_2_ < class365_sub1_sub1_sub2.currentGraphics.length; i_2_++) {
				if (-1 != -967533709
						* (class365_sub1_sub1_sub2.currentGraphics[i_2_].id)) {
					...
					if (class438_3_.method5826(-65534)) {
						...
						if (class398.aBoolean5215) {
							...
							} else if (1 == class391.anInt4182 * 62820525
									&& (class365_sub1_sub1_sub2.anInt10125 * 1888275831) > 0
									&& ((-412225079 * (class365_sub1_sub1_sub2.anInt10095)) <= 443738891 * client.anInt8884)
									&& ((1450943713 * (class365_sub1_sub1_sub2.anInt10103)) < 443738891 * client.anInt8884)) {
								if (i <= 0)
									throw new IllegalStateException();
								continue;
			...
			do {
				if (class438_4_.method5819((byte) -111)) {
					...
					if (class391.anInt4182 * 62820525 == 3) {
						...
						if (1888275831 * class365_sub1_sub1_sub2.anInt10125 > 0
								&& (class365_sub1_sub1_sub2.anInt10095
										* -412225079 <= 443738891 * client.anInt8884)
								&& (class365_sub1_sub1_sub2.anInt10103 * 1450943713 < 443738891 * client.anInt8884)) {
			...
			for (int i_5_ = 0; i_5_ < (class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112).length; i_5_++) {
				...
				else if (class438_sub2_sub1.method5822(1, 1635339259)
						&& class438_sub2_sub1.method5832(-1916061004))
					class365_sub1_sub1_sub2.aClass438_Sub2_Sub1Array10112[i_5_] = null;
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tm.if(").append(')').toString());
		}
	}
	...
	static void method6070(int i) {
		try {
			if (client.aByteArray8843 != null)
				...
				Class86.method966(Class360.username, Class360.password,
						(short) 5737);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("tm.a(").append(')').toString());
