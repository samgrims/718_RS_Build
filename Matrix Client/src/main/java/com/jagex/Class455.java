...
public class Class455 {
	...
	void method5955(byte[] is, int i, int i_9_) {
		try {
			...
			while (((Class455) this).anInt5656 * 1412698381 < 32)
				((Class455) this).aByteArray5654[((((Class455) this).anInt5656 += -715643451) * 1412698381 - 1)] = (byte) 0;
			System.arraycopy(((Class455) this).aByteArray5653, 0,
					((Class455) this).aByteArray5654, 32, 32);
			method5956((byte) 4);
			int i_10_ = 0;
			int i_11_ = i;
			while (i_10_ < 8) {
	...
	static {
		for (int i = 0; i < 256; i++) {
			...
			if (l_16_ >= 256L)
				l_16_ ^= 0x11dL;
			long l_17_ = l_16_ ^ l;
			aLongArrayArray5651[0][i] = (l << 56 | l << 48 | l_14_ << 40
					| l << 32 | l_16_ << 24 | l_15_ << 16 | l_13_ << 8 | l_17_);
		...
		for (int i = 1; i <= 10; i++) {
			int i_19_ = (i - 1) * 8;
			aLongArray5652[i] = (aLongArrayArray5651[0][i_19_]
					& ~0xffffffffffffffL ^ aLongArrayArray5651[1][i_19_ + 1]
					& 0xff000000000000L ^ aLongArrayArray5651[2][2 + i_19_]
					& 0xff0000000000L ^ aLongArrayArray5651[3][i_19_ + 3]
					& 0xff00000000L ^ aLongArrayArray5651[4][4 + i_19_]
					& 0xff000000L ^ aLongArrayArray5651[5][5 + i_19_]
					& 0xff0000L ^ aLongArrayArray5651[6][6 + i_19_] & 0xff00L ^ aLongArrayArray5651[7][7 + i_19_] & 0xffL);
		}
	}
	...
	void method5956(byte i) {
		try {
			...
			int i_21_ = 0;
			while (i_20_ < 8) {
				((Class455) this).aLongArray5660[i_20_] = ((long) ((Class455) this).aByteArray5654[i_21_] << 56
						^ ((long) ((Class455) this).aByteArray5654[1 + i_21_] & 0xffL) << 48
						^ ((long) ((Class455) this).aByteArray5654[2 + i_21_] & 0xffL) << 40
						^ ((long) ((Class455) this).aByteArray5654[i_21_ + 3] & 0xffL) << 32
						^ ((long) ((Class455) this).aByteArray5654[4 + i_21_] & 0xffL) << 24
						^ ((long) ((Class455) this).aByteArray5654[5 + i_21_] & 0xffL) << 16
			...
			for (i_20_ = 1; i_20_ <= 10; i_20_++) {
				for (i_21_ = 0; i_21_ < 8; i_21_++) {
					...
					int i_23_ = 56;
					while (i_22_ < 8) {
						((Class455) this).aLongArray5659[i_21_] ^= (aLongArrayArray5651[i_22_][(int) ((((Class455) this).aLongArray5657[i_21_
								- i_22_ & 0x7]) >>> i_23_) & 0xff]);
						i_22_++;
						i_23_ -= 8;
					}
				}
				...
				for (i_21_ = 0; i_21_ < 8; i_21_++) {
					...
					int i_25_ = 56;
					while (i_24_ < 8) {
						((Class455) this).aLongArray5659[i_21_] ^= (aLongArrayArray5651[i_24_][(int) ((((Class455) this).aLongArray5661[i_21_
								- i_24_ & 0x7]) >>> i_25_) & 0xff]);
						i_24_++;
						i_25_ -= 8;
					}
				}
	...
	public static void method5957(int i, int i_26_, int i_27_, int i_28_,
			int i_29_, int i_30_, int i_31_, int i_32_) {
		try {
			if (i_27_ == i_28_)
				Class285.method2712(i, i_26_, i_27_, i_29_, i_30_, i_31_,
						-790065680);
			else if (i - i_27_ >= -1424479739 * Class372_Sub1_Sub1.anInt4051
					&& i_27_ + i <= Class372_Sub1_Sub1.anInt4048 * 1135094847
					&& (i_26_ - i_28_ >= 1155384281 * Class372_Sub1_Sub1.anInt4049)
					&& (i_26_ + i_28_ <= -1062447355
							* Class372_Sub1_Sub1.anInt4050))
				Class298_Sub27.method3107(i, i_26_, i_27_, i_28_, i_29_, i_30_,
						i_31_, (byte) 121);
			else
				Class422_Sub13.method5676(i, i_26_, i_27_, i_28_, i_29_, i_30_,
						i_31_, -568588475);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("st.ae(").append(')').toString());
		}
	}

	static void method5958(GraphicsToolkit class_ra, int i, int i_33_,
			IComponentDefinition class105, int i_34_, int i_35_) {
		try {
