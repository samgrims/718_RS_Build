...
public class Class298_Sub5 extends Class298 {
	...
	void method2856(int i, int i_0_, int i_1_) {
		((Class298_Sub5) this).anIntArray7200[i_0_
				* (((Class298_Sub5) this).aClass_xa_Sub3_7194.anInt6287 * -506105871)
				+ i] |= 1 << i_1_;
	}

	void method2857(int i, int i_2_, int i_3_, float f) {
		if (((Class298_Sub5) this).anInt7199 != -1) {
			Class53 class53 = ((Class298_Sub5) this).aClass_ra_Sub2_7197.anInterface_ma5299
					.method174(((Class298_Sub5) this).anInt7199, 1908731420);
			...
			if (i_4_ != 0 && class53.aByte529 != 4) {
				...
				if (i_4_ == 256)
					...
					int i_6_ = i_4_;
					int i_7_ = 256 - i_4_;
					i_2_ = (((i_5_ & 0xff00ff) * i_6_ + (i_2_ & 0xff00ff)
							* i_7_ & ~0xff00ff) + ((i_5_ & 0xff00) * i_6_
							+ (i_2_ & 0xff00) * i_7_ & 0xff0000)) >> 8;
				}
			}
	...
	void method2859(int i) {
		((Class298_Sub5) this).aNativeHeapBuffer7195 = ((Class_ra_Sub2) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aNativeHeap8181
				.f(i * 4, true);
		((Class298_Sub5) this).aStream7202 = new Stream(
				((Class298_Sub5) this).aNativeHeapBuffer7195);
	}

	void method2860(int i) {
		((Class298_Sub5) this).aStream7202.x();
		Interface1 interface1 = (((Class298_Sub5) this).aClass_ra_Sub2_7197
				.method5245(4, ((Class298_Sub5) this).aNativeHeapBuffer7195,
						i * 4, false));
		if (interface1 instanceof Class40_Sub2)
			((Class298_Sub5) this).aNativeHeapBuffer7195.t();
		((Class298_Sub5) this).aClass32_7193 = new Class32(interface1, 5121, 4,
				0);
	...
	Class298_Sub5(Class_xa_Sub3 class_xa_sub3, int i, int i_15_, Class78 class78) {
		...
		((Class298_Sub5) this).anIntArray7200 = new int[(((Class298_Sub5) this).aClass_xa_Sub3_7194.anInt6287
				* -506105871 * (((Class298_Sub5) this).aClass_xa_Sub3_7194.anInt6286 * -1148794921))];
		((Class298_Sub5) this).aClass46_Sub1_7201 = new Class46_Sub1(
				((Class298_Sub5) this).aClass_ra_Sub2_7197, 5123, null, 1);
	}
	...
	void method2861(int[] is, int i) {
					...
					while (i_28_ < is_25_.length) {
						if ((i_26_ & 1 << i_27_++) != 0) {
							class298_sub53_sub1.method3587(
									(is_25_[i_28_++] & 0xffff), 1368367793);
							i_16_++;
							class298_sub53_sub1.method3587(
									(is_25_[i_28_++] & 0xffff), 1368367793);
							i_16_++;
		...
		if (i_16_ > 0) {
			((Class298_Sub5) this).aClass46_Sub1_7201.method19(5123,
					class298_sub53_sub1.buffer,
					class298_sub53_sub1.index * 385051775);
			((Class298_Sub5) this).aClass_ra_Sub2_7197
					.method5248(
							(((Class_xa_Sub3) ((Class298_Sub5) this).aClass_xa_Sub3_7194).aClass32_8539),
							(((Class_xa_Sub3) ((Class298_Sub5) this).aClass_xa_Sub3_7194).aClass32_8519),
							((Class298_Sub5) this).aClass32_7193,
							(((Class_xa_Sub3) ((Class298_Sub5) this).aClass_xa_Sub3_7194).aClass32_8517));
			((Class298_Sub5) this).aClass_ra_Sub2_7197
					.method5278(
							((Class298_Sub5) this).anInt7199,
							((((Class_xa_Sub3) ((Class298_Sub5) this).aClass_xa_Sub3_7194).anInt8523) & 0x7) != 0,
							((((Class_xa_Sub3) ((Class298_Sub5) this).aClass_xa_Sub3_7194).anInt8523) & 0x8) != 0);
			if (((Class_ra_Sub2) ((Class298_Sub5) this).aClass_ra_Sub2_7197).aBoolean8146)
				((Class298_Sub5) this).aClass_ra_Sub2_7197.method5058(
						2147483647, ((Class298_Sub5) this).aClass78_7198);
			OpenGL.glMatrixMode(5890);
			OpenGL.glPushMatrix();
			OpenGL.glScalef(1.0F / ((Class298_Sub5) this).aFloat7196,
					1.0F / ((Class298_Sub5) this).aFloat7196, 1.0F);
			...
			((Class298_Sub5) this).aClass_ra_Sub2_7197
					.method5248(
							...
							((Class298_Sub5) this).aClass32_7193,
							(((Class_xa_Sub3) ((Class298_Sub5) this).aClass_xa_Sub3_7194).aClass32_8517));
			((Class298_Sub5) this).aClass_ra_Sub2_7197.method5254(
					((Class298_Sub5) this).aClass46_Sub1_7201, 4, 0, i_16_);
			OpenGL.glMatrixMode(5890);
			OpenGL.glPopMatrix();
			OpenGL.glMatrixMode(5888);
		}
