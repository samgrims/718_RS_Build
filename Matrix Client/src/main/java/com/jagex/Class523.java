...
final class Class523 implements Interface17 {
	...
	static final void method6329(IComponentDefinition class105, Class403 class403, int i) {
		try {
			...
			Class503 class503 = Class15.aClass507_224.method6269(
					class105.anInt1151 * 572201537, -87546938);
			if (class105.aClass498_1307 == null)
				class105.aClass498_1307 = new Class498(class503, false);
			class105.aClass498_1307.aLong6110 = Class382
					.method4686(-1683898407) * 3177550440302969639L;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("x.qp(").append(')').toString());
		}
	}

	public static final void method6330(IComponentDefinition class105, int i, int i_2_,
			int i_3_) {
		try {
			if (client.aClass105_8850 == null
					&& !Class436.aBoolean5478
					&& (null != class105 && Class419.method5603(class105,
							1470456512))) {
				client.aClass105_8850 = class105;
				client.aClass105_8712 = Class331.method4063(class105,
						(byte) -122);
	...
	public static void method6332(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("x.i(").append(')').toString());
		}
	}

	static Class298_Sub50_Sub1 method6333(int i, int i_5_, int i_6_, long l,
			int i_7_, int i_8_) {
		try {
			synchronized (Class298_Sub50_Sub1.aClass298_Sub50_Sub1Array9735) {
				...
				((Class298_Sub50_Sub1) class298_sub50_sub1).anInt9736 = -435781441
						* i;
				((Class298_Sub50_Sub1) class298_sub50_sub1).anInt9737 = i_5_
						* -871010593;
				((Class298_Sub50_Sub1) class298_sub50_sub1).anInt9738 = i_6_
						* -25797095;
				((Class298_Sub50_Sub1) class298_sub50_sub1).aLong9739 = -8923914877553624531L
						* l;
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("x.av(").append(')').toString());
		}
	}

	public static GraphicsToolkit method6334(int i, Canvas canvas,
			Interface_ma interface_ma, Class243 class243, int i_10_, int i_11_) {
		try {
			int i_12_ = 0;
			int i_13_ = 0;
			if (null != canvas) {
			...
			return Class393.method4892(i, canvas, interface_ma, class243,
					i_10_, i_12_, i_13_, 16777215);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("x.a(").append(')').toString());
		}
