...
public class Class347 {
	...
	public Class358 method4176(int i, int i_0_) {
		try {
			...
			synchronized (((Class347) this).aClass348_3701) {
				class358 = (Class358) ((Class347) this).aClass348_3701
						.method4184((long) i);
			}
			if (null != class358)
				return class358;
	...
	public void method4179(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("om.p(").append(')').toString());
		}
	}

	public Class347(Class411 class411, Class429 class429, Class243 class243,
