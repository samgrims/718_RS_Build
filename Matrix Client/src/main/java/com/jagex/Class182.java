...
public class Class182 {
	...
	void method1844(RsByteBuffer class298_sub53, int i, short i_1_) {
		try {
			if (1 == i) {
				...
				anInt1858 = class298_sub53.readInt((byte) -103)
						* -1853520269;
			} else if (i == 4) {
				anInt1819 = class298_sub53.readUnsignedByte() * -687561841;
				anInt1847 = class298_sub53.readByte(-12558881) * -1070610169;
			} else if (5 == i)
				anInt1869 = (anInt1831 = (class298_sub53
						.readUnsignedShort() << 12 << 2)
						* -1969619697)
						* -2077217427;
			else if (6 == i) {
				((Class182) this).anInt1834 = class298_sub53
						.readInt((byte) 100)
						* -1365954181;
				((Class182) this).anInt1835 = class298_sub53
						.readInt((byte) -15) * 902519911;
			} else if (7 == i) {
				anInt1841 = class298_sub53.readUnsignedShort() * 704499925;
				anInt1842 = class298_sub53.readUnsignedShort()
						* -1653481859;
			} else if (i == 8) {
				...
				((Class182) this).anInt1838 = class298_sub53
						.readUnsignedByte() * 587779089;
			else if (21 == i)
				((Class182) this).anInt1839 = class298_sub53
						.readUnsignedByte() * 1460884271;
			else if (i == 22)
				anInt1828 = class298_sub53.readInt((byte) -1) * 460402411;
			else if (23 == i)
				((Class182) this).anInt1830 = class298_sub53
						.readUnsignedByte()
						* -853474699;
			else if (24 == i)
				aBoolean1860 = false;
				...
				for (int i_8_ = 0; i_8_ < i_7_; i_8_++)
					anIntArray1846[i_8_] = class298_sub53
							.readUnsignedShort();
			} else if (i == 26)
				aBoolean1877 = false;
			else if (i == 27)
				...
				((Class182) this).anInt1833 = class298_sub53
						.readUnsignedByte()
						* -1461114135;
			else if (29 == i)
				...
				anInt1831 = (class298_sub53.readUnsignedShort() << 12 << 2)
						* -1969619697;
			} else if (32 == i)
				aBoolean1874 = false;
			else if (33 == i)
	...
	void method1845(int i) {
		try {
			...
			anInt1867 = (((Class182) this).anInt1866 * 147388659 - anInt1865
					* -902341611);
			anInt1868 = 313528669 * (((Class182) this).anInt1834 * 737478067 >> 8 & 0xff);
			((Class182) this).anInt1825 = -339699839
					* (((Class182) this).anInt1835 * 1522532183 >> 8 & 0xff);
			...
			if (0 != 1558182711 * anInt1837) {
				anInt1886 = -1525995331
						* (1395500273 * ((Class182) this).anInt1838
								* (1940196053 * anInt1842) / 100);
				anInt1845 = -323160919
						* (anInt1842 * 1940196053
								* (-1087319089 * ((Class182) this).anInt1839) / 100);
				if (0 == -1703669099 * anInt1886)
					anInt1886 = -1525995331;
				anInt1879 = 220598105 * ((((anInt1837 * 1558182711 >> 16 & 0xff) - (anInt1867
						* -447935375 / 2 + anInt1865 * 1443995973)) << 8) / (-1703669099 * anInt1886));
				anInt1880 = 1551625825 * ((((1558182711 * anInt1837 >> 8 & 0xff) - (-1237529867
						* anInt1868 + -1154628453 * anInt1870 / 2)) << 8) / (anInt1886 * -1703669099));
				anInt1881 = (((1558182711 * anInt1837 & 0xff) - (anInt1871
						* -1297143849 + anInt1856 * -564637277 / 2)) << 8)
						/ (anInt1886 * -1703669099) * 1145782203;
				...
				class182_9_.anInt1879 = (class182_9_.anInt1879 + 220598105 * (-1778169623
						* anInt1879 > 0 ? -4 : 4));
				Class182 class182_10_ = this;
				class182_10_.anInt1880 = (class182_10_.anInt1880 + (anInt1880 * 936719777 > 0 ? -4
						: 4) * 1551625825);
				Class182 class182_11_ = this;
				class182_11_.anInt1881 = (class182_11_.anInt1881 + 1145782203 * (anInt1881 * 1137945971 > 0 ? -4
						: 4));
				Class182 class182_12_ = this;
				class182_12_.anInt1882 = (class182_12_.anInt1882 + 756703809 * (anInt1882 * 825667009 > 0 ? -4
						: 4));
			}
			if (anInt1828 * 799607235 != -1) {
				anInt1883 = -1215468705
						* (((Class182) this).anInt1830 * 635387357
								* (anInt1842 * 1940196053) / 100);
				if (anInt1883 * -1035489121 == 0)
					anInt1883 = -1215468705;
				anInt1884 = (799607235 * anInt1828 - (anInt1824 * 373784419 + ((anInt1858
						* -439251269 - 373784419 * anInt1824) / 2)))
						/ (anInt1883 * -1035489121) * -1441694519;
			}
			if (-1628433875 * anInt1832 != -1) {
				anInt1885 = (1204309337 * ((Class182) this).anInt1833
						* (1940196053 * anInt1842) / 100 * -1190650305);
				if (-1648307777 * anInt1885 == 0)
					anInt1885 = -1190650305;
				anInt1878 = ((-1628433875 * anInt1832 - ((-769306129
						* anInt1831 - -992661685 * anInt1869) / 2 + -992661685
						* anInt1869))
						/ (-1648307777 * anInt1885) * -1770208597);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("hp.i(").append(')').toString());
		}
	}

	static final void method1846(int i, int i_13_, int i_14_, int i_15_,
			...
			if (client.anInt8724 * 1596783995 == 3) {
				...
				for (int i_21_ = 0; i_21_ < i_20_; i_21_++) {
					...
					if (class365_sub1_sub1_sub2_sub2 != null)
						class365_sub1_sub1_sub2_sub2.method4441(i, i_13_,
								i_14_, i_15_, i_16_, i_17_, i_18_, (byte) 12);
				}
