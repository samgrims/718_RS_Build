...
public class Class368 {
	public static int[] anIntArray4002 = { 99, 99, 99, 99, 99, 99, 99, 99, 99,
			99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 120 };
	...
	static {
		...
		for (int i_0_ = 0; i_0_ < 120; i_0_++) {
			int i_1_ = i_0_ + 1;
			int i_2_ = (int) ((double) i_1_ + 300.0 * Math.pow(2.0,
					(double) i_1_ / 7.0));
			i += i_2_;
	...
	static void method4555(short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ph.v(").append(')').toString());
		}
	}

	static void method4556(GraphicsToolkit class_ra, Class298_Sub52 class298_sub52,
			Class352 class352, int i) {
		try {
			...
			if (class57 != null) {
				...
				if (null != class352.aString3792) {
					i_9_ = Class74.aClass505_695.method6257(
							(class352.aString3792), null,
							(Class301_Sub1.aStringArray7638), null, (byte) 37);
					...
					i_11_ = (Class52.aClass4_508.method309() * i_9_ + Class52.aClass4_508
							.method306() / 2);
				}
				...
				if (i_7_ < i_5_ + Class301_Sub1.anInt3221) {
					...
					i_14_ = i_10_ / 2
							+ (i_5_ / 2 + Class301_Sub1.anInt3221 + i_6_) + 5;
				} else if (i_7_ > Class301_Sub1.anInt3256 - i_5_) {
					i_7_ = Class301_Sub1.anInt3256 - i_5_;
					i_14_ = (Class301_Sub1.anInt3256 - i_5_ / 2 - i_6_ - i_10_
							/ 2 - 5);
				}
				...
				int i_16_ = ((int) (Math
						.atan2(
								(double) (i_7_ - (1333098669 * (class298_sub52.anInt7609))),
								(double) (i_8_ - (class298_sub52.anInt7606 * -685779893))) / 3.141592653589793 * 32767.0) & 0xffff);
				class57.method673((float) i_7_ + (float) i_5_ / 2.0F,
						(float) i_5_ / 2.0F + (float) i_8_, 4096, i_16_);
				int i_17_ = -2;
				int i_18_ = -2;
				int i_19_ = -2;
				int i_20_ = -2;
				if (class352.aString3792 != null) {
					...
					if (class352.anInt3787 * 594838161 != 0)
						class_ra.method5015(i_17_, i_18_, i_19_ - i_17_, i_20_
								- i_18_, class352.anInt3787 * 594838161,
								(byte) 7);
					if (0 != class352.anInt3802 * -828737913)
						class_ra.method5014(i_17_, i_18_, i_19_ - i_17_, i_20_
								- i_18_, class352.anInt3802 * -828737913,
								98431177);
					for (int i_21_ = 0; i_21_ < i_9_; i_21_++) {
						...
						if (i_21_ < i_9_ - 1)
							string = string.substring(0, string.length() - 4);
						Class52.aClass4_508
								.method308(class_ra, string, i_14_, i_15_,
										(class352.anInt3781 * -1836991893),
										true);
