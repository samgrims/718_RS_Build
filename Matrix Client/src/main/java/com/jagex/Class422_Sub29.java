package com.jagex;/* Class422_Sub29 - Decompiled by JODE
	...
	public static boolean method5729(byte i, short i_2_) {
		try {
			...
			if (i_3_ >= 128 && i_3_ < 160
					&& '\0' == Class419.aCharArray5340[i_3_ - 128])
				return false;
			return true;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aer.b(").append(')').toString());
		}
	}
}
