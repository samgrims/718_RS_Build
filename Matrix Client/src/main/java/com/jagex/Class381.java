	...
	void method4683(RsByteBuffer class298_sub53, int i) {
		try {
			for (;;) {
				...
				if (1 == i_0_)
					anInterface19_4113 = ObjectDefinitions.method5786(class298_sub53,
							(byte) -24);
				else if (i_0_ == 2)
					anInterface19_4109 = ObjectDefinitions.method5786(class298_sub53,
							(byte) 2);
				else if (3 == i_0_)
					anInterface19_4111 = ObjectDefinitions.method5786(class298_sub53,
							(byte) -93);
				else if (4 == i_0_)
					anInterface19_4112 = ObjectDefinitions.method5786(class298_sub53,
							(byte) -56);
				else if (i_0_ == 5)
					aClass355_4116 = Class422_Sub7.method5651(class298_sub53,
							(byte) -80);
				else if (i_0_ == 6)
					aClass355_4114 = Class422_Sub7.method5651(class298_sub53,
							(byte) 68);
				else if (i_0_ == 7)
					aClass355_4115 = Class422_Sub7.method5651(class298_sub53,
							(byte) 9);
				else if (8 == i_0_)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("pv.a(").append(')').toString());
		}
	}

	public Class381(Class243 class243) {
		byte[] is = class243.method2294(
				(Class380.aClass380_4106.anInt4108 * -363169051), (byte) 29);
		method4683(new RsByteBuffer(is), 1436577561);
	}

	public static int[][] method4684(int i, int i_1_, int i_2_, int i_3_,
			int i_4_, int i_5_, float f, boolean bool, byte i_6_) {
		try {
			...
			((Class298_Sub32_Sub34) class298_sub32_sub34).anInt9547 = i_5_
					* -1820512295;
