...
public class Class14 {
	...
	static final void method345(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ao.aic(").append(')').toString());
		}
	}

	static final void method346(byte i) {
		try {
			for (Class298_Sub37_Sub2 class298_sub37_sub2 = ((Class298_Sub37_Sub2) client.aClass453_8824
					.method5939(1766612795)); null != class298_sub37_sub2; class298_sub37_sub2 = ((Class298_Sub37_Sub2) client.aClass453_8824
					.method5944(49146))) {
				...
				if (443738891 * client.anInt8884 > class365_sub1_sub1_sub1.anInt10049
					...
					if (1894383945 * class365_sub1_sub1_sub1.anInt10058 > 0) {
						if (1596783995 * client.anInt8724 == 0) {
							Entity class365_sub1_sub1_sub2 = Class87.aClass94Array794[(class365_sub1_sub1_sub1.anInt10058 * 1894383945) - 1]
									.method1015(1231902873);
											...
											.method4405(
													...
													((Class356
															.method4271(
																	(int) class217.aFloat2451,
																	(int) class217.aFloat2454,
																	class365_sub1_sub1_sub2.plane,
																	-1503815167)) - (2134079017 * (class365_sub1_sub1_sub1.anInt10045))),
							...
							if (class298_sub29 != null) {
								...
								if ((int) class217.aFloat2451 >= 0
										&& ((int) class217.aFloat2451 < client.aClass283_8716
												.method2629(-1876273086) * 512)
										&& (int) class217.aFloat2454 >= 0
										&& ((int) class217.aFloat2454 < client.aClass283_8716
												.method2630(-203309822) * 512))
									class365_sub1_sub1_sub1
											.method4405(
													(int) class217.aFloat2451,
													(int) class217.aFloat2454,
													((Class356
															.method4271(
																	(int) class217.aFloat2451,
																	(int) class217.aFloat2454,
																	class365_sub1_sub1_sub1.plane,
																	-1366613250)) - (class365_sub1_sub1_sub1.anInt10045 * 2134079017)),
					...
					if (1894383945 * class365_sub1_sub1_sub1.anInt10058 < 0) {
						...
						if (null != class365_sub1_sub1_sub2_sub2) {
							...
							if ((int) class217.aFloat2451 >= 0
									&& ((int) class217.aFloat2451 < client.aClass283_8716
											.method2629(-1981087344) * 512)
									&& (int) class217.aFloat2454 >= 0
									&& ((int) class217.aFloat2454 < client.aClass283_8716
											.method2630(-1284142631) * 512))
								class365_sub1_sub1_sub1
										.method4405(
												(int) class217.aFloat2451,
												(int) class217.aFloat2454,
												((Class356
														.method4271(
																...
																(int) class217.aFloat2454,
																class365_sub1_sub1_sub1.plane,
																-1135065402)) - (class365_sub1_sub1_sub1.anInt10045 * 2134079017)),
												443738891 * client.anInt8884,
												1831333850);
						}
					}
					class365_sub1_sub1_sub1.method4407(
							client.anInt8961 * 614680345, (byte) 63);
					client.aClass283_8716.method2675(-1611682495).method4022(
							class365_sub1_sub1_sub1, true, (byte) 0);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ao.ie(").append(')').toString());
		}
	}
}
