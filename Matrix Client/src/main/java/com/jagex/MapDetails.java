...
public class MapDetails extends Class298_Sub37 {
	...
	boolean method3450(int i, int i_0_, byte i_1_) {
		try {
			for (Class298_Sub42 class298_sub42 = (Class298_Sub42) ((MapDetails) this).aClass453_9642
					.method5939(1766612795); null != class298_sub42; class298_sub42 = (Class298_Sub42) ((MapDetails) this).aClass453_9642
					.method5944(49146)) {
	...
	public boolean method3451(int i, int i_2_, int[] is, int i_3_) {
		try {
			for (Class298_Sub42 class298_sub42 = (Class298_Sub42) ((MapDetails) this).aClass453_9642
					.method5939(1766612795); class298_sub42 != null; class298_sub42 = (Class298_Sub42) ((MapDetails) this).aClass453_9642
					.method5944(49146)) {
	...
	void method3454(int i) {
		try {
			...
			for (Class298_Sub42 class298_sub42 = (Class298_Sub42) ((MapDetails) this).aClass453_9642
				...
				if (((Class298_Sub42) class298_sub42).anInt7461 * 37578241 > anInt9647
						* -2052483955)
				...
				if (50981941 * ((Class298_Sub42) class298_sub42).anInt7463 < anInt9649 * 1345239131)
					anInt9649 = -608005457
							* (((Class298_Sub42) class298_sub42).anInt7463);
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aiu.i(").append(')').toString());
		}
	}

	MapDetails(int i, String string, String string_9_, int i_10_,
			...
			if (Class350.aClass298_Sub25_3757 != null
				...
				if (-1 == class163.aByte1683) {
					...
					Class298_Sub36 class298_sub36 = Class18.method359(
							OutcommingPacket.aClass198_2045, class25.aClass449_330,
							(byte) 120);
					class298_sub36.out.writeByte(
							2 + Class58.method693(class163.aString1681,
									1064865624));
					class298_sub36.out.writeShort(i,
							16711935);
					class298_sub36.out.writeString(
							class163.aString1681, 2115033353);
					class25.method390(class298_sub36, (byte) -90);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("aiu.mo(").append(')').toString());
		}
	}
}
