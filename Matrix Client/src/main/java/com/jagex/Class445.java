...
public class Class445 {
	...
	public Class485 method5892(int i, int i_0_) {
		try {
			Class485 class485;
			synchronized (((Class445) this).aClass348_5610) {
				class485 = (Class485) ((Class445) this).aClass348_5610
						.method4184((long) i);
			}
			if (null != class485)
				return class485;
	...
	static void method5895(GraphicsToolkit class_ra, byte i) {
		try {
			...
			class_ra.B(0, 0, -2110394505 * Class462.anInt5683, 350,
					Class8.anInt98 * 256666041 << 24 | 0x332277, 1);
			int i_2_ = 350 / (376067837 * Class8.anInt110);
			if (Class8.anInt102 * -2035787443 > 0) {
				int i_3_ = 346 - 376067837 * Class8.anInt110 - 4;
				int i_4_ = i_3_ * i_2_
						/ (i_2_ + -2035787443 * Class8.anInt102 - 1);
				int i_5_ = 4;
				if (-2035787443 * Class8.anInt102 > 1)
					i_5_ += ((-2035787443 * Class8.anInt102 - 1 - Class8.anInt103
							* -1731316011)
							* (i_3_ - i_4_) / (Class8.anInt102 * -2035787443 - 1));
				class_ra.B(Class462.anInt5683 * -2110394505 - 16, i_5_, 12,
						i_4_, Class8.anInt98 * 256666041 << 24 | 0x332277, 2);
				for (int i_6_ = -1731316011 * Class8.anInt103; (i_6_ < -1731316011
						* Class8.anInt103 + i_2_ && i_6_ < -2035787443
						* Class8.anInt102); i_6_++) {
					String[] strings = Class365_Sub1_Sub3_Sub1.method4508(
							(Class8.aStringArray107[i_6_]), '\010', 846052986);
					...
					for (int i_8_ = 0; i_8_ < strings.length; i_8_++) {
						...
						Class343.aClass264_3673
								.method2488(
										Class117.method1276(strings[i_8_],
												(byte) 76),
										i_9_,
										(350
												- Class8.anInt106
												* 1194411673
												- 2
												- (-1883958527 * Class422_Sub2.aClass505_8369.anInt6197) - (376067837 * Class8.anInt110 * (i_6_ - Class8.anInt103
												* -1731316011))), -1,
										-16777216, 2087345638);
					}
				}
			}
			Class298_Sub46.aClass264_7534.method2474("718 1", -2110394505
					* Class462.anInt5683 - 25, 330, -1, -16777216, (byte) -63);
			class_ra.r(0, 0, Class462.anInt5683 * -2110394505, 350);
			class_ra.method4990(0, 350 - Class8.anInt106 * 1194411673,
					Class462.anInt5683 * -2110394505, -1, -2042566638);
			Class101.aClass264_1084.method2488(new StringBuilder().append(
					"--> ").append(
					Class117.method1276(Class8.aString101, (byte) -1))
					.toString(), 10,
					(350 - Class82_Sub19_Sub1.aClass505_9111.anInt6197
							* -1883958527 - 1), -1, -16777216, -10016873);
			if (Class422_Sub7.aBoolean8385) {
				int i_10_ = -1;
				if (443738891 * client.anInt8884 % 30 > 15)
					i_10_ = 16777215;
				class_ra.method5035((10 + (Class82_Sub19_Sub1.aClass505_9111
						.method6264(new StringBuilder().append("--> ").append(
								Class117.method1276(Class8.aString101,
										(byte) 58).substring(0,
										Class8.anInt99 * -1182747927))
								.toString(), -949897299))), 350 - -1883958527
						* (Class82_Sub19_Sub1.aClass505_9111.anInt6197) - 11,
						12, i_10_, (short) 26562);
			}
			class_ra.L();
			Class98_Sub2.method1061(-1132401323);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sj.s(").append(')').toString());
		}
	}
	...
	static final void method5896(Class403 class403, byte i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sj.mo(").append(')').toString());
		}
	}

	public static boolean method5897(Class243 class243, Class243 class243_11_,
			Class243 class243_12_, Class298_Sub19_Sub1 class298_sub19_sub1,
			Class284 class284, byte i) {
		try {
