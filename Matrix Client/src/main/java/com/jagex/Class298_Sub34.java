...
public class Class298_Sub34 extends Class298 {
				...
				if (null == is || is[i_2_] != 0) {
					...
					if (0 == i_3_) {
						...
						if (i_3_ != i_1_) {
							...
							i_3_--;
							if (0 == (i_3_ & 0x1))
								class298_sub26_sub1 = class272.method2551(
										i_3_ >> 2, is_0_, -1617127101);
							else
								class298_sub26_sub1 = class272.method2552(
										i_3_ >> 2, is_0_, (byte) 92);
	...
	Class298_Sub34(byte[] is) {
		...
		int i;
		for (i = 0; 0 != (class298_sub53.buffer[i + 385051775
				* class298_sub53.index]); i++) {
			/* empty */
		}
		...
		int i_7_;
		for (i_7_ = 0; ((class298_sub53.buffer[class298_sub53.index
				* 385051775 + i_7_]) != 0); i_7_++) {
			/* empty */
		}
		...
		int i_11_;
		for (i_11_ = 0; ((class298_sub53.buffer[385051775
				* class298_sub53.index + i_11_]) != 0); i_11_++) {
			/* empty */
		}
		...
		int i_24_;
		for (i_24_ = 0; ((class298_sub53.buffer[i_24_ + 385051775
				* class298_sub53.index]) != 0); i_24_++) {
			/* empty */
		}
		...
		((Class298_Sub34) this).anInt7389 = (class298_sub53
				.readUnsignedByte() + 1) * 306353405;
		...
		if (null != is_22_) {
			...
			for (int i_56_ = 0; i_56_ < i_54_; i_56_++)
				((Class298_Sub34) this).aByteArray7388[i_56_] = (byte) (i_55_
						* (((Class298_Sub34) this).aByteArray7388[i_56_]) + 32 >> 6);
			for (int i_57_ = 2; i_57_ < is_22_.length; i_57_ += 2) {
				...
				for (int i_61_ = i_54_; i_61_ < i_58_; i_61_++) {
					int i_62_ = Class304.method3740(i_60_, i_58_ - i_54_,
							-498753873);
					((Class298_Sub34) this).aByteArray7388[i_61_] = (byte) ((((Class298_Sub34) this).aByteArray7388[i_61_])
							* i_62_ + 32 >> 6);
					i_60_ += i_59_ - i_55_;
				}
				i_54_ = i_58_;
		...
		if (null != is_23_) {
			...
			for (int i_69_ = 2; i_69_ < is_23_.length; i_69_ += 2) {
				...
				for (int i_73_ = i_65_; i_73_ < i_70_; i_73_++) {
					int i_74_ = Class304.method3740(i_72_, i_70_ - i_65_,
							-1209989239);
			...
			for (int i_76_ = i_65_; i_76_ < 128; i_76_++) {
				int i_77_ = i_66_
						+ (((Class298_Sub34) this).aByteArray7392[i_76_] & 0xff);
				if (i_77_ < 0)
					i_77_ = 0;
				if (i_77_ > 128)
					i_77_ = 128;
		...
		for (int i_78_ = 0; i_78_ < i_15_; i_78_++)
			((Class104) class104s[i_78_]).anInt1111 = class298_sub53
					.readUnsignedByte() * 890917585;
		for (int i_79_ = 0; i_79_ < i_15_; i_79_++) {
			Class104 class104_80_ = class104s[i_79_];
			if (((Class104) class104_80_).aByteArray1114 != null)
				((Class104) class104_80_).anInt1112 = class298_sub53
						.readUnsignedByte() * 1553889121;
			if (((Class104) class104_80_).aByteArray1110 != null)
				((Class104) class104_80_).anInt1113 = class298_sub53
						.readUnsignedByte()
						* -1467946285;
			if (1753302577 * ((Class104) class104_80_).anInt1111 > 0)
				((Class104) class104_80_).anInt1109 = class298_sub53
						.readUnsignedByte() * 189354207;
		}
		for (int i_81_ = 0; i_81_ < i_15_; i_81_++)
			((Class104) class104s[i_81_]).anInt1116 = class298_sub53
					.readUnsignedByte() * 419117413;
		for (int i_82_ = 0; i_82_ < i_15_; i_82_++) {
			Class104 class104_83_ = class104s[i_82_];
			if (430264429 * ((Class104) class104_83_).anInt1116 > 0)
				((Class104) class104_83_).anInt1115 = class298_sub53
						.readUnsignedByte()
						* -1131925083;
		}
		for (int i_84_ = 0; i_84_ < i_15_; i_84_++) {
			...
			if (((Class104) class104_85_).anInt1115 * 671305261 > 0)
				((Class104) class104_85_).anInt1117 = class298_sub53
						.readUnsignedByte() * 1175770411;
		}
	}
