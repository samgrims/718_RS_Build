...
public final class Class52_Sub2_Sub1_Sub1 extends Class52_Sub2_Sub1 {
	...
	void method592() {
		...
		DataBufferInt databufferint = new DataBufferInt(
				((Class52_Sub2_Sub1_Sub1) this).anIntArray9076,
				(((Class52_Sub2_Sub1_Sub1) this).anIntArray9076).length);
				...
				.createWritableRaster(
						(directcolormodel
								.createCompatibleSampleModel(
										((Class52_Sub2_Sub1_Sub1) this).anInt9074 * 1038713159,
										2061776189 * ((Class52_Sub2_Sub1_Sub1) this).anInt9075)),
						databufferint, null));
		((Class52_Sub2_Sub1_Sub1) this).anImage9986 = new BufferedImage(
	...
	public final int method586(int i, int i_0_) {
		Graphics graphics = ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072
				.getGraphics();
		graphics.drawImage(((Class52_Sub2_Sub1_Sub1) this).anImage9986, i,
				i_0_, ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072);
		return 0;
	}

	Class52_Sub2_Sub1_Sub1(Class_ra_Sub1 class_ra_sub1, Canvas canvas, int i,
			int i_1_) {
	...
	public final int method584(int i, int i_2_) {
		Graphics graphics = ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072
				.getGraphics();
		graphics.drawImage(((Class52_Sub2_Sub1_Sub1) this).anImage9986, i,
				i_2_, ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072);
		return 0;
	}
	...
	public final int method585(int i, int i_3_) {
		Graphics graphics = ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072
				.getGraphics();
		graphics.drawImage(((Class52_Sub2_Sub1_Sub1) this).anImage9986, i,
				i_3_, ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072);
		return 0;
	}
	...
	public final int method581(int i, int i_4_) {
		try {
			Graphics graphics = ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072
					.getGraphics();
			graphics.drawImage(((Class52_Sub2_Sub1_Sub1) this).anImage9986, i,
					i_4_, ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072);
			return 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("akh.g(").append(')').toString());
		}
	}
	...
	public final int method587(int i, int i_5_) {
		Graphics graphics = ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072
				.getGraphics();
		graphics.drawImage(((Class52_Sub2_Sub1_Sub1) this).anImage9986, i,
				i_5_, ((Class52_Sub2_Sub1_Sub1) this).aCanvas9072);
		return 0;
	}
}
