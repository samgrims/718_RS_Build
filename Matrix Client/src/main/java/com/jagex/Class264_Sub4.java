...
public class Class264_Sub4 extends Class264 {
	...
	Class264_Sub4(Class_ra_Sub1 class_ra_sub1, Class505 class505,
                  IndexedImage[] class89s, int[] is, int[] is_0_) {
	...
	void method2509(byte[] is, int[] is_1_, int i, int i_2_, int i_3_,
		...
		for (int i_10_ = -i_5_; i_10_ < 0; i_10_++) {
			for (int i_11_ = -i_4_; i_11_ < 0; i_11_++) {
				if (is[i_2_++] != 0) {
					int i_12_ = ((((i & 0xff00) * i_8_ & 0xff0000) + (i_8_
							* (i & 0xff00ff) & ~0xff00ff)) >> 8);
					int i_13_ = is_1_[i_3_];
					is_1_[i_3_++] = (((i_9_ * (i_13_ & 0xff00ff) & ~0xff00ff) + (i_9_
							* (i_13_ & 0xff00) & 0xff0000)) >> 8)
							+ i_12_;
				} else
					i_3_++;
			}
	...
	void method2486(char c, int i, int i_14_, int i_15_, boolean bool,
		...
		if ((((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967) != null) {
			if (null == class_ta)
				...
				int i_24_ = 0;
				if (i_14_ < -1278653805
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976)) {
					int i_25_ = ((((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7976)
							* -1278653805 - i_14_);
					i_19_ -= i_25_;
					i_14_ = -1278653805
							* ((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976;
				...
				if (i_19_ + i_14_ > (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7977) * 63686679)
					i_19_ -= i_19_
							+ i_14_
							- 63686679
							* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7977);
				if (i < -912871679
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7974)) {
					int i_26_ = (-912871679
							* ((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7974 - i);
					i_18_ -= i_26_;
					i = -912871679
							* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7974);
					i_24_ += i_26_;
				...
				if (i_18_ + i > -1416794725
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991)) {
					int i_27_ = i_18_
							+ i
							- (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991)
							* -1416794725;
				...
				if (i_18_ > 0 && i_19_ > 0) {
					if (-16777216 == (i_15_ & ~0xffffff))
						method2510(
								(((Class264_Sub4) this).aByteArrayArray7135[c]),
								(((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anIntArray7967),
								i_15_, i_24_, i_21_, i_18_, i_19_, i_22_,
								i_23_, i, i_14_,
								((Class264_Sub4) this).anIntArray7133[c],
								class_ta, i_16_, i_17_);
					else
						method2512(
								(((Class264_Sub4) this).aByteArrayArray7135[c]),
								(((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anIntArray7967),
	...
	void method2510(byte[] is, int[] is_28_, int i, int i_29_, int i_30_,
			int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_,
			int i_37_, Class_ta class_ta, int i_38_, int i_39_) {
		...
		int i_43_ = (is_40_.length + i_39_ < i_32_ + i_36_ ? i_39_
	...
	void method2511(byte[] is, int[] is_52_, int i, int i_53_, int i_54_,
	...
	void method2512(byte[] is, int[] is_63_, int i, int i_64_, int i_65_,
			int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_,
			int i_72_, Class_ta class_ta, int i_73_, int i_74_) {
		Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
		...
		int i_79_ = (i_74_ + is_75_.length < i_71_ + i_67_ ? is_75_.length
				+ i_74_ : i_67_ + i_71_);
		int i_80_ = i >>> 24;
		int i_81_ = 255 - i_80_;
		for (int i_82_ = i_78_; i_82_ < i_79_; i_82_++) {
			...
			for (int i_89_ = -i_84_; i_89_ < 0; i_89_++) {
				if (is[i_64_++] != 0) {
					int i_90_ = ((((i & 0xff00) * i_80_ & 0xff0000) + (i_80_
							* (i & 0xff00ff) & ~0xff00ff)) >> 8);
					int i_91_ = is_63_[i_65_];
					is_63_[i_65_++] = i_90_
							+ (((i_81_ * (i_91_ & 0xff00ff) & ~0xff00ff) + ((i_91_ & 0xff00)
									* i_81_ & 0xff0000)) >> 8);
				} else
					i_65_++;
			}
	...
	void e(char c, int i, int i_92_, int i_93_, boolean bool) {
		if (null != (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967)) {
			...
			int i_99_ = 0;
			int i_100_ = 0;
			if (i_92_ < (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7976)
					* -1278653805) {
				int i_101_ = (-1278653805
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976) - i_92_);
				i_95_ -= i_101_;
			...
			if (i < (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7974)
					* -912871679) {
				int i_102_ = (-912871679
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7974) - i);
				i_94_ -= i_102_;
			...
			if (i_94_ + i > (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7991)
					* -1416794725) {
				int i_103_ = (i_94_ + i - -1416794725
						* ((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991);
				i_94_ -= i_103_;
				i_99_ += i_103_;
				i_98_ += i_103_;
			...
			if (i_94_ > 0 && i_95_ > 0) {
				if ((i_93_ & ~0xffffff) == -16777216)
					method2511(
							((Class264_Sub4) this).aByteArrayArray7135[c],
							(((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967),
							i_93_, i_100_, i_97_, i_94_, i_95_, i_98_, i_99_);
	...
	void UA(char c, int i, int i_104_, int i_105_, boolean bool) {
		if (null != (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967)) {
			...
			int i_111_ = 0;
			int i_112_ = 0;
			if (i_104_ < (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7976)
					* -1278653805) {
				int i_113_ = (-1278653805
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976) - i_104_);
				i_107_ -= i_113_;
			...
			if (i_106_ + i > (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7991)
					* -1416794725) {
				int i_115_ = (i_106_ + i - -1416794725
						* ((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991);
				i_106_ -= i_115_;
				i_111_ += i_115_;
				i_110_ += i_115_;
			...
			if (i_106_ > 0 && i_107_ > 0) {
				if ((i_105_ & ~0xffffff) == -16777216)
					method2511(
							((Class264_Sub4) this).aByteArrayArray7135[c],
							(((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967),
							i_105_, i_112_, i_109_, i_106_, i_107_, i_110_,
							i_111_);
	...
	void g(char c, int i, int i_116_, int i_117_, boolean bool) {
		if (null != (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967)) {
			...
			int i_123_ = 0;
			int i_124_ = 0;
			if (i_116_ < (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7976)
					* -1278653805) {
				int i_125_ = (-1278653805
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976) - i_116_);
				i_119_ -= i_125_;
			...
			if (i_118_ + i > (((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7991)
					* -1416794725) {
				int i_127_ = (i_118_ + i - -1416794725
						* ((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991);
				i_118_ -= i_127_;
				i_123_ += i_127_;
				i_122_ += i_127_;
			...
			if (i_118_ > 0 && i_119_ > 0) {
				if ((i_117_ & ~0xffffff) == -16777216)
					method2511(
							((Class264_Sub4) this).aByteArrayArray7135[c],
							(((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967),
							i_117_, i_124_, i_121_, i_118_, i_119_, i_122_,
							i_123_);
	...
	void method2489(char c, int i, int i_128_, int i_129_, boolean bool,
			Class_ta class_ta, int i_130_, int i_131_) {
		if ((((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anIntArray7967) != null) {
			if (null == class_ta)
				...
				int i_137_ = 0;
				int i_138_ = 0;
				if (i_128_ < -1278653805
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976)) {
					int i_139_ = ((((Class_ra_Sub1) ((Class264_Sub4) this).aClass_ra_Sub1_7137).anInt7976)
							* -1278653805 - i_128_);
					i_133_ -= i_139_;
					i_128_ = -1278653805
							* ((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7976;
				...
				if (i_132_ + i > -1416794725
						* (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991)) {
					int i_141_ = (i_132_ + i - (((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anInt7991)
							* -1416794725);
					i_132_ -= i_141_;
					i_137_ += i_141_;
					i_136_ += i_141_;
				...
				if (i_132_ > 0 && i_133_ > 0) {
					if (-16777216 == (i_129_ & ~0xffffff))
						method2510(
								(((Class264_Sub4) this).aByteArrayArray7135[c]),
								(((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anIntArray7967),
								i_129_, i_138_, i_135_, i_132_, i_133_, i_136_,
								i_137_, i, i_128_,
								((Class264_Sub4) this).anIntArray7133[c],
								class_ta, i_130_, i_131_);
					else
						method2512(
								(((Class264_Sub4) this).aByteArrayArray7135[c]),
								(((Class_ra_Sub1) (((Class264_Sub4) this).aClass_ra_Sub1_7137)).anIntArray7967),
	...
	public static void method2513(boolean bool, int i) {
		try {
			for (Class298_Sub41 class298_sub41 = ((Class298_Sub41) Class298_Sub41.aClass453_7421
					.method5939(1766612795)); null != class298_sub41; class298_sub41 = ((Class298_Sub41) Class298_Sub41.aClass453_7421
					.method5944(49146))) {
	...
	public static int method2514(int i, int i_142_, int i_143_, short i_144_) {
		try {
			...
			for (Class298_Sub52 class298_sub52 = ((Class298_Sub52) Class301_Sub1.aClass453_3236
					.method5939(1766612795)); class298_sub52 != null; class298_sub52 = (Class298_Sub52) Class301_Sub1.aClass453_3236
					.method5944(49146)) {
				if (class298_sub52.anInt7608 * -530122905 != i) {
					...
					int i_151_ = (i_149_ + Class301_Sub1.anInt3245 << 14 | i_150_
							+ Class301_Sub1.anInt3238);
					int i_152_ = ((i_147_ - i_149_) * (i_147_ - i_149_) + (i_148_ - i_150_)
							* (i_148_ - i_150_));
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("xw.ck(").append(')').toString());
		}
	}

	public static Class318 method2515(Socket socket, int i, int i_153_)
			throws IOException {
		try {
	...
	static final void method2516(Class403 class403, int i) {
		try {
			...
			if (i_154_ != Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub19_7567
