...
public class Class154 {
	...
	static final boolean method1669(int i, int i_10_) {
		return method1690(i, i_10_)
				& ((i & 0x2000) != 0 | method1661(i, i_10_) | method1684(i,
						i_10_));
	}
	...
	static final boolean method1672(int i, int i_13_) {
		return ((i & 0x70000) != 0 || method1659(i, i_13_) || method1685(i,
				i_13_));
	}

	static final boolean method1673(int i, int i_14_) {
		return ((i & 0x70000) != 0 || method1670(i, i_14_) || method1685(i,
				i_14_));
	}

	static final boolean method1674(int i, int i_15_) {
		return ((i & 0x70000) != 0 || method1660(i, i_15_) || method1685(i,
				i_15_));
	}

	static final boolean method1675(int i, int i_16_) {
		boolean bool = ((i_16_ & 0x37) != 0 ? method1669(i, i_16_)
				: method1680(i, i_16_));
	...
	static final boolean method1680(int i, int i_21_) {
		...
		if ((i & 0x9000) != 0 | method1662(i, i_21_) | method1663(i, i_21_))
			return true;
		return (i_21_ & 0x37) == 0
				& ((i & 0x2000) != 0 | method1661(i, i_21_) | method1684(i,
						i_21_));
	}
	...
	static final boolean method1685(int i, int i_26_) {
		return ((method1659(i, i_26_) | method1670(i, i_26_) | method1660(i,
				i_26_)) & method1671(i, i_26_));
	}
	...
	static final boolean method1687(int i, int i_28_) {
		return ((i & 0x40000) != 0 | method1663(i, i_28_) || method1680(i,
				i_28_));
	}
	...
	static final boolean method1691(int i, int i_32_) {
		return ((i & 0x60000) != 0 | method1682(i, i_32_) || method1686(i,
				i_32_));
	}
