...
public class Class91 {
	...
	static final void method1000(Class403 class403, int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ds.ox(").append(')').toString());
		}
	}

	static void method1001(Entity class365_sub1_sub1_sub2,
			byte i) {
		try {
			if (class365_sub1_sub1_sub2 instanceof NPC) {
				...
				if (class365_sub1_sub1_sub2_sub1.aClass503_10190 != null)
					Class140
							.method1555(
									...
									(class365_sub1_sub1_sub2_sub1.plane != (Class287.myPlayer.plane)),
									(byte) -64);
				...
				Class298_Sub47
						.method3535(
								...
								((Class287.myPlayer.plane) != (class365_sub1_sub1_sub2_sub2.plane)),
								1531362210);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ds.g(").append(')').toString());
		}
	}
	...
	static final void method1002(byte i) {
		try {
			...
			int i_5_ = Class356.method4271(Class75.anInt708 * 1103750049,
					Class106.anInt1309 * 1346160791,
					Class99.anInt952 * 1855729883, -737895541);
			int i_6_ = 0;
			if (i_3_ > 3 && i_4_ > 3
					&& i_3_ < client.aClass283_8716.method2629(-1981660153) - 4
					&& i_4_ < client.aClass283_8716.method2630(1904630701) - 4) {
				for (int i_7_ = i_3_ - 4; i_7_ <= 4 + i_3_; i_7_++) {
					for (int i_8_ = i_4_ - 4; i_8_ <= 4 + i_4_; i_8_++) {
						int i_9_ = Class99.anInt952 * 1855729883;
						if (i_9_ < 3
								&& class244.method2320(i_7_, i_8_, -316177210))
							i_9_++;
						int i_10_ = 0;
						byte[][] is = client.aClass283_8716.method2637(i_9_,
								300700071);
						if (null != is)
							i_10_ = (is[i_7_][i_8_] & 0xff) * 8 << 2;
						if (null != class331.aClass_xaArray3517
								&& class331.aClass_xaArray3517[i_9_] != null) {
							int i_11_ = (i_5_ - (class331.aClass_xaArray3517[i_9_]
									.method6341(i_7_, i_8_, (byte) -39) - i_10_));
							if (i_11_ > i_6_)
								i_6_ = i_11_;
						}
					}
			...
			if (i_12_ > client.anInt8764 * -523207831)
				...
				client.anInt8764 += 1746126041 * ((i_12_ - client.anInt8764
						* -523207831) / 80);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ds.hl(").append(')').toString());
		}
	}
}
