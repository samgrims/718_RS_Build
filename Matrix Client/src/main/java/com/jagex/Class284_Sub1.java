...
public class Class284_Sub1 extends Class284 {
	...
	int method2698() {
		return (-975542179 * ((Class284_Sub1) this).anInt7143 - (((Class284_Sub1) this).aSourceDataLine7142
				.available() >> (aBoolean3047 ? 2 : 1)));
	}
	...
	void method2683(Component component, byte i) {
		try {
			...
			((Class284_Sub1) this).anAudioFormat7144 = new AudioFormat(
					(float) (1164070869 * anInt3059), 16, aBoolean3047 ? 2 : 1,
							true, false);
			((Class284_Sub1) this).aByteArray7141 = new byte[256 << (aBoolean3047 ? 2
					: 1)];
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
			.append("aas.q(").append(')').toString());
		}
	}
	...
	void method2699() throws LineUnavailableException {
		...
		if (((Class284_Sub1) this).aBoolean7145) {
			...
			info = (new DataLine.Info(
					...
					((Class284_Sub1) this).anAudioFormat7144,
					(((Class284_Sub1) this).anInt7143 * -975542179 << (aBoolean3047 ? 2
							: 1))));
			((Class284_Sub1) this).aSourceDataLine7142 = (SourceDataLine) AudioSystem
					.getLine(info);
	...
	void method2685() {
		...
		((Class284_Sub1) this).aSourceDataLine7142.write(
				((Class284_Sub1) this).aByteArray7141, 0, i << 1);
	}
	...
	void method2701(int i) throws LineUnavailableException {
		try {
			DataLine.Info info = (new DataLine.Info(javax.sound.sampled.SourceDataLine.class,
					((Class284_Sub1) this).anAudioFormat7144,
					i << (aBoolean3047 ? 2 : 1)));
			((Class284_Sub1) this).aSourceDataLine7142 = (SourceDataLine) AudioSystem
					.getLine(info);
