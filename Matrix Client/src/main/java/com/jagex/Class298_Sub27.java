...
public class Class298_Sub27 extends Class298 {
	...
	static final void method3106(Class403 class403, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abl.rj(").append(')').toString());
		}
	}

	static void method3107(int i, int i_2_, int i_3_, int i_4_, int i_5_,
		...
		try {
			...
			Class82_Sub22
					.method940(is, i - i_12_, i_12_ + i, i_5_, -1835753044);
			...
			while (i_10_ > 0) {
				...
				if (bool) {
					...
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_40_]),
							i_43_, i_45_, i_6_, -1836919463);
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_40_]),
							i_45_, i_44_, i_5_, -2035540755);
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_40_]),
							i_44_, i_42_, i_6_, -981316535);
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_41_]),
							i_43_, i_45_, i_6_, -235264647);
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_41_]),
							i_45_, i_44_, i_5_, -955018458);
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_41_]),
							i_44_, i_42_, i_6_, 614343007);
				} else {
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_40_]),
							i_43_, i_42_, i_6_, 2012650318);
					Class82_Sub22.method940(
							(Class372_Sub1_Sub1.anIntArrayArray4047[i_41_]),
							i_43_, i_42_, i_6_, -1092242835);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("abl.ad(").append(')').toString());
		}
	}
}
