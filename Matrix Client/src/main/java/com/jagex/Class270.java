...
public class Class270 {
	...
	byte[] method2532(byte[] is, int i) {
		try {
			if (((Class270) this).anIntArrayArray2893 != null) {
				int i_0_ = (int) ((long) is.length
						* (long) (((Class270) this).anInt2892 * 278980631) / (long) (((Class270) this).anInt2888 * -931883257)) + 14;
				...
				for (int i_4_ = 0; i_4_ < is.length; i_4_++) {
					...
					int i_8_ = i_3_
							/ (-931883257 * ((Class270) this).anInt2888);
					i_2_ += i_8_;
	...
	public short[] method2533(short[] is, byte i) {
		try {
			if (null != ((Class270) this).anIntArrayArray2893) {
				int i_11_ = ((int) ((long) (((Class270) this).anInt2892 * 278980631)
						* (long) is.length / (long) (((Class270) this).anInt2888 * -931883257)) + 14);
	...
	int method2534(int i, int i_22_) {
		try {
			if (null != ((Class270) this).anIntArrayArray2893)
				i = (int) ((long) (278980631 * ((Class270) this).anInt2892)
						* (long) i / (long) (-931883257 * ((Class270) this).anInt2888));
			return i;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.b(").append(')').toString());
		}
	}
	...
	int method2535(int i, int i_23_) {
		try {
			if (((Class270) this).anIntArrayArray2893 != null)
				i = (int) ((long) (278980631 * ((Class270) this).anInt2892)
						* (long) i / (long) (-931883257 * ((Class270) this).anInt2888)) + 6;
			return i;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.p(").append(')').toString());
		}
	}
		...
		if (i_24_ != i) {
			...
			for (int i_26_ = 0; i_26_ < i; i_26_++) {
				...
				for (/**/; i_27_ < i_28_; i_27_++) {
					...
					d_31_ *= 0.54 + 0.46 * Math
							.cos(((double) i_27_ - d) * 0.2243994752564138);
	...
	static final void method2536(IComponentDefinition class105, Class119 class119,
		...
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.cq(").append(')').toString());
		}
	}

	static final void method2537(Class403 class403, int i) {
		try {
			if (client.anInt8932 * -1333485389 >= 5
					&& -1333485389 * client.anInt8932 <= 9)
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = -1333485389
						* client.anInt8932;
			else
				((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919) - 1] = 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.uo(").append(')').toString());
		}
	}
	...
	static final void method2538(Class403 class403, int i) {
		try {
			...
			int i_36_ = Class264_Sub4.method2514(i_32_, i_34_, i_35_,
					(short) -30782);
			if (i_36_ < 0)
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.aev(").append(')').toString());
		}
	}

	public static final void method2539(int i, int i_37_, int i_38_, int i_39_,
			int i_40_, int i_41_) {
		try {
			if (i >= Class372_Sub3.anInt4051 * -1424479739
					&& i_37_ <= 1135094847 * Class372_Sub3.anInt4048
					&& i_38_ >= Class372_Sub3.anInt4049 * 1155384281
					&& i_39_ <= -1062447355 * Class372_Sub3.anInt4050)
				Class390.method4873(i, i_37_, i_38_, i_39_, i_40_, -1435817713);
			else
				Class298_Sub20.method3052(i, i_37_, i_38_, i_39_, i_40_,
						1926849708);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.x(").append(')').toString());
		}
	}
	...
	static final void method2540(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub8_7566
					.method5612(i_42_, 1352882135);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.aox(").append(')').toString());
		}
	}

	static final void method2541(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563
					.method5638((byte) 78) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lf.ann(").append(')').toString());
		}
	}
}
