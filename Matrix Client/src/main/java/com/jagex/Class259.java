...
public class Class259 {
	public static GraphicsToolkit method2455(Canvas canvas, Interface_ma interface_ma,
			Class243 class243, int i) {
		...
		try {
			...
			if (l == 0L)
				throw new RuntimeException("");
			Class_ra_Sub3_Sub1 class_ra_sub3_sub1_0_ = new Class_ra_Sub3_Sub1(
					opengl, canvas, l, interface_ma, class243, i);
	...
	public static GraphicsToolkit method2456(Canvas canvas, Interface_ma interface_ma,
			Class243 class243, int i) {
		Class_ra_Sub3_Sub1 class_ra_sub3_sub1;
		try {
			boolean bool = Class_ra_Sub3.method5421();
			...
			if (l == 0L)
				throw new RuntimeException("");
			Class_ra_Sub3_Sub1 class_ra_sub3_sub1_1_ = new Class_ra_Sub3_Sub1(
					opengl, canvas, l, interface_ma, class243, i);
	...
	public static GraphicsToolkit method2457(Canvas canvas, Interface_ma interface_ma,
			Class243 class243, int i) {
		Class_ra_Sub3_Sub1 class_ra_sub3_sub1;
		try {
			boolean bool = Class_ra_Sub3.method5421();
			...
			if (l == 0L)
				throw new RuntimeException("");
			Class_ra_Sub3_Sub1 class_ra_sub3_sub1_2_ = new Class_ra_Sub3_Sub1(
					opengl, canvas, l, interface_ma, class243, i);
