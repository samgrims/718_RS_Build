...
public final class Class448 {
	...
	static final void method5912(int i, int i_1_, int i_2_, int i_3_, int i_4_,
		...
		try {
			if (!Class378.method4671(i, null, -1216775650)) {
				...
				Class422_Sub24.method5714(Class389.aClass119Array4165[i]
						.method1295((byte) -87), -1, i_1_, i_2_, i_3_, i_4_,
						i_5_, i_6_, i_7_, i_7_ < 0, (byte) 0);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("sm.kt(").append(')').toString());
		}
	}
