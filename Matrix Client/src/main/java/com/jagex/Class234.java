...
public class Class234 {
	...
	static void method2174(String string, String string_0_, int i, int i_1_,
			int i_2_, long l, int i_3_, int i_4_, boolean bool,
			boolean bool_5_, long l_6_, boolean bool_7_, int i_8_) {
		try {
			if (!Class436.aBoolean5478 && -278777595 * Class436.anInt5506 < 521) {
				i = i != -1 ? i : client.anInt8937 * -1808468501;
				Class298_Sub37_Sub15 class298_sub37_sub15 = new Class298_Sub37_Sub15(
						string, string_0_, i, i_1_, i_2_, l, i_3_, i_4_, bool,
						bool_5_, l_6_, bool_7_);
				Class282.method2618(class298_sub37_sub15, 1640099092);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jw.y(").append(')').toString());
		}
	}
	...
	static final void method2177(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = client.aClass251Array8920[i_11_].anInt2768 * 535421071;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jw.ya(").append(')').toString());
		}
	}
	...
	static final void method2179(Class403 class403, short i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jw.adl(").append(')').toString());
		}
	}

	static final void method2180(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7553
					.method5726(-2145285486);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jw.ajz(").append(')').toString());
		}
	}

	public static void method2181(RsBitsBuffer class298_sub53_sub2, int i) {
		try {
			Class298_Sub47 class298_sub47 = ((Class298_Sub47) Class478.aClass453_6002
					.method5939(1766612795));
			if (null != class298_sub47) {
				int i_14_ = 385051775 * class298_sub53_sub2.index;
				class298_sub53_sub2.writeInt(-1886044647
						* (((Class298_Sub47) class298_sub47).anInt7542),
						-169937628);
				for (int i_15_ = 0; i_15_ < (719522345 * ((Class298_Sub47) class298_sub47).anInt7538); i_15_++) {
					if (0 != (((Class298_Sub47) class298_sub47).anIntArray7536[i_15_]))
						class298_sub53_sub2
								.writeByte(
										(((Class298_Sub47) class298_sub47).anIntArray7536[i_15_]));
					else {
						try {
							...
							if (0 == i_16_) {
								...
								field
										.setInt(
												null,
												(((Class298_Sub47) class298_sub47).anIntArray7535[i_15_]));
								class298_sub53_sub2.writeByte(0);
							} else if (i_16_ == 2) {
								Field field = (((Class298_Sub47) class298_sub47).aFieldArray7539[i_15_]);
							...
							if (i_16_ == 3) {
								...
								for (int i_19_ = 0; i_19_ < is.length; i_19_++) {
									...
									objects[i_19_] = objectinputstream
											.readObject();
								}
								...
								if (object == null)
									...
									class298_sub53_sub2
											.writeByte(1);
									class298_sub53_sub2
											.writeLong(((Number) object)
													.longValue());
								} else if (object instanceof String) {
									class298_sub53_sub2
											.writeByte(2);
									class298_sub53_sub2.writeString(
											((String) object), 2146946191);
								} else
									class298_sub53_sub2
											.writeByte(4);
							} else if (i_16_ == 4) {
	...
	public static void method2183(int i) {
		try {
			...
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("jw.a(").append(')').toString());
		}
	}

	static final void method2184(IComponentDefinition class105, Class119 class119,
