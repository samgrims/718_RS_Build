...
public class Class298_Sub32_Sub21 extends Class298_Sub32 {
			...
			if (i_1_ > 0) {
				for (int i_2_ = 0; i_2_ < 257; i_2_++) {
					...
					if (i_8_ < 0)
						...
						i_8_ = 255;
					((Class298_Sub32_Sub21) this).anIntArray9456[i_2_] = i_6_ << 16
							| i_7_ << 8 | i_8_;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahj.ac(").append(')').toString());
		}
	}
	...
	void method3137(int i, RsByteBuffer class298_sub53, byte i_12_) {
		try {
			if (i == 0) {
				...
				if (0 == i_13_) {
					((Class298_Sub32_Sub21) this).anIntArrayArray9461 = new int[class298_sub53
							.readUnsignedByte()][4];
					for (int i_14_ = 0; i_14_ < (((Class298_Sub32_Sub21) this).anIntArrayArray9461).length; i_14_++) {
						((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_14_][0] = class298_sub53
								.readUnsignedShort();
						((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_14_][1] = class298_sub53
								.readUnsignedByte() << 4;
						((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_14_][2] = class298_sub53
								.readUnsignedByte() << 4;
						((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_14_][3] = class298_sub53
								.readUnsignedByte() << 4;
					}
				} else
		...
		if (i == 0) {
			...
			if (0 == i_15_) {
				...
				for (int i_16_ = 0; i_16_ < (((Class298_Sub32_Sub21) this).anIntArrayArray9461).length; i_16_++) {
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_16_][0] = class298_sub53
							.readUnsignedShort();
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_16_][1] = class298_sub53
							.readUnsignedByte() << 4;
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_16_][2] = class298_sub53
							.readUnsignedByte() << 4;
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_16_][3] = class298_sub53
							.readUnsignedByte() << 4;
				}
			} else
		...
		if (i == 0) {
			...
			if (0 == i_17_) {
				...
				for (int i_18_ = 0; i_18_ < (((Class298_Sub32_Sub21) this).anIntArrayArray9461).length; i_18_++) {
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_18_][0] = class298_sub53
							.readUnsignedShort();
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_18_][1] = class298_sub53
							.readUnsignedByte() << 4;
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_18_][2] = class298_sub53
							.readUnsignedByte() << 4;
					((Class298_Sub32_Sub21) this).anIntArrayArray9461[i_18_][3] = class298_sub53
							.readUnsignedByte() << 4;
				}
			} else
	...
	static final void method3273(Class403 class403, int i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_38_
					/ i_39_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("ahj.yw(").append(')').toString());
		}
	}
}
