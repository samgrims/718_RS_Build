...
public class Class334 {
	...
	Class334(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_,
	...
	public boolean method4082(int i, int i_9_, int i_10_) {
		if (i < ((Class334) this).anInt3610 || i > ((Class334) this).anInt3614)
			return false;
		if (i_9_ < ((Class334) this).anInt3612
				|| i_9_ > ((Class334) this).anInt3607)
			return false;
		if (i_10_ < ((Class334) this).anInt3613
				|| i_10_ > ((Class334) this).anInt3615)
			return false;
	...
	void method4083(int i, int i_13_, int i_14_, int i_15_, int i_16_,
