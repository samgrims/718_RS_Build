...
public final class Class253 {
	...
	public Object method2411(Object object, Object object_0_, byte i) {
		try {
			synchronized (this) {
				...
				Class261 class261 = (Class261) ((Class253) this).aMap2784
						.get(object);
				if (class261 != null) {
				...
				if (method2412((byte) 3)
						&& (((Class253) this).aMap2784.size() == 582284141 * ((Class253) this).anInt2780)) {
					Class261 class261_3_ = (Class261) ((Class253) this).anAbstractQueue_Sub1_2781
							.remove();
					((Class253) this).aMap2784
							.remove(((Class261) class261_3_).anObject2824);
					((Class253) this).anAbstractQueue_Sub1_2779
							.remove(class261_3_);
				}
	...
	Class253(long l, int i, Class254 class254) {
		...
		if (((Class253) this).anInt2780 * 582284141 == -1) {
			...
			((Class253) this).anAbstractQueue_Sub1_2779 = new AbstractQueue_Sub1(
					64);
			((Class253) this).anAbstractQueue_Sub1_2781 = null;
		} else {
			if (null == ((Class253) this).aClass254_2783)
				throw new IllegalArgumentException("");
			((Class253) this).aMap2784 = new HashMap(
					((Class253) this).anInt2780 * 582284141);
			((Class253) this).anAbstractQueue_Sub1_2779 = new AbstractQueue_Sub1(
					582284141 * ((Class253) this).anInt2780);
			((Class253) this).anAbstractQueue_Sub1_2781 = new AbstractQueue_Sub1(
					582284141 * ((Class253) this).anInt2780);
		}
	}
	...
	void method2414(Class261 class261, boolean bool, byte i) {
		try {
			if (!bool) {
				...
				if (method2412((byte) 3)
						&& !((Class253) this).anAbstractQueue_Sub1_2781
								.remove(class261))
					throw new IllegalStateException("");
			}
			((Class261) class261).aLong2823 = System.currentTimeMillis() * 7489795633800790139L;
			if (method2412((byte) 3)) {
				switch (((Class254) ((Class253) this).aClass254_2783).anInt2788
						* -1142442207) {
				case 0:
	...
	void method2415(int i) {
		try {
			if (((Class253) this).aLong2782 * -7599200929196954985L == -1L)
				throw new IllegalStateException("");
			long l = (System.currentTimeMillis() - -7599200929196954985L
					* ((Class253) this).aLong2782);
			while_67_: do {
				for (;;) {
					if (((Class253) this).anAbstractQueue_Sub1_2779.isEmpty())
						break while_67_;
					Class261 class261 = ((Class261) ((Class253) this).anAbstractQueue_Sub1_2779
							.peek());
					if (2922630875768299187L * ((Class261) class261).aLong2823 >= l)
						break;
					((Class253) this).aMap2784
							.remove(((Class261) class261).anObject2824);
					((Class253) this).anAbstractQueue_Sub1_2779
							.remove(class261);
					if (method2412((byte) 3))
						((Class253) this).anAbstractQueue_Sub1_2781
	...
	static final void method2419(Class403 class403, byte i) {
		try {
			String string = (String) (((Class403) class403).anObjectArray5240[(((Class403) class403).anInt5241 -= 969361751)
					* -203050393]);
			if (string.startsWith(Class247.method2368(0, -278777595))
					|| string.startsWith(Class247.method2368(1, -278777595)))
				string = string.substring(7);
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class478
					.method6098(string, -1316013258);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kp.wi(").append(')').toString());
		}
	}
	...
	static final void method2420(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = (class343_sub1 == null ? 0
					: class343_sub1.anInt3670 * -877023375);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kp.alt(").append(')').toString());
		}
	}
	...
	static final void method2421(Class403 class403, byte i) {
		try {
			...
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = ((Player) ((Class403) class403).aClass365_Sub1_Sub1_Sub2_5242).aClass70_10223
					.method799(i_10_, -1034906382);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kp.ae(").append(')').toString());
		}
	}
	...
	static void method2422(int i, int i_11_, int i_12_, int i_13_, int i_14_) {
		try {
			...
			((Class298_Sub37_Sub12) class298_sub37_sub12).anInt9609 = -80288087
					* i_13_;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("kp.ab(").append(')').toString());
