	...
	static final boolean method4548(Class25 class25, int i) throws IOException {
		try {
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.INTERFACE_PACKET) { //interface definitions way
				...
				Class113.method1254(parentHash, new Interface(interfaceId, clipped),
						new int[] { key1, key2, key3, key4 }, false,
						-37609880);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2250 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.method1924(i_342_, 5, client.playerIndex * -442628795,
						0, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (((Class25) class25).INCOMMING_PACKET == IncommingPacket.aClass202_2232) {
				...
				Class298_Sub36 class298_sub36 = Class18.method359(
						...
						(byte) 120);
				class298_sub36.aClass298_Sub53_Sub2_7396.write128Byte(
						914379507 * client.anInt6467, (byte) 1);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_413_,
						390381879);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeIntV1(i_414_,
						(byte) -42);
			...
			if (IncommingPacket.aClass202_2220 == ((Class25) class25).INCOMMING_PACKET) {
				...
				for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) client.aClass437_8685
					...
					if (i_426_ == Class375.basePlane * -191892109
							&& i_428_ >= 134435705 * Class162.baseTileX
							&& i_428_ < 8 + 134435705 * Class162.baseTileX
				...
				for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7152
						...
						.method5944(49146))) {
					if ((class298_sub1.anInt7150 * 634196087 >= 134435705 * Class162.baseTileX)
							&& (634196087 * class298_sub1.anInt7150 < 8 + 134435705 * Class162.baseTileX)
				...
				for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7162
						...
						.method5944(49146))) {
					if ((634196087 * class298_sub1.anInt7150 >= 134435705 * Class162.baseTileX)
							&& (634196087 * class298_sub1.anInt7150 < Class162.baseTileX * 134435705 + 8)
			...
			if (IncommingPacket.PLAYER_ON_ICOMPONENT_PACKET == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.method1924(i_453_, 3, client.playerIndex * -442628795,
						0, 262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
			...
			if (IncommingPacket.aClass202_2238 == ((Class25) class25).INCOMMING_PACKET) {
				...
				SubIncommingPacket.method1924(i_471_, 7, i_470_ << 16 | i_469_, i_472_,
						262144);
				((Class25) class25).INCOMMING_PACKET = null;
				return true;
			}
