...
public abstract class Class291 implements Interface14, Runnable, FocusListener,
	...
	final void method2752(String string, String string_5_, int i, int i_6_,
		...
		try {
			...
			Class216.aStringArray6657 = new String[] { "c:/rscache/",
					"/rscache/", "c:/windows/", "c:/winnt/", "c:/",
					Class83.aString765, "/tmp/", "" };
			Class68.aStringArray679 = (new String[] {
					new StringBuilder().append(".matrix_cache_").append(
							Class139.anInt1548 * -518493991).toString(),
					new StringBuilder().append(".file_store_").append(
							-518493991 * Class139.anInt1548).toString() });
			...
			aClass484_6476 = (new Class484(new Class476(Class482.method6118(
					"main_file_cache.dat2", (byte) -19), "rw", 524288000L),
					5200, 0));
			aClass484_6475 = (new Class484(new Class476(Class482.method6118(
					"main_file_cache.idx255", (byte) -21), "rw", 1048576L),
					6000, 0));
			...
			for (int i_13_ = 0; i_13_ < 1210163253 * Class310.anInt6512; i_13_++)
				Class497.aClass484Array6106[i_13_] = new Class484(new Class476(
						(Class482.method6118(
								new StringBuilder().append(
										"main_file_cache.idx").append(i_13_)
										.toString(), (byte) -49)), "rw",
						1048576L), 6000, 0);
			try {
			...
			for (ThreadGroup threadgroup_14_ = threadgroup.getParent(); threadgroup_14_ != null; threadgroup_14_ = threadgroup
					.getParent())
	...
	void method2755(File file, File file_18_, int i) {
		try {
			try {
				...
				if (file_18_ != null)
					class298_sub53
							.putJagString(file_18_.getPath(), (short) -4942);
	...
	void method2757(int i) {
		try {
			if (Class52_Sub2_Sub1.aCanvas9079 != null) {
				...
				Class52_Sub2_Sub1.aCanvas9079.getParent().setBackground(
						Color.black);
				Class52_Sub2_Sub1.aCanvas9079.getParent().remove(
						Class52_Sub2_Sub1.aCanvas9079);
			}
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.v(").append(')').toString());
		}
	}

	final boolean method2758(int i) {
		try {
			String string = ClientScriptMap.anApplet6044.getDocumentBase().getHost()
					.toLowerCase();
	...
	void method2759(byte i) {
		try {
			if (null != Class350.aString3759) {
				...
				if (string.indexOf("sun") != -1
					...
					if (string_19_.equals("1.1")
							...
							|| string_19_.equals("1.6.0")) {
						method2778("wrongjava", -1275699738);
						return;
					}
					if (string_19_.startsWith("1.6.0_")) {
						int i_20_;
						for (i_20_ = 6; (i_20_ < string_19_.length() && Class431
								.method5764(string_19_.charAt(i_20_),
										-1385964882)); i_20_++) {
							/* empty */
						}
			...
			maximumMemory = ((int) (Runtime.getRuntime().maxMemory() / 1048576L) + 1)
					* -1855823519;
			...
			while (0L == 2916456661870185289L * aLong6496
					|| (Class122.method1319((byte) 1) < aLong6496 * 2916456661870185289L)) {
				RuntimeException_Sub1.anInt6303 = (aClass309_6492
						.method3787(aLong6484 * -4639622049358970979L) * -2090388391);
	...
	void method2760(int i) {
		try {
			...
			Class272.anInt2903 = 1423456989 * (-1371443851 * Class272.anInt2903
					+ 1 & 0x1f);
			if (l_23_ != 0L && l > l_23_) {
			...
			if ((anInt6477 += -2020246835) * 698024453 - 1 > 50) {
				...
				aBoolean6471 = true;
				Class52_Sub2_Sub1.aCanvas9079.setSize(Class462.anInt5683
						* -2110394505, Class298_Sub40_Sub9.anInt9716
						* -1111710645);
				...
				if (null != Class298_Sub36.aFrame7403
					...
					Class52_Sub2_Sub1.aCanvas9079.setLocation(insets.left
	...
	public final synchronized void method195(Graphics graphics) {
		try {
			if (!aBoolean6497) {
				aBoolean6471 = true;
				if ((Class122.method1319((byte) 1) - -4623726814665285853L
						* aLong6491) > 1000L) {
					Rectangle rectangle = graphics.getClipBounds();
					if (rectangle == null
							|| (rectangle.width >= -639974669
									* Class78.anInt733 && rectangle.height >= anInt6472 * 1282634425))
						aBoolean6478 = true;
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public boolean method2766(int i) {
		try {
			((Class291) this).aBoolean6501 = Class85.method955(-1461998657)
					.method265("jaclib", 888400764);
	...
	public boolean method2767(int i) {
		try {
			return Class85.method955(-975726550).method265("jagtheora",
					1050805065);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	public final synchronized void method191(Graphics graphics) {
		if (!aBoolean6497) {
			...
			if ((Class122.method1319((byte) 1) - -4623726814665285853L
				...
				Rectangle rectangle = graphics.getClipBounds();
				if (rectangle == null
						|| (rectangle.width >= -639974669 * Class78.anInt733 && rectangle.height >= anInt6472 * 1282634425))
					aBoolean6478 = true;
			}
		}
	}
	...
	void method2777(Container container, int i) {
		try {
			...
			Class52_Sub2_Sub1.aCanvas9079.setSize(-2110394505
					* Class462.anInt5683, -1111710645
					* Class298_Sub40_Sub9.anInt9716);
			Class52_Sub2_Sub1.aCanvas9079.setVisible(true);
			if (container == Class298_Sub36.aFrame7403) {
				Insets insets = Class298_Sub36.aFrame7403.getInsets();
				Class52_Sub2_Sub1.aCanvas9079.setLocation(insets.left
						+ 1898544019 * anInt6473, anInt6474 * 540368727
						+ insets.top);
			} else
				Class52_Sub2_Sub1.aCanvas9079.setLocation(
	...
	void method2778(String string, int i) {
		try {
			if (!((Class291) this).aBoolean6498) {
				...
				try {
					Class466.method6021(ClientScriptMap.anApplet6044, "loggedout",
							(short) 19911);
				} catch (Throwable throwable) {
					/* empty */
				}
				try {
					ClientScriptMap.anApplet6044.getAppletContext().showDocument(
							new URL(ClientScriptMap.anApplet6044.getCodeBase(),
	...
	synchronized void method2780(String string, int i) {
		try {
			...
			Insets insets = Class298_Sub36.aFrame7403.getInsets();
			Class298_Sub36.aFrame7403.setSize((insets.right + (Class78.anInt733
					* -639974669 + insets.left)), (anInt6472 * 1282634425
					+ insets.top + insets.bottom));
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("mc.z(").append(')').toString());
		}
	}
	...
	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			String string_29_ = (i == 0 ? "" : new StringBuilder().append("")
					.append(i).toString());
			Class180.aFile6528 = new File(Class83.aString765,
					new StringBuilder().append("matrix_cl_").append(string)
				...
				while_74_: for (int i_34_ = 0; i_34_ < Class68.aStringArray679.length; i_34_++) {
					for (int i_35_ = 0; i_35_ < Class216.aStringArray6657.length; i_35_++) {
						File file = new File(new StringBuilder().append(
								...
								File.separatorChar).append(string).append(
			...
			if (string_30_ == null) {
				string_30_ = new StringBuilder().append(Class83.aString765)
						.append(File.separatorChar).append("matrixcache")
						.append(string_29_).append(File.separatorChar).append(
								string).append(File.separatorChar).append(
								string_27_).append(File.separatorChar)
						.toString();
				bool = true;
			}
			if (null != string_31_) {
	...
	static final void method2787(IComponentDefinition class105, Class119 class119,
			Class403 class403, int i) {
		try {
			class105.anInt1178 = (((Class403) class403).anIntArray5244[(((Class403) class403).anInt5239 -= -391880689) * 681479919]) * 1158843261;
	...
	static final void method2788(Class403 class403, byte i) {
		try {
			Class390 class390 = (((Class403) class403).aBoolean5261 ? ((Class403) class403).aClass390_5247
					: ((Class403) class403).aClass390_5246);
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			((Class403) class403).anIntArray5244[((((Class403) class403).anInt5239 += -391880689) * 681479919 - 1)] = -1424956747
					* class105.anInt1167;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	static final void method2790(Class403 class403, int i) {
		try {
			((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1] = (((Class403) class403).aClass162_5252
					.method1756((byte) 4)[(((Class403) class403).anIntArray5244[((Class403) class403).anInt5239 * 681479919 - 1])]);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
	...
	static void method2791(int i, String string, String string_44_, int i_45_) {
		try {
			if (null != client.aClass25_8711) {
				...
				class298_sub36.aClass298_Sub53_Sub2_7396.putJagString(string_44_,
						(short) -29506);
				class298_sub36.aClass298_Sub53_Sub2_7396
						.write128Byte(i, (byte) 1);
